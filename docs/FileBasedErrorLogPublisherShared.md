...
|**schemas** | **List&lt;EnumfileBasedErrorLogPublisherSchemaUrn&gt;** |  |  |
...
|**logFilePermissions** | **String** | The UNIX permissions of the log files created by this File Based Error Log Publisher. |  [optional] |
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the File Based Error Log Publisher . |  [optional] |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the File Based Error Log Publisher . |  [optional] |
...
|**asynchronous** | **Boolean** | Indicates whether the File Based Error Log Publisher will publish records asynchronously. |  [optional] |
