...
|**schemas** | **List&lt;EnumsyslogJsonAccessLogPublisherSchemaUrn&gt;** |  |  |
...
|**syslogMessageHostName** | **String** | The local host name that will be included in syslog messages that are logged by this Syslog JSON Access Log Publisher. |  [optional] |
|**syslogMessageApplicationName** | **String** | The application name that will be included in syslog messages that are logged by this Syslog JSON Access Log Publisher. |  [optional] |
