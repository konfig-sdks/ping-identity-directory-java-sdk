...
|**schemas** | **List&lt;EnumentryChecksumVirtualAttributeSchemaUrn&gt;** |  |  [optional] |
...
|**excludeOperationalAttributes** | **Boolean** | Indicates whether all operational attributes should be excluded from the generated checksum. |  [optional] |
|**excludedAttribute** | **List&lt;String&gt;** | Specifies the attributes that should be excluded from the checksum calculation. |  [optional] |
