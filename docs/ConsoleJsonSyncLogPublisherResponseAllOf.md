...
|**schemas** | **List&lt;EnumconsoleJsonSyncLogPublisherSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the Log Publisher |  [optional] |
|**enabled** | **Boolean** | Indicates whether the Console JSON Sync Log Publisher is enabled for use. |  [optional] |
