...
|**schemas** | **List&lt;EnumbrokerExternalServerSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the External Server |  [optional] |
|**serverHTTPPort** | **Integer** | The port number on which the server listens for HTTP requests. |  [optional] |
|**useSSL** | **Boolean** | Indicates whether the Broker External Server is using SSL for HTTP communications. |  [optional] |
...
|**connectionSecurity** | **EnumexternalServerBrokerConnectionSecurityProp** |  |  [optional] |
|**authenticationMethod** | **EnumexternalServerBrokerAuthenticationMethodProp** |  |  [optional] |
