...
|**schemas** | **List&lt;EnumconsoleJsonAccessLogPublisherSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the Log Publisher |  [optional] |
|**enabled** | **Boolean** | Indicates whether the Console JSON Access Log Publisher is enabled for use. |  [optional] |
