...
|**schemas** | **List&lt;EnumconsoleJsonErrorLogPublisherSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the Log Publisher |  [optional] |
|**enabled** | **Boolean** | Indicates whether the Console JSON Error Log Publisher is enabled for use. |  [optional] |
