...
|**schemas** | **List&lt;EnumsyslogJsonAuditLogPublisherSchemaUrn&gt;** |  |  |
...
|**syslogMessageHostName** | **String** | The local host name that will be included in syslog messages that are logged by this Syslog JSON Audit Log Publisher. |  [optional] |
|**syslogMessageApplicationName** | **String** | The application name that will be included in syslog messages that are logged by this Syslog JSON Audit Log Publisher. |  [optional] |
...
|**softDeleteEntryAuditBehavior** | **EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp** |  |  [optional] |
