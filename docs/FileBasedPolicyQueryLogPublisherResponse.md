...
|**schemas** | **List&lt;EnumfileBasedPolicyQueryLogPublisherSchemaUrn&gt;** |  |  |
|**id** | **String** | Name of the Log Publisher |  |
|**asynchronous** | **Boolean** | Indicates whether the File Based Policy Query Log Publisher will publish records asynchronously. |  |
...
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the File Based Policy Query Log Publisher . |  |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the File Based Policy Query Log Publisher . |  |
