...
|**schemas** | **List&lt;EnumfileBasedSyncLogPublisherSchemaUrn&gt;** |  |  |
...
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the File Based Sync Log Publisher . |  |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the File Based Sync Log Publisher . |  |
...
|**asynchronous** | **Boolean** | Indicates whether the File Based Sync Log Publisher will publish records asynchronously. |  |
