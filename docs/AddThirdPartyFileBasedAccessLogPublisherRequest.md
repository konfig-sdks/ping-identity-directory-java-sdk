...
|**logFilePermissions** | **String** | The UNIX permissions of the log files created by this Third Party File Based Access Log Publisher. |  [optional] |
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the Third Party File Based Access Log Publisher . |  [optional] |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the Third Party File Based Access Log Publisher . |  [optional] |
...
|**asynchronous** | **Boolean** | Indicates whether the Third Party File Based Access Log Publisher will publish records asynchronously. |  [optional] |
