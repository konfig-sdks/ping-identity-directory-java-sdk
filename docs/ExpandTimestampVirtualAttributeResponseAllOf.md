...
# ExpandTimestampVirtualAttributeResponseAllOf
...
|**schemas** | **List&lt;EnumexpandTimestampVirtualAttributeSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the Virtual Attribute |  [optional] |
|**conflictBehavior** | **EnumvirtualAttributeConflictBehaviorProp** |  |  [optional] |
|**sourceAttribute** | **String** | Specifies the source attribute containing the compact timestamp to be expanded. |  [optional] |
