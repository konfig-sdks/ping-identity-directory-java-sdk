...
|**schemas** | **List&lt;EnumactiveDirectoryExternalServerSchemaUrn&gt;** |  |  |
|**bindDN** | **String** | The DN to use to bind to the target LDAP server if simple authentication is required. The authentication identity can also be specified in User-Principal-Name (UPN) format. |  [optional] |
...
|**connectionSecurity** | **EnumexternalServerActiveDirectoryConnectionSecurityProp** |  |  [optional] |
|**authenticationMethod** | **EnumexternalServerActiveDirectoryAuthenticationMethodProp** |  |  [optional] |
