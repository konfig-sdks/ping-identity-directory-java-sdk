...
|**schemas** | **List&lt;EnumcurrentTimeVirtualAttributeSchemaUrn&gt;** |  |  [optional] |
...
|**returnUtcTime** | **Boolean** | Indicates whether to return current time in UTC. |  [optional] |
|**includeMilliseconds** | **Boolean** | Indicates whether the current time includes millisecond precision. |  [optional] |
