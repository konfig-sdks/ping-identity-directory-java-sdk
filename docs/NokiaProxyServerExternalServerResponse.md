...
|**connectionSecurity** | **EnumexternalServerNokiaProxyServerConnectionSecurityProp** |  |  |
|**authenticationMethod** | **EnumexternalServerNokiaProxyServerAuthenticationMethodProp** |  |  |
