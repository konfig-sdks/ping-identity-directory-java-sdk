...
|**schemas** | **List&lt;EnumfileBasedJsonSyncLogPublisherSchemaUrn&gt;** |  |  [optional] |
|**id** | **String** | Name of the Log Publisher |  [optional] |
|**logFile** | **String** | The file name to use for the log files generated by the File Based JSON Sync Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path. |  [optional] |
|**logFilePermissions** | **String** | The UNIX permissions of the log files created by this File Based JSON Sync Log Publisher. |  [optional] |
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the File Based JSON Sync Log Publisher . |  [optional] |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the File Based JSON Sync Log Publisher . |  [optional] |
...
|**asynchronous** | **Boolean** | Indicates whether the File Based JSON Sync Log Publisher will publish records asynchronously. |  [optional] |
