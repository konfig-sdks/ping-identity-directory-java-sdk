...
|**schemas** | **List&lt;EnummemberVirtualAttributeSchemaUrn&gt;** |  |  |
|**conflictBehavior** | **EnumvirtualAttributeConflictBehaviorProp** |  |  [optional] |
|**allowRetrievingMembership** | **Boolean** | Indicates whether to handle requests that request all values for the virtual attribute. |  [optional] |
