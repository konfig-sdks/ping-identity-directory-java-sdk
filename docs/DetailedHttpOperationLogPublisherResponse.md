...
|**rotationPolicy** | **List&lt;String&gt;** | The rotation policy to use for the Detailed HTTP Operation Log Publisher . |  |
|**rotationListener** | **List&lt;String&gt;** | A listener that should be notified whenever a log file is rotated out of service. |  [optional] |
|**retentionPolicy** | **List&lt;String&gt;** | The retention policy to use for the Detailed HTTP Operation Log Publisher . |  |
