...
public class RootDseBackendApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RootDseBackendApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RootDseBackendApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getSingleCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/root-dse-backend";
    ...
    private ApiResponse<RootDseBackendResponse> getSingleWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RootDseBackendResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(final ApiCallback<RootDseBackendResponse> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 404 </td><td> The Root DSE Backend does not exist </td><td>  -  </td></tr>
         </table>
         */
         ...
         */
        public RootDseBackendResponse execute() throws ApiException {
            ApiResponse<RootDseBackendResponse> localVarResp = getSingleWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSingle request with HTTP info returned
         * @return ApiResponse&lt;RootDseBackendResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RootDseBackendResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RootDseBackendResponse> _callback) throws ApiException {
    ...
    private ApiResponse<RootDseBackendResponse> updateByNameWithHttpInfo(UpdateRequest updateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByNameValidateBeforeCall(updateRequest, null);
        Type localVarReturnType = new TypeToken<RootDseBackendResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByNameAsync(UpdateRequest updateRequest, final ApiCallback<RootDseBackendResponse> _callback) throws ApiException {
    ...
    public class UpdateByNameRequestBuilder {
        ...
        public RootDseBackendResponse execute() throws ApiException {
            UpdateRequest updateRequest = buildBodyParams();
            ApiResponse<RootDseBackendResponse> localVarResp = updateByNameWithHttpInfo(updateRequest);
            return localVarResp.getResponseBody();
        }
     ...
     * 
     * @param updateRequest Update an existing Root DSE Backend (required)
