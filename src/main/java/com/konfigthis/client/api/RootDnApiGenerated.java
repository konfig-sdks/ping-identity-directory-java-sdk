...
public class RootDnApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public RootDnApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public RootDnApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private ApiResponse<RootDnResponse> getSingleWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<RootDnResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(final ApiCallback<RootDnResponse> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 404 </td><td> The Root DN does not exist </td><td>  -  </td></tr>
         </table>
         */
         ...
         */
        public RootDnResponse execute() throws ApiException {
            ApiResponse<RootDnResponse> localVarResp = getSingleWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSingle request with HTTP info returned
         * @return ApiResponse&lt;RootDnResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<RootDnResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<RootDnResponse> _callback) throws ApiException {
    ...
    private ApiResponse<RootDnResponse> updateByNameWithHttpInfo(UpdateRequest updateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByNameValidateBeforeCall(updateRequest, null);
        Type localVarReturnType = new TypeToken<RootDnResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByNameAsync(UpdateRequest updateRequest, final ApiCallback<RootDnResponse> _callback) throws ApiException {
    ...
    public class UpdateByNameRequestBuilder {
        ...
        public RootDnResponse execute() throws ApiException {
            UpdateRequest updateRequest = buildBodyParams();
            ApiResponse<RootDnResponse> localVarResp = updateByNameWithHttpInfo(updateRequest);
            return localVarResp.getResponseBody();
        }
     ...
     * 
     * @param updateRequest Update an existing Root DN (required)
