...
public class PluginRootApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public PluginRootApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public PluginRootApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call getSingleCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/plugin-root";
    ...
    private ApiResponse<PluginRootResponse> getSingleWithHttpInfo() throws ApiException {
        okhttp3.Call localVarCall = getSingleValidateBeforeCall(null);
        Type localVarReturnType = new TypeToken<PluginRootResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call getSingleAsync(final ApiCallback<PluginRootResponse> _callback) throws ApiException {
    ...
    public class GetSingleRequestBuilder {
         ...
         * @http.response.details
         <table summary="Response Details" border="1">
            ...
            <tr><td> 404 </td><td> The Plugin Root does not exist </td><td>  -  </td></tr>
         </table>
         */
         ...
         */
        public PluginRootResponse execute() throws ApiException {
            ApiResponse<PluginRootResponse> localVarResp = getSingleWithHttpInfo();
            return localVarResp.getResponseBody();
        }

        /**
         * Execute getSingle request with HTTP info returned
         * @return ApiResponse&lt;PluginRootResponse&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<PluginRootResponse> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<PluginRootResponse> _callback) throws ApiException {
    ...
    private ApiResponse<PluginRootResponse> updateByNameWithHttpInfo(UpdateRequest updateRequest) throws ApiException {
        okhttp3.Call localVarCall = updateByNameValidateBeforeCall(updateRequest, null);
        Type localVarReturnType = new TypeToken<PluginRootResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call updateByNameAsync(UpdateRequest updateRequest, final ApiCallback<PluginRootResponse> _callback) throws ApiException {
    ...
    public class UpdateByNameRequestBuilder {
        ...
        public PluginRootResponse execute() throws ApiException {
            UpdateRequest updateRequest = buildBodyParams();
            ApiResponse<PluginRootResponse> localVarResp = updateByNameWithHttpInfo(updateRequest);
            return localVarResp.getResponseBody();
        }
     ...
     * 
     * @param updateRequest Update an existing Plugin Root (required)
