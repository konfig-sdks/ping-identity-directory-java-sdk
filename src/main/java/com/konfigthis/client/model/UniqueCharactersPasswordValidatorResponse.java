...
public class UniqueCharactersPasswordValidatorResponse {
  ...
  public UniqueCharactersPasswordValidatorResponse() {
  }

  public UniqueCharactersPasswordValidatorResponse id(String id) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse description(String description) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse schemas(List<EnumuniqueCharactersPasswordValidatorSchemaUrn> schemas) {
  ...
  public UniqueCharactersPasswordValidatorResponse addSchemasItem(EnumuniqueCharactersPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse minUniqueCharacters(Integer minUniqueCharacters) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse caseSensitiveValidation(Boolean caseSensitiveValidation) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UniqueCharactersPasswordValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UniqueCharactersPasswordValidatorResponse instance itself
   */
  public UniqueCharactersPasswordValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UniqueCharactersPasswordValidatorResponse uniqueCharactersPasswordValidatorResponse = (UniqueCharactersPasswordValidatorResponse) o;
    return Objects.equals(this.id, uniqueCharactersPasswordValidatorResponse.id) &&
        Objects.equals(this.description, uniqueCharactersPasswordValidatorResponse.description) &&
        Objects.equals(this.schemas, uniqueCharactersPasswordValidatorResponse.schemas) &&
        Objects.equals(this.minUniqueCharacters, uniqueCharactersPasswordValidatorResponse.minUniqueCharacters) &&
        Objects.equals(this.caseSensitiveValidation, uniqueCharactersPasswordValidatorResponse.caseSensitiveValidation) &&
        Objects.equals(this.enabled, uniqueCharactersPasswordValidatorResponse.enabled) &&
        Objects.equals(this.validatorRequirementDescription, uniqueCharactersPasswordValidatorResponse.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, uniqueCharactersPasswordValidatorResponse.validatorFailureMessage) &&
        Objects.equals(this.meta, uniqueCharactersPasswordValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, uniqueCharactersPasswordValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, uniqueCharactersPasswordValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, minUniqueCharacters, caseSensitiveValidation, enabled, validatorRequirementDescription, validatorFailureMessage, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UniqueCharactersPasswordValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UniqueCharactersPasswordValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UniqueCharactersPasswordValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UniqueCharactersPasswordValidatorResponse is not found in the empty JSON string", UniqueCharactersPasswordValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UniqueCharactersPasswordValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UniqueCharactersPasswordValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UniqueCharactersPasswordValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UniqueCharactersPasswordValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UniqueCharactersPasswordValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UniqueCharactersPasswordValidatorResponse>() {
           @Override
           public void write(JsonWriter out, UniqueCharactersPasswordValidatorResponse value) throws IOException {
           ...
           @Override
           public UniqueCharactersPasswordValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UniqueCharactersPasswordValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UniqueCharactersPasswordValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UniqueCharactersPasswordValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to UniqueCharactersPasswordValidatorResponse
  */
  public static UniqueCharactersPasswordValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UniqueCharactersPasswordValidatorResponse.class);
  }

 /**
  * Convert an instance of UniqueCharactersPasswordValidatorResponse to an JSON string
  *
  * @return JSON string
  */
