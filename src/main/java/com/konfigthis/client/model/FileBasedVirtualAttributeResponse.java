...
import com.konfigthis.client.model.EnumfileBasedVirtualAttributeSchemaUrn;
...
public class FileBasedVirtualAttributeResponse {
  ...
  private List<EnumfileBasedVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_DATA_DIRECTORY = "dataDirectory";
  @SerializedName(SERIALIZED_NAME_DATA_DIRECTORY)
  ...
  public FileBasedVirtualAttributeResponse() {
  }

  public FileBasedVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse schemas(List<EnumfileBasedVirtualAttributeSchemaUrn> schemas) {
  ...
  public FileBasedVirtualAttributeResponse addSchemasItem(EnumfileBasedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumfileBasedVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumfileBasedVirtualAttributeSchemaUrn> schemas) {
  ...
  public FileBasedVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse sourceAttribute(String sourceAttribute) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the name or OID of the attribute which specifies the path to the file from which the value should be retrieved. If this attribute is multivalued, then the attribute specified in the attribute-type property must also be multivalued.")
  ...
  public FileBasedVirtualAttributeResponse dataDirectory(String dataDirectory) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the path to the directory in which the data files exist. Paths to data files will be relative to this directory, and only data files contained in this directory will be used. This directory must exist.")
  ...
  public FileBasedVirtualAttributeResponse maxFileSize(String maxFileSize) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the maximum file size for data files that will be allowed. A value of zero bytes indicates that there will not be any limit.")
  ...
  public FileBasedVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public FileBasedVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public FileBasedVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse filter(List<String> filter) {
  ...
  public FileBasedVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public FileBasedVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedVirtualAttributeResponse instance itself
   */
  public FileBasedVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedVirtualAttributeResponse fileBasedVirtualAttributeResponse = (FileBasedVirtualAttributeResponse) o;
    return Objects.equals(this.description, fileBasedVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, fileBasedVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, fileBasedVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, fileBasedVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.sourceAttribute, fileBasedVirtualAttributeResponse.sourceAttribute) &&
        Objects.equals(this.dataDirectory, fileBasedVirtualAttributeResponse.dataDirectory) &&
        Objects.equals(this.maxFileSize, fileBasedVirtualAttributeResponse.maxFileSize) &&
        Objects.equals(this.enabled, fileBasedVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, fileBasedVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, fileBasedVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, fileBasedVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, fileBasedVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, fileBasedVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, fileBasedVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, fileBasedVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, fileBasedVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, fileBasedVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, fileBasedVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, sourceAttribute, dataDirectory, maxFileSize, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedVirtualAttributeResponse {\n");
    ...
    sb.append("    dataDirectory: ").append(toIndentedString(dataDirectory)).append("\n");
  ...
  static {
    ...
    openapiFields.add("dataDirectory");
    ...
    openapiRequiredFields.add("dataDirectory");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedVirtualAttributeResponse is not found in the empty JSON string", FileBasedVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedVirtualAttributeResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("dataDirectory").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `dataDirectory` to be a primitive type in the JSON string but got `%s`", jsonObj.get("dataDirectory").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public FileBasedVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedVirtualAttributeResponse
  */
  public static FileBasedVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of FileBasedVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
