...
public class PeriodicStatsLoggerPluginResponse {
  ...
  public PeriodicStatsLoggerPluginResponse() {
  }

  public PeriodicStatsLoggerPluginResponse id(String id) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse description(String description) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse schemas(List<EnumperiodicStatsLoggerPluginSchemaUrn> schemas) {
  ...
  public PeriodicStatsLoggerPluginResponse addSchemasItem(EnumperiodicStatsLoggerPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse logInterval(String logInterval) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The duration between statistics collection and logging. A new line is logged to the output for each interval. Setting this value too small can have an impact on performance.")
  ...
  public PeriodicStatsLoggerPluginResponse collectionInterval(String collectionInterval) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Some of the calculated statistics, such as the average and maximum queue sizes, can use multiple samples within a log interval. This value controls how often samples are gathered. It should be a multiple of the log-interval.")
  ...
  public PeriodicStatsLoggerPluginResponse suppressIfIdle(Boolean suppressIfIdle) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "If the server is idle during the specified interval, then do not log any output if this property is set to true. The server is idle if during the interval, no new connections were established, no operations were processed, and no operations are pending.")
  ...
  public PeriodicStatsLoggerPluginResponse headerPrefixPerColumn(Boolean headerPrefixPerColumn) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse emptyInsteadOfZero(Boolean emptyInsteadOfZero) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse linesBetweenHeader(Integer linesBetweenHeader) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The number of lines to log between logging the header line that summarizes the columns in the table.")
  ...
  public PeriodicStatsLoggerPluginResponse includedLDAPStat(List<EnumpluginIncludedLDAPStatProp> includedLDAPStat) {
  ...
  public PeriodicStatsLoggerPluginResponse addIncludedLDAPStatItem(EnumpluginIncludedLDAPStatProp includedLDAPStatItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse includedResourceStat(List<EnumpluginIncludedResourceStatProp> includedResourceStat) {
  ...
  public PeriodicStatsLoggerPluginResponse addIncludedResourceStatItem(EnumpluginIncludedResourceStatProp includedResourceStatItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse histogramFormat(EnumpluginHistogramFormatProp histogramFormat) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse histogramOpType(List<EnumpluginHistogramOpTypeProp> histogramOpType) {
  ...
  public PeriodicStatsLoggerPluginResponse addHistogramOpTypeItem(EnumpluginHistogramOpTypeProp histogramOpTypeItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse perApplicationLDAPStats(EnumpluginPeriodicStatsLoggerPerApplicationLDAPStatsProp perApplicationLDAPStats) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse statusSummaryInfo(EnumpluginStatusSummaryInfoProp statusSummaryInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse ldapChangelogInfo(EnumpluginLdapChangelogInfoProp ldapChangelogInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse gaugeInfo(EnumpluginGaugeInfoProp gaugeInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse logFileFormat(EnumpluginLogFileFormatProp logFileFormat) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse logFile(String logFile) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Periodic Stats Logger Plugin.")
  ...
  public PeriodicStatsLoggerPluginResponse append(Boolean append) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public PeriodicStatsLoggerPluginResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Periodic Stats Logger Plugin .")
  ...
  public PeriodicStatsLoggerPluginResponse rotationListener(List<String> rotationListener) {
  ...
  public PeriodicStatsLoggerPluginResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public PeriodicStatsLoggerPluginResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Periodic Stats Logger Plugin .")
  ...
  public PeriodicStatsLoggerPluginResponse loggingErrorBehavior(EnumpluginLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse localDBBackendInfo(EnumpluginLocalDBBackendInfoProp localDBBackendInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse replicationInfo(EnumpluginReplicationInfoProp replicationInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse entryCacheInfo(EnumpluginEntryCacheInfoProp entryCacheInfo) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse hostInfo(List<EnumpluginHostInfoProp> hostInfo) {
  ...
  public PeriodicStatsLoggerPluginResponse addHostInfoItem(EnumpluginHostInfoProp hostInfoItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse includedLDAPApplication(List<String> includedLDAPApplication) {
  ...
  public PeriodicStatsLoggerPluginResponse addIncludedLDAPApplicationItem(String includedLDAPApplicationItem) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PeriodicStatsLoggerPluginResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PeriodicStatsLoggerPluginResponse instance itself
   */
  public PeriodicStatsLoggerPluginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeriodicStatsLoggerPluginResponse periodicStatsLoggerPluginResponse = (PeriodicStatsLoggerPluginResponse) o;
    return Objects.equals(this.id, periodicStatsLoggerPluginResponse.id) &&
        Objects.equals(this.description, periodicStatsLoggerPluginResponse.description) &&
        Objects.equals(this.schemas, periodicStatsLoggerPluginResponse.schemas) &&
        Objects.equals(this.logInterval, periodicStatsLoggerPluginResponse.logInterval) &&
        Objects.equals(this.collectionInterval, periodicStatsLoggerPluginResponse.collectionInterval) &&
        Objects.equals(this.suppressIfIdle, periodicStatsLoggerPluginResponse.suppressIfIdle) &&
        Objects.equals(this.headerPrefixPerColumn, periodicStatsLoggerPluginResponse.headerPrefixPerColumn) &&
        Objects.equals(this.emptyInsteadOfZero, periodicStatsLoggerPluginResponse.emptyInsteadOfZero) &&
        Objects.equals(this.linesBetweenHeader, periodicStatsLoggerPluginResponse.linesBetweenHeader) &&
        Objects.equals(this.includedLDAPStat, periodicStatsLoggerPluginResponse.includedLDAPStat) &&
        Objects.equals(this.includedResourceStat, periodicStatsLoggerPluginResponse.includedResourceStat) &&
        Objects.equals(this.histogramFormat, periodicStatsLoggerPluginResponse.histogramFormat) &&
        Objects.equals(this.histogramOpType, periodicStatsLoggerPluginResponse.histogramOpType) &&
        Objects.equals(this.perApplicationLDAPStats, periodicStatsLoggerPluginResponse.perApplicationLDAPStats) &&
        Objects.equals(this.statusSummaryInfo, periodicStatsLoggerPluginResponse.statusSummaryInfo) &&
        Objects.equals(this.ldapChangelogInfo, periodicStatsLoggerPluginResponse.ldapChangelogInfo) &&
        Objects.equals(this.gaugeInfo, periodicStatsLoggerPluginResponse.gaugeInfo) &&
        Objects.equals(this.logFileFormat, periodicStatsLoggerPluginResponse.logFileFormat) &&
        Objects.equals(this.logFile, periodicStatsLoggerPluginResponse.logFile) &&
        Objects.equals(this.logFilePermissions, periodicStatsLoggerPluginResponse.logFilePermissions) &&
        Objects.equals(this.append, periodicStatsLoggerPluginResponse.append) &&
        Objects.equals(this.rotationPolicy, periodicStatsLoggerPluginResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, periodicStatsLoggerPluginResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, periodicStatsLoggerPluginResponse.retentionPolicy) &&
        Objects.equals(this.loggingErrorBehavior, periodicStatsLoggerPluginResponse.loggingErrorBehavior) &&
        Objects.equals(this.localDBBackendInfo, periodicStatsLoggerPluginResponse.localDBBackendInfo) &&
        Objects.equals(this.replicationInfo, periodicStatsLoggerPluginResponse.replicationInfo) &&
        Objects.equals(this.entryCacheInfo, periodicStatsLoggerPluginResponse.entryCacheInfo) &&
        Objects.equals(this.hostInfo, periodicStatsLoggerPluginResponse.hostInfo) &&
        Objects.equals(this.includedLDAPApplication, periodicStatsLoggerPluginResponse.includedLDAPApplication) &&
        Objects.equals(this.enabled, periodicStatsLoggerPluginResponse.enabled) &&
        Objects.equals(this.meta, periodicStatsLoggerPluginResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, periodicStatsLoggerPluginResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, periodicStatsLoggerPluginResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logInterval, collectionInterval, suppressIfIdle, headerPrefixPerColumn, emptyInsteadOfZero, linesBetweenHeader, includedLDAPStat, includedResourceStat, histogramFormat, histogramOpType, perApplicationLDAPStats, statusSummaryInfo, ldapChangelogInfo, gaugeInfo, logFileFormat, logFile, logFilePermissions, append, rotationPolicy, rotationListener, retentionPolicy, loggingErrorBehavior, localDBBackendInfo, replicationInfo, entryCacheInfo, hostInfo, includedLDAPApplication, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PeriodicStatsLoggerPluginResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("collectionInterval");
    openapiRequiredFields.add("suppressIfIdle");
    openapiRequiredFields.add("linesBetweenHeader");
    openapiRequiredFields.add("histogramFormat");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeriodicStatsLoggerPluginResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeriodicStatsLoggerPluginResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PeriodicStatsLoggerPluginResponse is not found in the empty JSON string", PeriodicStatsLoggerPluginResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PeriodicStatsLoggerPluginResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("collectionInterval").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeriodicStatsLoggerPluginResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeriodicStatsLoggerPluginResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeriodicStatsLoggerPluginResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeriodicStatsLoggerPluginResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PeriodicStatsLoggerPluginResponse>() {
           @Override
           public void write(JsonWriter out, PeriodicStatsLoggerPluginResponse value) throws IOException {
           ...
           @Override
           public PeriodicStatsLoggerPluginResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PeriodicStatsLoggerPluginResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PeriodicStatsLoggerPluginResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PeriodicStatsLoggerPluginResponse
  * @throws IOException if the JSON string is invalid with respect to PeriodicStatsLoggerPluginResponse
  */
  public static PeriodicStatsLoggerPluginResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeriodicStatsLoggerPluginResponse.class);
  }

 /**
  * Convert an instance of PeriodicStatsLoggerPluginResponse to an JSON string
  *
  * @return JSON string
  */
