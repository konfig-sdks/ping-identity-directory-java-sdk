...
public class CollectSupportDataRecurringTaskShared {
  ...
  public CollectSupportDataRecurringTaskShared() {
  }

  public CollectSupportDataRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared schemas(List<EnumcollectSupportDataRecurringTaskSchemaUrn> schemas) {
  ...
  public CollectSupportDataRecurringTaskShared addSchemasItem(EnumcollectSupportDataRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared outputDirectory(String outputDirectory) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared encryptionPassphraseFile(String encryptionPassphraseFile) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared includeExpensiveData(Boolean includeExpensiveData) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared includeReplicationStateDump(Boolean includeReplicationStateDump) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared includeBinaryFiles(Boolean includeBinaryFiles) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared includeExtensionSource(Boolean includeExtensionSource) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared useSequentialMode(Boolean useSequentialMode) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared securityLevel(EnumrecurringTaskSecurityLevelProp securityLevel) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared jstackCount(Integer jstackCount) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared reportCount(Integer reportCount) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared reportIntervalSeconds(Integer reportIntervalSeconds) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared logDuration(String logDuration) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared logFileHeadCollectionSize(String logFileHeadCollectionSize) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared logFileTailCollectionSize(String logFileTailCollectionSize) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared comment(String comment) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared retainPreviousSupportDataArchiveCount(Integer retainPreviousSupportDataArchiveCount) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared retainPreviousSupportDataArchiveAge(String retainPreviousSupportDataArchiveAge) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public CollectSupportDataRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public CollectSupportDataRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public CollectSupportDataRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public CollectSupportDataRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the CollectSupportDataRecurringTaskShared instance itself
   */
  public CollectSupportDataRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CollectSupportDataRecurringTaskShared collectSupportDataRecurringTaskShared = (CollectSupportDataRecurringTaskShared) o;
    return Objects.equals(this.description, collectSupportDataRecurringTaskShared.description) &&
        Objects.equals(this.schemas, collectSupportDataRecurringTaskShared.schemas) &&
        Objects.equals(this.outputDirectory, collectSupportDataRecurringTaskShared.outputDirectory) &&
        Objects.equals(this.encryptionPassphraseFile, collectSupportDataRecurringTaskShared.encryptionPassphraseFile) &&
        Objects.equals(this.includeExpensiveData, collectSupportDataRecurringTaskShared.includeExpensiveData) &&
        Objects.equals(this.includeReplicationStateDump, collectSupportDataRecurringTaskShared.includeReplicationStateDump) &&
        Objects.equals(this.includeBinaryFiles, collectSupportDataRecurringTaskShared.includeBinaryFiles) &&
        Objects.equals(this.includeExtensionSource, collectSupportDataRecurringTaskShared.includeExtensionSource) &&
        Objects.equals(this.useSequentialMode, collectSupportDataRecurringTaskShared.useSequentialMode) &&
        Objects.equals(this.securityLevel, collectSupportDataRecurringTaskShared.securityLevel) &&
        Objects.equals(this.jstackCount, collectSupportDataRecurringTaskShared.jstackCount) &&
        Objects.equals(this.reportCount, collectSupportDataRecurringTaskShared.reportCount) &&
        Objects.equals(this.reportIntervalSeconds, collectSupportDataRecurringTaskShared.reportIntervalSeconds) &&
        Objects.equals(this.logDuration, collectSupportDataRecurringTaskShared.logDuration) &&
        Objects.equals(this.logFileHeadCollectionSize, collectSupportDataRecurringTaskShared.logFileHeadCollectionSize) &&
        Objects.equals(this.logFileTailCollectionSize, collectSupportDataRecurringTaskShared.logFileTailCollectionSize) &&
        Objects.equals(this.comment, collectSupportDataRecurringTaskShared.comment) &&
        Objects.equals(this.retainPreviousSupportDataArchiveCount, collectSupportDataRecurringTaskShared.retainPreviousSupportDataArchiveCount) &&
        Objects.equals(this.retainPreviousSupportDataArchiveAge, collectSupportDataRecurringTaskShared.retainPreviousSupportDataArchiveAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, collectSupportDataRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, collectSupportDataRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, collectSupportDataRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, collectSupportDataRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, collectSupportDataRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, collectSupportDataRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, collectSupportDataRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, collectSupportDataRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, outputDirectory, encryptionPassphraseFile, includeExpensiveData, includeReplicationStateDump, includeBinaryFiles, includeExtensionSource, useSequentialMode, securityLevel, jstackCount, reportCount, reportIntervalSeconds, logDuration, logFileHeadCollectionSize, logFileTailCollectionSize, comment, retainPreviousSupportDataArchiveCount, retainPreviousSupportDataArchiveAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CollectSupportDataRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectSupportDataRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectSupportDataRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CollectSupportDataRecurringTaskShared is not found in the empty JSON string", CollectSupportDataRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CollectSupportDataRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CollectSupportDataRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CollectSupportDataRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CollectSupportDataRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CollectSupportDataRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<CollectSupportDataRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, CollectSupportDataRecurringTaskShared value) throws IOException {
           ...
           @Override
           public CollectSupportDataRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CollectSupportDataRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CollectSupportDataRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CollectSupportDataRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to CollectSupportDataRecurringTaskShared
  */
  public static CollectSupportDataRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CollectSupportDataRecurringTaskShared.class);
  }

 /**
  * Convert an instance of CollectSupportDataRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
