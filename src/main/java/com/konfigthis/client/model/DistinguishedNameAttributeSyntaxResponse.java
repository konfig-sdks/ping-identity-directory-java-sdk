...
import com.konfigthis.client.model.EnumdistinguishedNameAttributeSyntaxSchemaUrn;
...
public class DistinguishedNameAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public DistinguishedNameAttributeSyntaxResponse() {
  }

  public DistinguishedNameAttributeSyntaxResponse schemas(List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> schemas) {
  ...
  public DistinguishedNameAttributeSyntaxResponse addSchemasItem(EnumdistinguishedNameAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> schemas) {
  ...
  public DistinguishedNameAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public DistinguishedNameAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public DistinguishedNameAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DistinguishedNameAttributeSyntaxResponse instance itself
   */
  public DistinguishedNameAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DistinguishedNameAttributeSyntaxResponse distinguishedNameAttributeSyntaxResponse = (DistinguishedNameAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, distinguishedNameAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, distinguishedNameAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, distinguishedNameAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, distinguishedNameAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, distinguishedNameAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, distinguishedNameAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, distinguishedNameAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, distinguishedNameAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, distinguishedNameAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, distinguishedNameAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DistinguishedNameAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DistinguishedNameAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DistinguishedNameAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DistinguishedNameAttributeSyntaxResponse is not found in the empty JSON string", DistinguishedNameAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DistinguishedNameAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DistinguishedNameAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DistinguishedNameAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DistinguishedNameAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DistinguishedNameAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DistinguishedNameAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, DistinguishedNameAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public DistinguishedNameAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DistinguishedNameAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DistinguishedNameAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DistinguishedNameAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to DistinguishedNameAttributeSyntaxResponse
  */
  public static DistinguishedNameAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DistinguishedNameAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of DistinguishedNameAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
