...
public class NameAndOptionalUidAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public NameAndOptionalUidAttributeSyntaxResponse() {
  }

  public NameAndOptionalUidAttributeSyntaxResponse schemas(List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponse addSchemasItem(EnumnameAndOptionalUidAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the NameAndOptionalUidAttributeSyntaxResponse instance itself
   */
  public NameAndOptionalUidAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NameAndOptionalUidAttributeSyntaxResponse nameAndOptionalUidAttributeSyntaxResponse = (NameAndOptionalUidAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, nameAndOptionalUidAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, nameAndOptionalUidAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, nameAndOptionalUidAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, nameAndOptionalUidAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, nameAndOptionalUidAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, nameAndOptionalUidAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, nameAndOptionalUidAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, nameAndOptionalUidAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, nameAndOptionalUidAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, nameAndOptionalUidAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NameAndOptionalUidAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NameAndOptionalUidAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NameAndOptionalUidAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NameAndOptionalUidAttributeSyntaxResponse is not found in the empty JSON string", NameAndOptionalUidAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NameAndOptionalUidAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NameAndOptionalUidAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NameAndOptionalUidAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NameAndOptionalUidAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NameAndOptionalUidAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NameAndOptionalUidAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, NameAndOptionalUidAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public NameAndOptionalUidAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NameAndOptionalUidAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NameAndOptionalUidAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NameAndOptionalUidAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to NameAndOptionalUidAttributeSyntaxResponse
  */
  public static NameAndOptionalUidAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NameAndOptionalUidAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of NameAndOptionalUidAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
