...
public class CharacterSetPasswordValidatorResponse {
  ...
  public CharacterSetPasswordValidatorResponse() {
  }

  public CharacterSetPasswordValidatorResponse id(String id) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse description(String description) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse schemas(List<EnumcharacterSetPasswordValidatorSchemaUrn> schemas) {
  ...
  public CharacterSetPasswordValidatorResponse addSchemasItem(EnumcharacterSetPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse characterSet(List<String> characterSet) {
  ...
  public CharacterSetPasswordValidatorResponse addCharacterSetItem(String characterSetItem) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse allowUnclassifiedCharacters(Boolean allowUnclassifiedCharacters) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse minimumRequiredCharacterSets(Integer minimumRequiredCharacterSets) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public CharacterSetPasswordValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the CharacterSetPasswordValidatorResponse instance itself
   */
  public CharacterSetPasswordValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CharacterSetPasswordValidatorResponse characterSetPasswordValidatorResponse = (CharacterSetPasswordValidatorResponse) o;
    return Objects.equals(this.id, characterSetPasswordValidatorResponse.id) &&
        Objects.equals(this.description, characterSetPasswordValidatorResponse.description) &&
        Objects.equals(this.schemas, characterSetPasswordValidatorResponse.schemas) &&
        Objects.equals(this.characterSet, characterSetPasswordValidatorResponse.characterSet) &&
        Objects.equals(this.allowUnclassifiedCharacters, characterSetPasswordValidatorResponse.allowUnclassifiedCharacters) &&
        Objects.equals(this.minimumRequiredCharacterSets, characterSetPasswordValidatorResponse.minimumRequiredCharacterSets) &&
        Objects.equals(this.enabled, characterSetPasswordValidatorResponse.enabled) &&
        Objects.equals(this.validatorRequirementDescription, characterSetPasswordValidatorResponse.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, characterSetPasswordValidatorResponse.validatorFailureMessage) &&
        Objects.equals(this.meta, characterSetPasswordValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, characterSetPasswordValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, characterSetPasswordValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, characterSet, allowUnclassifiedCharacters, minimumRequiredCharacterSets, enabled, validatorRequirementDescription, validatorFailureMessage, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CharacterSetPasswordValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CharacterSetPasswordValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CharacterSetPasswordValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CharacterSetPasswordValidatorResponse is not found in the empty JSON string", CharacterSetPasswordValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CharacterSetPasswordValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CharacterSetPasswordValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CharacterSetPasswordValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CharacterSetPasswordValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CharacterSetPasswordValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CharacterSetPasswordValidatorResponse>() {
           @Override
           public void write(JsonWriter out, CharacterSetPasswordValidatorResponse value) throws IOException {
           ...
           @Override
           public CharacterSetPasswordValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CharacterSetPasswordValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CharacterSetPasswordValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CharacterSetPasswordValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to CharacterSetPasswordValidatorResponse
  */
  public static CharacterSetPasswordValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CharacterSetPasswordValidatorResponse.class);
  }

 /**
  * Convert an instance of CharacterSetPasswordValidatorResponse to an JSON string
  *
  * @return JSON string
  */
