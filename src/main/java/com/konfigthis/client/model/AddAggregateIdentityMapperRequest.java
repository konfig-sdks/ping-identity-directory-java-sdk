...
public class AddAggregateIdentityMapperRequest {
  ...
  public AddAggregateIdentityMapperRequest() {
  }

  public AddAggregateIdentityMapperRequest mapperName(String mapperName) {
  ...
  **/
  ...
  public AddAggregateIdentityMapperRequest description(String description) {
  ...
  **/
  ...
  public AddAggregateIdentityMapperRequest schemas(List<EnumaggregateIdentityMapperSchemaUrn> schemas) {
  ...
  public AddAggregateIdentityMapperRequest addSchemasItem(EnumaggregateIdentityMapperSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAggregateIdentityMapperRequest allIncludedIdentityMapper(List<String> allIncludedIdentityMapper) {
  ...
  public AddAggregateIdentityMapperRequest addAllIncludedIdentityMapperItem(String allIncludedIdentityMapperItem) {
  ...
  **/
  ...
  public AddAggregateIdentityMapperRequest anyIncludedIdentityMapper(List<String> anyIncludedIdentityMapper) {
  ...
  public AddAggregateIdentityMapperRequest addAnyIncludedIdentityMapperItem(String anyIncludedIdentityMapperItem) {
  ...
  **/
  ...
  public AddAggregateIdentityMapperRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddAggregateIdentityMapperRequest instance itself
   */
  public AddAggregateIdentityMapperRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAggregateIdentityMapperRequest addAggregateIdentityMapperRequest = (AddAggregateIdentityMapperRequest) o;
    return Objects.equals(this.mapperName, addAggregateIdentityMapperRequest.mapperName) &&
        Objects.equals(this.description, addAggregateIdentityMapperRequest.description) &&
        Objects.equals(this.schemas, addAggregateIdentityMapperRequest.schemas) &&
        Objects.equals(this.allIncludedIdentityMapper, addAggregateIdentityMapperRequest.allIncludedIdentityMapper) &&
        Objects.equals(this.anyIncludedIdentityMapper, addAggregateIdentityMapperRequest.anyIncludedIdentityMapper) &&
        Objects.equals(this.enabled, addAggregateIdentityMapperRequest.enabled)&&
        Objects.equals(this.additionalProperties, addAggregateIdentityMapperRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mapperName, description, schemas, allIncludedIdentityMapper, anyIncludedIdentityMapper, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAggregateIdentityMapperRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAggregateIdentityMapperRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAggregateIdentityMapperRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAggregateIdentityMapperRequest is not found in the empty JSON string", AddAggregateIdentityMapperRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAggregateIdentityMapperRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAggregateIdentityMapperRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAggregateIdentityMapperRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAggregateIdentityMapperRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAggregateIdentityMapperRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAggregateIdentityMapperRequest>() {
           @Override
           public void write(JsonWriter out, AddAggregateIdentityMapperRequest value) throws IOException {
           ...
           @Override
           public AddAggregateIdentityMapperRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAggregateIdentityMapperRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAggregateIdentityMapperRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAggregateIdentityMapperRequest
  * @throws IOException if the JSON string is invalid with respect to AddAggregateIdentityMapperRequest
  */
  public static AddAggregateIdentityMapperRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAggregateIdentityMapperRequest.class);
  }

 /**
  * Convert an instance of AddAggregateIdentityMapperRequest to an JSON string
  *
  * @return JSON string
  */
