...
public class SyncServerInstanceResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumsyncServerInstanceSchemaUrn> schemas = null;
  ...
  public SyncServerInstanceResponseAllOf() {
  }

  public SyncServerInstanceResponseAllOf schemas(List<EnumsyncServerInstanceSchemaUrn> schemas) {
  ...
  public SyncServerInstanceResponseAllOf addSchemasItem(EnumsyncServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf id(String id) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf clusterName(String clusterName) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf hostname(String hostname) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf serverRoot(String serverRoot) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf serverVersion(String serverVersion) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf httpPort(Integer httpPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public SyncServerInstanceResponseAllOf addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf baseDN(List<String> baseDN) {
  ...
  public SyncServerInstanceResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public SyncServerInstanceResponseAllOf memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public SyncServerInstanceResponseAllOf addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
   ...
   * @return the SyncServerInstanceResponseAllOf instance itself
   */
  public SyncServerInstanceResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncServerInstanceResponseAllOf syncServerInstanceResponseAllOf = (SyncServerInstanceResponseAllOf) o;
    return Objects.equals(this.schemas, syncServerInstanceResponseAllOf.schemas) &&
        Objects.equals(this.id, syncServerInstanceResponseAllOf.id) &&
        Objects.equals(this.serverInstanceType, syncServerInstanceResponseAllOf.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, syncServerInstanceResponseAllOf.serverInstanceName) &&
        Objects.equals(this.clusterName, syncServerInstanceResponseAllOf.clusterName) &&
        Objects.equals(this.serverInstanceLocation, syncServerInstanceResponseAllOf.serverInstanceLocation) &&
        Objects.equals(this.hostname, syncServerInstanceResponseAllOf.hostname) &&
        Objects.equals(this.serverRoot, syncServerInstanceResponseAllOf.serverRoot) &&
        Objects.equals(this.serverVersion, syncServerInstanceResponseAllOf.serverVersion) &&
        Objects.equals(this.interServerCertificate, syncServerInstanceResponseAllOf.interServerCertificate) &&
        Objects.equals(this.ldapPort, syncServerInstanceResponseAllOf.ldapPort) &&
        Objects.equals(this.ldapsPort, syncServerInstanceResponseAllOf.ldapsPort) &&
        Objects.equals(this.httpPort, syncServerInstanceResponseAllOf.httpPort) &&
        Objects.equals(this.httpsPort, syncServerInstanceResponseAllOf.httpsPort) &&
        Objects.equals(this.replicationPort, syncServerInstanceResponseAllOf.replicationPort) &&
        Objects.equals(this.replicationServerID, syncServerInstanceResponseAllOf.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, syncServerInstanceResponseAllOf.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, syncServerInstanceResponseAllOf.jmxPort) &&
        Objects.equals(this.jmxsPort, syncServerInstanceResponseAllOf.jmxsPort) &&
        Objects.equals(this.preferredSecurity, syncServerInstanceResponseAllOf.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, syncServerInstanceResponseAllOf.startTLSEnabled) &&
        Objects.equals(this.baseDN, syncServerInstanceResponseAllOf.baseDN) &&
        Objects.equals(this.memberOfServerGroup, syncServerInstanceResponseAllOf.memberOfServerGroup)&&
        Objects.equals(this.additionalProperties, syncServerInstanceResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncServerInstanceResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncServerInstanceResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncServerInstanceResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncServerInstanceResponseAllOf is not found in the empty JSON string", SyncServerInstanceResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncServerInstanceResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncServerInstanceResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncServerInstanceResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncServerInstanceResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncServerInstanceResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SyncServerInstanceResponseAllOf value) throws IOException {
           ...
           @Override
           public SyncServerInstanceResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncServerInstanceResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncServerInstanceResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncServerInstanceResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SyncServerInstanceResponseAllOf
  */
  public static SyncServerInstanceResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncServerInstanceResponseAllOf.class);
  }

 /**
  * Convert an instance of SyncServerInstanceResponseAllOf to an JSON string
  *
  * @return JSON string
  */
