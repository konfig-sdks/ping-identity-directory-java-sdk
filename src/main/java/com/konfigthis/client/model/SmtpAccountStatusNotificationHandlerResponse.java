...
public class SmtpAccountStatusNotificationHandlerResponse {
  ...
  public SmtpAccountStatusNotificationHandlerResponse() {
  }

  public SmtpAccountStatusNotificationHandlerResponse id(String id) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse description(String description) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse schemas(List<EnumsmtpAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public SmtpAccountStatusNotificationHandlerResponse addSchemasItem(EnumsmtpAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse emailAddressAttributeType(List<String> emailAddressAttributeType) {
  ...
  public SmtpAccountStatusNotificationHandlerResponse addEmailAddressAttributeTypeItem(String emailAddressAttributeTypeItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse emailAddressJSONField(String emailAddressJSONField) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse emailAddressJSONObjectFilter(String emailAddressJSONObjectFilter) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse recipientAddress(List<String> recipientAddress) {
  ...
  public SmtpAccountStatusNotificationHandlerResponse addRecipientAddressItem(String recipientAddressItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse sendMessageWithoutEndUserAddress(Boolean sendMessageWithoutEndUserAddress) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether an email notification message should be generated and sent to the set of notification recipients even if the user entry does not contain any values for any of the email address attributes (that is, in cases when it is not possible to notify the end user).")
  ...
  public SmtpAccountStatusNotificationHandlerResponse senderAddress(String senderAddress) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse messageSubject(List<String> messageSubject) {
  ...
  public SmtpAccountStatusNotificationHandlerResponse addMessageSubjectItem(String messageSubjectItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse messageTemplateFile(List<String> messageTemplateFile) {
  ...
  public SmtpAccountStatusNotificationHandlerResponse addMessageTemplateFileItem(String messageTemplateFileItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SmtpAccountStatusNotificationHandlerResponse instance itself
   */
  public SmtpAccountStatusNotificationHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpAccountStatusNotificationHandlerResponse smtpAccountStatusNotificationHandlerResponse = (SmtpAccountStatusNotificationHandlerResponse) o;
    return Objects.equals(this.id, smtpAccountStatusNotificationHandlerResponse.id) &&
        Objects.equals(this.description, smtpAccountStatusNotificationHandlerResponse.description) &&
        Objects.equals(this.schemas, smtpAccountStatusNotificationHandlerResponse.schemas) &&
        Objects.equals(this.emailAddressAttributeType, smtpAccountStatusNotificationHandlerResponse.emailAddressAttributeType) &&
        Objects.equals(this.emailAddressJSONField, smtpAccountStatusNotificationHandlerResponse.emailAddressJSONField) &&
        Objects.equals(this.emailAddressJSONObjectFilter, smtpAccountStatusNotificationHandlerResponse.emailAddressJSONObjectFilter) &&
        Objects.equals(this.recipientAddress, smtpAccountStatusNotificationHandlerResponse.recipientAddress) &&
        Objects.equals(this.sendMessageWithoutEndUserAddress, smtpAccountStatusNotificationHandlerResponse.sendMessageWithoutEndUserAddress) &&
        Objects.equals(this.senderAddress, smtpAccountStatusNotificationHandlerResponse.senderAddress) &&
        Objects.equals(this.messageSubject, smtpAccountStatusNotificationHandlerResponse.messageSubject) &&
        Objects.equals(this.messageTemplateFile, smtpAccountStatusNotificationHandlerResponse.messageTemplateFile) &&
        Objects.equals(this.enabled, smtpAccountStatusNotificationHandlerResponse.enabled) &&
        Objects.equals(this.asynchronous, smtpAccountStatusNotificationHandlerResponse.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, smtpAccountStatusNotificationHandlerResponse.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, smtpAccountStatusNotificationHandlerResponse.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, smtpAccountStatusNotificationHandlerResponse.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, smtpAccountStatusNotificationHandlerResponse.accountUpdateNotificationRequestCriteria) &&
        Objects.equals(this.meta, smtpAccountStatusNotificationHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, smtpAccountStatusNotificationHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, smtpAccountStatusNotificationHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, emailAddressAttributeType, emailAddressJSONField, emailAddressJSONObjectFilter, recipientAddress, sendMessageWithoutEndUserAddress, senderAddress, messageSubject, messageTemplateFile, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmtpAccountStatusNotificationHandlerResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("sendMessageWithoutEndUserAddress");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmtpAccountStatusNotificationHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmtpAccountStatusNotificationHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpAccountStatusNotificationHandlerResponse is not found in the empty JSON string", SmtpAccountStatusNotificationHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmtpAccountStatusNotificationHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpAccountStatusNotificationHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpAccountStatusNotificationHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpAccountStatusNotificationHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpAccountStatusNotificationHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpAccountStatusNotificationHandlerResponse>() {
           @Override
           public void write(JsonWriter out, SmtpAccountStatusNotificationHandlerResponse value) throws IOException {
           ...
           @Override
           public SmtpAccountStatusNotificationHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SmtpAccountStatusNotificationHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SmtpAccountStatusNotificationHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmtpAccountStatusNotificationHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to SmtpAccountStatusNotificationHandlerResponse
  */
  public static SmtpAccountStatusNotificationHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpAccountStatusNotificationHandlerResponse.class);
  }

 /**
  * Convert an instance of SmtpAccountStatusNotificationHandlerResponse to an JSON string
  *
  * @return JSON string
  */
