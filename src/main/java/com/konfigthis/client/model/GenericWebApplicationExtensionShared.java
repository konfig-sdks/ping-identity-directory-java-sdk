...
public class GenericWebApplicationExtensionShared {
  ...
  public GenericWebApplicationExtensionShared() {
  }

  public GenericWebApplicationExtensionShared description(String description) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared schemas(List<EnumgenericWebApplicationExtensionSchemaUrn> schemas) {
  ...
  public GenericWebApplicationExtensionShared addSchemasItem(EnumgenericWebApplicationExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared warFile(String warFile) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared documentRootDirectory(String documentRootDirectory) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared deploymentDescriptorFile(String deploymentDescriptorFile) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared temporaryDirectory(String temporaryDirectory) {
  ...
  **/
  ...
  public GenericWebApplicationExtensionShared initParameter(List<String> initParameter) {
  ...
  public GenericWebApplicationExtensionShared addInitParameterItem(String initParameterItem) {
  ...
  **/
   ...
   * @return the GenericWebApplicationExtensionShared instance itself
   */
  public GenericWebApplicationExtensionShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenericWebApplicationExtensionShared genericWebApplicationExtensionShared = (GenericWebApplicationExtensionShared) o;
    return Objects.equals(this.description, genericWebApplicationExtensionShared.description) &&
        Objects.equals(this.schemas, genericWebApplicationExtensionShared.schemas) &&
        Objects.equals(this.baseContextPath, genericWebApplicationExtensionShared.baseContextPath) &&
        Objects.equals(this.warFile, genericWebApplicationExtensionShared.warFile) &&
        Objects.equals(this.documentRootDirectory, genericWebApplicationExtensionShared.documentRootDirectory) &&
        Objects.equals(this.deploymentDescriptorFile, genericWebApplicationExtensionShared.deploymentDescriptorFile) &&
        Objects.equals(this.temporaryDirectory, genericWebApplicationExtensionShared.temporaryDirectory) &&
        Objects.equals(this.initParameter, genericWebApplicationExtensionShared.initParameter)&&
        Objects.equals(this.additionalProperties, genericWebApplicationExtensionShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, baseContextPath, warFile, documentRootDirectory, deploymentDescriptorFile, temporaryDirectory, initParameter, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenericWebApplicationExtensionShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericWebApplicationExtensionShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericWebApplicationExtensionShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericWebApplicationExtensionShared is not found in the empty JSON string", GenericWebApplicationExtensionShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenericWebApplicationExtensionShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenericWebApplicationExtensionShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenericWebApplicationExtensionShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenericWebApplicationExtensionShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenericWebApplicationExtensionShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GenericWebApplicationExtensionShared>() {
           @Override
           public void write(JsonWriter out, GenericWebApplicationExtensionShared value) throws IOException {
           ...
           @Override
           public GenericWebApplicationExtensionShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenericWebApplicationExtensionShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenericWebApplicationExtensionShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenericWebApplicationExtensionShared
  * @throws IOException if the JSON string is invalid with respect to GenericWebApplicationExtensionShared
  */
  public static GenericWebApplicationExtensionShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericWebApplicationExtensionShared.class);
  }

 /**
  * Convert an instance of GenericWebApplicationExtensionShared to an JSON string
  *
  * @return JSON string
  */
