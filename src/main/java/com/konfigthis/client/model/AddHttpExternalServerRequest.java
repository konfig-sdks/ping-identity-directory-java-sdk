...
public class AddHttpExternalServerRequest {
  ...
  public AddHttpExternalServerRequest() {
  }

  public AddHttpExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest schemas(List<EnumhttpExternalServerSchemaUrn> schemas) {
  ...
  public AddHttpExternalServerRequest addSchemasItem(EnumhttpExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest baseURL(String baseURL) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest hostnameVerificationMethod(EnumexternalServerHttpHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddHttpExternalServerRequest responseTimeout(String responseTimeout) {
  ...
  **/
   ...
   * @return the AddHttpExternalServerRequest instance itself
   */
  public AddHttpExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddHttpExternalServerRequest addHttpExternalServerRequest = (AddHttpExternalServerRequest) o;
    return Objects.equals(this.serverName, addHttpExternalServerRequest.serverName) &&
        Objects.equals(this.description, addHttpExternalServerRequest.description) &&
        Objects.equals(this.schemas, addHttpExternalServerRequest.schemas) &&
        Objects.equals(this.baseURL, addHttpExternalServerRequest.baseURL) &&
        Objects.equals(this.hostnameVerificationMethod, addHttpExternalServerRequest.hostnameVerificationMethod) &&
        Objects.equals(this.keyManagerProvider, addHttpExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addHttpExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.sslCertNickname, addHttpExternalServerRequest.sslCertNickname) &&
        Objects.equals(this.connectTimeout, addHttpExternalServerRequest.connectTimeout) &&
        Objects.equals(this.responseTimeout, addHttpExternalServerRequest.responseTimeout)&&
        Objects.equals(this.additionalProperties, addHttpExternalServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, description, schemas, baseURL, hostnameVerificationMethod, keyManagerProvider, trustManagerProvider, sslCertNickname, connectTimeout, responseTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddHttpExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddHttpExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddHttpExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHttpExternalServerRequest is not found in the empty JSON string", AddHttpExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddHttpExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHttpExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHttpExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHttpExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHttpExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHttpExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddHttpExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddHttpExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddHttpExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddHttpExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddHttpExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddHttpExternalServerRequest
  */
  public static AddHttpExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHttpExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddHttpExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
