...
public class FileBasedSyncLogPublisherResponseAllOf {
  ...
  private List<EnumfileBasedSyncLogPublisherSchemaUrn> schemas = null;
  ...
  public FileBasedSyncLogPublisherResponseAllOf() {
  }

  public FileBasedSyncLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf schemas(List<EnumfileBasedSyncLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addSchemasItem(EnumfileBasedSyncLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The file name to use for the log files generated by the File Based Sync Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public FileBasedSyncLogPublisherResponseAllOf logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this File Based Sync Log Publisher.")
  ...
  public FileBasedSyncLogPublisherResponseAllOf rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the File Based Sync Log Publisher .")
  ...
  public FileBasedSyncLogPublisherResponseAllOf rotationListener(List<String> rotationListener) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the File Based Sync Log Publisher .")
  ...
  public FileBasedSyncLogPublisherResponseAllOf compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf append(Boolean append) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the File Based Sync Log Publisher will publish records asynchronously.")
  ...
  public FileBasedSyncLogPublisherResponseAllOf autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf loggedMessageType(List<EnumlogPublisherLoggedMessageTypeProp> loggedMessageType) {
  ...
  public FileBasedSyncLogPublisherResponseAllOf addLoggedMessageTypeItem(EnumlogPublisherLoggedMessageTypeProp loggedMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the FileBasedSyncLogPublisherResponseAllOf instance itself
   */
  public FileBasedSyncLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedSyncLogPublisherResponseAllOf fileBasedSyncLogPublisherResponseAllOf = (FileBasedSyncLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, fileBasedSyncLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, fileBasedSyncLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, fileBasedSyncLogPublisherResponseAllOf.id) &&
        Objects.equals(this.logFile, fileBasedSyncLogPublisherResponseAllOf.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedSyncLogPublisherResponseAllOf.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedSyncLogPublisherResponseAllOf.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedSyncLogPublisherResponseAllOf.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedSyncLogPublisherResponseAllOf.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedSyncLogPublisherResponseAllOf.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedSyncLogPublisherResponseAllOf.signLog) &&
        Objects.equals(this.encryptLog, fileBasedSyncLogPublisherResponseAllOf.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedSyncLogPublisherResponseAllOf.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedSyncLogPublisherResponseAllOf.append) &&
        Objects.equals(this.asynchronous, fileBasedSyncLogPublisherResponseAllOf.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedSyncLogPublisherResponseAllOf.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedSyncLogPublisherResponseAllOf.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedSyncLogPublisherResponseAllOf.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedSyncLogPublisherResponseAllOf.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedSyncLogPublisherResponseAllOf.timestampPrecision) &&
        Objects.equals(this.includeSyncPipe, fileBasedSyncLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.loggedMessageType, fileBasedSyncLogPublisherResponseAllOf.loggedMessageType) &&
        Objects.equals(this.enabled, fileBasedSyncLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedSyncLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, fileBasedSyncLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, includeSyncPipe, loggedMessageType, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedSyncLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedSyncLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedSyncLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedSyncLogPublisherResponseAllOf is not found in the empty JSON string", FileBasedSyncLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedSyncLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedSyncLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedSyncLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedSyncLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedSyncLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, FileBasedSyncLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public FileBasedSyncLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedSyncLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedSyncLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedSyncLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to FileBasedSyncLogPublisherResponseAllOf
  */
  public static FileBasedSyncLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedSyncLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of FileBasedSyncLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
