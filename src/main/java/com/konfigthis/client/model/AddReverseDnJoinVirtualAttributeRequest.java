...
public class AddReverseDnJoinVirtualAttributeRequest {
  ...
  public AddReverseDnJoinVirtualAttributeRequest() {
  }

  public AddReverseDnJoinVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest schemas(List<EnumreverseDnJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addSchemasItem(EnumreverseDnJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinDNAttribute(String joinDNAttribute) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinFilter(String joinFilter) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest joinAttribute(List<String> joinAttribute) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddReverseDnJoinVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddReverseDnJoinVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddReverseDnJoinVirtualAttributeRequest instance itself
   */
  public AddReverseDnJoinVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddReverseDnJoinVirtualAttributeRequest addReverseDnJoinVirtualAttributeRequest = (AddReverseDnJoinVirtualAttributeRequest) o;
    return Objects.equals(this.name, addReverseDnJoinVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addReverseDnJoinVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addReverseDnJoinVirtualAttributeRequest.schemas) &&
        Objects.equals(this.joinDNAttribute, addReverseDnJoinVirtualAttributeRequest.joinDNAttribute) &&
        Objects.equals(this.joinBaseDNType, addReverseDnJoinVirtualAttributeRequest.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, addReverseDnJoinVirtualAttributeRequest.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, addReverseDnJoinVirtualAttributeRequest.joinScope) &&
        Objects.equals(this.joinSizeLimit, addReverseDnJoinVirtualAttributeRequest.joinSizeLimit) &&
        Objects.equals(this.joinFilter, addReverseDnJoinVirtualAttributeRequest.joinFilter) &&
        Objects.equals(this.joinAttribute, addReverseDnJoinVirtualAttributeRequest.joinAttribute) &&
        Objects.equals(this.enabled, addReverseDnJoinVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addReverseDnJoinVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addReverseDnJoinVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addReverseDnJoinVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addReverseDnJoinVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addReverseDnJoinVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addReverseDnJoinVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addReverseDnJoinVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addReverseDnJoinVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addReverseDnJoinVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addReverseDnJoinVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addReverseDnJoinVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, joinDNAttribute, joinBaseDNType, joinCustomBaseDN, joinScope, joinSizeLimit, joinFilter, joinAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddReverseDnJoinVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddReverseDnJoinVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddReverseDnJoinVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddReverseDnJoinVirtualAttributeRequest is not found in the empty JSON string", AddReverseDnJoinVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddReverseDnJoinVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddReverseDnJoinVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddReverseDnJoinVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddReverseDnJoinVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddReverseDnJoinVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddReverseDnJoinVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddReverseDnJoinVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddReverseDnJoinVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddReverseDnJoinVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddReverseDnJoinVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddReverseDnJoinVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddReverseDnJoinVirtualAttributeRequest
  */
  public static AddReverseDnJoinVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddReverseDnJoinVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddReverseDnJoinVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
