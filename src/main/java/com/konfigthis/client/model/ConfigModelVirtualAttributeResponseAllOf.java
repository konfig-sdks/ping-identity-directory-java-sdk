...
public class ConfigModelVirtualAttributeResponseAllOf {
  ...
  private List<EnumconfigModelVirtualAttributeSchemaUrn> schemas = null;
  ...
  public ConfigModelVirtualAttributeResponseAllOf() {
  }

  public ConfigModelVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf schemas(List<EnumconfigModelVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConfigModelVirtualAttributeResponseAllOf addSchemasItem(EnumconfigModelVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public ConfigModelVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ConfigModelVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ConfigModelVirtualAttributeResponseAllOf instance itself
   */
  public ConfigModelVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigModelVirtualAttributeResponseAllOf configModelVirtualAttributeResponseAllOf = (ConfigModelVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, configModelVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, configModelVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, configModelVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, configModelVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, configModelVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.requireExplicitRequestByName, configModelVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.enabled, configModelVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.groupDN, configModelVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, configModelVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, configModelVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, configModelVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, configModelVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, configModelVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, requireExplicitRequestByName, enabled, groupDN, clientConnectionPolicy, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfigModelVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConfigModelVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConfigModelVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigModelVirtualAttributeResponseAllOf is not found in the empty JSON string", ConfigModelVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigModelVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigModelVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigModelVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigModelVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigModelVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ConfigModelVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public ConfigModelVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConfigModelVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConfigModelVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConfigModelVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ConfigModelVirtualAttributeResponseAllOf
  */
  public static ConfigModelVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigModelVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of ConfigModelVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
