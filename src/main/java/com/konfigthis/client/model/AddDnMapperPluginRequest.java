...
public class AddDnMapperPluginRequest {
  ...
  public AddDnMapperPluginRequest() {
  }

  public AddDnMapperPluginRequest pluginName(String pluginName) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest description(String description) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest schemas(List<EnumdnMapperPluginSchemaUrn> schemas) {
  ...
  public AddDnMapperPluginRequest addSchemasItem(EnumdnMapperPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public AddDnMapperPluginRequest addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest sourceDN(String sourceDN) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest targetDN(String targetDN) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest enableAttributeMapping(Boolean enableAttributeMapping) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether DN mapping should be applied to the values of attributes with appropriate syntaxes.")
  ...
  public AddDnMapperPluginRequest mapAttribute(List<String> mapAttribute) {
  ...
  public AddDnMapperPluginRequest addMapAttributeItem(String mapAttributeItem) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest enableControlMapping(Boolean enableControlMapping) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether DN mapping should be applied to DNs that may be present in specific controls. DN mapping will only be applied for control types which are specifically supported by the DN mapper plugin.")
  ...
  public AddDnMapperPluginRequest alwaysMapResponses(Boolean alwaysMapResponses) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether DNs in response messages containing the target DN should always be remapped back to the source DN. If this is \"false\", then mapping will be performed for a response message only if one or more elements of the associated request are mapped. Otherwise, the mapping will be performed for all responses regardless of whether the mapping was applied to the request.")
  ...
  public AddDnMapperPluginRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddDnMapperPluginRequest invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the AddDnMapperPluginRequest instance itself
   */
  public AddDnMapperPluginRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddDnMapperPluginRequest addDnMapperPluginRequest = (AddDnMapperPluginRequest) o;
    return Objects.equals(this.pluginName, addDnMapperPluginRequest.pluginName) &&
        Objects.equals(this.description, addDnMapperPluginRequest.description) &&
        Objects.equals(this.schemas, addDnMapperPluginRequest.schemas) &&
        Objects.equals(this.pluginType, addDnMapperPluginRequest.pluginType) &&
        Objects.equals(this.sourceDN, addDnMapperPluginRequest.sourceDN) &&
        Objects.equals(this.targetDN, addDnMapperPluginRequest.targetDN) &&
        Objects.equals(this.enableAttributeMapping, addDnMapperPluginRequest.enableAttributeMapping) &&
        Objects.equals(this.mapAttribute, addDnMapperPluginRequest.mapAttribute) &&
        Objects.equals(this.enableControlMapping, addDnMapperPluginRequest.enableControlMapping) &&
        Objects.equals(this.alwaysMapResponses, addDnMapperPluginRequest.alwaysMapResponses) &&
        Objects.equals(this.enabled, addDnMapperPluginRequest.enabled) &&
        Objects.equals(this.invokeForInternalOperations, addDnMapperPluginRequest.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, addDnMapperPluginRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pluginName, description, schemas, pluginType, sourceDN, targetDN, enableAttributeMapping, mapAttribute, enableControlMapping, alwaysMapResponses, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddDnMapperPluginRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddDnMapperPluginRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddDnMapperPluginRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddDnMapperPluginRequest is not found in the empty JSON string", AddDnMapperPluginRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddDnMapperPluginRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDnMapperPluginRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDnMapperPluginRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddDnMapperPluginRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddDnMapperPluginRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddDnMapperPluginRequest>() {
           @Override
           public void write(JsonWriter out, AddDnMapperPluginRequest value) throws IOException {
           ...
           @Override
           public AddDnMapperPluginRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddDnMapperPluginRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddDnMapperPluginRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddDnMapperPluginRequest
  * @throws IOException if the JSON string is invalid with respect to AddDnMapperPluginRequest
  */
  public static AddDnMapperPluginRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddDnMapperPluginRequest.class);
  }

 /**
  * Convert an instance of AddDnMapperPluginRequest to an JSON string
  *
  * @return JSON string
  */
