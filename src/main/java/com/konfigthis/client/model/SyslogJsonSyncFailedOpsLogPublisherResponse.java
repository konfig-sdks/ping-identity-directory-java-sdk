...
import com.konfigthis.client.model.EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn;
...
public class SyslogJsonSyncFailedOpsLogPublisherResponse {
  ...
  private List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse() {
  }

  public SyslogJsonSyncFailedOpsLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse schemas(List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse addSchemasItem(EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The local host name that will be included in syslog messages that are logged by this Syslog JSON Sync Failed Ops Log Publisher.")
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The application name that will be included in syslog messages that are logged by this Syslog JSON Sync Failed Ops Log Publisher.")
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogJsonSyncFailedOpsLogPublisherResponse instance itself
   */
  public SyslogJsonSyncFailedOpsLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonSyncFailedOpsLogPublisherResponse syslogJsonSyncFailedOpsLogPublisherResponse = (SyslogJsonSyncFailedOpsLogPublisherResponse) o;
    return Objects.equals(this.description, syslogJsonSyncFailedOpsLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogJsonSyncFailedOpsLogPublisherResponse.schemas) &&
        Objects.equals(this.id, syslogJsonSyncFailedOpsLogPublisherResponse.id) &&
        Objects.equals(this.syslogExternalServer, syslogJsonSyncFailedOpsLogPublisherResponse.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonSyncFailedOpsLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonSyncFailedOpsLogPublisherResponse.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonSyncFailedOpsLogPublisherResponse.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonSyncFailedOpsLogPublisherResponse.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonSyncFailedOpsLogPublisherResponse.queueSize) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonSyncFailedOpsLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, syslogJsonSyncFailedOpsLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonSyncFailedOpsLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonSyncFailedOpsLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonSyncFailedOpsLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, syslogJsonSyncFailedOpsLogPublisherResponse.includeSyncPipe) &&
        Objects.equals(this.enabled, syslogJsonSyncFailedOpsLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonSyncFailedOpsLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogJsonSyncFailedOpsLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogJsonSyncFailedOpsLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogJsonSyncFailedOpsLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogJsonSyncFailedOpsLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonSyncFailedOpsLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonSyncFailedOpsLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonSyncFailedOpsLogPublisherResponse is not found in the empty JSON string", SyslogJsonSyncFailedOpsLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonSyncFailedOpsLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonSyncFailedOpsLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonSyncFailedOpsLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonSyncFailedOpsLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonSyncFailedOpsLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonSyncFailedOpsLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogJsonSyncFailedOpsLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogJsonSyncFailedOpsLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonSyncFailedOpsLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonSyncFailedOpsLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonSyncFailedOpsLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonSyncFailedOpsLogPublisherResponse
  */
  public static SyslogJsonSyncFailedOpsLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonSyncFailedOpsLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogJsonSyncFailedOpsLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
