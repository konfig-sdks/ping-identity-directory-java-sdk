...
public class ConjurPassphraseProviderShared {
  ...
  public ConjurPassphraseProviderShared() {
  }

  public ConjurPassphraseProviderShared description(String description) {
  ...
  **/
  ...
  public ConjurPassphraseProviderShared schemas(List<EnumconjurPassphraseProviderSchemaUrn> schemas) {
  ...
  public ConjurPassphraseProviderShared addSchemasItem(EnumconjurPassphraseProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConjurPassphraseProviderShared conjurExternalServer(String conjurExternalServer) {
  ...
  **/
  ...
  public ConjurPassphraseProviderShared conjurSecretRelativePath(String conjurSecretRelativePath) {
  ...
  **/
  ...
  public ConjurPassphraseProviderShared maxCacheDuration(String maxCacheDuration) {
  ...
  **/
  ...
  public ConjurPassphraseProviderShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the ConjurPassphraseProviderShared instance itself
   */
  public ConjurPassphraseProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConjurPassphraseProviderShared conjurPassphraseProviderShared = (ConjurPassphraseProviderShared) o;
    return Objects.equals(this.description, conjurPassphraseProviderShared.description) &&
        Objects.equals(this.schemas, conjurPassphraseProviderShared.schemas) &&
        Objects.equals(this.conjurExternalServer, conjurPassphraseProviderShared.conjurExternalServer) &&
        Objects.equals(this.conjurSecretRelativePath, conjurPassphraseProviderShared.conjurSecretRelativePath) &&
        Objects.equals(this.maxCacheDuration, conjurPassphraseProviderShared.maxCacheDuration) &&
        Objects.equals(this.enabled, conjurPassphraseProviderShared.enabled)&&
        Objects.equals(this.additionalProperties, conjurPassphraseProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, conjurExternalServer, conjurSecretRelativePath, maxCacheDuration, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConjurPassphraseProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConjurPassphraseProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConjurPassphraseProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConjurPassphraseProviderShared is not found in the empty JSON string", ConjurPassphraseProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConjurPassphraseProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConjurPassphraseProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConjurPassphraseProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConjurPassphraseProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConjurPassphraseProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ConjurPassphraseProviderShared>() {
           @Override
           public void write(JsonWriter out, ConjurPassphraseProviderShared value) throws IOException {
           ...
           @Override
           public ConjurPassphraseProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConjurPassphraseProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConjurPassphraseProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConjurPassphraseProviderShared
  * @throws IOException if the JSON string is invalid with respect to ConjurPassphraseProviderShared
  */
  public static ConjurPassphraseProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConjurPassphraseProviderShared.class);
  }

 /**
  * Convert an instance of ConjurPassphraseProviderShared to an JSON string
  *
  * @return JSON string
  */
