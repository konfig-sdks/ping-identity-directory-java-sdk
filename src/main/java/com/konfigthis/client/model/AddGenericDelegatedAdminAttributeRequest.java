...
public class AddGenericDelegatedAdminAttributeRequest {
  ...
  public AddGenericDelegatedAdminAttributeRequest() {
  }

  public AddGenericDelegatedAdminAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest schemas(List<EnumgenericDelegatedAdminAttributeSchemaUrn> schemas) {
  ...
  public AddGenericDelegatedAdminAttributeRequest addSchemasItem(EnumgenericDelegatedAdminAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest displayName(String displayName) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest mutability(EnumdelegatedAdminAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest includeInSummary(Boolean includeInSummary) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether this Delegated Admin Attribute is to be included in the summary display for a resource.")
  ...
  public AddGenericDelegatedAdminAttributeRequest attributeCategory(String attributeCategory) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest displayOrderIndex(Integer displayOrderIndex) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest referenceResourceType(String referenceResourceType) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest attributePresentation(EnumdelegatedAdminAttributeAttributePresentationProp attributePresentation) {
  ...
  **/
  ...
  public AddGenericDelegatedAdminAttributeRequest dateTimeFormat(String dateTimeFormat) {
  ...
  **/
   ...
   * @return the AddGenericDelegatedAdminAttributeRequest instance itself
   */
  public AddGenericDelegatedAdminAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGenericDelegatedAdminAttributeRequest addGenericDelegatedAdminAttributeRequest = (AddGenericDelegatedAdminAttributeRequest) o;
    return Objects.equals(this.attributeType, addGenericDelegatedAdminAttributeRequest.attributeType) &&
        Objects.equals(this.description, addGenericDelegatedAdminAttributeRequest.description) &&
        Objects.equals(this.schemas, addGenericDelegatedAdminAttributeRequest.schemas) &&
        Objects.equals(this.displayName, addGenericDelegatedAdminAttributeRequest.displayName) &&
        Objects.equals(this.mutability, addGenericDelegatedAdminAttributeRequest.mutability) &&
        Objects.equals(this.multiValued, addGenericDelegatedAdminAttributeRequest.multiValued) &&
        Objects.equals(this.includeInSummary, addGenericDelegatedAdminAttributeRequest.includeInSummary) &&
        Objects.equals(this.attributeCategory, addGenericDelegatedAdminAttributeRequest.attributeCategory) &&
        Objects.equals(this.displayOrderIndex, addGenericDelegatedAdminAttributeRequest.displayOrderIndex) &&
        Objects.equals(this.referenceResourceType, addGenericDelegatedAdminAttributeRequest.referenceResourceType) &&
        Objects.equals(this.attributePresentation, addGenericDelegatedAdminAttributeRequest.attributePresentation) &&
        Objects.equals(this.dateTimeFormat, addGenericDelegatedAdminAttributeRequest.dateTimeFormat)&&
        Objects.equals(this.additionalProperties, addGenericDelegatedAdminAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributeType, description, schemas, displayName, mutability, multiValued, includeInSummary, attributeCategory, displayOrderIndex, referenceResourceType, attributePresentation, dateTimeFormat, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGenericDelegatedAdminAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGenericDelegatedAdminAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGenericDelegatedAdminAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGenericDelegatedAdminAttributeRequest is not found in the empty JSON string", AddGenericDelegatedAdminAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGenericDelegatedAdminAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGenericDelegatedAdminAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGenericDelegatedAdminAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGenericDelegatedAdminAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGenericDelegatedAdminAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGenericDelegatedAdminAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddGenericDelegatedAdminAttributeRequest value) throws IOException {
           ...
           @Override
           public AddGenericDelegatedAdminAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGenericDelegatedAdminAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGenericDelegatedAdminAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGenericDelegatedAdminAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddGenericDelegatedAdminAttributeRequest
  */
  public static AddGenericDelegatedAdminAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGenericDelegatedAdminAttributeRequest.class);
  }

 /**
  * Convert an instance of AddGenericDelegatedAdminAttributeRequest to an JSON string
  *
  * @return JSON string
  */
