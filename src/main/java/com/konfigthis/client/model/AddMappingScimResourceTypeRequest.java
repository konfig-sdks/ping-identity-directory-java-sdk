...
public class AddMappingScimResourceTypeRequest {
  ...
  public AddMappingScimResourceTypeRequest() {
  }

  public AddMappingScimResourceTypeRequest typeName(String typeName) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest description(String description) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest schemas(List<EnummappingScimResourceTypeSchemaUrn> schemas) {
  ...
  public AddMappingScimResourceTypeRequest addSchemasItem(EnummappingScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest coreSchema(String coreSchema) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest requiredSchemaExtension(List<String> requiredSchemaExtension) {
  ...
  public AddMappingScimResourceTypeRequest addRequiredSchemaExtensionItem(String requiredSchemaExtensionItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest optionalSchemaExtension(List<String> optionalSchemaExtension) {
  ...
  public AddMappingScimResourceTypeRequest addOptionalSchemaExtensionItem(String optionalSchemaExtensionItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest endpoint(String endpoint) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public AddMappingScimResourceTypeRequest addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public AddMappingScimResourceTypeRequest addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest includeFilter(List<String> includeFilter) {
  ...
  public AddMappingScimResourceTypeRequest addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public AddMappingScimResourceTypeRequest addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public AddMappingScimResourceTypeRequest createDNPattern(String createDNPattern) {
  ...
  **/
   ...
   * @return the AddMappingScimResourceTypeRequest instance itself
   */
  public AddMappingScimResourceTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddMappingScimResourceTypeRequest addMappingScimResourceTypeRequest = (AddMappingScimResourceTypeRequest) o;
    return Objects.equals(this.typeName, addMappingScimResourceTypeRequest.typeName) &&
        Objects.equals(this.description, addMappingScimResourceTypeRequest.description) &&
        Objects.equals(this.schemas, addMappingScimResourceTypeRequest.schemas) &&
        Objects.equals(this.coreSchema, addMappingScimResourceTypeRequest.coreSchema) &&
        Objects.equals(this.requiredSchemaExtension, addMappingScimResourceTypeRequest.requiredSchemaExtension) &&
        Objects.equals(this.optionalSchemaExtension, addMappingScimResourceTypeRequest.optionalSchemaExtension) &&
        Objects.equals(this.enabled, addMappingScimResourceTypeRequest.enabled) &&
        Objects.equals(this.endpoint, addMappingScimResourceTypeRequest.endpoint) &&
        Objects.equals(this.lookthroughLimit, addMappingScimResourceTypeRequest.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, addMappingScimResourceTypeRequest.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, addMappingScimResourceTypeRequest.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, addMappingScimResourceTypeRequest.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, addMappingScimResourceTypeRequest.includeBaseDN) &&
        Objects.equals(this.includeFilter, addMappingScimResourceTypeRequest.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, addMappingScimResourceTypeRequest.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, addMappingScimResourceTypeRequest.createDNPattern)&&
        Objects.equals(this.additionalProperties, addMappingScimResourceTypeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddMappingScimResourceTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddMappingScimResourceTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddMappingScimResourceTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddMappingScimResourceTypeRequest is not found in the empty JSON string", AddMappingScimResourceTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddMappingScimResourceTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddMappingScimResourceTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddMappingScimResourceTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddMappingScimResourceTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddMappingScimResourceTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddMappingScimResourceTypeRequest>() {
           @Override
           public void write(JsonWriter out, AddMappingScimResourceTypeRequest value) throws IOException {
           ...
           @Override
           public AddMappingScimResourceTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddMappingScimResourceTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddMappingScimResourceTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddMappingScimResourceTypeRequest
  * @throws IOException if the JSON string is invalid with respect to AddMappingScimResourceTypeRequest
  */
  public static AddMappingScimResourceTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddMappingScimResourceTypeRequest.class);
  }

 /**
  * Convert an instance of AddMappingScimResourceTypeRequest to an JSON string
  *
  * @return JSON string
  */
