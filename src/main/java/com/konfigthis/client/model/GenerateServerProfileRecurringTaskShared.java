...
public class GenerateServerProfileRecurringTaskShared {
  ...
  public GenerateServerProfileRecurringTaskShared() {
  }

  public GenerateServerProfileRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared schemas(List<EnumgenerateServerProfileRecurringTaskSchemaUrn> schemas) {
  ...
  public GenerateServerProfileRecurringTaskShared addSchemasItem(EnumgenerateServerProfileRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared profileDirectory(String profileDirectory) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared includePath(List<String> includePath) {
  ...
  public GenerateServerProfileRecurringTaskShared addIncludePathItem(String includePathItem) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared retainPreviousProfileCount(Integer retainPreviousProfileCount) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared retainPreviousProfileAge(String retainPreviousProfileAge) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public GenerateServerProfileRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public GenerateServerProfileRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public GenerateServerProfileRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public GenerateServerProfileRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the GenerateServerProfileRecurringTaskShared instance itself
   */
  public GenerateServerProfileRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenerateServerProfileRecurringTaskShared generateServerProfileRecurringTaskShared = (GenerateServerProfileRecurringTaskShared) o;
    return Objects.equals(this.description, generateServerProfileRecurringTaskShared.description) &&
        Objects.equals(this.schemas, generateServerProfileRecurringTaskShared.schemas) &&
        Objects.equals(this.profileDirectory, generateServerProfileRecurringTaskShared.profileDirectory) &&
        Objects.equals(this.includePath, generateServerProfileRecurringTaskShared.includePath) &&
        Objects.equals(this.retainPreviousProfileCount, generateServerProfileRecurringTaskShared.retainPreviousProfileCount) &&
        Objects.equals(this.retainPreviousProfileAge, generateServerProfileRecurringTaskShared.retainPreviousProfileAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, generateServerProfileRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, generateServerProfileRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, generateServerProfileRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, generateServerProfileRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, generateServerProfileRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, generateServerProfileRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, generateServerProfileRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, generateServerProfileRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, profileDirectory, includePath, retainPreviousProfileCount, retainPreviousProfileAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenerateServerProfileRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenerateServerProfileRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenerateServerProfileRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenerateServerProfileRecurringTaskShared is not found in the empty JSON string", GenerateServerProfileRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenerateServerProfileRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateServerProfileRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateServerProfileRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateServerProfileRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateServerProfileRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateServerProfileRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, GenerateServerProfileRecurringTaskShared value) throws IOException {
           ...
           @Override
           public GenerateServerProfileRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenerateServerProfileRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenerateServerProfileRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenerateServerProfileRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to GenerateServerProfileRecurringTaskShared
  */
  public static GenerateServerProfileRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateServerProfileRecurringTaskShared.class);
  }

 /**
  * Convert an instance of GenerateServerProfileRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
