...
public class SmtpExternalServerShared {
  ...
  public SmtpExternalServerShared() {
  }

  public SmtpExternalServerShared description(String description) {
  ...
  **/
  ...
  public SmtpExternalServerShared schemas(List<EnumsmtpExternalServerSchemaUrn> schemas) {
  ...
  public SmtpExternalServerShared addSchemasItem(EnumsmtpExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SmtpExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SmtpExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SmtpExternalServerShared smtpSecurity(EnumexternalServerSmtpSecurityProp smtpSecurity) {
  ...
  **/
  ...
  public SmtpExternalServerShared userName(String userName) {
  ...
  **/
  ...
  public SmtpExternalServerShared password(String password) {
  ...
  **/
  ...
  public SmtpExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public SmtpExternalServerShared smtpTimeout(String smtpTimeout) {
  ...
  **/
  ...
  public SmtpExternalServerShared smtpConnectionProperties(List<String> smtpConnectionProperties) {
  ...
  public SmtpExternalServerShared addSmtpConnectionPropertiesItem(String smtpConnectionPropertiesItem) {
  ...
  **/
   ...
   * @return the SmtpExternalServerShared instance itself
   */
  public SmtpExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpExternalServerShared smtpExternalServerShared = (SmtpExternalServerShared) o;
    return Objects.equals(this.description, smtpExternalServerShared.description) &&
        Objects.equals(this.schemas, smtpExternalServerShared.schemas) &&
        Objects.equals(this.serverHostName, smtpExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, smtpExternalServerShared.serverPort) &&
        Objects.equals(this.smtpSecurity, smtpExternalServerShared.smtpSecurity) &&
        Objects.equals(this.userName, smtpExternalServerShared.userName) &&
        Objects.equals(this.password, smtpExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, smtpExternalServerShared.passphraseProvider) &&
        Objects.equals(this.smtpTimeout, smtpExternalServerShared.smtpTimeout) &&
        Objects.equals(this.smtpConnectionProperties, smtpExternalServerShared.smtpConnectionProperties)&&
        Objects.equals(this.additionalProperties, smtpExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, serverHostName, serverPort, smtpSecurity, userName, password, passphraseProvider, smtpTimeout, smtpConnectionProperties, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmtpExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmtpExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmtpExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpExternalServerShared is not found in the empty JSON string", SmtpExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmtpExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpExternalServerShared>() {
           @Override
           public void write(JsonWriter out, SmtpExternalServerShared value) throws IOException {
           ...
           @Override
           public SmtpExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SmtpExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SmtpExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmtpExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to SmtpExternalServerShared
  */
  public static SmtpExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpExternalServerShared.class);
  }

 /**
  * Convert an instance of SmtpExternalServerShared to an JSON string
  *
  * @return JSON string
  */
