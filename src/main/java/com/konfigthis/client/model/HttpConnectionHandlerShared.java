...
public class HttpConnectionHandlerShared {
  ...
  public HttpConnectionHandlerShared() {
  }

  public HttpConnectionHandlerShared description(String description) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared schemas(List<EnumhttpConnectionHandlerSchemaUrn> schemas) {
  ...
  public HttpConnectionHandlerShared addSchemasItem(EnumhttpConnectionHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared listenAddress(String listenAddress) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared listenPort(Integer listenPort) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared httpServletExtension(List<String> httpServletExtension) {
  ...
  public HttpConnectionHandlerShared addHttpServletExtensionItem(String httpServletExtensionItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared webApplicationExtension(List<String> webApplicationExtension) {
  ...
  public HttpConnectionHandlerShared addWebApplicationExtensionItem(String webApplicationExtensionItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared httpOperationLogPublisher(List<String> httpOperationLogPublisher) {
  ...
  public HttpConnectionHandlerShared addHttpOperationLogPublisherItem(String httpOperationLogPublisherItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared sslProtocol(List<String> sslProtocol) {
  ...
  public HttpConnectionHandlerShared addSslProtocolItem(String sslProtocolItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared sslCipherSuite(List<String> sslCipherSuite) {
  ...
  public HttpConnectionHandlerShared addSslCipherSuiteItem(String sslCipherSuiteItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared numRequestHandlers(Integer numRequestHandlers) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared keepStats(Boolean keepStats) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared acceptBacklog(Integer acceptBacklog) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared allowTCPReuseAddress(Boolean allowTCPReuseAddress) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared idleTimeLimit(String idleTimeLimit) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared lowResourcesConnectionThreshold(Integer lowResourcesConnectionThreshold) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared lowResourcesIdleTimeLimit(String lowResourcesIdleTimeLimit) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared enableMultipartMIMEParameters(Boolean enableMultipartMIMEParameters) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared useForwardedHeaders(Boolean useForwardedHeaders) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared httpRequestHeaderSize(Integer httpRequestHeaderSize) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared responseHeader(List<String> responseHeader) {
  ...
  public HttpConnectionHandlerShared addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared useCorrelationIDHeader(Boolean useCorrelationIDHeader) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared correlationIDRequestHeader(List<String> correlationIDRequestHeader) {
  ...
  public HttpConnectionHandlerShared addCorrelationIDRequestHeaderItem(String correlationIDRequestHeaderItem) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared sslClientAuthPolicy(EnumconnectionHandlerSslClientAuthPolicyProp sslClientAuthPolicy) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared enableSniHostnameChecks(Boolean enableSniHostnameChecks) {
  ...
  **/
  ...
  public HttpConnectionHandlerShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the HttpConnectionHandlerShared instance itself
   */
  public HttpConnectionHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HttpConnectionHandlerShared httpConnectionHandlerShared = (HttpConnectionHandlerShared) o;
    return Objects.equals(this.description, httpConnectionHandlerShared.description) &&
        Objects.equals(this.schemas, httpConnectionHandlerShared.schemas) &&
        Objects.equals(this.listenAddress, httpConnectionHandlerShared.listenAddress) &&
        Objects.equals(this.listenPort, httpConnectionHandlerShared.listenPort) &&
        Objects.equals(this.useSSL, httpConnectionHandlerShared.useSSL) &&
        Objects.equals(this.sslCertNickname, httpConnectionHandlerShared.sslCertNickname) &&
        Objects.equals(this.httpServletExtension, httpConnectionHandlerShared.httpServletExtension) &&
        Objects.equals(this.webApplicationExtension, httpConnectionHandlerShared.webApplicationExtension) &&
        Objects.equals(this.httpOperationLogPublisher, httpConnectionHandlerShared.httpOperationLogPublisher) &&
        Objects.equals(this.sslProtocol, httpConnectionHandlerShared.sslProtocol) &&
        Objects.equals(this.sslCipherSuite, httpConnectionHandlerShared.sslCipherSuite) &&
        Objects.equals(this.keyManagerProvider, httpConnectionHandlerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, httpConnectionHandlerShared.trustManagerProvider) &&
        Objects.equals(this.numRequestHandlers, httpConnectionHandlerShared.numRequestHandlers) &&
        Objects.equals(this.keepStats, httpConnectionHandlerShared.keepStats) &&
        Objects.equals(this.acceptBacklog, httpConnectionHandlerShared.acceptBacklog) &&
        Objects.equals(this.allowTCPReuseAddress, httpConnectionHandlerShared.allowTCPReuseAddress) &&
        Objects.equals(this.idleTimeLimit, httpConnectionHandlerShared.idleTimeLimit) &&
        Objects.equals(this.lowResourcesConnectionThreshold, httpConnectionHandlerShared.lowResourcesConnectionThreshold) &&
        Objects.equals(this.lowResourcesIdleTimeLimit, httpConnectionHandlerShared.lowResourcesIdleTimeLimit) &&
        Objects.equals(this.enableMultipartMIMEParameters, httpConnectionHandlerShared.enableMultipartMIMEParameters) &&
        Objects.equals(this.useForwardedHeaders, httpConnectionHandlerShared.useForwardedHeaders) &&
        Objects.equals(this.httpRequestHeaderSize, httpConnectionHandlerShared.httpRequestHeaderSize) &&
        Objects.equals(this.responseHeader, httpConnectionHandlerShared.responseHeader) &&
        Objects.equals(this.useCorrelationIDHeader, httpConnectionHandlerShared.useCorrelationIDHeader) &&
        Objects.equals(this.correlationIDResponseHeader, httpConnectionHandlerShared.correlationIDResponseHeader) &&
        Objects.equals(this.correlationIDRequestHeader, httpConnectionHandlerShared.correlationIDRequestHeader) &&
        Objects.equals(this.sslClientAuthPolicy, httpConnectionHandlerShared.sslClientAuthPolicy) &&
        Objects.equals(this.enableSniHostnameChecks, httpConnectionHandlerShared.enableSniHostnameChecks) &&
        Objects.equals(this.enabled, httpConnectionHandlerShared.enabled)&&
        Objects.equals(this.additionalProperties, httpConnectionHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, listenAddress, listenPort, useSSL, sslCertNickname, httpServletExtension, webApplicationExtension, httpOperationLogPublisher, sslProtocol, sslCipherSuite, keyManagerProvider, trustManagerProvider, numRequestHandlers, keepStats, acceptBacklog, allowTCPReuseAddress, idleTimeLimit, lowResourcesConnectionThreshold, lowResourcesIdleTimeLimit, enableMultipartMIMEParameters, useForwardedHeaders, httpRequestHeaderSize, responseHeader, useCorrelationIDHeader, correlationIDResponseHeader, correlationIDRequestHeader, sslClientAuthPolicy, enableSniHostnameChecks, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HttpConnectionHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HttpConnectionHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HttpConnectionHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpConnectionHandlerShared is not found in the empty JSON string", HttpConnectionHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpConnectionHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpConnectionHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpConnectionHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpConnectionHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpConnectionHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpConnectionHandlerShared>() {
           @Override
           public void write(JsonWriter out, HttpConnectionHandlerShared value) throws IOException {
           ...
           @Override
           public HttpConnectionHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HttpConnectionHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HttpConnectionHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HttpConnectionHandlerShared
  * @throws IOException if the JSON string is invalid with respect to HttpConnectionHandlerShared
  */
  public static HttpConnectionHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpConnectionHandlerShared.class);
  }

 /**
  * Convert an instance of HttpConnectionHandlerShared to an JSON string
  *
  * @return JSON string
  */
