...
import com.konfigthis.client.model.EnumsyncFailedOpsLogPublisherSchemaUrn;
...
public class SyncFailedOpsLogPublisherResponse {
  ...
  private List<EnumsyncFailedOpsLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyncFailedOpsLogPublisherResponse() {
  }

  public SyncFailedOpsLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse schemas(List<EnumsyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyncFailedOpsLogPublisherResponse addSchemasItem(EnumsyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyncFailedOpsLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyncFailedOpsLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the Sync Failed Ops Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public SyncFailedOpsLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Sync Failed Ops Log Publisher.")
  ...
  public SyncFailedOpsLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public SyncFailedOpsLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Sync Failed Ops Log Publisher .")
  ...
  public SyncFailedOpsLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public SyncFailedOpsLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public SyncFailedOpsLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Sync Failed Ops Log Publisher .")
  ...
  public SyncFailedOpsLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Sync Failed Ops Log Publisher will publish records asynchronously.")
  ...
  public SyncFailedOpsLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public SyncFailedOpsLogPublisherResponse addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyncFailedOpsLogPublisherResponse instance itself
   */
  public SyncFailedOpsLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncFailedOpsLogPublisherResponse syncFailedOpsLogPublisherResponse = (SyncFailedOpsLogPublisherResponse) o;
    return Objects.equals(this.description, syncFailedOpsLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syncFailedOpsLogPublisherResponse.schemas) &&
        Objects.equals(this.id, syncFailedOpsLogPublisherResponse.id) &&
        Objects.equals(this.logFile, syncFailedOpsLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, syncFailedOpsLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, syncFailedOpsLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, syncFailedOpsLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, syncFailedOpsLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, syncFailedOpsLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, syncFailedOpsLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, syncFailedOpsLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, syncFailedOpsLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, syncFailedOpsLogPublisherResponse.append) &&
        Objects.equals(this.asynchronous, syncFailedOpsLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, syncFailedOpsLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, syncFailedOpsLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, syncFailedOpsLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, syncFailedOpsLogPublisherResponse.timeInterval) &&
        Objects.equals(this.includeSyncPipe, syncFailedOpsLogPublisherResponse.includeSyncPipe) &&
        Objects.equals(this.enabled, syncFailedOpsLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syncFailedOpsLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syncFailedOpsLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syncFailedOpsLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syncFailedOpsLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, includeSyncPipe, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyncFailedOpsLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncFailedOpsLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncFailedOpsLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncFailedOpsLogPublisherResponse is not found in the empty JSON string", SyncFailedOpsLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncFailedOpsLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncFailedOpsLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncFailedOpsLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncFailedOpsLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncFailedOpsLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncFailedOpsLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyncFailedOpsLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyncFailedOpsLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncFailedOpsLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncFailedOpsLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncFailedOpsLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyncFailedOpsLogPublisherResponse
  */
  public static SyncFailedOpsLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncFailedOpsLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyncFailedOpsLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
