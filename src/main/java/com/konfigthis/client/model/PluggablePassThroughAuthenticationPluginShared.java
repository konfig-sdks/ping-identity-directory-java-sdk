...
public class PluggablePassThroughAuthenticationPluginShared {
  ...
  public PluggablePassThroughAuthenticationPluginShared() {
  }

  public PluggablePassThroughAuthenticationPluginShared description(String description) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared schemas(List<EnumpluggablePassThroughAuthenticationPluginSchemaUrn> schemas) {
  ...
  public PluggablePassThroughAuthenticationPluginShared addSchemasItem(EnumpluggablePassThroughAuthenticationPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared passThroughAuthenticationHandler(String passThroughAuthenticationHandler) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public PluggablePassThroughAuthenticationPluginShared addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared tryLocalBind(Boolean tryLocalBind) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared overrideLocalPassword(Boolean overrideLocalPassword) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared updateLocalPassword(Boolean updateLocalPassword) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared updateLocalPasswordDN(String updateLocalPasswordDN) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared allowLaxPassThroughAuthenticationPasswords(Boolean allowLaxPassThroughAuthenticationPasswords) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared ignoredPasswordPolicyStateErrorCondition(List<EnumpluginIgnoredPasswordPolicyStateErrorConditionProp> ignoredPasswordPolicyStateErrorCondition) {
  ...
  public PluggablePassThroughAuthenticationPluginShared addIgnoredPasswordPolicyStateErrorConditionItem(EnumpluginIgnoredPasswordPolicyStateErrorConditionProp ignoredPasswordPolicyStateErrorConditionItem) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public PluggablePassThroughAuthenticationPluginShared invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the PluggablePassThroughAuthenticationPluginShared instance itself
   */
  public PluggablePassThroughAuthenticationPluginShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PluggablePassThroughAuthenticationPluginShared pluggablePassThroughAuthenticationPluginShared = (PluggablePassThroughAuthenticationPluginShared) o;
    return Objects.equals(this.description, pluggablePassThroughAuthenticationPluginShared.description) &&
        Objects.equals(this.schemas, pluggablePassThroughAuthenticationPluginShared.schemas) &&
        Objects.equals(this.passThroughAuthenticationHandler, pluggablePassThroughAuthenticationPluginShared.passThroughAuthenticationHandler) &&
        Objects.equals(this.includedLocalEntryBaseDN, pluggablePassThroughAuthenticationPluginShared.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, pluggablePassThroughAuthenticationPluginShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, pluggablePassThroughAuthenticationPluginShared.requestCriteria) &&
        Objects.equals(this.tryLocalBind, pluggablePassThroughAuthenticationPluginShared.tryLocalBind) &&
        Objects.equals(this.overrideLocalPassword, pluggablePassThroughAuthenticationPluginShared.overrideLocalPassword) &&
        Objects.equals(this.updateLocalPassword, pluggablePassThroughAuthenticationPluginShared.updateLocalPassword) &&
        Objects.equals(this.updateLocalPasswordDN, pluggablePassThroughAuthenticationPluginShared.updateLocalPasswordDN) &&
        Objects.equals(this.allowLaxPassThroughAuthenticationPasswords, pluggablePassThroughAuthenticationPluginShared.allowLaxPassThroughAuthenticationPasswords) &&
        Objects.equals(this.ignoredPasswordPolicyStateErrorCondition, pluggablePassThroughAuthenticationPluginShared.ignoredPasswordPolicyStateErrorCondition) &&
        Objects.equals(this.enabled, pluggablePassThroughAuthenticationPluginShared.enabled) &&
        Objects.equals(this.invokeForInternalOperations, pluggablePassThroughAuthenticationPluginShared.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, pluggablePassThroughAuthenticationPluginShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, passThroughAuthenticationHandler, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, tryLocalBind, overrideLocalPassword, updateLocalPassword, updateLocalPasswordDN, allowLaxPassThroughAuthenticationPasswords, ignoredPasswordPolicyStateErrorCondition, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PluggablePassThroughAuthenticationPluginShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PluggablePassThroughAuthenticationPluginShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PluggablePassThroughAuthenticationPluginShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PluggablePassThroughAuthenticationPluginShared is not found in the empty JSON string", PluggablePassThroughAuthenticationPluginShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PluggablePassThroughAuthenticationPluginShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PluggablePassThroughAuthenticationPluginShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PluggablePassThroughAuthenticationPluginShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PluggablePassThroughAuthenticationPluginShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PluggablePassThroughAuthenticationPluginShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PluggablePassThroughAuthenticationPluginShared>() {
           @Override
           public void write(JsonWriter out, PluggablePassThroughAuthenticationPluginShared value) throws IOException {
           ...
           @Override
           public PluggablePassThroughAuthenticationPluginShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PluggablePassThroughAuthenticationPluginShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PluggablePassThroughAuthenticationPluginShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PluggablePassThroughAuthenticationPluginShared
  * @throws IOException if the JSON string is invalid with respect to PluggablePassThroughAuthenticationPluginShared
  */
  public static PluggablePassThroughAuthenticationPluginShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PluggablePassThroughAuthenticationPluginShared.class);
  }

 /**
  * Convert an instance of PluggablePassThroughAuthenticationPluginShared to an JSON string
  *
  * @return JSON string
  */
