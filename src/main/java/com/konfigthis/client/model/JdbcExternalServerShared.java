...
public class JdbcExternalServerShared {
  ...
  public JdbcExternalServerShared() {
  }

  public JdbcExternalServerShared description(String description) {
  ...
  **/
  ...
  public JdbcExternalServerShared schemas(List<EnumjdbcExternalServerSchemaUrn> schemas) {
  ...
  public JdbcExternalServerShared addSchemasItem(EnumjdbcExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JdbcExternalServerShared jdbcDriverType(EnumexternalServerJdbcDriverTypeProp jdbcDriverType) {
  ...
  **/
  ...
  public JdbcExternalServerShared jdbcDriverURL(String jdbcDriverURL) {
  ...
  **/
  ...
  public JdbcExternalServerShared databaseName(String databaseName) {
  ...
  **/
  ...
  public JdbcExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public JdbcExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public JdbcExternalServerShared userName(String userName) {
  ...
  **/
  ...
  public JdbcExternalServerShared password(String password) {
  ...
  **/
  ...
  public JdbcExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public JdbcExternalServerShared validationQuery(String validationQuery) {
  ...
  **/
  ...
  public JdbcExternalServerShared validationQueryTimeout(String validationQueryTimeout) {
  ...
  **/
  ...
  public JdbcExternalServerShared jdbcConnectionProperties(List<String> jdbcConnectionProperties) {
  ...
  public JdbcExternalServerShared addJdbcConnectionPropertiesItem(String jdbcConnectionPropertiesItem) {
  ...
  **/
  ...
  public JdbcExternalServerShared transactionIsolationLevel(EnumexternalServerTransactionIsolationLevelProp transactionIsolationLevel) {
  ...
  **/
   ...
   * @return the JdbcExternalServerShared instance itself
   */
  public JdbcExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JdbcExternalServerShared jdbcExternalServerShared = (JdbcExternalServerShared) o;
    return Objects.equals(this.description, jdbcExternalServerShared.description) &&
        Objects.equals(this.schemas, jdbcExternalServerShared.schemas) &&
        Objects.equals(this.jdbcDriverType, jdbcExternalServerShared.jdbcDriverType) &&
        Objects.equals(this.jdbcDriverURL, jdbcExternalServerShared.jdbcDriverURL) &&
        Objects.equals(this.databaseName, jdbcExternalServerShared.databaseName) &&
        Objects.equals(this.serverHostName, jdbcExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, jdbcExternalServerShared.serverPort) &&
        Objects.equals(this.userName, jdbcExternalServerShared.userName) &&
        Objects.equals(this.password, jdbcExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, jdbcExternalServerShared.passphraseProvider) &&
        Objects.equals(this.validationQuery, jdbcExternalServerShared.validationQuery) &&
        Objects.equals(this.validationQueryTimeout, jdbcExternalServerShared.validationQueryTimeout) &&
        Objects.equals(this.jdbcConnectionProperties, jdbcExternalServerShared.jdbcConnectionProperties) &&
        Objects.equals(this.transactionIsolationLevel, jdbcExternalServerShared.transactionIsolationLevel)&&
        Objects.equals(this.additionalProperties, jdbcExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, jdbcDriverType, jdbcDriverURL, databaseName, serverHostName, serverPort, userName, password, passphraseProvider, validationQuery, validationQueryTimeout, jdbcConnectionProperties, transactionIsolationLevel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JdbcExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JdbcExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JdbcExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JdbcExternalServerShared is not found in the empty JSON string", JdbcExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JdbcExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JdbcExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JdbcExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JdbcExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JdbcExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JdbcExternalServerShared>() {
           @Override
           public void write(JsonWriter out, JdbcExternalServerShared value) throws IOException {
           ...
           @Override
           public JdbcExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JdbcExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JdbcExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JdbcExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to JdbcExternalServerShared
  */
  public static JdbcExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JdbcExternalServerShared.class);
  }

 /**
  * Convert an instance of JdbcExternalServerShared to an JSON string
  *
  * @return JSON string
  */
