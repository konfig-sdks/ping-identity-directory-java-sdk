...
public class AddPkcs11KeyManagerProviderRequest {
  ...
  public AddPkcs11KeyManagerProviderRequest() {
  }

  public AddPkcs11KeyManagerProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest description(String description) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest schemas(List<Enumpkcs11KeyManagerProviderSchemaUrn> schemas) {
  ...
  public AddPkcs11KeyManagerProviderRequest addSchemasItem(Enumpkcs11KeyManagerProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest pkcs11ProviderClass(String pkcs11ProviderClass) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest pkcs11ProviderConfigurationFile(String pkcs11ProviderConfigurationFile) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest pkcs11KeyStoreType(String pkcs11KeyStoreType) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest pkcs11MaxCacheDuration(String pkcs11MaxCacheDuration) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest keyStorePin(String keyStorePin) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest keyStorePinFile(String keyStorePinFile) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest keyStorePinPassphraseProvider(String keyStorePinPassphraseProvider) {
  ...
  **/
  ...
  public AddPkcs11KeyManagerProviderRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddPkcs11KeyManagerProviderRequest instance itself
   */
  public AddPkcs11KeyManagerProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPkcs11KeyManagerProviderRequest addPkcs11KeyManagerProviderRequest = (AddPkcs11KeyManagerProviderRequest) o;
    return Objects.equals(this.providerName, addPkcs11KeyManagerProviderRequest.providerName) &&
        Objects.equals(this.description, addPkcs11KeyManagerProviderRequest.description) &&
        Objects.equals(this.schemas, addPkcs11KeyManagerProviderRequest.schemas) &&
        Objects.equals(this.pkcs11ProviderClass, addPkcs11KeyManagerProviderRequest.pkcs11ProviderClass) &&
        Objects.equals(this.pkcs11ProviderConfigurationFile, addPkcs11KeyManagerProviderRequest.pkcs11ProviderConfigurationFile) &&
        Objects.equals(this.pkcs11KeyStoreType, addPkcs11KeyManagerProviderRequest.pkcs11KeyStoreType) &&
        Objects.equals(this.pkcs11MaxCacheDuration, addPkcs11KeyManagerProviderRequest.pkcs11MaxCacheDuration) &&
        Objects.equals(this.keyStorePin, addPkcs11KeyManagerProviderRequest.keyStorePin) &&
        Objects.equals(this.keyStorePinFile, addPkcs11KeyManagerProviderRequest.keyStorePinFile) &&
        Objects.equals(this.keyStorePinPassphraseProvider, addPkcs11KeyManagerProviderRequest.keyStorePinPassphraseProvider) &&
        Objects.equals(this.enabled, addPkcs11KeyManagerProviderRequest.enabled)&&
        Objects.equals(this.additionalProperties, addPkcs11KeyManagerProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, description, schemas, pkcs11ProviderClass, pkcs11ProviderConfigurationFile, pkcs11KeyStoreType, pkcs11MaxCacheDuration, keyStorePin, keyStorePinFile, keyStorePinPassphraseProvider, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPkcs11KeyManagerProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPkcs11KeyManagerProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPkcs11KeyManagerProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPkcs11KeyManagerProviderRequest is not found in the empty JSON string", AddPkcs11KeyManagerProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPkcs11KeyManagerProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPkcs11KeyManagerProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPkcs11KeyManagerProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPkcs11KeyManagerProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPkcs11KeyManagerProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPkcs11KeyManagerProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddPkcs11KeyManagerProviderRequest value) throws IOException {
           ...
           @Override
           public AddPkcs11KeyManagerProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPkcs11KeyManagerProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPkcs11KeyManagerProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPkcs11KeyManagerProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddPkcs11KeyManagerProviderRequest
  */
  public static AddPkcs11KeyManagerProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPkcs11KeyManagerProviderRequest.class);
  }

 /**
  * Convert an instance of AddPkcs11KeyManagerProviderRequest to an JSON string
  *
  * @return JSON string
  */
