...
public class AddPassThroughAuthenticationPluginRequest {
  ...
  public AddPassThroughAuthenticationPluginRequest() {
  }

  public AddPassThroughAuthenticationPluginRequest pluginName(String pluginName) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest description(String description) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest schemas(List<EnumpassThroughAuthenticationPluginSchemaUrn> schemas) {
  ...
  public AddPassThroughAuthenticationPluginRequest addSchemasItem(EnumpassThroughAuthenticationPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public AddPassThroughAuthenticationPluginRequest addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest server(List<String> server) {
  ...
  public AddPassThroughAuthenticationPluginRequest addServerItem(String serverItem) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest tryLocalBind(Boolean tryLocalBind) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the bind attempt should first be attempted against the local server. Depending on the value of the override-local-password property, the bind attempt may then be attempted against a remote server if the local bind fails.")
  ...
  public AddPassThroughAuthenticationPluginRequest overrideLocalPassword(Boolean overrideLocalPassword) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the bind attempt should be attempted against a remote server in the event that the local bind fails but the local password is present.")
  ...
  public AddPassThroughAuthenticationPluginRequest updateLocalPassword(Boolean updateLocalPassword) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the local password value should be updated to the value used in the bind request in the event that the local bind fails but the remote bind succeeds.")
  ...
  public AddPassThroughAuthenticationPluginRequest allowLaxPassThroughAuthenticationPasswords(Boolean allowLaxPassThroughAuthenticationPasswords) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest serverAccessMode(EnumpluginServerAccessModeProp serverAccessMode) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public AddPassThroughAuthenticationPluginRequest addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest dnMap(List<String> dnMap) {
  ...
  public AddPassThroughAuthenticationPluginRequest addDnMapItem(String dnMapItem) {
    if (this.dnMap == null) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest bindDNPattern(String bindDNPattern) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddPassThroughAuthenticationPluginRequest invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the AddPassThroughAuthenticationPluginRequest instance itself
   */
  public AddPassThroughAuthenticationPluginRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPassThroughAuthenticationPluginRequest addPassThroughAuthenticationPluginRequest = (AddPassThroughAuthenticationPluginRequest) o;
    return Objects.equals(this.pluginName, addPassThroughAuthenticationPluginRequest.pluginName) &&
        Objects.equals(this.description, addPassThroughAuthenticationPluginRequest.description) &&
        Objects.equals(this.schemas, addPassThroughAuthenticationPluginRequest.schemas) &&
        Objects.equals(this.pluginType, addPassThroughAuthenticationPluginRequest.pluginType) &&
        Objects.equals(this.server, addPassThroughAuthenticationPluginRequest.server) &&
        Objects.equals(this.tryLocalBind, addPassThroughAuthenticationPluginRequest.tryLocalBind) &&
        Objects.equals(this.overrideLocalPassword, addPassThroughAuthenticationPluginRequest.overrideLocalPassword) &&
        Objects.equals(this.updateLocalPassword, addPassThroughAuthenticationPluginRequest.updateLocalPassword) &&
        Objects.equals(this.allowLaxPassThroughAuthenticationPasswords, addPassThroughAuthenticationPluginRequest.allowLaxPassThroughAuthenticationPasswords) &&
        Objects.equals(this.serverAccessMode, addPassThroughAuthenticationPluginRequest.serverAccessMode) &&
        Objects.equals(this.includedLocalEntryBaseDN, addPassThroughAuthenticationPluginRequest.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, addPassThroughAuthenticationPluginRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addPassThroughAuthenticationPluginRequest.requestCriteria) &&
        Objects.equals(this.dnMap, addPassThroughAuthenticationPluginRequest.dnMap) &&
        Objects.equals(this.bindDNPattern, addPassThroughAuthenticationPluginRequest.bindDNPattern) &&
        Objects.equals(this.searchBaseDN, addPassThroughAuthenticationPluginRequest.searchBaseDN) &&
        Objects.equals(this.searchFilterPattern, addPassThroughAuthenticationPluginRequest.searchFilterPattern) &&
        Objects.equals(this.initialConnections, addPassThroughAuthenticationPluginRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addPassThroughAuthenticationPluginRequest.maxConnections) &&
        Objects.equals(this.enabled, addPassThroughAuthenticationPluginRequest.enabled) &&
        Objects.equals(this.invokeForInternalOperations, addPassThroughAuthenticationPluginRequest.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, addPassThroughAuthenticationPluginRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pluginName, description, schemas, pluginType, server, tryLocalBind, overrideLocalPassword, updateLocalPassword, allowLaxPassThroughAuthenticationPasswords, serverAccessMode, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, dnMap, bindDNPattern, searchBaseDN, searchFilterPattern, initialConnections, maxConnections, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPassThroughAuthenticationPluginRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPassThroughAuthenticationPluginRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPassThroughAuthenticationPluginRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPassThroughAuthenticationPluginRequest is not found in the empty JSON string", AddPassThroughAuthenticationPluginRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPassThroughAuthenticationPluginRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPassThroughAuthenticationPluginRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPassThroughAuthenticationPluginRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPassThroughAuthenticationPluginRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPassThroughAuthenticationPluginRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPassThroughAuthenticationPluginRequest>() {
           @Override
           public void write(JsonWriter out, AddPassThroughAuthenticationPluginRequest value) throws IOException {
           ...
           @Override
           public AddPassThroughAuthenticationPluginRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPassThroughAuthenticationPluginRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPassThroughAuthenticationPluginRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPassThroughAuthenticationPluginRequest
  * @throws IOException if the JSON string is invalid with respect to AddPassThroughAuthenticationPluginRequest
  */
  public static AddPassThroughAuthenticationPluginRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPassThroughAuthenticationPluginRequest.class);
  }

 /**
  * Convert an instance of AddPassThroughAuthenticationPluginRequest to an JSON string
  *
  * @return JSON string
  */
