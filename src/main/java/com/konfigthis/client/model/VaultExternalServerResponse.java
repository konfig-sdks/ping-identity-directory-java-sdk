...
public class VaultExternalServerResponse {
  ...
  public VaultExternalServerResponse() {
  }

  public VaultExternalServerResponse id(String id) {
  ...
  **/
  ...
  public VaultExternalServerResponse description(String description) {
  ...
  **/
  ...
  public VaultExternalServerResponse schemas(List<EnumvaultExternalServerSchemaUrn> schemas) {
  ...
  public VaultExternalServerResponse addSchemasItem(EnumvaultExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultExternalServerResponse vaultServerBaseURI(List<String> vaultServerBaseURI) {
  ...
  public VaultExternalServerResponse addVaultServerBaseURIItem(String vaultServerBaseURIItem) {
  ...
  **/
  ...
  public VaultExternalServerResponse vaultAuthenticationMethod(String vaultAuthenticationMethod) {
  ...
  **/
  ...
  public VaultExternalServerResponse httpConnectTimeout(String httpConnectTimeout) {
  ...
  **/
  ...
  public VaultExternalServerResponse httpResponseTimeout(String httpResponseTimeout) {
  ...
  **/
  ...
  public VaultExternalServerResponse trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public VaultExternalServerResponse trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public VaultExternalServerResponse trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public VaultExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public VaultExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the VaultExternalServerResponse instance itself
   */
  public VaultExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultExternalServerResponse vaultExternalServerResponse = (VaultExternalServerResponse) o;
    return Objects.equals(this.id, vaultExternalServerResponse.id) &&
        Objects.equals(this.description, vaultExternalServerResponse.description) &&
        Objects.equals(this.schemas, vaultExternalServerResponse.schemas) &&
        Objects.equals(this.vaultServerBaseURI, vaultExternalServerResponse.vaultServerBaseURI) &&
        Objects.equals(this.vaultAuthenticationMethod, vaultExternalServerResponse.vaultAuthenticationMethod) &&
        Objects.equals(this.httpConnectTimeout, vaultExternalServerResponse.httpConnectTimeout) &&
        Objects.equals(this.httpResponseTimeout, vaultExternalServerResponse.httpResponseTimeout) &&
        Objects.equals(this.trustStoreFile, vaultExternalServerResponse.trustStoreFile) &&
        Objects.equals(this.trustStorePin, vaultExternalServerResponse.trustStorePin) &&
        Objects.equals(this.trustStoreType, vaultExternalServerResponse.trustStoreType) &&
        Objects.equals(this.meta, vaultExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, vaultExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, vaultExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, vaultServerBaseURI, vaultAuthenticationMethod, httpConnectTimeout, httpResponseTimeout, trustStoreFile, trustStorePin, trustStoreType, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultExternalServerResponse is not found in the empty JSON string", VaultExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, VaultExternalServerResponse value) throws IOException {
           ...
           @Override
           public VaultExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to VaultExternalServerResponse
  */
  public static VaultExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultExternalServerResponse.class);
  }

 /**
  * Convert an instance of VaultExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
