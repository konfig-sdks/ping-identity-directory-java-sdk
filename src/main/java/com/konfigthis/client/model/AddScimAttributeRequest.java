...
public class AddScimAttributeRequest {
  ...
  public AddScimAttributeRequest() {
  }

  public AddScimAttributeRequest attributeName(String attributeName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new SCIM Attribute")
  ...
  public AddScimAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddScimAttributeRequest schemas(List<EnumscimAttributeSchemaUrn> schemas) {
  ...
  public AddScimAttributeRequest addSchemasItem(EnumscimAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddScimAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddScimAttributeRequest type(EnumscimAttributeTypeProp type) {
  ...
  **/
  ...
  public AddScimAttributeRequest required(Boolean required) {
  ...
  **/
  ...
  public AddScimAttributeRequest caseExact(Boolean caseExact) {
  ...
  **/
  ...
  public AddScimAttributeRequest multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public AddScimAttributeRequest canonicalValue(List<String> canonicalValue) {
  ...
  public AddScimAttributeRequest addCanonicalValueItem(String canonicalValueItem) {
  ...
  **/
  ...
  public AddScimAttributeRequest mutability(EnumscimAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public AddScimAttributeRequest returned(EnumscimAttributeReturnedProp returned) {
  ...
  **/
  ...
  public AddScimAttributeRequest referenceType(List<String> referenceType) {
  ...
  public AddScimAttributeRequest addReferenceTypeItem(String referenceTypeItem) {
  ...
  **/
   ...
   * @return the AddScimAttributeRequest instance itself
   */
  public AddScimAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddScimAttributeRequest addScimAttributeRequest = (AddScimAttributeRequest) o;
    return Objects.equals(this.attributeName, addScimAttributeRequest.attributeName) &&
        Objects.equals(this.description, addScimAttributeRequest.description) &&
        Objects.equals(this.schemas, addScimAttributeRequest.schemas) &&
        Objects.equals(this.name, addScimAttributeRequest.name) &&
        Objects.equals(this.type, addScimAttributeRequest.type) &&
        Objects.equals(this.required, addScimAttributeRequest.required) &&
        Objects.equals(this.caseExact, addScimAttributeRequest.caseExact) &&
        Objects.equals(this.multiValued, addScimAttributeRequest.multiValued) &&
        Objects.equals(this.canonicalValue, addScimAttributeRequest.canonicalValue) &&
        Objects.equals(this.mutability, addScimAttributeRequest.mutability) &&
        Objects.equals(this.returned, addScimAttributeRequest.returned) &&
        Objects.equals(this.referenceType, addScimAttributeRequest.referenceType)&&
        Objects.equals(this.additionalProperties, addScimAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(attributeName, description, schemas, name, type, required, caseExact, multiValued, canonicalValue, mutability, returned, referenceType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddScimAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddScimAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddScimAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddScimAttributeRequest is not found in the empty JSON string", AddScimAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddScimAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddScimAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddScimAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddScimAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddScimAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddScimAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddScimAttributeRequest value) throws IOException {
           ...
           @Override
           public AddScimAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddScimAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddScimAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddScimAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddScimAttributeRequest
  */
  public static AddScimAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddScimAttributeRequest.class);
  }

 /**
  * Convert an instance of AddScimAttributeRequest to an JSON string
  *
  * @return JSON string
  */
