...
public class AddOracleUnifiedDirectoryExternalServerRequest {
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest() {
  }

  public AddOracleUnifiedDirectoryExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest schemas(List<EnumoracleUnifiedDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest addSchemasItem(EnumoracleUnifiedDirectoryExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest location(String location) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest bindDN(String bindDN) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest password(String password) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest connectionSecurity(EnumexternalServerOracleUnifiedDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest authenticationMethod(EnumexternalServerOracleUnifiedDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public AddOracleUnifiedDirectoryExternalServerRequest abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the AddOracleUnifiedDirectoryExternalServerRequest instance itself
   */
  public AddOracleUnifiedDirectoryExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddOracleUnifiedDirectoryExternalServerRequest addOracleUnifiedDirectoryExternalServerRequest = (AddOracleUnifiedDirectoryExternalServerRequest) o;
    return Objects.equals(this.serverName, addOracleUnifiedDirectoryExternalServerRequest.serverName) &&
        Objects.equals(this.description, addOracleUnifiedDirectoryExternalServerRequest.description) &&
        Objects.equals(this.schemas, addOracleUnifiedDirectoryExternalServerRequest.schemas) &&
        Objects.equals(this.serverHostName, addOracleUnifiedDirectoryExternalServerRequest.serverHostName) &&
        Objects.equals(this.serverPort, addOracleUnifiedDirectoryExternalServerRequest.serverPort) &&
        Objects.equals(this.location, addOracleUnifiedDirectoryExternalServerRequest.location) &&
        Objects.equals(this.bindDN, addOracleUnifiedDirectoryExternalServerRequest.bindDN) &&
        Objects.equals(this.password, addOracleUnifiedDirectoryExternalServerRequest.password) &&
        Objects.equals(this.passphraseProvider, addOracleUnifiedDirectoryExternalServerRequest.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, addOracleUnifiedDirectoryExternalServerRequest.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, addOracleUnifiedDirectoryExternalServerRequest.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, addOracleUnifiedDirectoryExternalServerRequest.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, addOracleUnifiedDirectoryExternalServerRequest.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, addOracleUnifiedDirectoryExternalServerRequest.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, addOracleUnifiedDirectoryExternalServerRequest.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, addOracleUnifiedDirectoryExternalServerRequest.connectTimeout) &&
        Objects.equals(this.maxResponseSize, addOracleUnifiedDirectoryExternalServerRequest.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, addOracleUnifiedDirectoryExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addOracleUnifiedDirectoryExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.initialConnections, addOracleUnifiedDirectoryExternalServerRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addOracleUnifiedDirectoryExternalServerRequest.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, addOracleUnifiedDirectoryExternalServerRequest.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, addOracleUnifiedDirectoryExternalServerRequest.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, addOracleUnifiedDirectoryExternalServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, description, schemas, serverHostName, serverPort, location, bindDN, password, passphraseProvider, connectionSecurity, authenticationMethod, verifyCredentialsMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddOracleUnifiedDirectoryExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddOracleUnifiedDirectoryExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddOracleUnifiedDirectoryExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddOracleUnifiedDirectoryExternalServerRequest is not found in the empty JSON string", AddOracleUnifiedDirectoryExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddOracleUnifiedDirectoryExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddOracleUnifiedDirectoryExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddOracleUnifiedDirectoryExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddOracleUnifiedDirectoryExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddOracleUnifiedDirectoryExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddOracleUnifiedDirectoryExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddOracleUnifiedDirectoryExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddOracleUnifiedDirectoryExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddOracleUnifiedDirectoryExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddOracleUnifiedDirectoryExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddOracleUnifiedDirectoryExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddOracleUnifiedDirectoryExternalServerRequest
  */
  public static AddOracleUnifiedDirectoryExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddOracleUnifiedDirectoryExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddOracleUnifiedDirectoryExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
