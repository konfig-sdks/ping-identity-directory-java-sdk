...
public class AddLeaveLockdownModeRecurringTaskRequest {
  ...
  public AddLeaveLockdownModeRecurringTaskRequest() {
  }

  public AddLeaveLockdownModeRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest schemas(List<EnumleaveLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public AddLeaveLockdownModeRecurringTaskRequest addSchemasItem(EnumleaveLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest reason(String reason) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddLeaveLockdownModeRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddLeaveLockdownModeRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddLeaveLockdownModeRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddLeaveLockdownModeRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddLeaveLockdownModeRecurringTaskRequest instance itself
   */
  public AddLeaveLockdownModeRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddLeaveLockdownModeRecurringTaskRequest addLeaveLockdownModeRecurringTaskRequest = (AddLeaveLockdownModeRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addLeaveLockdownModeRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addLeaveLockdownModeRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addLeaveLockdownModeRecurringTaskRequest.schemas) &&
        Objects.equals(this.reason, addLeaveLockdownModeRecurringTaskRequest.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addLeaveLockdownModeRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addLeaveLockdownModeRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addLeaveLockdownModeRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addLeaveLockdownModeRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addLeaveLockdownModeRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addLeaveLockdownModeRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addLeaveLockdownModeRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addLeaveLockdownModeRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, reason, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddLeaveLockdownModeRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddLeaveLockdownModeRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddLeaveLockdownModeRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLeaveLockdownModeRecurringTaskRequest is not found in the empty JSON string", AddLeaveLockdownModeRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLeaveLockdownModeRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLeaveLockdownModeRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLeaveLockdownModeRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLeaveLockdownModeRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLeaveLockdownModeRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLeaveLockdownModeRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddLeaveLockdownModeRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddLeaveLockdownModeRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddLeaveLockdownModeRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddLeaveLockdownModeRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddLeaveLockdownModeRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddLeaveLockdownModeRecurringTaskRequest
  */
  public static AddLeaveLockdownModeRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLeaveLockdownModeRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddLeaveLockdownModeRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
