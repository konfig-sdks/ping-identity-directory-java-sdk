...
public class LdapPassThroughAuthenticationHandlerResponse {
  ...
  public LdapPassThroughAuthenticationHandlerResponse() {
  }

  public LdapPassThroughAuthenticationHandlerResponse id(String id) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse description(String description) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse schemas(List<EnumldapPassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public LdapPassThroughAuthenticationHandlerResponse addSchemasItem(EnumldapPassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse server(List<String> server) {
  ...
  public LdapPassThroughAuthenticationHandlerResponse addServerItem(String serverItem) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse serverAccessMode(EnumpassThroughAuthenticationHandlerServerAccessModeProp serverAccessMode) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse dnMap(List<String> dnMap) {
  ...
  public LdapPassThroughAuthenticationHandlerResponse addDnMapItem(String dnMapItem) {
    if (this.dnMap == null) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse bindDNPattern(String bindDNPattern) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse useLocation(Boolean useLocation) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse maximumAllowedLocalResponseTime(String maximumAllowedLocalResponseTime) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse maximumAllowedNonlocalResponseTime(String maximumAllowedNonlocalResponseTime) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse usePasswordPolicyControl(Boolean usePasswordPolicyControl) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public LdapPassThroughAuthenticationHandlerResponse addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdapPassThroughAuthenticationHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdapPassThroughAuthenticationHandlerResponse instance itself
   */
  public LdapPassThroughAuthenticationHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapPassThroughAuthenticationHandlerResponse ldapPassThroughAuthenticationHandlerResponse = (LdapPassThroughAuthenticationHandlerResponse) o;
    return Objects.equals(this.id, ldapPassThroughAuthenticationHandlerResponse.id) &&
        Objects.equals(this.description, ldapPassThroughAuthenticationHandlerResponse.description) &&
        Objects.equals(this.schemas, ldapPassThroughAuthenticationHandlerResponse.schemas) &&
        Objects.equals(this.server, ldapPassThroughAuthenticationHandlerResponse.server) &&
        Objects.equals(this.serverAccessMode, ldapPassThroughAuthenticationHandlerResponse.serverAccessMode) &&
        Objects.equals(this.dnMap, ldapPassThroughAuthenticationHandlerResponse.dnMap) &&
        Objects.equals(this.bindDNPattern, ldapPassThroughAuthenticationHandlerResponse.bindDNPattern) &&
        Objects.equals(this.searchBaseDN, ldapPassThroughAuthenticationHandlerResponse.searchBaseDN) &&
        Objects.equals(this.searchFilterPattern, ldapPassThroughAuthenticationHandlerResponse.searchFilterPattern) &&
        Objects.equals(this.initialConnections, ldapPassThroughAuthenticationHandlerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, ldapPassThroughAuthenticationHandlerResponse.maxConnections) &&
        Objects.equals(this.useLocation, ldapPassThroughAuthenticationHandlerResponse.useLocation) &&
        Objects.equals(this.maximumAllowedLocalResponseTime, ldapPassThroughAuthenticationHandlerResponse.maximumAllowedLocalResponseTime) &&
        Objects.equals(this.maximumAllowedNonlocalResponseTime, ldapPassThroughAuthenticationHandlerResponse.maximumAllowedNonlocalResponseTime) &&
        Objects.equals(this.usePasswordPolicyControl, ldapPassThroughAuthenticationHandlerResponse.usePasswordPolicyControl) &&
        Objects.equals(this.includedLocalEntryBaseDN, ldapPassThroughAuthenticationHandlerResponse.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, ldapPassThroughAuthenticationHandlerResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, ldapPassThroughAuthenticationHandlerResponse.requestCriteria) &&
        Objects.equals(this.meta, ldapPassThroughAuthenticationHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldapPassThroughAuthenticationHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldapPassThroughAuthenticationHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, server, serverAccessMode, dnMap, bindDNPattern, searchBaseDN, searchFilterPattern, initialConnections, maxConnections, useLocation, maximumAllowedLocalResponseTime, maximumAllowedNonlocalResponseTime, usePasswordPolicyControl, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdapPassThroughAuthenticationHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapPassThroughAuthenticationHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapPassThroughAuthenticationHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapPassThroughAuthenticationHandlerResponse is not found in the empty JSON string", LdapPassThroughAuthenticationHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdapPassThroughAuthenticationHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapPassThroughAuthenticationHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapPassThroughAuthenticationHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapPassThroughAuthenticationHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapPassThroughAuthenticationHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapPassThroughAuthenticationHandlerResponse>() {
           @Override
           public void write(JsonWriter out, LdapPassThroughAuthenticationHandlerResponse value) throws IOException {
           ...
           @Override
           public LdapPassThroughAuthenticationHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapPassThroughAuthenticationHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapPassThroughAuthenticationHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapPassThroughAuthenticationHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to LdapPassThroughAuthenticationHandlerResponse
  */
  public static LdapPassThroughAuthenticationHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapPassThroughAuthenticationHandlerResponse.class);
  }

 /**
  * Convert an instance of LdapPassThroughAuthenticationHandlerResponse to an JSON string
  *
  * @return JSON string
  */
