...
public class ThirdPartyFileBasedAccessLogPublisherResponse {
  ...
  private List<EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse() {
  }

  public ThirdPartyFileBasedAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse schemas(List<EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse addSchemasItem(EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumthirdPartyFileBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the Third Party File Based Access Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Third Party File Based Access Log Publisher.")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Third Party File Based Access Log Publisher .")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Third Party File Based Access Log Publisher .")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse extensionClass(String extensionClass) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fully-qualified name of the Java class providing the logic for the Third Party File Based Access Log Publisher.")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of arguments used to customize the behavior for the Third Party File Based Access Log Publisher. Each configuration property should be given in the form 'name=value'.")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Third Party File Based Access Log Publisher will publish records asynchronously.")
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyFileBasedAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyFileBasedAccessLogPublisherResponse instance itself
   */
  public ThirdPartyFileBasedAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyFileBasedAccessLogPublisherResponse thirdPartyFileBasedAccessLogPublisherResponse = (ThirdPartyFileBasedAccessLogPublisherResponse) o;
    return Objects.equals(this.id, thirdPartyFileBasedAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, thirdPartyFileBasedAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, thirdPartyFileBasedAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, thirdPartyFileBasedAccessLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, thirdPartyFileBasedAccessLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, thirdPartyFileBasedAccessLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, thirdPartyFileBasedAccessLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, thirdPartyFileBasedAccessLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, thirdPartyFileBasedAccessLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, thirdPartyFileBasedAccessLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, thirdPartyFileBasedAccessLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, thirdPartyFileBasedAccessLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, thirdPartyFileBasedAccessLogPublisherResponse.append) &&
        Objects.equals(this.extensionClass, thirdPartyFileBasedAccessLogPublisherResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyFileBasedAccessLogPublisherResponse.extensionArgument) &&
        Objects.equals(this.asynchronous, thirdPartyFileBasedAccessLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, thirdPartyFileBasedAccessLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, thirdPartyFileBasedAccessLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, thirdPartyFileBasedAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, thirdPartyFileBasedAccessLogPublisherResponse.timeInterval) &&
        Objects.equals(this.logConnects, thirdPartyFileBasedAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, thirdPartyFileBasedAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, thirdPartyFileBasedAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, thirdPartyFileBasedAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, thirdPartyFileBasedAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, thirdPartyFileBasedAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logSearchEntries, thirdPartyFileBasedAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, thirdPartyFileBasedAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, thirdPartyFileBasedAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, thirdPartyFileBasedAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, thirdPartyFileBasedAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, thirdPartyFileBasedAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, thirdPartyFileBasedAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, thirdPartyFileBasedAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, thirdPartyFileBasedAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, thirdPartyFileBasedAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, thirdPartyFileBasedAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, thirdPartyFileBasedAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, thirdPartyFileBasedAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, thirdPartyFileBasedAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyFileBasedAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyFileBasedAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, extensionClass, extensionArgument, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyFileBasedAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyFileBasedAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyFileBasedAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyFileBasedAccessLogPublisherResponse is not found in the empty JSON string", ThirdPartyFileBasedAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyFileBasedAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyFileBasedAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyFileBasedAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyFileBasedAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyFileBasedAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyFileBasedAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyFileBasedAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyFileBasedAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyFileBasedAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyFileBasedAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyFileBasedAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyFileBasedAccessLogPublisherResponse
  */
  public static ThirdPartyFileBasedAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyFileBasedAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyFileBasedAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
