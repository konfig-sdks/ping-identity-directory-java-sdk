...
import com.konfigthis.client.model.EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn;
...
public class GroovyScriptedFileBasedErrorLogPublisherResponse {
  ...
  private List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse() {
  }

  public GroovyScriptedFileBasedErrorLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse schemas(List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addSchemasItem(EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse scriptClass(String scriptClass) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fully-qualified name of the Groovy class providing the logic for the Groovy Scripted File Based Error Log Publisher.")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the Scripted File Based Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Scripted File Based Error Log Publisher.")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Scripted File Based Error Log Publisher .")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Scripted File Based Error Log Publisher .")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of arguments used to customize the behavior for the Scripted File Based Error Log Publisher. Each configuration property should be given in the form 'name=value'.")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Scripted File Based Error Log Publisher will publish records asynchronously.")
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse overrideSeverity(List<String> overrideSeverity) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GroovyScriptedFileBasedErrorLogPublisherResponse instance itself
   */
  public GroovyScriptedFileBasedErrorLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedFileBasedErrorLogPublisherResponse groovyScriptedFileBasedErrorLogPublisherResponse = (GroovyScriptedFileBasedErrorLogPublisherResponse) o;
    return Objects.equals(this.id, groovyScriptedFileBasedErrorLogPublisherResponse.id) &&
        Objects.equals(this.description, groovyScriptedFileBasedErrorLogPublisherResponse.description) &&
        Objects.equals(this.schemas, groovyScriptedFileBasedErrorLogPublisherResponse.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedFileBasedErrorLogPublisherResponse.scriptClass) &&
        Objects.equals(this.logFile, groovyScriptedFileBasedErrorLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, groovyScriptedFileBasedErrorLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, groovyScriptedFileBasedErrorLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, groovyScriptedFileBasedErrorLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, groovyScriptedFileBasedErrorLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, groovyScriptedFileBasedErrorLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, groovyScriptedFileBasedErrorLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, groovyScriptedFileBasedErrorLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, groovyScriptedFileBasedErrorLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, groovyScriptedFileBasedErrorLogPublisherResponse.append) &&
        Objects.equals(this.scriptArgument, groovyScriptedFileBasedErrorLogPublisherResponse.scriptArgument) &&
        Objects.equals(this.asynchronous, groovyScriptedFileBasedErrorLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, groovyScriptedFileBasedErrorLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, groovyScriptedFileBasedErrorLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, groovyScriptedFileBasedErrorLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, groovyScriptedFileBasedErrorLogPublisherResponse.timeInterval) &&
        Objects.equals(this.defaultSeverity, groovyScriptedFileBasedErrorLogPublisherResponse.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, groovyScriptedFileBasedErrorLogPublisherResponse.overrideSeverity) &&
        Objects.equals(this.enabled, groovyScriptedFileBasedErrorLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, groovyScriptedFileBasedErrorLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, groovyScriptedFileBasedErrorLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, groovyScriptedFileBasedErrorLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, groovyScriptedFileBasedErrorLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, scriptClass, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, scriptArgument, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroovyScriptedFileBasedErrorLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedFileBasedErrorLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedFileBasedErrorLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedFileBasedErrorLogPublisherResponse is not found in the empty JSON string", GroovyScriptedFileBasedErrorLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedFileBasedErrorLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedFileBasedErrorLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedFileBasedErrorLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedFileBasedErrorLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedFileBasedErrorLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedFileBasedErrorLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedFileBasedErrorLogPublisherResponse value) throws IOException {
           ...
           @Override
           public GroovyScriptedFileBasedErrorLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedFileBasedErrorLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedFileBasedErrorLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedFileBasedErrorLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedFileBasedErrorLogPublisherResponse
  */
  public static GroovyScriptedFileBasedErrorLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedFileBasedErrorLogPublisherResponse.class);
  }

 /**
  * Convert an instance of GroovyScriptedFileBasedErrorLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
