...
public class UserDefinedVirtualAttributeResponse {
  ...
  public UserDefinedVirtualAttributeResponse() {
  }

  public UserDefinedVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse schemas(List<EnumuserDefinedVirtualAttributeSchemaUrn> schemas) {
  ...
  public UserDefinedVirtualAttributeResponse addSchemasItem(EnumuserDefinedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse value(List<String> value) {
  ...
  public UserDefinedVirtualAttributeResponse addValueItem(String valueItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public UserDefinedVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public UserDefinedVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse filter(List<String> filter) {
  ...
  public UserDefinedVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public UserDefinedVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UserDefinedVirtualAttributeResponse instance itself
   */
  public UserDefinedVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserDefinedVirtualAttributeResponse userDefinedVirtualAttributeResponse = (UserDefinedVirtualAttributeResponse) o;
    return Objects.equals(this.id, userDefinedVirtualAttributeResponse.id) &&
        Objects.equals(this.description, userDefinedVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, userDefinedVirtualAttributeResponse.schemas) &&
        Objects.equals(this.value, userDefinedVirtualAttributeResponse.value) &&
        Objects.equals(this.enabled, userDefinedVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, userDefinedVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, userDefinedVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, userDefinedVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, userDefinedVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, userDefinedVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, userDefinedVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, userDefinedVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, userDefinedVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, userDefinedVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, userDefinedVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, userDefinedVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, userDefinedVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, userDefinedVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, value, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserDefinedVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserDefinedVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserDefinedVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDefinedVirtualAttributeResponse is not found in the empty JSON string", UserDefinedVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserDefinedVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDefinedVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDefinedVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDefinedVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDefinedVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDefinedVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, UserDefinedVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public UserDefinedVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserDefinedVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserDefinedVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserDefinedVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to UserDefinedVirtualAttributeResponse
  */
  public static UserDefinedVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDefinedVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of UserDefinedVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
