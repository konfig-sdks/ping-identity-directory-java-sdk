...
public class GroovyScriptedPasswordValidatorResponse {
  ...
  public GroovyScriptedPasswordValidatorResponse() {
  }

  public GroovyScriptedPasswordValidatorResponse id(String id) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse description(String description) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse schemas(List<EnumgroovyScriptedPasswordValidatorSchemaUrn> schemas) {
  ...
  public GroovyScriptedPasswordValidatorResponse addSchemasItem(EnumgroovyScriptedPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedPasswordValidatorResponse addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GroovyScriptedPasswordValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GroovyScriptedPasswordValidatorResponse instance itself
   */
  public GroovyScriptedPasswordValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedPasswordValidatorResponse groovyScriptedPasswordValidatorResponse = (GroovyScriptedPasswordValidatorResponse) o;
    return Objects.equals(this.id, groovyScriptedPasswordValidatorResponse.id) &&
        Objects.equals(this.description, groovyScriptedPasswordValidatorResponse.description) &&
        Objects.equals(this.schemas, groovyScriptedPasswordValidatorResponse.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedPasswordValidatorResponse.scriptClass) &&
        Objects.equals(this.scriptArgument, groovyScriptedPasswordValidatorResponse.scriptArgument) &&
        Objects.equals(this.enabled, groovyScriptedPasswordValidatorResponse.enabled) &&
        Objects.equals(this.validatorRequirementDescription, groovyScriptedPasswordValidatorResponse.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, groovyScriptedPasswordValidatorResponse.validatorFailureMessage) &&
        Objects.equals(this.meta, groovyScriptedPasswordValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, groovyScriptedPasswordValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, groovyScriptedPasswordValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, scriptClass, scriptArgument, enabled, validatorRequirementDescription, validatorFailureMessage, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroovyScriptedPasswordValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedPasswordValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedPasswordValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedPasswordValidatorResponse is not found in the empty JSON string", GroovyScriptedPasswordValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedPasswordValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedPasswordValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedPasswordValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedPasswordValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedPasswordValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedPasswordValidatorResponse>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedPasswordValidatorResponse value) throws IOException {
           ...
           @Override
           public GroovyScriptedPasswordValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedPasswordValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedPasswordValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedPasswordValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedPasswordValidatorResponse
  */
  public static GroovyScriptedPasswordValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedPasswordValidatorResponse.class);
  }

 /**
  * Convert an instance of GroovyScriptedPasswordValidatorResponse to an JSON string
  *
  * @return JSON string
  */
