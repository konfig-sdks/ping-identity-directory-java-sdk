...
public class MetricsEngineServerInstanceResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnummetricsEngineServerInstanceSchemaUrn> schemas = new ArrayList<>();
  ...
  public MetricsEngineServerInstanceResponse() {
  }

  public MetricsEngineServerInstanceResponse schemas(List<EnummetricsEngineServerInstanceSchemaUrn> schemas) {
  ...
  public MetricsEngineServerInstanceResponse addSchemasItem(EnummetricsEngineServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse id(String id) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse clusterName(String clusterName) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse hostname(String hostname) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse serverRoot(String serverRoot) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse serverVersion(String serverVersion) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse httpPort(Integer httpPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public MetricsEngineServerInstanceResponse addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse baseDN(List<String> baseDN) {
  ...
  public MetricsEngineServerInstanceResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public MetricsEngineServerInstanceResponse addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MetricsEngineServerInstanceResponse instance itself
   */
  public MetricsEngineServerInstanceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricsEngineServerInstanceResponse metricsEngineServerInstanceResponse = (MetricsEngineServerInstanceResponse) o;
    return Objects.equals(this.schemas, metricsEngineServerInstanceResponse.schemas) &&
        Objects.equals(this.id, metricsEngineServerInstanceResponse.id) &&
        Objects.equals(this.serverInstanceType, metricsEngineServerInstanceResponse.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, metricsEngineServerInstanceResponse.serverInstanceName) &&
        Objects.equals(this.clusterName, metricsEngineServerInstanceResponse.clusterName) &&
        Objects.equals(this.serverInstanceLocation, metricsEngineServerInstanceResponse.serverInstanceLocation) &&
        Objects.equals(this.hostname, metricsEngineServerInstanceResponse.hostname) &&
        Objects.equals(this.serverRoot, metricsEngineServerInstanceResponse.serverRoot) &&
        Objects.equals(this.serverVersion, metricsEngineServerInstanceResponse.serverVersion) &&
        Objects.equals(this.interServerCertificate, metricsEngineServerInstanceResponse.interServerCertificate) &&
        Objects.equals(this.ldapPort, metricsEngineServerInstanceResponse.ldapPort) &&
        Objects.equals(this.ldapsPort, metricsEngineServerInstanceResponse.ldapsPort) &&
        Objects.equals(this.httpPort, metricsEngineServerInstanceResponse.httpPort) &&
        Objects.equals(this.httpsPort, metricsEngineServerInstanceResponse.httpsPort) &&
        Objects.equals(this.replicationPort, metricsEngineServerInstanceResponse.replicationPort) &&
        Objects.equals(this.replicationServerID, metricsEngineServerInstanceResponse.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, metricsEngineServerInstanceResponse.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, metricsEngineServerInstanceResponse.jmxPort) &&
        Objects.equals(this.jmxsPort, metricsEngineServerInstanceResponse.jmxsPort) &&
        Objects.equals(this.preferredSecurity, metricsEngineServerInstanceResponse.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, metricsEngineServerInstanceResponse.startTLSEnabled) &&
        Objects.equals(this.baseDN, metricsEngineServerInstanceResponse.baseDN) &&
        Objects.equals(this.memberOfServerGroup, metricsEngineServerInstanceResponse.memberOfServerGroup) &&
        Objects.equals(this.meta, metricsEngineServerInstanceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, metricsEngineServerInstanceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, metricsEngineServerInstanceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetricsEngineServerInstanceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetricsEngineServerInstanceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricsEngineServerInstanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricsEngineServerInstanceResponse is not found in the empty JSON string", MetricsEngineServerInstanceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MetricsEngineServerInstanceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricsEngineServerInstanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricsEngineServerInstanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricsEngineServerInstanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricsEngineServerInstanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricsEngineServerInstanceResponse>() {
           @Override
           public void write(JsonWriter out, MetricsEngineServerInstanceResponse value) throws IOException {
           ...
           @Override
           public MetricsEngineServerInstanceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetricsEngineServerInstanceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetricsEngineServerInstanceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetricsEngineServerInstanceResponse
  * @throws IOException if the JSON string is invalid with respect to MetricsEngineServerInstanceResponse
  */
  public static MetricsEngineServerInstanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricsEngineServerInstanceResponse.class);
  }

 /**
  * Convert an instance of MetricsEngineServerInstanceResponse to an JSON string
  *
  * @return JSON string
  */
