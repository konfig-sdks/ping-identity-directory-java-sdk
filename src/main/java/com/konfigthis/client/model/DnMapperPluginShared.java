...
public class DnMapperPluginShared {
  ...
  public DnMapperPluginShared() {
  }

  public DnMapperPluginShared description(String description) {
  ...
  **/
  ...
  public DnMapperPluginShared schemas(List<EnumdnMapperPluginSchemaUrn> schemas) {
  ...
  public DnMapperPluginShared addSchemasItem(EnumdnMapperPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DnMapperPluginShared pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public DnMapperPluginShared addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public DnMapperPluginShared sourceDN(String sourceDN) {
  ...
  **/
  ...
  public DnMapperPluginShared targetDN(String targetDN) {
  ...
  **/
  ...
  public DnMapperPluginShared enableAttributeMapping(Boolean enableAttributeMapping) {
  ...
  **/
  ...
  public DnMapperPluginShared mapAttribute(List<String> mapAttribute) {
  ...
  public DnMapperPluginShared addMapAttributeItem(String mapAttributeItem) {
  ...
  **/
  ...
  public DnMapperPluginShared enableControlMapping(Boolean enableControlMapping) {
  ...
  **/
  ...
  public DnMapperPluginShared alwaysMapResponses(Boolean alwaysMapResponses) {
  ...
  **/
  ...
  public DnMapperPluginShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public DnMapperPluginShared invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the DnMapperPluginShared instance itself
   */
  public DnMapperPluginShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DnMapperPluginShared dnMapperPluginShared = (DnMapperPluginShared) o;
    return Objects.equals(this.description, dnMapperPluginShared.description) &&
        Objects.equals(this.schemas, dnMapperPluginShared.schemas) &&
        Objects.equals(this.pluginType, dnMapperPluginShared.pluginType) &&
        Objects.equals(this.sourceDN, dnMapperPluginShared.sourceDN) &&
        Objects.equals(this.targetDN, dnMapperPluginShared.targetDN) &&
        Objects.equals(this.enableAttributeMapping, dnMapperPluginShared.enableAttributeMapping) &&
        Objects.equals(this.mapAttribute, dnMapperPluginShared.mapAttribute) &&
        Objects.equals(this.enableControlMapping, dnMapperPluginShared.enableControlMapping) &&
        Objects.equals(this.alwaysMapResponses, dnMapperPluginShared.alwaysMapResponses) &&
        Objects.equals(this.enabled, dnMapperPluginShared.enabled) &&
        Objects.equals(this.invokeForInternalOperations, dnMapperPluginShared.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, dnMapperPluginShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, pluginType, sourceDN, targetDN, enableAttributeMapping, mapAttribute, enableControlMapping, alwaysMapResponses, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DnMapperPluginShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DnMapperPluginShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DnMapperPluginShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnMapperPluginShared is not found in the empty JSON string", DnMapperPluginShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DnMapperPluginShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnMapperPluginShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnMapperPluginShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnMapperPluginShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnMapperPluginShared.class));

       return (TypeAdapter<T>) new TypeAdapter<DnMapperPluginShared>() {
           @Override
           public void write(JsonWriter out, DnMapperPluginShared value) throws IOException {
           ...
           @Override
           public DnMapperPluginShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DnMapperPluginShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DnMapperPluginShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnMapperPluginShared
  * @throws IOException if the JSON string is invalid with respect to DnMapperPluginShared
  */
  public static DnMapperPluginShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnMapperPluginShared.class);
  }

 /**
  * Convert an instance of DnMapperPluginShared to an JSON string
  *
  * @return JSON string
  */
