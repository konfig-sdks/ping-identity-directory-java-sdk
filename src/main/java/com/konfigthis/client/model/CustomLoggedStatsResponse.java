...
public class CustomLoggedStatsResponse {
  ...
  public CustomLoggedStatsResponse() {
  }

  public CustomLoggedStatsResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Custom Logged Stats")
  ...
  public CustomLoggedStatsResponse description(String description) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse schemas(List<EnumcustomLoggedStatsSchemaUrn> schemas) {
  ...
  public CustomLoggedStatsResponse addSchemasItem(EnumcustomLoggedStatsSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Custom Logged Stats object is enabled.")
  ...
  public CustomLoggedStatsResponse monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse includeFilter(String includeFilter) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse attributeToLog(List<String> attributeToLog) {
  ...
  public CustomLoggedStatsResponse addAttributeToLogItem(String attributeToLogItem) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse columnName(List<String> columnName) {
  ...
  public CustomLoggedStatsResponse addColumnNameItem(String columnNameItem) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse statisticType(List<EnumcustomLoggedStatsStatisticTypeProp> statisticType) {
  ...
  public CustomLoggedStatsResponse addStatisticTypeItem(EnumcustomLoggedStatsStatisticTypeProp statisticTypeItem) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse headerPrefix(String headerPrefix) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse headerPrefixAttribute(String headerPrefixAttribute) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse regexPattern(String regexPattern) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse regexReplacement(String regexReplacement) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse divideValueBy(String divideValueBy) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse divideValueByAttribute(String divideValueByAttribute) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse decimalFormat(String decimalFormat) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse nonZeroImpliesNotIdle(Boolean nonZeroImpliesNotIdle) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public CustomLoggedStatsResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the CustomLoggedStatsResponse instance itself
   */
  public CustomLoggedStatsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomLoggedStatsResponse customLoggedStatsResponse = (CustomLoggedStatsResponse) o;
    return Objects.equals(this.id, customLoggedStatsResponse.id) &&
        Objects.equals(this.description, customLoggedStatsResponse.description) &&
        Objects.equals(this.schemas, customLoggedStatsResponse.schemas) &&
        Objects.equals(this.enabled, customLoggedStatsResponse.enabled) &&
        Objects.equals(this.monitorObjectclass, customLoggedStatsResponse.monitorObjectclass) &&
        Objects.equals(this.includeFilter, customLoggedStatsResponse.includeFilter) &&
        Objects.equals(this.attributeToLog, customLoggedStatsResponse.attributeToLog) &&
        Objects.equals(this.columnName, customLoggedStatsResponse.columnName) &&
        Objects.equals(this.statisticType, customLoggedStatsResponse.statisticType) &&
        Objects.equals(this.headerPrefix, customLoggedStatsResponse.headerPrefix) &&
        Objects.equals(this.headerPrefixAttribute, customLoggedStatsResponse.headerPrefixAttribute) &&
        Objects.equals(this.regexPattern, customLoggedStatsResponse.regexPattern) &&
        Objects.equals(this.regexReplacement, customLoggedStatsResponse.regexReplacement) &&
        Objects.equals(this.divideValueBy, customLoggedStatsResponse.divideValueBy) &&
        Objects.equals(this.divideValueByAttribute, customLoggedStatsResponse.divideValueByAttribute) &&
        Objects.equals(this.decimalFormat, customLoggedStatsResponse.decimalFormat) &&
        Objects.equals(this.nonZeroImpliesNotIdle, customLoggedStatsResponse.nonZeroImpliesNotIdle) &&
        Objects.equals(this.meta, customLoggedStatsResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, customLoggedStatsResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, customLoggedStatsResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, monitorObjectclass, includeFilter, attributeToLog, columnName, statisticType, headerPrefix, headerPrefixAttribute, regexPattern, regexReplacement, divideValueBy, divideValueByAttribute, decimalFormat, nonZeroImpliesNotIdle, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomLoggedStatsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomLoggedStatsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomLoggedStatsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomLoggedStatsResponse is not found in the empty JSON string", CustomLoggedStatsResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomLoggedStatsResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomLoggedStatsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomLoggedStatsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomLoggedStatsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomLoggedStatsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomLoggedStatsResponse>() {
           @Override
           public void write(JsonWriter out, CustomLoggedStatsResponse value) throws IOException {
           ...
           @Override
           public CustomLoggedStatsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CustomLoggedStatsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustomLoggedStatsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomLoggedStatsResponse
  * @throws IOException if the JSON string is invalid with respect to CustomLoggedStatsResponse
  */
  public static CustomLoggedStatsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomLoggedStatsResponse.class);
  }

 /**
  * Convert an instance of CustomLoggedStatsResponse to an JSON string
  *
  * @return JSON string
  */
