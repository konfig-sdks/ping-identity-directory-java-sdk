...
public class AddEnterLockdownModeRecurringTaskRequest {
  ...
  public AddEnterLockdownModeRecurringTaskRequest() {
  }

  public AddEnterLockdownModeRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest schemas(List<EnumenterLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public AddEnterLockdownModeRecurringTaskRequest addSchemasItem(EnumenterLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest reason(String reason) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddEnterLockdownModeRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddEnterLockdownModeRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddEnterLockdownModeRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddEnterLockdownModeRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddEnterLockdownModeRecurringTaskRequest instance itself
   */
  public AddEnterLockdownModeRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddEnterLockdownModeRecurringTaskRequest addEnterLockdownModeRecurringTaskRequest = (AddEnterLockdownModeRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addEnterLockdownModeRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addEnterLockdownModeRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addEnterLockdownModeRecurringTaskRequest.schemas) &&
        Objects.equals(this.reason, addEnterLockdownModeRecurringTaskRequest.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addEnterLockdownModeRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addEnterLockdownModeRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addEnterLockdownModeRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addEnterLockdownModeRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addEnterLockdownModeRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addEnterLockdownModeRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addEnterLockdownModeRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addEnterLockdownModeRecurringTaskRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddEnterLockdownModeRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddEnterLockdownModeRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddEnterLockdownModeRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddEnterLockdownModeRecurringTaskRequest is not found in the empty JSON string", AddEnterLockdownModeRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddEnterLockdownModeRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddEnterLockdownModeRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddEnterLockdownModeRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddEnterLockdownModeRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddEnterLockdownModeRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddEnterLockdownModeRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddEnterLockdownModeRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddEnterLockdownModeRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddEnterLockdownModeRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddEnterLockdownModeRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddEnterLockdownModeRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddEnterLockdownModeRecurringTaskRequest
  */
  public static AddEnterLockdownModeRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddEnterLockdownModeRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddEnterLockdownModeRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
