...
public class DistinguishedNameAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf() {
  }

  public DistinguishedNameAttributeSyntaxResponseAllOf schemas(List<EnumdistinguishedNameAttributeSyntaxSchemaUrn> schemas) {
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf addSchemasItem(EnumdistinguishedNameAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public DistinguishedNameAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the DistinguishedNameAttributeSyntaxResponseAllOf instance itself
   */
  public DistinguishedNameAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DistinguishedNameAttributeSyntaxResponseAllOf distinguishedNameAttributeSyntaxResponseAllOf = (DistinguishedNameAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, distinguishedNameAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, distinguishedNameAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, distinguishedNameAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, distinguishedNameAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, distinguishedNameAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, distinguishedNameAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, distinguishedNameAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, distinguishedNameAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DistinguishedNameAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DistinguishedNameAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DistinguishedNameAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DistinguishedNameAttributeSyntaxResponseAllOf is not found in the empty JSON string", DistinguishedNameAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DistinguishedNameAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DistinguishedNameAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DistinguishedNameAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DistinguishedNameAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DistinguishedNameAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DistinguishedNameAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public DistinguishedNameAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DistinguishedNameAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DistinguishedNameAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DistinguishedNameAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DistinguishedNameAttributeSyntaxResponseAllOf
  */
  public static DistinguishedNameAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DistinguishedNameAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of DistinguishedNameAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
