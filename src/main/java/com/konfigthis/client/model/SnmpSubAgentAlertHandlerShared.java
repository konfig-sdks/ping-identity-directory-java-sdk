...
public class SnmpSubAgentAlertHandlerShared {
  ...
  public SnmpSubAgentAlertHandlerShared() {
  }

  public SnmpSubAgentAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared schemas(List<EnumsnmpSubAgentAlertHandlerSchemaUrn> schemas) {
  ...
  public SnmpSubAgentAlertHandlerShared addSchemasItem(EnumsnmpSubAgentAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public SnmpSubAgentAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public SnmpSubAgentAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public SnmpSubAgentAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public SnmpSubAgentAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the SnmpSubAgentAlertHandlerShared instance itself
   */
  public SnmpSubAgentAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnmpSubAgentAlertHandlerShared snmpSubAgentAlertHandlerShared = (SnmpSubAgentAlertHandlerShared) o;
    return Objects.equals(this.description, snmpSubAgentAlertHandlerShared.description) &&
        Objects.equals(this.schemas, snmpSubAgentAlertHandlerShared.schemas) &&
        Objects.equals(this.asynchronous, snmpSubAgentAlertHandlerShared.asynchronous) &&
        Objects.equals(this.enabled, snmpSubAgentAlertHandlerShared.enabled) &&
        Objects.equals(this.enabledAlertSeverity, snmpSubAgentAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, snmpSubAgentAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, snmpSubAgentAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, snmpSubAgentAlertHandlerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SnmpSubAgentAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnmpSubAgentAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnmpSubAgentAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnmpSubAgentAlertHandlerShared is not found in the empty JSON string", SnmpSubAgentAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnmpSubAgentAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnmpSubAgentAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnmpSubAgentAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnmpSubAgentAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnmpSubAgentAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SnmpSubAgentAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, SnmpSubAgentAlertHandlerShared value) throws IOException {
           ...
           @Override
           public SnmpSubAgentAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnmpSubAgentAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnmpSubAgentAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnmpSubAgentAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to SnmpSubAgentAlertHandlerShared
  */
  public static SnmpSubAgentAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnmpSubAgentAlertHandlerShared.class);
  }

 /**
  * Convert an instance of SnmpSubAgentAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
