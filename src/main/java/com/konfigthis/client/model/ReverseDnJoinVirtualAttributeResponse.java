...
public class ReverseDnJoinVirtualAttributeResponse {
  ...
  private List<EnumreverseDnJoinVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public ReverseDnJoinVirtualAttributeResponse() {
  }

  public ReverseDnJoinVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse schemas(List<EnumreverseDnJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addSchemasItem(EnumreverseDnJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumreverseDnJoinVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumreverseDnJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public ReverseDnJoinVirtualAttributeResponse joinDNAttribute(String joinDNAttribute) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The attribute in related entries whose set of values must contain the DN of the search result entry to be joined with that entry.")
  ...
  public ReverseDnJoinVirtualAttributeResponse joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse joinFilter(String joinFilter) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse joinAttribute(List<String> joinAttribute) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse filter(List<String> filter) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ReverseDnJoinVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ReverseDnJoinVirtualAttributeResponse instance itself
   */
  public ReverseDnJoinVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReverseDnJoinVirtualAttributeResponse reverseDnJoinVirtualAttributeResponse = (ReverseDnJoinVirtualAttributeResponse) o;
    return Objects.equals(this.id, reverseDnJoinVirtualAttributeResponse.id) &&
        Objects.equals(this.description, reverseDnJoinVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, reverseDnJoinVirtualAttributeResponse.schemas) &&
        Objects.equals(this.joinDNAttribute, reverseDnJoinVirtualAttributeResponse.joinDNAttribute) &&
        Objects.equals(this.joinBaseDNType, reverseDnJoinVirtualAttributeResponse.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, reverseDnJoinVirtualAttributeResponse.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, reverseDnJoinVirtualAttributeResponse.joinScope) &&
        Objects.equals(this.joinSizeLimit, reverseDnJoinVirtualAttributeResponse.joinSizeLimit) &&
        Objects.equals(this.joinFilter, reverseDnJoinVirtualAttributeResponse.joinFilter) &&
        Objects.equals(this.joinAttribute, reverseDnJoinVirtualAttributeResponse.joinAttribute) &&
        Objects.equals(this.enabled, reverseDnJoinVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, reverseDnJoinVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, reverseDnJoinVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, reverseDnJoinVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, reverseDnJoinVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, reverseDnJoinVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, reverseDnJoinVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, reverseDnJoinVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, reverseDnJoinVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, reverseDnJoinVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, reverseDnJoinVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, reverseDnJoinVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, reverseDnJoinVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, reverseDnJoinVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, joinDNAttribute, joinBaseDNType, joinCustomBaseDN, joinScope, joinSizeLimit, joinFilter, joinAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReverseDnJoinVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReverseDnJoinVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReverseDnJoinVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReverseDnJoinVirtualAttributeResponse is not found in the empty JSON string", ReverseDnJoinVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReverseDnJoinVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReverseDnJoinVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReverseDnJoinVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReverseDnJoinVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReverseDnJoinVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReverseDnJoinVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, ReverseDnJoinVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public ReverseDnJoinVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReverseDnJoinVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReverseDnJoinVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReverseDnJoinVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to ReverseDnJoinVirtualAttributeResponse
  */
  public static ReverseDnJoinVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReverseDnJoinVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of ReverseDnJoinVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
