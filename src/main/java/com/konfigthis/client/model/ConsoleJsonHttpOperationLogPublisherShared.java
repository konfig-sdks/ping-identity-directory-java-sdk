...
public class ConsoleJsonHttpOperationLogPublisherShared {
  ...
  public ConsoleJsonHttpOperationLogPublisherShared() {
  }

  public ConsoleJsonHttpOperationLogPublisherShared description(String description) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared schemas(List<EnumconsoleJsonHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonHttpOperationLogPublisherShared addSchemasItem(EnumconsoleJsonHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logResults(Boolean logResults) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequestHeaders(EnumlogPublisherLogRequestHeadersProp logRequestHeaders) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared suppressedRequestHeaderName(List<String> suppressedRequestHeaderName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherShared addSuppressedRequestHeaderNameItem(String suppressedRequestHeaderNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logResponseHeaders(EnumlogPublisherLogResponseHeadersProp logResponseHeaders) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared suppressedResponseHeaderName(List<String> suppressedResponseHeaderName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherShared addSuppressedResponseHeaderNameItem(String suppressedResponseHeaderNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequestAuthorizationType(Boolean logRequestAuthorizationType) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequestCookieNames(Boolean logRequestCookieNames) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logResponseCookieNames(Boolean logResponseCookieNames) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequestParameters(EnumlogPublisherLogRequestParametersProp logRequestParameters) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared suppressedRequestParameterName(List<String> suppressedRequestParameterName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherShared addSuppressedRequestParameterNameItem(String suppressedRequestParameterNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRequestProtocol(Boolean logRequestProtocol) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared logRedirectURI(Boolean logRedirectURI) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the ConsoleJsonHttpOperationLogPublisherShared instance itself
   */
  public ConsoleJsonHttpOperationLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonHttpOperationLogPublisherShared consoleJsonHttpOperationLogPublisherShared = (ConsoleJsonHttpOperationLogPublisherShared) o;
    return Objects.equals(this.description, consoleJsonHttpOperationLogPublisherShared.description) &&
        Objects.equals(this.schemas, consoleJsonHttpOperationLogPublisherShared.schemas) &&
        Objects.equals(this.enabled, consoleJsonHttpOperationLogPublisherShared.enabled) &&
        Objects.equals(this.outputLocation, consoleJsonHttpOperationLogPublisherShared.outputLocation) &&
        Objects.equals(this.logRequests, consoleJsonHttpOperationLogPublisherShared.logRequests) &&
        Objects.equals(this.logResults, consoleJsonHttpOperationLogPublisherShared.logResults) &&
        Objects.equals(this.includeProductName, consoleJsonHttpOperationLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonHttpOperationLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonHttpOperationLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonHttpOperationLogPublisherShared.includeThreadID) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, consoleJsonHttpOperationLogPublisherShared.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.logRequestHeaders, consoleJsonHttpOperationLogPublisherShared.logRequestHeaders) &&
        Objects.equals(this.suppressedRequestHeaderName, consoleJsonHttpOperationLogPublisherShared.suppressedRequestHeaderName) &&
        Objects.equals(this.logResponseHeaders, consoleJsonHttpOperationLogPublisherShared.logResponseHeaders) &&
        Objects.equals(this.suppressedResponseHeaderName, consoleJsonHttpOperationLogPublisherShared.suppressedResponseHeaderName) &&
        Objects.equals(this.logRequestAuthorizationType, consoleJsonHttpOperationLogPublisherShared.logRequestAuthorizationType) &&
        Objects.equals(this.logRequestCookieNames, consoleJsonHttpOperationLogPublisherShared.logRequestCookieNames) &&
        Objects.equals(this.logResponseCookieNames, consoleJsonHttpOperationLogPublisherShared.logResponseCookieNames) &&
        Objects.equals(this.logRequestParameters, consoleJsonHttpOperationLogPublisherShared.logRequestParameters) &&
        Objects.equals(this.suppressedRequestParameterName, consoleJsonHttpOperationLogPublisherShared.suppressedRequestParameterName) &&
        Objects.equals(this.logRequestProtocol, consoleJsonHttpOperationLogPublisherShared.logRequestProtocol) &&
        Objects.equals(this.logRedirectURI, consoleJsonHttpOperationLogPublisherShared.logRedirectURI) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonHttpOperationLogPublisherShared.writeMultiLineMessages) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonHttpOperationLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, consoleJsonHttpOperationLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, enabled, outputLocation, logRequests, logResults, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequestDetailsInResultMessages, logRequestHeaders, suppressedRequestHeaderName, logResponseHeaders, suppressedResponseHeaderName, logRequestAuthorizationType, logRequestCookieNames, logResponseCookieNames, logRequestParameters, suppressedRequestParameterName, logRequestProtocol, logRedirectURI, writeMultiLineMessages, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonHttpOperationLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonHttpOperationLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonHttpOperationLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonHttpOperationLogPublisherShared is not found in the empty JSON string", ConsoleJsonHttpOperationLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsoleJsonHttpOperationLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonHttpOperationLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonHttpOperationLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonHttpOperationLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonHttpOperationLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonHttpOperationLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonHttpOperationLogPublisherShared value) throws IOException {
           ...
           @Override
           public ConsoleJsonHttpOperationLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonHttpOperationLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonHttpOperationLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonHttpOperationLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonHttpOperationLogPublisherShared
  */
  public static ConsoleJsonHttpOperationLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonHttpOperationLogPublisherShared.class);
  }

 /**
  * Convert an instance of ConsoleJsonHttpOperationLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
