...
public class LocalDbIndexShared {
  ...
  public LocalDbIndexShared() {
  }

  public LocalDbIndexShared schemas(List<EnumlocalDbIndexSchemaUrn> schemas) {
  ...
  public LocalDbIndexShared addSchemasItem(EnumlocalDbIndexSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LocalDbIndexShared attribute(String attribute) {
  ...
  **/
  ...
  public LocalDbIndexShared indexEntryLimit(Integer indexEntryLimit) {
  ...
  **/
  ...
  public LocalDbIndexShared substringIndexEntryLimit(Integer substringIndexEntryLimit) {
  ...
  **/
  ...
  public LocalDbIndexShared maintainMatchCountForKeysExceedingEntryLimit(Boolean maintainMatchCountForKeysExceedingEntryLimit) {
  ...
  **/
  ...
  public LocalDbIndexShared indexType(List<EnumlocalDbIndexIndexTypeProp> indexType) {
  ...
  public LocalDbIndexShared addIndexTypeItem(EnumlocalDbIndexIndexTypeProp indexTypeItem) {
  ...
  **/
  ...
  public LocalDbIndexShared substringLength(Integer substringLength) {
  ...
  **/
  ...
  public LocalDbIndexShared primeIndex(Boolean primeIndex) {
  ...
  **/
  ...
  public LocalDbIndexShared primeInternalNodesOnly(Boolean primeInternalNodesOnly) {
  ...
  **/
  ...
  public LocalDbIndexShared equalityIndexFilter(List<String> equalityIndexFilter) {
  ...
  public LocalDbIndexShared addEqualityIndexFilterItem(String equalityIndexFilterItem) {
  ...
  **/
  ...
  public LocalDbIndexShared maintainEqualityIndexWithoutFilter(Boolean maintainEqualityIndexWithoutFilter) {
  ...
  **/
  ...
  public LocalDbIndexShared cacheMode(EnumlocalDbIndexCacheModeProp cacheMode) {
  ...
  **/
   ...
   * @return the LocalDbIndexShared instance itself
   */
  public LocalDbIndexShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LocalDbIndexShared localDbIndexShared = (LocalDbIndexShared) o;
    return Objects.equals(this.schemas, localDbIndexShared.schemas) &&
        Objects.equals(this.attribute, localDbIndexShared.attribute) &&
        Objects.equals(this.indexEntryLimit, localDbIndexShared.indexEntryLimit) &&
        Objects.equals(this.substringIndexEntryLimit, localDbIndexShared.substringIndexEntryLimit) &&
        Objects.equals(this.maintainMatchCountForKeysExceedingEntryLimit, localDbIndexShared.maintainMatchCountForKeysExceedingEntryLimit) &&
        Objects.equals(this.indexType, localDbIndexShared.indexType) &&
        Objects.equals(this.substringLength, localDbIndexShared.substringLength) &&
        Objects.equals(this.primeIndex, localDbIndexShared.primeIndex) &&
        Objects.equals(this.primeInternalNodesOnly, localDbIndexShared.primeInternalNodesOnly) &&
        Objects.equals(this.equalityIndexFilter, localDbIndexShared.equalityIndexFilter) &&
        Objects.equals(this.maintainEqualityIndexWithoutFilter, localDbIndexShared.maintainEqualityIndexWithoutFilter) &&
        Objects.equals(this.cacheMode, localDbIndexShared.cacheMode)&&
        Objects.equals(this.additionalProperties, localDbIndexShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, attribute, indexEntryLimit, substringIndexEntryLimit, maintainMatchCountForKeysExceedingEntryLimit, indexType, substringLength, primeIndex, primeInternalNodesOnly, equalityIndexFilter, maintainEqualityIndexWithoutFilter, cacheMode, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LocalDbIndexShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LocalDbIndexShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LocalDbIndexShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LocalDbIndexShared is not found in the empty JSON string", LocalDbIndexShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LocalDbIndexShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LocalDbIndexShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LocalDbIndexShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LocalDbIndexShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LocalDbIndexShared.class));

       return (TypeAdapter<T>) new TypeAdapter<LocalDbIndexShared>() {
           @Override
           public void write(JsonWriter out, LocalDbIndexShared value) throws IOException {
           ...
           @Override
           public LocalDbIndexShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LocalDbIndexShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LocalDbIndexShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LocalDbIndexShared
  * @throws IOException if the JSON string is invalid with respect to LocalDbIndexShared
  */
  public static LocalDbIndexShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LocalDbIndexShared.class);
  }

 /**
  * Convert an instance of LocalDbIndexShared to an JSON string
  *
  * @return JSON string
  */
