...
public class AvailabilityStateHttpServletExtensionResponse {
  ...
  public AvailabilityStateHttpServletExtensionResponse() {
  }

  public AvailabilityStateHttpServletExtensionResponse id(String id) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse description(String description) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse schemas(List<EnumavailabilityStateHttpServletExtensionSchemaUrn> schemas) {
  ...
  public AvailabilityStateHttpServletExtensionResponse addSchemasItem(EnumavailabilityStateHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse availableStatusCode(Integer availableStatusCode) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse degradedStatusCode(Integer degradedStatusCode) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse unavailableStatusCode(Integer unavailableStatusCode) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse overrideStatusCode(Integer overrideStatusCode) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse includeResponseBody(Boolean includeResponseBody) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse additionalResponseContents(String additionalResponseContents) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse responseHeader(List<String> responseHeader) {
  ...
  public AvailabilityStateHttpServletExtensionResponse addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AvailabilityStateHttpServletExtensionResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AvailabilityStateHttpServletExtensionResponse instance itself
   */
  public AvailabilityStateHttpServletExtensionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AvailabilityStateHttpServletExtensionResponse availabilityStateHttpServletExtensionResponse = (AvailabilityStateHttpServletExtensionResponse) o;
    return Objects.equals(this.id, availabilityStateHttpServletExtensionResponse.id) &&
        Objects.equals(this.description, availabilityStateHttpServletExtensionResponse.description) &&
        Objects.equals(this.schemas, availabilityStateHttpServletExtensionResponse.schemas) &&
        Objects.equals(this.baseContextPath, availabilityStateHttpServletExtensionResponse.baseContextPath) &&
        Objects.equals(this.availableStatusCode, availabilityStateHttpServletExtensionResponse.availableStatusCode) &&
        Objects.equals(this.degradedStatusCode, availabilityStateHttpServletExtensionResponse.degradedStatusCode) &&
        Objects.equals(this.unavailableStatusCode, availabilityStateHttpServletExtensionResponse.unavailableStatusCode) &&
        Objects.equals(this.overrideStatusCode, availabilityStateHttpServletExtensionResponse.overrideStatusCode) &&
        Objects.equals(this.includeResponseBody, availabilityStateHttpServletExtensionResponse.includeResponseBody) &&
        Objects.equals(this.additionalResponseContents, availabilityStateHttpServletExtensionResponse.additionalResponseContents) &&
        Objects.equals(this.crossOriginPolicy, availabilityStateHttpServletExtensionResponse.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, availabilityStateHttpServletExtensionResponse.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, availabilityStateHttpServletExtensionResponse.correlationIDResponseHeader) &&
        Objects.equals(this.meta, availabilityStateHttpServletExtensionResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, availabilityStateHttpServletExtensionResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, availabilityStateHttpServletExtensionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, baseContextPath, availableStatusCode, degradedStatusCode, unavailableStatusCode, overrideStatusCode, includeResponseBody, additionalResponseContents, crossOriginPolicy, responseHeader, correlationIDResponseHeader, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AvailabilityStateHttpServletExtensionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvailabilityStateHttpServletExtensionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AvailabilityStateHttpServletExtensionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AvailabilityStateHttpServletExtensionResponse is not found in the empty JSON string", AvailabilityStateHttpServletExtensionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AvailabilityStateHttpServletExtensionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AvailabilityStateHttpServletExtensionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AvailabilityStateHttpServletExtensionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AvailabilityStateHttpServletExtensionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AvailabilityStateHttpServletExtensionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AvailabilityStateHttpServletExtensionResponse>() {
           @Override
           public void write(JsonWriter out, AvailabilityStateHttpServletExtensionResponse value) throws IOException {
           ...
           @Override
           public AvailabilityStateHttpServletExtensionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AvailabilityStateHttpServletExtensionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AvailabilityStateHttpServletExtensionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AvailabilityStateHttpServletExtensionResponse
  * @throws IOException if the JSON string is invalid with respect to AvailabilityStateHttpServletExtensionResponse
  */
  public static AvailabilityStateHttpServletExtensionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AvailabilityStateHttpServletExtensionResponse.class);
  }

 /**
  * Convert an instance of AvailabilityStateHttpServletExtensionResponse to an JSON string
  *
  * @return JSON string
  */
