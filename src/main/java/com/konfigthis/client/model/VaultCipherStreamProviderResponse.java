...
public class VaultCipherStreamProviderResponse {
  ...
  public VaultCipherStreamProviderResponse() {
  }

  public VaultCipherStreamProviderResponse id(String id) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse description(String description) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse schemas(List<EnumvaultCipherStreamProviderSchemaUrn> schemas) {
  ...
  public VaultCipherStreamProviderResponse addSchemasItem(EnumvaultCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultExternalServer(String vaultExternalServer) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultServerBaseURI(List<String> vaultServerBaseURI) {
  ...
  public VaultCipherStreamProviderResponse addVaultServerBaseURIItem(String vaultServerBaseURIItem) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultAuthenticationMethod(String vaultAuthenticationMethod) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultSecretPath(String vaultSecretPath) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultSecretFieldName(String vaultSecretFieldName) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse vaultEncryptionMetadataFile(String vaultEncryptionMetadataFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The path to a file that will hold metadata about the encryption performed by this Vault Cipher Stream Provider.")
  ...
  public VaultCipherStreamProviderResponse trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public VaultCipherStreamProviderResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the VaultCipherStreamProviderResponse instance itself
   */
  public VaultCipherStreamProviderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultCipherStreamProviderResponse vaultCipherStreamProviderResponse = (VaultCipherStreamProviderResponse) o;
    return Objects.equals(this.id, vaultCipherStreamProviderResponse.id) &&
        Objects.equals(this.description, vaultCipherStreamProviderResponse.description) &&
        Objects.equals(this.schemas, vaultCipherStreamProviderResponse.schemas) &&
        Objects.equals(this.vaultExternalServer, vaultCipherStreamProviderResponse.vaultExternalServer) &&
        Objects.equals(this.vaultServerBaseURI, vaultCipherStreamProviderResponse.vaultServerBaseURI) &&
        Objects.equals(this.vaultAuthenticationMethod, vaultCipherStreamProviderResponse.vaultAuthenticationMethod) &&
        Objects.equals(this.vaultSecretPath, vaultCipherStreamProviderResponse.vaultSecretPath) &&
        Objects.equals(this.vaultSecretFieldName, vaultCipherStreamProviderResponse.vaultSecretFieldName) &&
        Objects.equals(this.vaultEncryptionMetadataFile, vaultCipherStreamProviderResponse.vaultEncryptionMetadataFile) &&
        Objects.equals(this.trustStoreFile, vaultCipherStreamProviderResponse.trustStoreFile) &&
        Objects.equals(this.trustStorePin, vaultCipherStreamProviderResponse.trustStorePin) &&
        Objects.equals(this.trustStoreType, vaultCipherStreamProviderResponse.trustStoreType) &&
        Objects.equals(this.iterationCount, vaultCipherStreamProviderResponse.iterationCount) &&
        Objects.equals(this.enabled, vaultCipherStreamProviderResponse.enabled) &&
        Objects.equals(this.meta, vaultCipherStreamProviderResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, vaultCipherStreamProviderResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, vaultCipherStreamProviderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, vaultExternalServer, vaultServerBaseURI, vaultAuthenticationMethod, vaultSecretPath, vaultSecretFieldName, vaultEncryptionMetadataFile, trustStoreFile, trustStorePin, trustStoreType, iterationCount, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultCipherStreamProviderResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("vaultEncryptionMetadataFile");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultCipherStreamProviderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultCipherStreamProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultCipherStreamProviderResponse is not found in the empty JSON string", VaultCipherStreamProviderResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultCipherStreamProviderResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("vaultEncryptionMetadataFile").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultCipherStreamProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultCipherStreamProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultCipherStreamProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultCipherStreamProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultCipherStreamProviderResponse>() {
           @Override
           public void write(JsonWriter out, VaultCipherStreamProviderResponse value) throws IOException {
           ...
           @Override
           public VaultCipherStreamProviderResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultCipherStreamProviderResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultCipherStreamProviderResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultCipherStreamProviderResponse
  * @throws IOException if the JSON string is invalid with respect to VaultCipherStreamProviderResponse
  */
  public static VaultCipherStreamProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultCipherStreamProviderResponse.class);
  }

 /**
  * Convert an instance of VaultCipherStreamProviderResponse to an JSON string
  *
  * @return JSON string
  */
