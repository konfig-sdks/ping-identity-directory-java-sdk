...
public class GroovyScriptedVirtualAttributeShared {
  ...
  public GroovyScriptedVirtualAttributeShared() {
  }

  public GroovyScriptedVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared schemas(List<EnumgroovyScriptedVirtualAttributeSchemaUrn> schemas) {
  ...
  public GroovyScriptedVirtualAttributeShared addSchemasItem(EnumgroovyScriptedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedVirtualAttributeShared addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public GroovyScriptedVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public GroovyScriptedVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared filter(List<String> filter) {
  ...
  public GroovyScriptedVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public GroovyScriptedVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public GroovyScriptedVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the GroovyScriptedVirtualAttributeShared instance itself
   */
  public GroovyScriptedVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedVirtualAttributeShared groovyScriptedVirtualAttributeShared = (GroovyScriptedVirtualAttributeShared) o;
    return Objects.equals(this.description, groovyScriptedVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, groovyScriptedVirtualAttributeShared.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedVirtualAttributeShared.scriptClass) &&
        Objects.equals(this.scriptArgument, groovyScriptedVirtualAttributeShared.scriptArgument) &&
        Objects.equals(this.enabled, groovyScriptedVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, groovyScriptedVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, groovyScriptedVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, groovyScriptedVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, groovyScriptedVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, groovyScriptedVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, groovyScriptedVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, groovyScriptedVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, groovyScriptedVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, groovyScriptedVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, groovyScriptedVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, groovyScriptedVirtualAttributeShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroovyScriptedVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedVirtualAttributeShared is not found in the empty JSON string", GroovyScriptedVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public GroovyScriptedVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedVirtualAttributeShared
  */
  public static GroovyScriptedVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of GroovyScriptedVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
