...
public class AddMemberVirtualAttributeRequest {
  ...
  public AddMemberVirtualAttributeRequest() {
  }

  public AddMemberVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest schemas(List<EnummemberVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddMemberVirtualAttributeRequest addSchemasItem(EnummemberVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest allowRetrievingMembership(Boolean allowRetrievingMembership) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether to handle requests that request all values for the virtual attribute.")
  ...
  public AddMemberVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddMemberVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddMemberVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddMemberVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddMemberVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddMemberVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
   ...
   * @return the AddMemberVirtualAttributeRequest instance itself
   */
  public AddMemberVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddMemberVirtualAttributeRequest addMemberVirtualAttributeRequest = (AddMemberVirtualAttributeRequest) o;
    return Objects.equals(this.name, addMemberVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addMemberVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addMemberVirtualAttributeRequest.schemas) &&
        Objects.equals(this.conflictBehavior, addMemberVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.allowRetrievingMembership, addMemberVirtualAttributeRequest.allowRetrievingMembership) &&
        Objects.equals(this.filter, addMemberVirtualAttributeRequest.filter) &&
        Objects.equals(this.allowIndexConflicts, addMemberVirtualAttributeRequest.allowIndexConflicts) &&
        Objects.equals(this.enabled, addMemberVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addMemberVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addMemberVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addMemberVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, addMemberVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, addMemberVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addMemberVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addMemberVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior)&&
        Objects.equals(this.additionalProperties, addMemberVirtualAttributeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddMemberVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddMemberVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddMemberVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddMemberVirtualAttributeRequest is not found in the empty JSON string", AddMemberVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddMemberVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddMemberVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddMemberVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddMemberVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddMemberVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddMemberVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddMemberVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddMemberVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddMemberVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddMemberVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddMemberVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddMemberVirtualAttributeRequest
  */
  public static AddMemberVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddMemberVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddMemberVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
