...
public class BooleanAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumbooleanAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public BooleanAttributeSyntaxResponseAllOf() {
  }

  public BooleanAttributeSyntaxResponseAllOf schemas(List<EnumbooleanAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BooleanAttributeSyntaxResponseAllOf addSchemasItem(EnumbooleanAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public BooleanAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public BooleanAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the BooleanAttributeSyntaxResponseAllOf instance itself
   */
  public BooleanAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BooleanAttributeSyntaxResponseAllOf booleanAttributeSyntaxResponseAllOf = (BooleanAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, booleanAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, booleanAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, booleanAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, booleanAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, booleanAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, booleanAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, booleanAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, booleanAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BooleanAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BooleanAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BooleanAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BooleanAttributeSyntaxResponseAllOf is not found in the empty JSON string", BooleanAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BooleanAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BooleanAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BooleanAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BooleanAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<BooleanAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, BooleanAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public BooleanAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BooleanAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BooleanAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BooleanAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to BooleanAttributeSyntaxResponseAllOf
  */
  public static BooleanAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BooleanAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of BooleanAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
