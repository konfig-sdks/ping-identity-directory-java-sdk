...
public class IntegerAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumintegerAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public IntegerAttributeSyntaxResponseAllOf() {
  }

  public IntegerAttributeSyntaxResponseAllOf schemas(List<EnumintegerAttributeSyntaxSchemaUrn> schemas) {
  ...
  public IntegerAttributeSyntaxResponseAllOf addSchemasItem(EnumintegerAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public IntegerAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public IntegerAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public IntegerAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the IntegerAttributeSyntaxResponseAllOf instance itself
   */
  public IntegerAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IntegerAttributeSyntaxResponseAllOf integerAttributeSyntaxResponseAllOf = (IntegerAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, integerAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, integerAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, integerAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, integerAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, integerAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, integerAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, integerAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, integerAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class IntegerAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IntegerAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IntegerAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IntegerAttributeSyntaxResponseAllOf is not found in the empty JSON string", IntegerAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IntegerAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IntegerAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IntegerAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IntegerAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<IntegerAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, IntegerAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public IntegerAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IntegerAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IntegerAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IntegerAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to IntegerAttributeSyntaxResponseAllOf
  */
  public static IntegerAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IntegerAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of IntegerAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
