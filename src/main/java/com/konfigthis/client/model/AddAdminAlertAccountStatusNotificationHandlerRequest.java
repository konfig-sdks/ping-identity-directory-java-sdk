...
public class AddAdminAlertAccountStatusNotificationHandlerRequest {
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest() {
  }

  public AddAdminAlertAccountStatusNotificationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest schemas(List<EnumadminAlertAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest addSchemasItem(EnumadminAlertAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest accountStatusNotificationType(List<EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp> accountStatusNotificationType) {
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest addAccountStatusNotificationTypeItem(EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp accountStatusNotificationTypeItem) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddAdminAlertAccountStatusNotificationHandlerRequest accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the AddAdminAlertAccountStatusNotificationHandlerRequest instance itself
   */
  public AddAdminAlertAccountStatusNotificationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAdminAlertAccountStatusNotificationHandlerRequest addAdminAlertAccountStatusNotificationHandlerRequest = (AddAdminAlertAccountStatusNotificationHandlerRequest) o;
    return Objects.equals(this.handlerName, addAdminAlertAccountStatusNotificationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addAdminAlertAccountStatusNotificationHandlerRequest.description) &&
        Objects.equals(this.schemas, addAdminAlertAccountStatusNotificationHandlerRequest.schemas) &&
        Objects.equals(this.accountStatusNotificationType, addAdminAlertAccountStatusNotificationHandlerRequest.accountStatusNotificationType) &&
        Objects.equals(this.enabled, addAdminAlertAccountStatusNotificationHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addAdminAlertAccountStatusNotificationHandlerRequest.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, addAdminAlertAccountStatusNotificationHandlerRequest.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, addAdminAlertAccountStatusNotificationHandlerRequest.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, addAdminAlertAccountStatusNotificationHandlerRequest.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, addAdminAlertAccountStatusNotificationHandlerRequest.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, addAdminAlertAccountStatusNotificationHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, accountStatusNotificationType, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAdminAlertAccountStatusNotificationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAdminAlertAccountStatusNotificationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAdminAlertAccountStatusNotificationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAdminAlertAccountStatusNotificationHandlerRequest is not found in the empty JSON string", AddAdminAlertAccountStatusNotificationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAdminAlertAccountStatusNotificationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAdminAlertAccountStatusNotificationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAdminAlertAccountStatusNotificationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAdminAlertAccountStatusNotificationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAdminAlertAccountStatusNotificationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAdminAlertAccountStatusNotificationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddAdminAlertAccountStatusNotificationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddAdminAlertAccountStatusNotificationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAdminAlertAccountStatusNotificationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAdminAlertAccountStatusNotificationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAdminAlertAccountStatusNotificationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddAdminAlertAccountStatusNotificationHandlerRequest
  */
  public static AddAdminAlertAccountStatusNotificationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAdminAlertAccountStatusNotificationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddAdminAlertAccountStatusNotificationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
