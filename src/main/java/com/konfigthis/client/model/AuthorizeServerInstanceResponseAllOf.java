...
import com.konfigthis.client.model.EnumauthorizeServerInstanceSchemaUrn;
...
public class AuthorizeServerInstanceResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumauthorizeServerInstanceSchemaUrn> schemas = null;
  ...
  public AuthorizeServerInstanceResponseAllOf() {
  }

  public AuthorizeServerInstanceResponseAllOf schemas(List<EnumauthorizeServerInstanceSchemaUrn> schemas) {
  ...
  public AuthorizeServerInstanceResponseAllOf addSchemasItem(EnumauthorizeServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumauthorizeServerInstanceSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumauthorizeServerInstanceSchemaUrn> schemas) {
  ...
  public AuthorizeServerInstanceResponseAllOf id(String id) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf clusterName(String clusterName) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf hostname(String hostname) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf serverRoot(String serverRoot) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf serverVersion(String serverVersion) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf httpPort(Integer httpPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public AuthorizeServerInstanceResponseAllOf addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf baseDN(List<String> baseDN) {
  ...
  public AuthorizeServerInstanceResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponseAllOf memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public AuthorizeServerInstanceResponseAllOf addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
   ...
   * @return the AuthorizeServerInstanceResponseAllOf instance itself
   */
  public AuthorizeServerInstanceResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizeServerInstanceResponseAllOf authorizeServerInstanceResponseAllOf = (AuthorizeServerInstanceResponseAllOf) o;
    return Objects.equals(this.schemas, authorizeServerInstanceResponseAllOf.schemas) &&
        Objects.equals(this.id, authorizeServerInstanceResponseAllOf.id) &&
        Objects.equals(this.serverInstanceType, authorizeServerInstanceResponseAllOf.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, authorizeServerInstanceResponseAllOf.serverInstanceName) &&
        Objects.equals(this.clusterName, authorizeServerInstanceResponseAllOf.clusterName) &&
        Objects.equals(this.serverInstanceLocation, authorizeServerInstanceResponseAllOf.serverInstanceLocation) &&
        Objects.equals(this.hostname, authorizeServerInstanceResponseAllOf.hostname) &&
        Objects.equals(this.serverRoot, authorizeServerInstanceResponseAllOf.serverRoot) &&
        Objects.equals(this.serverVersion, authorizeServerInstanceResponseAllOf.serverVersion) &&
        Objects.equals(this.interServerCertificate, authorizeServerInstanceResponseAllOf.interServerCertificate) &&
        Objects.equals(this.ldapPort, authorizeServerInstanceResponseAllOf.ldapPort) &&
        Objects.equals(this.ldapsPort, authorizeServerInstanceResponseAllOf.ldapsPort) &&
        Objects.equals(this.httpPort, authorizeServerInstanceResponseAllOf.httpPort) &&
        Objects.equals(this.httpsPort, authorizeServerInstanceResponseAllOf.httpsPort) &&
        Objects.equals(this.replicationPort, authorizeServerInstanceResponseAllOf.replicationPort) &&
        Objects.equals(this.replicationServerID, authorizeServerInstanceResponseAllOf.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, authorizeServerInstanceResponseAllOf.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, authorizeServerInstanceResponseAllOf.jmxPort) &&
        Objects.equals(this.jmxsPort, authorizeServerInstanceResponseAllOf.jmxsPort) &&
        Objects.equals(this.preferredSecurity, authorizeServerInstanceResponseAllOf.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, authorizeServerInstanceResponseAllOf.startTLSEnabled) &&
        Objects.equals(this.baseDN, authorizeServerInstanceResponseAllOf.baseDN) &&
        Objects.equals(this.memberOfServerGroup, authorizeServerInstanceResponseAllOf.memberOfServerGroup)&&
        Objects.equals(this.additionalProperties, authorizeServerInstanceResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizeServerInstanceResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuthorizeServerInstanceResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuthorizeServerInstanceResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizeServerInstanceResponseAllOf is not found in the empty JSON string", AuthorizeServerInstanceResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizeServerInstanceResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizeServerInstanceResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizeServerInstanceResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizeServerInstanceResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizeServerInstanceResponseAllOf>() {
           @Override
           public void write(JsonWriter out, AuthorizeServerInstanceResponseAllOf value) throws IOException {
           ...
           @Override
           public AuthorizeServerInstanceResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AuthorizeServerInstanceResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AuthorizeServerInstanceResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthorizeServerInstanceResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to AuthorizeServerInstanceResponseAllOf
  */
  public static AuthorizeServerInstanceResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizeServerInstanceResponseAllOf.class);
  }

 /**
  * Convert an instance of AuthorizeServerInstanceResponseAllOf to an JSON string
  *
  * @return JSON string
  */
