...
public class AddLdapPassThroughScimResourceTypeRequest {
  ...
  public AddLdapPassThroughScimResourceTypeRequest() {
  }

  public AddLdapPassThroughScimResourceTypeRequest typeName(String typeName) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest description(String description) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest schemas(List<EnumldapPassThroughScimResourceTypeSchemaUrn> schemas) {
  ...
  public AddLdapPassThroughScimResourceTypeRequest addSchemasItem(EnumldapPassThroughScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest endpoint(String endpoint) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public AddLdapPassThroughScimResourceTypeRequest addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public AddLdapPassThroughScimResourceTypeRequest addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest includeFilter(List<String> includeFilter) {
  ...
  public AddLdapPassThroughScimResourceTypeRequest addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public AddLdapPassThroughScimResourceTypeRequest addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public AddLdapPassThroughScimResourceTypeRequest createDNPattern(String createDNPattern) {
  ...
  **/
   ...
   * @return the AddLdapPassThroughScimResourceTypeRequest instance itself
   */
  public AddLdapPassThroughScimResourceTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddLdapPassThroughScimResourceTypeRequest addLdapPassThroughScimResourceTypeRequest = (AddLdapPassThroughScimResourceTypeRequest) o;
    return Objects.equals(this.typeName, addLdapPassThroughScimResourceTypeRequest.typeName) &&
        Objects.equals(this.description, addLdapPassThroughScimResourceTypeRequest.description) &&
        Objects.equals(this.schemas, addLdapPassThroughScimResourceTypeRequest.schemas) &&
        Objects.equals(this.enabled, addLdapPassThroughScimResourceTypeRequest.enabled) &&
        Objects.equals(this.endpoint, addLdapPassThroughScimResourceTypeRequest.endpoint) &&
        Objects.equals(this.lookthroughLimit, addLdapPassThroughScimResourceTypeRequest.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, addLdapPassThroughScimResourceTypeRequest.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, addLdapPassThroughScimResourceTypeRequest.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, addLdapPassThroughScimResourceTypeRequest.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, addLdapPassThroughScimResourceTypeRequest.includeBaseDN) &&
        Objects.equals(this.includeFilter, addLdapPassThroughScimResourceTypeRequest.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, addLdapPassThroughScimResourceTypeRequest.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, addLdapPassThroughScimResourceTypeRequest.createDNPattern)&&
        Objects.equals(this.additionalProperties, addLdapPassThroughScimResourceTypeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeName, description, schemas, enabled, endpoint, lookthroughLimit, schemaCheckingOption, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, includeBaseDN, includeFilter, includeOperationalAttribute, createDNPattern, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddLdapPassThroughScimResourceTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddLdapPassThroughScimResourceTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddLdapPassThroughScimResourceTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLdapPassThroughScimResourceTypeRequest is not found in the empty JSON string", AddLdapPassThroughScimResourceTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLdapPassThroughScimResourceTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLdapPassThroughScimResourceTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLdapPassThroughScimResourceTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLdapPassThroughScimResourceTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLdapPassThroughScimResourceTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLdapPassThroughScimResourceTypeRequest>() {
           @Override
           public void write(JsonWriter out, AddLdapPassThroughScimResourceTypeRequest value) throws IOException {
           ...
           @Override
           public AddLdapPassThroughScimResourceTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddLdapPassThroughScimResourceTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddLdapPassThroughScimResourceTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddLdapPassThroughScimResourceTypeRequest
  * @throws IOException if the JSON string is invalid with respect to AddLdapPassThroughScimResourceTypeRequest
  */
  public static AddLdapPassThroughScimResourceTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLdapPassThroughScimResourceTypeRequest.class);
  }

 /**
  * Convert an instance of AddLdapPassThroughScimResourceTypeRequest to an JSON string
  *
  * @return JSON string
  */
