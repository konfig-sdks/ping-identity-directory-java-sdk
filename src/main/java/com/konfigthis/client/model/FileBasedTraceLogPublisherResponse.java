...
public class FileBasedTraceLogPublisherResponse {
  ...
  public FileBasedTraceLogPublisherResponse() {
  }

  public FileBasedTraceLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse schemas(List<EnumfileBasedTraceLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedTraceLogPublisherResponse addSchemasItem(EnumfileBasedTraceLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Trace Log Publisher.")
  ...
  public FileBasedTraceLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedTraceLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Trace Log Publisher .")
  ...
  public FileBasedTraceLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedTraceLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedTraceLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Trace Log Publisher .")
  ...
  public FileBasedTraceLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Writer Based Trace Log Publisher will publish records asynchronously.")
  ...
  public FileBasedTraceLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse debugMessageType(List<EnumlogPublisherDebugMessageTypeProp> debugMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addDebugMessageTypeItem(EnumlogPublisherDebugMessageTypeProp debugMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse httpMessageType(List<EnumlogPublisherHttpMessageTypeProp> httpMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addHttpMessageTypeItem(EnumlogPublisherHttpMessageTypeProp httpMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse accessTokenValidatorMessageType(List<EnumlogPublisherAccessTokenValidatorMessageTypeProp> accessTokenValidatorMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addAccessTokenValidatorMessageTypeItem(EnumlogPublisherAccessTokenValidatorMessageTypeProp accessTokenValidatorMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse idTokenValidatorMessageType(List<EnumlogPublisherIdTokenValidatorMessageTypeProp> idTokenValidatorMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addIdTokenValidatorMessageTypeItem(EnumlogPublisherIdTokenValidatorMessageTypeProp idTokenValidatorMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse scimMessageType(List<EnumlogPublisherScimMessageTypeProp> scimMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addScimMessageTypeItem(EnumlogPublisherScimMessageTypeProp scimMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse consentMessageType(List<EnumlogPublisherConsentMessageTypeProp> consentMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addConsentMessageTypeItem(EnumlogPublisherConsentMessageTypeProp consentMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse directoryRESTAPIMessageType(List<EnumlogPublisherDirectoryRESTAPIMessageTypeProp> directoryRESTAPIMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addDirectoryRESTAPIMessageTypeItem(EnumlogPublisherDirectoryRESTAPIMessageTypeProp directoryRESTAPIMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse extensionMessageType(List<EnumlogPublisherExtensionMessageTypeProp> extensionMessageType) {
  ...
  public FileBasedTraceLogPublisherResponse addExtensionMessageTypeItem(EnumlogPublisherExtensionMessageTypeProp extensionMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse includePathPattern(List<String> includePathPattern) {
  ...
  public FileBasedTraceLogPublisherResponse addIncludePathPatternItem(String includePathPatternItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse excludePathPattern(List<String> excludePathPattern) {
  ...
  public FileBasedTraceLogPublisherResponse addExcludePathPatternItem(String excludePathPatternItem) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedTraceLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedTraceLogPublisherResponse instance itself
   */
  public FileBasedTraceLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedTraceLogPublisherResponse fileBasedTraceLogPublisherResponse = (FileBasedTraceLogPublisherResponse) o;
    return Objects.equals(this.id, fileBasedTraceLogPublisherResponse.id) &&
        Objects.equals(this.description, fileBasedTraceLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedTraceLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, fileBasedTraceLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedTraceLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedTraceLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedTraceLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedTraceLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedTraceLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedTraceLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedTraceLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedTraceLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedTraceLogPublisherResponse.append) &&
        Objects.equals(this.bufferSize, fileBasedTraceLogPublisherResponse.bufferSize) &&
        Objects.equals(this.timeInterval, fileBasedTraceLogPublisherResponse.timeInterval) &&
        Objects.equals(this.asynchronous, fileBasedTraceLogPublisherResponse.asynchronous) &&
        Objects.equals(this.queueSize, fileBasedTraceLogPublisherResponse.queueSize) &&
        Objects.equals(this.maxStringLength, fileBasedTraceLogPublisherResponse.maxStringLength) &&
        Objects.equals(this.debugMessageType, fileBasedTraceLogPublisherResponse.debugMessageType) &&
        Objects.equals(this.httpMessageType, fileBasedTraceLogPublisherResponse.httpMessageType) &&
        Objects.equals(this.accessTokenValidatorMessageType, fileBasedTraceLogPublisherResponse.accessTokenValidatorMessageType) &&
        Objects.equals(this.idTokenValidatorMessageType, fileBasedTraceLogPublisherResponse.idTokenValidatorMessageType) &&
        Objects.equals(this.scimMessageType, fileBasedTraceLogPublisherResponse.scimMessageType) &&
        Objects.equals(this.consentMessageType, fileBasedTraceLogPublisherResponse.consentMessageType) &&
        Objects.equals(this.directoryRESTAPIMessageType, fileBasedTraceLogPublisherResponse.directoryRESTAPIMessageType) &&
        Objects.equals(this.extensionMessageType, fileBasedTraceLogPublisherResponse.extensionMessageType) &&
        Objects.equals(this.includePathPattern, fileBasedTraceLogPublisherResponse.includePathPattern) &&
        Objects.equals(this.excludePathPattern, fileBasedTraceLogPublisherResponse.excludePathPattern) &&
        Objects.equals(this.enabled, fileBasedTraceLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedTraceLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedTraceLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedTraceLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedTraceLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, bufferSize, timeInterval, asynchronous, queueSize, maxStringLength, debugMessageType, httpMessageType, accessTokenValidatorMessageType, idTokenValidatorMessageType, scimMessageType, consentMessageType, directoryRESTAPIMessageType, extensionMessageType, includePathPattern, excludePathPattern, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedTraceLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedTraceLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedTraceLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedTraceLogPublisherResponse is not found in the empty JSON string", FileBasedTraceLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedTraceLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedTraceLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedTraceLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedTraceLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedTraceLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedTraceLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedTraceLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedTraceLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedTraceLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedTraceLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedTraceLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedTraceLogPublisherResponse
  */
  public static FileBasedTraceLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedTraceLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedTraceLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
