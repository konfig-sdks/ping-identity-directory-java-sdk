...
public class CurrentTimeVirtualAttributeResponseAllOf {
  ...
  private List<EnumcurrentTimeVirtualAttributeSchemaUrn> schemas = null;
  ...
  public CurrentTimeVirtualAttributeResponseAllOf() {
  }

  public CurrentTimeVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf schemas(List<EnumcurrentTimeVirtualAttributeSchemaUrn> schemas) {
  ...
  public CurrentTimeVirtualAttributeResponseAllOf addSchemasItem(EnumcurrentTimeVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf returnUtcTime(Boolean returnUtcTime) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf includeMilliseconds(Boolean includeMilliseconds) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public CurrentTimeVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public CurrentTimeVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public CurrentTimeVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public CurrentTimeVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public CurrentTimeVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the CurrentTimeVirtualAttributeResponseAllOf instance itself
   */
  public CurrentTimeVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CurrentTimeVirtualAttributeResponseAllOf currentTimeVirtualAttributeResponseAllOf = (CurrentTimeVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, currentTimeVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, currentTimeVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, currentTimeVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, currentTimeVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, currentTimeVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.returnUtcTime, currentTimeVirtualAttributeResponseAllOf.returnUtcTime) &&
        Objects.equals(this.includeMilliseconds, currentTimeVirtualAttributeResponseAllOf.includeMilliseconds) &&
        Objects.equals(this.enabled, currentTimeVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, currentTimeVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, currentTimeVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, currentTimeVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, currentTimeVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, currentTimeVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, currentTimeVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, currentTimeVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, currentTimeVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, currentTimeVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrentTimeVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CurrentTimeVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CurrentTimeVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CurrentTimeVirtualAttributeResponseAllOf is not found in the empty JSON string", CurrentTimeVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrentTimeVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrentTimeVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrentTimeVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrentTimeVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrentTimeVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, CurrentTimeVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public CurrentTimeVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CurrentTimeVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CurrentTimeVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CurrentTimeVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to CurrentTimeVirtualAttributeResponseAllOf
  */
  public static CurrentTimeVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrentTimeVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of CurrentTimeVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
