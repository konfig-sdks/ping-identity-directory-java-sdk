...
/**
 * SyslogJsonSyncFailedOpsLogPublisherResponseAllOf
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SyslogJsonSyncFailedOpsLogPublisherResponseAllOf {
  ...
  private List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> schemas = null;
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf() {
  }

  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf schemas(List<EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf addSchemasItem(EnumsyslogJsonSyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyslogJsonSyncFailedOpsLogPublisherResponseAllOf instance itself
   */
  public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonSyncFailedOpsLogPublisherResponseAllOf syslogJsonSyncFailedOpsLogPublisherResponseAllOf = (SyslogJsonSyncFailedOpsLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.id) &&
        Objects.equals(this.syslogExternalServer, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.queueSize) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.enabled, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syslogJsonSyncFailedOpsLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogJsonSyncFailedOpsLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonSyncFailedOpsLogPublisherResponseAllOf is not found in the empty JSON string", SyslogJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonSyncFailedOpsLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonSyncFailedOpsLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonSyncFailedOpsLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonSyncFailedOpsLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonSyncFailedOpsLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SyslogJsonSyncFailedOpsLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public SyslogJsonSyncFailedOpsLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonSyncFailedOpsLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonSyncFailedOpsLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonSyncFailedOpsLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static SyslogJsonSyncFailedOpsLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonSyncFailedOpsLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of SyslogJsonSyncFailedOpsLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
