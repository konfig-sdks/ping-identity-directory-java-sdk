...
public class AddEqualityJoinVirtualAttributeRequest {
  ...
  public AddEqualityJoinVirtualAttributeRequest() {
  }

  public AddEqualityJoinVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest schemas(List<EnumequalityJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addSchemasItem(EnumequalityJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinSourceAttribute(String joinSourceAttribute) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinTargetAttribute(String joinTargetAttribute) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinMatchAll(Boolean joinMatchAll) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinFilter(String joinFilter) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest joinAttribute(List<String> joinAttribute) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddEqualityJoinVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddEqualityJoinVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddEqualityJoinVirtualAttributeRequest instance itself
   */
  public AddEqualityJoinVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddEqualityJoinVirtualAttributeRequest addEqualityJoinVirtualAttributeRequest = (AddEqualityJoinVirtualAttributeRequest) o;
    return Objects.equals(this.name, addEqualityJoinVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addEqualityJoinVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addEqualityJoinVirtualAttributeRequest.schemas) &&
        Objects.equals(this.joinSourceAttribute, addEqualityJoinVirtualAttributeRequest.joinSourceAttribute) &&
        Objects.equals(this.joinTargetAttribute, addEqualityJoinVirtualAttributeRequest.joinTargetAttribute) &&
        Objects.equals(this.joinMatchAll, addEqualityJoinVirtualAttributeRequest.joinMatchAll) &&
        Objects.equals(this.joinBaseDNType, addEqualityJoinVirtualAttributeRequest.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, addEqualityJoinVirtualAttributeRequest.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, addEqualityJoinVirtualAttributeRequest.joinScope) &&
        Objects.equals(this.joinSizeLimit, addEqualityJoinVirtualAttributeRequest.joinSizeLimit) &&
        Objects.equals(this.joinFilter, addEqualityJoinVirtualAttributeRequest.joinFilter) &&
        Objects.equals(this.joinAttribute, addEqualityJoinVirtualAttributeRequest.joinAttribute) &&
        Objects.equals(this.enabled, addEqualityJoinVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addEqualityJoinVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addEqualityJoinVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addEqualityJoinVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addEqualityJoinVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addEqualityJoinVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addEqualityJoinVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addEqualityJoinVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addEqualityJoinVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addEqualityJoinVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addEqualityJoinVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addEqualityJoinVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, joinSourceAttribute, joinTargetAttribute, joinMatchAll, joinBaseDNType, joinCustomBaseDN, joinScope, joinSizeLimit, joinFilter, joinAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddEqualityJoinVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddEqualityJoinVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddEqualityJoinVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddEqualityJoinVirtualAttributeRequest is not found in the empty JSON string", AddEqualityJoinVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddEqualityJoinVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddEqualityJoinVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddEqualityJoinVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddEqualityJoinVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddEqualityJoinVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddEqualityJoinVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddEqualityJoinVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddEqualityJoinVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddEqualityJoinVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddEqualityJoinVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddEqualityJoinVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddEqualityJoinVirtualAttributeRequest
  */
  public static AddEqualityJoinVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddEqualityJoinVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddEqualityJoinVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
