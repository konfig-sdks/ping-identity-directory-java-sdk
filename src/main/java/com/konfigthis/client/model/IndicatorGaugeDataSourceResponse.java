...
public class IndicatorGaugeDataSourceResponse {
  ...
  private List<EnumindicatorGaugeDataSourceSchemaUrn> schemas = new ArrayList<>();
  ...
  public IndicatorGaugeDataSourceResponse() {
  }

  public IndicatorGaugeDataSourceResponse id(String id) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse description(String description) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse schemas(List<EnumindicatorGaugeDataSourceSchemaUrn> schemas) {
  ...
  public IndicatorGaugeDataSourceResponse addSchemasItem(EnumindicatorGaugeDataSourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumindicatorGaugeDataSourceSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumindicatorGaugeDataSourceSchemaUrn> schemas) {
  ...
  public IndicatorGaugeDataSourceResponse additionalText(String additionalText) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse monitorAttribute(String monitorAttribute) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse includeFilter(String includeFilter) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse resourceAttribute(String resourceAttribute) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse resourceType(String resourceType) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse minimumUpdateInterval(String minimumUpdateInterval) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the IndicatorGaugeDataSourceResponse instance itself
   */
  public IndicatorGaugeDataSourceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IndicatorGaugeDataSourceResponse indicatorGaugeDataSourceResponse = (IndicatorGaugeDataSourceResponse) o;
    return Objects.equals(this.id, indicatorGaugeDataSourceResponse.id) &&
        Objects.equals(this.description, indicatorGaugeDataSourceResponse.description) &&
        Objects.equals(this.schemas, indicatorGaugeDataSourceResponse.schemas) &&
        Objects.equals(this.additionalText, indicatorGaugeDataSourceResponse.additionalText) &&
        Objects.equals(this.monitorObjectclass, indicatorGaugeDataSourceResponse.monitorObjectclass) &&
        Objects.equals(this.monitorAttribute, indicatorGaugeDataSourceResponse.monitorAttribute) &&
        Objects.equals(this.includeFilter, indicatorGaugeDataSourceResponse.includeFilter) &&
        Objects.equals(this.resourceAttribute, indicatorGaugeDataSourceResponse.resourceAttribute) &&
        Objects.equals(this.resourceType, indicatorGaugeDataSourceResponse.resourceType) &&
        Objects.equals(this.minimumUpdateInterval, indicatorGaugeDataSourceResponse.minimumUpdateInterval) &&
        Objects.equals(this.meta, indicatorGaugeDataSourceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, indicatorGaugeDataSourceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, indicatorGaugeDataSourceResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, additionalText, monitorObjectclass, monitorAttribute, includeFilter, resourceAttribute, resourceType, minimumUpdateInterval, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IndicatorGaugeDataSourceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IndicatorGaugeDataSourceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IndicatorGaugeDataSourceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndicatorGaugeDataSourceResponse is not found in the empty JSON string", IndicatorGaugeDataSourceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IndicatorGaugeDataSourceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndicatorGaugeDataSourceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndicatorGaugeDataSourceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndicatorGaugeDataSourceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndicatorGaugeDataSourceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IndicatorGaugeDataSourceResponse>() {
           @Override
           public void write(JsonWriter out, IndicatorGaugeDataSourceResponse value) throws IOException {
           ...
           @Override
           public IndicatorGaugeDataSourceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IndicatorGaugeDataSourceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IndicatorGaugeDataSourceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IndicatorGaugeDataSourceResponse
  * @throws IOException if the JSON string is invalid with respect to IndicatorGaugeDataSourceResponse
  */
  public static IndicatorGaugeDataSourceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndicatorGaugeDataSourceResponse.class);
  }

 /**
  * Convert an instance of IndicatorGaugeDataSourceResponse to an JSON string
  *
  * @return JSON string
  */
