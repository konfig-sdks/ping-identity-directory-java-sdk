...
public class GroupRestResourceTypeResponse {
  ...
  public GroupRestResourceTypeResponse() {
  }

  public GroupRestResourceTypeResponse id(String id) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse description(String description) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse schemas(List<EnumgroupRestResourceTypeSchemaUrn> schemas) {
  ...
  public GroupRestResourceTypeResponse addSchemasItem(EnumgroupRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public GroupRestResourceTypeResponse addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse includeFilter(List<String> includeFilter) {
  ...
  public GroupRestResourceTypeResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse parentDN(String parentDN) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public GroupRestResourceTypeResponse addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public GroupRestResourceTypeResponse addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse displayName(String displayName) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GroupRestResourceTypeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GroupRestResourceTypeResponse instance itself
   */
  public GroupRestResourceTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroupRestResourceTypeResponse groupRestResourceTypeResponse = (GroupRestResourceTypeResponse) o;
    return Objects.equals(this.id, groupRestResourceTypeResponse.id) &&
        Objects.equals(this.description, groupRestResourceTypeResponse.description) &&
        Objects.equals(this.schemas, groupRestResourceTypeResponse.schemas) &&
        Objects.equals(this.membersColumnName, groupRestResourceTypeResponse.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, groupRestResourceTypeResponse.nonmembersColumnName) &&
        Objects.equals(this.enabled, groupRestResourceTypeResponse.enabled) &&
        Objects.equals(this.resourceEndpoint, groupRestResourceTypeResponse.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, groupRestResourceTypeResponse.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, groupRestResourceTypeResponse.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, groupRestResourceTypeResponse.searchBaseDN) &&
        Objects.equals(this.includeFilter, groupRestResourceTypeResponse.includeFilter) &&
        Objects.equals(this.parentDN, groupRestResourceTypeResponse.parentDN) &&
        Objects.equals(this.parentResourceType, groupRestResourceTypeResponse.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, groupRestResourceTypeResponse.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, groupRestResourceTypeResponse.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, groupRestResourceTypeResponse.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, groupRestResourceTypeResponse.updateConstructedAttribute) &&
        Objects.equals(this.displayName, groupRestResourceTypeResponse.displayName) &&
        Objects.equals(this.searchFilterPattern, groupRestResourceTypeResponse.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, groupRestResourceTypeResponse.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, groupRestResourceTypeResponse.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, groupRestResourceTypeResponse.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.meta, groupRestResourceTypeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, groupRestResourceTypeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, groupRestResourceTypeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, membersColumnName, nonmembersColumnName, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroupRestResourceTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroupRestResourceTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroupRestResourceTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroupRestResourceTypeResponse is not found in the empty JSON string", GroupRestResourceTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroupRestResourceTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroupRestResourceTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroupRestResourceTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroupRestResourceTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroupRestResourceTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroupRestResourceTypeResponse>() {
           @Override
           public void write(JsonWriter out, GroupRestResourceTypeResponse value) throws IOException {
           ...
           @Override
           public GroupRestResourceTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroupRestResourceTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroupRestResourceTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroupRestResourceTypeResponse
  * @throws IOException if the JSON string is invalid with respect to GroupRestResourceTypeResponse
  */
  public static GroupRestResourceTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroupRestResourceTypeResponse.class);
  }

 /**
  * Convert an instance of GroupRestResourceTypeResponse to an JSON string
  *
  * @return JSON string
  */
