...
public class ThirdPartyRecurringTaskShared {
  ...
  public ThirdPartyRecurringTaskShared() {
  }

  public ThirdPartyRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared schemas(List<EnumthirdPartyRecurringTaskSchemaUrn> schemas) {
  ...
  public ThirdPartyRecurringTaskShared addSchemasItem(EnumthirdPartyRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyRecurringTaskShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public ThirdPartyRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public ThirdPartyRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public ThirdPartyRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the ThirdPartyRecurringTaskShared instance itself
   */
  public ThirdPartyRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyRecurringTaskShared thirdPartyRecurringTaskShared = (ThirdPartyRecurringTaskShared) o;
    return Objects.equals(this.description, thirdPartyRecurringTaskShared.description) &&
        Objects.equals(this.schemas, thirdPartyRecurringTaskShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyRecurringTaskShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyRecurringTaskShared.extensionArgument) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, thirdPartyRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, thirdPartyRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, thirdPartyRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, thirdPartyRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, thirdPartyRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, thirdPartyRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, thirdPartyRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, thirdPartyRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyRecurringTaskShared is not found in the empty JSON string", ThirdPartyRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyRecurringTaskShared value) throws IOException {
           ...
           @Override
           public ThirdPartyRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyRecurringTaskShared
  */
  public static ThirdPartyRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyRecurringTaskShared.class);
  }

 /**
  * Convert an instance of ThirdPartyRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
