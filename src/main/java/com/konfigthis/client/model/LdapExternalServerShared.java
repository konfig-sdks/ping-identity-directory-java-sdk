...
public class LdapExternalServerShared {
  ...
  public LdapExternalServerShared() {
  }

  public LdapExternalServerShared description(String description) {
  ...
  **/
  ...
  public LdapExternalServerShared schemas(List<EnumldapExternalServerSchemaUrn> schemas) {
  ...
  public LdapExternalServerShared addSchemasItem(EnumldapExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdapExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public LdapExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public LdapExternalServerShared location(String location) {
  ...
  **/
  ...
  public LdapExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public LdapExternalServerShared password(String password) {
  ...
  **/
  ...
  public LdapExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public LdapExternalServerShared connectionSecurity(EnumexternalServerLdapConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public LdapExternalServerShared authenticationMethod(EnumexternalServerLdapAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public LdapExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public LdapExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public LdapExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public LdapExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public LdapExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public LdapExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public LdapExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public LdapExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public LdapExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public LdapExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public LdapExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public LdapExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public LdapExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the LdapExternalServerShared instance itself
   */
  public LdapExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapExternalServerShared ldapExternalServerShared = (LdapExternalServerShared) o;
    return Objects.equals(this.description, ldapExternalServerShared.description) &&
        Objects.equals(this.schemas, ldapExternalServerShared.schemas) &&
        Objects.equals(this.serverHostName, ldapExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, ldapExternalServerShared.serverPort) &&
        Objects.equals(this.location, ldapExternalServerShared.location) &&
        Objects.equals(this.bindDN, ldapExternalServerShared.bindDN) &&
        Objects.equals(this.password, ldapExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, ldapExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, ldapExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, ldapExternalServerShared.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, ldapExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, ldapExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, ldapExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, ldapExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, ldapExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, ldapExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, ldapExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, ldapExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, ldapExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, ldapExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, ldapExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, ldapExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, ldapExternalServerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LdapExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapExternalServerShared is not found in the empty JSON string", LdapExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdapExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapExternalServerShared>() {
           @Override
           public void write(JsonWriter out, LdapExternalServerShared value) throws IOException {
           ...
           @Override
           public LdapExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to LdapExternalServerShared
  */
  public static LdapExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapExternalServerShared.class);
  }

 /**
  * Convert an instance of LdapExternalServerShared to an JSON string
  *
  * @return JSON string
  */
