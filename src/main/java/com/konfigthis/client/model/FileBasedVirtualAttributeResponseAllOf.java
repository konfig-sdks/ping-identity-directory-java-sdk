...
public class FileBasedVirtualAttributeResponseAllOf {
  ...
  private List<EnumfileBasedVirtualAttributeSchemaUrn> schemas = null;
  ...
  public FileBasedVirtualAttributeResponseAllOf() {
  }

  public FileBasedVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf schemas(List<EnumfileBasedVirtualAttributeSchemaUrn> schemas) {
  ...
  public FileBasedVirtualAttributeResponseAllOf addSchemasItem(EnumfileBasedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf sourceAttribute(String sourceAttribute) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the name or OID of the attribute which specifies the path to the file from which the value should be retrieved. If this attribute is multivalued, then the attribute specified in the attribute-type property must also be multivalued.")
  ...
  public FileBasedVirtualAttributeResponseAllOf dataDirectory(String dataDirectory) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the path to the directory in which the data files exist. Paths to data files will be relative to this directory, and only data files contained in this directory will be used. This directory must exist.")
  ...
  public FileBasedVirtualAttributeResponseAllOf maxFileSize(String maxFileSize) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public FileBasedVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public FileBasedVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public FileBasedVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public FileBasedVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public FileBasedVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the FileBasedVirtualAttributeResponseAllOf instance itself
   */
  public FileBasedVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedVirtualAttributeResponseAllOf fileBasedVirtualAttributeResponseAllOf = (FileBasedVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, fileBasedVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, fileBasedVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, fileBasedVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, fileBasedVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.sourceAttribute, fileBasedVirtualAttributeResponseAllOf.sourceAttribute) &&
        Objects.equals(this.dataDirectory, fileBasedVirtualAttributeResponseAllOf.dataDirectory) &&
        Objects.equals(this.maxFileSize, fileBasedVirtualAttributeResponseAllOf.maxFileSize) &&
        Objects.equals(this.enabled, fileBasedVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.attributeType, fileBasedVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.baseDN, fileBasedVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, fileBasedVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, fileBasedVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, fileBasedVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, fileBasedVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, fileBasedVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, fileBasedVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, fileBasedVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, fileBasedVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileBasedVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedVirtualAttributeResponseAllOf is not found in the empty JSON string", FileBasedVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("sourceAttribute") != null && !jsonObj.get("sourceAttribute").isJsonNull()) && !jsonObj.get("sourceAttribute").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("dataDirectory") != null && !jsonObj.get("dataDirectory").isJsonNull()) && !jsonObj.get("dataDirectory").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, FileBasedVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public FileBasedVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to FileBasedVirtualAttributeResponseAllOf
  */
  public static FileBasedVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of FileBasedVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
