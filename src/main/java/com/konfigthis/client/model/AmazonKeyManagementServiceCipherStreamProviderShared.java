...
public class AmazonKeyManagementServiceCipherStreamProviderShared {
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared() {
  }

  public AmazonKeyManagementServiceCipherStreamProviderShared description(String description) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared schemas(List<EnumamazonKeyManagementServiceCipherStreamProviderSchemaUrn> schemas) {
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared addSchemasItem(EnumamazonKeyManagementServiceCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared encryptedPassphraseFile(String encryptedPassphraseFile) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared awsAccessKeyID(String awsAccessKeyID) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared awsSecretAccessKey(String awsSecretAccessKey) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared awsRegionName(String awsRegionName) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared kmsEncryptionKeyArn(String kmsEncryptionKeyArn) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public AmazonKeyManagementServiceCipherStreamProviderShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AmazonKeyManagementServiceCipherStreamProviderShared instance itself
   */
  public AmazonKeyManagementServiceCipherStreamProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonKeyManagementServiceCipherStreamProviderShared amazonKeyManagementServiceCipherStreamProviderShared = (AmazonKeyManagementServiceCipherStreamProviderShared) o;
    return Objects.equals(this.description, amazonKeyManagementServiceCipherStreamProviderShared.description) &&
        Objects.equals(this.schemas, amazonKeyManagementServiceCipherStreamProviderShared.schemas) &&
        Objects.equals(this.encryptedPassphraseFile, amazonKeyManagementServiceCipherStreamProviderShared.encryptedPassphraseFile) &&
        Objects.equals(this.awsExternalServer, amazonKeyManagementServiceCipherStreamProviderShared.awsExternalServer) &&
        Objects.equals(this.awsAccessKeyID, amazonKeyManagementServiceCipherStreamProviderShared.awsAccessKeyID) &&
        Objects.equals(this.awsSecretAccessKey, amazonKeyManagementServiceCipherStreamProviderShared.awsSecretAccessKey) &&
        Objects.equals(this.awsRegionName, amazonKeyManagementServiceCipherStreamProviderShared.awsRegionName) &&
        Objects.equals(this.kmsEncryptionKeyArn, amazonKeyManagementServiceCipherStreamProviderShared.kmsEncryptionKeyArn) &&
        Objects.equals(this.iterationCount, amazonKeyManagementServiceCipherStreamProviderShared.iterationCount) &&
        Objects.equals(this.enabled, amazonKeyManagementServiceCipherStreamProviderShared.enabled)&&
        Objects.equals(this.additionalProperties, amazonKeyManagementServiceCipherStreamProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, encryptedPassphraseFile, awsExternalServer, awsAccessKeyID, awsSecretAccessKey, awsRegionName, kmsEncryptionKeyArn, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AmazonKeyManagementServiceCipherStreamProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AmazonKeyManagementServiceCipherStreamProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AmazonKeyManagementServiceCipherStreamProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonKeyManagementServiceCipherStreamProviderShared is not found in the empty JSON string", AmazonKeyManagementServiceCipherStreamProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonKeyManagementServiceCipherStreamProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonKeyManagementServiceCipherStreamProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonKeyManagementServiceCipherStreamProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonKeyManagementServiceCipherStreamProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonKeyManagementServiceCipherStreamProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonKeyManagementServiceCipherStreamProviderShared>() {
           @Override
           public void write(JsonWriter out, AmazonKeyManagementServiceCipherStreamProviderShared value) throws IOException {
           ...
           @Override
           public AmazonKeyManagementServiceCipherStreamProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AmazonKeyManagementServiceCipherStreamProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AmazonKeyManagementServiceCipherStreamProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AmazonKeyManagementServiceCipherStreamProviderShared
  * @throws IOException if the JSON string is invalid with respect to AmazonKeyManagementServiceCipherStreamProviderShared
  */
  public static AmazonKeyManagementServiceCipherStreamProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonKeyManagementServiceCipherStreamProviderShared.class);
  }

 /**
  * Convert an instance of AmazonKeyManagementServiceCipherStreamProviderShared to an JSON string
  *
  * @return JSON string
  */
