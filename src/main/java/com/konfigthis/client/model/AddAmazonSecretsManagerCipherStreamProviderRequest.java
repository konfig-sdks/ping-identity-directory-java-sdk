...
public class AddAmazonSecretsManagerCipherStreamProviderRequest {
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest() {
  }

  public AddAmazonSecretsManagerCipherStreamProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest description(String description) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest schemas(List<EnumamazonSecretsManagerCipherStreamProviderSchemaUrn> schemas) {
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest addSchemasItem(EnumamazonSecretsManagerCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest secretID(String secretID) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest secretFieldName(String secretFieldName) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest secretVersionID(String secretVersionID) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest secretVersionStage(String secretVersionStage) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest encryptionMetadataFile(String encryptionMetadataFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The path to a file that will hold metadata about the encryption performed by this Amazon Secrets Manager Cipher Stream Provider.")
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public AddAmazonSecretsManagerCipherStreamProviderRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddAmazonSecretsManagerCipherStreamProviderRequest instance itself
   */
  public AddAmazonSecretsManagerCipherStreamProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAmazonSecretsManagerCipherStreamProviderRequest addAmazonSecretsManagerCipherStreamProviderRequest = (AddAmazonSecretsManagerCipherStreamProviderRequest) o;
    return Objects.equals(this.providerName, addAmazonSecretsManagerCipherStreamProviderRequest.providerName) &&
        Objects.equals(this.description, addAmazonSecretsManagerCipherStreamProviderRequest.description) &&
        Objects.equals(this.schemas, addAmazonSecretsManagerCipherStreamProviderRequest.schemas) &&
        Objects.equals(this.awsExternalServer, addAmazonSecretsManagerCipherStreamProviderRequest.awsExternalServer) &&
        Objects.equals(this.secretID, addAmazonSecretsManagerCipherStreamProviderRequest.secretID) &&
        Objects.equals(this.secretFieldName, addAmazonSecretsManagerCipherStreamProviderRequest.secretFieldName) &&
        Objects.equals(this.secretVersionID, addAmazonSecretsManagerCipherStreamProviderRequest.secretVersionID) &&
        Objects.equals(this.secretVersionStage, addAmazonSecretsManagerCipherStreamProviderRequest.secretVersionStage) &&
        Objects.equals(this.encryptionMetadataFile, addAmazonSecretsManagerCipherStreamProviderRequest.encryptionMetadataFile) &&
        Objects.equals(this.iterationCount, addAmazonSecretsManagerCipherStreamProviderRequest.iterationCount) &&
        Objects.equals(this.enabled, addAmazonSecretsManagerCipherStreamProviderRequest.enabled)&&
        Objects.equals(this.additionalProperties, addAmazonSecretsManagerCipherStreamProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, description, schemas, awsExternalServer, secretID, secretFieldName, secretVersionID, secretVersionStage, encryptionMetadataFile, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAmazonSecretsManagerCipherStreamProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAmazonSecretsManagerCipherStreamProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAmazonSecretsManagerCipherStreamProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAmazonSecretsManagerCipherStreamProviderRequest is not found in the empty JSON string", AddAmazonSecretsManagerCipherStreamProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAmazonSecretsManagerCipherStreamProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAmazonSecretsManagerCipherStreamProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAmazonSecretsManagerCipherStreamProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAmazonSecretsManagerCipherStreamProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAmazonSecretsManagerCipherStreamProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAmazonSecretsManagerCipherStreamProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddAmazonSecretsManagerCipherStreamProviderRequest value) throws IOException {
           ...
           @Override
           public AddAmazonSecretsManagerCipherStreamProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAmazonSecretsManagerCipherStreamProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAmazonSecretsManagerCipherStreamProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAmazonSecretsManagerCipherStreamProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddAmazonSecretsManagerCipherStreamProviderRequest
  */
  public static AddAmazonSecretsManagerCipherStreamProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAmazonSecretsManagerCipherStreamProviderRequest.class);
  }

 /**
  * Convert an instance of AddAmazonSecretsManagerCipherStreamProviderRequest to an JSON string
  *
  * @return JSON string
  */
