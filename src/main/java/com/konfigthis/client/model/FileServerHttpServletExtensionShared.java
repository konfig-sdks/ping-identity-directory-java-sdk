...
public class FileServerHttpServletExtensionShared {
  ...
  public FileServerHttpServletExtensionShared() {
  }

  public FileServerHttpServletExtensionShared description(String description) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared schemas(List<EnumfileServerHttpServletExtensionSchemaUrn> schemas) {
  ...
  public FileServerHttpServletExtensionShared addSchemasItem(EnumfileServerHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared documentRootDirectory(String documentRootDirectory) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared enableDirectoryIndexing(Boolean enableDirectoryIndexing) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared indexFile(List<String> indexFile) {
  ...
  public FileServerHttpServletExtensionShared addIndexFileItem(String indexFileItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared mimeTypesFile(String mimeTypesFile) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared defaultMIMEType(String defaultMIMEType) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared requireAuthentication(Boolean requireAuthentication) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared allowedAuthenticationType(List<EnumhttpServletExtensionAllowedAuthenticationTypeProp> allowedAuthenticationType) {
  ...
  public FileServerHttpServletExtensionShared addAllowedAuthenticationTypeItem(EnumhttpServletExtensionAllowedAuthenticationTypeProp allowedAuthenticationTypeItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public FileServerHttpServletExtensionShared addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared idTokenValidator(List<String> idTokenValidator) {
  ...
  public FileServerHttpServletExtensionShared addIdTokenValidatorItem(String idTokenValidatorItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared requireFileServletAccessPrivilege(Boolean requireFileServletAccessPrivilege) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared requireGroup(List<String> requireGroup) {
  ...
  public FileServerHttpServletExtensionShared addRequireGroupItem(String requireGroupItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared identityMapper(String identityMapper) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared responseHeader(List<String> responseHeader) {
  ...
  public FileServerHttpServletExtensionShared addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public FileServerHttpServletExtensionShared correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the FileServerHttpServletExtensionShared instance itself
   */
  public FileServerHttpServletExtensionShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileServerHttpServletExtensionShared fileServerHttpServletExtensionShared = (FileServerHttpServletExtensionShared) o;
    return Objects.equals(this.description, fileServerHttpServletExtensionShared.description) &&
        Objects.equals(this.schemas, fileServerHttpServletExtensionShared.schemas) &&
        Objects.equals(this.baseContextPath, fileServerHttpServletExtensionShared.baseContextPath) &&
        Objects.equals(this.documentRootDirectory, fileServerHttpServletExtensionShared.documentRootDirectory) &&
        Objects.equals(this.enableDirectoryIndexing, fileServerHttpServletExtensionShared.enableDirectoryIndexing) &&
        Objects.equals(this.indexFile, fileServerHttpServletExtensionShared.indexFile) &&
        Objects.equals(this.mimeTypesFile, fileServerHttpServletExtensionShared.mimeTypesFile) &&
        Objects.equals(this.defaultMIMEType, fileServerHttpServletExtensionShared.defaultMIMEType) &&
        Objects.equals(this.requireAuthentication, fileServerHttpServletExtensionShared.requireAuthentication) &&
        Objects.equals(this.allowedAuthenticationType, fileServerHttpServletExtensionShared.allowedAuthenticationType) &&
        Objects.equals(this.accessTokenValidator, fileServerHttpServletExtensionShared.accessTokenValidator) &&
        Objects.equals(this.idTokenValidator, fileServerHttpServletExtensionShared.idTokenValidator) &&
        Objects.equals(this.requireFileServletAccessPrivilege, fileServerHttpServletExtensionShared.requireFileServletAccessPrivilege) &&
        Objects.equals(this.requireGroup, fileServerHttpServletExtensionShared.requireGroup) &&
        Objects.equals(this.identityMapper, fileServerHttpServletExtensionShared.identityMapper) &&
        Objects.equals(this.crossOriginPolicy, fileServerHttpServletExtensionShared.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, fileServerHttpServletExtensionShared.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, fileServerHttpServletExtensionShared.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, fileServerHttpServletExtensionShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, baseContextPath, documentRootDirectory, enableDirectoryIndexing, indexFile, mimeTypesFile, defaultMIMEType, requireAuthentication, allowedAuthenticationType, accessTokenValidator, idTokenValidator, requireFileServletAccessPrivilege, requireGroup, identityMapper, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileServerHttpServletExtensionShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileServerHttpServletExtensionShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileServerHttpServletExtensionShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileServerHttpServletExtensionShared is not found in the empty JSON string", FileServerHttpServletExtensionShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileServerHttpServletExtensionShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileServerHttpServletExtensionShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileServerHttpServletExtensionShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileServerHttpServletExtensionShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileServerHttpServletExtensionShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FileServerHttpServletExtensionShared>() {
           @Override
           public void write(JsonWriter out, FileServerHttpServletExtensionShared value) throws IOException {
           ...
           @Override
           public FileServerHttpServletExtensionShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileServerHttpServletExtensionShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileServerHttpServletExtensionShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileServerHttpServletExtensionShared
  * @throws IOException if the JSON string is invalid with respect to FileServerHttpServletExtensionShared
  */
  public static FileServerHttpServletExtensionShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileServerHttpServletExtensionShared.class);
  }

 /**
  * Convert an instance of FileServerHttpServletExtensionShared to an JSON string
  *
  * @return JSON string
  */
