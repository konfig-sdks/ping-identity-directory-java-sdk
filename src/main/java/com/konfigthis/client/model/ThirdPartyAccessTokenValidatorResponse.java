...
public class ThirdPartyAccessTokenValidatorResponse {
  ...
  public ThirdPartyAccessTokenValidatorResponse() {
  }

  public ThirdPartyAccessTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse schemas(List<EnumthirdPartyAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public ThirdPartyAccessTokenValidatorResponse addSchemasItem(EnumthirdPartyAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyAccessTokenValidatorResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyAccessTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyAccessTokenValidatorResponse instance itself
   */
  public ThirdPartyAccessTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyAccessTokenValidatorResponse thirdPartyAccessTokenValidatorResponse = (ThirdPartyAccessTokenValidatorResponse) o;
    return Objects.equals(this.id, thirdPartyAccessTokenValidatorResponse.id) &&
        Objects.equals(this.description, thirdPartyAccessTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, thirdPartyAccessTokenValidatorResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyAccessTokenValidatorResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyAccessTokenValidatorResponse.extensionArgument) &&
        Objects.equals(this.identityMapper, thirdPartyAccessTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, thirdPartyAccessTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.enabled, thirdPartyAccessTokenValidatorResponse.enabled) &&
        Objects.equals(this.evaluationOrderIndex, thirdPartyAccessTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.meta, thirdPartyAccessTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyAccessTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyAccessTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, identityMapper, subjectClaimName, enabled, evaluationOrderIndex, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyAccessTokenValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyAccessTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyAccessTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyAccessTokenValidatorResponse is not found in the empty JSON string", ThirdPartyAccessTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyAccessTokenValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyAccessTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyAccessTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyAccessTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyAccessTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyAccessTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyAccessTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyAccessTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyAccessTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyAccessTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyAccessTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyAccessTokenValidatorResponse
  */
  public static ThirdPartyAccessTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyAccessTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyAccessTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
