...
public class ErrorLogAccountStatusNotificationHandlerShared {
  ...
  public ErrorLogAccountStatusNotificationHandlerShared() {
  }

  public ErrorLogAccountStatusNotificationHandlerShared description(String description) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared schemas(List<EnumerrorLogAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public ErrorLogAccountStatusNotificationHandlerShared addSchemasItem(EnumerrorLogAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared accountStatusNotificationType(List<EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp> accountStatusNotificationType) {
  ...
  public ErrorLogAccountStatusNotificationHandlerShared addAccountStatusNotificationTypeItem(EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp accountStatusNotificationTypeItem) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public ErrorLogAccountStatusNotificationHandlerShared accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the ErrorLogAccountStatusNotificationHandlerShared instance itself
   */
  public ErrorLogAccountStatusNotificationHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorLogAccountStatusNotificationHandlerShared errorLogAccountStatusNotificationHandlerShared = (ErrorLogAccountStatusNotificationHandlerShared) o;
    return Objects.equals(this.description, errorLogAccountStatusNotificationHandlerShared.description) &&
        Objects.equals(this.schemas, errorLogAccountStatusNotificationHandlerShared.schemas) &&
        Objects.equals(this.accountStatusNotificationType, errorLogAccountStatusNotificationHandlerShared.accountStatusNotificationType) &&
        Objects.equals(this.enabled, errorLogAccountStatusNotificationHandlerShared.enabled) &&
        Objects.equals(this.asynchronous, errorLogAccountStatusNotificationHandlerShared.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, errorLogAccountStatusNotificationHandlerShared.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, errorLogAccountStatusNotificationHandlerShared.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, errorLogAccountStatusNotificationHandlerShared.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, errorLogAccountStatusNotificationHandlerShared.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, errorLogAccountStatusNotificationHandlerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorLogAccountStatusNotificationHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ErrorLogAccountStatusNotificationHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorLogAccountStatusNotificationHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorLogAccountStatusNotificationHandlerShared is not found in the empty JSON string", ErrorLogAccountStatusNotificationHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ErrorLogAccountStatusNotificationHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorLogAccountStatusNotificationHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorLogAccountStatusNotificationHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorLogAccountStatusNotificationHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorLogAccountStatusNotificationHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorLogAccountStatusNotificationHandlerShared>() {
           @Override
           public void write(JsonWriter out, ErrorLogAccountStatusNotificationHandlerShared value) throws IOException {
           ...
           @Override
           public ErrorLogAccountStatusNotificationHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ErrorLogAccountStatusNotificationHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ErrorLogAccountStatusNotificationHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ErrorLogAccountStatusNotificationHandlerShared
  * @throws IOException if the JSON string is invalid with respect to ErrorLogAccountStatusNotificationHandlerShared
  */
  public static ErrorLogAccountStatusNotificationHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorLogAccountStatusNotificationHandlerShared.class);
  }

 /**
  * Convert an instance of ErrorLogAccountStatusNotificationHandlerShared to an JSON string
  *
  * @return JSON string
  */
