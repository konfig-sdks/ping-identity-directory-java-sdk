...
public class ThirdPartyRecurringTaskResponse {
  ...
  public ThirdPartyRecurringTaskResponse() {
  }

  public ThirdPartyRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse schemas(List<EnumthirdPartyRecurringTaskSchemaUrn> schemas) {
  ...
  public ThirdPartyRecurringTaskResponse addSchemasItem(EnumthirdPartyRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyRecurringTaskResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public ThirdPartyRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public ThirdPartyRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public ThirdPartyRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyRecurringTaskResponse instance itself
   */
  public ThirdPartyRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyRecurringTaskResponse thirdPartyRecurringTaskResponse = (ThirdPartyRecurringTaskResponse) o;
    return Objects.equals(this.id, thirdPartyRecurringTaskResponse.id) &&
        Objects.equals(this.description, thirdPartyRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, thirdPartyRecurringTaskResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyRecurringTaskResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyRecurringTaskResponse.extensionArgument) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, thirdPartyRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, thirdPartyRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, thirdPartyRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, thirdPartyRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, thirdPartyRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, thirdPartyRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, thirdPartyRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, thirdPartyRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyRecurringTaskResponse is not found in the empty JSON string", ThirdPartyRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyRecurringTaskResponse
  */
  public static ThirdPartyRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
