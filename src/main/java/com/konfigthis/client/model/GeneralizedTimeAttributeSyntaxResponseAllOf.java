...
public class GeneralizedTimeAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf() {
  }

  public GeneralizedTimeAttributeSyntaxResponseAllOf schemas(List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> schemas) {
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf addSchemasItem(EnumgeneralizedTimeAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the GeneralizedTimeAttributeSyntaxResponseAllOf instance itself
   */
  public GeneralizedTimeAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GeneralizedTimeAttributeSyntaxResponseAllOf generalizedTimeAttributeSyntaxResponseAllOf = (GeneralizedTimeAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, generalizedTimeAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, generalizedTimeAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, generalizedTimeAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, generalizedTimeAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, generalizedTimeAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, generalizedTimeAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, generalizedTimeAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, generalizedTimeAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneralizedTimeAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GeneralizedTimeAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GeneralizedTimeAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeneralizedTimeAttributeSyntaxResponseAllOf is not found in the empty JSON string", GeneralizedTimeAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeneralizedTimeAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeneralizedTimeAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeneralizedTimeAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeneralizedTimeAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<GeneralizedTimeAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, GeneralizedTimeAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public GeneralizedTimeAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GeneralizedTimeAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GeneralizedTimeAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GeneralizedTimeAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to GeneralizedTimeAttributeSyntaxResponseAllOf
  */
  public static GeneralizedTimeAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeneralizedTimeAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of GeneralizedTimeAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
