...
public class KeyPairResponse {
  ...
  public KeyPairResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Key Pair")
  ...
  public KeyPairResponse schemas(List<EnumkeyPairSchemaUrn> schemas) {
  ...
  public KeyPairResponse addSchemasItem(EnumkeyPairSchemaUrn schemasItem) {
  ...
  **/
  ...
  public KeyPairResponse keyAlgorithm(EnumkeyPairKeyAlgorithmProp keyAlgorithm) {
  ...
  **/
  ...
  public KeyPairResponse selfSignedCertificateValidity(String selfSignedCertificateValidity) {
  ...
  **/
  ...
  public KeyPairResponse subjectDN(String subjectDN) {
  ...
  **/
  ...
  public KeyPairResponse certificateChain(String certificateChain) {
  ...
  **/
  ...
  public KeyPairResponse privateKey(String privateKey) {
  ...
  **/
  ...
  public KeyPairResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public KeyPairResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the KeyPairResponse instance itself
   */
  public KeyPairResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KeyPairResponse keyPairResponse = (KeyPairResponse) o;
    return Objects.equals(this.id, keyPairResponse.id) &&
        Objects.equals(this.schemas, keyPairResponse.schemas) &&
        Objects.equals(this.keyAlgorithm, keyPairResponse.keyAlgorithm) &&
        Objects.equals(this.selfSignedCertificateValidity, keyPairResponse.selfSignedCertificateValidity) &&
        Objects.equals(this.subjectDN, keyPairResponse.subjectDN) &&
        Objects.equals(this.certificateChain, keyPairResponse.certificateChain) &&
        Objects.equals(this.privateKey, keyPairResponse.privateKey) &&
        Objects.equals(this.meta, keyPairResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, keyPairResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, keyPairResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, schemas, keyAlgorithm, selfSignedCertificateValidity, subjectDN, certificateChain, privateKey, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeyPairResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KeyPairResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KeyPairResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyPairResponse is not found in the empty JSON string", KeyPairResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : KeyPairResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyPairResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyPairResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyPairResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyPairResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyPairResponse>() {
           @Override
           public void write(JsonWriter out, KeyPairResponse value) throws IOException {
           ...
           @Override
           public KeyPairResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KeyPairResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KeyPairResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeyPairResponse
  * @throws IOException if the JSON string is invalid with respect to KeyPairResponse
  */
  public static KeyPairResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyPairResponse.class);
  }

 /**
  * Convert an instance of KeyPairResponse to an JSON string
  *
  * @return JSON string
  */
