...
public class SyslogJsonAuditLogPublisherShared {
  ...
  public SyslogJsonAuditLogPublisherShared() {
  }

  public SyslogJsonAuditLogPublisherShared description(String description) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared schemas(List<EnumsyslogJsonAuditLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonAuditLogPublisherShared addSchemasItem(EnumsyslogJsonAuditLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonAuditLogPublisherShared addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared useReversibleForm(Boolean useReversibleForm) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared softDeleteEntryAuditBehavior(EnumlogPublisherSyslogJsonAuditSoftDeleteEntryAuditBehaviorProp softDeleteEntryAuditBehavior) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeOperationPurposeRequestControl(Boolean includeOperationPurposeRequestControl) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeIntermediateClientRequestControl(Boolean includeIntermediateClientRequestControl) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared obscureAttribute(List<String> obscureAttribute) {
  ...
  public SyslogJsonAuditLogPublisherShared addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared excludeAttribute(List<String> excludeAttribute) {
  ...
  public SyslogJsonAuditLogPublisherShared addExcludeAttributeItem(String excludeAttributeItem) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonAuditLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyslogJsonAuditLogPublisherShared instance itself
   */
  public SyslogJsonAuditLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonAuditLogPublisherShared syslogJsonAuditLogPublisherShared = (SyslogJsonAuditLogPublisherShared) o;
    return Objects.equals(this.description, syslogJsonAuditLogPublisherShared.description) &&
        Objects.equals(this.schemas, syslogJsonAuditLogPublisherShared.schemas) &&
        Objects.equals(this.syslogExternalServer, syslogJsonAuditLogPublisherShared.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonAuditLogPublisherShared.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonAuditLogPublisherShared.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonAuditLogPublisherShared.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonAuditLogPublisherShared.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonAuditLogPublisherShared.queueSize) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonAuditLogPublisherShared.writeMultiLineMessages) &&
        Objects.equals(this.useReversibleForm, syslogJsonAuditLogPublisherShared.useReversibleForm) &&
        Objects.equals(this.softDeleteEntryAuditBehavior, syslogJsonAuditLogPublisherShared.softDeleteEntryAuditBehavior) &&
        Objects.equals(this.includeOperationPurposeRequestControl, syslogJsonAuditLogPublisherShared.includeOperationPurposeRequestControl) &&
        Objects.equals(this.includeIntermediateClientRequestControl, syslogJsonAuditLogPublisherShared.includeIntermediateClientRequestControl) &&
        Objects.equals(this.obscureAttribute, syslogJsonAuditLogPublisherShared.obscureAttribute) &&
        Objects.equals(this.excludeAttribute, syslogJsonAuditLogPublisherShared.excludeAttribute) &&
        Objects.equals(this.suppressInternalOperations, syslogJsonAuditLogPublisherShared.suppressInternalOperations) &&
        Objects.equals(this.includeProductName, syslogJsonAuditLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonAuditLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonAuditLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonAuditLogPublisherShared.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, syslogJsonAuditLogPublisherShared.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, syslogJsonAuditLogPublisherShared.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestControls, syslogJsonAuditLogPublisherShared.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, syslogJsonAuditLogPublisherShared.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, syslogJsonAuditLogPublisherShared.includeReplicationChangeID) &&
        Objects.equals(this.logSecurityNegotiation, syslogJsonAuditLogPublisherShared.logSecurityNegotiation) &&
        Objects.equals(this.suppressReplicationOperations, syslogJsonAuditLogPublisherShared.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, syslogJsonAuditLogPublisherShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, syslogJsonAuditLogPublisherShared.requestCriteria) &&
        Objects.equals(this.resultCriteria, syslogJsonAuditLogPublisherShared.resultCriteria) &&
        Objects.equals(this.enabled, syslogJsonAuditLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonAuditLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syslogJsonAuditLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyslogJsonAuditLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonAuditLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonAuditLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonAuditLogPublisherShared is not found in the empty JSON string", SyslogJsonAuditLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonAuditLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonAuditLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonAuditLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonAuditLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonAuditLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonAuditLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, SyslogJsonAuditLogPublisherShared value) throws IOException {
           ...
           @Override
           public SyslogJsonAuditLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonAuditLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonAuditLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonAuditLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonAuditLogPublisherShared
  */
  public static SyslogJsonAuditLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonAuditLogPublisherShared.class);
  }

 /**
  * Convert an instance of SyslogJsonAuditLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
