...
public class AddLdapExternalServerRequest {
  ...
  public AddLdapExternalServerRequest() {
  }

  public AddLdapExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest schemas(List<EnumldapExternalServerSchemaUrn> schemas) {
  ...
  public AddLdapExternalServerRequest addSchemasItem(EnumldapExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest location(String location) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest bindDN(String bindDN) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest password(String password) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest connectionSecurity(EnumexternalServerLdapConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest authenticationMethod(EnumexternalServerLdapAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public AddLdapExternalServerRequest addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public AddLdapExternalServerRequest abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the AddLdapExternalServerRequest instance itself
   */
  public AddLdapExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddLdapExternalServerRequest addLdapExternalServerRequest = (AddLdapExternalServerRequest) o;
    return Objects.equals(this.serverName, addLdapExternalServerRequest.serverName) &&
        Objects.equals(this.description, addLdapExternalServerRequest.description) &&
        Objects.equals(this.schemas, addLdapExternalServerRequest.schemas) &&
        Objects.equals(this.serverHostName, addLdapExternalServerRequest.serverHostName) &&
        Objects.equals(this.serverPort, addLdapExternalServerRequest.serverPort) &&
        Objects.equals(this.location, addLdapExternalServerRequest.location) &&
        Objects.equals(this.bindDN, addLdapExternalServerRequest.bindDN) &&
        Objects.equals(this.password, addLdapExternalServerRequest.password) &&
        Objects.equals(this.passphraseProvider, addLdapExternalServerRequest.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, addLdapExternalServerRequest.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, addLdapExternalServerRequest.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, addLdapExternalServerRequest.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, addLdapExternalServerRequest.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, addLdapExternalServerRequest.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, addLdapExternalServerRequest.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, addLdapExternalServerRequest.connectTimeout) &&
        Objects.equals(this.maxResponseSize, addLdapExternalServerRequest.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, addLdapExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addLdapExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.initialConnections, addLdapExternalServerRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addLdapExternalServerRequest.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, addLdapExternalServerRequest.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, addLdapExternalServerRequest.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, addLdapExternalServerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddLdapExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddLdapExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddLdapExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLdapExternalServerRequest is not found in the empty JSON string", AddLdapExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLdapExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLdapExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLdapExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLdapExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLdapExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLdapExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddLdapExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddLdapExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddLdapExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddLdapExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddLdapExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddLdapExternalServerRequest
  */
  public static AddLdapExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLdapExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddLdapExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
