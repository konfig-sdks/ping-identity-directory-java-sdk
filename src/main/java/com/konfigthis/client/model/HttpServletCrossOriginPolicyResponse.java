...
public class HttpServletCrossOriginPolicyResponse {
  ...
  public HttpServletCrossOriginPolicyResponse() {
  }

  public HttpServletCrossOriginPolicyResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the HTTP Servlet Cross Origin Policy")
  ...
  public HttpServletCrossOriginPolicyResponse description(String description) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse schemas(List<EnumhttpServletCrossOriginPolicySchemaUrn> schemas) {
  ...
  public HttpServletCrossOriginPolicyResponse addSchemasItem(EnumhttpServletCrossOriginPolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsAllowedMethods(List<String> corsAllowedMethods) {
  ...
  public HttpServletCrossOriginPolicyResponse addCorsAllowedMethodsItem(String corsAllowedMethodsItem) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsAllowedOrigins(List<String> corsAllowedOrigins) {
  ...
  public HttpServletCrossOriginPolicyResponse addCorsAllowedOriginsItem(String corsAllowedOriginsItem) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsExposedHeaders(List<String> corsExposedHeaders) {
  ...
  public HttpServletCrossOriginPolicyResponse addCorsExposedHeadersItem(String corsExposedHeadersItem) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsAllowedHeaders(List<String> corsAllowedHeaders) {
  ...
  public HttpServletCrossOriginPolicyResponse addCorsAllowedHeadersItem(String corsAllowedHeadersItem) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsPreflightMaxAge(String corsPreflightMaxAge) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse corsAllowCredentials(Boolean corsAllowCredentials) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public HttpServletCrossOriginPolicyResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the HttpServletCrossOriginPolicyResponse instance itself
   */
  public HttpServletCrossOriginPolicyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HttpServletCrossOriginPolicyResponse httpServletCrossOriginPolicyResponse = (HttpServletCrossOriginPolicyResponse) o;
    return Objects.equals(this.id, httpServletCrossOriginPolicyResponse.id) &&
        Objects.equals(this.description, httpServletCrossOriginPolicyResponse.description) &&
        Objects.equals(this.schemas, httpServletCrossOriginPolicyResponse.schemas) &&
        Objects.equals(this.corsAllowedMethods, httpServletCrossOriginPolicyResponse.corsAllowedMethods) &&
        Objects.equals(this.corsAllowedOrigins, httpServletCrossOriginPolicyResponse.corsAllowedOrigins) &&
        Objects.equals(this.corsExposedHeaders, httpServletCrossOriginPolicyResponse.corsExposedHeaders) &&
        Objects.equals(this.corsAllowedHeaders, httpServletCrossOriginPolicyResponse.corsAllowedHeaders) &&
        Objects.equals(this.corsPreflightMaxAge, httpServletCrossOriginPolicyResponse.corsPreflightMaxAge) &&
        Objects.equals(this.corsAllowCredentials, httpServletCrossOriginPolicyResponse.corsAllowCredentials) &&
        Objects.equals(this.meta, httpServletCrossOriginPolicyResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, httpServletCrossOriginPolicyResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, httpServletCrossOriginPolicyResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, corsAllowedMethods, corsAllowedOrigins, corsExposedHeaders, corsAllowedHeaders, corsPreflightMaxAge, corsAllowCredentials, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HttpServletCrossOriginPolicyResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HttpServletCrossOriginPolicyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HttpServletCrossOriginPolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpServletCrossOriginPolicyResponse is not found in the empty JSON string", HttpServletCrossOriginPolicyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpServletCrossOriginPolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpServletCrossOriginPolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpServletCrossOriginPolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpServletCrossOriginPolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpServletCrossOriginPolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpServletCrossOriginPolicyResponse>() {
           @Override
           public void write(JsonWriter out, HttpServletCrossOriginPolicyResponse value) throws IOException {
           ...
           @Override
           public HttpServletCrossOriginPolicyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HttpServletCrossOriginPolicyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HttpServletCrossOriginPolicyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HttpServletCrossOriginPolicyResponse
  * @throws IOException if the JSON string is invalid with respect to HttpServletCrossOriginPolicyResponse
  */
  public static HttpServletCrossOriginPolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpServletCrossOriginPolicyResponse.class);
  }

 /**
  * Convert an instance of HttpServletCrossOriginPolicyResponse to an JSON string
  *
  * @return JSON string
  */
