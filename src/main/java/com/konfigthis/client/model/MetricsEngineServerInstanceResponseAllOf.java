...
public class MetricsEngineServerInstanceResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnummetricsEngineServerInstanceSchemaUrn> schemas = null;
  ...
  public MetricsEngineServerInstanceResponseAllOf() {
  }

  public MetricsEngineServerInstanceResponseAllOf schemas(List<EnummetricsEngineServerInstanceSchemaUrn> schemas) {
  ...
  public MetricsEngineServerInstanceResponseAllOf addSchemasItem(EnummetricsEngineServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnummetricsEngineServerInstanceSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnummetricsEngineServerInstanceSchemaUrn> schemas) {
  ...
  public MetricsEngineServerInstanceResponseAllOf id(String id) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf clusterName(String clusterName) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf hostname(String hostname) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf serverRoot(String serverRoot) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf serverVersion(String serverVersion) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf httpPort(Integer httpPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public MetricsEngineServerInstanceResponseAllOf addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf baseDN(List<String> baseDN) {
  ...
  public MetricsEngineServerInstanceResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MetricsEngineServerInstanceResponseAllOf memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public MetricsEngineServerInstanceResponseAllOf addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
   ...
   * @return the MetricsEngineServerInstanceResponseAllOf instance itself
   */
  public MetricsEngineServerInstanceResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricsEngineServerInstanceResponseAllOf metricsEngineServerInstanceResponseAllOf = (MetricsEngineServerInstanceResponseAllOf) o;
    return Objects.equals(this.schemas, metricsEngineServerInstanceResponseAllOf.schemas) &&
        Objects.equals(this.id, metricsEngineServerInstanceResponseAllOf.id) &&
        Objects.equals(this.serverInstanceType, metricsEngineServerInstanceResponseAllOf.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, metricsEngineServerInstanceResponseAllOf.serverInstanceName) &&
        Objects.equals(this.clusterName, metricsEngineServerInstanceResponseAllOf.clusterName) &&
        Objects.equals(this.serverInstanceLocation, metricsEngineServerInstanceResponseAllOf.serverInstanceLocation) &&
        Objects.equals(this.hostname, metricsEngineServerInstanceResponseAllOf.hostname) &&
        Objects.equals(this.serverRoot, metricsEngineServerInstanceResponseAllOf.serverRoot) &&
        Objects.equals(this.serverVersion, metricsEngineServerInstanceResponseAllOf.serverVersion) &&
        Objects.equals(this.interServerCertificate, metricsEngineServerInstanceResponseAllOf.interServerCertificate) &&
        Objects.equals(this.ldapPort, metricsEngineServerInstanceResponseAllOf.ldapPort) &&
        Objects.equals(this.ldapsPort, metricsEngineServerInstanceResponseAllOf.ldapsPort) &&
        Objects.equals(this.httpPort, metricsEngineServerInstanceResponseAllOf.httpPort) &&
        Objects.equals(this.httpsPort, metricsEngineServerInstanceResponseAllOf.httpsPort) &&
        Objects.equals(this.replicationPort, metricsEngineServerInstanceResponseAllOf.replicationPort) &&
        Objects.equals(this.replicationServerID, metricsEngineServerInstanceResponseAllOf.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, metricsEngineServerInstanceResponseAllOf.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, metricsEngineServerInstanceResponseAllOf.jmxPort) &&
        Objects.equals(this.jmxsPort, metricsEngineServerInstanceResponseAllOf.jmxsPort) &&
        Objects.equals(this.preferredSecurity, metricsEngineServerInstanceResponseAllOf.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, metricsEngineServerInstanceResponseAllOf.startTLSEnabled) &&
        Objects.equals(this.baseDN, metricsEngineServerInstanceResponseAllOf.baseDN) &&
        Objects.equals(this.memberOfServerGroup, metricsEngineServerInstanceResponseAllOf.memberOfServerGroup)&&
        Objects.equals(this.additionalProperties, metricsEngineServerInstanceResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetricsEngineServerInstanceResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetricsEngineServerInstanceResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricsEngineServerInstanceResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricsEngineServerInstanceResponseAllOf is not found in the empty JSON string", MetricsEngineServerInstanceResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricsEngineServerInstanceResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricsEngineServerInstanceResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricsEngineServerInstanceResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricsEngineServerInstanceResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricsEngineServerInstanceResponseAllOf>() {
           @Override
           public void write(JsonWriter out, MetricsEngineServerInstanceResponseAllOf value) throws IOException {
           ...
           @Override
           public MetricsEngineServerInstanceResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetricsEngineServerInstanceResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetricsEngineServerInstanceResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetricsEngineServerInstanceResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to MetricsEngineServerInstanceResponseAllOf
  */
  public static MetricsEngineServerInstanceResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricsEngineServerInstanceResponseAllOf.class);
  }

 /**
  * Convert an instance of MetricsEngineServerInstanceResponseAllOf to an JSON string
  *
  * @return JSON string
  */
