...
public class ConsoleWebApplicationExtensionResponseAllOf {
  ...
  private List<EnumconsoleWebApplicationExtensionSchemaUrn> schemas = null;
  ...
  public ConsoleWebApplicationExtensionResponseAllOf() {
  }

  public ConsoleWebApplicationExtensionResponseAllOf description(String description) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf schemas(List<EnumconsoleWebApplicationExtensionSchemaUrn> schemas) {
  ...
  public ConsoleWebApplicationExtensionResponseAllOf addSchemasItem(EnumconsoleWebApplicationExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the Web Application Extension")
  ...
  public ConsoleWebApplicationExtensionResponseAllOf ssoEnabled(Boolean ssoEnabled) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcClientID(String oidcClientID) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcClientSecret(String oidcClientSecret) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcClientSecretPassphraseProvider(String oidcClientSecretPassphraseProvider) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcIssuerURL(String oidcIssuerURL) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcTrustStoreFile(String oidcTrustStoreFile) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcTrustStoreType(String oidcTrustStoreType) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcTrustStorePinPassphraseProvider(String oidcTrustStorePinPassphraseProvider) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcStrictHostnameVerification(Boolean oidcStrictHostnameVerification) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf oidcTrustAll(Boolean oidcTrustAll) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf ldapServer(String ldapServer) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf trustStorePinPassphraseProvider(String trustStorePinPassphraseProvider) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf logFile(String logFile) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf complexity(EnumwebApplicationExtensionComplexityProp complexity) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf baseContextPath(String baseContextPath) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the base context path that should be used by HTTP clients to reference content. The value must start with a forward slash and at least one additional character and must represent a valid HTTP context path.")
  ...
  public ConsoleWebApplicationExtensionResponseAllOf warFile(String warFile) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf documentRootDirectory(String documentRootDirectory) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf deploymentDescriptorFile(String deploymentDescriptorFile) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf temporaryDirectory(String temporaryDirectory) {
  ...
  **/
  ...
  public ConsoleWebApplicationExtensionResponseAllOf initParameter(List<String> initParameter) {
  ...
  public ConsoleWebApplicationExtensionResponseAllOf addInitParameterItem(String initParameterItem) {
  ...
  **/
   ...
   * @return the ConsoleWebApplicationExtensionResponseAllOf instance itself
   */
  public ConsoleWebApplicationExtensionResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleWebApplicationExtensionResponseAllOf consoleWebApplicationExtensionResponseAllOf = (ConsoleWebApplicationExtensionResponseAllOf) o;
    return Objects.equals(this.description, consoleWebApplicationExtensionResponseAllOf.description) &&
        Objects.equals(this.schemas, consoleWebApplicationExtensionResponseAllOf.schemas) &&
        Objects.equals(this.id, consoleWebApplicationExtensionResponseAllOf.id) &&
        Objects.equals(this.ssoEnabled, consoleWebApplicationExtensionResponseAllOf.ssoEnabled) &&
        Objects.equals(this.oidcClientID, consoleWebApplicationExtensionResponseAllOf.oidcClientID) &&
        Objects.equals(this.oidcClientSecret, consoleWebApplicationExtensionResponseAllOf.oidcClientSecret) &&
        Objects.equals(this.oidcClientSecretPassphraseProvider, consoleWebApplicationExtensionResponseAllOf.oidcClientSecretPassphraseProvider) &&
        Objects.equals(this.oidcIssuerURL, consoleWebApplicationExtensionResponseAllOf.oidcIssuerURL) &&
        Objects.equals(this.oidcTrustStoreFile, consoleWebApplicationExtensionResponseAllOf.oidcTrustStoreFile) &&
        Objects.equals(this.oidcTrustStoreType, consoleWebApplicationExtensionResponseAllOf.oidcTrustStoreType) &&
        Objects.equals(this.oidcTrustStorePinPassphraseProvider, consoleWebApplicationExtensionResponseAllOf.oidcTrustStorePinPassphraseProvider) &&
        Objects.equals(this.oidcStrictHostnameVerification, consoleWebApplicationExtensionResponseAllOf.oidcStrictHostnameVerification) &&
        Objects.equals(this.oidcTrustAll, consoleWebApplicationExtensionResponseAllOf.oidcTrustAll) &&
        Objects.equals(this.ldapServer, consoleWebApplicationExtensionResponseAllOf.ldapServer) &&
        Objects.equals(this.trustStoreFile, consoleWebApplicationExtensionResponseAllOf.trustStoreFile) &&
        Objects.equals(this.trustStoreType, consoleWebApplicationExtensionResponseAllOf.trustStoreType) &&
        Objects.equals(this.trustStorePinPassphraseProvider, consoleWebApplicationExtensionResponseAllOf.trustStorePinPassphraseProvider) &&
        Objects.equals(this.logFile, consoleWebApplicationExtensionResponseAllOf.logFile) &&
        Objects.equals(this.complexity, consoleWebApplicationExtensionResponseAllOf.complexity) &&
        Objects.equals(this.baseContextPath, consoleWebApplicationExtensionResponseAllOf.baseContextPath) &&
        Objects.equals(this.warFile, consoleWebApplicationExtensionResponseAllOf.warFile) &&
        Objects.equals(this.documentRootDirectory, consoleWebApplicationExtensionResponseAllOf.documentRootDirectory) &&
        Objects.equals(this.deploymentDescriptorFile, consoleWebApplicationExtensionResponseAllOf.deploymentDescriptorFile) &&
        Objects.equals(this.temporaryDirectory, consoleWebApplicationExtensionResponseAllOf.temporaryDirectory) &&
        Objects.equals(this.initParameter, consoleWebApplicationExtensionResponseAllOf.initParameter)&&
        Objects.equals(this.additionalProperties, consoleWebApplicationExtensionResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, ssoEnabled, oidcClientID, oidcClientSecret, oidcClientSecretPassphraseProvider, oidcIssuerURL, oidcTrustStoreFile, oidcTrustStoreType, oidcTrustStorePinPassphraseProvider, oidcStrictHostnameVerification, oidcTrustAll, ldapServer, trustStoreFile, trustStoreType, trustStorePinPassphraseProvider, logFile, complexity, baseContextPath, warFile, documentRootDirectory, deploymentDescriptorFile, temporaryDirectory, initParameter, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleWebApplicationExtensionResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleWebApplicationExtensionResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleWebApplicationExtensionResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleWebApplicationExtensionResponseAllOf is not found in the empty JSON string", ConsoleWebApplicationExtensionResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleWebApplicationExtensionResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleWebApplicationExtensionResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleWebApplicationExtensionResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleWebApplicationExtensionResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleWebApplicationExtensionResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ConsoleWebApplicationExtensionResponseAllOf value) throws IOException {
           ...
           @Override
           public ConsoleWebApplicationExtensionResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleWebApplicationExtensionResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleWebApplicationExtensionResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleWebApplicationExtensionResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ConsoleWebApplicationExtensionResponseAllOf
  */
  public static ConsoleWebApplicationExtensionResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleWebApplicationExtensionResponseAllOf.class);
  }

 /**
  * Convert an instance of ConsoleWebApplicationExtensionResponseAllOf to an JSON string
  *
  * @return JSON string
  */
