...
public class SyslogJsonHttpOperationLogPublisherResponse {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse() {
  }

  public SyslogJsonHttpOperationLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse schemas(List<EnumsyslogJsonHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse addSchemasItem(EnumsyslogJsonHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequestHeaders(EnumlogPublisherLogRequestHeadersProp logRequestHeaders) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse suppressedRequestHeaderName(List<String> suppressedRequestHeaderName) {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse addSuppressedRequestHeaderNameItem(String suppressedRequestHeaderNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logResponseHeaders(EnumlogPublisherLogResponseHeadersProp logResponseHeaders) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse suppressedResponseHeaderName(List<String> suppressedResponseHeaderName) {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse addSuppressedResponseHeaderNameItem(String suppressedResponseHeaderNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequestAuthorizationType(Boolean logRequestAuthorizationType) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequestCookieNames(Boolean logRequestCookieNames) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logResponseCookieNames(Boolean logResponseCookieNames) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequestParameters(EnumlogPublisherLogRequestParametersProp logRequestParameters) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse suppressedRequestParameterName(List<String> suppressedRequestParameterName) {
  ...
  public SyslogJsonHttpOperationLogPublisherResponse addSuppressedRequestParameterNameItem(String suppressedRequestParameterNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRequestProtocol(Boolean logRequestProtocol) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse logRedirectURI(Boolean logRedirectURI) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogJsonHttpOperationLogPublisherResponse instance itself
   */
  public SyslogJsonHttpOperationLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonHttpOperationLogPublisherResponse syslogJsonHttpOperationLogPublisherResponse = (SyslogJsonHttpOperationLogPublisherResponse) o;
    return Objects.equals(this.id, syslogJsonHttpOperationLogPublisherResponse.id) &&
        Objects.equals(this.description, syslogJsonHttpOperationLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogJsonHttpOperationLogPublisherResponse.schemas) &&
        Objects.equals(this.syslogExternalServer, syslogJsonHttpOperationLogPublisherResponse.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonHttpOperationLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonHttpOperationLogPublisherResponse.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonHttpOperationLogPublisherResponse.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonHttpOperationLogPublisherResponse.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonHttpOperationLogPublisherResponse.queueSize) &&
        Objects.equals(this.logRequests, syslogJsonHttpOperationLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, syslogJsonHttpOperationLogPublisherResponse.logResults) &&
        Objects.equals(this.includeProductName, syslogJsonHttpOperationLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonHttpOperationLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonHttpOperationLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonHttpOperationLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, syslogJsonHttpOperationLogPublisherResponse.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.logRequestHeaders, syslogJsonHttpOperationLogPublisherResponse.logRequestHeaders) &&
        Objects.equals(this.suppressedRequestHeaderName, syslogJsonHttpOperationLogPublisherResponse.suppressedRequestHeaderName) &&
        Objects.equals(this.logResponseHeaders, syslogJsonHttpOperationLogPublisherResponse.logResponseHeaders) &&
        Objects.equals(this.suppressedResponseHeaderName, syslogJsonHttpOperationLogPublisherResponse.suppressedResponseHeaderName) &&
        Objects.equals(this.logRequestAuthorizationType, syslogJsonHttpOperationLogPublisherResponse.logRequestAuthorizationType) &&
        Objects.equals(this.logRequestCookieNames, syslogJsonHttpOperationLogPublisherResponse.logRequestCookieNames) &&
        Objects.equals(this.logResponseCookieNames, syslogJsonHttpOperationLogPublisherResponse.logResponseCookieNames) &&
        Objects.equals(this.logRequestParameters, syslogJsonHttpOperationLogPublisherResponse.logRequestParameters) &&
        Objects.equals(this.suppressedRequestParameterName, syslogJsonHttpOperationLogPublisherResponse.suppressedRequestParameterName) &&
        Objects.equals(this.logRequestProtocol, syslogJsonHttpOperationLogPublisherResponse.logRequestProtocol) &&
        Objects.equals(this.logRedirectURI, syslogJsonHttpOperationLogPublisherResponse.logRedirectURI) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonHttpOperationLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.enabled, syslogJsonHttpOperationLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonHttpOperationLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogJsonHttpOperationLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogJsonHttpOperationLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogJsonHttpOperationLogPublisherResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyslogJsonHttpOperationLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonHttpOperationLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonHttpOperationLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonHttpOperationLogPublisherResponse is not found in the empty JSON string", SyslogJsonHttpOperationLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonHttpOperationLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonHttpOperationLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonHttpOperationLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonHttpOperationLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonHttpOperationLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonHttpOperationLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogJsonHttpOperationLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogJsonHttpOperationLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonHttpOperationLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonHttpOperationLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonHttpOperationLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonHttpOperationLogPublisherResponse
  */
  public static SyslogJsonHttpOperationLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonHttpOperationLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogJsonHttpOperationLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
