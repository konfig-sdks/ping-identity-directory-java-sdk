...
public class AddErrorLogAccountStatusNotificationHandlerRequest {
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest() {
  }

  public AddErrorLogAccountStatusNotificationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest schemas(List<EnumerrorLogAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest addSchemasItem(EnumerrorLogAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest accountStatusNotificationType(List<EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp> accountStatusNotificationType) {
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest addAccountStatusNotificationTypeItem(EnumaccountStatusNotificationHandlerAccountStatusNotificationTypeProp accountStatusNotificationTypeItem) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddErrorLogAccountStatusNotificationHandlerRequest accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the AddErrorLogAccountStatusNotificationHandlerRequest instance itself
   */
  public AddErrorLogAccountStatusNotificationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddErrorLogAccountStatusNotificationHandlerRequest addErrorLogAccountStatusNotificationHandlerRequest = (AddErrorLogAccountStatusNotificationHandlerRequest) o;
    return Objects.equals(this.handlerName, addErrorLogAccountStatusNotificationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addErrorLogAccountStatusNotificationHandlerRequest.description) &&
        Objects.equals(this.schemas, addErrorLogAccountStatusNotificationHandlerRequest.schemas) &&
        Objects.equals(this.accountStatusNotificationType, addErrorLogAccountStatusNotificationHandlerRequest.accountStatusNotificationType) &&
        Objects.equals(this.enabled, addErrorLogAccountStatusNotificationHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addErrorLogAccountStatusNotificationHandlerRequest.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, addErrorLogAccountStatusNotificationHandlerRequest.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, addErrorLogAccountStatusNotificationHandlerRequest.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, addErrorLogAccountStatusNotificationHandlerRequest.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, addErrorLogAccountStatusNotificationHandlerRequest.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, addErrorLogAccountStatusNotificationHandlerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddErrorLogAccountStatusNotificationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddErrorLogAccountStatusNotificationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddErrorLogAccountStatusNotificationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddErrorLogAccountStatusNotificationHandlerRequest is not found in the empty JSON string", AddErrorLogAccountStatusNotificationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddErrorLogAccountStatusNotificationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddErrorLogAccountStatusNotificationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddErrorLogAccountStatusNotificationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddErrorLogAccountStatusNotificationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddErrorLogAccountStatusNotificationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddErrorLogAccountStatusNotificationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddErrorLogAccountStatusNotificationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddErrorLogAccountStatusNotificationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddErrorLogAccountStatusNotificationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddErrorLogAccountStatusNotificationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddErrorLogAccountStatusNotificationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddErrorLogAccountStatusNotificationHandlerRequest
  */
  public static AddErrorLogAccountStatusNotificationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddErrorLogAccountStatusNotificationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddErrorLogAccountStatusNotificationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
