...
public class AddFileServerHttpServletExtensionRequest {
  ...
  public AddFileServerHttpServletExtensionRequest() {
  }

  public AddFileServerHttpServletExtensionRequest extensionName(String extensionName) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest description(String description) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest schemas(List<EnumfileServerHttpServletExtensionSchemaUrn> schemas) {
  ...
  public AddFileServerHttpServletExtensionRequest addSchemasItem(EnumfileServerHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest documentRootDirectory(String documentRootDirectory) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest enableDirectoryIndexing(Boolean enableDirectoryIndexing) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest indexFile(List<String> indexFile) {
  ...
  public AddFileServerHttpServletExtensionRequest addIndexFileItem(String indexFileItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest mimeTypesFile(String mimeTypesFile) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest defaultMIMEType(String defaultMIMEType) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest requireAuthentication(Boolean requireAuthentication) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest allowedAuthenticationType(List<EnumhttpServletExtensionAllowedAuthenticationTypeProp> allowedAuthenticationType) {
  ...
  public AddFileServerHttpServletExtensionRequest addAllowedAuthenticationTypeItem(EnumhttpServletExtensionAllowedAuthenticationTypeProp allowedAuthenticationTypeItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public AddFileServerHttpServletExtensionRequest addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest idTokenValidator(List<String> idTokenValidator) {
  ...
  public AddFileServerHttpServletExtensionRequest addIdTokenValidatorItem(String idTokenValidatorItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest requireFileServletAccessPrivilege(Boolean requireFileServletAccessPrivilege) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest requireGroup(List<String> requireGroup) {
  ...
  public AddFileServerHttpServletExtensionRequest addRequireGroupItem(String requireGroupItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest identityMapper(String identityMapper) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest responseHeader(List<String> responseHeader) {
  ...
  public AddFileServerHttpServletExtensionRequest addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public AddFileServerHttpServletExtensionRequest correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the AddFileServerHttpServletExtensionRequest instance itself
   */
  public AddFileServerHttpServletExtensionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddFileServerHttpServletExtensionRequest addFileServerHttpServletExtensionRequest = (AddFileServerHttpServletExtensionRequest) o;
    return Objects.equals(this.extensionName, addFileServerHttpServletExtensionRequest.extensionName) &&
        Objects.equals(this.description, addFileServerHttpServletExtensionRequest.description) &&
        Objects.equals(this.schemas, addFileServerHttpServletExtensionRequest.schemas) &&
        Objects.equals(this.baseContextPath, addFileServerHttpServletExtensionRequest.baseContextPath) &&
        Objects.equals(this.documentRootDirectory, addFileServerHttpServletExtensionRequest.documentRootDirectory) &&
        Objects.equals(this.enableDirectoryIndexing, addFileServerHttpServletExtensionRequest.enableDirectoryIndexing) &&
        Objects.equals(this.indexFile, addFileServerHttpServletExtensionRequest.indexFile) &&
        Objects.equals(this.mimeTypesFile, addFileServerHttpServletExtensionRequest.mimeTypesFile) &&
        Objects.equals(this.defaultMIMEType, addFileServerHttpServletExtensionRequest.defaultMIMEType) &&
        Objects.equals(this.requireAuthentication, addFileServerHttpServletExtensionRequest.requireAuthentication) &&
        Objects.equals(this.allowedAuthenticationType, addFileServerHttpServletExtensionRequest.allowedAuthenticationType) &&
        Objects.equals(this.accessTokenValidator, addFileServerHttpServletExtensionRequest.accessTokenValidator) &&
        Objects.equals(this.idTokenValidator, addFileServerHttpServletExtensionRequest.idTokenValidator) &&
        Objects.equals(this.requireFileServletAccessPrivilege, addFileServerHttpServletExtensionRequest.requireFileServletAccessPrivilege) &&
        Objects.equals(this.requireGroup, addFileServerHttpServletExtensionRequest.requireGroup) &&
        Objects.equals(this.identityMapper, addFileServerHttpServletExtensionRequest.identityMapper) &&
        Objects.equals(this.crossOriginPolicy, addFileServerHttpServletExtensionRequest.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, addFileServerHttpServletExtensionRequest.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, addFileServerHttpServletExtensionRequest.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, addFileServerHttpServletExtensionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extensionName, description, schemas, baseContextPath, documentRootDirectory, enableDirectoryIndexing, indexFile, mimeTypesFile, defaultMIMEType, requireAuthentication, allowedAuthenticationType, accessTokenValidator, idTokenValidator, requireFileServletAccessPrivilege, requireGroup, identityMapper, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddFileServerHttpServletExtensionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFileServerHttpServletExtensionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFileServerHttpServletExtensionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFileServerHttpServletExtensionRequest is not found in the empty JSON string", AddFileServerHttpServletExtensionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddFileServerHttpServletExtensionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddFileServerHttpServletExtensionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddFileServerHttpServletExtensionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddFileServerHttpServletExtensionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddFileServerHttpServletExtensionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddFileServerHttpServletExtensionRequest>() {
           @Override
           public void write(JsonWriter out, AddFileServerHttpServletExtensionRequest value) throws IOException {
           ...
           @Override
           public AddFileServerHttpServletExtensionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddFileServerHttpServletExtensionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddFileServerHttpServletExtensionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddFileServerHttpServletExtensionRequest
  * @throws IOException if the JSON string is invalid with respect to AddFileServerHttpServletExtensionRequest
  */
  public static AddFileServerHttpServletExtensionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddFileServerHttpServletExtensionRequest.class);
  }

 /**
  * Convert an instance of AddFileServerHttpServletExtensionRequest to an JSON string
  *
  * @return JSON string
  */
