...
public class Scim2HttpServletExtensionResponseAllOf {
  ...
  private List<Enumscim2HttpServletExtensionSchemaUrn> schemas = null;
  ...
  public Scim2HttpServletExtensionResponseAllOf() {
  }

  public Scim2HttpServletExtensionResponseAllOf description(String description) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf schemas(List<Enumscim2HttpServletExtensionSchemaUrn> schemas) {
  ...
  public Scim2HttpServletExtensionResponseAllOf addSchemasItem(Enumscim2HttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf id(String id) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf baseContextPath(String baseContextPath) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The context path to use to access the SCIM 2.0 interface. The value must start with a forward slash and must represent a valid HTTP context path.")
  ...
  public Scim2HttpServletExtensionResponseAllOf accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public Scim2HttpServletExtensionResponseAllOf addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf mapAccessTokensToLocalUsers(EnumhttpServletExtensionMapAccessTokensToLocalUsersProp mapAccessTokensToLocalUsers) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf debugEnabled(Boolean debugEnabled) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf debugLevel(EnumhttpServletExtensionDebugLevelProp debugLevel) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf debugType(List<EnumhttpServletExtensionDebugTypeProp> debugType) {
  ...
  public Scim2HttpServletExtensionResponseAllOf addDebugTypeItem(EnumhttpServletExtensionDebugTypeProp debugTypeItem) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf includeStackTrace(Boolean includeStackTrace) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf swaggerEnabled(Boolean swaggerEnabled) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf responseHeader(List<String> responseHeader) {
  ...
  public Scim2HttpServletExtensionResponseAllOf addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public Scim2HttpServletExtensionResponseAllOf correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the Scim2HttpServletExtensionResponseAllOf instance itself
   */
  public Scim2HttpServletExtensionResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Scim2HttpServletExtensionResponseAllOf scim2HttpServletExtensionResponseAllOf = (Scim2HttpServletExtensionResponseAllOf) o;
    return Objects.equals(this.description, scim2HttpServletExtensionResponseAllOf.description) &&
        Objects.equals(this.schemas, scim2HttpServletExtensionResponseAllOf.schemas) &&
        Objects.equals(this.id, scim2HttpServletExtensionResponseAllOf.id) &&
        Objects.equals(this.baseContextPath, scim2HttpServletExtensionResponseAllOf.baseContextPath) &&
        Objects.equals(this.accessTokenValidator, scim2HttpServletExtensionResponseAllOf.accessTokenValidator) &&
        Objects.equals(this.mapAccessTokensToLocalUsers, scim2HttpServletExtensionResponseAllOf.mapAccessTokensToLocalUsers) &&
        Objects.equals(this.debugEnabled, scim2HttpServletExtensionResponseAllOf.debugEnabled) &&
        Objects.equals(this.debugLevel, scim2HttpServletExtensionResponseAllOf.debugLevel) &&
        Objects.equals(this.debugType, scim2HttpServletExtensionResponseAllOf.debugType) &&
        Objects.equals(this.includeStackTrace, scim2HttpServletExtensionResponseAllOf.includeStackTrace) &&
        Objects.equals(this.swaggerEnabled, scim2HttpServletExtensionResponseAllOf.swaggerEnabled) &&
        Objects.equals(this.crossOriginPolicy, scim2HttpServletExtensionResponseAllOf.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, scim2HttpServletExtensionResponseAllOf.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, scim2HttpServletExtensionResponseAllOf.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, scim2HttpServletExtensionResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseContextPath, accessTokenValidator, mapAccessTokensToLocalUsers, debugEnabled, debugLevel, debugType, includeStackTrace, swaggerEnabled, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Scim2HttpServletExtensionResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Scim2HttpServletExtensionResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Scim2HttpServletExtensionResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Scim2HttpServletExtensionResponseAllOf is not found in the empty JSON string", Scim2HttpServletExtensionResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Scim2HttpServletExtensionResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Scim2HttpServletExtensionResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Scim2HttpServletExtensionResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Scim2HttpServletExtensionResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<Scim2HttpServletExtensionResponseAllOf>() {
           @Override
           public void write(JsonWriter out, Scim2HttpServletExtensionResponseAllOf value) throws IOException {
           ...
           @Override
           public Scim2HttpServletExtensionResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Scim2HttpServletExtensionResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Scim2HttpServletExtensionResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Scim2HttpServletExtensionResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to Scim2HttpServletExtensionResponseAllOf
  */
  public static Scim2HttpServletExtensionResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Scim2HttpServletExtensionResponseAllOf.class);
  }

 /**
  * Convert an instance of Scim2HttpServletExtensionResponseAllOf to an JSON string
  *
  * @return JSON string
  */
