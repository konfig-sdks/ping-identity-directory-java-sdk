...
public class SyslogJsonSyncLogPublisherResponse {
  ...
  private List<EnumsyslogJsonSyncLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyslogJsonSyncLogPublisherResponse() {
  }

  public SyslogJsonSyncLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse schemas(List<EnumsyslogJsonSyncLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonSyncLogPublisherResponse addSchemasItem(EnumsyslogJsonSyncLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonSyncLogPublisherResponse addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public SyslogJsonSyncLogPublisherResponse addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse loggedMessageType(List<EnumlogPublisherLoggedMessageTypeProp> loggedMessageType) {
  ...
  public SyslogJsonSyncLogPublisherResponse addLoggedMessageTypeItem(EnumlogPublisherLoggedMessageTypeProp loggedMessageTypeItem) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogJsonSyncLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogJsonSyncLogPublisherResponse instance itself
   */
  public SyslogJsonSyncLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonSyncLogPublisherResponse syslogJsonSyncLogPublisherResponse = (SyslogJsonSyncLogPublisherResponse) o;
    return Objects.equals(this.description, syslogJsonSyncLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogJsonSyncLogPublisherResponse.schemas) &&
        Objects.equals(this.id, syslogJsonSyncLogPublisherResponse.id) &&
        Objects.equals(this.syslogExternalServer, syslogJsonSyncLogPublisherResponse.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonSyncLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonSyncLogPublisherResponse.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonSyncLogPublisherResponse.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonSyncLogPublisherResponse.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonSyncLogPublisherResponse.queueSize) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonSyncLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, syslogJsonSyncLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonSyncLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonSyncLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonSyncLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, syslogJsonSyncLogPublisherResponse.includeSyncPipe) &&
        Objects.equals(this.loggedMessageType, syslogJsonSyncLogPublisherResponse.loggedMessageType) &&
        Objects.equals(this.enabled, syslogJsonSyncLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonSyncLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogJsonSyncLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogJsonSyncLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogJsonSyncLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, loggedMessageType, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogJsonSyncLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonSyncLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonSyncLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonSyncLogPublisherResponse is not found in the empty JSON string", SyslogJsonSyncLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonSyncLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonSyncLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonSyncLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonSyncLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonSyncLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonSyncLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogJsonSyncLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogJsonSyncLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonSyncLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonSyncLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonSyncLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonSyncLogPublisherResponse
  */
  public static SyslogJsonSyncLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonSyncLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogJsonSyncLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
