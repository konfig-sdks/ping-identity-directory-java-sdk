 ...
 */
@JsonAdapter(EnumrootDnDefaultRootPrivilegeNameProp.Adapter.class)public enum EnumrootDnDefaultRootPrivilegeNameProp {
  ...
  EnumrootDnDefaultRootPrivilegeNameProp(String value) {
    this.value = value;
  }
  ...
  public static EnumrootDnDefaultRootPrivilegeNameProp fromValue(String value) {
    for (EnumrootDnDefaultRootPrivilegeNameProp b : EnumrootDnDefaultRootPrivilegeNameProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumrootDnDefaultRootPrivilegeNameProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumrootDnDefaultRootPrivilegeNameProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumrootDnDefaultRootPrivilegeNameProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumrootDnDefaultRootPrivilegeNameProp.fromValue(value);
    }
  }
}
