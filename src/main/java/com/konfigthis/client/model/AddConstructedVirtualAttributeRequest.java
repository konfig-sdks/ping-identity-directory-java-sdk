...
public class AddConstructedVirtualAttributeRequest {
  ...
  public AddConstructedVirtualAttributeRequest() {
  }

  public AddConstructedVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest schemas(List<EnumconstructedVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddConstructedVirtualAttributeRequest addSchemasItem(EnumconstructedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest valuePattern(List<String> valuePattern) {
  ...
  public AddConstructedVirtualAttributeRequest addValuePatternItem(String valuePatternItem) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddConstructedVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddConstructedVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddConstructedVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddConstructedVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddConstructedVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddConstructedVirtualAttributeRequest instance itself
   */
  public AddConstructedVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddConstructedVirtualAttributeRequest addConstructedVirtualAttributeRequest = (AddConstructedVirtualAttributeRequest) o;
    return Objects.equals(this.name, addConstructedVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addConstructedVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addConstructedVirtualAttributeRequest.schemas) &&
        Objects.equals(this.valuePattern, addConstructedVirtualAttributeRequest.valuePattern) &&
        Objects.equals(this.enabled, addConstructedVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addConstructedVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addConstructedVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addConstructedVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addConstructedVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addConstructedVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addConstructedVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addConstructedVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addConstructedVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addConstructedVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addConstructedVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addConstructedVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, valuePattern, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddConstructedVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddConstructedVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddConstructedVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddConstructedVirtualAttributeRequest is not found in the empty JSON string", AddConstructedVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddConstructedVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddConstructedVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddConstructedVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddConstructedVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddConstructedVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddConstructedVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddConstructedVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddConstructedVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddConstructedVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddConstructedVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddConstructedVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddConstructedVirtualAttributeRequest
  */
  public static AddConstructedVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddConstructedVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddConstructedVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
