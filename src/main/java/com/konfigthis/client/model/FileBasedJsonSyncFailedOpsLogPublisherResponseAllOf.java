...
/**
 * FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf {
  ...
  private List<EnumfileBasedJsonSyncFailedOpsLogPublisherSchemaUrn> schemas = null;
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf() {
  }

  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf schemas(List<EnumfileBasedJsonSyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf addSchemasItem(EnumfileBasedJsonSyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The file name to use for the log files generated by the File Based JSON Sync Failed Ops Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this File Based JSON Sync Failed Ops Log Publisher.")
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the File Based JSON Sync Failed Ops Log Publisher .")
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf rotationListener(List<String> rotationListener) {
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the File Based JSON Sync Failed Ops Log Publisher .")
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf append(Boolean append) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the File Based JSON Sync Failed Ops Log Publisher will publish records asynchronously.")
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf instance itself
   */
  public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf = (FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.id) &&
        Objects.equals(this.logFile, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.signLog) &&
        Objects.equals(this.encryptLog, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.append) &&
        Objects.equals(this.asynchronous, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.timeInterval) &&
        Objects.equals(this.writeMultiLineMessages, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.includeProductName) &&
        Objects.equals(this.includeInstanceName, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.includeInstanceName) &&
        Objects.equals(this.includeStartupID, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.includeStartupID) &&
        Objects.equals(this.includeThreadID, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.enabled, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, fileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf is not found in the empty JSON string", FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of FileBasedJsonSyncFailedOpsLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
