...
public class AuthorizeServerInstanceResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumauthorizeServerInstanceSchemaUrn> schemas = new ArrayList<>();
  ...
  public AuthorizeServerInstanceResponse() {
  }

  public AuthorizeServerInstanceResponse schemas(List<EnumauthorizeServerInstanceSchemaUrn> schemas) {
  ...
  public AuthorizeServerInstanceResponse addSchemasItem(EnumauthorizeServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse id(String id) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse clusterName(String clusterName) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse hostname(String hostname) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse serverRoot(String serverRoot) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse serverVersion(String serverVersion) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse httpPort(Integer httpPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public AuthorizeServerInstanceResponse addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse baseDN(List<String> baseDN) {
  ...
  public AuthorizeServerInstanceResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public AuthorizeServerInstanceResponse addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AuthorizeServerInstanceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AuthorizeServerInstanceResponse instance itself
   */
  public AuthorizeServerInstanceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuthorizeServerInstanceResponse authorizeServerInstanceResponse = (AuthorizeServerInstanceResponse) o;
    return Objects.equals(this.schemas, authorizeServerInstanceResponse.schemas) &&
        Objects.equals(this.id, authorizeServerInstanceResponse.id) &&
        Objects.equals(this.serverInstanceType, authorizeServerInstanceResponse.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, authorizeServerInstanceResponse.serverInstanceName) &&
        Objects.equals(this.clusterName, authorizeServerInstanceResponse.clusterName) &&
        Objects.equals(this.serverInstanceLocation, authorizeServerInstanceResponse.serverInstanceLocation) &&
        Objects.equals(this.hostname, authorizeServerInstanceResponse.hostname) &&
        Objects.equals(this.serverRoot, authorizeServerInstanceResponse.serverRoot) &&
        Objects.equals(this.serverVersion, authorizeServerInstanceResponse.serverVersion) &&
        Objects.equals(this.interServerCertificate, authorizeServerInstanceResponse.interServerCertificate) &&
        Objects.equals(this.ldapPort, authorizeServerInstanceResponse.ldapPort) &&
        Objects.equals(this.ldapsPort, authorizeServerInstanceResponse.ldapsPort) &&
        Objects.equals(this.httpPort, authorizeServerInstanceResponse.httpPort) &&
        Objects.equals(this.httpsPort, authorizeServerInstanceResponse.httpsPort) &&
        Objects.equals(this.replicationPort, authorizeServerInstanceResponse.replicationPort) &&
        Objects.equals(this.replicationServerID, authorizeServerInstanceResponse.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, authorizeServerInstanceResponse.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, authorizeServerInstanceResponse.jmxPort) &&
        Objects.equals(this.jmxsPort, authorizeServerInstanceResponse.jmxsPort) &&
        Objects.equals(this.preferredSecurity, authorizeServerInstanceResponse.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, authorizeServerInstanceResponse.startTLSEnabled) &&
        Objects.equals(this.baseDN, authorizeServerInstanceResponse.baseDN) &&
        Objects.equals(this.memberOfServerGroup, authorizeServerInstanceResponse.memberOfServerGroup) &&
        Objects.equals(this.meta, authorizeServerInstanceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, authorizeServerInstanceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, authorizeServerInstanceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AuthorizeServerInstanceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuthorizeServerInstanceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuthorizeServerInstanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuthorizeServerInstanceResponse is not found in the empty JSON string", AuthorizeServerInstanceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuthorizeServerInstanceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuthorizeServerInstanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuthorizeServerInstanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuthorizeServerInstanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuthorizeServerInstanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AuthorizeServerInstanceResponse>() {
           @Override
           public void write(JsonWriter out, AuthorizeServerInstanceResponse value) throws IOException {
           ...
           @Override
           public AuthorizeServerInstanceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AuthorizeServerInstanceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AuthorizeServerInstanceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuthorizeServerInstanceResponse
  * @throws IOException if the JSON string is invalid with respect to AuthorizeServerInstanceResponse
  */
  public static AuthorizeServerInstanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuthorizeServerInstanceResponse.class);
  }

 /**
  * Convert an instance of AuthorizeServerInstanceResponse to an JSON string
  *
  * @return JSON string
  */
