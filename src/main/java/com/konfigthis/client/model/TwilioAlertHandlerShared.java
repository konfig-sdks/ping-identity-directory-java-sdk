...
public class TwilioAlertHandlerShared {
  ...
  public TwilioAlertHandlerShared() {
  }

  public TwilioAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared schemas(List<EnumtwilioAlertHandlerSchemaUrn> schemas) {
  ...
  public TwilioAlertHandlerShared addSchemasItem(EnumtwilioAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared twilioAccountSID(String twilioAccountSID) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared twilioAuthToken(String twilioAuthToken) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared twilioAuthTokenPassphraseProvider(String twilioAuthTokenPassphraseProvider) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared senderPhoneNumber(List<String> senderPhoneNumber) {
  ...
  public TwilioAlertHandlerShared addSenderPhoneNumberItem(String senderPhoneNumberItem) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared recipientPhoneNumber(List<String> recipientPhoneNumber) {
  ...
  public TwilioAlertHandlerShared addRecipientPhoneNumberItem(String recipientPhoneNumberItem) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared longMessageBehavior(EnumalertHandlerLongMessageBehaviorProp longMessageBehavior) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public TwilioAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public TwilioAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public TwilioAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public TwilioAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the TwilioAlertHandlerShared instance itself
   */
  public TwilioAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TwilioAlertHandlerShared twilioAlertHandlerShared = (TwilioAlertHandlerShared) o;
    return Objects.equals(this.description, twilioAlertHandlerShared.description) &&
        Objects.equals(this.schemas, twilioAlertHandlerShared.schemas) &&
        Objects.equals(this.asynchronous, twilioAlertHandlerShared.asynchronous) &&
        Objects.equals(this.httpProxyExternalServer, twilioAlertHandlerShared.httpProxyExternalServer) &&
        Objects.equals(this.twilioAccountSID, twilioAlertHandlerShared.twilioAccountSID) &&
        Objects.equals(this.twilioAuthToken, twilioAlertHandlerShared.twilioAuthToken) &&
        Objects.equals(this.twilioAuthTokenPassphraseProvider, twilioAlertHandlerShared.twilioAuthTokenPassphraseProvider) &&
        Objects.equals(this.senderPhoneNumber, twilioAlertHandlerShared.senderPhoneNumber) &&
        Objects.equals(this.recipientPhoneNumber, twilioAlertHandlerShared.recipientPhoneNumber) &&
        Objects.equals(this.longMessageBehavior, twilioAlertHandlerShared.longMessageBehavior) &&
        Objects.equals(this.enabled, twilioAlertHandlerShared.enabled) &&
        Objects.equals(this.enabledAlertSeverity, twilioAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, twilioAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, twilioAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, twilioAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, asynchronous, httpProxyExternalServer, twilioAccountSID, twilioAuthToken, twilioAuthTokenPassphraseProvider, senderPhoneNumber, recipientPhoneNumber, longMessageBehavior, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TwilioAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TwilioAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TwilioAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TwilioAlertHandlerShared is not found in the empty JSON string", TwilioAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TwilioAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TwilioAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TwilioAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TwilioAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TwilioAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<TwilioAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, TwilioAlertHandlerShared value) throws IOException {
           ...
           @Override
           public TwilioAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TwilioAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TwilioAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TwilioAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to TwilioAlertHandlerShared
  */
  public static TwilioAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TwilioAlertHandlerShared.class);
  }

 /**
  * Convert an instance of TwilioAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
