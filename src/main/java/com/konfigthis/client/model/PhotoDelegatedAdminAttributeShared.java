...
public class PhotoDelegatedAdminAttributeShared {
  ...
  public PhotoDelegatedAdminAttributeShared() {
  }

  public PhotoDelegatedAdminAttributeShared description(String description) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared schemas(List<EnumphotoDelegatedAdminAttributeSchemaUrn> schemas) {
  ...
  public PhotoDelegatedAdminAttributeShared addSchemasItem(EnumphotoDelegatedAdminAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared allowedMIMEType(List<EnumdelegatedAdminAttributePhotoAllowedMIMETypeProp> allowedMIMEType) {
  ...
  public PhotoDelegatedAdminAttributeShared addAllowedMIMETypeItem(EnumdelegatedAdminAttributePhotoAllowedMIMETypeProp allowedMIMETypeItem) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared displayName(String displayName) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared mutability(EnumdelegatedAdminAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared attributeCategory(String attributeCategory) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared displayOrderIndex(Integer displayOrderIndex) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared referenceResourceType(String referenceResourceType) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared attributePresentation(EnumdelegatedAdminAttributeAttributePresentationProp attributePresentation) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeShared dateTimeFormat(String dateTimeFormat) {
  ...
  **/
   ...
   * @return the PhotoDelegatedAdminAttributeShared instance itself
   */
  public PhotoDelegatedAdminAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PhotoDelegatedAdminAttributeShared photoDelegatedAdminAttributeShared = (PhotoDelegatedAdminAttributeShared) o;
    return Objects.equals(this.description, photoDelegatedAdminAttributeShared.description) &&
        Objects.equals(this.schemas, photoDelegatedAdminAttributeShared.schemas) &&
        Objects.equals(this.allowedMIMEType, photoDelegatedAdminAttributeShared.allowedMIMEType) &&
        Objects.equals(this.attributeType, photoDelegatedAdminAttributeShared.attributeType) &&
        Objects.equals(this.displayName, photoDelegatedAdminAttributeShared.displayName) &&
        Objects.equals(this.mutability, photoDelegatedAdminAttributeShared.mutability) &&
        Objects.equals(this.multiValued, photoDelegatedAdminAttributeShared.multiValued) &&
        Objects.equals(this.attributeCategory, photoDelegatedAdminAttributeShared.attributeCategory) &&
        Objects.equals(this.displayOrderIndex, photoDelegatedAdminAttributeShared.displayOrderIndex) &&
        Objects.equals(this.referenceResourceType, photoDelegatedAdminAttributeShared.referenceResourceType) &&
        Objects.equals(this.attributePresentation, photoDelegatedAdminAttributeShared.attributePresentation) &&
        Objects.equals(this.dateTimeFormat, photoDelegatedAdminAttributeShared.dateTimeFormat)&&
        Objects.equals(this.additionalProperties, photoDelegatedAdminAttributeShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhotoDelegatedAdminAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PhotoDelegatedAdminAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhotoDelegatedAdminAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhotoDelegatedAdminAttributeShared is not found in the empty JSON string", PhotoDelegatedAdminAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PhotoDelegatedAdminAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhotoDelegatedAdminAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhotoDelegatedAdminAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhotoDelegatedAdminAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhotoDelegatedAdminAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PhotoDelegatedAdminAttributeShared>() {
           @Override
           public void write(JsonWriter out, PhotoDelegatedAdminAttributeShared value) throws IOException {
           ...
           @Override
           public PhotoDelegatedAdminAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PhotoDelegatedAdminAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PhotoDelegatedAdminAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PhotoDelegatedAdminAttributeShared
  * @throws IOException if the JSON string is invalid with respect to PhotoDelegatedAdminAttributeShared
  */
  public static PhotoDelegatedAdminAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhotoDelegatedAdminAttributeShared.class);
  }

 /**
  * Convert an instance of PhotoDelegatedAdminAttributeShared to an JSON string
  *
  * @return JSON string
  */
