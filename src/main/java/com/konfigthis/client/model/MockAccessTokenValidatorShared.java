...
public class MockAccessTokenValidatorShared {
  ...
  public MockAccessTokenValidatorShared() {
  }

  public MockAccessTokenValidatorShared description(String description) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared schemas(List<EnummockAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public MockAccessTokenValidatorShared addSchemasItem(EnummockAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared clientIDClaimName(String clientIDClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared scopeClaimName(String scopeClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared identityMapper(String identityMapper) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the MockAccessTokenValidatorShared instance itself
   */
  public MockAccessTokenValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MockAccessTokenValidatorShared mockAccessTokenValidatorShared = (MockAccessTokenValidatorShared) o;
    return Objects.equals(this.description, mockAccessTokenValidatorShared.description) &&
        Objects.equals(this.schemas, mockAccessTokenValidatorShared.schemas) &&
        Objects.equals(this.clientIDClaimName, mockAccessTokenValidatorShared.clientIDClaimName) &&
        Objects.equals(this.scopeClaimName, mockAccessTokenValidatorShared.scopeClaimName) &&
        Objects.equals(this.evaluationOrderIndex, mockAccessTokenValidatorShared.evaluationOrderIndex) &&
        Objects.equals(this.identityMapper, mockAccessTokenValidatorShared.identityMapper) &&
        Objects.equals(this.subjectClaimName, mockAccessTokenValidatorShared.subjectClaimName) &&
        Objects.equals(this.enabled, mockAccessTokenValidatorShared.enabled)&&
        Objects.equals(this.additionalProperties, mockAccessTokenValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, clientIDClaimName, scopeClaimName, evaluationOrderIndex, identityMapper, subjectClaimName, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MockAccessTokenValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MockAccessTokenValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MockAccessTokenValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MockAccessTokenValidatorShared is not found in the empty JSON string", MockAccessTokenValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MockAccessTokenValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MockAccessTokenValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MockAccessTokenValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MockAccessTokenValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MockAccessTokenValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<MockAccessTokenValidatorShared>() {
           @Override
           public void write(JsonWriter out, MockAccessTokenValidatorShared value) throws IOException {
           ...
           @Override
           public MockAccessTokenValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MockAccessTokenValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MockAccessTokenValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MockAccessTokenValidatorShared
  * @throws IOException if the JSON string is invalid with respect to MockAccessTokenValidatorShared
  */
  public static MockAccessTokenValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MockAccessTokenValidatorShared.class);
  }

 /**
  * Convert an instance of MockAccessTokenValidatorShared to an JSON string
  *
  * @return JSON string
  */
