...
public class SuccessfulBindResultCriteriaShared {
  ...
  public SuccessfulBindResultCriteriaShared() {
  }

  public SuccessfulBindResultCriteriaShared description(String description) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared schemas(List<EnumsuccessfulBindResultCriteriaSchemaUrn> schemas) {
  ...
  public SuccessfulBindResultCriteriaShared addSchemasItem(EnumsuccessfulBindResultCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared includeAnonymousBinds(Boolean includeAnonymousBinds) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared includedUserBaseDN(List<String> includedUserBaseDN) {
  ...
  public SuccessfulBindResultCriteriaShared addIncludedUserBaseDNItem(String includedUserBaseDNItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared excludedUserBaseDN(List<String> excludedUserBaseDN) {
  ...
  public SuccessfulBindResultCriteriaShared addExcludedUserBaseDNItem(String excludedUserBaseDNItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared includedUserFilter(List<String> includedUserFilter) {
  ...
  public SuccessfulBindResultCriteriaShared addIncludedUserFilterItem(String includedUserFilterItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared excludedUserFilter(List<String> excludedUserFilter) {
  ...
  public SuccessfulBindResultCriteriaShared addExcludedUserFilterItem(String excludedUserFilterItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared includedUserGroupDN(List<String> includedUserGroupDN) {
  ...
  public SuccessfulBindResultCriteriaShared addIncludedUserGroupDNItem(String includedUserGroupDNItem) {
  ...
  **/
  ...
  public SuccessfulBindResultCriteriaShared excludedUserGroupDN(List<String> excludedUserGroupDN) {
  ...
  public SuccessfulBindResultCriteriaShared addExcludedUserGroupDNItem(String excludedUserGroupDNItem) {
  ...
  **/
   ...
   * @return the SuccessfulBindResultCriteriaShared instance itself
   */
  public SuccessfulBindResultCriteriaShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SuccessfulBindResultCriteriaShared successfulBindResultCriteriaShared = (SuccessfulBindResultCriteriaShared) o;
    return Objects.equals(this.description, successfulBindResultCriteriaShared.description) &&
        Objects.equals(this.schemas, successfulBindResultCriteriaShared.schemas) &&
        Objects.equals(this.requestCriteria, successfulBindResultCriteriaShared.requestCriteria) &&
        Objects.equals(this.includeAnonymousBinds, successfulBindResultCriteriaShared.includeAnonymousBinds) &&
        Objects.equals(this.includedUserBaseDN, successfulBindResultCriteriaShared.includedUserBaseDN) &&
        Objects.equals(this.excludedUserBaseDN, successfulBindResultCriteriaShared.excludedUserBaseDN) &&
        Objects.equals(this.includedUserFilter, successfulBindResultCriteriaShared.includedUserFilter) &&
        Objects.equals(this.excludedUserFilter, successfulBindResultCriteriaShared.excludedUserFilter) &&
        Objects.equals(this.includedUserGroupDN, successfulBindResultCriteriaShared.includedUserGroupDN) &&
        Objects.equals(this.excludedUserGroupDN, successfulBindResultCriteriaShared.excludedUserGroupDN)&&
        Objects.equals(this.additionalProperties, successfulBindResultCriteriaShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, requestCriteria, includeAnonymousBinds, includedUserBaseDN, excludedUserBaseDN, includedUserFilter, excludedUserFilter, includedUserGroupDN, excludedUserGroupDN, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SuccessfulBindResultCriteriaShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SuccessfulBindResultCriteriaShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SuccessfulBindResultCriteriaShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SuccessfulBindResultCriteriaShared is not found in the empty JSON string", SuccessfulBindResultCriteriaShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SuccessfulBindResultCriteriaShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SuccessfulBindResultCriteriaShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SuccessfulBindResultCriteriaShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SuccessfulBindResultCriteriaShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SuccessfulBindResultCriteriaShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SuccessfulBindResultCriteriaShared>() {
           @Override
           public void write(JsonWriter out, SuccessfulBindResultCriteriaShared value) throws IOException {
           ...
           @Override
           public SuccessfulBindResultCriteriaShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SuccessfulBindResultCriteriaShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SuccessfulBindResultCriteriaShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SuccessfulBindResultCriteriaShared
  * @throws IOException if the JSON string is invalid with respect to SuccessfulBindResultCriteriaShared
  */
  public static SuccessfulBindResultCriteriaShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SuccessfulBindResultCriteriaShared.class);
  }

 /**
  * Convert an instance of SuccessfulBindResultCriteriaShared to an JSON string
  *
  * @return JSON string
  */
