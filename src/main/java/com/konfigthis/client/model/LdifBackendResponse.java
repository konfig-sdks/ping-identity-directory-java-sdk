...
public class LdifBackendResponse {
  ...
  private List<EnumldifBackendSchemaUrn> schemas = new ArrayList<>();
  ...
  public LdifBackendResponse() {
  }

  public LdifBackendResponse description(String description) {
  ...
  **/
  ...
  public LdifBackendResponse schemas(List<EnumldifBackendSchemaUrn> schemas) {
  ...
  public LdifBackendResponse addSchemasItem(EnumldifBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumldifBackendSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumldifBackendSchemaUrn> schemas) {
  ...
  public LdifBackendResponse id(String id) {
  ...
  **/
  ...
  public LdifBackendResponse writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public LdifBackendResponse isPrivateBackend(Boolean isPrivateBackend) {
  ...
  **/
  ...
  public LdifBackendResponse ldifFile(String ldifFile) {
  ...
  **/
  ...
  public LdifBackendResponse backendID(String backendID) {
  ...
  **/
  ...
  public LdifBackendResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public LdifBackendResponse baseDN(List<String> baseDN) {
  ...
  public LdifBackendResponse addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public LdifBackendResponse setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public LdifBackendResponse returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public LdifBackendResponse backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public LdifBackendResponse notificationManager(String notificationManager) {
  ...
  **/
  ...
  public LdifBackendResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdifBackendResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdifBackendResponse instance itself
   */
  public LdifBackendResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdifBackendResponse ldifBackendResponse = (LdifBackendResponse) o;
    return Objects.equals(this.description, ldifBackendResponse.description) &&
        Objects.equals(this.schemas, ldifBackendResponse.schemas) &&
        Objects.equals(this.id, ldifBackendResponse.id) &&
        Objects.equals(this.writabilityMode, ldifBackendResponse.writabilityMode) &&
        Objects.equals(this.isPrivateBackend, ldifBackendResponse.isPrivateBackend) &&
        Objects.equals(this.ldifFile, ldifBackendResponse.ldifFile) &&
        Objects.equals(this.backendID, ldifBackendResponse.backendID) &&
        Objects.equals(this.enabled, ldifBackendResponse.enabled) &&
        Objects.equals(this.baseDN, ldifBackendResponse.baseDN) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, ldifBackendResponse.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, ldifBackendResponse.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, ldifBackendResponse.backupFilePermissions) &&
        Objects.equals(this.notificationManager, ldifBackendResponse.notificationManager) &&
        Objects.equals(this.meta, ldifBackendResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldifBackendResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldifBackendResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, writabilityMode, isPrivateBackend, ldifFile, backendID, enabled, baseDN, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdifBackendResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdifBackendResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdifBackendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdifBackendResponse is not found in the empty JSON string", LdifBackendResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdifBackendResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdifBackendResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdifBackendResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdifBackendResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdifBackendResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdifBackendResponse>() {
           @Override
           public void write(JsonWriter out, LdifBackendResponse value) throws IOException {
           ...
           @Override
           public LdifBackendResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdifBackendResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdifBackendResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdifBackendResponse
  * @throws IOException if the JSON string is invalid with respect to LdifBackendResponse
  */
  public static LdifBackendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdifBackendResponse.class);
  }

 /**
  * Convert an instance of LdifBackendResponse to an JSON string
  *
  * @return JSON string
  */
