...
public class AggregateRequestCriteriaResponse {
  ...
  public AggregateRequestCriteriaResponse() {
  }

  public AggregateRequestCriteriaResponse id(String id) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse description(String description) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse schemas(List<EnumaggregateRequestCriteriaSchemaUrn> schemas) {
  ...
  public AggregateRequestCriteriaResponse addSchemasItem(EnumaggregateRequestCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse allIncludedRequestCriteria(List<String> allIncludedRequestCriteria) {
  ...
  public AggregateRequestCriteriaResponse addAllIncludedRequestCriteriaItem(String allIncludedRequestCriteriaItem) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse anyIncludedRequestCriteria(List<String> anyIncludedRequestCriteria) {
  ...
  public AggregateRequestCriteriaResponse addAnyIncludedRequestCriteriaItem(String anyIncludedRequestCriteriaItem) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse notAllIncludedRequestCriteria(List<String> notAllIncludedRequestCriteria) {
  ...
  public AggregateRequestCriteriaResponse addNotAllIncludedRequestCriteriaItem(String notAllIncludedRequestCriteriaItem) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse noneIncludedRequestCriteria(List<String> noneIncludedRequestCriteria) {
  ...
  public AggregateRequestCriteriaResponse addNoneIncludedRequestCriteriaItem(String noneIncludedRequestCriteriaItem) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AggregateRequestCriteriaResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AggregateRequestCriteriaResponse instance itself
   */
  public AggregateRequestCriteriaResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AggregateRequestCriteriaResponse aggregateRequestCriteriaResponse = (AggregateRequestCriteriaResponse) o;
    return Objects.equals(this.id, aggregateRequestCriteriaResponse.id) &&
        Objects.equals(this.description, aggregateRequestCriteriaResponse.description) &&
        Objects.equals(this.schemas, aggregateRequestCriteriaResponse.schemas) &&
        Objects.equals(this.allIncludedRequestCriteria, aggregateRequestCriteriaResponse.allIncludedRequestCriteria) &&
        Objects.equals(this.anyIncludedRequestCriteria, aggregateRequestCriteriaResponse.anyIncludedRequestCriteria) &&
        Objects.equals(this.notAllIncludedRequestCriteria, aggregateRequestCriteriaResponse.notAllIncludedRequestCriteria) &&
        Objects.equals(this.noneIncludedRequestCriteria, aggregateRequestCriteriaResponse.noneIncludedRequestCriteria) &&
        Objects.equals(this.meta, aggregateRequestCriteriaResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, aggregateRequestCriteriaResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, aggregateRequestCriteriaResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, allIncludedRequestCriteria, anyIncludedRequestCriteria, notAllIncludedRequestCriteria, noneIncludedRequestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregateRequestCriteriaResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AggregateRequestCriteriaResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AggregateRequestCriteriaResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregateRequestCriteriaResponse is not found in the empty JSON string", AggregateRequestCriteriaResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregateRequestCriteriaResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregateRequestCriteriaResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregateRequestCriteriaResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregateRequestCriteriaResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregateRequestCriteriaResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregateRequestCriteriaResponse>() {
           @Override
           public void write(JsonWriter out, AggregateRequestCriteriaResponse value) throws IOException {
           ...
           @Override
           public AggregateRequestCriteriaResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AggregateRequestCriteriaResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AggregateRequestCriteriaResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AggregateRequestCriteriaResponse
  * @throws IOException if the JSON string is invalid with respect to AggregateRequestCriteriaResponse
  */
  public static AggregateRequestCriteriaResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregateRequestCriteriaResponse.class);
  }

 /**
  * Convert an instance of AggregateRequestCriteriaResponse to an JSON string
  *
  * @return JSON string
  */
