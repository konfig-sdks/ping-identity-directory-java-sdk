...
public class FileBasedAuditLogPublisherResponse {
  ...
  public FileBasedAuditLogPublisherResponse() {
  }

  public FileBasedAuditLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse schemas(List<EnumfileBasedAuditLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedAuditLogPublisherResponse addSchemasItem(EnumfileBasedAuditLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Audit Log Publisher.")
  ...
  public FileBasedAuditLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedAuditLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Audit Log Publisher .")
  ...
  public FileBasedAuditLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedAuditLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedAuditLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Audit Log Publisher .")
  ...
  public FileBasedAuditLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse useReversibleForm(Boolean useReversibleForm) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse softDeleteEntryAuditBehavior(EnumlogPublisherFileBasedAuditSoftDeleteEntryAuditBehaviorProp softDeleteEntryAuditBehavior) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeOperationPurposeRequestControl(Boolean includeOperationPurposeRequestControl) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse includeIntermediateClientRequestControl(Boolean includeIntermediateClientRequestControl) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse obscureAttribute(List<String> obscureAttribute) {
  ...
  public FileBasedAuditLogPublisherResponse addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse excludeAttribute(List<String> excludeAttribute) {
  ...
  public FileBasedAuditLogPublisherResponse addExcludeAttributeItem(String excludeAttributeItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based Audit Log Publisher will publish records asynchronously.")
  ...
  public FileBasedAuditLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedAuditLogPublisherResponse instance itself
   */
  public FileBasedAuditLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedAuditLogPublisherResponse fileBasedAuditLogPublisherResponse = (FileBasedAuditLogPublisherResponse) o;
    return Objects.equals(this.id, fileBasedAuditLogPublisherResponse.id) &&
        Objects.equals(this.description, fileBasedAuditLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedAuditLogPublisherResponse.schemas) &&
        Objects.equals(this.suppressInternalOperations, fileBasedAuditLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.logFile, fileBasedAuditLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedAuditLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedAuditLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedAuditLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedAuditLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedAuditLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedAuditLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedAuditLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedAuditLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedAuditLogPublisherResponse.append) &&
        Objects.equals(this.includeProductName, fileBasedAuditLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, fileBasedAuditLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, fileBasedAuditLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, fileBasedAuditLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequesterIPAddress, fileBasedAuditLogPublisherResponse.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequesterDN, fileBasedAuditLogPublisherResponse.includeRequesterDN) &&
        Objects.equals(this.includeReplicationChangeID, fileBasedAuditLogPublisherResponse.includeReplicationChangeID) &&
        Objects.equals(this.useReversibleForm, fileBasedAuditLogPublisherResponse.useReversibleForm) &&
        Objects.equals(this.softDeleteEntryAuditBehavior, fileBasedAuditLogPublisherResponse.softDeleteEntryAuditBehavior) &&
        Objects.equals(this.includeRequestControls, fileBasedAuditLogPublisherResponse.includeRequestControls) &&
        Objects.equals(this.includeOperationPurposeRequestControl, fileBasedAuditLogPublisherResponse.includeOperationPurposeRequestControl) &&
        Objects.equals(this.includeIntermediateClientRequestControl, fileBasedAuditLogPublisherResponse.includeIntermediateClientRequestControl) &&
        Objects.equals(this.obscureAttribute, fileBasedAuditLogPublisherResponse.obscureAttribute) &&
        Objects.equals(this.excludeAttribute, fileBasedAuditLogPublisherResponse.excludeAttribute) &&
        Objects.equals(this.asynchronous, fileBasedAuditLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedAuditLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedAuditLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedAuditLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedAuditLogPublisherResponse.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedAuditLogPublisherResponse.timestampPrecision) &&
        Objects.equals(this.logSecurityNegotiation, fileBasedAuditLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logIntermediateResponses, fileBasedAuditLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressReplicationOperations, fileBasedAuditLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, fileBasedAuditLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, fileBasedAuditLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, fileBasedAuditLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.enabled, fileBasedAuditLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedAuditLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedAuditLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedAuditLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedAuditLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, suppressInternalOperations, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterIPAddress, includeRequesterDN, includeReplicationChangeID, useReversibleForm, softDeleteEntryAuditBehavior, includeRequestControls, includeOperationPurposeRequestControl, includeIntermediateClientRequestControl, obscureAttribute, excludeAttribute, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, logSecurityNegotiation, logIntermediateResponses, suppressReplicationOperations, connectionCriteria, requestCriteria, resultCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedAuditLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedAuditLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedAuditLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedAuditLogPublisherResponse is not found in the empty JSON string", FileBasedAuditLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedAuditLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedAuditLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedAuditLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedAuditLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedAuditLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedAuditLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedAuditLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedAuditLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedAuditLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedAuditLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedAuditLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedAuditLogPublisherResponse
  */
  public static FileBasedAuditLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedAuditLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedAuditLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
