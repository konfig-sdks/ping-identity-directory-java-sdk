 ...
 */
@JsonAdapter(EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp.Adapter.class)public enum EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp {
  ...
  EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp(String value) {
    this.value = value;
  }
  ...
  public static EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp fromValue(String value) {
    for (EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp b : EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumconnectionCriteriaNotAllIncludedUserPrivilegeProp.fromValue(value);
    }
  }
}
