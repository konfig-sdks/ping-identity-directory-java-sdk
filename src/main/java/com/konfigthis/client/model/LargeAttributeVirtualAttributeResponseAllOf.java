...
public class LargeAttributeVirtualAttributeResponseAllOf {
  ...
  private List<EnumlargeAttributeVirtualAttributeSchemaUrn> schemas = null;
  ...
  public LargeAttributeVirtualAttributeResponseAllOf() {
  }

  public LargeAttributeVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf schemas(List<EnumlargeAttributeVirtualAttributeSchemaUrn> schemas) {
  ...
  public LargeAttributeVirtualAttributeResponseAllOf addSchemasItem(EnumlargeAttributeVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public LargeAttributeVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public LargeAttributeVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public LargeAttributeVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public LargeAttributeVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the LargeAttributeVirtualAttributeResponseAllOf instance itself
   */
  public LargeAttributeVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LargeAttributeVirtualAttributeResponseAllOf largeAttributeVirtualAttributeResponseAllOf = (LargeAttributeVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, largeAttributeVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, largeAttributeVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, largeAttributeVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, largeAttributeVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.filter, largeAttributeVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.enabled, largeAttributeVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.attributeType, largeAttributeVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.baseDN, largeAttributeVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, largeAttributeVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, largeAttributeVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, largeAttributeVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, largeAttributeVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, largeAttributeVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, largeAttributeVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, largeAttributeVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, filter, enabled, attributeType, baseDN, groupDN, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LargeAttributeVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LargeAttributeVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LargeAttributeVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LargeAttributeVirtualAttributeResponseAllOf is not found in the empty JSON string", LargeAttributeVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LargeAttributeVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LargeAttributeVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LargeAttributeVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LargeAttributeVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<LargeAttributeVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, LargeAttributeVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public LargeAttributeVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LargeAttributeVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LargeAttributeVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LargeAttributeVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to LargeAttributeVirtualAttributeResponseAllOf
  */
  public static LargeAttributeVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LargeAttributeVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of LargeAttributeVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
