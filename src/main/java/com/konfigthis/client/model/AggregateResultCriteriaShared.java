...
public class AggregateResultCriteriaShared {
  ...
  public AggregateResultCriteriaShared() {
  }

  public AggregateResultCriteriaShared description(String description) {
  ...
  **/
  ...
  public AggregateResultCriteriaShared schemas(List<EnumaggregateResultCriteriaSchemaUrn> schemas) {
  ...
  public AggregateResultCriteriaShared addSchemasItem(EnumaggregateResultCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AggregateResultCriteriaShared allIncludedResultCriteria(List<String> allIncludedResultCriteria) {
  ...
  public AggregateResultCriteriaShared addAllIncludedResultCriteriaItem(String allIncludedResultCriteriaItem) {
  ...
  **/
  ...
  public AggregateResultCriteriaShared anyIncludedResultCriteria(List<String> anyIncludedResultCriteria) {
  ...
  public AggregateResultCriteriaShared addAnyIncludedResultCriteriaItem(String anyIncludedResultCriteriaItem) {
  ...
  **/
  ...
  public AggregateResultCriteriaShared notAllIncludedResultCriteria(List<String> notAllIncludedResultCriteria) {
  ...
  public AggregateResultCriteriaShared addNotAllIncludedResultCriteriaItem(String notAllIncludedResultCriteriaItem) {
  ...
  **/
  ...
  public AggregateResultCriteriaShared noneIncludedResultCriteria(List<String> noneIncludedResultCriteria) {
  ...
  public AggregateResultCriteriaShared addNoneIncludedResultCriteriaItem(String noneIncludedResultCriteriaItem) {
  ...
  **/
   ...
   * @return the AggregateResultCriteriaShared instance itself
   */
  public AggregateResultCriteriaShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AggregateResultCriteriaShared aggregateResultCriteriaShared = (AggregateResultCriteriaShared) o;
    return Objects.equals(this.description, aggregateResultCriteriaShared.description) &&
        Objects.equals(this.schemas, aggregateResultCriteriaShared.schemas) &&
        Objects.equals(this.allIncludedResultCriteria, aggregateResultCriteriaShared.allIncludedResultCriteria) &&
        Objects.equals(this.anyIncludedResultCriteria, aggregateResultCriteriaShared.anyIncludedResultCriteria) &&
        Objects.equals(this.notAllIncludedResultCriteria, aggregateResultCriteriaShared.notAllIncludedResultCriteria) &&
        Objects.equals(this.noneIncludedResultCriteria, aggregateResultCriteriaShared.noneIncludedResultCriteria)&&
        Objects.equals(this.additionalProperties, aggregateResultCriteriaShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, allIncludedResultCriteria, anyIncludedResultCriteria, notAllIncludedResultCriteria, noneIncludedResultCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregateResultCriteriaShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AggregateResultCriteriaShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AggregateResultCriteriaShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregateResultCriteriaShared is not found in the empty JSON string", AggregateResultCriteriaShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregateResultCriteriaShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregateResultCriteriaShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregateResultCriteriaShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregateResultCriteriaShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregateResultCriteriaShared.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregateResultCriteriaShared>() {
           @Override
           public void write(JsonWriter out, AggregateResultCriteriaShared value) throws IOException {
           ...
           @Override
           public AggregateResultCriteriaShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AggregateResultCriteriaShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AggregateResultCriteriaShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AggregateResultCriteriaShared
  * @throws IOException if the JSON string is invalid with respect to AggregateResultCriteriaShared
  */
  public static AggregateResultCriteriaShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregateResultCriteriaShared.class);
  }

 /**
  * Convert an instance of AggregateResultCriteriaShared to an JSON string
  *
  * @return JSON string
  */
