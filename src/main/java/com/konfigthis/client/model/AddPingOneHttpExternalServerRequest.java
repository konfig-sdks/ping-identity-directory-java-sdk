...
public class AddPingOneHttpExternalServerRequest {
  ...
  public AddPingOneHttpExternalServerRequest() {
  }

  public AddPingOneHttpExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest schemas(List<EnumpingOneHttpExternalServerSchemaUrn> schemas) {
  ...
  public AddPingOneHttpExternalServerRequest addSchemasItem(EnumpingOneHttpExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest hostnameVerificationMethod(EnumexternalServerPingOneHttpHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddPingOneHttpExternalServerRequest responseTimeout(String responseTimeout) {
  ...
  **/
   ...
   * @return the AddPingOneHttpExternalServerRequest instance itself
   */
  public AddPingOneHttpExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPingOneHttpExternalServerRequest addPingOneHttpExternalServerRequest = (AddPingOneHttpExternalServerRequest) o;
    return Objects.equals(this.serverName, addPingOneHttpExternalServerRequest.serverName) &&
        Objects.equals(this.description, addPingOneHttpExternalServerRequest.description) &&
        Objects.equals(this.schemas, addPingOneHttpExternalServerRequest.schemas) &&
        Objects.equals(this.hostnameVerificationMethod, addPingOneHttpExternalServerRequest.hostnameVerificationMethod) &&
        Objects.equals(this.trustManagerProvider, addPingOneHttpExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.connectTimeout, addPingOneHttpExternalServerRequest.connectTimeout) &&
        Objects.equals(this.responseTimeout, addPingOneHttpExternalServerRequest.responseTimeout)&&
        Objects.equals(this.additionalProperties, addPingOneHttpExternalServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, description, schemas, hostnameVerificationMethod, trustManagerProvider, connectTimeout, responseTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPingOneHttpExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPingOneHttpExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPingOneHttpExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPingOneHttpExternalServerRequest is not found in the empty JSON string", AddPingOneHttpExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPingOneHttpExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPingOneHttpExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPingOneHttpExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPingOneHttpExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPingOneHttpExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPingOneHttpExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddPingOneHttpExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddPingOneHttpExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPingOneHttpExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPingOneHttpExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPingOneHttpExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddPingOneHttpExternalServerRequest
  */
  public static AddPingOneHttpExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPingOneHttpExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddPingOneHttpExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
