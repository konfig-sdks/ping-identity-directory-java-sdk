...
public class JdbcBasedErrorLogPublisherShared {
  ...
  public JdbcBasedErrorLogPublisherShared() {
  }

  public JdbcBasedErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared schemas(List<EnumjdbcBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public JdbcBasedErrorLogPublisherShared addSchemasItem(EnumjdbcBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared server(String server) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared logFieldMapping(String logFieldMapping) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared logTableName(String logTableName) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public JdbcBasedErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public JdbcBasedErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public JdbcBasedErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the JdbcBasedErrorLogPublisherShared instance itself
   */
  public JdbcBasedErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JdbcBasedErrorLogPublisherShared jdbcBasedErrorLogPublisherShared = (JdbcBasedErrorLogPublisherShared) o;
    return Objects.equals(this.description, jdbcBasedErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, jdbcBasedErrorLogPublisherShared.schemas) &&
        Objects.equals(this.server, jdbcBasedErrorLogPublisherShared.server) &&
        Objects.equals(this.logFieldMapping, jdbcBasedErrorLogPublisherShared.logFieldMapping) &&
        Objects.equals(this.logTableName, jdbcBasedErrorLogPublisherShared.logTableName) &&
        Objects.equals(this.queueSize, jdbcBasedErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.defaultSeverity, jdbcBasedErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, jdbcBasedErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, jdbcBasedErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, jdbcBasedErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, jdbcBasedErrorLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, server, logFieldMapping, logTableName, queueSize, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JdbcBasedErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JdbcBasedErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JdbcBasedErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JdbcBasedErrorLogPublisherShared is not found in the empty JSON string", JdbcBasedErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JdbcBasedErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JdbcBasedErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JdbcBasedErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JdbcBasedErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JdbcBasedErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JdbcBasedErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, JdbcBasedErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public JdbcBasedErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JdbcBasedErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JdbcBasedErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JdbcBasedErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to JdbcBasedErrorLogPublisherShared
  */
  public static JdbcBasedErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JdbcBasedErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of JdbcBasedErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
