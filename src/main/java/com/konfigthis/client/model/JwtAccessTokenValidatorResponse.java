...
public class JwtAccessTokenValidatorResponse {
  ...
  private List<EnumaccessTokenValidatorAllowedSigningAlgorithmProp> allowedSigningAlgorithm = new ArrayList<>();
  ...
  private List<EnumaccessTokenValidatorAllowedKeyEncryptionAlgorithmProp> allowedKeyEncryptionAlgorithm = new ArrayList<>();
  ...
  private List<EnumaccessTokenValidatorAllowedContentEncryptionAlgorithmProp> allowedContentEncryptionAlgorithm = new ArrayList<>();
  ...
  public JwtAccessTokenValidatorResponse() {
  }

  public JwtAccessTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Access Token Validator")
  ...
  public JwtAccessTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse schemas(List<EnumjwtAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public JwtAccessTokenValidatorResponse addSchemasItem(EnumjwtAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse allowedSigningAlgorithm(List<EnumaccessTokenValidatorAllowedSigningAlgorithmProp> allowedSigningAlgorithm) {
  ...
  public JwtAccessTokenValidatorResponse addAllowedSigningAlgorithmItem(EnumaccessTokenValidatorAllowedSigningAlgorithmProp allowedSigningAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse signingCertificate(List<String> signingCertificate) {
  ...
  public JwtAccessTokenValidatorResponse addSigningCertificateItem(String signingCertificateItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse jwksEndpointPath(String jwksEndpointPath) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse encryptionKeyPair(String encryptionKeyPair) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse allowedKeyEncryptionAlgorithm(List<EnumaccessTokenValidatorAllowedKeyEncryptionAlgorithmProp> allowedKeyEncryptionAlgorithm) {
  ...
  public JwtAccessTokenValidatorResponse addAllowedKeyEncryptionAlgorithmItem(EnumaccessTokenValidatorAllowedKeyEncryptionAlgorithmProp allowedKeyEncryptionAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse allowedContentEncryptionAlgorithm(List<EnumaccessTokenValidatorAllowedContentEncryptionAlgorithmProp> allowedContentEncryptionAlgorithm) {
  ...
  public JwtAccessTokenValidatorResponse addAllowedContentEncryptionAlgorithmItem(EnumaccessTokenValidatorAllowedContentEncryptionAlgorithmProp allowedContentEncryptionAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse clientIDClaimName(String clientIDClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse scopeClaimName(String scopeClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "When multiple JWT Access Token Validators are defined for a single Directory Server, this property determines the evaluation order for determining the correct validator class for an access token received by the Directory Server. Values of this property must be unique among all JWT Access Token Validators defined within Directory Server but not necessarily contiguous. JWT Access Token Validators with a smaller value will be evaluated first to determine if they are able to validate the access token.")
  ...
  public JwtAccessTokenValidatorResponse authorizationServer(String authorizationServer) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the JwtAccessTokenValidatorResponse instance itself
   */
  public JwtAccessTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JwtAccessTokenValidatorResponse jwtAccessTokenValidatorResponse = (JwtAccessTokenValidatorResponse) o;
    return Objects.equals(this.id, jwtAccessTokenValidatorResponse.id) &&
        Objects.equals(this.description, jwtAccessTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, jwtAccessTokenValidatorResponse.schemas) &&
        Objects.equals(this.allowedSigningAlgorithm, jwtAccessTokenValidatorResponse.allowedSigningAlgorithm) &&
        Objects.equals(this.signingCertificate, jwtAccessTokenValidatorResponse.signingCertificate) &&
        Objects.equals(this.jwksEndpointPath, jwtAccessTokenValidatorResponse.jwksEndpointPath) &&
        Objects.equals(this.encryptionKeyPair, jwtAccessTokenValidatorResponse.encryptionKeyPair) &&
        Objects.equals(this.allowedKeyEncryptionAlgorithm, jwtAccessTokenValidatorResponse.allowedKeyEncryptionAlgorithm) &&
        Objects.equals(this.allowedContentEncryptionAlgorithm, jwtAccessTokenValidatorResponse.allowedContentEncryptionAlgorithm) &&
        Objects.equals(this.clockSkewGracePeriod, jwtAccessTokenValidatorResponse.clockSkewGracePeriod) &&
        Objects.equals(this.clientIDClaimName, jwtAccessTokenValidatorResponse.clientIDClaimName) &&
        Objects.equals(this.scopeClaimName, jwtAccessTokenValidatorResponse.scopeClaimName) &&
        Objects.equals(this.evaluationOrderIndex, jwtAccessTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.authorizationServer, jwtAccessTokenValidatorResponse.authorizationServer) &&
        Objects.equals(this.identityMapper, jwtAccessTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, jwtAccessTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.enabled, jwtAccessTokenValidatorResponse.enabled) &&
        Objects.equals(this.meta, jwtAccessTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, jwtAccessTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, jwtAccessTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, allowedSigningAlgorithm, signingCertificate, jwksEndpointPath, encryptionKeyPair, allowedKeyEncryptionAlgorithm, allowedContentEncryptionAlgorithm, clockSkewGracePeriod, clientIDClaimName, scopeClaimName, evaluationOrderIndex, authorizationServer, identityMapper, subjectClaimName, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JwtAccessTokenValidatorResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("allowedKeyEncryptionAlgorithm");
    openapiRequiredFields.add("allowedContentEncryptionAlgorithm");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JwtAccessTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JwtAccessTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JwtAccessTokenValidatorResponse is not found in the empty JSON string", JwtAccessTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JwtAccessTokenValidatorResponse.openapiRequiredFields) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("allowedKeyEncryptionAlgorithm") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("allowedKeyEncryptionAlgorithm").isJsonArray()) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("allowedContentEncryptionAlgorithm") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("allowedContentEncryptionAlgorithm").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JwtAccessTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JwtAccessTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JwtAccessTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JwtAccessTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<JwtAccessTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, JwtAccessTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public JwtAccessTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JwtAccessTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JwtAccessTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JwtAccessTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to JwtAccessTokenValidatorResponse
  */
  public static JwtAccessTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JwtAccessTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of JwtAccessTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
