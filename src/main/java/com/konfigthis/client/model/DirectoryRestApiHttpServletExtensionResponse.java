...
public class DirectoryRestApiHttpServletExtensionResponse {
  ...
  private List<EnumdirectoryRestApiHttpServletExtensionSchemaUrn> schemas = new ArrayList<>();
  ...
  public DirectoryRestApiHttpServletExtensionResponse() {
  }

  public DirectoryRestApiHttpServletExtensionResponse description(String description) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse schemas(List<EnumdirectoryRestApiHttpServletExtensionSchemaUrn> schemas) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addSchemasItem(EnumdirectoryRestApiHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse id(String id) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse basicAuthEnabled(Boolean basicAuthEnabled) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse accessTokenScope(String accessTokenScope) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse audience(String audience) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse maxPageSize(Integer maxPageSize) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse schemasEndpointObjectclass(List<String> schemasEndpointObjectclass) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addSchemasEndpointObjectclassItem(String schemasEndpointObjectclassItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse defaultOperationalAttribute(List<String> defaultOperationalAttribute) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addDefaultOperationalAttributeItem(String defaultOperationalAttributeItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse rejectExpansionAttribute(List<String> rejectExpansionAttribute) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addRejectExpansionAttributeItem(String rejectExpansionAttributeItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse alwaysUsePermissiveModify(Boolean alwaysUsePermissiveModify) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse allowedControl(List<EnumhttpServletExtensionAllowedControlProp> allowedControl) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addAllowedControlItem(EnumhttpServletExtensionAllowedControlProp allowedControlItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse responseHeader(List<String> responseHeader) {
  ...
  public DirectoryRestApiHttpServletExtensionResponse addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DirectoryRestApiHttpServletExtensionResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DirectoryRestApiHttpServletExtensionResponse instance itself
   */
  public DirectoryRestApiHttpServletExtensionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DirectoryRestApiHttpServletExtensionResponse directoryRestApiHttpServletExtensionResponse = (DirectoryRestApiHttpServletExtensionResponse) o;
    return Objects.equals(this.description, directoryRestApiHttpServletExtensionResponse.description) &&
        Objects.equals(this.schemas, directoryRestApiHttpServletExtensionResponse.schemas) &&
        Objects.equals(this.id, directoryRestApiHttpServletExtensionResponse.id) &&
        Objects.equals(this.basicAuthEnabled, directoryRestApiHttpServletExtensionResponse.basicAuthEnabled) &&
        Objects.equals(this.identityMapper, directoryRestApiHttpServletExtensionResponse.identityMapper) &&
        Objects.equals(this.accessTokenValidator, directoryRestApiHttpServletExtensionResponse.accessTokenValidator) &&
        Objects.equals(this.accessTokenScope, directoryRestApiHttpServletExtensionResponse.accessTokenScope) &&
        Objects.equals(this.audience, directoryRestApiHttpServletExtensionResponse.audience) &&
        Objects.equals(this.maxPageSize, directoryRestApiHttpServletExtensionResponse.maxPageSize) &&
        Objects.equals(this.schemasEndpointObjectclass, directoryRestApiHttpServletExtensionResponse.schemasEndpointObjectclass) &&
        Objects.equals(this.defaultOperationalAttribute, directoryRestApiHttpServletExtensionResponse.defaultOperationalAttribute) &&
        Objects.equals(this.rejectExpansionAttribute, directoryRestApiHttpServletExtensionResponse.rejectExpansionAttribute) &&
        Objects.equals(this.alwaysUsePermissiveModify, directoryRestApiHttpServletExtensionResponse.alwaysUsePermissiveModify) &&
        Objects.equals(this.allowedControl, directoryRestApiHttpServletExtensionResponse.allowedControl) &&
        Objects.equals(this.crossOriginPolicy, directoryRestApiHttpServletExtensionResponse.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, directoryRestApiHttpServletExtensionResponse.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, directoryRestApiHttpServletExtensionResponse.correlationIDResponseHeader) &&
        Objects.equals(this.meta, directoryRestApiHttpServletExtensionResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, directoryRestApiHttpServletExtensionResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, directoryRestApiHttpServletExtensionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectoryRestApiHttpServletExtensionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DirectoryRestApiHttpServletExtensionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DirectoryRestApiHttpServletExtensionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectoryRestApiHttpServletExtensionResponse is not found in the empty JSON string", DirectoryRestApiHttpServletExtensionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DirectoryRestApiHttpServletExtensionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectoryRestApiHttpServletExtensionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectoryRestApiHttpServletExtensionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectoryRestApiHttpServletExtensionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectoryRestApiHttpServletExtensionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectoryRestApiHttpServletExtensionResponse>() {
           @Override
           public void write(JsonWriter out, DirectoryRestApiHttpServletExtensionResponse value) throws IOException {
           ...
           @Override
           public DirectoryRestApiHttpServletExtensionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DirectoryRestApiHttpServletExtensionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DirectoryRestApiHttpServletExtensionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DirectoryRestApiHttpServletExtensionResponse
  * @throws IOException if the JSON string is invalid with respect to DirectoryRestApiHttpServletExtensionResponse
  */
  public static DirectoryRestApiHttpServletExtensionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectoryRestApiHttpServletExtensionResponse.class);
  }

 /**
  * Convert an instance of DirectoryRestApiHttpServletExtensionResponse to an JSON string
  *
  * @return JSON string
  */
