...
public class NokiaProxyServerExternalServerShared {
  ...
  public NokiaProxyServerExternalServerShared() {
  }

  public NokiaProxyServerExternalServerShared description(String description) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared schemas(List<EnumnokiaProxyServerExternalServerSchemaUrn> schemas) {
  ...
  public NokiaProxyServerExternalServerShared addSchemasItem(EnumnokiaProxyServerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared location(String location) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared password(String password) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared connectionSecurity(EnumexternalServerNokiaProxyServerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared authenticationMethod(EnumexternalServerNokiaProxyServerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public NokiaProxyServerExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public NokiaProxyServerExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the NokiaProxyServerExternalServerShared instance itself
   */
  public NokiaProxyServerExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NokiaProxyServerExternalServerShared nokiaProxyServerExternalServerShared = (NokiaProxyServerExternalServerShared) o;
    return Objects.equals(this.description, nokiaProxyServerExternalServerShared.description) &&
        Objects.equals(this.schemas, nokiaProxyServerExternalServerShared.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, nokiaProxyServerExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, nokiaProxyServerExternalServerShared.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, nokiaProxyServerExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, nokiaProxyServerExternalServerShared.serverPort) &&
        Objects.equals(this.location, nokiaProxyServerExternalServerShared.location) &&
        Objects.equals(this.bindDN, nokiaProxyServerExternalServerShared.bindDN) &&
        Objects.equals(this.password, nokiaProxyServerExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, nokiaProxyServerExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, nokiaProxyServerExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, nokiaProxyServerExternalServerShared.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, nokiaProxyServerExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, nokiaProxyServerExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, nokiaProxyServerExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, nokiaProxyServerExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, nokiaProxyServerExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, nokiaProxyServerExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, nokiaProxyServerExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, nokiaProxyServerExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, nokiaProxyServerExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, nokiaProxyServerExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, nokiaProxyServerExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, nokiaProxyServerExternalServerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NokiaProxyServerExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NokiaProxyServerExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NokiaProxyServerExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NokiaProxyServerExternalServerShared is not found in the empty JSON string", NokiaProxyServerExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NokiaProxyServerExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NokiaProxyServerExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NokiaProxyServerExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NokiaProxyServerExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NokiaProxyServerExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<NokiaProxyServerExternalServerShared>() {
           @Override
           public void write(JsonWriter out, NokiaProxyServerExternalServerShared value) throws IOException {
           ...
           @Override
           public NokiaProxyServerExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NokiaProxyServerExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NokiaProxyServerExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NokiaProxyServerExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to NokiaProxyServerExternalServerShared
  */
  public static NokiaProxyServerExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NokiaProxyServerExternalServerShared.class);
  }

 /**
  * Convert an instance of NokiaProxyServerExternalServerShared to an JSON string
  *
  * @return JSON string
  */
