...
public class PurgeExpiredDataPluginResponse {
  ...
  public PurgeExpiredDataPluginResponse() {
  }

  public PurgeExpiredDataPluginResponse id(String id) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse description(String description) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse schemas(List<EnumpurgeExpiredDataPluginSchemaUrn> schemas) {
  ...
  public PurgeExpiredDataPluginResponse addSchemasItem(EnumpurgeExpiredDataPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse datetimeAttribute(String datetimeAttribute) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse datetimeJSONField(String datetimeJSONField) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse datetimeFormat(EnumpluginDatetimeFormatProp datetimeFormat) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse customDatetimeFormat(String customDatetimeFormat) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse customTimezone(String customTimezone) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse expirationOffset(String expirationOffset) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse purgeBehavior(EnumpluginPurgeBehaviorProp purgeBehavior) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse baseDN(String baseDN) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse filter(String filter) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse pollingInterval(String pollingInterval) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse maxUpdatesPerSecond(Integer maxUpdatesPerSecond) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse peerServerPriorityIndex(Integer peerServerPriorityIndex) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse numDeleteThreads(Integer numDeleteThreads) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PurgeExpiredDataPluginResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PurgeExpiredDataPluginResponse instance itself
   */
  public PurgeExpiredDataPluginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PurgeExpiredDataPluginResponse purgeExpiredDataPluginResponse = (PurgeExpiredDataPluginResponse) o;
    return Objects.equals(this.id, purgeExpiredDataPluginResponse.id) &&
        Objects.equals(this.description, purgeExpiredDataPluginResponse.description) &&
        Objects.equals(this.schemas, purgeExpiredDataPluginResponse.schemas) &&
        Objects.equals(this.datetimeAttribute, purgeExpiredDataPluginResponse.datetimeAttribute) &&
        Objects.equals(this.datetimeJSONField, purgeExpiredDataPluginResponse.datetimeJSONField) &&
        Objects.equals(this.datetimeFormat, purgeExpiredDataPluginResponse.datetimeFormat) &&
        Objects.equals(this.customDatetimeFormat, purgeExpiredDataPluginResponse.customDatetimeFormat) &&
        Objects.equals(this.customTimezone, purgeExpiredDataPluginResponse.customTimezone) &&
        Objects.equals(this.expirationOffset, purgeExpiredDataPluginResponse.expirationOffset) &&
        Objects.equals(this.purgeBehavior, purgeExpiredDataPluginResponse.purgeBehavior) &&
        Objects.equals(this.baseDN, purgeExpiredDataPluginResponse.baseDN) &&
        Objects.equals(this.filter, purgeExpiredDataPluginResponse.filter) &&
        Objects.equals(this.pollingInterval, purgeExpiredDataPluginResponse.pollingInterval) &&
        Objects.equals(this.maxUpdatesPerSecond, purgeExpiredDataPluginResponse.maxUpdatesPerSecond) &&
        Objects.equals(this.peerServerPriorityIndex, purgeExpiredDataPluginResponse.peerServerPriorityIndex) &&
        Objects.equals(this.numDeleteThreads, purgeExpiredDataPluginResponse.numDeleteThreads) &&
        Objects.equals(this.enabled, purgeExpiredDataPluginResponse.enabled) &&
        Objects.equals(this.meta, purgeExpiredDataPluginResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, purgeExpiredDataPluginResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, purgeExpiredDataPluginResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, datetimeAttribute, datetimeJSONField, datetimeFormat, customDatetimeFormat, customTimezone, expirationOffset, purgeBehavior, baseDN, filter, pollingInterval, maxUpdatesPerSecond, peerServerPriorityIndex, numDeleteThreads, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PurgeExpiredDataPluginResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PurgeExpiredDataPluginResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PurgeExpiredDataPluginResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PurgeExpiredDataPluginResponse is not found in the empty JSON string", PurgeExpiredDataPluginResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PurgeExpiredDataPluginResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PurgeExpiredDataPluginResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PurgeExpiredDataPluginResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PurgeExpiredDataPluginResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PurgeExpiredDataPluginResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PurgeExpiredDataPluginResponse>() {
           @Override
           public void write(JsonWriter out, PurgeExpiredDataPluginResponse value) throws IOException {
           ...
           @Override
           public PurgeExpiredDataPluginResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PurgeExpiredDataPluginResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PurgeExpiredDataPluginResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PurgeExpiredDataPluginResponse
  * @throws IOException if the JSON string is invalid with respect to PurgeExpiredDataPluginResponse
  */
  public static PurgeExpiredDataPluginResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PurgeExpiredDataPluginResponse.class);
  }

 /**
  * Convert an instance of PurgeExpiredDataPluginResponse to an JSON string
  *
  * @return JSON string
  */
