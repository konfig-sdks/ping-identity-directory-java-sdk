...
import com.konfigthis.client.model.EnumexternalServerPingIdentityDsAuthenticationMethodProp;
import com.konfigthis.client.model.EnumexternalServerPingIdentityDsConnectionSecurityProp;
import com.konfigthis.client.model.EnumexternalServerVerifyCredentialsMethodProp;
import com.konfigthis.client.model.EnumpingIdentityDsExternalServerSchemaUrn;
...
public class PingIdentityDsExternalServerResponse {
  ...
  private List<EnumpingIdentityDsExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerPingIdentityDsConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerPingIdentityDsAuthenticationMethodProp authenticationMethod;
  ...
  public PingIdentityDsExternalServerResponse() {
  }

  public PingIdentityDsExternalServerResponse id(String id) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse description(String description) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse schemas(List<EnumpingIdentityDsExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityDsExternalServerResponse addSchemasItem(EnumpingIdentityDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumpingIdentityDsExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumpingIdentityDsExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityDsExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse location(String location) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse password(String password) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse connectionSecurity(EnumexternalServerPingIdentityDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerPingIdentityDsConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerPingIdentityDsConnectionSecurityProp connectionSecurity) {
  ...
  public PingIdentityDsExternalServerResponse authenticationMethod(EnumexternalServerPingIdentityDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerPingIdentityDsAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerPingIdentityDsAuthenticationMethodProp authenticationMethod) {
  ...
  public PingIdentityDsExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public PingIdentityDsExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PingIdentityDsExternalServerResponse instance itself
   */
  public PingIdentityDsExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingIdentityDsExternalServerResponse pingIdentityDsExternalServerResponse = (PingIdentityDsExternalServerResponse) o;
    return Objects.equals(this.id, pingIdentityDsExternalServerResponse.id) &&
        Objects.equals(this.description, pingIdentityDsExternalServerResponse.description) &&
        Objects.equals(this.schemas, pingIdentityDsExternalServerResponse.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, pingIdentityDsExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, pingIdentityDsExternalServerResponse.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, pingIdentityDsExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, pingIdentityDsExternalServerResponse.serverPort) &&
        Objects.equals(this.location, pingIdentityDsExternalServerResponse.location) &&
        Objects.equals(this.bindDN, pingIdentityDsExternalServerResponse.bindDN) &&
        Objects.equals(this.password, pingIdentityDsExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, pingIdentityDsExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, pingIdentityDsExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, pingIdentityDsExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, pingIdentityDsExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, pingIdentityDsExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, pingIdentityDsExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, pingIdentityDsExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, pingIdentityDsExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, pingIdentityDsExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, pingIdentityDsExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, pingIdentityDsExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, pingIdentityDsExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, pingIdentityDsExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, pingIdentityDsExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, pingIdentityDsExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pingIdentityDsExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pingIdentityDsExternalServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PingIdentityDsExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingIdentityDsExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingIdentityDsExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingIdentityDsExternalServerResponse is not found in the empty JSON string", PingIdentityDsExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingIdentityDsExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingIdentityDsExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingIdentityDsExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingIdentityDsExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingIdentityDsExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PingIdentityDsExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, PingIdentityDsExternalServerResponse value) throws IOException {
           ...
           @Override
           public PingIdentityDsExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingIdentityDsExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingIdentityDsExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingIdentityDsExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to PingIdentityDsExternalServerResponse
  */
  public static PingIdentityDsExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingIdentityDsExternalServerResponse.class);
  }

 /**
  * Convert an instance of PingIdentityDsExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
