...
public class LdapConnectionHandlerResponse {
  ...
  public LdapConnectionHandlerResponse() {
  }

  public LdapConnectionHandlerResponse id(String id) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse description(String description) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse schemas(List<EnumldapConnectionHandlerSchemaUrn> schemas) {
  ...
  public LdapConnectionHandlerResponse addSchemasItem(EnumldapConnectionHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse listenAddress(List<String> listenAddress) {
  ...
  public LdapConnectionHandlerResponse addListenAddressItem(String listenAddressItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse listenPort(Integer listenPort) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse allowStartTLS(Boolean allowStartTLS) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse allowLDAPV2(Boolean allowLDAPV2) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse useTCPKeepAlive(Boolean useTCPKeepAlive) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse sendRejectionNotice(Boolean sendRejectionNotice) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse failedBindResponseDelay(String failedBindResponseDelay) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse maxRequestSize(String maxRequestSize) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse maxCancelHandlers(Integer maxCancelHandlers) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse numAcceptHandlers(Integer numAcceptHandlers) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse numRequestHandlers(Integer numRequestHandlers) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse requestHandlerPerConnection(Boolean requestHandlerPerConnection) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse sslClientAuthPolicy(EnumconnectionHandlerSslClientAuthPolicyProp sslClientAuthPolicy) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse acceptBacklog(Integer acceptBacklog) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse sslProtocol(List<String> sslProtocol) {
  ...
  public LdapConnectionHandlerResponse addSslProtocolItem(String sslProtocolItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse sslCipherSuite(List<String> sslCipherSuite) {
  ...
  public LdapConnectionHandlerResponse addSslCipherSuiteItem(String sslCipherSuiteItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse maxBlockedWriteTimeLimit(String maxBlockedWriteTimeLimit) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse autoAuthenticateUsingClientCertificate(Boolean autoAuthenticateUsingClientCertificate) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse closeConnectionsWhenUnavailable(Boolean closeConnectionsWhenUnavailable) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse closeConnectionsOnExplicitGC(Boolean closeConnectionsOnExplicitGC) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse allowedClient(List<String> allowedClient) {
  ...
  public LdapConnectionHandlerResponse addAllowedClientItem(String allowedClientItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse deniedClient(List<String> deniedClient) {
  ...
  public LdapConnectionHandlerResponse addDeniedClientItem(String deniedClientItem) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdapConnectionHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdapConnectionHandlerResponse instance itself
   */
  public LdapConnectionHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapConnectionHandlerResponse ldapConnectionHandlerResponse = (LdapConnectionHandlerResponse) o;
    return Objects.equals(this.id, ldapConnectionHandlerResponse.id) &&
        Objects.equals(this.description, ldapConnectionHandlerResponse.description) &&
        Objects.equals(this.schemas, ldapConnectionHandlerResponse.schemas) &&
        Objects.equals(this.listenAddress, ldapConnectionHandlerResponse.listenAddress) &&
        Objects.equals(this.listenPort, ldapConnectionHandlerResponse.listenPort) &&
        Objects.equals(this.useSSL, ldapConnectionHandlerResponse.useSSL) &&
        Objects.equals(this.allowStartTLS, ldapConnectionHandlerResponse.allowStartTLS) &&
        Objects.equals(this.sslCertNickname, ldapConnectionHandlerResponse.sslCertNickname) &&
        Objects.equals(this.keyManagerProvider, ldapConnectionHandlerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, ldapConnectionHandlerResponse.trustManagerProvider) &&
        Objects.equals(this.allowLDAPV2, ldapConnectionHandlerResponse.allowLDAPV2) &&
        Objects.equals(this.useTCPKeepAlive, ldapConnectionHandlerResponse.useTCPKeepAlive) &&
        Objects.equals(this.sendRejectionNotice, ldapConnectionHandlerResponse.sendRejectionNotice) &&
        Objects.equals(this.failedBindResponseDelay, ldapConnectionHandlerResponse.failedBindResponseDelay) &&
        Objects.equals(this.maxRequestSize, ldapConnectionHandlerResponse.maxRequestSize) &&
        Objects.equals(this.maxCancelHandlers, ldapConnectionHandlerResponse.maxCancelHandlers) &&
        Objects.equals(this.numAcceptHandlers, ldapConnectionHandlerResponse.numAcceptHandlers) &&
        Objects.equals(this.numRequestHandlers, ldapConnectionHandlerResponse.numRequestHandlers) &&
        Objects.equals(this.requestHandlerPerConnection, ldapConnectionHandlerResponse.requestHandlerPerConnection) &&
        Objects.equals(this.sslClientAuthPolicy, ldapConnectionHandlerResponse.sslClientAuthPolicy) &&
        Objects.equals(this.acceptBacklog, ldapConnectionHandlerResponse.acceptBacklog) &&
        Objects.equals(this.sslProtocol, ldapConnectionHandlerResponse.sslProtocol) &&
        Objects.equals(this.sslCipherSuite, ldapConnectionHandlerResponse.sslCipherSuite) &&
        Objects.equals(this.maxBlockedWriteTimeLimit, ldapConnectionHandlerResponse.maxBlockedWriteTimeLimit) &&
        Objects.equals(this.autoAuthenticateUsingClientCertificate, ldapConnectionHandlerResponse.autoAuthenticateUsingClientCertificate) &&
        Objects.equals(this.closeConnectionsWhenUnavailable, ldapConnectionHandlerResponse.closeConnectionsWhenUnavailable) &&
        Objects.equals(this.closeConnectionsOnExplicitGC, ldapConnectionHandlerResponse.closeConnectionsOnExplicitGC) &&
        Objects.equals(this.enabled, ldapConnectionHandlerResponse.enabled) &&
        Objects.equals(this.allowedClient, ldapConnectionHandlerResponse.allowedClient) &&
        Objects.equals(this.deniedClient, ldapConnectionHandlerResponse.deniedClient) &&
        Objects.equals(this.meta, ldapConnectionHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldapConnectionHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldapConnectionHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, listenAddress, listenPort, useSSL, allowStartTLS, sslCertNickname, keyManagerProvider, trustManagerProvider, allowLDAPV2, useTCPKeepAlive, sendRejectionNotice, failedBindResponseDelay, maxRequestSize, maxCancelHandlers, numAcceptHandlers, numRequestHandlers, requestHandlerPerConnection, sslClientAuthPolicy, acceptBacklog, sslProtocol, sslCipherSuite, maxBlockedWriteTimeLimit, autoAuthenticateUsingClientCertificate, closeConnectionsWhenUnavailable, closeConnectionsOnExplicitGC, enabled, allowedClient, deniedClient, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdapConnectionHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapConnectionHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapConnectionHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapConnectionHandlerResponse is not found in the empty JSON string", LdapConnectionHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdapConnectionHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapConnectionHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapConnectionHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapConnectionHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapConnectionHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapConnectionHandlerResponse>() {
           @Override
           public void write(JsonWriter out, LdapConnectionHandlerResponse value) throws IOException {
           ...
           @Override
           public LdapConnectionHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapConnectionHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapConnectionHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapConnectionHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to LdapConnectionHandlerResponse
  */
  public static LdapConnectionHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapConnectionHandlerResponse.class);
  }

 /**
  * Convert an instance of LdapConnectionHandlerResponse to an JSON string
  *
  * @return JSON string
  */
