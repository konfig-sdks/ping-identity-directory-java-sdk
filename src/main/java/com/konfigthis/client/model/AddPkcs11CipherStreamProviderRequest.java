...
public class AddPkcs11CipherStreamProviderRequest {
  ...
  public AddPkcs11CipherStreamProviderRequest() {
  }

  public AddPkcs11CipherStreamProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest description(String description) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest schemas(List<Enumpkcs11CipherStreamProviderSchemaUrn> schemas) {
  ...
  public AddPkcs11CipherStreamProviderRequest addSchemasItem(Enumpkcs11CipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest pkcs11ProviderClass(String pkcs11ProviderClass) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest pkcs11ProviderConfigurationFile(String pkcs11ProviderConfigurationFile) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest keyStorePin(String keyStorePin) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest keyStorePinFile(String keyStorePinFile) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest keyStorePinEnvironmentVariable(String keyStorePinEnvironmentVariable) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest pkcs11KeyStoreType(String pkcs11KeyStoreType) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest encryptionMetadataFile(String encryptionMetadataFile) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public AddPkcs11CipherStreamProviderRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddPkcs11CipherStreamProviderRequest instance itself
   */
  public AddPkcs11CipherStreamProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPkcs11CipherStreamProviderRequest addPkcs11CipherStreamProviderRequest = (AddPkcs11CipherStreamProviderRequest) o;
    return Objects.equals(this.providerName, addPkcs11CipherStreamProviderRequest.providerName) &&
        Objects.equals(this.description, addPkcs11CipherStreamProviderRequest.description) &&
        Objects.equals(this.schemas, addPkcs11CipherStreamProviderRequest.schemas) &&
        Objects.equals(this.pkcs11ProviderClass, addPkcs11CipherStreamProviderRequest.pkcs11ProviderClass) &&
        Objects.equals(this.pkcs11ProviderConfigurationFile, addPkcs11CipherStreamProviderRequest.pkcs11ProviderConfigurationFile) &&
        Objects.equals(this.keyStorePin, addPkcs11CipherStreamProviderRequest.keyStorePin) &&
        Objects.equals(this.keyStorePinFile, addPkcs11CipherStreamProviderRequest.keyStorePinFile) &&
        Objects.equals(this.keyStorePinEnvironmentVariable, addPkcs11CipherStreamProviderRequest.keyStorePinEnvironmentVariable) &&
        Objects.equals(this.pkcs11KeyStoreType, addPkcs11CipherStreamProviderRequest.pkcs11KeyStoreType) &&
        Objects.equals(this.sslCertNickname, addPkcs11CipherStreamProviderRequest.sslCertNickname) &&
        Objects.equals(this.encryptionMetadataFile, addPkcs11CipherStreamProviderRequest.encryptionMetadataFile) &&
        Objects.equals(this.iterationCount, addPkcs11CipherStreamProviderRequest.iterationCount) &&
        Objects.equals(this.enabled, addPkcs11CipherStreamProviderRequest.enabled)&&
        Objects.equals(this.additionalProperties, addPkcs11CipherStreamProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, description, schemas, pkcs11ProviderClass, pkcs11ProviderConfigurationFile, keyStorePin, keyStorePinFile, keyStorePinEnvironmentVariable, pkcs11KeyStoreType, sslCertNickname, encryptionMetadataFile, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPkcs11CipherStreamProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPkcs11CipherStreamProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPkcs11CipherStreamProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPkcs11CipherStreamProviderRequest is not found in the empty JSON string", AddPkcs11CipherStreamProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPkcs11CipherStreamProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPkcs11CipherStreamProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPkcs11CipherStreamProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPkcs11CipherStreamProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPkcs11CipherStreamProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPkcs11CipherStreamProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddPkcs11CipherStreamProviderRequest value) throws IOException {
           ...
           @Override
           public AddPkcs11CipherStreamProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPkcs11CipherStreamProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPkcs11CipherStreamProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPkcs11CipherStreamProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddPkcs11CipherStreamProviderRequest
  */
  public static AddPkcs11CipherStreamProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPkcs11CipherStreamProviderRequest.class);
  }

 /**
  * Convert an instance of AddPkcs11CipherStreamProviderRequest to an JSON string
  *
  * @return JSON string
  */
