...
public class UnboundidTotpSaslMechanismHandlerResponse {
  ...
  private List<EnumunboundidTotpSaslMechanismHandlerSchemaUrn> schemas = new ArrayList<>();
  ...
  public UnboundidTotpSaslMechanismHandlerResponse() {
  }

  public UnboundidTotpSaslMechanismHandlerResponse description(String description) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse schemas(List<EnumunboundidTotpSaslMechanismHandlerSchemaUrn> schemas) {
  ...
  public UnboundidTotpSaslMechanismHandlerResponse addSchemasItem(EnumunboundidTotpSaslMechanismHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse id(String id) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse sharedSecretAttributeType(String sharedSecretAttributeType) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse timeIntervalDuration(String timeIntervalDuration) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse adjacentIntervalsToCheck(Integer adjacentIntervalsToCheck) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse requireStaticPassword(Boolean requireStaticPassword) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse preventTOTPReuse(Boolean preventTOTPReuse) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UnboundidTotpSaslMechanismHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UnboundidTotpSaslMechanismHandlerResponse instance itself
   */
  public UnboundidTotpSaslMechanismHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UnboundidTotpSaslMechanismHandlerResponse unboundidTotpSaslMechanismHandlerResponse = (UnboundidTotpSaslMechanismHandlerResponse) o;
    return Objects.equals(this.description, unboundidTotpSaslMechanismHandlerResponse.description) &&
        Objects.equals(this.schemas, unboundidTotpSaslMechanismHandlerResponse.schemas) &&
        Objects.equals(this.id, unboundidTotpSaslMechanismHandlerResponse.id) &&
        Objects.equals(this.identityMapper, unboundidTotpSaslMechanismHandlerResponse.identityMapper) &&
        Objects.equals(this.sharedSecretAttributeType, unboundidTotpSaslMechanismHandlerResponse.sharedSecretAttributeType) &&
        Objects.equals(this.timeIntervalDuration, unboundidTotpSaslMechanismHandlerResponse.timeIntervalDuration) &&
        Objects.equals(this.adjacentIntervalsToCheck, unboundidTotpSaslMechanismHandlerResponse.adjacentIntervalsToCheck) &&
        Objects.equals(this.requireStaticPassword, unboundidTotpSaslMechanismHandlerResponse.requireStaticPassword) &&
        Objects.equals(this.preventTOTPReuse, unboundidTotpSaslMechanismHandlerResponse.preventTOTPReuse) &&
        Objects.equals(this.enabled, unboundidTotpSaslMechanismHandlerResponse.enabled) &&
        Objects.equals(this.meta, unboundidTotpSaslMechanismHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, unboundidTotpSaslMechanismHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, unboundidTotpSaslMechanismHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, identityMapper, sharedSecretAttributeType, timeIntervalDuration, adjacentIntervalsToCheck, requireStaticPassword, preventTOTPReuse, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UnboundidTotpSaslMechanismHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UnboundidTotpSaslMechanismHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UnboundidTotpSaslMechanismHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UnboundidTotpSaslMechanismHandlerResponse is not found in the empty JSON string", UnboundidTotpSaslMechanismHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UnboundidTotpSaslMechanismHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UnboundidTotpSaslMechanismHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UnboundidTotpSaslMechanismHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UnboundidTotpSaslMechanismHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UnboundidTotpSaslMechanismHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UnboundidTotpSaslMechanismHandlerResponse>() {
           @Override
           public void write(JsonWriter out, UnboundidTotpSaslMechanismHandlerResponse value) throws IOException {
           ...
           @Override
           public UnboundidTotpSaslMechanismHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UnboundidTotpSaslMechanismHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UnboundidTotpSaslMechanismHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UnboundidTotpSaslMechanismHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to UnboundidTotpSaslMechanismHandlerResponse
  */
  public static UnboundidTotpSaslMechanismHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UnboundidTotpSaslMechanismHandlerResponse.class);
  }

 /**
  * Convert an instance of UnboundidTotpSaslMechanismHandlerResponse to an JSON string
  *
  * @return JSON string
  */
