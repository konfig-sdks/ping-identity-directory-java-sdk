...
public class AddThirdPartyPasswordValidatorRequest {
  ...
  public AddThirdPartyPasswordValidatorRequest() {
  }

  public AddThirdPartyPasswordValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest schemas(List<EnumthirdPartyPasswordValidatorSchemaUrn> schemas) {
  ...
  public AddThirdPartyPasswordValidatorRequest addSchemasItem(EnumthirdPartyPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyPasswordValidatorRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public AddThirdPartyPasswordValidatorRequest validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the AddThirdPartyPasswordValidatorRequest instance itself
   */
  public AddThirdPartyPasswordValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyPasswordValidatorRequest addThirdPartyPasswordValidatorRequest = (AddThirdPartyPasswordValidatorRequest) o;
    return Objects.equals(this.validatorName, addThirdPartyPasswordValidatorRequest.validatorName) &&
        Objects.equals(this.description, addThirdPartyPasswordValidatorRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyPasswordValidatorRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyPasswordValidatorRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyPasswordValidatorRequest.extensionArgument) &&
        Objects.equals(this.enabled, addThirdPartyPasswordValidatorRequest.enabled) &&
        Objects.equals(this.validatorRequirementDescription, addThirdPartyPasswordValidatorRequest.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, addThirdPartyPasswordValidatorRequest.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, addThirdPartyPasswordValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, extensionClass, extensionArgument, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyPasswordValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyPasswordValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyPasswordValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyPasswordValidatorRequest is not found in the empty JSON string", AddThirdPartyPasswordValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyPasswordValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyPasswordValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyPasswordValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyPasswordValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyPasswordValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyPasswordValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyPasswordValidatorRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyPasswordValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyPasswordValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyPasswordValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyPasswordValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyPasswordValidatorRequest
  */
  public static AddThirdPartyPasswordValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyPasswordValidatorRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyPasswordValidatorRequest to an JSON string
  *
  * @return JSON string
  */
