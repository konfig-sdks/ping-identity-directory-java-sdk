...
public class PassThroughScimResourceTypeResponseAllOf {
  ...
  private List<EnumpassThroughScimResourceTypeSchemaUrn> schemas = null;
  ...
  public PassThroughScimResourceTypeResponseAllOf() {
  }

  public PassThroughScimResourceTypeResponseAllOf description(String description) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf schemas(List<EnumpassThroughScimResourceTypeSchemaUrn> schemas) {
  ...
  public PassThroughScimResourceTypeResponseAllOf addSchemasItem(EnumpassThroughScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf id(String id) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Name of the SCIM Resource Type")
  ...
  public PassThroughScimResourceTypeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the SCIM Resource Type is enabled.")
  ...
  public PassThroughScimResourceTypeResponseAllOf endpoint(String endpoint) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The HTTP addressable endpoint of this SCIM Resource Type relative to the '/scim/v2' base URL. Do not include a leading '/'.")
  ...
  public PassThroughScimResourceTypeResponseAllOf lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public PassThroughScimResourceTypeResponseAllOf addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public PassThroughScimResourceTypeResponseAllOf addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf includeFilter(List<String> includeFilter) {
  ...
  public PassThroughScimResourceTypeResponseAllOf addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public PassThroughScimResourceTypeResponseAllOf addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public PassThroughScimResourceTypeResponseAllOf createDNPattern(String createDNPattern) {
  ...
  **/
   ...
   * @return the PassThroughScimResourceTypeResponseAllOf instance itself
   */
  public PassThroughScimResourceTypeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PassThroughScimResourceTypeResponseAllOf passThroughScimResourceTypeResponseAllOf = (PassThroughScimResourceTypeResponseAllOf) o;
    return Objects.equals(this.description, passThroughScimResourceTypeResponseAllOf.description) &&
        Objects.equals(this.schemas, passThroughScimResourceTypeResponseAllOf.schemas) &&
        Objects.equals(this.id, passThroughScimResourceTypeResponseAllOf.id) &&
        Objects.equals(this.enabled, passThroughScimResourceTypeResponseAllOf.enabled) &&
        Objects.equals(this.endpoint, passThroughScimResourceTypeResponseAllOf.endpoint) &&
        Objects.equals(this.lookthroughLimit, passThroughScimResourceTypeResponseAllOf.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, passThroughScimResourceTypeResponseAllOf.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, passThroughScimResourceTypeResponseAllOf.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, passThroughScimResourceTypeResponseAllOf.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, passThroughScimResourceTypeResponseAllOf.includeBaseDN) &&
        Objects.equals(this.includeFilter, passThroughScimResourceTypeResponseAllOf.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, passThroughScimResourceTypeResponseAllOf.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, passThroughScimResourceTypeResponseAllOf.createDNPattern)&&
        Objects.equals(this.additionalProperties, passThroughScimResourceTypeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, endpoint, lookthroughLimit, schemaCheckingOption, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, includeBaseDN, includeFilter, includeOperationalAttribute, createDNPattern, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PassThroughScimResourceTypeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PassThroughScimResourceTypeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PassThroughScimResourceTypeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PassThroughScimResourceTypeResponseAllOf is not found in the empty JSON string", PassThroughScimResourceTypeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PassThroughScimResourceTypeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PassThroughScimResourceTypeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PassThroughScimResourceTypeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PassThroughScimResourceTypeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<PassThroughScimResourceTypeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, PassThroughScimResourceTypeResponseAllOf value) throws IOException {
           ...
           @Override
           public PassThroughScimResourceTypeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PassThroughScimResourceTypeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PassThroughScimResourceTypeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PassThroughScimResourceTypeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to PassThroughScimResourceTypeResponseAllOf
  */
  public static PassThroughScimResourceTypeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PassThroughScimResourceTypeResponseAllOf.class);
  }

 /**
  * Convert an instance of PassThroughScimResourceTypeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
