...
public class ScimExternalServerResponse {
  ...
  private List<EnumscimExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  public ScimExternalServerResponse() {
  }

  public ScimExternalServerResponse description(String description) {
  ...
  **/
  ...
  public ScimExternalServerResponse schemas(List<EnumscimExternalServerSchemaUrn> schemas) {
  ...
  public ScimExternalServerResponse addSchemasItem(EnumscimExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ScimExternalServerResponse id(String id) {
  ...
  **/
  ...
  public ScimExternalServerResponse scimServiceURL(String scimServiceURL) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The complete URL which will be used to access the SCIM service provider.")
  ...
  public ScimExternalServerResponse userName(String userName) {
  ...
  **/
  ...
  public ScimExternalServerResponse password(String password) {
  ...
  **/
  ...
  public ScimExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public ScimExternalServerResponse location(String location) {
  ...
  **/
  ...
  public ScimExternalServerResponse connectionSecurity(EnumexternalServerScimConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public ScimExternalServerResponse authenticationMethod(EnumexternalServerScimAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public ScimExternalServerResponse hostnameVerificationMethod(EnumexternalServerScimHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public ScimExternalServerResponse httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public ScimExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public ScimExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public ScimExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public ScimExternalServerResponse responseTimeout(String responseTimeout) {
  ...
  **/
  ...
  public ScimExternalServerResponse oauthTokenType(EnumexternalServerOAuthTokenTypeProp oauthTokenType) {
  ...
  **/
  ...
  public ScimExternalServerResponse oauthToken(String oauthToken) {
  ...
  **/
  ...
  public ScimExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ScimExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ScimExternalServerResponse instance itself
   */
  public ScimExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ScimExternalServerResponse scimExternalServerResponse = (ScimExternalServerResponse) o;
    return Objects.equals(this.description, scimExternalServerResponse.description) &&
        Objects.equals(this.schemas, scimExternalServerResponse.schemas) &&
        Objects.equals(this.id, scimExternalServerResponse.id) &&
        Objects.equals(this.scimServiceURL, scimExternalServerResponse.scimServiceURL) &&
        Objects.equals(this.userName, scimExternalServerResponse.userName) &&
        Objects.equals(this.password, scimExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, scimExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.location, scimExternalServerResponse.location) &&
        Objects.equals(this.connectionSecurity, scimExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, scimExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.hostnameVerificationMethod, scimExternalServerResponse.hostnameVerificationMethod) &&
        Objects.equals(this.httpProxyExternalServer, scimExternalServerResponse.httpProxyExternalServer) &&
        Objects.equals(this.keyManagerProvider, scimExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, scimExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.connectTimeout, scimExternalServerResponse.connectTimeout) &&
        Objects.equals(this.responseTimeout, scimExternalServerResponse.responseTimeout) &&
        Objects.equals(this.oauthTokenType, scimExternalServerResponse.oauthTokenType) &&
        Objects.equals(this.oauthToken, scimExternalServerResponse.oauthToken) &&
        Objects.equals(this.meta, scimExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, scimExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, scimExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, scimServiceURL, userName, password, passphraseProvider, location, connectionSecurity, authenticationMethod, hostnameVerificationMethod, httpProxyExternalServer, keyManagerProvider, trustManagerProvider, connectTimeout, responseTimeout, oauthTokenType, oauthToken, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ScimExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ScimExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ScimExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ScimExternalServerResponse is not found in the empty JSON string", ScimExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ScimExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ScimExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ScimExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ScimExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ScimExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ScimExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, ScimExternalServerResponse value) throws IOException {
           ...
           @Override
           public ScimExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ScimExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ScimExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ScimExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to ScimExternalServerResponse
  */
  public static ScimExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ScimExternalServerResponse.class);
  }

 /**
  * Convert an instance of ScimExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
