...
import com.konfigthis.client.model.EnumdirectoryServerInstanceSchemaUrn;
...
public class DirectoryServerInstanceResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumdirectoryServerInstanceSchemaUrn> schemas = null;
  ...
  public static final String SERIALIZED_NAME_LOAD_BALANCING_ALGORITHM_NAME = "loadBalancingAlgorithmName";
  @SerializedName(SERIALIZED_NAME_LOAD_BALANCING_ALGORITHM_NAME)
  private List<String> loadBalancingAlgorithmName = null;
  ...
  public DirectoryServerInstanceResponseAllOf() {
  }

  public DirectoryServerInstanceResponseAllOf schemas(List<EnumdirectoryServerInstanceSchemaUrn> schemas) {
  ...
  public DirectoryServerInstanceResponseAllOf addSchemasItem(EnumdirectoryServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumdirectoryServerInstanceSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumdirectoryServerInstanceSchemaUrn> schemas) {
  ...
  public DirectoryServerInstanceResponseAllOf id(String id) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf replicationSetName(String replicationSetName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf loadBalancingAlgorithmName(List<String> loadBalancingAlgorithmName) {
    
    
    
    
    this.loadBalancingAlgorithmName = loadBalancingAlgorithmName;
    return this;
  }

  public DirectoryServerInstanceResponseAllOf addLoadBalancingAlgorithmNameItem(String loadBalancingAlgorithmNameItem) {
    if (this.loadBalancingAlgorithmName == null) {
      this.loadBalancingAlgorithmName = new ArrayList<>();
    }
    this.loadBalancingAlgorithmName.add(loadBalancingAlgorithmNameItem);
    return this;
  }

   /**
   * The name of the configuration object for a load-balancing algorithm that should include this server.
   * @return loadBalancingAlgorithmName
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the configuration object for a load-balancing algorithm that should include this server.")

  public List<String> getLoadBalancingAlgorithmName() {
    return loadBalancingAlgorithmName;
  }


  public void setLoadBalancingAlgorithmName(List<String> loadBalancingAlgorithmName) {
  ...
  public DirectoryServerInstanceResponseAllOf serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf clusterName(String clusterName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf hostname(String hostname) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf serverRoot(String serverRoot) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf serverVersion(String serverVersion) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf httpPort(Integer httpPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public DirectoryServerInstanceResponseAllOf addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf baseDN(List<String> baseDN) {
  ...
  public DirectoryServerInstanceResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponseAllOf memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public DirectoryServerInstanceResponseAllOf addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
   ...
   * @return the DirectoryServerInstanceResponseAllOf instance itself
   */
  public DirectoryServerInstanceResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DirectoryServerInstanceResponseAllOf directoryServerInstanceResponseAllOf = (DirectoryServerInstanceResponseAllOf) o;
    return Objects.equals(this.schemas, directoryServerInstanceResponseAllOf.schemas) &&
        Objects.equals(this.id, directoryServerInstanceResponseAllOf.id) &&
        Objects.equals(this.serverInstanceType, directoryServerInstanceResponseAllOf.serverInstanceType) &&
        Objects.equals(this.replicationSetName, directoryServerInstanceResponseAllOf.replicationSetName) &&
        Objects.equals(this.loadBalancingAlgorithmName, directoryServerInstanceResponseAllOf.loadBalancingAlgorithmName) &&
        Objects.equals(this.serverInstanceName, directoryServerInstanceResponseAllOf.serverInstanceName) &&
        Objects.equals(this.clusterName, directoryServerInstanceResponseAllOf.clusterName) &&
        Objects.equals(this.serverInstanceLocation, directoryServerInstanceResponseAllOf.serverInstanceLocation) &&
        Objects.equals(this.hostname, directoryServerInstanceResponseAllOf.hostname) &&
        Objects.equals(this.serverRoot, directoryServerInstanceResponseAllOf.serverRoot) &&
        Objects.equals(this.serverVersion, directoryServerInstanceResponseAllOf.serverVersion) &&
        Objects.equals(this.interServerCertificate, directoryServerInstanceResponseAllOf.interServerCertificate) &&
        Objects.equals(this.ldapPort, directoryServerInstanceResponseAllOf.ldapPort) &&
        Objects.equals(this.ldapsPort, directoryServerInstanceResponseAllOf.ldapsPort) &&
        Objects.equals(this.httpPort, directoryServerInstanceResponseAllOf.httpPort) &&
        Objects.equals(this.httpsPort, directoryServerInstanceResponseAllOf.httpsPort) &&
        Objects.equals(this.replicationPort, directoryServerInstanceResponseAllOf.replicationPort) &&
        Objects.equals(this.replicationServerID, directoryServerInstanceResponseAllOf.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, directoryServerInstanceResponseAllOf.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, directoryServerInstanceResponseAllOf.jmxPort) &&
        Objects.equals(this.jmxsPort, directoryServerInstanceResponseAllOf.jmxsPort) &&
        Objects.equals(this.preferredSecurity, directoryServerInstanceResponseAllOf.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, directoryServerInstanceResponseAllOf.startTLSEnabled) &&
        Objects.equals(this.baseDN, directoryServerInstanceResponseAllOf.baseDN) &&
        Objects.equals(this.memberOfServerGroup, directoryServerInstanceResponseAllOf.memberOfServerGroup)&&
        Objects.equals(this.additionalProperties, directoryServerInstanceResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, id, serverInstanceType, replicationSetName, loadBalancingAlgorithmName, serverInstanceName, clusterName, serverInstanceLocation, hostname, serverRoot, serverVersion, interServerCertificate, ldapPort, ldapsPort, httpPort, httpsPort, replicationPort, replicationServerID, replicationDomainServerID, jmxPort, jmxsPort, preferredSecurity, startTLSEnabled, baseDN, memberOfServerGroup, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DirectoryServerInstanceResponseAllOf {\n");
    ...
    sb.append("    loadBalancingAlgorithmName: ").append(toIndentedString(loadBalancingAlgorithmName)).append("\n");
  ...
  static {
    ...
    openapiFields.add("loadBalancingAlgorithmName");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DirectoryServerInstanceResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DirectoryServerInstanceResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectoryServerInstanceResponseAllOf is not found in the empty JSON string", DirectoryServerInstanceResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("loadBalancingAlgorithmName") != null && !jsonObj.get("loadBalancingAlgorithmName").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `loadBalancingAlgorithmName` to be an array in the JSON string but got `%s`", jsonObj.get("loadBalancingAlgorithmName").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectoryServerInstanceResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectoryServerInstanceResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectoryServerInstanceResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectoryServerInstanceResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectoryServerInstanceResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DirectoryServerInstanceResponseAllOf value) throws IOException {
           ...
           @Override
           public DirectoryServerInstanceResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DirectoryServerInstanceResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DirectoryServerInstanceResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DirectoryServerInstanceResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DirectoryServerInstanceResponseAllOf
  */
  public static DirectoryServerInstanceResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectoryServerInstanceResponseAllOf.class);
  }

 /**
  * Convert an instance of DirectoryServerInstanceResponseAllOf to an JSON string
  *
  * @return JSON string
  */
