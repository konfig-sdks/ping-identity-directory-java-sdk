...
public class AlarmBackendResponse {
  ...
  private List<EnumalarmBackendSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_ALARM_RETENTION_TIME = "alarmRetentionTime";
  @SerializedName(SERIALIZED_NAME_ALARM_RETENTION_TIME)
  private String alarmRetentionTime;

  public static final String SERIALIZED_NAME_MAX_ALARMS = "maxAlarms";
  @SerializedName(SERIALIZED_NAME_MAX_ALARMS)
  ...
  public AlarmBackendResponse() {
  }

  public AlarmBackendResponse description(String description) {
  ...
  **/
  ...
  public AlarmBackendResponse schemas(List<EnumalarmBackendSchemaUrn> schemas) {
  ...
  public AlarmBackendResponse addSchemasItem(EnumalarmBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumalarmBackendSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumalarmBackendSchemaUrn> schemas) {
  ...
  public AlarmBackendResponse id(String id) {
  ...
  **/
  ...
  public AlarmBackendResponse backendID(String backendID) {
  ...
  **/
  ...
  public AlarmBackendResponse baseDN(List<String> baseDN) {
  ...
  public AlarmBackendResponse addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public AlarmBackendResponse ldifFile(String ldifFile) {
  ...
  **/
  ...
  public AlarmBackendResponse alarmRetentionTime(String alarmRetentionTime) {
   ...
   * @return alarmRetentionTime
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the maximum length of time that information about raised alarms should be maintained before they will be purged.")

  public String getAlarmRetentionTime() {
    return alarmRetentionTime;
  }


  public void setAlarmRetentionTime(String alarmRetentionTime) {
  ...
  public AlarmBackendResponse maxAlarms(Integer maxAlarms) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the maximum number of alarms that should be retained. If more alarms than this configured maximum are generated within the alarm retention time, then the oldest alarms will be purged to achieve this maximum. Only alarms at normal severity will be purged.")
  ...
  public AlarmBackendResponse writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public AlarmBackendResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public AlarmBackendResponse setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public AlarmBackendResponse returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public AlarmBackendResponse backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public AlarmBackendResponse notificationManager(String notificationManager) {
  ...
  **/
  ...
  public AlarmBackendResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AlarmBackendResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AlarmBackendResponse instance itself
   */
  public AlarmBackendResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AlarmBackendResponse alarmBackendResponse = (AlarmBackendResponse) o;
    return Objects.equals(this.description, alarmBackendResponse.description) &&
        Objects.equals(this.schemas, alarmBackendResponse.schemas) &&
        Objects.equals(this.id, alarmBackendResponse.id) &&
        Objects.equals(this.backendID, alarmBackendResponse.backendID) &&
        Objects.equals(this.baseDN, alarmBackendResponse.baseDN) &&
        Objects.equals(this.ldifFile, alarmBackendResponse.ldifFile) &&
        Objects.equals(this.alarmRetentionTime, alarmBackendResponse.alarmRetentionTime) &&
        Objects.equals(this.maxAlarms, alarmBackendResponse.maxAlarms) &&
        Objects.equals(this.writabilityMode, alarmBackendResponse.writabilityMode) &&
        Objects.equals(this.enabled, alarmBackendResponse.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, alarmBackendResponse.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, alarmBackendResponse.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, alarmBackendResponse.backupFilePermissions) &&
        Objects.equals(this.notificationManager, alarmBackendResponse.notificationManager) &&
        Objects.equals(this.meta, alarmBackendResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, alarmBackendResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, alarmBackendResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, backendID, baseDN, ldifFile, alarmRetentionTime, maxAlarms, writabilityMode, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlarmBackendResponse {\n");
    ...
    sb.append("    alarmRetentionTime: ").append(toIndentedString(alarmRetentionTime)).append("\n");
  ...
  static {
    ...
    openapiFields.add("alarmRetentionTime");
    openapiFields.add("maxAlarms");
    ...
    openapiRequiredFields.add("alarmRetentionTime");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlarmBackendResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlarmBackendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlarmBackendResponse is not found in the empty JSON string", AlarmBackendResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AlarmBackendResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("alarmRetentionTime").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `alarmRetentionTime` to be a primitive type in the JSON string but got `%s`", jsonObj.get("alarmRetentionTime").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlarmBackendResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlarmBackendResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlarmBackendResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlarmBackendResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AlarmBackendResponse>() {
           @Override
           public void write(JsonWriter out, AlarmBackendResponse value) throws IOException {
           ...
           @Override
           public AlarmBackendResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AlarmBackendResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AlarmBackendResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlarmBackendResponse
  * @throws IOException if the JSON string is invalid with respect to AlarmBackendResponse
  */
  public static AlarmBackendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlarmBackendResponse.class);
  }

 /**
  * Convert an instance of AlarmBackendResponse to an JSON string
  *
  * @return JSON string
  */
