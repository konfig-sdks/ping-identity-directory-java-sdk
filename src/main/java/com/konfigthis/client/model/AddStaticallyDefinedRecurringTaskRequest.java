...
public class AddStaticallyDefinedRecurringTaskRequest {
  ...
  public AddStaticallyDefinedRecurringTaskRequest() {
  }

  public AddStaticallyDefinedRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest schemas(List<EnumstaticallyDefinedRecurringTaskSchemaUrn> schemas) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addSchemasItem(EnumstaticallyDefinedRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest taskJavaClass(String taskJavaClass) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest taskObjectClass(List<String> taskObjectClass) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addTaskObjectClassItem(String taskObjectClassItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest taskAttributeValue(List<String> taskAttributeValue) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addTaskAttributeValueItem(String taskAttributeValueItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddStaticallyDefinedRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddStaticallyDefinedRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddStaticallyDefinedRecurringTaskRequest instance itself
   */
  public AddStaticallyDefinedRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddStaticallyDefinedRecurringTaskRequest addStaticallyDefinedRecurringTaskRequest = (AddStaticallyDefinedRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addStaticallyDefinedRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addStaticallyDefinedRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addStaticallyDefinedRecurringTaskRequest.schemas) &&
        Objects.equals(this.taskJavaClass, addStaticallyDefinedRecurringTaskRequest.taskJavaClass) &&
        Objects.equals(this.taskObjectClass, addStaticallyDefinedRecurringTaskRequest.taskObjectClass) &&
        Objects.equals(this.taskAttributeValue, addStaticallyDefinedRecurringTaskRequest.taskAttributeValue) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addStaticallyDefinedRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addStaticallyDefinedRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addStaticallyDefinedRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addStaticallyDefinedRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addStaticallyDefinedRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addStaticallyDefinedRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addStaticallyDefinedRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addStaticallyDefinedRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, taskJavaClass, taskObjectClass, taskAttributeValue, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddStaticallyDefinedRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddStaticallyDefinedRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddStaticallyDefinedRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddStaticallyDefinedRecurringTaskRequest is not found in the empty JSON string", AddStaticallyDefinedRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddStaticallyDefinedRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddStaticallyDefinedRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddStaticallyDefinedRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddStaticallyDefinedRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddStaticallyDefinedRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddStaticallyDefinedRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddStaticallyDefinedRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddStaticallyDefinedRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddStaticallyDefinedRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddStaticallyDefinedRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddStaticallyDefinedRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddStaticallyDefinedRecurringTaskRequest
  */
  public static AddStaticallyDefinedRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddStaticallyDefinedRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddStaticallyDefinedRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
