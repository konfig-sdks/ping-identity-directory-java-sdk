...
import com.konfigthis.client.model.EnumexternalServerSyncServerAuthenticationMethodProp;
import com.konfigthis.client.model.EnumexternalServerSyncServerConnectionSecurityProp;
import com.konfigthis.client.model.EnumexternalServerVerifyCredentialsMethodProp;
import com.konfigthis.client.model.EnumsyncServerExternalServerSchemaUrn;
...
public class SyncServerExternalServerResponse {
  ...
  private List<EnumsyncServerExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_SYNC_SERVER_PRIORITY_INDEX = "syncServerPriorityIndex";
  @SerializedName(SERIALIZED_NAME_SYNC_SERVER_PRIORITY_INDEX)
  private Integer syncServerPriorityIndex;
  ...
  private EnumexternalServerSyncServerConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerSyncServerAuthenticationMethodProp authenticationMethod;
  ...
  public SyncServerExternalServerResponse() {
  }

  public SyncServerExternalServerResponse description(String description) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse schemas(List<EnumsyncServerExternalServerSchemaUrn> schemas) {
  ...
  public SyncServerExternalServerResponse addSchemasItem(EnumsyncServerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyncServerExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyncServerExternalServerSchemaUrn> schemas) {
  ...
  public SyncServerExternalServerResponse id(String id) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse syncServerPriorityIndex(Integer syncServerPriorityIndex) {
   ...
   * @return syncServerPriorityIndex
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The relative failover priority of this server. Lower numbers have a higher priority.")

  public Integer getSyncServerPriorityIndex() {
    return syncServerPriorityIndex;
  }


  public void setSyncServerPriorityIndex(Integer syncServerPriorityIndex) {
  ...
  public SyncServerExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse location(String location) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse password(String password) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse connectionSecurity(EnumexternalServerSyncServerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerSyncServerConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerSyncServerConnectionSecurityProp connectionSecurity) {
  ...
  public SyncServerExternalServerResponse authenticationMethod(EnumexternalServerSyncServerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerSyncServerAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerSyncServerAuthenticationMethodProp authenticationMethod) {
  ...
  public SyncServerExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public SyncServerExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyncServerExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyncServerExternalServerResponse instance itself
   */
  public SyncServerExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncServerExternalServerResponse syncServerExternalServerResponse = (SyncServerExternalServerResponse) o;
    return Objects.equals(this.description, syncServerExternalServerResponse.description) &&
        Objects.equals(this.schemas, syncServerExternalServerResponse.schemas) &&
        Objects.equals(this.id, syncServerExternalServerResponse.id) &&
        Objects.equals(this.verifyCredentialsMethod, syncServerExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.syncServerPriorityIndex, syncServerExternalServerResponse.syncServerPriorityIndex) &&
        Objects.equals(this.serverHostName, syncServerExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, syncServerExternalServerResponse.serverPort) &&
        Objects.equals(this.location, syncServerExternalServerResponse.location) &&
        Objects.equals(this.bindDN, syncServerExternalServerResponse.bindDN) &&
        Objects.equals(this.password, syncServerExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, syncServerExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, syncServerExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, syncServerExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, syncServerExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, syncServerExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, syncServerExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, syncServerExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, syncServerExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, syncServerExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, syncServerExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, syncServerExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, syncServerExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, syncServerExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, syncServerExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, syncServerExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syncServerExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syncServerExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, verifyCredentialsMethod, syncServerPriorityIndex, serverHostName, serverPort, location, bindDN, password, passphraseProvider, connectionSecurity, authenticationMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyncServerExternalServerResponse {\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    schemas: ").append(toIndentedString(schemas)).append("\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    verifyCredentialsMethod: ").append(toIndentedString(verifyCredentialsMethod)).append("\n");
    sb.append("    syncServerPriorityIndex: ").append(toIndentedString(syncServerPriorityIndex)).append("\n");
  ...
  static {
    ...
    openapiFields.add("syncServerPriorityIndex");
    ...
    openapiRequiredFields.add("syncServerPriorityIndex");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncServerExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncServerExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncServerExternalServerResponse is not found in the empty JSON string", SyncServerExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyncServerExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncServerExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncServerExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncServerExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncServerExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncServerExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, SyncServerExternalServerResponse value) throws IOException {
           ...
           @Override
           public SyncServerExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncServerExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncServerExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncServerExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to SyncServerExternalServerResponse
  */
  public static SyncServerExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncServerExternalServerResponse.class);
  }

 /**
  * Convert an instance of SyncServerExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
