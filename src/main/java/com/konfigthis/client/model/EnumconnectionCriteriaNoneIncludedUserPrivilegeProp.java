 ...
 */
@JsonAdapter(EnumconnectionCriteriaNoneIncludedUserPrivilegeProp.Adapter.class)public enum EnumconnectionCriteriaNoneIncludedUserPrivilegeProp {
  ...
  EnumconnectionCriteriaNoneIncludedUserPrivilegeProp(String value) {
    this.value = value;
  }
  ...
  public static EnumconnectionCriteriaNoneIncludedUserPrivilegeProp fromValue(String value) {
    for (EnumconnectionCriteriaNoneIncludedUserPrivilegeProp b : EnumconnectionCriteriaNoneIncludedUserPrivilegeProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumconnectionCriteriaNoneIncludedUserPrivilegeProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumconnectionCriteriaNoneIncludedUserPrivilegeProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumconnectionCriteriaNoneIncludedUserPrivilegeProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumconnectionCriteriaNoneIncludedUserPrivilegeProp.fromValue(value);
    }
  }
}
