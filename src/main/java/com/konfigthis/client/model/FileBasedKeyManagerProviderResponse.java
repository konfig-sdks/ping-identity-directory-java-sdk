...
public class FileBasedKeyManagerProviderResponse {
  ...
  public FileBasedKeyManagerProviderResponse() {
  }

  public FileBasedKeyManagerProviderResponse id(String id) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse description(String description) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse schemas(List<EnumfileBasedKeyManagerProviderSchemaUrn> schemas) {
  ...
  public FileBasedKeyManagerProviderResponse addSchemasItem(EnumfileBasedKeyManagerProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse keyStoreFile(String keyStoreFile) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse keyStoreType(String keyStoreType) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse keyStorePin(String keyStorePin) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse keyStorePinFile(String keyStorePinFile) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse keyStorePinPassphraseProvider(String keyStorePinPassphraseProvider) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse privateKeyPin(String privateKeyPin) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse privateKeyPinFile(String privateKeyPinFile) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse privateKeyPinPassphraseProvider(String privateKeyPinPassphraseProvider) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedKeyManagerProviderResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedKeyManagerProviderResponse instance itself
   */
  public FileBasedKeyManagerProviderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedKeyManagerProviderResponse fileBasedKeyManagerProviderResponse = (FileBasedKeyManagerProviderResponse) o;
    return Objects.equals(this.id, fileBasedKeyManagerProviderResponse.id) &&
        Objects.equals(this.description, fileBasedKeyManagerProviderResponse.description) &&
        Objects.equals(this.schemas, fileBasedKeyManagerProviderResponse.schemas) &&
        Objects.equals(this.keyStoreFile, fileBasedKeyManagerProviderResponse.keyStoreFile) &&
        Objects.equals(this.keyStoreType, fileBasedKeyManagerProviderResponse.keyStoreType) &&
        Objects.equals(this.keyStorePin, fileBasedKeyManagerProviderResponse.keyStorePin) &&
        Objects.equals(this.keyStorePinFile, fileBasedKeyManagerProviderResponse.keyStorePinFile) &&
        Objects.equals(this.keyStorePinPassphraseProvider, fileBasedKeyManagerProviderResponse.keyStorePinPassphraseProvider) &&
        Objects.equals(this.privateKeyPin, fileBasedKeyManagerProviderResponse.privateKeyPin) &&
        Objects.equals(this.privateKeyPinFile, fileBasedKeyManagerProviderResponse.privateKeyPinFile) &&
        Objects.equals(this.privateKeyPinPassphraseProvider, fileBasedKeyManagerProviderResponse.privateKeyPinPassphraseProvider) &&
        Objects.equals(this.enabled, fileBasedKeyManagerProviderResponse.enabled) &&
        Objects.equals(this.meta, fileBasedKeyManagerProviderResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedKeyManagerProviderResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedKeyManagerProviderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, keyStoreFile, keyStoreType, keyStorePin, keyStorePinFile, keyStorePinPassphraseProvider, privateKeyPin, privateKeyPinFile, privateKeyPinPassphraseProvider, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedKeyManagerProviderResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedKeyManagerProviderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedKeyManagerProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedKeyManagerProviderResponse is not found in the empty JSON string", FileBasedKeyManagerProviderResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedKeyManagerProviderResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedKeyManagerProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedKeyManagerProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedKeyManagerProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedKeyManagerProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedKeyManagerProviderResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedKeyManagerProviderResponse value) throws IOException {
           ...
           @Override
           public FileBasedKeyManagerProviderResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedKeyManagerProviderResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedKeyManagerProviderResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedKeyManagerProviderResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedKeyManagerProviderResponse
  */
  public static FileBasedKeyManagerProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedKeyManagerProviderResponse.class);
  }

 /**
  * Convert an instance of FileBasedKeyManagerProviderResponse to an JSON string
  *
  * @return JSON string
  */
