...
import com.konfigthis.client.model.EnumnumSubordinatesVirtualAttributeSchemaUrn;
...
public class NumSubordinatesVirtualAttributeResponse {
  ...
  private List<EnumnumSubordinatesVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public NumSubordinatesVirtualAttributeResponse() {
  }

  public NumSubordinatesVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse schemas(List<EnumnumSubordinatesVirtualAttributeSchemaUrn> schemas) {
  ...
  public NumSubordinatesVirtualAttributeResponse addSchemasItem(EnumnumSubordinatesVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumnumSubordinatesVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumnumSubordinatesVirtualAttributeSchemaUrn> schemas) {
  ...
  public NumSubordinatesVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public NumSubordinatesVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public NumSubordinatesVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse filter(List<String> filter) {
  ...
  public NumSubordinatesVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public NumSubordinatesVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the NumSubordinatesVirtualAttributeResponse instance itself
   */
  public NumSubordinatesVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NumSubordinatesVirtualAttributeResponse numSubordinatesVirtualAttributeResponse = (NumSubordinatesVirtualAttributeResponse) o;
    return Objects.equals(this.description, numSubordinatesVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, numSubordinatesVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, numSubordinatesVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, numSubordinatesVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, numSubordinatesVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, numSubordinatesVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, numSubordinatesVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, numSubordinatesVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, numSubordinatesVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, numSubordinatesVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, numSubordinatesVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, numSubordinatesVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, numSubordinatesVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, numSubordinatesVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, numSubordinatesVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, numSubordinatesVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, numSubordinatesVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NumSubordinatesVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NumSubordinatesVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NumSubordinatesVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NumSubordinatesVirtualAttributeResponse is not found in the empty JSON string", NumSubordinatesVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NumSubordinatesVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NumSubordinatesVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NumSubordinatesVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NumSubordinatesVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NumSubordinatesVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NumSubordinatesVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, NumSubordinatesVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public NumSubordinatesVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NumSubordinatesVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NumSubordinatesVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NumSubordinatesVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to NumSubordinatesVirtualAttributeResponse
  */
  public static NumSubordinatesVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NumSubordinatesVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of NumSubordinatesVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
