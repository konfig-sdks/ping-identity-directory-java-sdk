...
public class AddThirdPartyAccessLogPublisherRequest {
  ...
  public AddThirdPartyAccessLogPublisherRequest() {
  }

  public AddThirdPartyAccessLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest schemas(List<EnumthirdPartyAccessLogPublisherSchemaUrn> schemas) {
  ...
  public AddThirdPartyAccessLogPublisherRequest addSchemasItem(EnumthirdPartyAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyAccessLogPublisherRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logResults(Boolean logResults) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyAccessLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddThirdPartyAccessLogPublisherRequest instance itself
   */
  public AddThirdPartyAccessLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyAccessLogPublisherRequest addThirdPartyAccessLogPublisherRequest = (AddThirdPartyAccessLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addThirdPartyAccessLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addThirdPartyAccessLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyAccessLogPublisherRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyAccessLogPublisherRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyAccessLogPublisherRequest.extensionArgument) &&
        Objects.equals(this.logConnects, addThirdPartyAccessLogPublisherRequest.logConnects) &&
        Objects.equals(this.logDisconnects, addThirdPartyAccessLogPublisherRequest.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, addThirdPartyAccessLogPublisherRequest.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, addThirdPartyAccessLogPublisherRequest.logClientCertificates) &&
        Objects.equals(this.logRequests, addThirdPartyAccessLogPublisherRequest.logRequests) &&
        Objects.equals(this.logResults, addThirdPartyAccessLogPublisherRequest.logResults) &&
        Objects.equals(this.logSearchEntries, addThirdPartyAccessLogPublisherRequest.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, addThirdPartyAccessLogPublisherRequest.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, addThirdPartyAccessLogPublisherRequest.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, addThirdPartyAccessLogPublisherRequest.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, addThirdPartyAccessLogPublisherRequest.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, addThirdPartyAccessLogPublisherRequest.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, addThirdPartyAccessLogPublisherRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addThirdPartyAccessLogPublisherRequest.requestCriteria) &&
        Objects.equals(this.resultCriteria, addThirdPartyAccessLogPublisherRequest.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, addThirdPartyAccessLogPublisherRequest.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, addThirdPartyAccessLogPublisherRequest.searchReferenceCriteria) &&
        Objects.equals(this.enabled, addThirdPartyAccessLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addThirdPartyAccessLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addThirdPartyAccessLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, extensionClass, extensionArgument, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyAccessLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyAccessLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyAccessLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyAccessLogPublisherRequest is not found in the empty JSON string", AddThirdPartyAccessLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyAccessLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyAccessLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyAccessLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyAccessLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyAccessLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyAccessLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyAccessLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyAccessLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyAccessLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyAccessLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyAccessLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyAccessLogPublisherRequest
  */
  public static AddThirdPartyAccessLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyAccessLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyAccessLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
