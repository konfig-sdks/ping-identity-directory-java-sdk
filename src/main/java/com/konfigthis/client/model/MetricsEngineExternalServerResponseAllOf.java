...
public class MetricsEngineExternalServerResponseAllOf {
  ...
  private List<EnummetricsEngineExternalServerSchemaUrn> schemas = null;
  ...
  public MetricsEngineExternalServerResponseAllOf() {
  }

  public MetricsEngineExternalServerResponseAllOf description(String description) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf schemas(List<EnummetricsEngineExternalServerSchemaUrn> schemas) {
  ...
  public MetricsEngineExternalServerResponseAllOf addSchemasItem(EnummetricsEngineExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf id(String id) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf serverHostName(String serverHostName) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf serverPort(Integer serverPort) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf location(String location) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf bindDN(String bindDN) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf password(String password) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf connectionSecurity(EnumexternalServerMetricsEngineConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf authenticationMethod(EnumexternalServerMetricsEngineAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public MetricsEngineExternalServerResponseAllOf addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public MetricsEngineExternalServerResponseAllOf abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the MetricsEngineExternalServerResponseAllOf instance itself
   */
  public MetricsEngineExternalServerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MetricsEngineExternalServerResponseAllOf metricsEngineExternalServerResponseAllOf = (MetricsEngineExternalServerResponseAllOf) o;
    return Objects.equals(this.description, metricsEngineExternalServerResponseAllOf.description) &&
        Objects.equals(this.schemas, metricsEngineExternalServerResponseAllOf.schemas) &&
        Objects.equals(this.id, metricsEngineExternalServerResponseAllOf.id) &&
        Objects.equals(this.verifyCredentialsMethod, metricsEngineExternalServerResponseAllOf.verifyCredentialsMethod) &&
        Objects.equals(this.serverHostName, metricsEngineExternalServerResponseAllOf.serverHostName) &&
        Objects.equals(this.serverPort, metricsEngineExternalServerResponseAllOf.serverPort) &&
        Objects.equals(this.location, metricsEngineExternalServerResponseAllOf.location) &&
        Objects.equals(this.bindDN, metricsEngineExternalServerResponseAllOf.bindDN) &&
        Objects.equals(this.password, metricsEngineExternalServerResponseAllOf.password) &&
        Objects.equals(this.passphraseProvider, metricsEngineExternalServerResponseAllOf.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, metricsEngineExternalServerResponseAllOf.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, metricsEngineExternalServerResponseAllOf.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, metricsEngineExternalServerResponseAllOf.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, metricsEngineExternalServerResponseAllOf.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, metricsEngineExternalServerResponseAllOf.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, metricsEngineExternalServerResponseAllOf.connectTimeout) &&
        Objects.equals(this.maxResponseSize, metricsEngineExternalServerResponseAllOf.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, metricsEngineExternalServerResponseAllOf.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, metricsEngineExternalServerResponseAllOf.trustManagerProvider) &&
        Objects.equals(this.initialConnections, metricsEngineExternalServerResponseAllOf.initialConnections) &&
        Objects.equals(this.maxConnections, metricsEngineExternalServerResponseAllOf.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, metricsEngineExternalServerResponseAllOf.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, metricsEngineExternalServerResponseAllOf.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, metricsEngineExternalServerResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetricsEngineExternalServerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetricsEngineExternalServerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetricsEngineExternalServerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MetricsEngineExternalServerResponseAllOf is not found in the empty JSON string", MetricsEngineExternalServerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetricsEngineExternalServerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetricsEngineExternalServerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetricsEngineExternalServerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetricsEngineExternalServerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MetricsEngineExternalServerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, MetricsEngineExternalServerResponseAllOf value) throws IOException {
           ...
           @Override
           public MetricsEngineExternalServerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MetricsEngineExternalServerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MetricsEngineExternalServerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MetricsEngineExternalServerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to MetricsEngineExternalServerResponseAllOf
  */
  public static MetricsEngineExternalServerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MetricsEngineExternalServerResponseAllOf.class);
  }

 /**
  * Convert an instance of MetricsEngineExternalServerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
