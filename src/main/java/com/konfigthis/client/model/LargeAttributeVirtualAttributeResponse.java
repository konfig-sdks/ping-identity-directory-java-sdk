...
import com.konfigthis.client.model.EnumlargeAttributeVirtualAttributeSchemaUrn;
...
public class LargeAttributeVirtualAttributeResponse {
  ...
  private List<EnumlargeAttributeVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public LargeAttributeVirtualAttributeResponse() {
  }

  public LargeAttributeVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse schemas(List<EnumlargeAttributeVirtualAttributeSchemaUrn> schemas) {
  ...
  public LargeAttributeVirtualAttributeResponse addSchemasItem(EnumlargeAttributeVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumlargeAttributeVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumlargeAttributeVirtualAttributeSchemaUrn> schemas) {
  ...
  public LargeAttributeVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse filter(List<String> filter) {
  ...
  public LargeAttributeVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public LargeAttributeVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public LargeAttributeVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public LargeAttributeVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LargeAttributeVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LargeAttributeVirtualAttributeResponse instance itself
   */
  public LargeAttributeVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LargeAttributeVirtualAttributeResponse largeAttributeVirtualAttributeResponse = (LargeAttributeVirtualAttributeResponse) o;
    return Objects.equals(this.description, largeAttributeVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, largeAttributeVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, largeAttributeVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, largeAttributeVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.filter, largeAttributeVirtualAttributeResponse.filter) &&
        Objects.equals(this.enabled, largeAttributeVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, largeAttributeVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, largeAttributeVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, largeAttributeVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, largeAttributeVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, largeAttributeVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, largeAttributeVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, largeAttributeVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, largeAttributeVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, largeAttributeVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, largeAttributeVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, largeAttributeVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, filter, enabled, attributeType, baseDN, groupDN, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LargeAttributeVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LargeAttributeVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LargeAttributeVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LargeAttributeVirtualAttributeResponse is not found in the empty JSON string", LargeAttributeVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LargeAttributeVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LargeAttributeVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LargeAttributeVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LargeAttributeVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LargeAttributeVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LargeAttributeVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, LargeAttributeVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public LargeAttributeVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LargeAttributeVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LargeAttributeVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LargeAttributeVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to LargeAttributeVirtualAttributeResponse
  */
  public static LargeAttributeVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LargeAttributeVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of LargeAttributeVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
