...
public class OpenidConnectIdTokenValidatorShared {
  ...
  public OpenidConnectIdTokenValidatorShared() {
  }

  public OpenidConnectIdTokenValidatorShared description(String description) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared schemas(List<EnumopenidConnectIdTokenValidatorSchemaUrn> schemas) {
  ...
  public OpenidConnectIdTokenValidatorShared addSchemasItem(EnumopenidConnectIdTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared allowedSigningAlgorithm(List<EnumidTokenValidatorAllowedSigningAlgorithmProp> allowedSigningAlgorithm) {
  ...
  public OpenidConnectIdTokenValidatorShared addAllowedSigningAlgorithmItem(EnumidTokenValidatorAllowedSigningAlgorithmProp allowedSigningAlgorithmItem) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared signingCertificate(List<String> signingCertificate) {
  ...
  public OpenidConnectIdTokenValidatorShared addSigningCertificateItem(String signingCertificateItem) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared openIDConnectProvider(String openIDConnectProvider) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared jwksEndpointPath(String jwksEndpointPath) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared identityMapper(String identityMapper) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared issuerURL(String issuerURL) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared jwksCacheDuration(String jwksCacheDuration) {
  ...
  **/
  ...
  public OpenidConnectIdTokenValidatorShared evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
   ...
   * @return the OpenidConnectIdTokenValidatorShared instance itself
   */
  public OpenidConnectIdTokenValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpenidConnectIdTokenValidatorShared openidConnectIdTokenValidatorShared = (OpenidConnectIdTokenValidatorShared) o;
    return Objects.equals(this.description, openidConnectIdTokenValidatorShared.description) &&
        Objects.equals(this.schemas, openidConnectIdTokenValidatorShared.schemas) &&
        Objects.equals(this.allowedSigningAlgorithm, openidConnectIdTokenValidatorShared.allowedSigningAlgorithm) &&
        Objects.equals(this.signingCertificate, openidConnectIdTokenValidatorShared.signingCertificate) &&
        Objects.equals(this.openIDConnectProvider, openidConnectIdTokenValidatorShared.openIDConnectProvider) &&
        Objects.equals(this.jwksEndpointPath, openidConnectIdTokenValidatorShared.jwksEndpointPath) &&
        Objects.equals(this.enabled, openidConnectIdTokenValidatorShared.enabled) &&
        Objects.equals(this.identityMapper, openidConnectIdTokenValidatorShared.identityMapper) &&
        Objects.equals(this.subjectClaimName, openidConnectIdTokenValidatorShared.subjectClaimName) &&
        Objects.equals(this.issuerURL, openidConnectIdTokenValidatorShared.issuerURL) &&
        Objects.equals(this.clockSkewGracePeriod, openidConnectIdTokenValidatorShared.clockSkewGracePeriod) &&
        Objects.equals(this.jwksCacheDuration, openidConnectIdTokenValidatorShared.jwksCacheDuration) &&
        Objects.equals(this.evaluationOrderIndex, openidConnectIdTokenValidatorShared.evaluationOrderIndex)&&
        Objects.equals(this.additionalProperties, openidConnectIdTokenValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, allowedSigningAlgorithm, signingCertificate, openIDConnectProvider, jwksEndpointPath, enabled, identityMapper, subjectClaimName, issuerURL, clockSkewGracePeriod, jwksCacheDuration, evaluationOrderIndex, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OpenidConnectIdTokenValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpenidConnectIdTokenValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpenidConnectIdTokenValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpenidConnectIdTokenValidatorShared is not found in the empty JSON string", OpenidConnectIdTokenValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpenidConnectIdTokenValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpenidConnectIdTokenValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpenidConnectIdTokenValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpenidConnectIdTokenValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpenidConnectIdTokenValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<OpenidConnectIdTokenValidatorShared>() {
           @Override
           public void write(JsonWriter out, OpenidConnectIdTokenValidatorShared value) throws IOException {
           ...
           @Override
           public OpenidConnectIdTokenValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OpenidConnectIdTokenValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OpenidConnectIdTokenValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OpenidConnectIdTokenValidatorShared
  * @throws IOException if the JSON string is invalid with respect to OpenidConnectIdTokenValidatorShared
  */
  public static OpenidConnectIdTokenValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpenidConnectIdTokenValidatorShared.class);
  }

 /**
  * Convert an instance of OpenidConnectIdTokenValidatorShared to an JSON string
  *
  * @return JSON string
  */
