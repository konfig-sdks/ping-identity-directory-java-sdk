...
public class AddGroovyScriptedAlertHandlerRequest {
  ...
  public AddGroovyScriptedAlertHandlerRequest() {
  }

  public AddGroovyScriptedAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest schemas(List<EnumgroovyScriptedAlertHandlerSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedAlertHandlerRequest addSchemasItem(EnumgroovyScriptedAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedAlertHandlerRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddGroovyScriptedAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddGroovyScriptedAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddGroovyScriptedAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedAlertHandlerRequest instance itself
   */
  public AddGroovyScriptedAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedAlertHandlerRequest addGroovyScriptedAlertHandlerRequest = (AddGroovyScriptedAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addGroovyScriptedAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addGroovyScriptedAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedAlertHandlerRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedAlertHandlerRequest.scriptClass) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedAlertHandlerRequest.scriptArgument) &&
        Objects.equals(this.enabled, addGroovyScriptedAlertHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addGroovyScriptedAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, addGroovyScriptedAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addGroovyScriptedAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addGroovyScriptedAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedAlertHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, scriptClass, scriptArgument, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedAlertHandlerRequest is not found in the empty JSON string", AddGroovyScriptedAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedAlertHandlerRequest
  */
  public static AddGroovyScriptedAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
