...
public class EntryChecksumVirtualAttributeResponseAllOf {
  ...
  private List<EnumentryChecksumVirtualAttributeSchemaUrn> schemas = null;
  ...
  public EntryChecksumVirtualAttributeResponseAllOf() {
  }

  public EntryChecksumVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf schemas(List<EnumentryChecksumVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addSchemasItem(EnumentryChecksumVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf excludeOperationalAttributes(Boolean excludeOperationalAttributes) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf excludedAttribute(List<String> excludedAttribute) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addExcludedAttributeItem(String excludedAttributeItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EntryChecksumVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the EntryChecksumVirtualAttributeResponseAllOf instance itself
   */
  public EntryChecksumVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntryChecksumVirtualAttributeResponseAllOf entryChecksumVirtualAttributeResponseAllOf = (EntryChecksumVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, entryChecksumVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, entryChecksumVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, entryChecksumVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, entryChecksumVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, entryChecksumVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.excludeOperationalAttributes, entryChecksumVirtualAttributeResponseAllOf.excludeOperationalAttributes) &&
        Objects.equals(this.excludedAttribute, entryChecksumVirtualAttributeResponseAllOf.excludedAttribute) &&
        Objects.equals(this.enabled, entryChecksumVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, entryChecksumVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, entryChecksumVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, entryChecksumVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, entryChecksumVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, entryChecksumVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, entryChecksumVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, entryChecksumVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, entryChecksumVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, entryChecksumVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntryChecksumVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EntryChecksumVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntryChecksumVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryChecksumVirtualAttributeResponseAllOf is not found in the empty JSON string", EntryChecksumVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntryChecksumVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntryChecksumVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntryChecksumVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntryChecksumVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<EntryChecksumVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, EntryChecksumVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public EntryChecksumVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EntryChecksumVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EntryChecksumVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EntryChecksumVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to EntryChecksumVirtualAttributeResponseAllOf
  */
  public static EntryChecksumVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntryChecksumVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of EntryChecksumVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
