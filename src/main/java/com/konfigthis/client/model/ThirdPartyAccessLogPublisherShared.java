...
public class ThirdPartyAccessLogPublisherShared {
  ...
  public ThirdPartyAccessLogPublisherShared() {
  }

  public ThirdPartyAccessLogPublisherShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared schemas(List<EnumthirdPartyAccessLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyAccessLogPublisherShared addSchemasItem(EnumthirdPartyAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyAccessLogPublisherShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logResults(Boolean logResults) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the ThirdPartyAccessLogPublisherShared instance itself
   */
  public ThirdPartyAccessLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyAccessLogPublisherShared thirdPartyAccessLogPublisherShared = (ThirdPartyAccessLogPublisherShared) o;
    return Objects.equals(this.description, thirdPartyAccessLogPublisherShared.description) &&
        Objects.equals(this.schemas, thirdPartyAccessLogPublisherShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyAccessLogPublisherShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyAccessLogPublisherShared.extensionArgument) &&
        Objects.equals(this.logConnects, thirdPartyAccessLogPublisherShared.logConnects) &&
        Objects.equals(this.logDisconnects, thirdPartyAccessLogPublisherShared.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, thirdPartyAccessLogPublisherShared.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, thirdPartyAccessLogPublisherShared.logClientCertificates) &&
        Objects.equals(this.logRequests, thirdPartyAccessLogPublisherShared.logRequests) &&
        Objects.equals(this.logResults, thirdPartyAccessLogPublisherShared.logResults) &&
        Objects.equals(this.logSearchEntries, thirdPartyAccessLogPublisherShared.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, thirdPartyAccessLogPublisherShared.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, thirdPartyAccessLogPublisherShared.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, thirdPartyAccessLogPublisherShared.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, thirdPartyAccessLogPublisherShared.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, thirdPartyAccessLogPublisherShared.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, thirdPartyAccessLogPublisherShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, thirdPartyAccessLogPublisherShared.requestCriteria) &&
        Objects.equals(this.resultCriteria, thirdPartyAccessLogPublisherShared.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, thirdPartyAccessLogPublisherShared.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, thirdPartyAccessLogPublisherShared.searchReferenceCriteria) &&
        Objects.equals(this.enabled, thirdPartyAccessLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, thirdPartyAccessLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, thirdPartyAccessLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyAccessLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyAccessLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyAccessLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyAccessLogPublisherShared is not found in the empty JSON string", ThirdPartyAccessLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyAccessLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyAccessLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyAccessLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyAccessLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyAccessLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyAccessLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyAccessLogPublisherShared value) throws IOException {
           ...
           @Override
           public ThirdPartyAccessLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyAccessLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyAccessLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyAccessLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyAccessLogPublisherShared
  */
  public static ThirdPartyAccessLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyAccessLogPublisherShared.class);
  }

 /**
  * Convert an instance of ThirdPartyAccessLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
