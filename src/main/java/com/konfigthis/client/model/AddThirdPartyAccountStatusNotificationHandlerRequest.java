...
public class AddThirdPartyAccountStatusNotificationHandlerRequest {
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest() {
  }

  public AddThirdPartyAccountStatusNotificationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest schemas(List<EnumthirdPartyAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest addSchemasItem(EnumthirdPartyAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddThirdPartyAccountStatusNotificationHandlerRequest accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the AddThirdPartyAccountStatusNotificationHandlerRequest instance itself
   */
  public AddThirdPartyAccountStatusNotificationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyAccountStatusNotificationHandlerRequest addThirdPartyAccountStatusNotificationHandlerRequest = (AddThirdPartyAccountStatusNotificationHandlerRequest) o;
    return Objects.equals(this.handlerName, addThirdPartyAccountStatusNotificationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addThirdPartyAccountStatusNotificationHandlerRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyAccountStatusNotificationHandlerRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyAccountStatusNotificationHandlerRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyAccountStatusNotificationHandlerRequest.extensionArgument) &&
        Objects.equals(this.enabled, addThirdPartyAccountStatusNotificationHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addThirdPartyAccountStatusNotificationHandlerRequest.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, addThirdPartyAccountStatusNotificationHandlerRequest.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, addThirdPartyAccountStatusNotificationHandlerRequest.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, addThirdPartyAccountStatusNotificationHandlerRequest.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, addThirdPartyAccountStatusNotificationHandlerRequest.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, addThirdPartyAccountStatusNotificationHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, extensionClass, extensionArgument, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyAccountStatusNotificationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyAccountStatusNotificationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyAccountStatusNotificationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyAccountStatusNotificationHandlerRequest is not found in the empty JSON string", AddThirdPartyAccountStatusNotificationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyAccountStatusNotificationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyAccountStatusNotificationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyAccountStatusNotificationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyAccountStatusNotificationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyAccountStatusNotificationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyAccountStatusNotificationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyAccountStatusNotificationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyAccountStatusNotificationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyAccountStatusNotificationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyAccountStatusNotificationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyAccountStatusNotificationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyAccountStatusNotificationHandlerRequest
  */
  public static AddThirdPartyAccountStatusNotificationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyAccountStatusNotificationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyAccountStatusNotificationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
