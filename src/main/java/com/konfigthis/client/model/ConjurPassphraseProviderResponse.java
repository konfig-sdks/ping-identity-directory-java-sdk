...
public class ConjurPassphraseProviderResponse {
  ...
  public ConjurPassphraseProviderResponse() {
  }

  public ConjurPassphraseProviderResponse id(String id) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse description(String description) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse schemas(List<EnumconjurPassphraseProviderSchemaUrn> schemas) {
  ...
  public ConjurPassphraseProviderResponse addSchemasItem(EnumconjurPassphraseProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse conjurExternalServer(String conjurExternalServer) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse conjurSecretRelativePath(String conjurSecretRelativePath) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse maxCacheDuration(String maxCacheDuration) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConjurPassphraseProviderResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConjurPassphraseProviderResponse instance itself
   */
  public ConjurPassphraseProviderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConjurPassphraseProviderResponse conjurPassphraseProviderResponse = (ConjurPassphraseProviderResponse) o;
    return Objects.equals(this.id, conjurPassphraseProviderResponse.id) &&
        Objects.equals(this.description, conjurPassphraseProviderResponse.description) &&
        Objects.equals(this.schemas, conjurPassphraseProviderResponse.schemas) &&
        Objects.equals(this.conjurExternalServer, conjurPassphraseProviderResponse.conjurExternalServer) &&
        Objects.equals(this.conjurSecretRelativePath, conjurPassphraseProviderResponse.conjurSecretRelativePath) &&
        Objects.equals(this.maxCacheDuration, conjurPassphraseProviderResponse.maxCacheDuration) &&
        Objects.equals(this.enabled, conjurPassphraseProviderResponse.enabled) &&
        Objects.equals(this.meta, conjurPassphraseProviderResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, conjurPassphraseProviderResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, conjurPassphraseProviderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, conjurExternalServer, conjurSecretRelativePath, maxCacheDuration, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConjurPassphraseProviderResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConjurPassphraseProviderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConjurPassphraseProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConjurPassphraseProviderResponse is not found in the empty JSON string", ConjurPassphraseProviderResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConjurPassphraseProviderResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConjurPassphraseProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConjurPassphraseProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConjurPassphraseProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConjurPassphraseProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConjurPassphraseProviderResponse>() {
           @Override
           public void write(JsonWriter out, ConjurPassphraseProviderResponse value) throws IOException {
           ...
           @Override
           public ConjurPassphraseProviderResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConjurPassphraseProviderResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConjurPassphraseProviderResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConjurPassphraseProviderResponse
  * @throws IOException if the JSON string is invalid with respect to ConjurPassphraseProviderResponse
  */
  public static ConjurPassphraseProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConjurPassphraseProviderResponse.class);
  }

 /**
  * Convert an instance of ConjurPassphraseProviderResponse to an JSON string
  *
  * @return JSON string
  */
