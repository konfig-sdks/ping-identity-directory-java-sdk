...
public class SearchShutdownPluginShared {
  ...
  public SearchShutdownPluginShared() {
  }

  public SearchShutdownPluginShared description(String description) {
  ...
  **/
  ...
  public SearchShutdownPluginShared schemas(List<EnumsearchShutdownPluginSchemaUrn> schemas) {
  ...
  public SearchShutdownPluginShared addSchemasItem(EnumsearchShutdownPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SearchShutdownPluginShared baseDN(String baseDN) {
  ...
  **/
  ...
  public SearchShutdownPluginShared scope(EnumpluginScopeProp scope) {
  ...
  **/
  ...
  public SearchShutdownPluginShared filter(String filter) {
  ...
  **/
  ...
  public SearchShutdownPluginShared includeAttribute(List<String> includeAttribute) {
  ...
  public SearchShutdownPluginShared addIncludeAttributeItem(String includeAttributeItem) {
  ...
  **/
  ...
  public SearchShutdownPluginShared outputFile(String outputFile) {
  ...
  **/
  ...
  public SearchShutdownPluginShared previousFileExtension(String previousFileExtension) {
  ...
  **/
  ...
  public SearchShutdownPluginShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the SearchShutdownPluginShared instance itself
   */
  public SearchShutdownPluginShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SearchShutdownPluginShared searchShutdownPluginShared = (SearchShutdownPluginShared) o;
    return Objects.equals(this.description, searchShutdownPluginShared.description) &&
        Objects.equals(this.schemas, searchShutdownPluginShared.schemas) &&
        Objects.equals(this.baseDN, searchShutdownPluginShared.baseDN) &&
        Objects.equals(this.scope, searchShutdownPluginShared.scope) &&
        Objects.equals(this.filter, searchShutdownPluginShared.filter) &&
        Objects.equals(this.includeAttribute, searchShutdownPluginShared.includeAttribute) &&
        Objects.equals(this.outputFile, searchShutdownPluginShared.outputFile) &&
        Objects.equals(this.previousFileExtension, searchShutdownPluginShared.previousFileExtension) &&
        Objects.equals(this.enabled, searchShutdownPluginShared.enabled)&&
        Objects.equals(this.additionalProperties, searchShutdownPluginShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, baseDN, scope, filter, includeAttribute, outputFile, previousFileExtension, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SearchShutdownPluginShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SearchShutdownPluginShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SearchShutdownPluginShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SearchShutdownPluginShared is not found in the empty JSON string", SearchShutdownPluginShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SearchShutdownPluginShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SearchShutdownPluginShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SearchShutdownPluginShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SearchShutdownPluginShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SearchShutdownPluginShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SearchShutdownPluginShared>() {
           @Override
           public void write(JsonWriter out, SearchShutdownPluginShared value) throws IOException {
           ...
           @Override
           public SearchShutdownPluginShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SearchShutdownPluginShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SearchShutdownPluginShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SearchShutdownPluginShared
  * @throws IOException if the JSON string is invalid with respect to SearchShutdownPluginShared
  */
  public static SearchShutdownPluginShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SearchShutdownPluginShared.class);
  }

 /**
  * Convert an instance of SearchShutdownPluginShared to an JSON string
  *
  * @return JSON string
  */
