...
public class IdentifyReferencesVirtualAttributeResponse {
  ...
  public IdentifyReferencesVirtualAttributeResponse() {
  }

  public IdentifyReferencesVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse schemas(List<EnumidentifyReferencesVirtualAttributeSchemaUrn> schemas) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addSchemasItem(EnumidentifyReferencesVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse referencedByAttribute(List<String> referencedByAttribute) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addReferencedByAttributeItem(String referencedByAttributeItem) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse referenceSearchBaseDN(List<String> referenceSearchBaseDN) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addReferenceSearchBaseDNItem(String referenceSearchBaseDNItem) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse filter(List<String> filter) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public IdentifyReferencesVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public IdentifyReferencesVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the IdentifyReferencesVirtualAttributeResponse instance itself
   */
  public IdentifyReferencesVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IdentifyReferencesVirtualAttributeResponse identifyReferencesVirtualAttributeResponse = (IdentifyReferencesVirtualAttributeResponse) o;
    return Objects.equals(this.id, identifyReferencesVirtualAttributeResponse.id) &&
        Objects.equals(this.description, identifyReferencesVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, identifyReferencesVirtualAttributeResponse.schemas) &&
        Objects.equals(this.referencedByAttribute, identifyReferencesVirtualAttributeResponse.referencedByAttribute) &&
        Objects.equals(this.referenceSearchBaseDN, identifyReferencesVirtualAttributeResponse.referenceSearchBaseDN) &&
        Objects.equals(this.enabled, identifyReferencesVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, identifyReferencesVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, identifyReferencesVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, identifyReferencesVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, identifyReferencesVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, identifyReferencesVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, identifyReferencesVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, identifyReferencesVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, identifyReferencesVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, identifyReferencesVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, identifyReferencesVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, identifyReferencesVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, identifyReferencesVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, identifyReferencesVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, referencedByAttribute, referenceSearchBaseDN, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdentifyReferencesVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IdentifyReferencesVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IdentifyReferencesVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IdentifyReferencesVirtualAttributeResponse is not found in the empty JSON string", IdentifyReferencesVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IdentifyReferencesVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IdentifyReferencesVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IdentifyReferencesVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IdentifyReferencesVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IdentifyReferencesVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IdentifyReferencesVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, IdentifyReferencesVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public IdentifyReferencesVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IdentifyReferencesVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IdentifyReferencesVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IdentifyReferencesVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to IdentifyReferencesVirtualAttributeResponse
  */
  public static IdentifyReferencesVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IdentifyReferencesVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of IdentifyReferencesVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
