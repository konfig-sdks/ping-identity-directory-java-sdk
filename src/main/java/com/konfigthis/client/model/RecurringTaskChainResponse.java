...
public class RecurringTaskChainResponse {
  ...
  private List<EnumrecurringTaskChainScheduledMonthProp> scheduledMonth = new ArrayList<>();
  ...
  public RecurringTaskChainResponse() {
  }

  public RecurringTaskChainResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Recurring Task Chain")
  ...
  public RecurringTaskChainResponse description(String description) {
  ...
  **/
  ...
  public RecurringTaskChainResponse schemas(List<EnumrecurringTaskChainSchemaUrn> schemas) {
  ...
  public RecurringTaskChainResponse addSchemasItem(EnumrecurringTaskChainSchemaUrn schemasItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether this Recurring Task Chain is enabled for use. Recurring Task Chains that are disabled will not have any new instances scheduled, but instances that are already scheduled will be preserved. Those instances may be manually canceled if desired.")
  ...
  public RecurringTaskChainResponse recurringTask(List<String> recurringTask) {
  ...
  public RecurringTaskChainResponse addRecurringTaskItem(String recurringTaskItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse scheduledMonth(List<EnumrecurringTaskChainScheduledMonthProp> scheduledMonth) {
  ...
  public RecurringTaskChainResponse addScheduledMonthItem(EnumrecurringTaskChainScheduledMonthProp scheduledMonthItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse scheduledDateSelectionType(EnumrecurringTaskChainScheduledDateSelectionTypeProp scheduledDateSelectionType) {
  ...
  **/
  ...
  public RecurringTaskChainResponse scheduledDayOfTheWeek(List<EnumrecurringTaskChainScheduledDayOfTheWeekProp> scheduledDayOfTheWeek) {
  ...
  public RecurringTaskChainResponse addScheduledDayOfTheWeekItem(EnumrecurringTaskChainScheduledDayOfTheWeekProp scheduledDayOfTheWeekItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse scheduledDayOfTheMonth(List<EnumrecurringTaskChainScheduledDayOfTheMonthProp> scheduledDayOfTheMonth) {
  ...
  public RecurringTaskChainResponse addScheduledDayOfTheMonthItem(EnumrecurringTaskChainScheduledDayOfTheMonthProp scheduledDayOfTheMonthItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse scheduledTimeOfDay(List<String> scheduledTimeOfDay) {
  ...
  public RecurringTaskChainResponse addScheduledTimeOfDayItem(String scheduledTimeOfDayItem) {
  ...
  **/
  ...
  public RecurringTaskChainResponse timeZone(String timeZone) {
  ...
  **/
  ...
  public RecurringTaskChainResponse interruptedByShutdownBehavior(EnumrecurringTaskChainInterruptedByShutdownBehaviorProp interruptedByShutdownBehavior) {
  ...
  **/
  ...
  public RecurringTaskChainResponse serverOfflineAtStartTimeBehavior(EnumrecurringTaskChainServerOfflineAtStartTimeBehaviorProp serverOfflineAtStartTimeBehavior) {
  ...
  **/
  ...
  public RecurringTaskChainResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public RecurringTaskChainResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the RecurringTaskChainResponse instance itself
   */
  public RecurringTaskChainResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecurringTaskChainResponse recurringTaskChainResponse = (RecurringTaskChainResponse) o;
    return Objects.equals(this.id, recurringTaskChainResponse.id) &&
        Objects.equals(this.description, recurringTaskChainResponse.description) &&
        Objects.equals(this.schemas, recurringTaskChainResponse.schemas) &&
        Objects.equals(this.enabled, recurringTaskChainResponse.enabled) &&
        Objects.equals(this.recurringTask, recurringTaskChainResponse.recurringTask) &&
        Objects.equals(this.scheduledMonth, recurringTaskChainResponse.scheduledMonth) &&
        Objects.equals(this.scheduledDateSelectionType, recurringTaskChainResponse.scheduledDateSelectionType) &&
        Objects.equals(this.scheduledDayOfTheWeek, recurringTaskChainResponse.scheduledDayOfTheWeek) &&
        Objects.equals(this.scheduledDayOfTheMonth, recurringTaskChainResponse.scheduledDayOfTheMonth) &&
        Objects.equals(this.scheduledTimeOfDay, recurringTaskChainResponse.scheduledTimeOfDay) &&
        Objects.equals(this.timeZone, recurringTaskChainResponse.timeZone) &&
        Objects.equals(this.interruptedByShutdownBehavior, recurringTaskChainResponse.interruptedByShutdownBehavior) &&
        Objects.equals(this.serverOfflineAtStartTimeBehavior, recurringTaskChainResponse.serverOfflineAtStartTimeBehavior) &&
        Objects.equals(this.meta, recurringTaskChainResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, recurringTaskChainResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, recurringTaskChainResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, recurringTask, scheduledMonth, scheduledDateSelectionType, scheduledDayOfTheWeek, scheduledDayOfTheMonth, scheduledTimeOfDay, timeZone, interruptedByShutdownBehavior, serverOfflineAtStartTimeBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RecurringTaskChainResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("scheduledMonth");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecurringTaskChainResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecurringTaskChainResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecurringTaskChainResponse is not found in the empty JSON string", RecurringTaskChainResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RecurringTaskChainResponse.openapiRequiredFields) {
      ...
      // ensure the required json array is present
      if (jsonObj.get("scheduledMonth") == null) {
        throw new IllegalArgumentException("Expected the field `linkedContent` to be an array in the JSON string but got `null`");
      } else if (!jsonObj.get("scheduledMonth").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecurringTaskChainResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecurringTaskChainResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecurringTaskChainResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecurringTaskChainResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<RecurringTaskChainResponse>() {
           @Override
           public void write(JsonWriter out, RecurringTaskChainResponse value) throws IOException {
           ...
           @Override
           public RecurringTaskChainResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecurringTaskChainResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecurringTaskChainResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecurringTaskChainResponse
  * @throws IOException if the JSON string is invalid with respect to RecurringTaskChainResponse
  */
  public static RecurringTaskChainResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecurringTaskChainResponse.class);
  }

 /**
  * Convert an instance of RecurringTaskChainResponse to an JSON string
  *
  * @return JSON string
  */
