...
public class ThirdPartyVirtualAttributeShared {
  ...
  public ThirdPartyVirtualAttributeShared() {
  }

  public ThirdPartyVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared schemas(List<EnumthirdPartyVirtualAttributeSchemaUrn> schemas) {
  ...
  public ThirdPartyVirtualAttributeShared addSchemasItem(EnumthirdPartyVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyVirtualAttributeShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public ThirdPartyVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public ThirdPartyVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared filter(List<String> filter) {
  ...
  public ThirdPartyVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ThirdPartyVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ThirdPartyVirtualAttributeShared instance itself
   */
  public ThirdPartyVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyVirtualAttributeShared thirdPartyVirtualAttributeShared = (ThirdPartyVirtualAttributeShared) o;
    return Objects.equals(this.description, thirdPartyVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, thirdPartyVirtualAttributeShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyVirtualAttributeShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyVirtualAttributeShared.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, thirdPartyVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, thirdPartyVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, thirdPartyVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, thirdPartyVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, thirdPartyVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, thirdPartyVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, thirdPartyVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, thirdPartyVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, thirdPartyVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, thirdPartyVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, thirdPartyVirtualAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyVirtualAttributeShared is not found in the empty JSON string", ThirdPartyVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public ThirdPartyVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyVirtualAttributeShared
  */
  public static ThirdPartyVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of ThirdPartyVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
