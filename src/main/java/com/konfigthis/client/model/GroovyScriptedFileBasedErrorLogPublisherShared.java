...
public class GroovyScriptedFileBasedErrorLogPublisherShared {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared() {
  }

  public GroovyScriptedFileBasedErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared schemas(List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addSchemasItem(EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedFileBasedErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the GroovyScriptedFileBasedErrorLogPublisherShared instance itself
   */
  public GroovyScriptedFileBasedErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedFileBasedErrorLogPublisherShared groovyScriptedFileBasedErrorLogPublisherShared = (GroovyScriptedFileBasedErrorLogPublisherShared) o;
    return Objects.equals(this.description, groovyScriptedFileBasedErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, groovyScriptedFileBasedErrorLogPublisherShared.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedFileBasedErrorLogPublisherShared.scriptClass) &&
        Objects.equals(this.logFile, groovyScriptedFileBasedErrorLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, groovyScriptedFileBasedErrorLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, groovyScriptedFileBasedErrorLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, groovyScriptedFileBasedErrorLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, groovyScriptedFileBasedErrorLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, groovyScriptedFileBasedErrorLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, groovyScriptedFileBasedErrorLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, groovyScriptedFileBasedErrorLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, groovyScriptedFileBasedErrorLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, groovyScriptedFileBasedErrorLogPublisherShared.append) &&
        Objects.equals(this.scriptArgument, groovyScriptedFileBasedErrorLogPublisherShared.scriptArgument) &&
        Objects.equals(this.asynchronous, groovyScriptedFileBasedErrorLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, groovyScriptedFileBasedErrorLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, groovyScriptedFileBasedErrorLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, groovyScriptedFileBasedErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, groovyScriptedFileBasedErrorLogPublisherShared.timeInterval) &&
        Objects.equals(this.defaultSeverity, groovyScriptedFileBasedErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, groovyScriptedFileBasedErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, groovyScriptedFileBasedErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, groovyScriptedFileBasedErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, groovyScriptedFileBasedErrorLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroovyScriptedFileBasedErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedFileBasedErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedFileBasedErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedFileBasedErrorLogPublisherShared is not found in the empty JSON string", GroovyScriptedFileBasedErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedFileBasedErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedFileBasedErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedFileBasedErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedFileBasedErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedFileBasedErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedFileBasedErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedFileBasedErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public GroovyScriptedFileBasedErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedFileBasedErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedFileBasedErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedFileBasedErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedFileBasedErrorLogPublisherShared
  */
  public static GroovyScriptedFileBasedErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedFileBasedErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of GroovyScriptedFileBasedErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
