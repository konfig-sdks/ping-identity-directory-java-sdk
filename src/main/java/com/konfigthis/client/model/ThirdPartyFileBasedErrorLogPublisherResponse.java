...
import com.konfigthis.client.model.EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn;
...
public class ThirdPartyFileBasedErrorLogPublisherResponse {
  ...
  private List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse() {
  }

  public ThirdPartyFileBasedErrorLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse schemas(List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addSchemasItem(EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the Third Party File Based Error Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Third Party File Based Error Log Publisher.")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Third Party File Based Error Log Publisher .")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Third Party File Based Error Log Publisher .")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse extensionClass(String extensionClass) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fully-qualified name of the Java class providing the logic for the Third Party File Based Error Log Publisher.")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of arguments used to customize the behavior for the Third Party File Based Error Log Publisher. Each configuration property should be given in the form 'name=value'.")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Third Party File Based Error Log Publisher will publish records asynchronously.")
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse overrideSeverity(List<String> overrideSeverity) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyFileBasedErrorLogPublisherResponse instance itself
   */
  public ThirdPartyFileBasedErrorLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyFileBasedErrorLogPublisherResponse thirdPartyFileBasedErrorLogPublisherResponse = (ThirdPartyFileBasedErrorLogPublisherResponse) o;
    return Objects.equals(this.id, thirdPartyFileBasedErrorLogPublisherResponse.id) &&
        Objects.equals(this.description, thirdPartyFileBasedErrorLogPublisherResponse.description) &&
        Objects.equals(this.schemas, thirdPartyFileBasedErrorLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, thirdPartyFileBasedErrorLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, thirdPartyFileBasedErrorLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, thirdPartyFileBasedErrorLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, thirdPartyFileBasedErrorLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, thirdPartyFileBasedErrorLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, thirdPartyFileBasedErrorLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, thirdPartyFileBasedErrorLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, thirdPartyFileBasedErrorLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, thirdPartyFileBasedErrorLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, thirdPartyFileBasedErrorLogPublisherResponse.append) &&
        Objects.equals(this.extensionClass, thirdPartyFileBasedErrorLogPublisherResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyFileBasedErrorLogPublisherResponse.extensionArgument) &&
        Objects.equals(this.asynchronous, thirdPartyFileBasedErrorLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, thirdPartyFileBasedErrorLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, thirdPartyFileBasedErrorLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, thirdPartyFileBasedErrorLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, thirdPartyFileBasedErrorLogPublisherResponse.timeInterval) &&
        Objects.equals(this.defaultSeverity, thirdPartyFileBasedErrorLogPublisherResponse.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, thirdPartyFileBasedErrorLogPublisherResponse.overrideSeverity) &&
        Objects.equals(this.enabled, thirdPartyFileBasedErrorLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, thirdPartyFileBasedErrorLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, thirdPartyFileBasedErrorLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyFileBasedErrorLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyFileBasedErrorLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, extensionClass, extensionArgument, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyFileBasedErrorLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyFileBasedErrorLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyFileBasedErrorLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyFileBasedErrorLogPublisherResponse is not found in the empty JSON string", ThirdPartyFileBasedErrorLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyFileBasedErrorLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyFileBasedErrorLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyFileBasedErrorLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyFileBasedErrorLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyFileBasedErrorLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyFileBasedErrorLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyFileBasedErrorLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyFileBasedErrorLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyFileBasedErrorLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyFileBasedErrorLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyFileBasedErrorLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyFileBasedErrorLogPublisherResponse
  */
  public static ThirdPartyFileBasedErrorLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyFileBasedErrorLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyFileBasedErrorLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
