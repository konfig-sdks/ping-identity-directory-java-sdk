...
public class AddPasswordPolicyStateJsonVirtualAttributeRequest {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest() {
  }

  public AddPasswordPolicyStateJsonVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest schemas(List<EnumpasswordPolicyStateJsonVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest addSchemasItem(EnumpasswordPolicyStateJsonVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddPasswordPolicyStateJsonVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
   ...
   * @return the AddPasswordPolicyStateJsonVirtualAttributeRequest instance itself
   */
  public AddPasswordPolicyStateJsonVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPasswordPolicyStateJsonVirtualAttributeRequest addPasswordPolicyStateJsonVirtualAttributeRequest = (AddPasswordPolicyStateJsonVirtualAttributeRequest) o;
    return Objects.equals(this.name, addPasswordPolicyStateJsonVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addPasswordPolicyStateJsonVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addPasswordPolicyStateJsonVirtualAttributeRequest.schemas) &&
        Objects.equals(this.enabled, addPasswordPolicyStateJsonVirtualAttributeRequest.enabled) &&
        Objects.equals(this.baseDN, addPasswordPolicyStateJsonVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addPasswordPolicyStateJsonVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addPasswordPolicyStateJsonVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addPasswordPolicyStateJsonVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, addPasswordPolicyStateJsonVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addPasswordPolicyStateJsonVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex)&&
        Objects.equals(this.additionalProperties, addPasswordPolicyStateJsonVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPasswordPolicyStateJsonVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPasswordPolicyStateJsonVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPasswordPolicyStateJsonVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPasswordPolicyStateJsonVirtualAttributeRequest is not found in the empty JSON string", AddPasswordPolicyStateJsonVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPasswordPolicyStateJsonVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPasswordPolicyStateJsonVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPasswordPolicyStateJsonVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPasswordPolicyStateJsonVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPasswordPolicyStateJsonVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPasswordPolicyStateJsonVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddPasswordPolicyStateJsonVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddPasswordPolicyStateJsonVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPasswordPolicyStateJsonVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPasswordPolicyStateJsonVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPasswordPolicyStateJsonVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddPasswordPolicyStateJsonVirtualAttributeRequest
  */
  public static AddPasswordPolicyStateJsonVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPasswordPolicyStateJsonVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddPasswordPolicyStateJsonVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
