...
public class AddCommonLogFileHttpOperationLogPublisherRequest {
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest() {
  }

  public AddCommonLogFileHttpOperationLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest schemas(List<EnumcommonLogFileHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest addSchemasItem(EnumcommonLogFileHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest logFile(String logFile) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this Common Log File HTTP Operation Log Publisher.")
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest rotationPolicy(List<String> rotationPolicy) {
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the Common Log File HTTP Operation Log Publisher .")
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest rotationListener(List<String> rotationListener) {
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest retentionPolicy(List<String> retentionPolicy) {
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the Common Log File HTTP Operation Log Publisher .")
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest signLog(Boolean signLog) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest append(Boolean append) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Common Log File HTTP Operation Log Publisher will publish records asynchronously.")
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest bufferSize(String bufferSize) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest timeInterval(String timeInterval) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddCommonLogFileHttpOperationLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddCommonLogFileHttpOperationLogPublisherRequest instance itself
   */
  public AddCommonLogFileHttpOperationLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddCommonLogFileHttpOperationLogPublisherRequest addCommonLogFileHttpOperationLogPublisherRequest = (AddCommonLogFileHttpOperationLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addCommonLogFileHttpOperationLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addCommonLogFileHttpOperationLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addCommonLogFileHttpOperationLogPublisherRequest.schemas) &&
        Objects.equals(this.logFile, addCommonLogFileHttpOperationLogPublisherRequest.logFile) &&
        Objects.equals(this.logFilePermissions, addCommonLogFileHttpOperationLogPublisherRequest.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, addCommonLogFileHttpOperationLogPublisherRequest.rotationPolicy) &&
        Objects.equals(this.rotationListener, addCommonLogFileHttpOperationLogPublisherRequest.rotationListener) &&
        Objects.equals(this.retentionPolicy, addCommonLogFileHttpOperationLogPublisherRequest.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, addCommonLogFileHttpOperationLogPublisherRequest.compressionMechanism) &&
        Objects.equals(this.signLog, addCommonLogFileHttpOperationLogPublisherRequest.signLog) &&
        Objects.equals(this.encryptLog, addCommonLogFileHttpOperationLogPublisherRequest.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, addCommonLogFileHttpOperationLogPublisherRequest.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, addCommonLogFileHttpOperationLogPublisherRequest.append) &&
        Objects.equals(this.asynchronous, addCommonLogFileHttpOperationLogPublisherRequest.asynchronous) &&
        Objects.equals(this.autoFlush, addCommonLogFileHttpOperationLogPublisherRequest.autoFlush) &&
        Objects.equals(this.bufferSize, addCommonLogFileHttpOperationLogPublisherRequest.bufferSize) &&
        Objects.equals(this.queueSize, addCommonLogFileHttpOperationLogPublisherRequest.queueSize) &&
        Objects.equals(this.timeInterval, addCommonLogFileHttpOperationLogPublisherRequest.timeInterval) &&
        Objects.equals(this.enabled, addCommonLogFileHttpOperationLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addCommonLogFileHttpOperationLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addCommonLogFileHttpOperationLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddCommonLogFileHttpOperationLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCommonLogFileHttpOperationLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCommonLogFileHttpOperationLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCommonLogFileHttpOperationLogPublisherRequest is not found in the empty JSON string", AddCommonLogFileHttpOperationLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCommonLogFileHttpOperationLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCommonLogFileHttpOperationLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCommonLogFileHttpOperationLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCommonLogFileHttpOperationLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCommonLogFileHttpOperationLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCommonLogFileHttpOperationLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddCommonLogFileHttpOperationLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddCommonLogFileHttpOperationLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddCommonLogFileHttpOperationLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddCommonLogFileHttpOperationLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddCommonLogFileHttpOperationLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddCommonLogFileHttpOperationLogPublisherRequest
  */
  public static AddCommonLogFileHttpOperationLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCommonLogFileHttpOperationLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddCommonLogFileHttpOperationLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
