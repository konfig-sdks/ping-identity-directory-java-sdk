...
import com.konfigthis.client.model.EnumfileBasedSyncLogPublisherSchemaUrn;
...
public class FileBasedSyncLogPublisherResponse {
  ...
  private List<EnumfileBasedSyncLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public FileBasedSyncLogPublisherResponse() {
  }

  public FileBasedSyncLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse schemas(List<EnumfileBasedSyncLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedSyncLogPublisherResponse addSchemasItem(EnumfileBasedSyncLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumfileBasedSyncLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumfileBasedSyncLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedSyncLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the File Based Sync Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public FileBasedSyncLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Sync Log Publisher.")
  ...
  public FileBasedSyncLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedSyncLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Sync Log Publisher .")
  ...
  public FileBasedSyncLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedSyncLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedSyncLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Sync Log Publisher .")
  ...
  public FileBasedSyncLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based Sync Log Publisher will publish records asynchronously.")
  ...
  public FileBasedSyncLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public FileBasedSyncLogPublisherResponse addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse loggedMessageType(List<EnumlogPublisherLoggedMessageTypeProp> loggedMessageType) {
  ...
  public FileBasedSyncLogPublisherResponse addLoggedMessageTypeItem(EnumlogPublisherLoggedMessageTypeProp loggedMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedSyncLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedSyncLogPublisherResponse instance itself
   */
  public FileBasedSyncLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedSyncLogPublisherResponse fileBasedSyncLogPublisherResponse = (FileBasedSyncLogPublisherResponse) o;
    return Objects.equals(this.description, fileBasedSyncLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedSyncLogPublisherResponse.schemas) &&
        Objects.equals(this.id, fileBasedSyncLogPublisherResponse.id) &&
        Objects.equals(this.logFile, fileBasedSyncLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedSyncLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedSyncLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedSyncLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedSyncLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedSyncLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedSyncLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedSyncLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedSyncLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedSyncLogPublisherResponse.append) &&
        Objects.equals(this.asynchronous, fileBasedSyncLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedSyncLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedSyncLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedSyncLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedSyncLogPublisherResponse.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedSyncLogPublisherResponse.timestampPrecision) &&
        Objects.equals(this.includeSyncPipe, fileBasedSyncLogPublisherResponse.includeSyncPipe) &&
        Objects.equals(this.loggedMessageType, fileBasedSyncLogPublisherResponse.loggedMessageType) &&
        Objects.equals(this.enabled, fileBasedSyncLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedSyncLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedSyncLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedSyncLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedSyncLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, includeSyncPipe, loggedMessageType, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedSyncLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedSyncLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedSyncLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedSyncLogPublisherResponse is not found in the empty JSON string", FileBasedSyncLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedSyncLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedSyncLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedSyncLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedSyncLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedSyncLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedSyncLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedSyncLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedSyncLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedSyncLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedSyncLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedSyncLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedSyncLogPublisherResponse
  */
  public static FileBasedSyncLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedSyncLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedSyncLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
