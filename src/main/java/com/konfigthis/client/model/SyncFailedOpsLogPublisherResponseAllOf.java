...
public class SyncFailedOpsLogPublisherResponseAllOf {
  ...
  private List<EnumsyncFailedOpsLogPublisherSchemaUrn> schemas = null;
  ...
  public SyncFailedOpsLogPublisherResponseAllOf() {
  }

  public SyncFailedOpsLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf schemas(List<EnumsyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public SyncFailedOpsLogPublisherResponseAllOf addSchemasItem(EnumsyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The file name to use for the log files generated by the Sync Failed Ops Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public SyncFailedOpsLogPublisherResponseAllOf logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this Sync Failed Ops Log Publisher.")
  ...
  public SyncFailedOpsLogPublisherResponseAllOf rotationPolicy(List<String> rotationPolicy) {
  ...
  public SyncFailedOpsLogPublisherResponseAllOf addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the Sync Failed Ops Log Publisher .")
  ...
  public SyncFailedOpsLogPublisherResponseAllOf rotationListener(List<String> rotationListener) {
  ...
  public SyncFailedOpsLogPublisherResponseAllOf addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf retentionPolicy(List<String> retentionPolicy) {
  ...
  public SyncFailedOpsLogPublisherResponseAllOf addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the Sync Failed Ops Log Publisher .")
  ...
  public SyncFailedOpsLogPublisherResponseAllOf compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf signLog(Boolean signLog) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf append(Boolean append) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Sync Failed Ops Log Publisher will publish records asynchronously.")
  ...
  public SyncFailedOpsLogPublisherResponseAllOf autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf bufferSize(String bufferSize) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf timeInterval(String timeInterval) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public SyncFailedOpsLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyncFailedOpsLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyncFailedOpsLogPublisherResponseAllOf instance itself
   */
  public SyncFailedOpsLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncFailedOpsLogPublisherResponseAllOf syncFailedOpsLogPublisherResponseAllOf = (SyncFailedOpsLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, syncFailedOpsLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, syncFailedOpsLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, syncFailedOpsLogPublisherResponseAllOf.id) &&
        Objects.equals(this.logFile, syncFailedOpsLogPublisherResponseAllOf.logFile) &&
        Objects.equals(this.logFilePermissions, syncFailedOpsLogPublisherResponseAllOf.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, syncFailedOpsLogPublisherResponseAllOf.rotationPolicy) &&
        Objects.equals(this.rotationListener, syncFailedOpsLogPublisherResponseAllOf.rotationListener) &&
        Objects.equals(this.retentionPolicy, syncFailedOpsLogPublisherResponseAllOf.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, syncFailedOpsLogPublisherResponseAllOf.compressionMechanism) &&
        Objects.equals(this.signLog, syncFailedOpsLogPublisherResponseAllOf.signLog) &&
        Objects.equals(this.encryptLog, syncFailedOpsLogPublisherResponseAllOf.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, syncFailedOpsLogPublisherResponseAllOf.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, syncFailedOpsLogPublisherResponseAllOf.append) &&
        Objects.equals(this.asynchronous, syncFailedOpsLogPublisherResponseAllOf.asynchronous) &&
        Objects.equals(this.autoFlush, syncFailedOpsLogPublisherResponseAllOf.autoFlush) &&
        Objects.equals(this.bufferSize, syncFailedOpsLogPublisherResponseAllOf.bufferSize) &&
        Objects.equals(this.queueSize, syncFailedOpsLogPublisherResponseAllOf.queueSize) &&
        Objects.equals(this.timeInterval, syncFailedOpsLogPublisherResponseAllOf.timeInterval) &&
        Objects.equals(this.includeSyncPipe, syncFailedOpsLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.enabled, syncFailedOpsLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syncFailedOpsLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syncFailedOpsLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, includeSyncPipe, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyncFailedOpsLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncFailedOpsLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncFailedOpsLogPublisherResponseAllOf is not found in the empty JSON string", SyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncFailedOpsLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncFailedOpsLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncFailedOpsLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncFailedOpsLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncFailedOpsLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SyncFailedOpsLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public SyncFailedOpsLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncFailedOpsLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncFailedOpsLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncFailedOpsLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SyncFailedOpsLogPublisherResponseAllOf
  */
  public static SyncFailedOpsLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncFailedOpsLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of SyncFailedOpsLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
