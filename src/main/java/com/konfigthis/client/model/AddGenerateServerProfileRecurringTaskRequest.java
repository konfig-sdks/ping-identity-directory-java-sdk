...
public class AddGenerateServerProfileRecurringTaskRequest {
  ...
  public AddGenerateServerProfileRecurringTaskRequest() {
  }

  public AddGenerateServerProfileRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest schemas(List<EnumgenerateServerProfileRecurringTaskSchemaUrn> schemas) {
  ...
  public AddGenerateServerProfileRecurringTaskRequest addSchemasItem(EnumgenerateServerProfileRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest profileDirectory(String profileDirectory) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest includePath(List<String> includePath) {
  ...
  public AddGenerateServerProfileRecurringTaskRequest addIncludePathItem(String includePathItem) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest retainPreviousProfileCount(Integer retainPreviousProfileCount) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest retainPreviousProfileAge(String retainPreviousProfileAge) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddGenerateServerProfileRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddGenerateServerProfileRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddGenerateServerProfileRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddGenerateServerProfileRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddGenerateServerProfileRecurringTaskRequest instance itself
   */
  public AddGenerateServerProfileRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGenerateServerProfileRecurringTaskRequest addGenerateServerProfileRecurringTaskRequest = (AddGenerateServerProfileRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addGenerateServerProfileRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addGenerateServerProfileRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addGenerateServerProfileRecurringTaskRequest.schemas) &&
        Objects.equals(this.profileDirectory, addGenerateServerProfileRecurringTaskRequest.profileDirectory) &&
        Objects.equals(this.includePath, addGenerateServerProfileRecurringTaskRequest.includePath) &&
        Objects.equals(this.retainPreviousProfileCount, addGenerateServerProfileRecurringTaskRequest.retainPreviousProfileCount) &&
        Objects.equals(this.retainPreviousProfileAge, addGenerateServerProfileRecurringTaskRequest.retainPreviousProfileAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addGenerateServerProfileRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addGenerateServerProfileRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addGenerateServerProfileRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addGenerateServerProfileRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addGenerateServerProfileRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addGenerateServerProfileRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addGenerateServerProfileRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addGenerateServerProfileRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, profileDirectory, includePath, retainPreviousProfileCount, retainPreviousProfileAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGenerateServerProfileRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGenerateServerProfileRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGenerateServerProfileRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGenerateServerProfileRecurringTaskRequest is not found in the empty JSON string", AddGenerateServerProfileRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGenerateServerProfileRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGenerateServerProfileRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGenerateServerProfileRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGenerateServerProfileRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGenerateServerProfileRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGenerateServerProfileRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddGenerateServerProfileRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddGenerateServerProfileRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGenerateServerProfileRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGenerateServerProfileRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGenerateServerProfileRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddGenerateServerProfileRecurringTaskRequest
  */
  public static AddGenerateServerProfileRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGenerateServerProfileRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddGenerateServerProfileRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
