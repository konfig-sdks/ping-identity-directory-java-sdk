...
public class AddErrorLogAlertHandlerRequest {
  ...
  public AddErrorLogAlertHandlerRequest() {
  }

  public AddErrorLogAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest schemas(List<EnumerrorLogAlertHandlerSchemaUrn> schemas) {
  ...
  public AddErrorLogAlertHandlerRequest addSchemasItem(EnumerrorLogAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddErrorLogAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddErrorLogAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddErrorLogAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddErrorLogAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddErrorLogAlertHandlerRequest instance itself
   */
  public AddErrorLogAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddErrorLogAlertHandlerRequest addErrorLogAlertHandlerRequest = (AddErrorLogAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addErrorLogAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addErrorLogAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addErrorLogAlertHandlerRequest.schemas) &&
        Objects.equals(this.enabled, addErrorLogAlertHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addErrorLogAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, addErrorLogAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addErrorLogAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addErrorLogAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addErrorLogAlertHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddErrorLogAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddErrorLogAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddErrorLogAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddErrorLogAlertHandlerRequest is not found in the empty JSON string", AddErrorLogAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddErrorLogAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddErrorLogAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddErrorLogAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddErrorLogAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddErrorLogAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddErrorLogAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddErrorLogAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddErrorLogAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddErrorLogAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddErrorLogAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddErrorLogAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddErrorLogAlertHandlerRequest
  */
  public static AddErrorLogAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddErrorLogAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddErrorLogAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
