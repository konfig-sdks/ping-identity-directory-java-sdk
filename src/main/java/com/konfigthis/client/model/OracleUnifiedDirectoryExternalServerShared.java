...
public class OracleUnifiedDirectoryExternalServerShared {
  ...
  public OracleUnifiedDirectoryExternalServerShared() {
  }

  public OracleUnifiedDirectoryExternalServerShared description(String description) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared schemas(List<EnumoracleUnifiedDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public OracleUnifiedDirectoryExternalServerShared addSchemasItem(EnumoracleUnifiedDirectoryExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared location(String location) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared password(String password) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared connectionSecurity(EnumexternalServerOracleUnifiedDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared authenticationMethod(EnumexternalServerOracleUnifiedDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public OracleUnifiedDirectoryExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public OracleUnifiedDirectoryExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the OracleUnifiedDirectoryExternalServerShared instance itself
   */
  public OracleUnifiedDirectoryExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OracleUnifiedDirectoryExternalServerShared oracleUnifiedDirectoryExternalServerShared = (OracleUnifiedDirectoryExternalServerShared) o;
    return Objects.equals(this.description, oracleUnifiedDirectoryExternalServerShared.description) &&
        Objects.equals(this.schemas, oracleUnifiedDirectoryExternalServerShared.schemas) &&
        Objects.equals(this.serverHostName, oracleUnifiedDirectoryExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, oracleUnifiedDirectoryExternalServerShared.serverPort) &&
        Objects.equals(this.location, oracleUnifiedDirectoryExternalServerShared.location) &&
        Objects.equals(this.bindDN, oracleUnifiedDirectoryExternalServerShared.bindDN) &&
        Objects.equals(this.password, oracleUnifiedDirectoryExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, oracleUnifiedDirectoryExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, oracleUnifiedDirectoryExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, oracleUnifiedDirectoryExternalServerShared.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, oracleUnifiedDirectoryExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, oracleUnifiedDirectoryExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, oracleUnifiedDirectoryExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, oracleUnifiedDirectoryExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, oracleUnifiedDirectoryExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, oracleUnifiedDirectoryExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, oracleUnifiedDirectoryExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, oracleUnifiedDirectoryExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, oracleUnifiedDirectoryExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, oracleUnifiedDirectoryExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, oracleUnifiedDirectoryExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, oracleUnifiedDirectoryExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, oracleUnifiedDirectoryExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, serverHostName, serverPort, location, bindDN, password, passphraseProvider, connectionSecurity, authenticationMethod, verifyCredentialsMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OracleUnifiedDirectoryExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OracleUnifiedDirectoryExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OracleUnifiedDirectoryExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OracleUnifiedDirectoryExternalServerShared is not found in the empty JSON string", OracleUnifiedDirectoryExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OracleUnifiedDirectoryExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OracleUnifiedDirectoryExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OracleUnifiedDirectoryExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OracleUnifiedDirectoryExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OracleUnifiedDirectoryExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<OracleUnifiedDirectoryExternalServerShared>() {
           @Override
           public void write(JsonWriter out, OracleUnifiedDirectoryExternalServerShared value) throws IOException {
           ...
           @Override
           public OracleUnifiedDirectoryExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OracleUnifiedDirectoryExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OracleUnifiedDirectoryExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OracleUnifiedDirectoryExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to OracleUnifiedDirectoryExternalServerShared
  */
  public static OracleUnifiedDirectoryExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OracleUnifiedDirectoryExternalServerShared.class);
  }

 /**
  * Convert an instance of OracleUnifiedDirectoryExternalServerShared to an JSON string
  *
  * @return JSON string
  */
