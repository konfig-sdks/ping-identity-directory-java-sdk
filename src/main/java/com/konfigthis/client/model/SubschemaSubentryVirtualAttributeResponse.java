...
import com.konfigthis.client.model.EnumsubschemaSubentryVirtualAttributeSchemaUrn;
...
public class SubschemaSubentryVirtualAttributeResponse {
  ...
  private List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public SubschemaSubentryVirtualAttributeResponse() {
  }

  public SubschemaSubentryVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse schemas(List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> schemas) {
  ...
  public SubschemaSubentryVirtualAttributeResponse addSchemasItem(EnumsubschemaSubentryVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> schemas) {
  ...
  public SubschemaSubentryVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public SubschemaSubentryVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public SubschemaSubentryVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse filter(List<String> filter) {
  ...
  public SubschemaSubentryVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public SubschemaSubentryVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SubschemaSubentryVirtualAttributeResponse instance itself
   */
  public SubschemaSubentryVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubschemaSubentryVirtualAttributeResponse subschemaSubentryVirtualAttributeResponse = (SubschemaSubentryVirtualAttributeResponse) o;
    return Objects.equals(this.description, subschemaSubentryVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, subschemaSubentryVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, subschemaSubentryVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, subschemaSubentryVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, subschemaSubentryVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, subschemaSubentryVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, subschemaSubentryVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, subschemaSubentryVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, subschemaSubentryVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, subschemaSubentryVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, subschemaSubentryVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, subschemaSubentryVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, subschemaSubentryVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, subschemaSubentryVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, subschemaSubentryVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, subschemaSubentryVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, subschemaSubentryVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubschemaSubentryVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubschemaSubentryVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubschemaSubentryVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubschemaSubentryVirtualAttributeResponse is not found in the empty JSON string", SubschemaSubentryVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubschemaSubentryVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubschemaSubentryVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubschemaSubentryVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubschemaSubentryVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubschemaSubentryVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SubschemaSubentryVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, SubschemaSubentryVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public SubschemaSubentryVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubschemaSubentryVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubschemaSubentryVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubschemaSubentryVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to SubschemaSubentryVirtualAttributeResponse
  */
  public static SubschemaSubentryVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubschemaSubentryVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of SubschemaSubentryVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
