...
import com.konfigthis.client.model.EnumthirdPartyVirtualAttributeSchemaUrn;
...
public class ThirdPartyVirtualAttributeResponse {
  ...
  private List<EnumthirdPartyVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public ThirdPartyVirtualAttributeResponse() {
  }

  public ThirdPartyVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse schemas(List<EnumthirdPartyVirtualAttributeSchemaUrn> schemas) {
  ...
  public ThirdPartyVirtualAttributeResponse addSchemasItem(EnumthirdPartyVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumthirdPartyVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumthirdPartyVirtualAttributeSchemaUrn> schemas) {
  ...
  public ThirdPartyVirtualAttributeResponse extensionClass(String extensionClass) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fully-qualified name of the Java class providing the logic for the Third Party Virtual Attribute.")
  ...
  public ThirdPartyVirtualAttributeResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyVirtualAttributeResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of arguments used to customize the behavior for the Third Party Virtual Attribute. Each configuration property should be given in the form 'name=value'.")
  ...
  public ThirdPartyVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public ThirdPartyVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public ThirdPartyVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse filter(List<String> filter) {
  ...
  public ThirdPartyVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ThirdPartyVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyVirtualAttributeResponse instance itself
   */
  public ThirdPartyVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyVirtualAttributeResponse thirdPartyVirtualAttributeResponse = (ThirdPartyVirtualAttributeResponse) o;
    return Objects.equals(this.id, thirdPartyVirtualAttributeResponse.id) &&
        Objects.equals(this.description, thirdPartyVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, thirdPartyVirtualAttributeResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyVirtualAttributeResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyVirtualAttributeResponse.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, thirdPartyVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, thirdPartyVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, thirdPartyVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, thirdPartyVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, thirdPartyVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, thirdPartyVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, thirdPartyVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, thirdPartyVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, thirdPartyVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, thirdPartyVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, thirdPartyVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyVirtualAttributeResponse is not found in the empty JSON string", ThirdPartyVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyVirtualAttributeResponse
  */
  public static ThirdPartyVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
