...
public class AddAzureKeyVaultCipherStreamProviderRequest {
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest() {
  }

  public AddAzureKeyVaultCipherStreamProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest description(String description) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest schemas(List<EnumazureKeyVaultCipherStreamProviderSchemaUrn> schemas) {
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest addSchemasItem(EnumazureKeyVaultCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest keyVaultURI(String keyVaultURI) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest azureAuthenticationMethod(String azureAuthenticationMethod) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest secretName(String secretName) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest encryptionMetadataFile(String encryptionMetadataFile) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public AddAzureKeyVaultCipherStreamProviderRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddAzureKeyVaultCipherStreamProviderRequest instance itself
   */
  public AddAzureKeyVaultCipherStreamProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAzureKeyVaultCipherStreamProviderRequest addAzureKeyVaultCipherStreamProviderRequest = (AddAzureKeyVaultCipherStreamProviderRequest) o;
    return Objects.equals(this.providerName, addAzureKeyVaultCipherStreamProviderRequest.providerName) &&
        Objects.equals(this.description, addAzureKeyVaultCipherStreamProviderRequest.description) &&
        Objects.equals(this.schemas, addAzureKeyVaultCipherStreamProviderRequest.schemas) &&
        Objects.equals(this.keyVaultURI, addAzureKeyVaultCipherStreamProviderRequest.keyVaultURI) &&
        Objects.equals(this.azureAuthenticationMethod, addAzureKeyVaultCipherStreamProviderRequest.azureAuthenticationMethod) &&
        Objects.equals(this.httpProxyExternalServer, addAzureKeyVaultCipherStreamProviderRequest.httpProxyExternalServer) &&
        Objects.equals(this.secretName, addAzureKeyVaultCipherStreamProviderRequest.secretName) &&
        Objects.equals(this.encryptionMetadataFile, addAzureKeyVaultCipherStreamProviderRequest.encryptionMetadataFile) &&
        Objects.equals(this.iterationCount, addAzureKeyVaultCipherStreamProviderRequest.iterationCount) &&
        Objects.equals(this.enabled, addAzureKeyVaultCipherStreamProviderRequest.enabled)&&
        Objects.equals(this.additionalProperties, addAzureKeyVaultCipherStreamProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, description, schemas, keyVaultURI, azureAuthenticationMethod, httpProxyExternalServer, secretName, encryptionMetadataFile, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAzureKeyVaultCipherStreamProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAzureKeyVaultCipherStreamProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAzureKeyVaultCipherStreamProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAzureKeyVaultCipherStreamProviderRequest is not found in the empty JSON string", AddAzureKeyVaultCipherStreamProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAzureKeyVaultCipherStreamProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAzureKeyVaultCipherStreamProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAzureKeyVaultCipherStreamProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAzureKeyVaultCipherStreamProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAzureKeyVaultCipherStreamProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAzureKeyVaultCipherStreamProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddAzureKeyVaultCipherStreamProviderRequest value) throws IOException {
           ...
           @Override
           public AddAzureKeyVaultCipherStreamProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAzureKeyVaultCipherStreamProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAzureKeyVaultCipherStreamProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAzureKeyVaultCipherStreamProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddAzureKeyVaultCipherStreamProviderRequest
  */
  public static AddAzureKeyVaultCipherStreamProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAzureKeyVaultCipherStreamProviderRequest.class);
  }

 /**
  * Convert an instance of AddAzureKeyVaultCipherStreamProviderRequest to an JSON string
  *
  * @return JSON string
  */
