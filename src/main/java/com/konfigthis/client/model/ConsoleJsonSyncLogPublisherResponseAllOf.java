...
/**
 * ConsoleJsonSyncLogPublisherResponseAllOf
 */@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ConsoleJsonSyncLogPublisherResponseAllOf {
  ...
  private List<EnumconsoleJsonSyncLogPublisherSchemaUrn> schemas = null;
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf() {
  }

  public ConsoleJsonSyncLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf schemas(List<EnumconsoleJsonSyncLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf addSchemasItem(EnumconsoleJsonSyncLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Console JSON Sync Log Publisher is enabled for use.")
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf loggedMessageType(List<EnumlogPublisherLoggedMessageTypeProp> loggedMessageType) {
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf addLoggedMessageTypeItem(EnumlogPublisherLoggedMessageTypeProp loggedMessageTypeItem) {
  ...
  **/
  ...
  public ConsoleJsonSyncLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the ConsoleJsonSyncLogPublisherResponseAllOf instance itself
   */
  public ConsoleJsonSyncLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonSyncLogPublisherResponseAllOf consoleJsonSyncLogPublisherResponseAllOf = (ConsoleJsonSyncLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, consoleJsonSyncLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, consoleJsonSyncLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, consoleJsonSyncLogPublisherResponseAllOf.id) &&
        Objects.equals(this.enabled, consoleJsonSyncLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.outputLocation, consoleJsonSyncLogPublisherResponseAllOf.outputLocation) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonSyncLogPublisherResponseAllOf.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, consoleJsonSyncLogPublisherResponseAllOf.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonSyncLogPublisherResponseAllOf.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonSyncLogPublisherResponseAllOf.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonSyncLogPublisherResponseAllOf.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, consoleJsonSyncLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.loggedMessageType, consoleJsonSyncLogPublisherResponseAllOf.loggedMessageType) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonSyncLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, consoleJsonSyncLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, outputLocation, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, loggedMessageType, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonSyncLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonSyncLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonSyncLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonSyncLogPublisherResponseAllOf is not found in the empty JSON string", ConsoleJsonSyncLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonSyncLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonSyncLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonSyncLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonSyncLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonSyncLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonSyncLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public ConsoleJsonSyncLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonSyncLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonSyncLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonSyncLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonSyncLogPublisherResponseAllOf
  */
  public static ConsoleJsonSyncLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonSyncLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of ConsoleJsonSyncLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
