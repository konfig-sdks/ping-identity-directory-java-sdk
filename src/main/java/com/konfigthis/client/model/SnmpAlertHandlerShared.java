...
public class SnmpAlertHandlerShared {
  ...
  public SnmpAlertHandlerShared() {
  }

  public SnmpAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared schemas(List<EnumsnmpAlertHandlerSchemaUrn> schemas) {
  ...
  public SnmpAlertHandlerShared addSchemasItem(EnumsnmpAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared communityName(String communityName) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public SnmpAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public SnmpAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public SnmpAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public SnmpAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the SnmpAlertHandlerShared instance itself
   */
  public SnmpAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnmpAlertHandlerShared snmpAlertHandlerShared = (SnmpAlertHandlerShared) o;
    return Objects.equals(this.description, snmpAlertHandlerShared.description) &&
        Objects.equals(this.schemas, snmpAlertHandlerShared.schemas) &&
        Objects.equals(this.asynchronous, snmpAlertHandlerShared.asynchronous) &&
        Objects.equals(this.serverHostName, snmpAlertHandlerShared.serverHostName) &&
        Objects.equals(this.serverPort, snmpAlertHandlerShared.serverPort) &&
        Objects.equals(this.communityName, snmpAlertHandlerShared.communityName) &&
        Objects.equals(this.enabled, snmpAlertHandlerShared.enabled) &&
        Objects.equals(this.enabledAlertSeverity, snmpAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, snmpAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, snmpAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, snmpAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, asynchronous, serverHostName, serverPort, communityName, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnmpAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnmpAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnmpAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnmpAlertHandlerShared is not found in the empty JSON string", SnmpAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SnmpAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnmpAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnmpAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnmpAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnmpAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SnmpAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, SnmpAlertHandlerShared value) throws IOException {
           ...
           @Override
           public SnmpAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnmpAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnmpAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnmpAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to SnmpAlertHandlerShared
  */
  public static SnmpAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnmpAlertHandlerShared.class);
  }

 /**
  * Convert an instance of SnmpAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
