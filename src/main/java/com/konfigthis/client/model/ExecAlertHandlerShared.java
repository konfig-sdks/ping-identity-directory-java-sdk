...
public class ExecAlertHandlerShared {
  ...
  public ExecAlertHandlerShared() {
  }

  public ExecAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public ExecAlertHandlerShared schemas(List<EnumexecAlertHandlerSchemaUrn> schemas) {
  ...
  public ExecAlertHandlerShared addSchemasItem(EnumexecAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ExecAlertHandlerShared command(String command) {
  ...
  **/
  ...
  public ExecAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ExecAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ExecAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public ExecAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public ExecAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public ExecAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public ExecAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public ExecAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the ExecAlertHandlerShared instance itself
   */
  public ExecAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExecAlertHandlerShared execAlertHandlerShared = (ExecAlertHandlerShared) o;
    return Objects.equals(this.description, execAlertHandlerShared.description) &&
        Objects.equals(this.schemas, execAlertHandlerShared.schemas) &&
        Objects.equals(this.command, execAlertHandlerShared.command) &&
        Objects.equals(this.asynchronous, execAlertHandlerShared.asynchronous) &&
        Objects.equals(this.enabled, execAlertHandlerShared.enabled) &&
        Objects.equals(this.enabledAlertSeverity, execAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, execAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, execAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, execAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, command, asynchronous, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExecAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExecAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExecAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecAlertHandlerShared is not found in the empty JSON string", ExecAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExecAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, ExecAlertHandlerShared value) throws IOException {
           ...
           @Override
           public ExecAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExecAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExecAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExecAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to ExecAlertHandlerShared
  */
  public static ExecAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecAlertHandlerShared.class);
  }

 /**
  * Convert an instance of ExecAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
