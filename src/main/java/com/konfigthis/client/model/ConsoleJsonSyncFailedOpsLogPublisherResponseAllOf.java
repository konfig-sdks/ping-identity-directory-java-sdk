...
public class ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf {
  ...
  private List<EnumconsoleJsonSyncFailedOpsLogPublisherSchemaUrn> schemas = null;
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf() {
  }

  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf description(String description) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf schemas(List<EnumconsoleJsonSyncFailedOpsLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf addSchemasItem(EnumconsoleJsonSyncFailedOpsLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf id(String id) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Console JSON Sync Failed Ops Log Publisher is enabled for use.")
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf instance itself
   */
  public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf consoleJsonSyncFailedOpsLogPublisherResponseAllOf = (ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf) o;
    return Objects.equals(this.description, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.description) &&
        Objects.equals(this.schemas, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.schemas) &&
        Objects.equals(this.id, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.id) &&
        Objects.equals(this.enabled, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.enabled) &&
        Objects.equals(this.outputLocation, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.outputLocation) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.includeSyncPipe) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, consoleJsonSyncFailedOpsLogPublisherResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, outputLocation, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf is not found in the empty JSON string", ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf value) throws IOException {
           ...
           @Override
           public ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf
  */
  public static ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf.class);
  }

 /**
  * Convert an instance of ConsoleJsonSyncFailedOpsLogPublisherResponseAllOf to an JSON string
  *
  * @return JSON string
  */
