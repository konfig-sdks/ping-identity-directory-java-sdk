...
public class UuidAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumuuidAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public UuidAttributeSyntaxResponse() {
  }

  public UuidAttributeSyntaxResponse schemas(List<EnumuuidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public UuidAttributeSyntaxResponse addSchemasItem(EnumuuidAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumuuidAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumuuidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public UuidAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public UuidAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public UuidAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UuidAttributeSyntaxResponse instance itself
   */
  public UuidAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UuidAttributeSyntaxResponse uuidAttributeSyntaxResponse = (UuidAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, uuidAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, uuidAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, uuidAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, uuidAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, uuidAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, uuidAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, uuidAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, uuidAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, uuidAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, uuidAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UuidAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UuidAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UuidAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UuidAttributeSyntaxResponse is not found in the empty JSON string", UuidAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UuidAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UuidAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UuidAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UuidAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UuidAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UuidAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, UuidAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public UuidAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UuidAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UuidAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UuidAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to UuidAttributeSyntaxResponse
  */
  public static UuidAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UuidAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of UuidAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
