...
public class AddSimpleSearchReferenceCriteriaRequest {
  ...
  public AddSimpleSearchReferenceCriteriaRequest() {
  }

  public AddSimpleSearchReferenceCriteriaRequest criteriaName(String criteriaName) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest description(String description) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest schemas(List<EnumsimpleSearchReferenceCriteriaSchemaUrn> schemas) {
  ...
  public AddSimpleSearchReferenceCriteriaRequest addSchemasItem(EnumsimpleSearchReferenceCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest allIncludedReferenceControl(List<String> allIncludedReferenceControl) {
  ...
  public AddSimpleSearchReferenceCriteriaRequest addAllIncludedReferenceControlItem(String allIncludedReferenceControlItem) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest anyIncludedReferenceControl(List<String> anyIncludedReferenceControl) {
  ...
  public AddSimpleSearchReferenceCriteriaRequest addAnyIncludedReferenceControlItem(String anyIncludedReferenceControlItem) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest notAllIncludedReferenceControl(List<String> notAllIncludedReferenceControl) {
  ...
  public AddSimpleSearchReferenceCriteriaRequest addNotAllIncludedReferenceControlItem(String notAllIncludedReferenceControlItem) {
  ...
  **/
  ...
  public AddSimpleSearchReferenceCriteriaRequest noneIncludedReferenceControl(List<String> noneIncludedReferenceControl) {
  ...
  public AddSimpleSearchReferenceCriteriaRequest addNoneIncludedReferenceControlItem(String noneIncludedReferenceControlItem) {
  ...
  **/
   ...
   * @return the AddSimpleSearchReferenceCriteriaRequest instance itself
   */
  public AddSimpleSearchReferenceCriteriaRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddSimpleSearchReferenceCriteriaRequest addSimpleSearchReferenceCriteriaRequest = (AddSimpleSearchReferenceCriteriaRequest) o;
    return Objects.equals(this.criteriaName, addSimpleSearchReferenceCriteriaRequest.criteriaName) &&
        Objects.equals(this.description, addSimpleSearchReferenceCriteriaRequest.description) &&
        Objects.equals(this.schemas, addSimpleSearchReferenceCriteriaRequest.schemas) &&
        Objects.equals(this.requestCriteria, addSimpleSearchReferenceCriteriaRequest.requestCriteria) &&
        Objects.equals(this.allIncludedReferenceControl, addSimpleSearchReferenceCriteriaRequest.allIncludedReferenceControl) &&
        Objects.equals(this.anyIncludedReferenceControl, addSimpleSearchReferenceCriteriaRequest.anyIncludedReferenceControl) &&
        Objects.equals(this.notAllIncludedReferenceControl, addSimpleSearchReferenceCriteriaRequest.notAllIncludedReferenceControl) &&
        Objects.equals(this.noneIncludedReferenceControl, addSimpleSearchReferenceCriteriaRequest.noneIncludedReferenceControl)&&
        Objects.equals(this.additionalProperties, addSimpleSearchReferenceCriteriaRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(criteriaName, description, schemas, requestCriteria, allIncludedReferenceControl, anyIncludedReferenceControl, notAllIncludedReferenceControl, noneIncludedReferenceControl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSimpleSearchReferenceCriteriaRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddSimpleSearchReferenceCriteriaRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddSimpleSearchReferenceCriteriaRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSimpleSearchReferenceCriteriaRequest is not found in the empty JSON string", AddSimpleSearchReferenceCriteriaRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSimpleSearchReferenceCriteriaRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSimpleSearchReferenceCriteriaRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSimpleSearchReferenceCriteriaRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSimpleSearchReferenceCriteriaRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSimpleSearchReferenceCriteriaRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSimpleSearchReferenceCriteriaRequest>() {
           @Override
           public void write(JsonWriter out, AddSimpleSearchReferenceCriteriaRequest value) throws IOException {
           ...
           @Override
           public AddSimpleSearchReferenceCriteriaRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddSimpleSearchReferenceCriteriaRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddSimpleSearchReferenceCriteriaRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddSimpleSearchReferenceCriteriaRequest
  * @throws IOException if the JSON string is invalid with respect to AddSimpleSearchReferenceCriteriaRequest
  */
  public static AddSimpleSearchReferenceCriteriaRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSimpleSearchReferenceCriteriaRequest.class);
  }

 /**
  * Convert an instance of AddSimpleSearchReferenceCriteriaRequest to an JSON string
  *
  * @return JSON string
  */
