...
public class GroovyScriptedAlertHandlerShared {
  ...
  public GroovyScriptedAlertHandlerShared() {
  }

  public GroovyScriptedAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared schemas(List<EnumgroovyScriptedAlertHandlerSchemaUrn> schemas) {
  ...
  public GroovyScriptedAlertHandlerShared addSchemasItem(EnumgroovyScriptedAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedAlertHandlerShared addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public GroovyScriptedAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public GroovyScriptedAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public GroovyScriptedAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public GroovyScriptedAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the GroovyScriptedAlertHandlerShared instance itself
   */
  public GroovyScriptedAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedAlertHandlerShared groovyScriptedAlertHandlerShared = (GroovyScriptedAlertHandlerShared) o;
    return Objects.equals(this.description, groovyScriptedAlertHandlerShared.description) &&
        Objects.equals(this.schemas, groovyScriptedAlertHandlerShared.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedAlertHandlerShared.scriptClass) &&
        Objects.equals(this.scriptArgument, groovyScriptedAlertHandlerShared.scriptArgument) &&
        Objects.equals(this.enabled, groovyScriptedAlertHandlerShared.enabled) &&
        Objects.equals(this.asynchronous, groovyScriptedAlertHandlerShared.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, groovyScriptedAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, groovyScriptedAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, groovyScriptedAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, groovyScriptedAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, scriptClass, scriptArgument, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GroovyScriptedAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedAlertHandlerShared is not found in the empty JSON string", GroovyScriptedAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedAlertHandlerShared value) throws IOException {
           ...
           @Override
           public GroovyScriptedAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedAlertHandlerShared
  */
  public static GroovyScriptedAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedAlertHandlerShared.class);
  }

 /**
  * Convert an instance of GroovyScriptedAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
