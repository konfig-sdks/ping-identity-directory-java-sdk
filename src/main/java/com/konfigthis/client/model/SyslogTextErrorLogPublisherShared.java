...
public class SyslogTextErrorLogPublisherShared {
  ...
  public SyslogTextErrorLogPublisherShared() {
  }

  public SyslogTextErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared schemas(List<EnumsyslogTextErrorLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogTextErrorLogPublisherShared addSchemasItem(EnumsyslogTextErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public SyslogTextErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogTextErrorLogPublisherShared addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public SyslogTextErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogTextErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyslogTextErrorLogPublisherShared instance itself
   */
  public SyslogTextErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogTextErrorLogPublisherShared syslogTextErrorLogPublisherShared = (SyslogTextErrorLogPublisherShared) o;
    return Objects.equals(this.description, syslogTextErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, syslogTextErrorLogPublisherShared.schemas) &&
        Objects.equals(this.defaultSeverity, syslogTextErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.syslogExternalServer, syslogTextErrorLogPublisherShared.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogTextErrorLogPublisherShared.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogTextErrorLogPublisherShared.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogTextErrorLogPublisherShared.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogTextErrorLogPublisherShared.syslogMessageApplicationName) &&
        Objects.equals(this.includeProductName, syslogTextErrorLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogTextErrorLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogTextErrorLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogTextErrorLogPublisherShared.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, syslogTextErrorLogPublisherShared.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.timestampPrecision, syslogTextErrorLogPublisherShared.timestampPrecision) &&
        Objects.equals(this.queueSize, syslogTextErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.overrideSeverity, syslogTextErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, syslogTextErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogTextErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syslogTextErrorLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyslogTextErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogTextErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogTextErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogTextErrorLogPublisherShared is not found in the empty JSON string", SyslogTextErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogTextErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogTextErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogTextErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogTextErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogTextErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogTextErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, SyslogTextErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public SyslogTextErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogTextErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogTextErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogTextErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to SyslogTextErrorLogPublisherShared
  */
  public static SyslogTextErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogTextErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of SyslogTextErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
