...
public class UserRestResourceTypeShared {
  ...
  public UserRestResourceTypeShared() {
  }

  public UserRestResourceTypeShared description(String description) {
  ...
  **/
  ...
  public UserRestResourceTypeShared schemas(List<EnumuserRestResourceTypeSchemaUrn> schemas) {
  ...
  public UserRestResourceTypeShared addSchemasItem(EnumuserRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UserRestResourceTypeShared passwordAttributeCategory(String passwordAttributeCategory) {
  ...
  **/
  ...
  public UserRestResourceTypeShared passwordDisplayOrderIndex(Integer passwordDisplayOrderIndex) {
  ...
  **/
  ...
  public UserRestResourceTypeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public UserRestResourceTypeShared resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public UserRestResourceTypeShared structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public UserRestResourceTypeShared auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public UserRestResourceTypeShared addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public UserRestResourceTypeShared searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public UserRestResourceTypeShared includeFilter(List<String> includeFilter) {
  ...
  public UserRestResourceTypeShared addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public UserRestResourceTypeShared parentDN(String parentDN) {
  ...
  **/
  ...
  public UserRestResourceTypeShared parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public UserRestResourceTypeShared relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public UserRestResourceTypeShared createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public UserRestResourceTypeShared postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public UserRestResourceTypeShared addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public UserRestResourceTypeShared updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public UserRestResourceTypeShared addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public UserRestResourceTypeShared displayName(String displayName) {
  ...
  **/
  ...
  public UserRestResourceTypeShared searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public UserRestResourceTypeShared primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public UserRestResourceTypeShared delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public UserRestResourceTypeShared delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public UserRestResourceTypeShared membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public UserRestResourceTypeShared nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
   ...
   * @return the UserRestResourceTypeShared instance itself
   */
  public UserRestResourceTypeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserRestResourceTypeShared userRestResourceTypeShared = (UserRestResourceTypeShared) o;
    return Objects.equals(this.description, userRestResourceTypeShared.description) &&
        Objects.equals(this.schemas, userRestResourceTypeShared.schemas) &&
        Objects.equals(this.passwordAttributeCategory, userRestResourceTypeShared.passwordAttributeCategory) &&
        Objects.equals(this.passwordDisplayOrderIndex, userRestResourceTypeShared.passwordDisplayOrderIndex) &&
        Objects.equals(this.enabled, userRestResourceTypeShared.enabled) &&
        Objects.equals(this.resourceEndpoint, userRestResourceTypeShared.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, userRestResourceTypeShared.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, userRestResourceTypeShared.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, userRestResourceTypeShared.searchBaseDN) &&
        Objects.equals(this.includeFilter, userRestResourceTypeShared.includeFilter) &&
        Objects.equals(this.parentDN, userRestResourceTypeShared.parentDN) &&
        Objects.equals(this.parentResourceType, userRestResourceTypeShared.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, userRestResourceTypeShared.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, userRestResourceTypeShared.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, userRestResourceTypeShared.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, userRestResourceTypeShared.updateConstructedAttribute) &&
        Objects.equals(this.displayName, userRestResourceTypeShared.displayName) &&
        Objects.equals(this.searchFilterPattern, userRestResourceTypeShared.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, userRestResourceTypeShared.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, userRestResourceTypeShared.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, userRestResourceTypeShared.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.membersColumnName, userRestResourceTypeShared.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, userRestResourceTypeShared.nonmembersColumnName)&&
        Objects.equals(this.additionalProperties, userRestResourceTypeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, passwordAttributeCategory, passwordDisplayOrderIndex, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, membersColumnName, nonmembersColumnName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserRestResourceTypeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserRestResourceTypeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserRestResourceTypeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserRestResourceTypeShared is not found in the empty JSON string", UserRestResourceTypeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserRestResourceTypeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserRestResourceTypeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserRestResourceTypeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserRestResourceTypeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserRestResourceTypeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<UserRestResourceTypeShared>() {
           @Override
           public void write(JsonWriter out, UserRestResourceTypeShared value) throws IOException {
           ...
           @Override
           public UserRestResourceTypeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserRestResourceTypeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserRestResourceTypeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserRestResourceTypeShared
  * @throws IOException if the JSON string is invalid with respect to UserRestResourceTypeShared
  */
  public static UserRestResourceTypeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserRestResourceTypeShared.class);
  }

 /**
  * Convert an instance of UserRestResourceTypeShared to an JSON string
  *
  * @return JSON string
  */
