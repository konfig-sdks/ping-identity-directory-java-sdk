...
public class AddGroovyScriptedFileBasedErrorLogPublisherRequest {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest() {
  }

  public AddGroovyScriptedFileBasedErrorLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest schemas(List<EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addSchemasItem(EnumgroovyScriptedFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest logFile(String logFile) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this Scripted File Based Error Log Publisher.")
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest rotationPolicy(List<String> rotationPolicy) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the Scripted File Based Error Log Publisher .")
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest rotationListener(List<String> rotationListener) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest retentionPolicy(List<String> retentionPolicy) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the Scripted File Based Error Log Publisher .")
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest signLog(Boolean signLog) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest append(Boolean append) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Scripted File Based Error Log Publisher will publish records asynchronously.")
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest bufferSize(String bufferSize) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest timeInterval(String timeInterval) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest overrideSeverity(List<String> overrideSeverity) {
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedFileBasedErrorLogPublisherRequest instance itself
   */
  public AddGroovyScriptedFileBasedErrorLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedFileBasedErrorLogPublisherRequest addGroovyScriptedFileBasedErrorLogPublisherRequest = (AddGroovyScriptedFileBasedErrorLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addGroovyScriptedFileBasedErrorLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addGroovyScriptedFileBasedErrorLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedFileBasedErrorLogPublisherRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedFileBasedErrorLogPublisherRequest.scriptClass) &&
        Objects.equals(this.logFile, addGroovyScriptedFileBasedErrorLogPublisherRequest.logFile) &&
        Objects.equals(this.logFilePermissions, addGroovyScriptedFileBasedErrorLogPublisherRequest.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, addGroovyScriptedFileBasedErrorLogPublisherRequest.rotationPolicy) &&
        Objects.equals(this.rotationListener, addGroovyScriptedFileBasedErrorLogPublisherRequest.rotationListener) &&
        Objects.equals(this.retentionPolicy, addGroovyScriptedFileBasedErrorLogPublisherRequest.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, addGroovyScriptedFileBasedErrorLogPublisherRequest.compressionMechanism) &&
        Objects.equals(this.signLog, addGroovyScriptedFileBasedErrorLogPublisherRequest.signLog) &&
        Objects.equals(this.encryptLog, addGroovyScriptedFileBasedErrorLogPublisherRequest.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, addGroovyScriptedFileBasedErrorLogPublisherRequest.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, addGroovyScriptedFileBasedErrorLogPublisherRequest.append) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedFileBasedErrorLogPublisherRequest.scriptArgument) &&
        Objects.equals(this.asynchronous, addGroovyScriptedFileBasedErrorLogPublisherRequest.asynchronous) &&
        Objects.equals(this.autoFlush, addGroovyScriptedFileBasedErrorLogPublisherRequest.autoFlush) &&
        Objects.equals(this.bufferSize, addGroovyScriptedFileBasedErrorLogPublisherRequest.bufferSize) &&
        Objects.equals(this.queueSize, addGroovyScriptedFileBasedErrorLogPublisherRequest.queueSize) &&
        Objects.equals(this.timeInterval, addGroovyScriptedFileBasedErrorLogPublisherRequest.timeInterval) &&
        Objects.equals(this.defaultSeverity, addGroovyScriptedFileBasedErrorLogPublisherRequest.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, addGroovyScriptedFileBasedErrorLogPublisherRequest.overrideSeverity) &&
        Objects.equals(this.enabled, addGroovyScriptedFileBasedErrorLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addGroovyScriptedFileBasedErrorLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedFileBasedErrorLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, scriptClass, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, scriptArgument, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedFileBasedErrorLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedFileBasedErrorLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedFileBasedErrorLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedFileBasedErrorLogPublisherRequest is not found in the empty JSON string", AddGroovyScriptedFileBasedErrorLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedFileBasedErrorLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedFileBasedErrorLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedFileBasedErrorLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedFileBasedErrorLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedFileBasedErrorLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedFileBasedErrorLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedFileBasedErrorLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedFileBasedErrorLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedFileBasedErrorLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedFileBasedErrorLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedFileBasedErrorLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedFileBasedErrorLogPublisherRequest
  */
  public static AddGroovyScriptedFileBasedErrorLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedFileBasedErrorLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedFileBasedErrorLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
