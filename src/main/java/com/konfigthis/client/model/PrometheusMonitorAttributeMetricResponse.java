...
public class PrometheusMonitorAttributeMetricResponse {
  ...
  public PrometheusMonitorAttributeMetricResponse() {
  }

  public PrometheusMonitorAttributeMetricResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Prometheus Monitor Attribute Metric")
  ...
  public PrometheusMonitorAttributeMetricResponse schemas(List<EnumprometheusMonitorAttributeMetricSchemaUrn> schemas) {
  ...
  public PrometheusMonitorAttributeMetricResponse addSchemasItem(EnumprometheusMonitorAttributeMetricSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse metricName(String metricName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse monitorAttributeName(String monitorAttributeName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse monitorObjectClassName(String monitorObjectClassName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse metricType(EnumprometheusMonitorAttributeMetricMetricTypeProp metricType) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse filter(String filter) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse metricDescription(String metricDescription) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse labelNameValuePair(List<String> labelNameValuePair) {
  ...
  public PrometheusMonitorAttributeMetricResponse addLabelNameValuePairItem(String labelNameValuePairItem) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PrometheusMonitorAttributeMetricResponse instance itself
   */
  public PrometheusMonitorAttributeMetricResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrometheusMonitorAttributeMetricResponse prometheusMonitorAttributeMetricResponse = (PrometheusMonitorAttributeMetricResponse) o;
    return Objects.equals(this.id, prometheusMonitorAttributeMetricResponse.id) &&
        Objects.equals(this.schemas, prometheusMonitorAttributeMetricResponse.schemas) &&
        Objects.equals(this.metricName, prometheusMonitorAttributeMetricResponse.metricName) &&
        Objects.equals(this.monitorAttributeName, prometheusMonitorAttributeMetricResponse.monitorAttributeName) &&
        Objects.equals(this.monitorObjectClassName, prometheusMonitorAttributeMetricResponse.monitorObjectClassName) &&
        Objects.equals(this.metricType, prometheusMonitorAttributeMetricResponse.metricType) &&
        Objects.equals(this.filter, prometheusMonitorAttributeMetricResponse.filter) &&
        Objects.equals(this.metricDescription, prometheusMonitorAttributeMetricResponse.metricDescription) &&
        Objects.equals(this.labelNameValuePair, prometheusMonitorAttributeMetricResponse.labelNameValuePair) &&
        Objects.equals(this.meta, prometheusMonitorAttributeMetricResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, prometheusMonitorAttributeMetricResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, prometheusMonitorAttributeMetricResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, schemas, metricName, monitorAttributeName, monitorObjectClassName, metricType, filter, metricDescription, labelNameValuePair, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrometheusMonitorAttributeMetricResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrometheusMonitorAttributeMetricResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrometheusMonitorAttributeMetricResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrometheusMonitorAttributeMetricResponse is not found in the empty JSON string", PrometheusMonitorAttributeMetricResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrometheusMonitorAttributeMetricResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrometheusMonitorAttributeMetricResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrometheusMonitorAttributeMetricResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrometheusMonitorAttributeMetricResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrometheusMonitorAttributeMetricResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrometheusMonitorAttributeMetricResponse>() {
           @Override
           public void write(JsonWriter out, PrometheusMonitorAttributeMetricResponse value) throws IOException {
           ...
           @Override
           public PrometheusMonitorAttributeMetricResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrometheusMonitorAttributeMetricResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrometheusMonitorAttributeMetricResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrometheusMonitorAttributeMetricResponse
  * @throws IOException if the JSON string is invalid with respect to PrometheusMonitorAttributeMetricResponse
  */
  public static PrometheusMonitorAttributeMetricResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrometheusMonitorAttributeMetricResponse.class);
  }

 /**
  * Convert an instance of PrometheusMonitorAttributeMetricResponse to an JSON string
  *
  * @return JSON string
  */
