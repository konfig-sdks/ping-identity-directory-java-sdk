...
public class MetaMeta {
  ...
  public MetaMeta resourceType(String resourceType) {
  ...
  **/
  ...
  public MetaMeta location(String location) {
  ...
  **/
   ...
   * @return the MetaMeta instance itself
   */
  public MetaMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.resourceType, metaMeta.resourceType) &&
        Objects.equals(this.location, metaMeta.location)&&
        Objects.equals(this.additionalProperties, metaMeta.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceType, location, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MetaMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MetaMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<MetaMeta>() {
           ...
           public MetaMeta read(JsonReader in) throws IOException {
             ...
             MetaMeta instance = thisAdapter.fromJsonTree(jsonObj);
