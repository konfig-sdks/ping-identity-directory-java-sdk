...
public class InstanceNameVirtualAttributeResponseAllOf {
  ...
  private List<EnuminstanceNameVirtualAttributeSchemaUrn> schemas = null;
  ...
  public InstanceNameVirtualAttributeResponseAllOf() {
  }

  public InstanceNameVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf schemas(List<EnuminstanceNameVirtualAttributeSchemaUrn> schemas) {
  ...
  public InstanceNameVirtualAttributeResponseAllOf addSchemasItem(EnuminstanceNameVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public InstanceNameVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public InstanceNameVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public InstanceNameVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public InstanceNameVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the InstanceNameVirtualAttributeResponseAllOf instance itself
   */
  public InstanceNameVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceNameVirtualAttributeResponseAllOf instanceNameVirtualAttributeResponseAllOf = (InstanceNameVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, instanceNameVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, instanceNameVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, instanceNameVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, instanceNameVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, instanceNameVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.enabled, instanceNameVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, instanceNameVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, instanceNameVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, instanceNameVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, instanceNameVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, instanceNameVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, instanceNameVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, instanceNameVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, instanceNameVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, instanceNameVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceNameVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstanceNameVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstanceNameVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceNameVirtualAttributeResponseAllOf is not found in the empty JSON string", InstanceNameVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceNameVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceNameVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceNameVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceNameVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceNameVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, InstanceNameVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public InstanceNameVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstanceNameVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InstanceNameVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstanceNameVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to InstanceNameVirtualAttributeResponseAllOf
  */
  public static InstanceNameVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceNameVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of InstanceNameVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
