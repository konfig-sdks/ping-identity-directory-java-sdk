...
public class BrokerExternalServerResponse {
  ...
  private List<EnumbrokerExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  public BrokerExternalServerResponse() {
  }

  public BrokerExternalServerResponse description(String description) {
  ...
  **/
  ...
  public BrokerExternalServerResponse schemas(List<EnumbrokerExternalServerSchemaUrn> schemas) {
  ...
  public BrokerExternalServerResponse addSchemasItem(EnumbrokerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BrokerExternalServerResponse id(String id) {
  ...
  **/
  ...
  public BrokerExternalServerResponse serverHTTPPort(Integer serverHTTPPort) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The port number on which the server listens for HTTP requests.")
  ...
  public BrokerExternalServerResponse useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public BrokerExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public BrokerExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public BrokerExternalServerResponse location(String location) {
  ...
  **/
  ...
  public BrokerExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public BrokerExternalServerResponse password(String password) {
  ...
  **/
  ...
  public BrokerExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public BrokerExternalServerResponse connectionSecurity(EnumexternalServerBrokerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public BrokerExternalServerResponse authenticationMethod(EnumexternalServerBrokerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public BrokerExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public BrokerExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public BrokerExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public BrokerExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public BrokerExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public BrokerExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public BrokerExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public BrokerExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public BrokerExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public BrokerExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public BrokerExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public BrokerExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public BrokerExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public BrokerExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public BrokerExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the BrokerExternalServerResponse instance itself
   */
  public BrokerExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BrokerExternalServerResponse brokerExternalServerResponse = (BrokerExternalServerResponse) o;
    return Objects.equals(this.description, brokerExternalServerResponse.description) &&
        Objects.equals(this.schemas, brokerExternalServerResponse.schemas) &&
        Objects.equals(this.id, brokerExternalServerResponse.id) &&
        Objects.equals(this.serverHTTPPort, brokerExternalServerResponse.serverHTTPPort) &&
        Objects.equals(this.useSSL, brokerExternalServerResponse.useSSL) &&
        Objects.equals(this.serverHostName, brokerExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, brokerExternalServerResponse.serverPort) &&
        Objects.equals(this.location, brokerExternalServerResponse.location) &&
        Objects.equals(this.bindDN, brokerExternalServerResponse.bindDN) &&
        Objects.equals(this.password, brokerExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, brokerExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, brokerExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, brokerExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, brokerExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, brokerExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, brokerExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, brokerExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, brokerExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, brokerExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, brokerExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, brokerExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, brokerExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, brokerExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, brokerExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, brokerExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, brokerExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, brokerExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, brokerExternalServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrokerExternalServerResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("serverHTTPPort");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BrokerExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BrokerExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BrokerExternalServerResponse is not found in the empty JSON string", BrokerExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BrokerExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BrokerExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BrokerExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BrokerExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BrokerExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BrokerExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, BrokerExternalServerResponse value) throws IOException {
           ...
           @Override
           public BrokerExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BrokerExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BrokerExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BrokerExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to BrokerExternalServerResponse
  */
  public static BrokerExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BrokerExternalServerResponse.class);
  }

 /**
  * Convert an instance of BrokerExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
