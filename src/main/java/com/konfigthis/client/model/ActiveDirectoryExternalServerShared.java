...
public class ActiveDirectoryExternalServerShared {
  ...
  public ActiveDirectoryExternalServerShared() {
  }

  public ActiveDirectoryExternalServerShared description(String description) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared schemas(List<EnumactiveDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public ActiveDirectoryExternalServerShared addSchemasItem(EnumactiveDirectoryExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared location(String location) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared password(String password) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared connectionSecurity(EnumexternalServerActiveDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared authenticationMethod(EnumexternalServerActiveDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public ActiveDirectoryExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the ActiveDirectoryExternalServerShared instance itself
   */
  public ActiveDirectoryExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActiveDirectoryExternalServerShared activeDirectoryExternalServerShared = (ActiveDirectoryExternalServerShared) o;
    return Objects.equals(this.description, activeDirectoryExternalServerShared.description) &&
        Objects.equals(this.schemas, activeDirectoryExternalServerShared.schemas) &&
        Objects.equals(this.bindDN, activeDirectoryExternalServerShared.bindDN) &&
        Objects.equals(this.serverHostName, activeDirectoryExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, activeDirectoryExternalServerShared.serverPort) &&
        Objects.equals(this.location, activeDirectoryExternalServerShared.location) &&
        Objects.equals(this.password, activeDirectoryExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, activeDirectoryExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, activeDirectoryExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, activeDirectoryExternalServerShared.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, activeDirectoryExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, activeDirectoryExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, activeDirectoryExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, activeDirectoryExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, activeDirectoryExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, activeDirectoryExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, activeDirectoryExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, activeDirectoryExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, activeDirectoryExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, activeDirectoryExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, activeDirectoryExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, activeDirectoryExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, activeDirectoryExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, bindDN, serverHostName, serverPort, location, password, passphraseProvider, connectionSecurity, authenticationMethod, verifyCredentialsMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActiveDirectoryExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActiveDirectoryExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActiveDirectoryExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveDirectoryExternalServerShared is not found in the empty JSON string", ActiveDirectoryExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActiveDirectoryExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActiveDirectoryExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActiveDirectoryExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActiveDirectoryExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActiveDirectoryExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ActiveDirectoryExternalServerShared>() {
           @Override
           public void write(JsonWriter out, ActiveDirectoryExternalServerShared value) throws IOException {
           ...
           @Override
           public ActiveDirectoryExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActiveDirectoryExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActiveDirectoryExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActiveDirectoryExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to ActiveDirectoryExternalServerShared
  */
  public static ActiveDirectoryExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActiveDirectoryExternalServerShared.class);
  }

 /**
  * Convert an instance of ActiveDirectoryExternalServerShared to an JSON string
  *
  * @return JSON string
  */
