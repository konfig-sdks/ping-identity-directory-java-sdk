...
public class AddHttpConnectionHandlerRequest {
  ...
  public AddHttpConnectionHandlerRequest() {
  }

  public AddHttpConnectionHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest schemas(List<EnumhttpConnectionHandlerSchemaUrn> schemas) {
  ...
  public AddHttpConnectionHandlerRequest addSchemasItem(EnumhttpConnectionHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest listenAddress(String listenAddress) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest listenPort(Integer listenPort) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest httpServletExtension(List<String> httpServletExtension) {
  ...
  public AddHttpConnectionHandlerRequest addHttpServletExtensionItem(String httpServletExtensionItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest webApplicationExtension(List<String> webApplicationExtension) {
  ...
  public AddHttpConnectionHandlerRequest addWebApplicationExtensionItem(String webApplicationExtensionItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest httpOperationLogPublisher(List<String> httpOperationLogPublisher) {
  ...
  public AddHttpConnectionHandlerRequest addHttpOperationLogPublisherItem(String httpOperationLogPublisherItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest sslProtocol(List<String> sslProtocol) {
  ...
  public AddHttpConnectionHandlerRequest addSslProtocolItem(String sslProtocolItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest sslCipherSuite(List<String> sslCipherSuite) {
  ...
  public AddHttpConnectionHandlerRequest addSslCipherSuiteItem(String sslCipherSuiteItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest numRequestHandlers(Integer numRequestHandlers) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest keepStats(Boolean keepStats) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest acceptBacklog(Integer acceptBacklog) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest allowTCPReuseAddress(Boolean allowTCPReuseAddress) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest idleTimeLimit(String idleTimeLimit) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest lowResourcesConnectionThreshold(Integer lowResourcesConnectionThreshold) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest lowResourcesIdleTimeLimit(String lowResourcesIdleTimeLimit) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest enableMultipartMIMEParameters(Boolean enableMultipartMIMEParameters) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest useForwardedHeaders(Boolean useForwardedHeaders) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest httpRequestHeaderSize(Integer httpRequestHeaderSize) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest responseHeader(List<String> responseHeader) {
  ...
  public AddHttpConnectionHandlerRequest addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest useCorrelationIDHeader(Boolean useCorrelationIDHeader) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest correlationIDRequestHeader(List<String> correlationIDRequestHeader) {
  ...
  public AddHttpConnectionHandlerRequest addCorrelationIDRequestHeaderItem(String correlationIDRequestHeaderItem) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest sslClientAuthPolicy(EnumconnectionHandlerSslClientAuthPolicyProp sslClientAuthPolicy) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest enableSniHostnameChecks(Boolean enableSniHostnameChecks) {
  ...
  **/
  ...
  public AddHttpConnectionHandlerRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddHttpConnectionHandlerRequest instance itself
   */
  public AddHttpConnectionHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddHttpConnectionHandlerRequest addHttpConnectionHandlerRequest = (AddHttpConnectionHandlerRequest) o;
    return Objects.equals(this.handlerName, addHttpConnectionHandlerRequest.handlerName) &&
        Objects.equals(this.description, addHttpConnectionHandlerRequest.description) &&
        Objects.equals(this.schemas, addHttpConnectionHandlerRequest.schemas) &&
        Objects.equals(this.listenAddress, addHttpConnectionHandlerRequest.listenAddress) &&
        Objects.equals(this.listenPort, addHttpConnectionHandlerRequest.listenPort) &&
        Objects.equals(this.useSSL, addHttpConnectionHandlerRequest.useSSL) &&
        Objects.equals(this.sslCertNickname, addHttpConnectionHandlerRequest.sslCertNickname) &&
        Objects.equals(this.httpServletExtension, addHttpConnectionHandlerRequest.httpServletExtension) &&
        Objects.equals(this.webApplicationExtension, addHttpConnectionHandlerRequest.webApplicationExtension) &&
        Objects.equals(this.httpOperationLogPublisher, addHttpConnectionHandlerRequest.httpOperationLogPublisher) &&
        Objects.equals(this.sslProtocol, addHttpConnectionHandlerRequest.sslProtocol) &&
        Objects.equals(this.sslCipherSuite, addHttpConnectionHandlerRequest.sslCipherSuite) &&
        Objects.equals(this.keyManagerProvider, addHttpConnectionHandlerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addHttpConnectionHandlerRequest.trustManagerProvider) &&
        Objects.equals(this.numRequestHandlers, addHttpConnectionHandlerRequest.numRequestHandlers) &&
        Objects.equals(this.keepStats, addHttpConnectionHandlerRequest.keepStats) &&
        Objects.equals(this.acceptBacklog, addHttpConnectionHandlerRequest.acceptBacklog) &&
        Objects.equals(this.allowTCPReuseAddress, addHttpConnectionHandlerRequest.allowTCPReuseAddress) &&
        Objects.equals(this.idleTimeLimit, addHttpConnectionHandlerRequest.idleTimeLimit) &&
        Objects.equals(this.lowResourcesConnectionThreshold, addHttpConnectionHandlerRequest.lowResourcesConnectionThreshold) &&
        Objects.equals(this.lowResourcesIdleTimeLimit, addHttpConnectionHandlerRequest.lowResourcesIdleTimeLimit) &&
        Objects.equals(this.enableMultipartMIMEParameters, addHttpConnectionHandlerRequest.enableMultipartMIMEParameters) &&
        Objects.equals(this.useForwardedHeaders, addHttpConnectionHandlerRequest.useForwardedHeaders) &&
        Objects.equals(this.httpRequestHeaderSize, addHttpConnectionHandlerRequest.httpRequestHeaderSize) &&
        Objects.equals(this.responseHeader, addHttpConnectionHandlerRequest.responseHeader) &&
        Objects.equals(this.useCorrelationIDHeader, addHttpConnectionHandlerRequest.useCorrelationIDHeader) &&
        Objects.equals(this.correlationIDResponseHeader, addHttpConnectionHandlerRequest.correlationIDResponseHeader) &&
        Objects.equals(this.correlationIDRequestHeader, addHttpConnectionHandlerRequest.correlationIDRequestHeader) &&
        Objects.equals(this.sslClientAuthPolicy, addHttpConnectionHandlerRequest.sslClientAuthPolicy) &&
        Objects.equals(this.enableSniHostnameChecks, addHttpConnectionHandlerRequest.enableSniHostnameChecks) &&
        Objects.equals(this.enabled, addHttpConnectionHandlerRequest.enabled)&&
        Objects.equals(this.additionalProperties, addHttpConnectionHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, listenAddress, listenPort, useSSL, sslCertNickname, httpServletExtension, webApplicationExtension, httpOperationLogPublisher, sslProtocol, sslCipherSuite, keyManagerProvider, trustManagerProvider, numRequestHandlers, keepStats, acceptBacklog, allowTCPReuseAddress, idleTimeLimit, lowResourcesConnectionThreshold, lowResourcesIdleTimeLimit, enableMultipartMIMEParameters, useForwardedHeaders, httpRequestHeaderSize, responseHeader, useCorrelationIDHeader, correlationIDResponseHeader, correlationIDRequestHeader, sslClientAuthPolicy, enableSniHostnameChecks, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddHttpConnectionHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddHttpConnectionHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddHttpConnectionHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHttpConnectionHandlerRequest is not found in the empty JSON string", AddHttpConnectionHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddHttpConnectionHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHttpConnectionHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHttpConnectionHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHttpConnectionHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHttpConnectionHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHttpConnectionHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddHttpConnectionHandlerRequest value) throws IOException {
           ...
           @Override
           public AddHttpConnectionHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddHttpConnectionHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddHttpConnectionHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddHttpConnectionHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddHttpConnectionHandlerRequest
  */
  public static AddHttpConnectionHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHttpConnectionHandlerRequest.class);
  }

 /**
  * Convert an instance of AddHttpConnectionHandlerRequest to an JSON string
  *
  * @return JSON string
  */
