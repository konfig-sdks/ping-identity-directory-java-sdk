...
public class ThirdPartyNotificationManagerResponse {
  ...
  public ThirdPartyNotificationManagerResponse() {
  }

  public ThirdPartyNotificationManagerResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Notification Manager")
  ...
  public ThirdPartyNotificationManagerResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse schemas(List<EnumthirdPartyNotificationManagerSchemaUrn> schemas) {
  ...
  public ThirdPartyNotificationManagerResponse addSchemasItem(EnumthirdPartyNotificationManagerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyNotificationManagerResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse subscriptionBaseDN(String subscriptionBaseDN) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse transactionNotification(EnumnotificationManagerTransactionNotificationProp transactionNotification) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse monitorEntriesEnabled(Boolean monitorEntriesEnabled) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyNotificationManagerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyNotificationManagerResponse instance itself
   */
  public ThirdPartyNotificationManagerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyNotificationManagerResponse thirdPartyNotificationManagerResponse = (ThirdPartyNotificationManagerResponse) o;
    return Objects.equals(this.id, thirdPartyNotificationManagerResponse.id) &&
        Objects.equals(this.description, thirdPartyNotificationManagerResponse.description) &&
        Objects.equals(this.schemas, thirdPartyNotificationManagerResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyNotificationManagerResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyNotificationManagerResponse.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyNotificationManagerResponse.enabled) &&
        Objects.equals(this.subscriptionBaseDN, thirdPartyNotificationManagerResponse.subscriptionBaseDN) &&
        Objects.equals(this.transactionNotification, thirdPartyNotificationManagerResponse.transactionNotification) &&
        Objects.equals(this.monitorEntriesEnabled, thirdPartyNotificationManagerResponse.monitorEntriesEnabled) &&
        Objects.equals(this.meta, thirdPartyNotificationManagerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyNotificationManagerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyNotificationManagerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, enabled, subscriptionBaseDN, transactionNotification, monitorEntriesEnabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyNotificationManagerResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("transactionNotification");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyNotificationManagerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyNotificationManagerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyNotificationManagerResponse is not found in the empty JSON string", ThirdPartyNotificationManagerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyNotificationManagerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyNotificationManagerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyNotificationManagerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyNotificationManagerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyNotificationManagerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyNotificationManagerResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyNotificationManagerResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyNotificationManagerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyNotificationManagerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyNotificationManagerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyNotificationManagerResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyNotificationManagerResponse
  */
  public static ThirdPartyNotificationManagerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyNotificationManagerResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyNotificationManagerResponse to an JSON string
  *
  * @return JSON string
  */
