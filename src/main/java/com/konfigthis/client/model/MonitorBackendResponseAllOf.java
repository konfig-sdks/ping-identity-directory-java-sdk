...
public class MonitorBackendResponseAllOf {
  ...
  private List<EnummonitorBackendSchemaUrn> schemas = null;
  ...
  public MonitorBackendResponseAllOf() {
  }

  public MonitorBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf schemas(List<EnummonitorBackendSchemaUrn> schemas) {
  ...
  public MonitorBackendResponseAllOf addSchemasItem(EnummonitorBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public MonitorBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public MonitorBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the MonitorBackendResponseAllOf instance itself
   */
  public MonitorBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MonitorBackendResponseAllOf monitorBackendResponseAllOf = (MonitorBackendResponseAllOf) o;
    return Objects.equals(this.description, monitorBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, monitorBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, monitorBackendResponseAllOf.id) &&
        Objects.equals(this.backendID, monitorBackendResponseAllOf.backendID) &&
        Objects.equals(this.baseDN, monitorBackendResponseAllOf.baseDN) &&
        Objects.equals(this.enabled, monitorBackendResponseAllOf.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, monitorBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, monitorBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.notificationManager, monitorBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, monitorBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, backendID, baseDN, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MonitorBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MonitorBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MonitorBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MonitorBackendResponseAllOf is not found in the empty JSON string", MonitorBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MonitorBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MonitorBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MonitorBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MonitorBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MonitorBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, MonitorBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public MonitorBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MonitorBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MonitorBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MonitorBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to MonitorBackendResponseAllOf
  */
  public static MonitorBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MonitorBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of MonitorBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
