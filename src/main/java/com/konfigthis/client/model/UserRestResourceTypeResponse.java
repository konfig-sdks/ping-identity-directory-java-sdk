...
public class UserRestResourceTypeResponse {
  ...
  public UserRestResourceTypeResponse() {
  }

  public UserRestResourceTypeResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the REST Resource Type")
  ...
  public UserRestResourceTypeResponse description(String description) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse schemas(List<EnumuserRestResourceTypeSchemaUrn> schemas) {
  ...
  public UserRestResourceTypeResponse addSchemasItem(EnumuserRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse passwordAttributeCategory(String passwordAttributeCategory) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse passwordDisplayOrderIndex(Integer passwordDisplayOrderIndex) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public UserRestResourceTypeResponse addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse includeFilter(List<String> includeFilter) {
  ...
  public UserRestResourceTypeResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse parentDN(String parentDN) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public UserRestResourceTypeResponse addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public UserRestResourceTypeResponse addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse displayName(String displayName) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UserRestResourceTypeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UserRestResourceTypeResponse instance itself
   */
  public UserRestResourceTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserRestResourceTypeResponse userRestResourceTypeResponse = (UserRestResourceTypeResponse) o;
    return Objects.equals(this.id, userRestResourceTypeResponse.id) &&
        Objects.equals(this.description, userRestResourceTypeResponse.description) &&
        Objects.equals(this.schemas, userRestResourceTypeResponse.schemas) &&
        Objects.equals(this.passwordAttributeCategory, userRestResourceTypeResponse.passwordAttributeCategory) &&
        Objects.equals(this.passwordDisplayOrderIndex, userRestResourceTypeResponse.passwordDisplayOrderIndex) &&
        Objects.equals(this.enabled, userRestResourceTypeResponse.enabled) &&
        Objects.equals(this.resourceEndpoint, userRestResourceTypeResponse.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, userRestResourceTypeResponse.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, userRestResourceTypeResponse.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, userRestResourceTypeResponse.searchBaseDN) &&
        Objects.equals(this.includeFilter, userRestResourceTypeResponse.includeFilter) &&
        Objects.equals(this.parentDN, userRestResourceTypeResponse.parentDN) &&
        Objects.equals(this.parentResourceType, userRestResourceTypeResponse.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, userRestResourceTypeResponse.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, userRestResourceTypeResponse.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, userRestResourceTypeResponse.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, userRestResourceTypeResponse.updateConstructedAttribute) &&
        Objects.equals(this.displayName, userRestResourceTypeResponse.displayName) &&
        Objects.equals(this.searchFilterPattern, userRestResourceTypeResponse.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, userRestResourceTypeResponse.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, userRestResourceTypeResponse.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, userRestResourceTypeResponse.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.membersColumnName, userRestResourceTypeResponse.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, userRestResourceTypeResponse.nonmembersColumnName) &&
        Objects.equals(this.meta, userRestResourceTypeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, userRestResourceTypeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, userRestResourceTypeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, passwordAttributeCategory, passwordDisplayOrderIndex, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, membersColumnName, nonmembersColumnName, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserRestResourceTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserRestResourceTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserRestResourceTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserRestResourceTypeResponse is not found in the empty JSON string", UserRestResourceTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserRestResourceTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserRestResourceTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserRestResourceTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserRestResourceTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserRestResourceTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UserRestResourceTypeResponse>() {
           @Override
           public void write(JsonWriter out, UserRestResourceTypeResponse value) throws IOException {
           ...
           @Override
           public UserRestResourceTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserRestResourceTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserRestResourceTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserRestResourceTypeResponse
  * @throws IOException if the JSON string is invalid with respect to UserRestResourceTypeResponse
  */
  public static UserRestResourceTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserRestResourceTypeResponse.class);
  }

 /**
  * Convert an instance of UserRestResourceTypeResponse to an JSON string
  *
  * @return JSON string
  */
