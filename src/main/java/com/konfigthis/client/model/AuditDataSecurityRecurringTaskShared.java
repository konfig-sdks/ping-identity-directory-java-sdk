...
public class AuditDataSecurityRecurringTaskShared {
  ...
  public AuditDataSecurityRecurringTaskShared() {
  }

  public AuditDataSecurityRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared schemas(List<EnumauditDataSecurityRecurringTaskSchemaUrn> schemas) {
  ...
  public AuditDataSecurityRecurringTaskShared addSchemasItem(EnumauditDataSecurityRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared baseOutputDirectory(String baseOutputDirectory) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared dataSecurityAuditor(List<String> dataSecurityAuditor) {
  ...
  public AuditDataSecurityRecurringTaskShared addDataSecurityAuditorItem(String dataSecurityAuditorItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared backend(List<String> backend) {
  ...
  public AuditDataSecurityRecurringTaskShared addBackendItem(String backendItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared includeFilter(List<String> includeFilter) {
  ...
  public AuditDataSecurityRecurringTaskShared addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared retainPreviousReportCount(Integer retainPreviousReportCount) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared retainPreviousReportAge(String retainPreviousReportAge) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public AuditDataSecurityRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AuditDataSecurityRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public AuditDataSecurityRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AuditDataSecurityRecurringTaskShared instance itself
   */
  public AuditDataSecurityRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuditDataSecurityRecurringTaskShared auditDataSecurityRecurringTaskShared = (AuditDataSecurityRecurringTaskShared) o;
    return Objects.equals(this.description, auditDataSecurityRecurringTaskShared.description) &&
        Objects.equals(this.schemas, auditDataSecurityRecurringTaskShared.schemas) &&
        Objects.equals(this.baseOutputDirectory, auditDataSecurityRecurringTaskShared.baseOutputDirectory) &&
        Objects.equals(this.dataSecurityAuditor, auditDataSecurityRecurringTaskShared.dataSecurityAuditor) &&
        Objects.equals(this.backend, auditDataSecurityRecurringTaskShared.backend) &&
        Objects.equals(this.includeFilter, auditDataSecurityRecurringTaskShared.includeFilter) &&
        Objects.equals(this.retainPreviousReportCount, auditDataSecurityRecurringTaskShared.retainPreviousReportCount) &&
        Objects.equals(this.retainPreviousReportAge, auditDataSecurityRecurringTaskShared.retainPreviousReportAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, auditDataSecurityRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, auditDataSecurityRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, auditDataSecurityRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, auditDataSecurityRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, auditDataSecurityRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, auditDataSecurityRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, auditDataSecurityRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, auditDataSecurityRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, baseOutputDirectory, dataSecurityAuditor, backend, includeFilter, retainPreviousReportCount, retainPreviousReportAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuditDataSecurityRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuditDataSecurityRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuditDataSecurityRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuditDataSecurityRecurringTaskShared is not found in the empty JSON string", AuditDataSecurityRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuditDataSecurityRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditDataSecurityRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditDataSecurityRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditDataSecurityRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditDataSecurityRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditDataSecurityRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, AuditDataSecurityRecurringTaskShared value) throws IOException {
           ...
           @Override
           public AuditDataSecurityRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AuditDataSecurityRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AuditDataSecurityRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuditDataSecurityRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to AuditDataSecurityRecurringTaskShared
  */
  public static AuditDataSecurityRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuditDataSecurityRecurringTaskShared.class);
  }

 /**
  * Convert an instance of AuditDataSecurityRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
