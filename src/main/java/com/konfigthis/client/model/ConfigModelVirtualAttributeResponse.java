...
import com.konfigthis.client.model.EnumconfigModelVirtualAttributeSchemaUrn;
...
public class ConfigModelVirtualAttributeResponse {
  ...
  private List<EnumconfigModelVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConfigModelVirtualAttributeResponse() {
  }

  public ConfigModelVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse schemas(List<EnumconfigModelVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConfigModelVirtualAttributeResponse addSchemasItem(EnumconfigModelVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumconfigModelVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumconfigModelVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConfigModelVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public ConfigModelVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ConfigModelVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConfigModelVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConfigModelVirtualAttributeResponse instance itself
   */
  public ConfigModelVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigModelVirtualAttributeResponse configModelVirtualAttributeResponse = (ConfigModelVirtualAttributeResponse) o;
    return Objects.equals(this.description, configModelVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, configModelVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, configModelVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, configModelVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, configModelVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.requireExplicitRequestByName, configModelVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.enabled, configModelVirtualAttributeResponse.enabled) &&
        Objects.equals(this.groupDN, configModelVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, configModelVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, configModelVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, configModelVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, configModelVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, configModelVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, configModelVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, configModelVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, requireExplicitRequestByName, enabled, groupDN, clientConnectionPolicy, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConfigModelVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConfigModelVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConfigModelVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigModelVirtualAttributeResponse is not found in the empty JSON string", ConfigModelVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigModelVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigModelVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigModelVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigModelVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigModelVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigModelVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, ConfigModelVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public ConfigModelVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConfigModelVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConfigModelVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConfigModelVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to ConfigModelVirtualAttributeResponse
  */
  public static ConfigModelVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigModelVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of ConfigModelVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
