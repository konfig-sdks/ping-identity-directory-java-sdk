...
public class AddThirdPartyPassThroughAuthenticationHandlerRequest {
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest() {
  }

  public AddThirdPartyPassThroughAuthenticationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest schemas(List<EnumthirdPartyPassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest addSchemasItem(EnumthirdPartyPassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddThirdPartyPassThroughAuthenticationHandlerRequest requestCriteria(String requestCriteria) {
  ...
  **/
   ...
   * @return the AddThirdPartyPassThroughAuthenticationHandlerRequest instance itself
   */
  public AddThirdPartyPassThroughAuthenticationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyPassThroughAuthenticationHandlerRequest addThirdPartyPassThroughAuthenticationHandlerRequest = (AddThirdPartyPassThroughAuthenticationHandlerRequest) o;
    return Objects.equals(this.handlerName, addThirdPartyPassThroughAuthenticationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addThirdPartyPassThroughAuthenticationHandlerRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyPassThroughAuthenticationHandlerRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyPassThroughAuthenticationHandlerRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyPassThroughAuthenticationHandlerRequest.extensionArgument) &&
        Objects.equals(this.includedLocalEntryBaseDN, addThirdPartyPassThroughAuthenticationHandlerRequest.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, addThirdPartyPassThroughAuthenticationHandlerRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addThirdPartyPassThroughAuthenticationHandlerRequest.requestCriteria)&&
        Objects.equals(this.additionalProperties, addThirdPartyPassThroughAuthenticationHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, extensionClass, extensionArgument, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyPassThroughAuthenticationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyPassThroughAuthenticationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyPassThroughAuthenticationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyPassThroughAuthenticationHandlerRequest is not found in the empty JSON string", AddThirdPartyPassThroughAuthenticationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyPassThroughAuthenticationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyPassThroughAuthenticationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyPassThroughAuthenticationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyPassThroughAuthenticationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyPassThroughAuthenticationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyPassThroughAuthenticationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyPassThroughAuthenticationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyPassThroughAuthenticationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyPassThroughAuthenticationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyPassThroughAuthenticationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyPassThroughAuthenticationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyPassThroughAuthenticationHandlerRequest
  */
  public static AddThirdPartyPassThroughAuthenticationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyPassThroughAuthenticationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyPassThroughAuthenticationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
