...
public class AddJmxAlertHandlerRequest {
  ...
  public AddJmxAlertHandlerRequest() {
  }

  public AddJmxAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest schemas(List<EnumjmxAlertHandlerSchemaUrn> schemas) {
  ...
  public AddJmxAlertHandlerRequest addSchemasItem(EnumjmxAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddJmxAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddJmxAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddJmxAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddJmxAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddJmxAlertHandlerRequest instance itself
   */
  public AddJmxAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddJmxAlertHandlerRequest addJmxAlertHandlerRequest = (AddJmxAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addJmxAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addJmxAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addJmxAlertHandlerRequest.schemas) &&
        Objects.equals(this.asynchronous, addJmxAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabled, addJmxAlertHandlerRequest.enabled) &&
        Objects.equals(this.enabledAlertSeverity, addJmxAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addJmxAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addJmxAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addJmxAlertHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, asynchronous, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddJmxAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddJmxAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddJmxAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddJmxAlertHandlerRequest is not found in the empty JSON string", AddJmxAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddJmxAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddJmxAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddJmxAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddJmxAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddJmxAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddJmxAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddJmxAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddJmxAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddJmxAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddJmxAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddJmxAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddJmxAlertHandlerRequest
  */
  public static AddJmxAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddJmxAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddJmxAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
