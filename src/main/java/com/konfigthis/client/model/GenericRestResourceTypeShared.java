...
public class GenericRestResourceTypeShared {
  ...
  public GenericRestResourceTypeShared() {
  }

  public GenericRestResourceTypeShared description(String description) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared schemas(List<EnumgenericRestResourceTypeSchemaUrn> schemas) {
  ...
  public GenericRestResourceTypeShared addSchemasItem(EnumgenericRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public GenericRestResourceTypeShared addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared includeFilter(List<String> includeFilter) {
  ...
  public GenericRestResourceTypeShared addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared parentDN(String parentDN) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public GenericRestResourceTypeShared addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public GenericRestResourceTypeShared addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared displayName(String displayName) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public GenericRestResourceTypeShared nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
   ...
   * @return the GenericRestResourceTypeShared instance itself
   */
  public GenericRestResourceTypeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenericRestResourceTypeShared genericRestResourceTypeShared = (GenericRestResourceTypeShared) o;
    return Objects.equals(this.description, genericRestResourceTypeShared.description) &&
        Objects.equals(this.schemas, genericRestResourceTypeShared.schemas) &&
        Objects.equals(this.enabled, genericRestResourceTypeShared.enabled) &&
        Objects.equals(this.resourceEndpoint, genericRestResourceTypeShared.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, genericRestResourceTypeShared.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, genericRestResourceTypeShared.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, genericRestResourceTypeShared.searchBaseDN) &&
        Objects.equals(this.includeFilter, genericRestResourceTypeShared.includeFilter) &&
        Objects.equals(this.parentDN, genericRestResourceTypeShared.parentDN) &&
        Objects.equals(this.parentResourceType, genericRestResourceTypeShared.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, genericRestResourceTypeShared.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, genericRestResourceTypeShared.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, genericRestResourceTypeShared.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, genericRestResourceTypeShared.updateConstructedAttribute) &&
        Objects.equals(this.displayName, genericRestResourceTypeShared.displayName) &&
        Objects.equals(this.searchFilterPattern, genericRestResourceTypeShared.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, genericRestResourceTypeShared.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, genericRestResourceTypeShared.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, genericRestResourceTypeShared.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.membersColumnName, genericRestResourceTypeShared.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, genericRestResourceTypeShared.nonmembersColumnName)&&
        Objects.equals(this.additionalProperties, genericRestResourceTypeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, membersColumnName, nonmembersColumnName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenericRestResourceTypeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericRestResourceTypeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericRestResourceTypeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericRestResourceTypeShared is not found in the empty JSON string", GenericRestResourceTypeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenericRestResourceTypeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenericRestResourceTypeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenericRestResourceTypeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenericRestResourceTypeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenericRestResourceTypeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GenericRestResourceTypeShared>() {
           @Override
           public void write(JsonWriter out, GenericRestResourceTypeShared value) throws IOException {
           ...
           @Override
           public GenericRestResourceTypeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenericRestResourceTypeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenericRestResourceTypeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenericRestResourceTypeShared
  * @throws IOException if the JSON string is invalid with respect to GenericRestResourceTypeShared
  */
  public static GenericRestResourceTypeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericRestResourceTypeShared.class);
  }

 /**
  * Convert an instance of GenericRestResourceTypeShared to an JSON string
  *
  * @return JSON string
  */
