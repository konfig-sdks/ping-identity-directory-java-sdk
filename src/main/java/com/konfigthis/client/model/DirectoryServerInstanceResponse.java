...
public class DirectoryServerInstanceResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumdirectoryServerInstanceSchemaUrn> schemas = new ArrayList<>();
  ...
  public DirectoryServerInstanceResponse() {
  }

  public DirectoryServerInstanceResponse schemas(List<EnumdirectoryServerInstanceSchemaUrn> schemas) {
  ...
  public DirectoryServerInstanceResponse addSchemasItem(EnumdirectoryServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse id(String id) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse replicationSetName(String replicationSetName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse loadBalancingAlgorithmName(List<String> loadBalancingAlgorithmName) {
  ...
  public DirectoryServerInstanceResponse addLoadBalancingAlgorithmNameItem(String loadBalancingAlgorithmNameItem) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse clusterName(String clusterName) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse hostname(String hostname) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse serverRoot(String serverRoot) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse serverVersion(String serverVersion) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse httpPort(Integer httpPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public DirectoryServerInstanceResponse addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse baseDN(List<String> baseDN) {
  ...
  public DirectoryServerInstanceResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public DirectoryServerInstanceResponse addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DirectoryServerInstanceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DirectoryServerInstanceResponse instance itself
   */
  public DirectoryServerInstanceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DirectoryServerInstanceResponse directoryServerInstanceResponse = (DirectoryServerInstanceResponse) o;
    return Objects.equals(this.schemas, directoryServerInstanceResponse.schemas) &&
        Objects.equals(this.id, directoryServerInstanceResponse.id) &&
        Objects.equals(this.serverInstanceType, directoryServerInstanceResponse.serverInstanceType) &&
        Objects.equals(this.replicationSetName, directoryServerInstanceResponse.replicationSetName) &&
        Objects.equals(this.loadBalancingAlgorithmName, directoryServerInstanceResponse.loadBalancingAlgorithmName) &&
        Objects.equals(this.serverInstanceName, directoryServerInstanceResponse.serverInstanceName) &&
        Objects.equals(this.clusterName, directoryServerInstanceResponse.clusterName) &&
        Objects.equals(this.serverInstanceLocation, directoryServerInstanceResponse.serverInstanceLocation) &&
        Objects.equals(this.hostname, directoryServerInstanceResponse.hostname) &&
        Objects.equals(this.serverRoot, directoryServerInstanceResponse.serverRoot) &&
        Objects.equals(this.serverVersion, directoryServerInstanceResponse.serverVersion) &&
        Objects.equals(this.interServerCertificate, directoryServerInstanceResponse.interServerCertificate) &&
        Objects.equals(this.ldapPort, directoryServerInstanceResponse.ldapPort) &&
        Objects.equals(this.ldapsPort, directoryServerInstanceResponse.ldapsPort) &&
        Objects.equals(this.httpPort, directoryServerInstanceResponse.httpPort) &&
        Objects.equals(this.httpsPort, directoryServerInstanceResponse.httpsPort) &&
        Objects.equals(this.replicationPort, directoryServerInstanceResponse.replicationPort) &&
        Objects.equals(this.replicationServerID, directoryServerInstanceResponse.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, directoryServerInstanceResponse.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, directoryServerInstanceResponse.jmxPort) &&
        Objects.equals(this.jmxsPort, directoryServerInstanceResponse.jmxsPort) &&
        Objects.equals(this.preferredSecurity, directoryServerInstanceResponse.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, directoryServerInstanceResponse.startTLSEnabled) &&
        Objects.equals(this.baseDN, directoryServerInstanceResponse.baseDN) &&
        Objects.equals(this.memberOfServerGroup, directoryServerInstanceResponse.memberOfServerGroup) &&
        Objects.equals(this.meta, directoryServerInstanceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, directoryServerInstanceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, directoryServerInstanceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DirectoryServerInstanceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DirectoryServerInstanceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DirectoryServerInstanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DirectoryServerInstanceResponse is not found in the empty JSON string", DirectoryServerInstanceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DirectoryServerInstanceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DirectoryServerInstanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DirectoryServerInstanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DirectoryServerInstanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DirectoryServerInstanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DirectoryServerInstanceResponse>() {
           @Override
           public void write(JsonWriter out, DirectoryServerInstanceResponse value) throws IOException {
           ...
           @Override
           public DirectoryServerInstanceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DirectoryServerInstanceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DirectoryServerInstanceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DirectoryServerInstanceResponse
  * @throws IOException if the JSON string is invalid with respect to DirectoryServerInstanceResponse
  */
  public static DirectoryServerInstanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DirectoryServerInstanceResponse.class);
  }

 /**
  * Convert an instance of DirectoryServerInstanceResponse to an JSON string
  *
  * @return JSON string
  */
