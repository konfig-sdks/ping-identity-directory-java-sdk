...
public class AddHttpServletCrossOriginPolicyRequest {
  ...
  public AddHttpServletCrossOriginPolicyRequest() {
  }

  public AddHttpServletCrossOriginPolicyRequest policyName(String policyName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new HTTP Servlet Cross Origin Policy")
  ...
  public AddHttpServletCrossOriginPolicyRequest description(String description) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest schemas(List<EnumhttpServletCrossOriginPolicySchemaUrn> schemas) {
  ...
  public AddHttpServletCrossOriginPolicyRequest addSchemasItem(EnumhttpServletCrossOriginPolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsAllowedMethods(List<String> corsAllowedMethods) {
  ...
  public AddHttpServletCrossOriginPolicyRequest addCorsAllowedMethodsItem(String corsAllowedMethodsItem) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsAllowedOrigins(List<String> corsAllowedOrigins) {
  ...
  public AddHttpServletCrossOriginPolicyRequest addCorsAllowedOriginsItem(String corsAllowedOriginsItem) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsExposedHeaders(List<String> corsExposedHeaders) {
  ...
  public AddHttpServletCrossOriginPolicyRequest addCorsExposedHeadersItem(String corsExposedHeadersItem) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsAllowedHeaders(List<String> corsAllowedHeaders) {
  ...
  public AddHttpServletCrossOriginPolicyRequest addCorsAllowedHeadersItem(String corsAllowedHeadersItem) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsPreflightMaxAge(String corsPreflightMaxAge) {
  ...
  **/
  ...
  public AddHttpServletCrossOriginPolicyRequest corsAllowCredentials(Boolean corsAllowCredentials) {
  ...
  **/
   ...
   * @return the AddHttpServletCrossOriginPolicyRequest instance itself
   */
  public AddHttpServletCrossOriginPolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddHttpServletCrossOriginPolicyRequest addHttpServletCrossOriginPolicyRequest = (AddHttpServletCrossOriginPolicyRequest) o;
    return Objects.equals(this.policyName, addHttpServletCrossOriginPolicyRequest.policyName) &&
        Objects.equals(this.description, addHttpServletCrossOriginPolicyRequest.description) &&
        Objects.equals(this.schemas, addHttpServletCrossOriginPolicyRequest.schemas) &&
        Objects.equals(this.corsAllowedMethods, addHttpServletCrossOriginPolicyRequest.corsAllowedMethods) &&
        Objects.equals(this.corsAllowedOrigins, addHttpServletCrossOriginPolicyRequest.corsAllowedOrigins) &&
        Objects.equals(this.corsExposedHeaders, addHttpServletCrossOriginPolicyRequest.corsExposedHeaders) &&
        Objects.equals(this.corsAllowedHeaders, addHttpServletCrossOriginPolicyRequest.corsAllowedHeaders) &&
        Objects.equals(this.corsPreflightMaxAge, addHttpServletCrossOriginPolicyRequest.corsPreflightMaxAge) &&
        Objects.equals(this.corsAllowCredentials, addHttpServletCrossOriginPolicyRequest.corsAllowCredentials)&&
        Objects.equals(this.additionalProperties, addHttpServletCrossOriginPolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyName, description, schemas, corsAllowedMethods, corsAllowedOrigins, corsExposedHeaders, corsAllowedHeaders, corsPreflightMaxAge, corsAllowCredentials, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddHttpServletCrossOriginPolicyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddHttpServletCrossOriginPolicyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddHttpServletCrossOriginPolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddHttpServletCrossOriginPolicyRequest is not found in the empty JSON string", AddHttpServletCrossOriginPolicyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddHttpServletCrossOriginPolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddHttpServletCrossOriginPolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddHttpServletCrossOriginPolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddHttpServletCrossOriginPolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddHttpServletCrossOriginPolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddHttpServletCrossOriginPolicyRequest>() {
           @Override
           public void write(JsonWriter out, AddHttpServletCrossOriginPolicyRequest value) throws IOException {
           ...
           @Override
           public AddHttpServletCrossOriginPolicyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddHttpServletCrossOriginPolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddHttpServletCrossOriginPolicyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddHttpServletCrossOriginPolicyRequest
  * @throws IOException if the JSON string is invalid with respect to AddHttpServletCrossOriginPolicyRequest
  */
  public static AddHttpServletCrossOriginPolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddHttpServletCrossOriginPolicyRequest.class);
  }

 /**
  * Convert an instance of AddHttpServletCrossOriginPolicyRequest to an JSON string
  *
  * @return JSON string
  */
