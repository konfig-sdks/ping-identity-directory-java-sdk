...
public class ConsentServiceExternalServerResponse {
  ...
  private List<EnumconsentServiceExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerConsentServiceHostnameVerificationMethodProp hostnameVerificationMethod;
  ...
  public ConsentServiceExternalServerResponse() {
  }

  public ConsentServiceExternalServerResponse description(String description) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse schemas(List<EnumconsentServiceExternalServerSchemaUrn> schemas) {
  ...
  public ConsentServiceExternalServerResponse addSchemasItem(EnumconsentServiceExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumconsentServiceExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumconsentServiceExternalServerSchemaUrn> schemas) {
  ...
  public ConsentServiceExternalServerResponse id(String id) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse baseURL(String baseURL) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The base URL of the external Consent Service, including the base path and optionally including the port number. For example, \"https://example.com:1443/consent/v1\".")
  ...
  public ConsentServiceExternalServerResponse userName(String userName) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name of the login account to use when using Basic authentication on REST calls to the Consent Service.")
  ...
  public ConsentServiceExternalServerResponse password(String password) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The login password to use when using Basic authentication on REST calls to the Consent Service.")
  ...
  public ConsentServiceExternalServerResponse hostnameVerificationMethod(EnumexternalServerConsentServiceHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public EnumexternalServerConsentServiceHostnameVerificationMethodProp getHostnameVerificationMethod() {
    return hostnameVerificationMethod;
  }


  public void setHostnameVerificationMethod(EnumexternalServerConsentServiceHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  public ConsentServiceExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse responseTimeout(String responseTimeout) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConsentServiceExternalServerResponse instance itself
   */
  public ConsentServiceExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsentServiceExternalServerResponse consentServiceExternalServerResponse = (ConsentServiceExternalServerResponse) o;
    return Objects.equals(this.description, consentServiceExternalServerResponse.description) &&
        Objects.equals(this.schemas, consentServiceExternalServerResponse.schemas) &&
        Objects.equals(this.id, consentServiceExternalServerResponse.id) &&
        Objects.equals(this.baseURL, consentServiceExternalServerResponse.baseURL) &&
        Objects.equals(this.userName, consentServiceExternalServerResponse.userName) &&
        Objects.equals(this.password, consentServiceExternalServerResponse.password) &&
        Objects.equals(this.hostnameVerificationMethod, consentServiceExternalServerResponse.hostnameVerificationMethod) &&
        Objects.equals(this.keyManagerProvider, consentServiceExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, consentServiceExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.sslCertNickname, consentServiceExternalServerResponse.sslCertNickname) &&
        Objects.equals(this.connectTimeout, consentServiceExternalServerResponse.connectTimeout) &&
        Objects.equals(this.responseTimeout, consentServiceExternalServerResponse.responseTimeout) &&
        Objects.equals(this.meta, consentServiceExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, consentServiceExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, consentServiceExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseURL, userName, password, hostnameVerificationMethod, keyManagerProvider, trustManagerProvider, sslCertNickname, connectTimeout, responseTimeout, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsentServiceExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsentServiceExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsentServiceExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsentServiceExternalServerResponse is not found in the empty JSON string", ConsentServiceExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsentServiceExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsentServiceExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsentServiceExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsentServiceExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsentServiceExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsentServiceExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, ConsentServiceExternalServerResponse value) throws IOException {
           ...
           @Override
           public ConsentServiceExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsentServiceExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsentServiceExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsentServiceExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to ConsentServiceExternalServerResponse
  */
  public static ConsentServiceExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsentServiceExternalServerResponse.class);
  }

 /**
  * Convert an instance of ConsentServiceExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
