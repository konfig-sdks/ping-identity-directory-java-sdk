...
public class ReverseDnJoinVirtualAttributeShared {
  ...
  public ReverseDnJoinVirtualAttributeShared() {
  }

  public ReverseDnJoinVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared schemas(List<EnumreverseDnJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public ReverseDnJoinVirtualAttributeShared addSchemasItem(EnumreverseDnJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinDNAttribute(String joinDNAttribute) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinFilter(String joinFilter) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared joinAttribute(List<String> joinAttribute) {
  ...
  public ReverseDnJoinVirtualAttributeShared addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public ReverseDnJoinVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public ReverseDnJoinVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared filter(List<String> filter) {
  ...
  public ReverseDnJoinVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ReverseDnJoinVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ReverseDnJoinVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ReverseDnJoinVirtualAttributeShared instance itself
   */
  public ReverseDnJoinVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReverseDnJoinVirtualAttributeShared reverseDnJoinVirtualAttributeShared = (ReverseDnJoinVirtualAttributeShared) o;
    return Objects.equals(this.description, reverseDnJoinVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, reverseDnJoinVirtualAttributeShared.schemas) &&
        Objects.equals(this.joinDNAttribute, reverseDnJoinVirtualAttributeShared.joinDNAttribute) &&
        Objects.equals(this.joinBaseDNType, reverseDnJoinVirtualAttributeShared.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, reverseDnJoinVirtualAttributeShared.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, reverseDnJoinVirtualAttributeShared.joinScope) &&
        Objects.equals(this.joinSizeLimit, reverseDnJoinVirtualAttributeShared.joinSizeLimit) &&
        Objects.equals(this.joinFilter, reverseDnJoinVirtualAttributeShared.joinFilter) &&
        Objects.equals(this.joinAttribute, reverseDnJoinVirtualAttributeShared.joinAttribute) &&
        Objects.equals(this.enabled, reverseDnJoinVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, reverseDnJoinVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, reverseDnJoinVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, reverseDnJoinVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, reverseDnJoinVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, reverseDnJoinVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, reverseDnJoinVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, reverseDnJoinVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, reverseDnJoinVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, reverseDnJoinVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, reverseDnJoinVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, reverseDnJoinVirtualAttributeShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReverseDnJoinVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReverseDnJoinVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReverseDnJoinVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReverseDnJoinVirtualAttributeShared is not found in the empty JSON string", ReverseDnJoinVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReverseDnJoinVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReverseDnJoinVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReverseDnJoinVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReverseDnJoinVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReverseDnJoinVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ReverseDnJoinVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, ReverseDnJoinVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public ReverseDnJoinVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReverseDnJoinVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReverseDnJoinVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReverseDnJoinVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to ReverseDnJoinVirtualAttributeShared
  */
  public static ReverseDnJoinVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReverseDnJoinVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of ReverseDnJoinVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
