...
public class AddExecAlertHandlerRequest {
  ...
  public AddExecAlertHandlerRequest() {
  }

  public AddExecAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest schemas(List<EnumexecAlertHandlerSchemaUrn> schemas) {
  ...
  public AddExecAlertHandlerRequest addSchemasItem(EnumexecAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest command(String command) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddExecAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddExecAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddExecAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddExecAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddExecAlertHandlerRequest instance itself
   */
  public AddExecAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddExecAlertHandlerRequest addExecAlertHandlerRequest = (AddExecAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addExecAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addExecAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addExecAlertHandlerRequest.schemas) &&
        Objects.equals(this.command, addExecAlertHandlerRequest.command) &&
        Objects.equals(this.asynchronous, addExecAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabled, addExecAlertHandlerRequest.enabled) &&
        Objects.equals(this.enabledAlertSeverity, addExecAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addExecAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addExecAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addExecAlertHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, command, asynchronous, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddExecAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddExecAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddExecAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddExecAlertHandlerRequest is not found in the empty JSON string", AddExecAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddExecAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddExecAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddExecAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddExecAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddExecAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddExecAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddExecAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddExecAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddExecAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddExecAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddExecAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddExecAlertHandlerRequest
  */
  public static AddExecAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddExecAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddExecAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
