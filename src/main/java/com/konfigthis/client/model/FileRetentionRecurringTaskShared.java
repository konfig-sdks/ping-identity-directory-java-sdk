...
public class FileRetentionRecurringTaskShared {
  ...
  public FileRetentionRecurringTaskShared() {
  }

  public FileRetentionRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared schemas(List<EnumfileRetentionRecurringTaskSchemaUrn> schemas) {
  ...
  public FileRetentionRecurringTaskShared addSchemasItem(EnumfileRetentionRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared targetDirectory(String targetDirectory) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared filenamePattern(String filenamePattern) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared timestampFormat(EnumrecurringTaskTimestampFormatProp timestampFormat) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared retainFileCount(Integer retainFileCount) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared retainFileAge(String retainFileAge) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared retainAggregateFileSize(String retainAggregateFileSize) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public FileRetentionRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public FileRetentionRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public FileRetentionRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public FileRetentionRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the FileRetentionRecurringTaskShared instance itself
   */
  public FileRetentionRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileRetentionRecurringTaskShared fileRetentionRecurringTaskShared = (FileRetentionRecurringTaskShared) o;
    return Objects.equals(this.description, fileRetentionRecurringTaskShared.description) &&
        Objects.equals(this.schemas, fileRetentionRecurringTaskShared.schemas) &&
        Objects.equals(this.targetDirectory, fileRetentionRecurringTaskShared.targetDirectory) &&
        Objects.equals(this.filenamePattern, fileRetentionRecurringTaskShared.filenamePattern) &&
        Objects.equals(this.timestampFormat, fileRetentionRecurringTaskShared.timestampFormat) &&
        Objects.equals(this.retainFileCount, fileRetentionRecurringTaskShared.retainFileCount) &&
        Objects.equals(this.retainFileAge, fileRetentionRecurringTaskShared.retainFileAge) &&
        Objects.equals(this.retainAggregateFileSize, fileRetentionRecurringTaskShared.retainAggregateFileSize) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, fileRetentionRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, fileRetentionRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, fileRetentionRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, fileRetentionRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, fileRetentionRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, fileRetentionRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, fileRetentionRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, fileRetentionRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, targetDirectory, filenamePattern, timestampFormat, retainFileCount, retainFileAge, retainAggregateFileSize, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileRetentionRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileRetentionRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileRetentionRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileRetentionRecurringTaskShared is not found in the empty JSON string", FileRetentionRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileRetentionRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileRetentionRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileRetentionRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileRetentionRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileRetentionRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FileRetentionRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, FileRetentionRecurringTaskShared value) throws IOException {
           ...
           @Override
           public FileRetentionRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileRetentionRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileRetentionRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileRetentionRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to FileRetentionRecurringTaskShared
  */
  public static FileRetentionRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileRetentionRecurringTaskShared.class);
  }

 /**
  * Convert an instance of FileRetentionRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
