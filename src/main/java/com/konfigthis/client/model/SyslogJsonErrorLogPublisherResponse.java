...
public class SyslogJsonErrorLogPublisherResponse {
  ...
  private List<EnumsyslogJsonErrorLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyslogJsonErrorLogPublisherResponse() {
  }

  public SyslogJsonErrorLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse schemas(List<EnumsyslogJsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonErrorLogPublisherResponse addSchemasItem(EnumsyslogJsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyslogJsonErrorLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyslogJsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonErrorLogPublisherResponse defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public SyslogJsonErrorLogPublisherResponse addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonErrorLogPublisherResponse addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The local host name that will be included in syslog messages that are logged by this Syslog JSON Error Log Publisher.")
  ...
  public SyslogJsonErrorLogPublisherResponse syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The application name that will be included in syslog messages that are logged by this Syslog JSON Error Log Publisher.")
  ...
  public SyslogJsonErrorLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse overrideSeverity(List<String> overrideSeverity) {
  ...
  public SyslogJsonErrorLogPublisherResponse addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogJsonErrorLogPublisherResponse instance itself
   */
  public SyslogJsonErrorLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonErrorLogPublisherResponse syslogJsonErrorLogPublisherResponse = (SyslogJsonErrorLogPublisherResponse) o;
    return Objects.equals(this.id, syslogJsonErrorLogPublisherResponse.id) &&
        Objects.equals(this.description, syslogJsonErrorLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogJsonErrorLogPublisherResponse.schemas) &&
        Objects.equals(this.defaultSeverity, syslogJsonErrorLogPublisherResponse.defaultSeverity) &&
        Objects.equals(this.syslogExternalServer, syslogJsonErrorLogPublisherResponse.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonErrorLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonErrorLogPublisherResponse.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonErrorLogPublisherResponse.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonErrorLogPublisherResponse.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonErrorLogPublisherResponse.queueSize) &&
        Objects.equals(this.includeProductName, syslogJsonErrorLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonErrorLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonErrorLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonErrorLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, syslogJsonErrorLogPublisherResponse.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.overrideSeverity, syslogJsonErrorLogPublisherResponse.overrideSeverity) &&
        Objects.equals(this.enabled, syslogJsonErrorLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonErrorLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogJsonErrorLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogJsonErrorLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogJsonErrorLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, defaultSeverity, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, overrideSeverity, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogJsonErrorLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonErrorLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonErrorLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonErrorLogPublisherResponse is not found in the empty JSON string", SyslogJsonErrorLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonErrorLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonErrorLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonErrorLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonErrorLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonErrorLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonErrorLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogJsonErrorLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogJsonErrorLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonErrorLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonErrorLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonErrorLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonErrorLogPublisherResponse
  */
  public static SyslogJsonErrorLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonErrorLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogJsonErrorLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
