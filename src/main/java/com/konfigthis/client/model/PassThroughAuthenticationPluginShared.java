...
public class PassThroughAuthenticationPluginShared {
  ...
  public PassThroughAuthenticationPluginShared() {
  }

  public PassThroughAuthenticationPluginShared description(String description) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared schemas(List<EnumpassThroughAuthenticationPluginSchemaUrn> schemas) {
  ...
  public PassThroughAuthenticationPluginShared addSchemasItem(EnumpassThroughAuthenticationPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public PassThroughAuthenticationPluginShared addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared server(List<String> server) {
  ...
  public PassThroughAuthenticationPluginShared addServerItem(String serverItem) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared tryLocalBind(Boolean tryLocalBind) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared overrideLocalPassword(Boolean overrideLocalPassword) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared updateLocalPassword(Boolean updateLocalPassword) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared allowLaxPassThroughAuthenticationPasswords(Boolean allowLaxPassThroughAuthenticationPasswords) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared serverAccessMode(EnumpluginServerAccessModeProp serverAccessMode) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public PassThroughAuthenticationPluginShared addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared dnMap(List<String> dnMap) {
  ...
  public PassThroughAuthenticationPluginShared addDnMapItem(String dnMapItem) {
    if (this.dnMap == null) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared bindDNPattern(String bindDNPattern) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public PassThroughAuthenticationPluginShared invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the PassThroughAuthenticationPluginShared instance itself
   */
  public PassThroughAuthenticationPluginShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PassThroughAuthenticationPluginShared passThroughAuthenticationPluginShared = (PassThroughAuthenticationPluginShared) o;
    return Objects.equals(this.description, passThroughAuthenticationPluginShared.description) &&
        Objects.equals(this.schemas, passThroughAuthenticationPluginShared.schemas) &&
        Objects.equals(this.pluginType, passThroughAuthenticationPluginShared.pluginType) &&
        Objects.equals(this.server, passThroughAuthenticationPluginShared.server) &&
        Objects.equals(this.tryLocalBind, passThroughAuthenticationPluginShared.tryLocalBind) &&
        Objects.equals(this.overrideLocalPassword, passThroughAuthenticationPluginShared.overrideLocalPassword) &&
        Objects.equals(this.updateLocalPassword, passThroughAuthenticationPluginShared.updateLocalPassword) &&
        Objects.equals(this.allowLaxPassThroughAuthenticationPasswords, passThroughAuthenticationPluginShared.allowLaxPassThroughAuthenticationPasswords) &&
        Objects.equals(this.serverAccessMode, passThroughAuthenticationPluginShared.serverAccessMode) &&
        Objects.equals(this.includedLocalEntryBaseDN, passThroughAuthenticationPluginShared.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, passThroughAuthenticationPluginShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, passThroughAuthenticationPluginShared.requestCriteria) &&
        Objects.equals(this.dnMap, passThroughAuthenticationPluginShared.dnMap) &&
        Objects.equals(this.bindDNPattern, passThroughAuthenticationPluginShared.bindDNPattern) &&
        Objects.equals(this.searchBaseDN, passThroughAuthenticationPluginShared.searchBaseDN) &&
        Objects.equals(this.searchFilterPattern, passThroughAuthenticationPluginShared.searchFilterPattern) &&
        Objects.equals(this.initialConnections, passThroughAuthenticationPluginShared.initialConnections) &&
        Objects.equals(this.maxConnections, passThroughAuthenticationPluginShared.maxConnections) &&
        Objects.equals(this.enabled, passThroughAuthenticationPluginShared.enabled) &&
        Objects.equals(this.invokeForInternalOperations, passThroughAuthenticationPluginShared.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, passThroughAuthenticationPluginShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PassThroughAuthenticationPluginShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PassThroughAuthenticationPluginShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PassThroughAuthenticationPluginShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PassThroughAuthenticationPluginShared is not found in the empty JSON string", PassThroughAuthenticationPluginShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PassThroughAuthenticationPluginShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PassThroughAuthenticationPluginShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PassThroughAuthenticationPluginShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PassThroughAuthenticationPluginShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PassThroughAuthenticationPluginShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PassThroughAuthenticationPluginShared>() {
           @Override
           public void write(JsonWriter out, PassThroughAuthenticationPluginShared value) throws IOException {
           ...
           @Override
           public PassThroughAuthenticationPluginShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PassThroughAuthenticationPluginShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PassThroughAuthenticationPluginShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PassThroughAuthenticationPluginShared
  * @throws IOException if the JSON string is invalid with respect to PassThroughAuthenticationPluginShared
  */
  public static PassThroughAuthenticationPluginShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PassThroughAuthenticationPluginShared.class);
  }

 /**
  * Convert an instance of PassThroughAuthenticationPluginShared to an JSON string
  *
  * @return JSON string
  */
