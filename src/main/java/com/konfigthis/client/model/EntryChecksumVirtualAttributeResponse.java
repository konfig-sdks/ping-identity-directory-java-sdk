...
import com.konfigthis.client.model.EnumentryChecksumVirtualAttributeSchemaUrn;
...
public class EntryChecksumVirtualAttributeResponse {
  ...
  private List<EnumentryChecksumVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_EXCLUDE_OPERATIONAL_ATTRIBUTES = "excludeOperationalAttributes";
  @SerializedName(SERIALIZED_NAME_EXCLUDE_OPERATIONAL_ATTRIBUTES)
  private Boolean excludeOperationalAttributes;

  public static final String SERIALIZED_NAME_EXCLUDED_ATTRIBUTE = "excludedAttribute";
  @SerializedName(SERIALIZED_NAME_EXCLUDED_ATTRIBUTE)
  private List<String> excludedAttribute = null;
  ...
  public EntryChecksumVirtualAttributeResponse() {
  }

  public EntryChecksumVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse schemas(List<EnumentryChecksumVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryChecksumVirtualAttributeResponse addSchemasItem(EnumentryChecksumVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumentryChecksumVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumentryChecksumVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryChecksumVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse excludeOperationalAttributes(Boolean excludeOperationalAttributes) {
   ...
   * @return excludeOperationalAttributes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether all operational attributes should be excluded from the generated checksum.")

  public Boolean getExcludeOperationalAttributes() {
    return excludeOperationalAttributes;
  }


  public void setExcludeOperationalAttributes(Boolean excludeOperationalAttributes) {
  ...
  public EntryChecksumVirtualAttributeResponse excludedAttribute(List<String> excludedAttribute) {
    
    
    
    
    this.excludedAttribute = excludedAttribute;
    return this;
  }

  public EntryChecksumVirtualAttributeResponse addExcludedAttributeItem(String excludedAttributeItem) {
    if (this.excludedAttribute == null) {
      this.excludedAttribute = new ArrayList<>();
    }
    this.excludedAttribute.add(excludedAttributeItem);
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the attributes that should be excluded from the checksum calculation.")

  public List<String> getExcludedAttribute() {
    return excludedAttribute;
  }


  public void setExcludedAttribute(List<String> excludedAttribute) {
  ...
  public EntryChecksumVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public EntryChecksumVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public EntryChecksumVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse filter(List<String> filter) {
  ...
  public EntryChecksumVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EntryChecksumVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EntryChecksumVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EntryChecksumVirtualAttributeResponse instance itself
   */
  public EntryChecksumVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntryChecksumVirtualAttributeResponse entryChecksumVirtualAttributeResponse = (EntryChecksumVirtualAttributeResponse) o;
    return Objects.equals(this.description, entryChecksumVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, entryChecksumVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, entryChecksumVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, entryChecksumVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, entryChecksumVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.excludeOperationalAttributes, entryChecksumVirtualAttributeResponse.excludeOperationalAttributes) &&
        Objects.equals(this.excludedAttribute, entryChecksumVirtualAttributeResponse.excludedAttribute) &&
        Objects.equals(this.enabled, entryChecksumVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, entryChecksumVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, entryChecksumVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, entryChecksumVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, entryChecksumVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, entryChecksumVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, entryChecksumVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, entryChecksumVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, entryChecksumVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, entryChecksumVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, entryChecksumVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, entryChecksumVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, excludeOperationalAttributes, excludedAttribute, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntryChecksumVirtualAttributeResponse {\n");
    ...
    sb.append("    excludeOperationalAttributes: ").append(toIndentedString(excludeOperationalAttributes)).append("\n");
    sb.append("    excludedAttribute: ").append(toIndentedString(excludedAttribute)).append("\n");
  ...
  static {
    ...
    openapiFields.add("excludeOperationalAttributes");
    openapiFields.add("excludedAttribute");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EntryChecksumVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntryChecksumVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryChecksumVirtualAttributeResponse is not found in the empty JSON string", EntryChecksumVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntryChecksumVirtualAttributeResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("excludedAttribute") != null && !jsonObj.get("excludedAttribute").isJsonArray()) {
        throw new IllegalArgumentException(String.format("Expected the field `excludedAttribute` to be an array in the JSON string but got `%s`", jsonObj.get("excludedAttribute").toString()));
      }
      // ensure the optional json data is an array if present
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntryChecksumVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntryChecksumVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntryChecksumVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntryChecksumVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EntryChecksumVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, EntryChecksumVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public EntryChecksumVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EntryChecksumVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EntryChecksumVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EntryChecksumVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to EntryChecksumVirtualAttributeResponse
  */
  public static EntryChecksumVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntryChecksumVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of EntryChecksumVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
