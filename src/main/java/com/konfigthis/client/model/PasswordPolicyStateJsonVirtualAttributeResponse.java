...
public class PasswordPolicyStateJsonVirtualAttributeResponse {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse() {
  }

  public PasswordPolicyStateJsonVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse schemas(List<EnumpasswordPolicyStateJsonVirtualAttributeSchemaUrn> schemas) {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse addSchemasItem(EnumpasswordPolicyStateJsonVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse filter(List<String> filter) {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PasswordPolicyStateJsonVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PasswordPolicyStateJsonVirtualAttributeResponse instance itself
   */
  public PasswordPolicyStateJsonVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PasswordPolicyStateJsonVirtualAttributeResponse passwordPolicyStateJsonVirtualAttributeResponse = (PasswordPolicyStateJsonVirtualAttributeResponse) o;
    return Objects.equals(this.id, passwordPolicyStateJsonVirtualAttributeResponse.id) &&
        Objects.equals(this.description, passwordPolicyStateJsonVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, passwordPolicyStateJsonVirtualAttributeResponse.schemas) &&
        Objects.equals(this.enabled, passwordPolicyStateJsonVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, passwordPolicyStateJsonVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, passwordPolicyStateJsonVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, passwordPolicyStateJsonVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, passwordPolicyStateJsonVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, passwordPolicyStateJsonVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, passwordPolicyStateJsonVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.meta, passwordPolicyStateJsonVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, passwordPolicyStateJsonVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, passwordPolicyStateJsonVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PasswordPolicyStateJsonVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PasswordPolicyStateJsonVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PasswordPolicyStateJsonVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PasswordPolicyStateJsonVirtualAttributeResponse is not found in the empty JSON string", PasswordPolicyStateJsonVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PasswordPolicyStateJsonVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PasswordPolicyStateJsonVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PasswordPolicyStateJsonVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PasswordPolicyStateJsonVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PasswordPolicyStateJsonVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PasswordPolicyStateJsonVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, PasswordPolicyStateJsonVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public PasswordPolicyStateJsonVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PasswordPolicyStateJsonVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PasswordPolicyStateJsonVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PasswordPolicyStateJsonVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to PasswordPolicyStateJsonVirtualAttributeResponse
  */
  public static PasswordPolicyStateJsonVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PasswordPolicyStateJsonVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of PasswordPolicyStateJsonVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
