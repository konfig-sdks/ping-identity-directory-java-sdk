...
public class ConsoleJsonErrorLogPublisherResponse {
  ...
  private List<EnumconsoleJsonErrorLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConsoleJsonErrorLogPublisherResponse() {
  }

  public ConsoleJsonErrorLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse schemas(List<EnumconsoleJsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonErrorLogPublisherResponse addSchemasItem(EnumconsoleJsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Console JSON Error Log Publisher is enabled for use.")
  ...
  public ConsoleJsonErrorLogPublisherResponse defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public ConsoleJsonErrorLogPublisherResponse addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse overrideSeverity(List<String> overrideSeverity) {
  ...
  public ConsoleJsonErrorLogPublisherResponse addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConsoleJsonErrorLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConsoleJsonErrorLogPublisherResponse instance itself
   */
  public ConsoleJsonErrorLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonErrorLogPublisherResponse consoleJsonErrorLogPublisherResponse = (ConsoleJsonErrorLogPublisherResponse) o;
    return Objects.equals(this.description, consoleJsonErrorLogPublisherResponse.description) &&
        Objects.equals(this.schemas, consoleJsonErrorLogPublisherResponse.schemas) &&
        Objects.equals(this.id, consoleJsonErrorLogPublisherResponse.id) &&
        Objects.equals(this.enabled, consoleJsonErrorLogPublisherResponse.enabled) &&
        Objects.equals(this.defaultSeverity, consoleJsonErrorLogPublisherResponse.defaultSeverity) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonErrorLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.outputLocation, consoleJsonErrorLogPublisherResponse.outputLocation) &&
        Objects.equals(this.includeProductName, consoleJsonErrorLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonErrorLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonErrorLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonErrorLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, consoleJsonErrorLogPublisherResponse.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.overrideSeverity, consoleJsonErrorLogPublisherResponse.overrideSeverity) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonErrorLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, consoleJsonErrorLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, consoleJsonErrorLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, consoleJsonErrorLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, defaultSeverity, writeMultiLineMessages, outputLocation, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, overrideSeverity, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonErrorLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonErrorLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonErrorLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonErrorLogPublisherResponse is not found in the empty JSON string", ConsoleJsonErrorLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsoleJsonErrorLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonErrorLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonErrorLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonErrorLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonErrorLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonErrorLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonErrorLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ConsoleJsonErrorLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonErrorLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonErrorLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonErrorLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonErrorLogPublisherResponse
  */
  public static ConsoleJsonErrorLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonErrorLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ConsoleJsonErrorLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
