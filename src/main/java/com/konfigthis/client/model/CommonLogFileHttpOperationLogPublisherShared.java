...
public class CommonLogFileHttpOperationLogPublisherShared {
  ...
  public CommonLogFileHttpOperationLogPublisherShared() {
  }

  public CommonLogFileHttpOperationLogPublisherShared description(String description) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared schemas(List<EnumcommonLogFileHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public CommonLogFileHttpOperationLogPublisherShared addSchemasItem(EnumcommonLogFileHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public CommonLogFileHttpOperationLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public CommonLogFileHttpOperationLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public CommonLogFileHttpOperationLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public CommonLogFileHttpOperationLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the CommonLogFileHttpOperationLogPublisherShared instance itself
   */
  public CommonLogFileHttpOperationLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommonLogFileHttpOperationLogPublisherShared commonLogFileHttpOperationLogPublisherShared = (CommonLogFileHttpOperationLogPublisherShared) o;
    return Objects.equals(this.description, commonLogFileHttpOperationLogPublisherShared.description) &&
        Objects.equals(this.schemas, commonLogFileHttpOperationLogPublisherShared.schemas) &&
        Objects.equals(this.logFile, commonLogFileHttpOperationLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, commonLogFileHttpOperationLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, commonLogFileHttpOperationLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, commonLogFileHttpOperationLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, commonLogFileHttpOperationLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, commonLogFileHttpOperationLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, commonLogFileHttpOperationLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, commonLogFileHttpOperationLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, commonLogFileHttpOperationLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, commonLogFileHttpOperationLogPublisherShared.append) &&
        Objects.equals(this.asynchronous, commonLogFileHttpOperationLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, commonLogFileHttpOperationLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, commonLogFileHttpOperationLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, commonLogFileHttpOperationLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, commonLogFileHttpOperationLogPublisherShared.timeInterval) &&
        Objects.equals(this.enabled, commonLogFileHttpOperationLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, commonLogFileHttpOperationLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, commonLogFileHttpOperationLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommonLogFileHttpOperationLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommonLogFileHttpOperationLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommonLogFileHttpOperationLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonLogFileHttpOperationLogPublisherShared is not found in the empty JSON string", CommonLogFileHttpOperationLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CommonLogFileHttpOperationLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonLogFileHttpOperationLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonLogFileHttpOperationLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonLogFileHttpOperationLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonLogFileHttpOperationLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonLogFileHttpOperationLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, CommonLogFileHttpOperationLogPublisherShared value) throws IOException {
           ...
           @Override
           public CommonLogFileHttpOperationLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CommonLogFileHttpOperationLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CommonLogFileHttpOperationLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommonLogFileHttpOperationLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to CommonLogFileHttpOperationLogPublisherShared
  */
  public static CommonLogFileHttpOperationLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonLogFileHttpOperationLogPublisherShared.class);
  }

 /**
  * Convert an instance of CommonLogFileHttpOperationLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
