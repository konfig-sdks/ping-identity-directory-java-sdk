...
public class LdapExternalServerResponse {
  ...
  private List<EnumldapExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerLdapConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerLdapAuthenticationMethodProp authenticationMethod;
  ...
  public LdapExternalServerResponse() {
  }

  public LdapExternalServerResponse id(String id) {
  ...
  **/
  ...
  public LdapExternalServerResponse description(String description) {
  ...
  **/
  ...
  public LdapExternalServerResponse schemas(List<EnumldapExternalServerSchemaUrn> schemas) {
  ...
  public LdapExternalServerResponse addSchemasItem(EnumldapExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumldapExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumldapExternalServerSchemaUrn> schemas) {
  ...
  public LdapExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public LdapExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public LdapExternalServerResponse location(String location) {
  ...
  **/
  ...
  public LdapExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public LdapExternalServerResponse password(String password) {
  ...
  **/
  ...
  public LdapExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public LdapExternalServerResponse connectionSecurity(EnumexternalServerLdapConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerLdapConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerLdapConnectionSecurityProp connectionSecurity) {
  ...
  public LdapExternalServerResponse authenticationMethod(EnumexternalServerLdapAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerLdapAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerLdapAuthenticationMethodProp authenticationMethod) {
  ...
  public LdapExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public LdapExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public LdapExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public LdapExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public LdapExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public LdapExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public LdapExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public LdapExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public LdapExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public LdapExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public LdapExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public LdapExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public LdapExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public LdapExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdapExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdapExternalServerResponse instance itself
   */
  public LdapExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapExternalServerResponse ldapExternalServerResponse = (LdapExternalServerResponse) o;
    return Objects.equals(this.id, ldapExternalServerResponse.id) &&
        Objects.equals(this.description, ldapExternalServerResponse.description) &&
        Objects.equals(this.schemas, ldapExternalServerResponse.schemas) &&
        Objects.equals(this.serverHostName, ldapExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, ldapExternalServerResponse.serverPort) &&
        Objects.equals(this.location, ldapExternalServerResponse.location) &&
        Objects.equals(this.bindDN, ldapExternalServerResponse.bindDN) &&
        Objects.equals(this.password, ldapExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, ldapExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, ldapExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, ldapExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, ldapExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, ldapExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, ldapExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, ldapExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, ldapExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, ldapExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, ldapExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, ldapExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, ldapExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, ldapExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, ldapExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, ldapExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, ldapExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldapExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldapExternalServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class LdapExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapExternalServerResponse is not found in the empty JSON string", LdapExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdapExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, LdapExternalServerResponse value) throws IOException {
           ...
           @Override
           public LdapExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to LdapExternalServerResponse
  */
  public static LdapExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapExternalServerResponse.class);
  }

 /**
  * Convert an instance of LdapExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
