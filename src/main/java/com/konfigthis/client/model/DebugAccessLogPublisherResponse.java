...
public class DebugAccessLogPublisherResponse {
  ...
  public DebugAccessLogPublisherResponse() {
  }

  public DebugAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse schemas(List<EnumdebugAccessLogPublisherSchemaUrn> schemas) {
  ...
  public DebugAccessLogPublisherResponse addSchemasItem(EnumdebugAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logAssuranceCompleted(Boolean logAssuranceCompleted) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Debug Access Log Publisher.")
  ...
  public DebugAccessLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public DebugAccessLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Debug Access Log Publisher .")
  ...
  public DebugAccessLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public DebugAccessLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public DebugAccessLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Debug Access Log Publisher .")
  ...
  public DebugAccessLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse obscureSensitiveContent(Boolean obscureSensitiveContent) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse obscureAttribute(List<String> obscureAttribute) {
  ...
  public DebugAccessLogPublisherResponse addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse debugACIEnabled(Boolean debugACIEnabled) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Debug Access Log Publisher will publish records asynchronously.")
  ...
  public DebugAccessLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DebugAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DebugAccessLogPublisherResponse instance itself
   */
  public DebugAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DebugAccessLogPublisherResponse debugAccessLogPublisherResponse = (DebugAccessLogPublisherResponse) o;
    return Objects.equals(this.id, debugAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, debugAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, debugAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.suppressReplicationOperations, debugAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.logSecurityNegotiation, debugAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logAssuranceCompleted, debugAccessLogPublisherResponse.logAssuranceCompleted) &&
        Objects.equals(this.logSearchEntries, debugAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, debugAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logFile, debugAccessLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, debugAccessLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, debugAccessLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, debugAccessLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, debugAccessLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, debugAccessLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, debugAccessLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, debugAccessLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, debugAccessLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, debugAccessLogPublisherResponse.append) &&
        Objects.equals(this.obscureSensitiveContent, debugAccessLogPublisherResponse.obscureSensitiveContent) &&
        Objects.equals(this.obscureAttribute, debugAccessLogPublisherResponse.obscureAttribute) &&
        Objects.equals(this.debugACIEnabled, debugAccessLogPublisherResponse.debugACIEnabled) &&
        Objects.equals(this.asynchronous, debugAccessLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, debugAccessLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, debugAccessLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, debugAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, debugAccessLogPublisherResponse.timeInterval) &&
        Objects.equals(this.logConnects, debugAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, debugAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logClientCertificates, debugAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, debugAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, debugAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logIntermediateResponses, debugAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, debugAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.correlateRequestsAndResults, debugAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, debugAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, debugAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, debugAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, debugAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, debugAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, debugAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, debugAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, debugAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, debugAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, debugAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, suppressReplicationOperations, logSecurityNegotiation, logAssuranceCompleted, logSearchEntries, logSearchReferences, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, obscureSensitiveContent, obscureAttribute, debugACIEnabled, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, logConnects, logDisconnects, logClientCertificates, logRequests, logResults, logIntermediateResponses, suppressInternalOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DebugAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DebugAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DebugAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DebugAccessLogPublisherResponse is not found in the empty JSON string", DebugAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DebugAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DebugAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DebugAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DebugAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DebugAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DebugAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, DebugAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public DebugAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DebugAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DebugAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DebugAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to DebugAccessLogPublisherResponse
  */
  public static DebugAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DebugAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of DebugAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
