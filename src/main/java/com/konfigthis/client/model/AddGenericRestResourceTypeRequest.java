...
public class AddGenericRestResourceTypeRequest {
  ...
  public AddGenericRestResourceTypeRequest() {
  }

  public AddGenericRestResourceTypeRequest typeName(String typeName) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest description(String description) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest schemas(List<EnumgenericRestResourceTypeSchemaUrn> schemas) {
  ...
  public AddGenericRestResourceTypeRequest addSchemasItem(EnumgenericRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public AddGenericRestResourceTypeRequest addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest includeFilter(List<String> includeFilter) {
  ...
  public AddGenericRestResourceTypeRequest addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest parentDN(String parentDN) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public AddGenericRestResourceTypeRequest addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public AddGenericRestResourceTypeRequest addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest displayName(String displayName) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public AddGenericRestResourceTypeRequest nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
   ...
   * @return the AddGenericRestResourceTypeRequest instance itself
   */
  public AddGenericRestResourceTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGenericRestResourceTypeRequest addGenericRestResourceTypeRequest = (AddGenericRestResourceTypeRequest) o;
    return Objects.equals(this.typeName, addGenericRestResourceTypeRequest.typeName) &&
        Objects.equals(this.description, addGenericRestResourceTypeRequest.description) &&
        Objects.equals(this.schemas, addGenericRestResourceTypeRequest.schemas) &&
        Objects.equals(this.enabled, addGenericRestResourceTypeRequest.enabled) &&
        Objects.equals(this.resourceEndpoint, addGenericRestResourceTypeRequest.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, addGenericRestResourceTypeRequest.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, addGenericRestResourceTypeRequest.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, addGenericRestResourceTypeRequest.searchBaseDN) &&
        Objects.equals(this.includeFilter, addGenericRestResourceTypeRequest.includeFilter) &&
        Objects.equals(this.parentDN, addGenericRestResourceTypeRequest.parentDN) &&
        Objects.equals(this.parentResourceType, addGenericRestResourceTypeRequest.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, addGenericRestResourceTypeRequest.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, addGenericRestResourceTypeRequest.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, addGenericRestResourceTypeRequest.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, addGenericRestResourceTypeRequest.updateConstructedAttribute) &&
        Objects.equals(this.displayName, addGenericRestResourceTypeRequest.displayName) &&
        Objects.equals(this.searchFilterPattern, addGenericRestResourceTypeRequest.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, addGenericRestResourceTypeRequest.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, addGenericRestResourceTypeRequest.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, addGenericRestResourceTypeRequest.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.membersColumnName, addGenericRestResourceTypeRequest.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, addGenericRestResourceTypeRequest.nonmembersColumnName)&&
        Objects.equals(this.additionalProperties, addGenericRestResourceTypeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeName, description, schemas, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, membersColumnName, nonmembersColumnName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGenericRestResourceTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGenericRestResourceTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGenericRestResourceTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGenericRestResourceTypeRequest is not found in the empty JSON string", AddGenericRestResourceTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGenericRestResourceTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGenericRestResourceTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGenericRestResourceTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGenericRestResourceTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGenericRestResourceTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGenericRestResourceTypeRequest>() {
           @Override
           public void write(JsonWriter out, AddGenericRestResourceTypeRequest value) throws IOException {
           ...
           @Override
           public AddGenericRestResourceTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGenericRestResourceTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGenericRestResourceTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGenericRestResourceTypeRequest
  * @throws IOException if the JSON string is invalid with respect to AddGenericRestResourceTypeRequest
  */
  public static AddGenericRestResourceTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGenericRestResourceTypeRequest.class);
  }

 /**
  * Convert an instance of AddGenericRestResourceTypeRequest to an JSON string
  *
  * @return JSON string
  */
