...
public class GroovyScriptedAccountStatusNotificationHandlerResponse {
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse() {
  }

  public GroovyScriptedAccountStatusNotificationHandlerResponse id(String id) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse description(String description) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse schemas(List<EnumgroovyScriptedAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse addSchemasItem(EnumgroovyScriptedAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GroovyScriptedAccountStatusNotificationHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GroovyScriptedAccountStatusNotificationHandlerResponse instance itself
   */
  public GroovyScriptedAccountStatusNotificationHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedAccountStatusNotificationHandlerResponse groovyScriptedAccountStatusNotificationHandlerResponse = (GroovyScriptedAccountStatusNotificationHandlerResponse) o;
    return Objects.equals(this.id, groovyScriptedAccountStatusNotificationHandlerResponse.id) &&
        Objects.equals(this.description, groovyScriptedAccountStatusNotificationHandlerResponse.description) &&
        Objects.equals(this.schemas, groovyScriptedAccountStatusNotificationHandlerResponse.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedAccountStatusNotificationHandlerResponse.scriptClass) &&
        Objects.equals(this.scriptArgument, groovyScriptedAccountStatusNotificationHandlerResponse.scriptArgument) &&
        Objects.equals(this.enabled, groovyScriptedAccountStatusNotificationHandlerResponse.enabled) &&
        Objects.equals(this.asynchronous, groovyScriptedAccountStatusNotificationHandlerResponse.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, groovyScriptedAccountStatusNotificationHandlerResponse.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, groovyScriptedAccountStatusNotificationHandlerResponse.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, groovyScriptedAccountStatusNotificationHandlerResponse.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, groovyScriptedAccountStatusNotificationHandlerResponse.accountUpdateNotificationRequestCriteria) &&
        Objects.equals(this.meta, groovyScriptedAccountStatusNotificationHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, groovyScriptedAccountStatusNotificationHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, groovyScriptedAccountStatusNotificationHandlerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroovyScriptedAccountStatusNotificationHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedAccountStatusNotificationHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedAccountStatusNotificationHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedAccountStatusNotificationHandlerResponse is not found in the empty JSON string", GroovyScriptedAccountStatusNotificationHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedAccountStatusNotificationHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedAccountStatusNotificationHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedAccountStatusNotificationHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedAccountStatusNotificationHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedAccountStatusNotificationHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedAccountStatusNotificationHandlerResponse>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedAccountStatusNotificationHandlerResponse value) throws IOException {
           ...
           @Override
           public GroovyScriptedAccountStatusNotificationHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedAccountStatusNotificationHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedAccountStatusNotificationHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedAccountStatusNotificationHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedAccountStatusNotificationHandlerResponse
  */
  public static GroovyScriptedAccountStatusNotificationHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedAccountStatusNotificationHandlerResponse.class);
  }

 /**
  * Convert an instance of GroovyScriptedAccountStatusNotificationHandlerResponse to an JSON string
  *
  * @return JSON string
  */
