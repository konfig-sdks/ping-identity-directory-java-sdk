...
public class PingOnePassThroughAuthenticationHandlerShared {
  ...
  public PingOnePassThroughAuthenticationHandlerShared() {
  }

  public PingOnePassThroughAuthenticationHandlerShared description(String description) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared schemas(List<EnumpingOnePassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public PingOnePassThroughAuthenticationHandlerShared addSchemasItem(EnumpingOnePassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared apiURL(String apiURL) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared authURL(String authURL) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared oauthClientID(String oauthClientID) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared oauthClientSecret(String oauthClientSecret) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared oauthClientSecretPassphraseProvider(String oauthClientSecretPassphraseProvider) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared environmentID(String environmentID) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared userMappingLocalAttribute(List<String> userMappingLocalAttribute) {
  ...
  public PingOnePassThroughAuthenticationHandlerShared addUserMappingLocalAttributeItem(String userMappingLocalAttributeItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared userMappingRemoteJSONField(List<String> userMappingRemoteJSONField) {
  ...
  public PingOnePassThroughAuthenticationHandlerShared addUserMappingRemoteJSONFieldItem(String userMappingRemoteJSONFieldItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared additionalUserMappingSCIMFilter(String additionalUserMappingSCIMFilter) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public PingOnePassThroughAuthenticationHandlerShared addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerShared requestCriteria(String requestCriteria) {
  ...
  **/
   ...
   * @return the PingOnePassThroughAuthenticationHandlerShared instance itself
   */
  public PingOnePassThroughAuthenticationHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingOnePassThroughAuthenticationHandlerShared pingOnePassThroughAuthenticationHandlerShared = (PingOnePassThroughAuthenticationHandlerShared) o;
    return Objects.equals(this.description, pingOnePassThroughAuthenticationHandlerShared.description) &&
        Objects.equals(this.schemas, pingOnePassThroughAuthenticationHandlerShared.schemas) &&
        Objects.equals(this.apiURL, pingOnePassThroughAuthenticationHandlerShared.apiURL) &&
        Objects.equals(this.authURL, pingOnePassThroughAuthenticationHandlerShared.authURL) &&
        Objects.equals(this.oauthClientID, pingOnePassThroughAuthenticationHandlerShared.oauthClientID) &&
        Objects.equals(this.oauthClientSecret, pingOnePassThroughAuthenticationHandlerShared.oauthClientSecret) &&
        Objects.equals(this.oauthClientSecretPassphraseProvider, pingOnePassThroughAuthenticationHandlerShared.oauthClientSecretPassphraseProvider) &&
        Objects.equals(this.environmentID, pingOnePassThroughAuthenticationHandlerShared.environmentID) &&
        Objects.equals(this.httpProxyExternalServer, pingOnePassThroughAuthenticationHandlerShared.httpProxyExternalServer) &&
        Objects.equals(this.userMappingLocalAttribute, pingOnePassThroughAuthenticationHandlerShared.userMappingLocalAttribute) &&
        Objects.equals(this.userMappingRemoteJSONField, pingOnePassThroughAuthenticationHandlerShared.userMappingRemoteJSONField) &&
        Objects.equals(this.additionalUserMappingSCIMFilter, pingOnePassThroughAuthenticationHandlerShared.additionalUserMappingSCIMFilter) &&
        Objects.equals(this.includedLocalEntryBaseDN, pingOnePassThroughAuthenticationHandlerShared.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, pingOnePassThroughAuthenticationHandlerShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, pingOnePassThroughAuthenticationHandlerShared.requestCriteria)&&
        Objects.equals(this.additionalProperties, pingOnePassThroughAuthenticationHandlerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PingOnePassThroughAuthenticationHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingOnePassThroughAuthenticationHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingOnePassThroughAuthenticationHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingOnePassThroughAuthenticationHandlerShared is not found in the empty JSON string", PingOnePassThroughAuthenticationHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingOnePassThroughAuthenticationHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingOnePassThroughAuthenticationHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingOnePassThroughAuthenticationHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingOnePassThroughAuthenticationHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingOnePassThroughAuthenticationHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PingOnePassThroughAuthenticationHandlerShared>() {
           @Override
           public void write(JsonWriter out, PingOnePassThroughAuthenticationHandlerShared value) throws IOException {
           ...
           @Override
           public PingOnePassThroughAuthenticationHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingOnePassThroughAuthenticationHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingOnePassThroughAuthenticationHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingOnePassThroughAuthenticationHandlerShared
  * @throws IOException if the JSON string is invalid with respect to PingOnePassThroughAuthenticationHandlerShared
  */
  public static PingOnePassThroughAuthenticationHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingOnePassThroughAuthenticationHandlerShared.class);
  }

 /**
  * Convert an instance of PingOnePassThroughAuthenticationHandlerShared to an JSON string
  *
  * @return JSON string
  */
