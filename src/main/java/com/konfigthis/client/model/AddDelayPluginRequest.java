...
public class AddDelayPluginRequest {
  ...
  public AddDelayPluginRequest() {
  }

  public AddDelayPluginRequest pluginName(String pluginName) {
  ...
  **/
  ...
  public AddDelayPluginRequest description(String description) {
  ...
  **/
  ...
  public AddDelayPluginRequest schemas(List<EnumdelayPluginSchemaUrn> schemas) {
  ...
  public AddDelayPluginRequest addSchemasItem(EnumdelayPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddDelayPluginRequest pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public AddDelayPluginRequest addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public AddDelayPluginRequest delay(String delay) {
  ...
  **/
  ...
  public AddDelayPluginRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddDelayPluginRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddDelayPluginRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddDelayPluginRequest invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the AddDelayPluginRequest instance itself
   */
  public AddDelayPluginRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddDelayPluginRequest addDelayPluginRequest = (AddDelayPluginRequest) o;
    return Objects.equals(this.pluginName, addDelayPluginRequest.pluginName) &&
        Objects.equals(this.description, addDelayPluginRequest.description) &&
        Objects.equals(this.schemas, addDelayPluginRequest.schemas) &&
        Objects.equals(this.pluginType, addDelayPluginRequest.pluginType) &&
        Objects.equals(this.delay, addDelayPluginRequest.delay) &&
        Objects.equals(this.connectionCriteria, addDelayPluginRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addDelayPluginRequest.requestCriteria) &&
        Objects.equals(this.enabled, addDelayPluginRequest.enabled) &&
        Objects.equals(this.invokeForInternalOperations, addDelayPluginRequest.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, addDelayPluginRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pluginName, description, schemas, pluginType, delay, connectionCriteria, requestCriteria, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddDelayPluginRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddDelayPluginRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddDelayPluginRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddDelayPluginRequest is not found in the empty JSON string", AddDelayPluginRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddDelayPluginRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDelayPluginRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDelayPluginRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddDelayPluginRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddDelayPluginRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddDelayPluginRequest>() {
           @Override
           public void write(JsonWriter out, AddDelayPluginRequest value) throws IOException {
           ...
           @Override
           public AddDelayPluginRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddDelayPluginRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddDelayPluginRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddDelayPluginRequest
  * @throws IOException if the JSON string is invalid with respect to AddDelayPluginRequest
  */
  public static AddDelayPluginRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddDelayPluginRequest.class);
  }

 /**
  * Convert an instance of AddDelayPluginRequest to an JSON string
  *
  * @return JSON string
  */
