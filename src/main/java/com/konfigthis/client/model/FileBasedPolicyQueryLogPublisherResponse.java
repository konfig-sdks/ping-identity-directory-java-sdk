...
public class FileBasedPolicyQueryLogPublisherResponse {
  ...
  private List<EnumfileBasedPolicyQueryLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public FileBasedPolicyQueryLogPublisherResponse() {
  }

  public FileBasedPolicyQueryLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse schemas(List<EnumfileBasedPolicyQueryLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedPolicyQueryLogPublisherResponse addSchemasItem(EnumfileBasedPolicyQueryLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based Policy Query Log Publisher will publish records asynchronously.")
  ...
  public FileBasedPolicyQueryLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the File Based Policy Query Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public FileBasedPolicyQueryLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Policy Query Log Publisher.")
  ...
  public FileBasedPolicyQueryLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedPolicyQueryLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Policy Query Log Publisher .")
  ...
  public FileBasedPolicyQueryLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedPolicyQueryLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedPolicyQueryLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Policy Query Log Publisher .")
  ...
  public FileBasedPolicyQueryLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse includeQueryResponse(Boolean includeQueryResponse) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedPolicyQueryLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedPolicyQueryLogPublisherResponse instance itself
   */
  public FileBasedPolicyQueryLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedPolicyQueryLogPublisherResponse fileBasedPolicyQueryLogPublisherResponse = (FileBasedPolicyQueryLogPublisherResponse) o;
    return Objects.equals(this.description, fileBasedPolicyQueryLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedPolicyQueryLogPublisherResponse.schemas) &&
        Objects.equals(this.id, fileBasedPolicyQueryLogPublisherResponse.id) &&
        Objects.equals(this.asynchronous, fileBasedPolicyQueryLogPublisherResponse.asynchronous) &&
        Objects.equals(this.queueSize, fileBasedPolicyQueryLogPublisherResponse.queueSize) &&
        Objects.equals(this.bufferSize, fileBasedPolicyQueryLogPublisherResponse.bufferSize) &&
        Objects.equals(this.timeInterval, fileBasedPolicyQueryLogPublisherResponse.timeInterval) &&
        Objects.equals(this.logFile, fileBasedPolicyQueryLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedPolicyQueryLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedPolicyQueryLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedPolicyQueryLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedPolicyQueryLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedPolicyQueryLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedPolicyQueryLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedPolicyQueryLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedPolicyQueryLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedPolicyQueryLogPublisherResponse.append) &&
        Objects.equals(this.includeQueryResponse, fileBasedPolicyQueryLogPublisherResponse.includeQueryResponse) &&
        Objects.equals(this.enabled, fileBasedPolicyQueryLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedPolicyQueryLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedPolicyQueryLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedPolicyQueryLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedPolicyQueryLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, asynchronous, queueSize, bufferSize, timeInterval, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, includeQueryResponse, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedPolicyQueryLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedPolicyQueryLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedPolicyQueryLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedPolicyQueryLogPublisherResponse is not found in the empty JSON string", FileBasedPolicyQueryLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedPolicyQueryLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedPolicyQueryLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedPolicyQueryLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedPolicyQueryLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedPolicyQueryLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedPolicyQueryLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedPolicyQueryLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedPolicyQueryLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedPolicyQueryLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedPolicyQueryLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedPolicyQueryLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedPolicyQueryLogPublisherResponse
  */
  public static FileBasedPolicyQueryLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedPolicyQueryLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedPolicyQueryLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
