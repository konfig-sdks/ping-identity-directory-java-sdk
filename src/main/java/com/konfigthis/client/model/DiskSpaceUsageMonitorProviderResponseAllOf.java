...
public class DiskSpaceUsageMonitorProviderResponseAllOf {
  ...
  private List<EnumdiskSpaceUsageMonitorProviderSchemaUrn> schemas = null;
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf() {
  }

  public DiskSpaceUsageMonitorProviderResponseAllOf description(String description) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf schemas(List<EnumdiskSpaceUsageMonitorProviderSchemaUrn> schemas) {
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf addSchemasItem(EnumdiskSpaceUsageMonitorProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf id(String id) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf lowSpaceWarningSizeThreshold(String lowSpaceWarningSizeThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf lowSpaceWarningPercentThreshold(Integer lowSpaceWarningPercentThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf lowSpaceErrorSizeThreshold(String lowSpaceErrorSizeThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf lowSpaceErrorPercentThreshold(Integer lowSpaceErrorPercentThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf outOfSpaceErrorSizeThreshold(String outOfSpaceErrorSizeThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf outOfSpaceErrorPercentThreshold(Integer outOfSpaceErrorPercentThreshold) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf alertFrequency(String alertFrequency) {
  ...
  **/
  ...
  public DiskSpaceUsageMonitorProviderResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Monitor Provider is enabled for use.")
   ...
   * @return the DiskSpaceUsageMonitorProviderResponseAllOf instance itself
   */
  public DiskSpaceUsageMonitorProviderResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DiskSpaceUsageMonitorProviderResponseAllOf diskSpaceUsageMonitorProviderResponseAllOf = (DiskSpaceUsageMonitorProviderResponseAllOf) o;
    return Objects.equals(this.description, diskSpaceUsageMonitorProviderResponseAllOf.description) &&
        Objects.equals(this.schemas, diskSpaceUsageMonitorProviderResponseAllOf.schemas) &&
        Objects.equals(this.id, diskSpaceUsageMonitorProviderResponseAllOf.id) &&
        Objects.equals(this.lowSpaceWarningSizeThreshold, diskSpaceUsageMonitorProviderResponseAllOf.lowSpaceWarningSizeThreshold) &&
        Objects.equals(this.lowSpaceWarningPercentThreshold, diskSpaceUsageMonitorProviderResponseAllOf.lowSpaceWarningPercentThreshold) &&
        Objects.equals(this.lowSpaceErrorSizeThreshold, diskSpaceUsageMonitorProviderResponseAllOf.lowSpaceErrorSizeThreshold) &&
        Objects.equals(this.lowSpaceErrorPercentThreshold, diskSpaceUsageMonitorProviderResponseAllOf.lowSpaceErrorPercentThreshold) &&
        Objects.equals(this.outOfSpaceErrorSizeThreshold, diskSpaceUsageMonitorProviderResponseAllOf.outOfSpaceErrorSizeThreshold) &&
        Objects.equals(this.outOfSpaceErrorPercentThreshold, diskSpaceUsageMonitorProviderResponseAllOf.outOfSpaceErrorPercentThreshold) &&
        Objects.equals(this.alertFrequency, diskSpaceUsageMonitorProviderResponseAllOf.alertFrequency) &&
        Objects.equals(this.enabled, diskSpaceUsageMonitorProviderResponseAllOf.enabled)&&
        Objects.equals(this.additionalProperties, diskSpaceUsageMonitorProviderResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, lowSpaceWarningSizeThreshold, lowSpaceWarningPercentThreshold, lowSpaceErrorSizeThreshold, lowSpaceErrorPercentThreshold, outOfSpaceErrorSizeThreshold, outOfSpaceErrorPercentThreshold, alertFrequency, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DiskSpaceUsageMonitorProviderResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DiskSpaceUsageMonitorProviderResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DiskSpaceUsageMonitorProviderResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DiskSpaceUsageMonitorProviderResponseAllOf is not found in the empty JSON string", DiskSpaceUsageMonitorProviderResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("alertFrequency") != null && !jsonObj.get("alertFrequency").isJsonNull()) && !jsonObj.get("alertFrequency").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DiskSpaceUsageMonitorProviderResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DiskSpaceUsageMonitorProviderResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DiskSpaceUsageMonitorProviderResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DiskSpaceUsageMonitorProviderResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DiskSpaceUsageMonitorProviderResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DiskSpaceUsageMonitorProviderResponseAllOf value) throws IOException {
           ...
           @Override
           public DiskSpaceUsageMonitorProviderResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DiskSpaceUsageMonitorProviderResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DiskSpaceUsageMonitorProviderResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DiskSpaceUsageMonitorProviderResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DiskSpaceUsageMonitorProviderResponseAllOf
  */
  public static DiskSpaceUsageMonitorProviderResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DiskSpaceUsageMonitorProviderResponseAllOf.class);
  }

 /**
  * Convert an instance of DiskSpaceUsageMonitorProviderResponseAllOf to an JSON string
  *
  * @return JSON string
  */
