...
public class PrometheusMonitoringHttpServletExtensionResponse {
  ...
  public PrometheusMonitoringHttpServletExtensionResponse() {
  }

  public PrometheusMonitoringHttpServletExtensionResponse id(String id) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse description(String description) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse schemas(List<EnumprometheusMonitoringHttpServletExtensionSchemaUrn> schemas) {
  ...
  public PrometheusMonitoringHttpServletExtensionResponse addSchemasItem(EnumprometheusMonitoringHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse includeInstanceNameLabel(Boolean includeInstanceNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse includeProductNameLabel(Boolean includeProductNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse includeLocationNameLabel(Boolean includeLocationNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse alwaysIncludeMonitorEntryNameLabel(Boolean alwaysIncludeMonitorEntryNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse includeMonitorObjectClassNameLabel(Boolean includeMonitorObjectClassNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse includeMonitorAttributeNameLabel(Boolean includeMonitorAttributeNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse labelNameValuePair(List<String> labelNameValuePair) {
  ...
  public PrometheusMonitoringHttpServletExtensionResponse addLabelNameValuePairItem(String labelNameValuePairItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse responseHeader(List<String> responseHeader) {
  ...
  public PrometheusMonitoringHttpServletExtensionResponse addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PrometheusMonitoringHttpServletExtensionResponse instance itself
   */
  public PrometheusMonitoringHttpServletExtensionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrometheusMonitoringHttpServletExtensionResponse prometheusMonitoringHttpServletExtensionResponse = (PrometheusMonitoringHttpServletExtensionResponse) o;
    return Objects.equals(this.id, prometheusMonitoringHttpServletExtensionResponse.id) &&
        Objects.equals(this.description, prometheusMonitoringHttpServletExtensionResponse.description) &&
        Objects.equals(this.schemas, prometheusMonitoringHttpServletExtensionResponse.schemas) &&
        Objects.equals(this.baseContextPath, prometheusMonitoringHttpServletExtensionResponse.baseContextPath) &&
        Objects.equals(this.includeInstanceNameLabel, prometheusMonitoringHttpServletExtensionResponse.includeInstanceNameLabel) &&
        Objects.equals(this.includeProductNameLabel, prometheusMonitoringHttpServletExtensionResponse.includeProductNameLabel) &&
        Objects.equals(this.includeLocationNameLabel, prometheusMonitoringHttpServletExtensionResponse.includeLocationNameLabel) &&
        Objects.equals(this.alwaysIncludeMonitorEntryNameLabel, prometheusMonitoringHttpServletExtensionResponse.alwaysIncludeMonitorEntryNameLabel) &&
        Objects.equals(this.includeMonitorObjectClassNameLabel, prometheusMonitoringHttpServletExtensionResponse.includeMonitorObjectClassNameLabel) &&
        Objects.equals(this.includeMonitorAttributeNameLabel, prometheusMonitoringHttpServletExtensionResponse.includeMonitorAttributeNameLabel) &&
        Objects.equals(this.labelNameValuePair, prometheusMonitoringHttpServletExtensionResponse.labelNameValuePair) &&
        Objects.equals(this.crossOriginPolicy, prometheusMonitoringHttpServletExtensionResponse.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, prometheusMonitoringHttpServletExtensionResponse.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, prometheusMonitoringHttpServletExtensionResponse.correlationIDResponseHeader) &&
        Objects.equals(this.meta, prometheusMonitoringHttpServletExtensionResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, prometheusMonitoringHttpServletExtensionResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, prometheusMonitoringHttpServletExtensionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, baseContextPath, includeInstanceNameLabel, includeProductNameLabel, includeLocationNameLabel, alwaysIncludeMonitorEntryNameLabel, includeMonitorObjectClassNameLabel, includeMonitorAttributeNameLabel, labelNameValuePair, crossOriginPolicy, responseHeader, correlationIDResponseHeader, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrometheusMonitoringHttpServletExtensionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrometheusMonitoringHttpServletExtensionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrometheusMonitoringHttpServletExtensionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrometheusMonitoringHttpServletExtensionResponse is not found in the empty JSON string", PrometheusMonitoringHttpServletExtensionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrometheusMonitoringHttpServletExtensionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrometheusMonitoringHttpServletExtensionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrometheusMonitoringHttpServletExtensionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrometheusMonitoringHttpServletExtensionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrometheusMonitoringHttpServletExtensionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PrometheusMonitoringHttpServletExtensionResponse>() {
           @Override
           public void write(JsonWriter out, PrometheusMonitoringHttpServletExtensionResponse value) throws IOException {
           ...
           @Override
           public PrometheusMonitoringHttpServletExtensionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrometheusMonitoringHttpServletExtensionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrometheusMonitoringHttpServletExtensionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrometheusMonitoringHttpServletExtensionResponse
  * @throws IOException if the JSON string is invalid with respect to PrometheusMonitoringHttpServletExtensionResponse
  */
  public static PrometheusMonitoringHttpServletExtensionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrometheusMonitoringHttpServletExtensionResponse.class);
  }

 /**
  * Convert an instance of PrometheusMonitoringHttpServletExtensionResponse to an JSON string
  *
  * @return JSON string
  */
