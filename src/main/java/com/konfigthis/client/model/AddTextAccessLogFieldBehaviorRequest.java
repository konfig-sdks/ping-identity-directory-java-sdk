...
public class AddTextAccessLogFieldBehaviorRequest {
  ...
  public AddTextAccessLogFieldBehaviorRequest() {
  }

  public AddTextAccessLogFieldBehaviorRequest behaviorName(String behaviorName) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest description(String description) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest schemas(List<EnumtextAccessLogFieldBehaviorSchemaUrn> schemas) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addSchemasItem(EnumtextAccessLogFieldBehaviorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest preserveField(List<EnumlogFieldBehaviorTextAccessPreserveFieldProp> preserveField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addPreserveFieldItem(EnumlogFieldBehaviorTextAccessPreserveFieldProp preserveFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest preserveFieldName(List<String> preserveFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addPreserveFieldNameItem(String preserveFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest omitField(List<EnumlogFieldBehaviorTextAccessOmitFieldProp> omitField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addOmitFieldItem(EnumlogFieldBehaviorTextAccessOmitFieldProp omitFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest omitFieldName(List<String> omitFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addOmitFieldNameItem(String omitFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest redactEntireValueField(List<EnumlogFieldBehaviorTextAccessRedactEntireValueFieldProp> redactEntireValueField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addRedactEntireValueFieldItem(EnumlogFieldBehaviorTextAccessRedactEntireValueFieldProp redactEntireValueFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest redactEntireValueFieldName(List<String> redactEntireValueFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addRedactEntireValueFieldNameItem(String redactEntireValueFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest redactValueComponentsField(List<EnumlogFieldBehaviorTextAccessRedactValueComponentsFieldProp> redactValueComponentsField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addRedactValueComponentsFieldItem(EnumlogFieldBehaviorTextAccessRedactValueComponentsFieldProp redactValueComponentsFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest redactValueComponentsFieldName(List<String> redactValueComponentsFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addRedactValueComponentsFieldNameItem(String redactValueComponentsFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest tokenizeEntireValueField(List<EnumlogFieldBehaviorTextAccessTokenizeEntireValueFieldProp> tokenizeEntireValueField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addTokenizeEntireValueFieldItem(EnumlogFieldBehaviorTextAccessTokenizeEntireValueFieldProp tokenizeEntireValueFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest tokenizeEntireValueFieldName(List<String> tokenizeEntireValueFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addTokenizeEntireValueFieldNameItem(String tokenizeEntireValueFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest tokenizeValueComponentsField(List<EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp> tokenizeValueComponentsField) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addTokenizeValueComponentsFieldItem(EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp tokenizeValueComponentsFieldItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest tokenizeValueComponentsFieldName(List<String> tokenizeValueComponentsFieldName) {
  ...
  public AddTextAccessLogFieldBehaviorRequest addTokenizeValueComponentsFieldNameItem(String tokenizeValueComponentsFieldNameItem) {
  ...
  **/
  ...
  public AddTextAccessLogFieldBehaviorRequest defaultBehavior(EnumlogFieldBehaviorDefaultBehaviorProp defaultBehavior) {
  ...
  **/
   ...
   * @return the AddTextAccessLogFieldBehaviorRequest instance itself
   */
  public AddTextAccessLogFieldBehaviorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddTextAccessLogFieldBehaviorRequest addTextAccessLogFieldBehaviorRequest = (AddTextAccessLogFieldBehaviorRequest) o;
    return Objects.equals(this.behaviorName, addTextAccessLogFieldBehaviorRequest.behaviorName) &&
        Objects.equals(this.description, addTextAccessLogFieldBehaviorRequest.description) &&
        Objects.equals(this.schemas, addTextAccessLogFieldBehaviorRequest.schemas) &&
        Objects.equals(this.preserveField, addTextAccessLogFieldBehaviorRequest.preserveField) &&
        Objects.equals(this.preserveFieldName, addTextAccessLogFieldBehaviorRequest.preserveFieldName) &&
        Objects.equals(this.omitField, addTextAccessLogFieldBehaviorRequest.omitField) &&
        Objects.equals(this.omitFieldName, addTextAccessLogFieldBehaviorRequest.omitFieldName) &&
        Objects.equals(this.redactEntireValueField, addTextAccessLogFieldBehaviorRequest.redactEntireValueField) &&
        Objects.equals(this.redactEntireValueFieldName, addTextAccessLogFieldBehaviorRequest.redactEntireValueFieldName) &&
        Objects.equals(this.redactValueComponentsField, addTextAccessLogFieldBehaviorRequest.redactValueComponentsField) &&
        Objects.equals(this.redactValueComponentsFieldName, addTextAccessLogFieldBehaviorRequest.redactValueComponentsFieldName) &&
        Objects.equals(this.tokenizeEntireValueField, addTextAccessLogFieldBehaviorRequest.tokenizeEntireValueField) &&
        Objects.equals(this.tokenizeEntireValueFieldName, addTextAccessLogFieldBehaviorRequest.tokenizeEntireValueFieldName) &&
        Objects.equals(this.tokenizeValueComponentsField, addTextAccessLogFieldBehaviorRequest.tokenizeValueComponentsField) &&
        Objects.equals(this.tokenizeValueComponentsFieldName, addTextAccessLogFieldBehaviorRequest.tokenizeValueComponentsFieldName) &&
        Objects.equals(this.defaultBehavior, addTextAccessLogFieldBehaviorRequest.defaultBehavior)&&
        Objects.equals(this.additionalProperties, addTextAccessLogFieldBehaviorRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddTextAccessLogFieldBehaviorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddTextAccessLogFieldBehaviorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddTextAccessLogFieldBehaviorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddTextAccessLogFieldBehaviorRequest is not found in the empty JSON string", AddTextAccessLogFieldBehaviorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddTextAccessLogFieldBehaviorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddTextAccessLogFieldBehaviorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddTextAccessLogFieldBehaviorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddTextAccessLogFieldBehaviorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddTextAccessLogFieldBehaviorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddTextAccessLogFieldBehaviorRequest>() {
           @Override
           public void write(JsonWriter out, AddTextAccessLogFieldBehaviorRequest value) throws IOException {
           ...
           @Override
           public AddTextAccessLogFieldBehaviorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddTextAccessLogFieldBehaviorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddTextAccessLogFieldBehaviorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddTextAccessLogFieldBehaviorRequest
  * @throws IOException if the JSON string is invalid with respect to AddTextAccessLogFieldBehaviorRequest
  */
  public static AddTextAccessLogFieldBehaviorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddTextAccessLogFieldBehaviorRequest.class);
  }

 /**
  * Convert an instance of AddTextAccessLogFieldBehaviorRequest to an JSON string
  *
  * @return JSON string
  */
