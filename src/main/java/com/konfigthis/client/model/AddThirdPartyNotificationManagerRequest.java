...
public class AddThirdPartyNotificationManagerRequest {
  ...
  public AddThirdPartyNotificationManagerRequest() {
  }

  public AddThirdPartyNotificationManagerRequest managerName(String managerName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Notification Manager")
  ...
  public AddThirdPartyNotificationManagerRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest schemas(List<EnumthirdPartyNotificationManagerSchemaUrn> schemas) {
  ...
  public AddThirdPartyNotificationManagerRequest addSchemasItem(EnumthirdPartyNotificationManagerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyNotificationManagerRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest subscriptionBaseDN(String subscriptionBaseDN) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest transactionNotification(EnumnotificationManagerTransactionNotificationProp transactionNotification) {
  ...
  **/
  ...
  public AddThirdPartyNotificationManagerRequest monitorEntriesEnabled(Boolean monitorEntriesEnabled) {
  ...
  **/
   ...
   * @return the AddThirdPartyNotificationManagerRequest instance itself
   */
  public AddThirdPartyNotificationManagerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyNotificationManagerRequest addThirdPartyNotificationManagerRequest = (AddThirdPartyNotificationManagerRequest) o;
    return Objects.equals(this.managerName, addThirdPartyNotificationManagerRequest.managerName) &&
        Objects.equals(this.description, addThirdPartyNotificationManagerRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyNotificationManagerRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyNotificationManagerRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyNotificationManagerRequest.extensionArgument) &&
        Objects.equals(this.enabled, addThirdPartyNotificationManagerRequest.enabled) &&
        Objects.equals(this.subscriptionBaseDN, addThirdPartyNotificationManagerRequest.subscriptionBaseDN) &&
        Objects.equals(this.transactionNotification, addThirdPartyNotificationManagerRequest.transactionNotification) &&
        Objects.equals(this.monitorEntriesEnabled, addThirdPartyNotificationManagerRequest.monitorEntriesEnabled)&&
        Objects.equals(this.additionalProperties, addThirdPartyNotificationManagerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(managerName, description, schemas, extensionClass, extensionArgument, enabled, subscriptionBaseDN, transactionNotification, monitorEntriesEnabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyNotificationManagerRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("managerName");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyNotificationManagerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyNotificationManagerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyNotificationManagerRequest is not found in the empty JSON string", AddThirdPartyNotificationManagerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyNotificationManagerRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("managerName").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyNotificationManagerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyNotificationManagerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyNotificationManagerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyNotificationManagerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyNotificationManagerRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyNotificationManagerRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyNotificationManagerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyNotificationManagerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyNotificationManagerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyNotificationManagerRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyNotificationManagerRequest
  */
  public static AddThirdPartyNotificationManagerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyNotificationManagerRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyNotificationManagerRequest to an JSON string
  *
  * @return JSON string
  */
