...
public class FileBasedDebugLogPublisherResponse {
  ...
  public FileBasedDebugLogPublisherResponse() {
  }

  public FileBasedDebugLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse schemas(List<EnumfileBasedDebugLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedDebugLogPublisherResponse addSchemasItem(EnumfileBasedDebugLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Debug Log Publisher.")
  ...
  public FileBasedDebugLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedDebugLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Debug Log Publisher .")
  ...
  public FileBasedDebugLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedDebugLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedDebugLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Debug Log Publisher .")
  ...
  public FileBasedDebugLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based Debug Log Publisher will publish records asynchronously.")
  ...
  public FileBasedDebugLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultDebugLevel(EnumlogPublisherDefaultDebugLevelProp defaultDebugLevel) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultDebugCategory(List<EnumlogPublisherDefaultDebugCategoryProp> defaultDebugCategory) {
  ...
  public FileBasedDebugLogPublisherResponse addDefaultDebugCategoryItem(EnumlogPublisherDefaultDebugCategoryProp defaultDebugCategoryItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultOmitMethodEntryArguments(Boolean defaultOmitMethodEntryArguments) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultOmitMethodReturnValue(Boolean defaultOmitMethodReturnValue) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultIncludeThrowableCause(Boolean defaultIncludeThrowableCause) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse defaultThrowableStackFrames(Integer defaultThrowableStackFrames) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedDebugLogPublisherResponse instance itself
   */
  public FileBasedDebugLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedDebugLogPublisherResponse fileBasedDebugLogPublisherResponse = (FileBasedDebugLogPublisherResponse) o;
    return Objects.equals(this.id, fileBasedDebugLogPublisherResponse.id) &&
        Objects.equals(this.description, fileBasedDebugLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedDebugLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, fileBasedDebugLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedDebugLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedDebugLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedDebugLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedDebugLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedDebugLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedDebugLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedDebugLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedDebugLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedDebugLogPublisherResponse.append) &&
        Objects.equals(this.asynchronous, fileBasedDebugLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedDebugLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedDebugLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedDebugLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedDebugLogPublisherResponse.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedDebugLogPublisherResponse.timestampPrecision) &&
        Objects.equals(this.defaultDebugLevel, fileBasedDebugLogPublisherResponse.defaultDebugLevel) &&
        Objects.equals(this.defaultDebugCategory, fileBasedDebugLogPublisherResponse.defaultDebugCategory) &&
        Objects.equals(this.defaultOmitMethodEntryArguments, fileBasedDebugLogPublisherResponse.defaultOmitMethodEntryArguments) &&
        Objects.equals(this.defaultOmitMethodReturnValue, fileBasedDebugLogPublisherResponse.defaultOmitMethodReturnValue) &&
        Objects.equals(this.defaultIncludeThrowableCause, fileBasedDebugLogPublisherResponse.defaultIncludeThrowableCause) &&
        Objects.equals(this.defaultThrowableStackFrames, fileBasedDebugLogPublisherResponse.defaultThrowableStackFrames) &&
        Objects.equals(this.enabled, fileBasedDebugLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedDebugLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedDebugLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedDebugLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedDebugLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, defaultDebugLevel, defaultDebugCategory, defaultOmitMethodEntryArguments, defaultOmitMethodReturnValue, defaultIncludeThrowableCause, defaultThrowableStackFrames, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedDebugLogPublisherResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("defaultDebugLevel");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedDebugLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedDebugLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedDebugLogPublisherResponse is not found in the empty JSON string", FileBasedDebugLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedDebugLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedDebugLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedDebugLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedDebugLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedDebugLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedDebugLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedDebugLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedDebugLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedDebugLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedDebugLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedDebugLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedDebugLogPublisherResponse
  */
  public static FileBasedDebugLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedDebugLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedDebugLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
