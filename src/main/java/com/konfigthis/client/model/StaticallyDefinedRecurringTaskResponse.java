...
public class StaticallyDefinedRecurringTaskResponse {
  ...
  public StaticallyDefinedRecurringTaskResponse() {
  }

  public StaticallyDefinedRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse schemas(List<EnumstaticallyDefinedRecurringTaskSchemaUrn> schemas) {
  ...
  public StaticallyDefinedRecurringTaskResponse addSchemasItem(EnumstaticallyDefinedRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse taskJavaClass(String taskJavaClass) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse taskObjectClass(List<String> taskObjectClass) {
  ...
  public StaticallyDefinedRecurringTaskResponse addTaskObjectClassItem(String taskObjectClassItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse taskAttributeValue(List<String> taskAttributeValue) {
  ...
  public StaticallyDefinedRecurringTaskResponse addTaskAttributeValueItem(String taskAttributeValueItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public StaticallyDefinedRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public StaticallyDefinedRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public StaticallyDefinedRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public StaticallyDefinedRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the StaticallyDefinedRecurringTaskResponse instance itself
   */
  public StaticallyDefinedRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StaticallyDefinedRecurringTaskResponse staticallyDefinedRecurringTaskResponse = (StaticallyDefinedRecurringTaskResponse) o;
    return Objects.equals(this.id, staticallyDefinedRecurringTaskResponse.id) &&
        Objects.equals(this.description, staticallyDefinedRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, staticallyDefinedRecurringTaskResponse.schemas) &&
        Objects.equals(this.taskJavaClass, staticallyDefinedRecurringTaskResponse.taskJavaClass) &&
        Objects.equals(this.taskObjectClass, staticallyDefinedRecurringTaskResponse.taskObjectClass) &&
        Objects.equals(this.taskAttributeValue, staticallyDefinedRecurringTaskResponse.taskAttributeValue) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, staticallyDefinedRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, staticallyDefinedRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, staticallyDefinedRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, staticallyDefinedRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, staticallyDefinedRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, staticallyDefinedRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, staticallyDefinedRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, staticallyDefinedRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, staticallyDefinedRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, staticallyDefinedRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, taskJavaClass, taskObjectClass, taskAttributeValue, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StaticallyDefinedRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to StaticallyDefinedRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StaticallyDefinedRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StaticallyDefinedRecurringTaskResponse is not found in the empty JSON string", StaticallyDefinedRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StaticallyDefinedRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StaticallyDefinedRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StaticallyDefinedRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StaticallyDefinedRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StaticallyDefinedRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StaticallyDefinedRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, StaticallyDefinedRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public StaticallyDefinedRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StaticallyDefinedRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StaticallyDefinedRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StaticallyDefinedRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to StaticallyDefinedRecurringTaskResponse
  */
  public static StaticallyDefinedRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StaticallyDefinedRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of StaticallyDefinedRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
