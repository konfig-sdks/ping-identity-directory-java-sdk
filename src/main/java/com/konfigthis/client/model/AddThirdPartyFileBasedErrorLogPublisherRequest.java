...
public class AddThirdPartyFileBasedErrorLogPublisherRequest {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest() {
  }

  public AddThirdPartyFileBasedErrorLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest schemas(List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addSchemasItem(EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest logFile(String logFile) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this Third Party File Based Error Log Publisher.")
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest rotationPolicy(List<String> rotationPolicy) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the Third Party File Based Error Log Publisher .")
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest rotationListener(List<String> rotationListener) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest retentionPolicy(List<String> retentionPolicy) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the Third Party File Based Error Log Publisher .")
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest signLog(Boolean signLog) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest append(Boolean append) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the Third Party File Based Error Log Publisher will publish records asynchronously.")
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest bufferSize(String bufferSize) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest timeInterval(String timeInterval) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest overrideSeverity(List<String> overrideSeverity) {
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyFileBasedErrorLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddThirdPartyFileBasedErrorLogPublisherRequest instance itself
   */
  public AddThirdPartyFileBasedErrorLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyFileBasedErrorLogPublisherRequest addThirdPartyFileBasedErrorLogPublisherRequest = (AddThirdPartyFileBasedErrorLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addThirdPartyFileBasedErrorLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addThirdPartyFileBasedErrorLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyFileBasedErrorLogPublisherRequest.schemas) &&
        Objects.equals(this.logFile, addThirdPartyFileBasedErrorLogPublisherRequest.logFile) &&
        Objects.equals(this.logFilePermissions, addThirdPartyFileBasedErrorLogPublisherRequest.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, addThirdPartyFileBasedErrorLogPublisherRequest.rotationPolicy) &&
        Objects.equals(this.rotationListener, addThirdPartyFileBasedErrorLogPublisherRequest.rotationListener) &&
        Objects.equals(this.retentionPolicy, addThirdPartyFileBasedErrorLogPublisherRequest.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, addThirdPartyFileBasedErrorLogPublisherRequest.compressionMechanism) &&
        Objects.equals(this.signLog, addThirdPartyFileBasedErrorLogPublisherRequest.signLog) &&
        Objects.equals(this.encryptLog, addThirdPartyFileBasedErrorLogPublisherRequest.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, addThirdPartyFileBasedErrorLogPublisherRequest.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, addThirdPartyFileBasedErrorLogPublisherRequest.append) &&
        Objects.equals(this.extensionClass, addThirdPartyFileBasedErrorLogPublisherRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyFileBasedErrorLogPublisherRequest.extensionArgument) &&
        Objects.equals(this.asynchronous, addThirdPartyFileBasedErrorLogPublisherRequest.asynchronous) &&
        Objects.equals(this.autoFlush, addThirdPartyFileBasedErrorLogPublisherRequest.autoFlush) &&
        Objects.equals(this.bufferSize, addThirdPartyFileBasedErrorLogPublisherRequest.bufferSize) &&
        Objects.equals(this.queueSize, addThirdPartyFileBasedErrorLogPublisherRequest.queueSize) &&
        Objects.equals(this.timeInterval, addThirdPartyFileBasedErrorLogPublisherRequest.timeInterval) &&
        Objects.equals(this.defaultSeverity, addThirdPartyFileBasedErrorLogPublisherRequest.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, addThirdPartyFileBasedErrorLogPublisherRequest.overrideSeverity) &&
        Objects.equals(this.enabled, addThirdPartyFileBasedErrorLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addThirdPartyFileBasedErrorLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addThirdPartyFileBasedErrorLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, extensionClass, extensionArgument, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyFileBasedErrorLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyFileBasedErrorLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyFileBasedErrorLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyFileBasedErrorLogPublisherRequest is not found in the empty JSON string", AddThirdPartyFileBasedErrorLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyFileBasedErrorLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyFileBasedErrorLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyFileBasedErrorLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyFileBasedErrorLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyFileBasedErrorLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyFileBasedErrorLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyFileBasedErrorLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyFileBasedErrorLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyFileBasedErrorLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyFileBasedErrorLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyFileBasedErrorLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyFileBasedErrorLogPublisherRequest
  */
  public static AddThirdPartyFileBasedErrorLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyFileBasedErrorLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyFileBasedErrorLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
