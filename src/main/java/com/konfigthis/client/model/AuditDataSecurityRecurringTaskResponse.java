...
public class AuditDataSecurityRecurringTaskResponse {
  ...
  public AuditDataSecurityRecurringTaskResponse() {
  }

  public AuditDataSecurityRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse schemas(List<EnumauditDataSecurityRecurringTaskSchemaUrn> schemas) {
  ...
  public AuditDataSecurityRecurringTaskResponse addSchemasItem(EnumauditDataSecurityRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse baseOutputDirectory(String baseOutputDirectory) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The base directory below which generated reports will be written. Each invocation of the audit-data-security task will create a new subdirectory below this base directory whose name is a timestamp indicating when the report was generated.")
  ...
  public AuditDataSecurityRecurringTaskResponse dataSecurityAuditor(List<String> dataSecurityAuditor) {
  ...
  public AuditDataSecurityRecurringTaskResponse addDataSecurityAuditorItem(String dataSecurityAuditorItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse backend(List<String> backend) {
  ...
  public AuditDataSecurityRecurringTaskResponse addBackendItem(String backendItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse includeFilter(List<String> includeFilter) {
  ...
  public AuditDataSecurityRecurringTaskResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse retainPreviousReportCount(Integer retainPreviousReportCount) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse retainPreviousReportAge(String retainPreviousReportAge) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public AuditDataSecurityRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AuditDataSecurityRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public AuditDataSecurityRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AuditDataSecurityRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AuditDataSecurityRecurringTaskResponse instance itself
   */
  public AuditDataSecurityRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AuditDataSecurityRecurringTaskResponse auditDataSecurityRecurringTaskResponse = (AuditDataSecurityRecurringTaskResponse) o;
    return Objects.equals(this.id, auditDataSecurityRecurringTaskResponse.id) &&
        Objects.equals(this.description, auditDataSecurityRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, auditDataSecurityRecurringTaskResponse.schemas) &&
        Objects.equals(this.baseOutputDirectory, auditDataSecurityRecurringTaskResponse.baseOutputDirectory) &&
        Objects.equals(this.dataSecurityAuditor, auditDataSecurityRecurringTaskResponse.dataSecurityAuditor) &&
        Objects.equals(this.backend, auditDataSecurityRecurringTaskResponse.backend) &&
        Objects.equals(this.includeFilter, auditDataSecurityRecurringTaskResponse.includeFilter) &&
        Objects.equals(this.retainPreviousReportCount, auditDataSecurityRecurringTaskResponse.retainPreviousReportCount) &&
        Objects.equals(this.retainPreviousReportAge, auditDataSecurityRecurringTaskResponse.retainPreviousReportAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, auditDataSecurityRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, auditDataSecurityRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, auditDataSecurityRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, auditDataSecurityRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, auditDataSecurityRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, auditDataSecurityRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, auditDataSecurityRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, auditDataSecurityRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, auditDataSecurityRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, auditDataSecurityRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, baseOutputDirectory, dataSecurityAuditor, backend, includeFilter, retainPreviousReportCount, retainPreviousReportAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuditDataSecurityRecurringTaskResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("baseOutputDirectory");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AuditDataSecurityRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AuditDataSecurityRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AuditDataSecurityRecurringTaskResponse is not found in the empty JSON string", AuditDataSecurityRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AuditDataSecurityRecurringTaskResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("baseOutputDirectory").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AuditDataSecurityRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AuditDataSecurityRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AuditDataSecurityRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AuditDataSecurityRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AuditDataSecurityRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, AuditDataSecurityRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public AuditDataSecurityRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AuditDataSecurityRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AuditDataSecurityRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AuditDataSecurityRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to AuditDataSecurityRecurringTaskResponse
  */
  public static AuditDataSecurityRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AuditDataSecurityRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of AuditDataSecurityRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
