...
public class SimpleSearchReferenceCriteriaResponse {
  ...
  public SimpleSearchReferenceCriteriaResponse() {
  }

  public SimpleSearchReferenceCriteriaResponse id(String id) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse description(String description) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse schemas(List<EnumsimpleSearchReferenceCriteriaSchemaUrn> schemas) {
  ...
  public SimpleSearchReferenceCriteriaResponse addSchemasItem(EnumsimpleSearchReferenceCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse allIncludedReferenceControl(List<String> allIncludedReferenceControl) {
  ...
  public SimpleSearchReferenceCriteriaResponse addAllIncludedReferenceControlItem(String allIncludedReferenceControlItem) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse anyIncludedReferenceControl(List<String> anyIncludedReferenceControl) {
  ...
  public SimpleSearchReferenceCriteriaResponse addAnyIncludedReferenceControlItem(String anyIncludedReferenceControlItem) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse notAllIncludedReferenceControl(List<String> notAllIncludedReferenceControl) {
  ...
  public SimpleSearchReferenceCriteriaResponse addNotAllIncludedReferenceControlItem(String notAllIncludedReferenceControlItem) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse noneIncludedReferenceControl(List<String> noneIncludedReferenceControl) {
  ...
  public SimpleSearchReferenceCriteriaResponse addNoneIncludedReferenceControlItem(String noneIncludedReferenceControlItem) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SimpleSearchReferenceCriteriaResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SimpleSearchReferenceCriteriaResponse instance itself
   */
  public SimpleSearchReferenceCriteriaResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SimpleSearchReferenceCriteriaResponse simpleSearchReferenceCriteriaResponse = (SimpleSearchReferenceCriteriaResponse) o;
    return Objects.equals(this.id, simpleSearchReferenceCriteriaResponse.id) &&
        Objects.equals(this.description, simpleSearchReferenceCriteriaResponse.description) &&
        Objects.equals(this.schemas, simpleSearchReferenceCriteriaResponse.schemas) &&
        Objects.equals(this.requestCriteria, simpleSearchReferenceCriteriaResponse.requestCriteria) &&
        Objects.equals(this.allIncludedReferenceControl, simpleSearchReferenceCriteriaResponse.allIncludedReferenceControl) &&
        Objects.equals(this.anyIncludedReferenceControl, simpleSearchReferenceCriteriaResponse.anyIncludedReferenceControl) &&
        Objects.equals(this.notAllIncludedReferenceControl, simpleSearchReferenceCriteriaResponse.notAllIncludedReferenceControl) &&
        Objects.equals(this.noneIncludedReferenceControl, simpleSearchReferenceCriteriaResponse.noneIncludedReferenceControl) &&
        Objects.equals(this.meta, simpleSearchReferenceCriteriaResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, simpleSearchReferenceCriteriaResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, simpleSearchReferenceCriteriaResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, requestCriteria, allIncludedReferenceControl, anyIncludedReferenceControl, notAllIncludedReferenceControl, noneIncludedReferenceControl, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SimpleSearchReferenceCriteriaResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SimpleSearchReferenceCriteriaResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SimpleSearchReferenceCriteriaResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SimpleSearchReferenceCriteriaResponse is not found in the empty JSON string", SimpleSearchReferenceCriteriaResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SimpleSearchReferenceCriteriaResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SimpleSearchReferenceCriteriaResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SimpleSearchReferenceCriteriaResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SimpleSearchReferenceCriteriaResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SimpleSearchReferenceCriteriaResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SimpleSearchReferenceCriteriaResponse>() {
           @Override
           public void write(JsonWriter out, SimpleSearchReferenceCriteriaResponse value) throws IOException {
           ...
           @Override
           public SimpleSearchReferenceCriteriaResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SimpleSearchReferenceCriteriaResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SimpleSearchReferenceCriteriaResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SimpleSearchReferenceCriteriaResponse
  * @throws IOException if the JSON string is invalid with respect to SimpleSearchReferenceCriteriaResponse
  */
  public static SimpleSearchReferenceCriteriaResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SimpleSearchReferenceCriteriaResponse.class);
  }

 /**
  * Convert an instance of SimpleSearchReferenceCriteriaResponse to an JSON string
  *
  * @return JSON string
  */
