...
public class IsMemberOfVirtualAttributeShared {
  ...
  public IsMemberOfVirtualAttributeShared() {
  }

  public IsMemberOfVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared schemas(List<EnumisMemberOfVirtualAttributeSchemaUrn> schemas) {
  ...
  public IsMemberOfVirtualAttributeShared addSchemasItem(EnumisMemberOfVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared directMembershipsOnly(Boolean directMembershipsOnly) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared includedGroupFilter(String includedGroupFilter) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared rewriteSearchFilters(EnumvirtualAttributeRewriteSearchFiltersProp rewriteSearchFilters) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public IsMemberOfVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public IsMemberOfVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared filter(List<String> filter) {
  ...
  public IsMemberOfVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public IsMemberOfVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the IsMemberOfVirtualAttributeShared instance itself
   */
  public IsMemberOfVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IsMemberOfVirtualAttributeShared isMemberOfVirtualAttributeShared = (IsMemberOfVirtualAttributeShared) o;
    return Objects.equals(this.description, isMemberOfVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, isMemberOfVirtualAttributeShared.schemas) &&
        Objects.equals(this.conflictBehavior, isMemberOfVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.attributeType, isMemberOfVirtualAttributeShared.attributeType) &&
        Objects.equals(this.directMembershipsOnly, isMemberOfVirtualAttributeShared.directMembershipsOnly) &&
        Objects.equals(this.includedGroupFilter, isMemberOfVirtualAttributeShared.includedGroupFilter) &&
        Objects.equals(this.rewriteSearchFilters, isMemberOfVirtualAttributeShared.rewriteSearchFilters) &&
        Objects.equals(this.enabled, isMemberOfVirtualAttributeShared.enabled) &&
        Objects.equals(this.baseDN, isMemberOfVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, isMemberOfVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, isMemberOfVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, isMemberOfVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, isMemberOfVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, isMemberOfVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, isMemberOfVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, isMemberOfVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, isMemberOfVirtualAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, conflictBehavior, attributeType, directMembershipsOnly, includedGroupFilter, rewriteSearchFilters, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IsMemberOfVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IsMemberOfVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IsMemberOfVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsMemberOfVirtualAttributeShared is not found in the empty JSON string", IsMemberOfVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsMemberOfVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsMemberOfVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsMemberOfVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsMemberOfVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsMemberOfVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<IsMemberOfVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, IsMemberOfVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public IsMemberOfVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IsMemberOfVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IsMemberOfVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsMemberOfVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to IsMemberOfVirtualAttributeShared
  */
  public static IsMemberOfVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsMemberOfVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of IsMemberOfVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
