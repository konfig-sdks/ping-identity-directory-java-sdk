...
public class JdbcBasedAccessLogPublisherShared {
  ...
  public JdbcBasedAccessLogPublisherShared() {
  }

  public JdbcBasedAccessLogPublisherShared description(String description) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared schemas(List<EnumjdbcBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public JdbcBasedAccessLogPublisherShared addSchemasItem(EnumjdbcBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared server(String server) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logFieldMapping(String logFieldMapping) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logTableName(String logTableName) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logResults(Boolean logResults) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the JdbcBasedAccessLogPublisherShared instance itself
   */
  public JdbcBasedAccessLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JdbcBasedAccessLogPublisherShared jdbcBasedAccessLogPublisherShared = (JdbcBasedAccessLogPublisherShared) o;
    return Objects.equals(this.description, jdbcBasedAccessLogPublisherShared.description) &&
        Objects.equals(this.schemas, jdbcBasedAccessLogPublisherShared.schemas) &&
        Objects.equals(this.server, jdbcBasedAccessLogPublisherShared.server) &&
        Objects.equals(this.logFieldMapping, jdbcBasedAccessLogPublisherShared.logFieldMapping) &&
        Objects.equals(this.logTableName, jdbcBasedAccessLogPublisherShared.logTableName) &&
        Objects.equals(this.queueSize, jdbcBasedAccessLogPublisherShared.queueSize) &&
        Objects.equals(this.logConnects, jdbcBasedAccessLogPublisherShared.logConnects) &&
        Objects.equals(this.logDisconnects, jdbcBasedAccessLogPublisherShared.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, jdbcBasedAccessLogPublisherShared.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, jdbcBasedAccessLogPublisherShared.logClientCertificates) &&
        Objects.equals(this.logRequests, jdbcBasedAccessLogPublisherShared.logRequests) &&
        Objects.equals(this.logResults, jdbcBasedAccessLogPublisherShared.logResults) &&
        Objects.equals(this.logSearchEntries, jdbcBasedAccessLogPublisherShared.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, jdbcBasedAccessLogPublisherShared.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, jdbcBasedAccessLogPublisherShared.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, jdbcBasedAccessLogPublisherShared.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, jdbcBasedAccessLogPublisherShared.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, jdbcBasedAccessLogPublisherShared.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, jdbcBasedAccessLogPublisherShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, jdbcBasedAccessLogPublisherShared.requestCriteria) &&
        Objects.equals(this.resultCriteria, jdbcBasedAccessLogPublisherShared.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, jdbcBasedAccessLogPublisherShared.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, jdbcBasedAccessLogPublisherShared.searchReferenceCriteria) &&
        Objects.equals(this.enabled, jdbcBasedAccessLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, jdbcBasedAccessLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, jdbcBasedAccessLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, server, logFieldMapping, logTableName, queueSize, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JdbcBasedAccessLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JdbcBasedAccessLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JdbcBasedAccessLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JdbcBasedAccessLogPublisherShared is not found in the empty JSON string", JdbcBasedAccessLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JdbcBasedAccessLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JdbcBasedAccessLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JdbcBasedAccessLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JdbcBasedAccessLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JdbcBasedAccessLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JdbcBasedAccessLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, JdbcBasedAccessLogPublisherShared value) throws IOException {
           ...
           @Override
           public JdbcBasedAccessLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JdbcBasedAccessLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JdbcBasedAccessLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JdbcBasedAccessLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to JdbcBasedAccessLogPublisherShared
  */
  public static JdbcBasedAccessLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JdbcBasedAccessLogPublisherShared.class);
  }

 /**
  * Convert an instance of JdbcBasedAccessLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
