...
public class BackupRecurringTaskShared {
  ...
  public BackupRecurringTaskShared() {
  }

  public BackupRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public BackupRecurringTaskShared schemas(List<EnumbackupRecurringTaskSchemaUrn> schemas) {
  ...
  public BackupRecurringTaskShared addSchemasItem(EnumbackupRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared backupDirectory(String backupDirectory) {
  ...
  **/
  ...
  public BackupRecurringTaskShared includedBackendID(List<String> includedBackendID) {
  ...
  public BackupRecurringTaskShared addIncludedBackendIDItem(String includedBackendIDItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared excludedBackendID(List<String> excludedBackendID) {
  ...
  public BackupRecurringTaskShared addExcludedBackendIDItem(String excludedBackendIDItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared compress(Boolean compress) {
  ...
  **/
  ...
  public BackupRecurringTaskShared encrypt(Boolean encrypt) {
  ...
  **/
  ...
  public BackupRecurringTaskShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public BackupRecurringTaskShared sign(Boolean sign) {
  ...
  **/
  ...
  public BackupRecurringTaskShared retainPreviousFullBackupCount(Integer retainPreviousFullBackupCount) {
  ...
  **/
  ...
  public BackupRecurringTaskShared retainPreviousFullBackupAge(String retainPreviousFullBackupAge) {
  ...
  **/
  ...
  public BackupRecurringTaskShared maxMegabytesPerSecond(Integer maxMegabytesPerSecond) {
  ...
  **/
  ...
  public BackupRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public BackupRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public BackupRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public BackupRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public BackupRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public BackupRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public BackupRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public BackupRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the BackupRecurringTaskShared instance itself
   */
  public BackupRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BackupRecurringTaskShared backupRecurringTaskShared = (BackupRecurringTaskShared) o;
    return Objects.equals(this.description, backupRecurringTaskShared.description) &&
        Objects.equals(this.schemas, backupRecurringTaskShared.schemas) &&
        Objects.equals(this.backupDirectory, backupRecurringTaskShared.backupDirectory) &&
        Objects.equals(this.includedBackendID, backupRecurringTaskShared.includedBackendID) &&
        Objects.equals(this.excludedBackendID, backupRecurringTaskShared.excludedBackendID) &&
        Objects.equals(this.compress, backupRecurringTaskShared.compress) &&
        Objects.equals(this.encrypt, backupRecurringTaskShared.encrypt) &&
        Objects.equals(this.encryptionSettingsDefinitionID, backupRecurringTaskShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.sign, backupRecurringTaskShared.sign) &&
        Objects.equals(this.retainPreviousFullBackupCount, backupRecurringTaskShared.retainPreviousFullBackupCount) &&
        Objects.equals(this.retainPreviousFullBackupAge, backupRecurringTaskShared.retainPreviousFullBackupAge) &&
        Objects.equals(this.maxMegabytesPerSecond, backupRecurringTaskShared.maxMegabytesPerSecond) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, backupRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, backupRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, backupRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, backupRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, backupRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, backupRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, backupRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, backupRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, backupDirectory, includedBackendID, excludedBackendID, compress, encrypt, encryptionSettingsDefinitionID, sign, retainPreviousFullBackupCount, retainPreviousFullBackupAge, maxMegabytesPerSecond, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BackupRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BackupRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BackupRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackupRecurringTaskShared is not found in the empty JSON string", BackupRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BackupRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackupRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackupRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackupRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackupRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<BackupRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, BackupRecurringTaskShared value) throws IOException {
           ...
           @Override
           public BackupRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BackupRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BackupRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BackupRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to BackupRecurringTaskShared
  */
  public static BackupRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackupRecurringTaskShared.class);
  }

 /**
  * Convert an instance of BackupRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
