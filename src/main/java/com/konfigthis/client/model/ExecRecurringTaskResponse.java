...
public class ExecRecurringTaskResponse {
  ...
  public ExecRecurringTaskResponse() {
  }

  public ExecRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse schemas(List<EnumexecRecurringTaskSchemaUrn> schemas) {
  ...
  public ExecRecurringTaskResponse addSchemasItem(EnumexecRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse commandPath(String commandPath) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse commandArguments(String commandArguments) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse commandOutputFileBaseName(String commandOutputFileBaseName) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse retainPreviousOutputFileCount(Integer retainPreviousOutputFileCount) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse retainPreviousOutputFileAge(String retainPreviousOutputFileAge) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse logCommandOutput(Boolean logCommandOutput) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse taskCompletionStateForNonzeroExitCode(EnumrecurringTaskTaskCompletionStateForNonzeroExitCodeProp taskCompletionStateForNonzeroExitCode) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse workingDirectory(String workingDirectory) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public ExecRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public ExecRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public ExecRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ExecRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ExecRecurringTaskResponse instance itself
   */
  public ExecRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExecRecurringTaskResponse execRecurringTaskResponse = (ExecRecurringTaskResponse) o;
    return Objects.equals(this.id, execRecurringTaskResponse.id) &&
        Objects.equals(this.description, execRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, execRecurringTaskResponse.schemas) &&
        Objects.equals(this.commandPath, execRecurringTaskResponse.commandPath) &&
        Objects.equals(this.commandArguments, execRecurringTaskResponse.commandArguments) &&
        Objects.equals(this.commandOutputFileBaseName, execRecurringTaskResponse.commandOutputFileBaseName) &&
        Objects.equals(this.retainPreviousOutputFileCount, execRecurringTaskResponse.retainPreviousOutputFileCount) &&
        Objects.equals(this.retainPreviousOutputFileAge, execRecurringTaskResponse.retainPreviousOutputFileAge) &&
        Objects.equals(this.logCommandOutput, execRecurringTaskResponse.logCommandOutput) &&
        Objects.equals(this.taskCompletionStateForNonzeroExitCode, execRecurringTaskResponse.taskCompletionStateForNonzeroExitCode) &&
        Objects.equals(this.workingDirectory, execRecurringTaskResponse.workingDirectory) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, execRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, execRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, execRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, execRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, execRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, execRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, execRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, execRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, execRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, execRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, commandPath, commandArguments, commandOutputFileBaseName, retainPreviousOutputFileCount, retainPreviousOutputFileAge, logCommandOutput, taskCompletionStateForNonzeroExitCode, workingDirectory, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExecRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExecRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExecRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExecRecurringTaskResponse is not found in the empty JSON string", ExecRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExecRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExecRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExecRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExecRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExecRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExecRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, ExecRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public ExecRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExecRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExecRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExecRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to ExecRecurringTaskResponse
  */
  public static ExecRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExecRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of ExecRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
