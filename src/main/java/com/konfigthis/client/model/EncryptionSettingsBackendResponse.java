...
import com.konfigthis.client.model.EnumencryptionSettingsBackendSchemaUrn;
...
public class EncryptionSettingsBackendResponse {
  ...
  private List<EnumencryptionSettingsBackendSchemaUrn> schemas = new ArrayList<>();
  ...
  public EncryptionSettingsBackendResponse() {
  }

  public EncryptionSettingsBackendResponse description(String description) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse schemas(List<EnumencryptionSettingsBackendSchemaUrn> schemas) {
  ...
  public EncryptionSettingsBackendResponse addSchemasItem(EnumencryptionSettingsBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumencryptionSettingsBackendSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumencryptionSettingsBackendSchemaUrn> schemas) {
  ...
  public EncryptionSettingsBackendResponse id(String id) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse baseDN(List<String> baseDN) {
  ...
  public EncryptionSettingsBackendResponse addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse backendID(String backendID) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse notificationManager(String notificationManager) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EncryptionSettingsBackendResponse instance itself
   */
  public EncryptionSettingsBackendResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EncryptionSettingsBackendResponse encryptionSettingsBackendResponse = (EncryptionSettingsBackendResponse) o;
    return Objects.equals(this.description, encryptionSettingsBackendResponse.description) &&
        Objects.equals(this.schemas, encryptionSettingsBackendResponse.schemas) &&
        Objects.equals(this.id, encryptionSettingsBackendResponse.id) &&
        Objects.equals(this.baseDN, encryptionSettingsBackendResponse.baseDN) &&
        Objects.equals(this.backendID, encryptionSettingsBackendResponse.backendID) &&
        Objects.equals(this.enabled, encryptionSettingsBackendResponse.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, encryptionSettingsBackendResponse.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, encryptionSettingsBackendResponse.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, encryptionSettingsBackendResponse.backupFilePermissions) &&
        Objects.equals(this.notificationManager, encryptionSettingsBackendResponse.notificationManager) &&
        Objects.equals(this.meta, encryptionSettingsBackendResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, encryptionSettingsBackendResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, encryptionSettingsBackendResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseDN, backendID, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EncryptionSettingsBackendResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EncryptionSettingsBackendResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EncryptionSettingsBackendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptionSettingsBackendResponse is not found in the empty JSON string", EncryptionSettingsBackendResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EncryptionSettingsBackendResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptionSettingsBackendResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptionSettingsBackendResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptionSettingsBackendResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptionSettingsBackendResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptionSettingsBackendResponse>() {
           @Override
           public void write(JsonWriter out, EncryptionSettingsBackendResponse value) throws IOException {
           ...
           @Override
           public EncryptionSettingsBackendResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EncryptionSettingsBackendResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EncryptionSettingsBackendResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncryptionSettingsBackendResponse
  * @throws IOException if the JSON string is invalid with respect to EncryptionSettingsBackendResponse
  */
  public static EncryptionSettingsBackendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptionSettingsBackendResponse.class);
  }

 /**
  * Convert an instance of EncryptionSettingsBackendResponse to an JSON string
  *
  * @return JSON string
  */
