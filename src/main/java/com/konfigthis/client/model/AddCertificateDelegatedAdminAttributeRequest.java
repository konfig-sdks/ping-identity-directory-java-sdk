...
public class AddCertificateDelegatedAdminAttributeRequest {
  ...
  public AddCertificateDelegatedAdminAttributeRequest() {
  }

  public AddCertificateDelegatedAdminAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest schemas(List<EnumcertificateDelegatedAdminAttributeSchemaUrn> schemas) {
  ...
  public AddCertificateDelegatedAdminAttributeRequest addSchemasItem(EnumcertificateDelegatedAdminAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest allowedMIMEType(List<EnumdelegatedAdminAttributeCertificateAllowedMIMETypeProp> allowedMIMEType) {
  ...
  public AddCertificateDelegatedAdminAttributeRequest addAllowedMIMETypeItem(EnumdelegatedAdminAttributeCertificateAllowedMIMETypeProp allowedMIMETypeItem) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest displayName(String displayName) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest mutability(EnumdelegatedAdminAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest attributeCategory(String attributeCategory) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest displayOrderIndex(Integer displayOrderIndex) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest referenceResourceType(String referenceResourceType) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest attributePresentation(EnumdelegatedAdminAttributeAttributePresentationProp attributePresentation) {
  ...
  **/
  ...
  public AddCertificateDelegatedAdminAttributeRequest dateTimeFormat(String dateTimeFormat) {
  ...
  **/
   ...
   * @return the AddCertificateDelegatedAdminAttributeRequest instance itself
   */
  public AddCertificateDelegatedAdminAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddCertificateDelegatedAdminAttributeRequest addCertificateDelegatedAdminAttributeRequest = (AddCertificateDelegatedAdminAttributeRequest) o;
    return Objects.equals(this.attributeType, addCertificateDelegatedAdminAttributeRequest.attributeType) &&
        Objects.equals(this.description, addCertificateDelegatedAdminAttributeRequest.description) &&
        Objects.equals(this.schemas, addCertificateDelegatedAdminAttributeRequest.schemas) &&
        Objects.equals(this.allowedMIMEType, addCertificateDelegatedAdminAttributeRequest.allowedMIMEType) &&
        Objects.equals(this.displayName, addCertificateDelegatedAdminAttributeRequest.displayName) &&
        Objects.equals(this.mutability, addCertificateDelegatedAdminAttributeRequest.mutability) &&
        Objects.equals(this.multiValued, addCertificateDelegatedAdminAttributeRequest.multiValued) &&
        Objects.equals(this.attributeCategory, addCertificateDelegatedAdminAttributeRequest.attributeCategory) &&
        Objects.equals(this.displayOrderIndex, addCertificateDelegatedAdminAttributeRequest.displayOrderIndex) &&
        Objects.equals(this.referenceResourceType, addCertificateDelegatedAdminAttributeRequest.referenceResourceType) &&
        Objects.equals(this.attributePresentation, addCertificateDelegatedAdminAttributeRequest.attributePresentation) &&
        Objects.equals(this.dateTimeFormat, addCertificateDelegatedAdminAttributeRequest.dateTimeFormat)&&
        Objects.equals(this.additionalProperties, addCertificateDelegatedAdminAttributeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCertificateDelegatedAdminAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCertificateDelegatedAdminAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCertificateDelegatedAdminAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCertificateDelegatedAdminAttributeRequest is not found in the empty JSON string", AddCertificateDelegatedAdminAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCertificateDelegatedAdminAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCertificateDelegatedAdminAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCertificateDelegatedAdminAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCertificateDelegatedAdminAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCertificateDelegatedAdminAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCertificateDelegatedAdminAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddCertificateDelegatedAdminAttributeRequest value) throws IOException {
           ...
           @Override
           public AddCertificateDelegatedAdminAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddCertificateDelegatedAdminAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddCertificateDelegatedAdminAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddCertificateDelegatedAdminAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddCertificateDelegatedAdminAttributeRequest
  */
  public static AddCertificateDelegatedAdminAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCertificateDelegatedAdminAttributeRequest.class);
  }

 /**
  * Convert an instance of AddCertificateDelegatedAdminAttributeRequest to an JSON string
  *
  * @return JSON string
  */
