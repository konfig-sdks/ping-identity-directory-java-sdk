...
public class EqualityJoinVirtualAttributeShared {
  ...
  public EqualityJoinVirtualAttributeShared() {
  }

  public EqualityJoinVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared schemas(List<EnumequalityJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public EqualityJoinVirtualAttributeShared addSchemasItem(EnumequalityJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinSourceAttribute(String joinSourceAttribute) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinTargetAttribute(String joinTargetAttribute) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinMatchAll(Boolean joinMatchAll) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinFilter(String joinFilter) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared joinAttribute(List<String> joinAttribute) {
  ...
  public EqualityJoinVirtualAttributeShared addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public EqualityJoinVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public EqualityJoinVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared filter(List<String> filter) {
  ...
  public EqualityJoinVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EqualityJoinVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public EqualityJoinVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the EqualityJoinVirtualAttributeShared instance itself
   */
  public EqualityJoinVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EqualityJoinVirtualAttributeShared equalityJoinVirtualAttributeShared = (EqualityJoinVirtualAttributeShared) o;
    return Objects.equals(this.description, equalityJoinVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, equalityJoinVirtualAttributeShared.schemas) &&
        Objects.equals(this.joinSourceAttribute, equalityJoinVirtualAttributeShared.joinSourceAttribute) &&
        Objects.equals(this.joinTargetAttribute, equalityJoinVirtualAttributeShared.joinTargetAttribute) &&
        Objects.equals(this.joinMatchAll, equalityJoinVirtualAttributeShared.joinMatchAll) &&
        Objects.equals(this.joinBaseDNType, equalityJoinVirtualAttributeShared.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, equalityJoinVirtualAttributeShared.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, equalityJoinVirtualAttributeShared.joinScope) &&
        Objects.equals(this.joinSizeLimit, equalityJoinVirtualAttributeShared.joinSizeLimit) &&
        Objects.equals(this.joinFilter, equalityJoinVirtualAttributeShared.joinFilter) &&
        Objects.equals(this.joinAttribute, equalityJoinVirtualAttributeShared.joinAttribute) &&
        Objects.equals(this.enabled, equalityJoinVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, equalityJoinVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, equalityJoinVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, equalityJoinVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, equalityJoinVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, equalityJoinVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, equalityJoinVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, equalityJoinVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, equalityJoinVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, equalityJoinVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, equalityJoinVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, equalityJoinVirtualAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, joinSourceAttribute, joinTargetAttribute, joinMatchAll, joinBaseDNType, joinCustomBaseDN, joinScope, joinSizeLimit, joinFilter, joinAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EqualityJoinVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EqualityJoinVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EqualityJoinVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EqualityJoinVirtualAttributeShared is not found in the empty JSON string", EqualityJoinVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EqualityJoinVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EqualityJoinVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EqualityJoinVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EqualityJoinVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EqualityJoinVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<EqualityJoinVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, EqualityJoinVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public EqualityJoinVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EqualityJoinVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EqualityJoinVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EqualityJoinVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to EqualityJoinVirtualAttributeShared
  */
  public static EqualityJoinVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EqualityJoinVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of EqualityJoinVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
