...
public class AmazonSecretsManagerCipherStreamProviderShared {
  ...
  public AmazonSecretsManagerCipherStreamProviderShared() {
  }

  public AmazonSecretsManagerCipherStreamProviderShared description(String description) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared schemas(List<EnumamazonSecretsManagerCipherStreamProviderSchemaUrn> schemas) {
  ...
  public AmazonSecretsManagerCipherStreamProviderShared addSchemasItem(EnumamazonSecretsManagerCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared secretID(String secretID) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared secretFieldName(String secretFieldName) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared secretVersionID(String secretVersionID) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared secretVersionStage(String secretVersionStage) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared encryptionMetadataFile(String encryptionMetadataFile) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public AmazonSecretsManagerCipherStreamProviderShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AmazonSecretsManagerCipherStreamProviderShared instance itself
   */
  public AmazonSecretsManagerCipherStreamProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonSecretsManagerCipherStreamProviderShared amazonSecretsManagerCipherStreamProviderShared = (AmazonSecretsManagerCipherStreamProviderShared) o;
    return Objects.equals(this.description, amazonSecretsManagerCipherStreamProviderShared.description) &&
        Objects.equals(this.schemas, amazonSecretsManagerCipherStreamProviderShared.schemas) &&
        Objects.equals(this.awsExternalServer, amazonSecretsManagerCipherStreamProviderShared.awsExternalServer) &&
        Objects.equals(this.secretID, amazonSecretsManagerCipherStreamProviderShared.secretID) &&
        Objects.equals(this.secretFieldName, amazonSecretsManagerCipherStreamProviderShared.secretFieldName) &&
        Objects.equals(this.secretVersionID, amazonSecretsManagerCipherStreamProviderShared.secretVersionID) &&
        Objects.equals(this.secretVersionStage, amazonSecretsManagerCipherStreamProviderShared.secretVersionStage) &&
        Objects.equals(this.encryptionMetadataFile, amazonSecretsManagerCipherStreamProviderShared.encryptionMetadataFile) &&
        Objects.equals(this.iterationCount, amazonSecretsManagerCipherStreamProviderShared.iterationCount) &&
        Objects.equals(this.enabled, amazonSecretsManagerCipherStreamProviderShared.enabled)&&
        Objects.equals(this.additionalProperties, amazonSecretsManagerCipherStreamProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, awsExternalServer, secretID, secretFieldName, secretVersionID, secretVersionStage, encryptionMetadataFile, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AmazonSecretsManagerCipherStreamProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AmazonSecretsManagerCipherStreamProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AmazonSecretsManagerCipherStreamProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonSecretsManagerCipherStreamProviderShared is not found in the empty JSON string", AmazonSecretsManagerCipherStreamProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonSecretsManagerCipherStreamProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonSecretsManagerCipherStreamProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonSecretsManagerCipherStreamProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonSecretsManagerCipherStreamProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonSecretsManagerCipherStreamProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonSecretsManagerCipherStreamProviderShared>() {
           @Override
           public void write(JsonWriter out, AmazonSecretsManagerCipherStreamProviderShared value) throws IOException {
           ...
           @Override
           public AmazonSecretsManagerCipherStreamProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AmazonSecretsManagerCipherStreamProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AmazonSecretsManagerCipherStreamProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AmazonSecretsManagerCipherStreamProviderShared
  * @throws IOException if the JSON string is invalid with respect to AmazonSecretsManagerCipherStreamProviderShared
  */
  public static AmazonSecretsManagerCipherStreamProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonSecretsManagerCipherStreamProviderShared.class);
  }

 /**
  * Convert an instance of AmazonSecretsManagerCipherStreamProviderShared to an JSON string
  *
  * @return JSON string
  */
