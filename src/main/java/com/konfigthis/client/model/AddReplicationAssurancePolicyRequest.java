...
public class AddReplicationAssurancePolicyRequest {
  ...
  public AddReplicationAssurancePolicyRequest() {
  }

  public AddReplicationAssurancePolicyRequest policyName(String policyName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Replication Assurance Policy")
  ...
  public AddReplicationAssurancePolicyRequest description(String description) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest schemas(List<EnumreplicationAssurancePolicySchemaUrn> schemas) {
  ...
  public AddReplicationAssurancePolicyRequest addSchemasItem(EnumreplicationAssurancePolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest localLevel(EnumreplicationAssurancePolicyLocalLevelProp localLevel) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest remoteLevel(EnumreplicationAssurancePolicyRemoteLevelProp remoteLevel) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest timeout(String timeout) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddReplicationAssurancePolicyRequest requestCriteria(String requestCriteria) {
  ...
  **/
   ...
   * @return the AddReplicationAssurancePolicyRequest instance itself
   */
  public AddReplicationAssurancePolicyRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddReplicationAssurancePolicyRequest addReplicationAssurancePolicyRequest = (AddReplicationAssurancePolicyRequest) o;
    return Objects.equals(this.policyName, addReplicationAssurancePolicyRequest.policyName) &&
        Objects.equals(this.description, addReplicationAssurancePolicyRequest.description) &&
        Objects.equals(this.schemas, addReplicationAssurancePolicyRequest.schemas) &&
        Objects.equals(this.enabled, addReplicationAssurancePolicyRequest.enabled) &&
        Objects.equals(this.evaluationOrderIndex, addReplicationAssurancePolicyRequest.evaluationOrderIndex) &&
        Objects.equals(this.localLevel, addReplicationAssurancePolicyRequest.localLevel) &&
        Objects.equals(this.remoteLevel, addReplicationAssurancePolicyRequest.remoteLevel) &&
        Objects.equals(this.timeout, addReplicationAssurancePolicyRequest.timeout) &&
        Objects.equals(this.connectionCriteria, addReplicationAssurancePolicyRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addReplicationAssurancePolicyRequest.requestCriteria)&&
        Objects.equals(this.additionalProperties, addReplicationAssurancePolicyRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(policyName, description, schemas, enabled, evaluationOrderIndex, localLevel, remoteLevel, timeout, connectionCriteria, requestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddReplicationAssurancePolicyRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddReplicationAssurancePolicyRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddReplicationAssurancePolicyRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddReplicationAssurancePolicyRequest is not found in the empty JSON string", AddReplicationAssurancePolicyRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddReplicationAssurancePolicyRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddReplicationAssurancePolicyRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddReplicationAssurancePolicyRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddReplicationAssurancePolicyRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddReplicationAssurancePolicyRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddReplicationAssurancePolicyRequest>() {
           @Override
           public void write(JsonWriter out, AddReplicationAssurancePolicyRequest value) throws IOException {
           ...
           @Override
           public AddReplicationAssurancePolicyRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddReplicationAssurancePolicyRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddReplicationAssurancePolicyRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddReplicationAssurancePolicyRequest
  * @throws IOException if the JSON string is invalid with respect to AddReplicationAssurancePolicyRequest
  */
  public static AddReplicationAssurancePolicyRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddReplicationAssurancePolicyRequest.class);
  }

 /**
  * Convert an instance of AddReplicationAssurancePolicyRequest to an JSON string
  *
  * @return JSON string
  */
