...
public class SyslogBasedAccessLogPublisherResponse {
  ...
  private List<EnumsyslogBasedAccessLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyslogBasedAccessLogPublisherResponse() {
  }

  public SyslogBasedAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse schemas(List<EnumsyslogBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogBasedAccessLogPublisherResponse addSchemasItem(EnumsyslogBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyslogBasedAccessLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyslogBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogBasedAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Syslog Based Access Log Publisher is enabled for use.")
  ...
  public SyslogBasedAccessLogPublisherResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse syslogFacility(Integer syslogFacility) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the syslog facility to use for this Syslog Based Access Log Publisher")
  ...
  public SyslogBasedAccessLogPublisherResponse maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logAssuranceCompleted(Boolean logAssuranceCompleted) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequestDetailsInSearchEntryMessages(Boolean includeRequestDetailsInSearchEntryMessages) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequestDetailsInSearchReferenceMessages(Boolean includeRequestDetailsInSearchReferenceMessages) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequestDetailsInIntermediateResponseMessages(Boolean includeRequestDetailsInIntermediateResponseMessages) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeResultCodeNames(Boolean includeResultCodeNames) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeExtendedSearchRequestDetails(Boolean includeExtendedSearchRequestDetails) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeAddAttributeNames(Boolean includeAddAttributeNames) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeModifyAttributeNames(Boolean includeModifyAttributeNames) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeSearchEntryAttributeNames(Boolean includeSearchEntryAttributeNames) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logFieldBehavior(String logFieldBehavior) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogBasedAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogBasedAccessLogPublisherResponse instance itself
   */
  public SyslogBasedAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogBasedAccessLogPublisherResponse syslogBasedAccessLogPublisherResponse = (SyslogBasedAccessLogPublisherResponse) o;
    return Objects.equals(this.id, syslogBasedAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, syslogBasedAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogBasedAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.enabled, syslogBasedAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.serverHostName, syslogBasedAccessLogPublisherResponse.serverHostName) &&
        Objects.equals(this.serverPort, syslogBasedAccessLogPublisherResponse.serverPort) &&
        Objects.equals(this.syslogFacility, syslogBasedAccessLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.maxStringLength, syslogBasedAccessLogPublisherResponse.maxStringLength) &&
        Objects.equals(this.logConnects, syslogBasedAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, syslogBasedAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logRequests, syslogBasedAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logAssuranceCompleted, syslogBasedAccessLogPublisherResponse.logAssuranceCompleted) &&
        Objects.equals(this.includeProductName, syslogBasedAccessLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogBasedAccessLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogBasedAccessLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogBasedAccessLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, syslogBasedAccessLogPublisherResponse.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, syslogBasedAccessLogPublisherResponse.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, syslogBasedAccessLogPublisherResponse.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchEntryMessages, syslogBasedAccessLogPublisherResponse.includeRequestDetailsInSearchEntryMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchReferenceMessages, syslogBasedAccessLogPublisherResponse.includeRequestDetailsInSearchReferenceMessages) &&
        Objects.equals(this.includeRequestDetailsInIntermediateResponseMessages, syslogBasedAccessLogPublisherResponse.includeRequestDetailsInIntermediateResponseMessages) &&
        Objects.equals(this.includeResultCodeNames, syslogBasedAccessLogPublisherResponse.includeResultCodeNames) &&
        Objects.equals(this.includeExtendedSearchRequestDetails, syslogBasedAccessLogPublisherResponse.includeExtendedSearchRequestDetails) &&
        Objects.equals(this.includeAddAttributeNames, syslogBasedAccessLogPublisherResponse.includeAddAttributeNames) &&
        Objects.equals(this.includeModifyAttributeNames, syslogBasedAccessLogPublisherResponse.includeModifyAttributeNames) &&
        Objects.equals(this.includeSearchEntryAttributeNames, syslogBasedAccessLogPublisherResponse.includeSearchEntryAttributeNames) &&
        Objects.equals(this.includeRequestControls, syslogBasedAccessLogPublisherResponse.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, syslogBasedAccessLogPublisherResponse.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, syslogBasedAccessLogPublisherResponse.includeReplicationChangeID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, syslogBasedAccessLogPublisherResponse.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.asynchronous, syslogBasedAccessLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, syslogBasedAccessLogPublisherResponse.autoFlush) &&
        Objects.equals(this.queueSize, syslogBasedAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.logFieldBehavior, syslogBasedAccessLogPublisherResponse.logFieldBehavior) &&
        Objects.equals(this.logSecurityNegotiation, syslogBasedAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, syslogBasedAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logResults, syslogBasedAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logSearchEntries, syslogBasedAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, syslogBasedAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, syslogBasedAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, syslogBasedAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, syslogBasedAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, syslogBasedAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, syslogBasedAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, syslogBasedAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, syslogBasedAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, syslogBasedAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, syslogBasedAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.loggingErrorBehavior, syslogBasedAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogBasedAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogBasedAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogBasedAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, serverHostName, serverPort, syslogFacility, maxStringLength, logConnects, logDisconnects, logRequests, logAssuranceCompleted, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterDN, includeRequesterIPAddress, includeRequestDetailsInResultMessages, includeRequestDetailsInSearchEntryMessages, includeRequestDetailsInSearchReferenceMessages, includeRequestDetailsInIntermediateResponseMessages, includeResultCodeNames, includeExtendedSearchRequestDetails, includeAddAttributeNames, includeModifyAttributeNames, includeSearchEntryAttributeNames, includeRequestControls, includeResponseControls, includeReplicationChangeID, generifyMessageStringsWhenPossible, asynchronous, autoFlush, queueSize, logFieldBehavior, logSecurityNegotiation, logClientCertificates, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogBasedAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogBasedAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogBasedAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogBasedAccessLogPublisherResponse is not found in the empty JSON string", SyslogBasedAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogBasedAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogBasedAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogBasedAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogBasedAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogBasedAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogBasedAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogBasedAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogBasedAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogBasedAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogBasedAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogBasedAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogBasedAccessLogPublisherResponse
  */
  public static SyslogBasedAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogBasedAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogBasedAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
