...
public class SyslogExternalServerShared {
  ...
  public SyslogExternalServerShared() {
  }

  public SyslogExternalServerShared description(String description) {
  ...
  **/
  ...
  public SyslogExternalServerShared schemas(List<EnumsyslogExternalServerSchemaUrn> schemas) {
  ...
  public SyslogExternalServerShared addSchemasItem(EnumsyslogExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SyslogExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SyslogExternalServerShared transportMechanism(EnumexternalServerTransportMechanismProp transportMechanism) {
  ...
  **/
  ...
  public SyslogExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public SyslogExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public SyslogExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
   ...
   * @return the SyslogExternalServerShared instance itself
   */
  public SyslogExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogExternalServerShared syslogExternalServerShared = (SyslogExternalServerShared) o;
    return Objects.equals(this.description, syslogExternalServerShared.description) &&
        Objects.equals(this.schemas, syslogExternalServerShared.schemas) &&
        Objects.equals(this.serverHostName, syslogExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, syslogExternalServerShared.serverPort) &&
        Objects.equals(this.transportMechanism, syslogExternalServerShared.transportMechanism) &&
        Objects.equals(this.connectTimeout, syslogExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxConnectionAge, syslogExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.trustManagerProvider, syslogExternalServerShared.trustManagerProvider)&&
        Objects.equals(this.additionalProperties, syslogExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, serverHostName, serverPort, transportMechanism, connectTimeout, maxConnectionAge, trustManagerProvider, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogExternalServerShared is not found in the empty JSON string", SyslogExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogExternalServerShared>() {
           @Override
           public void write(JsonWriter out, SyslogExternalServerShared value) throws IOException {
           ...
           @Override
           public SyslogExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to SyslogExternalServerShared
  */
  public static SyslogExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogExternalServerShared.class);
  }

 /**
  * Convert an instance of SyslogExternalServerShared to an JSON string
  *
  * @return JSON string
  */
