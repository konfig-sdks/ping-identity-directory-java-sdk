...
public class NumericGaugeDataSourceResponse {
  ...
  public NumericGaugeDataSourceResponse() {
  }

  public NumericGaugeDataSourceResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Gauge Data Source")
  ...
  public NumericGaugeDataSourceResponse description(String description) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse schemas(List<EnumnumericGaugeDataSourceSchemaUrn> schemas) {
  ...
  public NumericGaugeDataSourceResponse addSchemasItem(EnumnumericGaugeDataSourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse dataOrientation(EnumgaugeDataSourceDataOrientationProp dataOrientation) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse statisticType(EnumgaugeDataSourceStatisticTypeProp statisticType) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse divideValueBy(Double divideValueBy) {
  ...
  public NumericGaugeDataSourceResponse divideValueBy(Integer divideValueBy) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse divideValueByAttribute(String divideValueByAttribute) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse divideValueByCounterAttribute(String divideValueByCounterAttribute) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse additionalText(String additionalText) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse monitorAttribute(String monitorAttribute) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse includeFilter(String includeFilter) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse resourceAttribute(String resourceAttribute) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse resourceType(String resourceType) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse minimumUpdateInterval(String minimumUpdateInterval) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public NumericGaugeDataSourceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the NumericGaugeDataSourceResponse instance itself
   */
  public NumericGaugeDataSourceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NumericGaugeDataSourceResponse numericGaugeDataSourceResponse = (NumericGaugeDataSourceResponse) o;
    return Objects.equals(this.id, numericGaugeDataSourceResponse.id) &&
        Objects.equals(this.description, numericGaugeDataSourceResponse.description) &&
        Objects.equals(this.schemas, numericGaugeDataSourceResponse.schemas) &&
        Objects.equals(this.dataOrientation, numericGaugeDataSourceResponse.dataOrientation) &&
        Objects.equals(this.statisticType, numericGaugeDataSourceResponse.statisticType) &&
        Objects.equals(this.divideValueBy, numericGaugeDataSourceResponse.divideValueBy) &&
        Objects.equals(this.divideValueByAttribute, numericGaugeDataSourceResponse.divideValueByAttribute) &&
        Objects.equals(this.divideValueByCounterAttribute, numericGaugeDataSourceResponse.divideValueByCounterAttribute) &&
        Objects.equals(this.additionalText, numericGaugeDataSourceResponse.additionalText) &&
        Objects.equals(this.monitorObjectclass, numericGaugeDataSourceResponse.monitorObjectclass) &&
        Objects.equals(this.monitorAttribute, numericGaugeDataSourceResponse.monitorAttribute) &&
        Objects.equals(this.includeFilter, numericGaugeDataSourceResponse.includeFilter) &&
        Objects.equals(this.resourceAttribute, numericGaugeDataSourceResponse.resourceAttribute) &&
        Objects.equals(this.resourceType, numericGaugeDataSourceResponse.resourceType) &&
        Objects.equals(this.minimumUpdateInterval, numericGaugeDataSourceResponse.minimumUpdateInterval) &&
        Objects.equals(this.meta, numericGaugeDataSourceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, numericGaugeDataSourceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, numericGaugeDataSourceResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, dataOrientation, statisticType, divideValueBy, divideValueByAttribute, divideValueByCounterAttribute, additionalText, monitorObjectclass, monitorAttribute, includeFilter, resourceAttribute, resourceType, minimumUpdateInterval, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NumericGaugeDataSourceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NumericGaugeDataSourceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NumericGaugeDataSourceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NumericGaugeDataSourceResponse is not found in the empty JSON string", NumericGaugeDataSourceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NumericGaugeDataSourceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NumericGaugeDataSourceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NumericGaugeDataSourceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NumericGaugeDataSourceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NumericGaugeDataSourceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NumericGaugeDataSourceResponse>() {
           @Override
           public void write(JsonWriter out, NumericGaugeDataSourceResponse value) throws IOException {
           ...
           @Override
           public NumericGaugeDataSourceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NumericGaugeDataSourceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NumericGaugeDataSourceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NumericGaugeDataSourceResponse
  * @throws IOException if the JSON string is invalid with respect to NumericGaugeDataSourceResponse
  */
  public static NumericGaugeDataSourceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NumericGaugeDataSourceResponse.class);
  }

 /**
  * Convert an instance of NumericGaugeDataSourceResponse to an JSON string
  *
  * @return JSON string
  */
