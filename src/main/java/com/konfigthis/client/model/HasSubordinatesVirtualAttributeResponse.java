...
public class HasSubordinatesVirtualAttributeResponse {
  ...
  private List<EnumhasSubordinatesVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public HasSubordinatesVirtualAttributeResponse() {
  }

  public HasSubordinatesVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse schemas(List<EnumhasSubordinatesVirtualAttributeSchemaUrn> schemas) {
  ...
  public HasSubordinatesVirtualAttributeResponse addSchemasItem(EnumhasSubordinatesVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public HasSubordinatesVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public HasSubordinatesVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse filter(List<String> filter) {
  ...
  public HasSubordinatesVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public HasSubordinatesVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public HasSubordinatesVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the HasSubordinatesVirtualAttributeResponse instance itself
   */
  public HasSubordinatesVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HasSubordinatesVirtualAttributeResponse hasSubordinatesVirtualAttributeResponse = (HasSubordinatesVirtualAttributeResponse) o;
    return Objects.equals(this.description, hasSubordinatesVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, hasSubordinatesVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, hasSubordinatesVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, hasSubordinatesVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, hasSubordinatesVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, hasSubordinatesVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, hasSubordinatesVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, hasSubordinatesVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, hasSubordinatesVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, hasSubordinatesVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, hasSubordinatesVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, hasSubordinatesVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, hasSubordinatesVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, hasSubordinatesVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, hasSubordinatesVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, hasSubordinatesVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, hasSubordinatesVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class HasSubordinatesVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HasSubordinatesVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HasSubordinatesVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HasSubordinatesVirtualAttributeResponse is not found in the empty JSON string", HasSubordinatesVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HasSubordinatesVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HasSubordinatesVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HasSubordinatesVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HasSubordinatesVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HasSubordinatesVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<HasSubordinatesVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, HasSubordinatesVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public HasSubordinatesVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HasSubordinatesVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HasSubordinatesVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HasSubordinatesVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to HasSubordinatesVirtualAttributeResponse
  */
  public static HasSubordinatesVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HasSubordinatesVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of HasSubordinatesVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
