...
public class EnterLockdownModeRecurringTaskShared {
  ...
  public EnterLockdownModeRecurringTaskShared() {
  }

  public EnterLockdownModeRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared schemas(List<EnumenterLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public EnterLockdownModeRecurringTaskShared addSchemasItem(EnumenterLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared reason(String reason) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public EnterLockdownModeRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public EnterLockdownModeRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public EnterLockdownModeRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the EnterLockdownModeRecurringTaskShared instance itself
   */
  public EnterLockdownModeRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EnterLockdownModeRecurringTaskShared enterLockdownModeRecurringTaskShared = (EnterLockdownModeRecurringTaskShared) o;
    return Objects.equals(this.description, enterLockdownModeRecurringTaskShared.description) &&
        Objects.equals(this.schemas, enterLockdownModeRecurringTaskShared.schemas) &&
        Objects.equals(this.reason, enterLockdownModeRecurringTaskShared.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, enterLockdownModeRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, enterLockdownModeRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, enterLockdownModeRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, enterLockdownModeRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, enterLockdownModeRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, enterLockdownModeRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, enterLockdownModeRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, enterLockdownModeRecurringTaskShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterLockdownModeRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EnterLockdownModeRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EnterLockdownModeRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnterLockdownModeRecurringTaskShared is not found in the empty JSON string", EnterLockdownModeRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnterLockdownModeRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnterLockdownModeRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnterLockdownModeRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnterLockdownModeRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnterLockdownModeRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<EnterLockdownModeRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, EnterLockdownModeRecurringTaskShared value) throws IOException {
           ...
           @Override
           public EnterLockdownModeRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EnterLockdownModeRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EnterLockdownModeRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EnterLockdownModeRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to EnterLockdownModeRecurringTaskShared
  */
  public static EnterLockdownModeRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnterLockdownModeRecurringTaskShared.class);
  }

 /**
  * Convert an instance of EnterLockdownModeRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
