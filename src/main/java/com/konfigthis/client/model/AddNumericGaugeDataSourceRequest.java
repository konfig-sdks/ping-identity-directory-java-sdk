...
public class AddNumericGaugeDataSourceRequest {
  ...
  public AddNumericGaugeDataSourceRequest() {
  }

  public AddNumericGaugeDataSourceRequest sourceName(String sourceName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Gauge Data Source")
  ...
  public AddNumericGaugeDataSourceRequest description(String description) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest schemas(List<EnumnumericGaugeDataSourceSchemaUrn> schemas) {
  ...
  public AddNumericGaugeDataSourceRequest addSchemasItem(EnumnumericGaugeDataSourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest dataOrientation(EnumgaugeDataSourceDataOrientationProp dataOrientation) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest statisticType(EnumgaugeDataSourceStatisticTypeProp statisticType) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest divideValueBy(Double divideValueBy) {
  ...
  public AddNumericGaugeDataSourceRequest divideValueBy(Integer divideValueBy) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest divideValueByAttribute(String divideValueByAttribute) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest divideValueByCounterAttribute(String divideValueByCounterAttribute) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest additionalText(String additionalText) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest monitorAttribute(String monitorAttribute) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest includeFilter(String includeFilter) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest resourceAttribute(String resourceAttribute) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest resourceType(String resourceType) {
  ...
  **/
  ...
  public AddNumericGaugeDataSourceRequest minimumUpdateInterval(String minimumUpdateInterval) {
  ...
  **/
   ...
   * @return the AddNumericGaugeDataSourceRequest instance itself
   */
  public AddNumericGaugeDataSourceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddNumericGaugeDataSourceRequest addNumericGaugeDataSourceRequest = (AddNumericGaugeDataSourceRequest) o;
    return Objects.equals(this.sourceName, addNumericGaugeDataSourceRequest.sourceName) &&
        Objects.equals(this.description, addNumericGaugeDataSourceRequest.description) &&
        Objects.equals(this.schemas, addNumericGaugeDataSourceRequest.schemas) &&
        Objects.equals(this.dataOrientation, addNumericGaugeDataSourceRequest.dataOrientation) &&
        Objects.equals(this.statisticType, addNumericGaugeDataSourceRequest.statisticType) &&
        Objects.equals(this.divideValueBy, addNumericGaugeDataSourceRequest.divideValueBy) &&
        Objects.equals(this.divideValueByAttribute, addNumericGaugeDataSourceRequest.divideValueByAttribute) &&
        Objects.equals(this.divideValueByCounterAttribute, addNumericGaugeDataSourceRequest.divideValueByCounterAttribute) &&
        Objects.equals(this.additionalText, addNumericGaugeDataSourceRequest.additionalText) &&
        Objects.equals(this.monitorObjectclass, addNumericGaugeDataSourceRequest.monitorObjectclass) &&
        Objects.equals(this.monitorAttribute, addNumericGaugeDataSourceRequest.monitorAttribute) &&
        Objects.equals(this.includeFilter, addNumericGaugeDataSourceRequest.includeFilter) &&
        Objects.equals(this.resourceAttribute, addNumericGaugeDataSourceRequest.resourceAttribute) &&
        Objects.equals(this.resourceType, addNumericGaugeDataSourceRequest.resourceType) &&
        Objects.equals(this.minimumUpdateInterval, addNumericGaugeDataSourceRequest.minimumUpdateInterval)&&
        Objects.equals(this.additionalProperties, addNumericGaugeDataSourceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceName, description, schemas, dataOrientation, statisticType, divideValueBy, divideValueByAttribute, divideValueByCounterAttribute, additionalText, monitorObjectclass, monitorAttribute, includeFilter, resourceAttribute, resourceType, minimumUpdateInterval, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddNumericGaugeDataSourceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddNumericGaugeDataSourceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddNumericGaugeDataSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddNumericGaugeDataSourceRequest is not found in the empty JSON string", AddNumericGaugeDataSourceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddNumericGaugeDataSourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddNumericGaugeDataSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddNumericGaugeDataSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddNumericGaugeDataSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddNumericGaugeDataSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddNumericGaugeDataSourceRequest>() {
           @Override
           public void write(JsonWriter out, AddNumericGaugeDataSourceRequest value) throws IOException {
           ...
           @Override
           public AddNumericGaugeDataSourceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddNumericGaugeDataSourceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddNumericGaugeDataSourceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddNumericGaugeDataSourceRequest
  * @throws IOException if the JSON string is invalid with respect to AddNumericGaugeDataSourceRequest
  */
  public static AddNumericGaugeDataSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddNumericGaugeDataSourceRequest.class);
  }

 /**
  * Convert an instance of AddNumericGaugeDataSourceRequest to an JSON string
  *
  * @return JSON string
  */
