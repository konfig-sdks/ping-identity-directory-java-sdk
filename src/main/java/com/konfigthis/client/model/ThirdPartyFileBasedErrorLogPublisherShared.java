...
public class ThirdPartyFileBasedErrorLogPublisherShared {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared() {
  }

  public ThirdPartyFileBasedErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared schemas(List<EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addSchemasItem(EnumthirdPartyFileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyFileBasedErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the ThirdPartyFileBasedErrorLogPublisherShared instance itself
   */
  public ThirdPartyFileBasedErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyFileBasedErrorLogPublisherShared thirdPartyFileBasedErrorLogPublisherShared = (ThirdPartyFileBasedErrorLogPublisherShared) o;
    return Objects.equals(this.description, thirdPartyFileBasedErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, thirdPartyFileBasedErrorLogPublisherShared.schemas) &&
        Objects.equals(this.logFile, thirdPartyFileBasedErrorLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, thirdPartyFileBasedErrorLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, thirdPartyFileBasedErrorLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, thirdPartyFileBasedErrorLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, thirdPartyFileBasedErrorLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, thirdPartyFileBasedErrorLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, thirdPartyFileBasedErrorLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, thirdPartyFileBasedErrorLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, thirdPartyFileBasedErrorLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, thirdPartyFileBasedErrorLogPublisherShared.append) &&
        Objects.equals(this.extensionClass, thirdPartyFileBasedErrorLogPublisherShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyFileBasedErrorLogPublisherShared.extensionArgument) &&
        Objects.equals(this.asynchronous, thirdPartyFileBasedErrorLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, thirdPartyFileBasedErrorLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, thirdPartyFileBasedErrorLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, thirdPartyFileBasedErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, thirdPartyFileBasedErrorLogPublisherShared.timeInterval) &&
        Objects.equals(this.defaultSeverity, thirdPartyFileBasedErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, thirdPartyFileBasedErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, thirdPartyFileBasedErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, thirdPartyFileBasedErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, thirdPartyFileBasedErrorLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ThirdPartyFileBasedErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyFileBasedErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyFileBasedErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyFileBasedErrorLogPublisherShared is not found in the empty JSON string", ThirdPartyFileBasedErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyFileBasedErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyFileBasedErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyFileBasedErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyFileBasedErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyFileBasedErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyFileBasedErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyFileBasedErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public ThirdPartyFileBasedErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyFileBasedErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyFileBasedErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyFileBasedErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyFileBasedErrorLogPublisherShared
  */
  public static ThirdPartyFileBasedErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyFileBasedErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of ThirdPartyFileBasedErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
