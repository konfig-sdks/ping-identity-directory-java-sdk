...
public class LdifExportRecurringTaskResponse {
  ...
  public LdifExportRecurringTaskResponse() {
  }

  public LdifExportRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse schemas(List<EnumldifExportRecurringTaskSchemaUrn> schemas) {
  ...
  public LdifExportRecurringTaskResponse addSchemasItem(EnumldifExportRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse ldifDirectory(String ldifDirectory) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The directory in which LDIF export files will be placed. The directory must already exist.")
  ...
  public LdifExportRecurringTaskResponse backendID(List<String> backendID) {
  ...
  public LdifExportRecurringTaskResponse addBackendIDItem(String backendIDItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse excludeBackendID(List<String> excludeBackendID) {
  ...
  public LdifExportRecurringTaskResponse addExcludeBackendIDItem(String excludeBackendIDItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse compress(Boolean compress) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse encrypt(Boolean encrypt) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse sign(Boolean sign) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse retainPreviousLDIFExportCount(Integer retainPreviousLDIFExportCount) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse retainPreviousLDIFExportAge(String retainPreviousLDIFExportAge) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse maxMegabytesPerSecond(Integer maxMegabytesPerSecond) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse postLDIFExportTaskProcessor(List<String> postLDIFExportTaskProcessor) {
  ...
  public LdifExportRecurringTaskResponse addPostLDIFExportTaskProcessorItem(String postLDIFExportTaskProcessorItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public LdifExportRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public LdifExportRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public LdifExportRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdifExportRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdifExportRecurringTaskResponse instance itself
   */
  public LdifExportRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdifExportRecurringTaskResponse ldifExportRecurringTaskResponse = (LdifExportRecurringTaskResponse) o;
    return Objects.equals(this.id, ldifExportRecurringTaskResponse.id) &&
        Objects.equals(this.description, ldifExportRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, ldifExportRecurringTaskResponse.schemas) &&
        Objects.equals(this.ldifDirectory, ldifExportRecurringTaskResponse.ldifDirectory) &&
        Objects.equals(this.backendID, ldifExportRecurringTaskResponse.backendID) &&
        Objects.equals(this.excludeBackendID, ldifExportRecurringTaskResponse.excludeBackendID) &&
        Objects.equals(this.compress, ldifExportRecurringTaskResponse.compress) &&
        Objects.equals(this.encrypt, ldifExportRecurringTaskResponse.encrypt) &&
        Objects.equals(this.encryptionSettingsDefinitionID, ldifExportRecurringTaskResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.sign, ldifExportRecurringTaskResponse.sign) &&
        Objects.equals(this.retainPreviousLDIFExportCount, ldifExportRecurringTaskResponse.retainPreviousLDIFExportCount) &&
        Objects.equals(this.retainPreviousLDIFExportAge, ldifExportRecurringTaskResponse.retainPreviousLDIFExportAge) &&
        Objects.equals(this.maxMegabytesPerSecond, ldifExportRecurringTaskResponse.maxMegabytesPerSecond) &&
        Objects.equals(this.postLDIFExportTaskProcessor, ldifExportRecurringTaskResponse.postLDIFExportTaskProcessor) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, ldifExportRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, ldifExportRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, ldifExportRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, ldifExportRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, ldifExportRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, ldifExportRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, ldifExportRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, ldifExportRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldifExportRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldifExportRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, ldifDirectory, backendID, excludeBackendID, compress, encrypt, encryptionSettingsDefinitionID, sign, retainPreviousLDIFExportCount, retainPreviousLDIFExportAge, maxMegabytesPerSecond, postLDIFExportTaskProcessor, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdifExportRecurringTaskResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("ldifDirectory");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdifExportRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdifExportRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdifExportRecurringTaskResponse is not found in the empty JSON string", LdifExportRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdifExportRecurringTaskResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("ldifDirectory").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdifExportRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdifExportRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdifExportRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdifExportRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdifExportRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, LdifExportRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public LdifExportRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdifExportRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdifExportRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdifExportRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to LdifExportRecurringTaskResponse
  */
  public static LdifExportRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdifExportRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of LdifExportRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
