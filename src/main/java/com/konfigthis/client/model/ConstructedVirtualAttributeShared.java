...
public class ConstructedVirtualAttributeShared {
  ...
  public ConstructedVirtualAttributeShared() {
  }

  public ConstructedVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared schemas(List<EnumconstructedVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConstructedVirtualAttributeShared addSchemasItem(EnumconstructedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared valuePattern(List<String> valuePattern) {
  ...
  public ConstructedVirtualAttributeShared addValuePatternItem(String valuePatternItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public ConstructedVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public ConstructedVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared filter(List<String> filter) {
  ...
  public ConstructedVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ConstructedVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ConstructedVirtualAttributeShared instance itself
   */
  public ConstructedVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConstructedVirtualAttributeShared constructedVirtualAttributeShared = (ConstructedVirtualAttributeShared) o;
    return Objects.equals(this.description, constructedVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, constructedVirtualAttributeShared.schemas) &&
        Objects.equals(this.valuePattern, constructedVirtualAttributeShared.valuePattern) &&
        Objects.equals(this.enabled, constructedVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, constructedVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, constructedVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, constructedVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, constructedVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, constructedVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, constructedVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, constructedVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, constructedVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, constructedVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, constructedVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, constructedVirtualAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, valuePattern, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConstructedVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConstructedVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConstructedVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConstructedVirtualAttributeShared is not found in the empty JSON string", ConstructedVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConstructedVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConstructedVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConstructedVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConstructedVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConstructedVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ConstructedVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, ConstructedVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public ConstructedVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConstructedVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConstructedVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConstructedVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to ConstructedVirtualAttributeShared
  */
  public static ConstructedVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConstructedVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of ConstructedVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
