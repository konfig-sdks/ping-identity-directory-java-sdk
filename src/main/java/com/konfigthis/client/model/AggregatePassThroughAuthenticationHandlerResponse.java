...
public class AggregatePassThroughAuthenticationHandlerResponse {
  ...
  public AggregatePassThroughAuthenticationHandlerResponse() {
  }

  public AggregatePassThroughAuthenticationHandlerResponse id(String id) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse description(String description) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse schemas(List<EnumaggregatePassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public AggregatePassThroughAuthenticationHandlerResponse addSchemasItem(EnumaggregatePassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse subordinatePassThroughAuthenticationHandler(List<String> subordinatePassThroughAuthenticationHandler) {
  ...
  public AggregatePassThroughAuthenticationHandlerResponse addSubordinatePassThroughAuthenticationHandlerItem(String subordinatePassThroughAuthenticationHandlerItem) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse continueOnFailureType(List<EnumpassThroughAuthenticationHandlerContinueOnFailureTypeProp> continueOnFailureType) {
  ...
  public AggregatePassThroughAuthenticationHandlerResponse addContinueOnFailureTypeItem(EnumpassThroughAuthenticationHandlerContinueOnFailureTypeProp continueOnFailureTypeItem) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public AggregatePassThroughAuthenticationHandlerResponse addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AggregatePassThroughAuthenticationHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AggregatePassThroughAuthenticationHandlerResponse instance itself
   */
  public AggregatePassThroughAuthenticationHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AggregatePassThroughAuthenticationHandlerResponse aggregatePassThroughAuthenticationHandlerResponse = (AggregatePassThroughAuthenticationHandlerResponse) o;
    return Objects.equals(this.id, aggregatePassThroughAuthenticationHandlerResponse.id) &&
        Objects.equals(this.description, aggregatePassThroughAuthenticationHandlerResponse.description) &&
        Objects.equals(this.schemas, aggregatePassThroughAuthenticationHandlerResponse.schemas) &&
        Objects.equals(this.subordinatePassThroughAuthenticationHandler, aggregatePassThroughAuthenticationHandlerResponse.subordinatePassThroughAuthenticationHandler) &&
        Objects.equals(this.continueOnFailureType, aggregatePassThroughAuthenticationHandlerResponse.continueOnFailureType) &&
        Objects.equals(this.includedLocalEntryBaseDN, aggregatePassThroughAuthenticationHandlerResponse.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, aggregatePassThroughAuthenticationHandlerResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, aggregatePassThroughAuthenticationHandlerResponse.requestCriteria) &&
        Objects.equals(this.meta, aggregatePassThroughAuthenticationHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, aggregatePassThroughAuthenticationHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, aggregatePassThroughAuthenticationHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, subordinatePassThroughAuthenticationHandler, continueOnFailureType, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregatePassThroughAuthenticationHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AggregatePassThroughAuthenticationHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AggregatePassThroughAuthenticationHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregatePassThroughAuthenticationHandlerResponse is not found in the empty JSON string", AggregatePassThroughAuthenticationHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregatePassThroughAuthenticationHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregatePassThroughAuthenticationHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregatePassThroughAuthenticationHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregatePassThroughAuthenticationHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregatePassThroughAuthenticationHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregatePassThroughAuthenticationHandlerResponse>() {
           @Override
           public void write(JsonWriter out, AggregatePassThroughAuthenticationHandlerResponse value) throws IOException {
           ...
           @Override
           public AggregatePassThroughAuthenticationHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AggregatePassThroughAuthenticationHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AggregatePassThroughAuthenticationHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AggregatePassThroughAuthenticationHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to AggregatePassThroughAuthenticationHandlerResponse
  */
  public static AggregatePassThroughAuthenticationHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregatePassThroughAuthenticationHandlerResponse.class);
  }

 /**
  * Convert an instance of AggregatePassThroughAuthenticationHandlerResponse to an JSON string
  *
  * @return JSON string
  */
