...
public class AddEntryDnVirtualAttributeRequest {
  ...
  public AddEntryDnVirtualAttributeRequest() {
  }

  public AddEntryDnVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest schemas(List<EnumentryDnVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddEntryDnVirtualAttributeRequest addSchemasItem(EnumentryDnVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddEntryDnVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddEntryDnVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddEntryDnVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddEntryDnVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddEntryDnVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddEntryDnVirtualAttributeRequest instance itself
   */
  public AddEntryDnVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddEntryDnVirtualAttributeRequest addEntryDnVirtualAttributeRequest = (AddEntryDnVirtualAttributeRequest) o;
    return Objects.equals(this.name, addEntryDnVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addEntryDnVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addEntryDnVirtualAttributeRequest.schemas) &&
        Objects.equals(this.conflictBehavior, addEntryDnVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.attributeType, addEntryDnVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.enabled, addEntryDnVirtualAttributeRequest.enabled) &&
        Objects.equals(this.baseDN, addEntryDnVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addEntryDnVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addEntryDnVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addEntryDnVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, addEntryDnVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addEntryDnVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addEntryDnVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addEntryDnVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addEntryDnVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, conflictBehavior, attributeType, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddEntryDnVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddEntryDnVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddEntryDnVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddEntryDnVirtualAttributeRequest is not found in the empty JSON string", AddEntryDnVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddEntryDnVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddEntryDnVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddEntryDnVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddEntryDnVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddEntryDnVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddEntryDnVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddEntryDnVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddEntryDnVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddEntryDnVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddEntryDnVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddEntryDnVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddEntryDnVirtualAttributeRequest
  */
  public static AddEntryDnVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddEntryDnVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddEntryDnVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
