...
public class SunDsExternalServerResponseAllOf {
  ...
  private List<EnumsunDsExternalServerSchemaUrn> schemas = null;
  ...
  public SunDsExternalServerResponseAllOf() {
  }

  public SunDsExternalServerResponseAllOf description(String description) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf schemas(List<EnumsunDsExternalServerSchemaUrn> schemas) {
  ...
  public SunDsExternalServerResponseAllOf addSchemasItem(EnumsunDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf id(String id) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf location(String location) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf bindDN(String bindDN) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf password(String password) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf connectionSecurity(EnumexternalServerSunDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf authenticationMethod(EnumexternalServerSunDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public SunDsExternalServerResponseAllOf addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public SunDsExternalServerResponseAllOf abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the SunDsExternalServerResponseAllOf instance itself
   */
  public SunDsExternalServerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SunDsExternalServerResponseAllOf sunDsExternalServerResponseAllOf = (SunDsExternalServerResponseAllOf) o;
    return Objects.equals(this.description, sunDsExternalServerResponseAllOf.description) &&
        Objects.equals(this.schemas, sunDsExternalServerResponseAllOf.schemas) &&
        Objects.equals(this.id, sunDsExternalServerResponseAllOf.id) &&
        Objects.equals(this.serverHostName, sunDsExternalServerResponseAllOf.serverHostName) &&
        Objects.equals(this.serverPort, sunDsExternalServerResponseAllOf.serverPort) &&
        Objects.equals(this.location, sunDsExternalServerResponseAllOf.location) &&
        Objects.equals(this.bindDN, sunDsExternalServerResponseAllOf.bindDN) &&
        Objects.equals(this.password, sunDsExternalServerResponseAllOf.password) &&
        Objects.equals(this.passphraseProvider, sunDsExternalServerResponseAllOf.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, sunDsExternalServerResponseAllOf.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, sunDsExternalServerResponseAllOf.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, sunDsExternalServerResponseAllOf.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, sunDsExternalServerResponseAllOf.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, sunDsExternalServerResponseAllOf.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, sunDsExternalServerResponseAllOf.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, sunDsExternalServerResponseAllOf.connectTimeout) &&
        Objects.equals(this.maxResponseSize, sunDsExternalServerResponseAllOf.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, sunDsExternalServerResponseAllOf.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, sunDsExternalServerResponseAllOf.trustManagerProvider) &&
        Objects.equals(this.initialConnections, sunDsExternalServerResponseAllOf.initialConnections) &&
        Objects.equals(this.maxConnections, sunDsExternalServerResponseAllOf.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, sunDsExternalServerResponseAllOf.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, sunDsExternalServerResponseAllOf.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, sunDsExternalServerResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SunDsExternalServerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SunDsExternalServerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SunDsExternalServerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SunDsExternalServerResponseAllOf is not found in the empty JSON string", SunDsExternalServerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SunDsExternalServerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SunDsExternalServerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SunDsExternalServerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SunDsExternalServerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SunDsExternalServerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SunDsExternalServerResponseAllOf value) throws IOException {
           ...
           @Override
           public SunDsExternalServerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SunDsExternalServerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SunDsExternalServerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SunDsExternalServerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SunDsExternalServerResponseAllOf
  */
  public static SunDsExternalServerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SunDsExternalServerResponseAllOf.class);
  }

 /**
  * Convert an instance of SunDsExternalServerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
