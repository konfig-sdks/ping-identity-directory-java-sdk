...
public class AddSyslogJsonErrorLogPublisherRequest {
  ...
  public AddSyslogJsonErrorLogPublisherRequest() {
  }

  public AddSyslogJsonErrorLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest schemas(List<EnumsyslogJsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public AddSyslogJsonErrorLogPublisherRequest addSchemasItem(EnumsyslogJsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public AddSyslogJsonErrorLogPublisherRequest addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public AddSyslogJsonErrorLogPublisherRequest addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest overrideSeverity(List<String> overrideSeverity) {
  ...
  public AddSyslogJsonErrorLogPublisherRequest addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddSyslogJsonErrorLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddSyslogJsonErrorLogPublisherRequest instance itself
   */
  public AddSyslogJsonErrorLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddSyslogJsonErrorLogPublisherRequest addSyslogJsonErrorLogPublisherRequest = (AddSyslogJsonErrorLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addSyslogJsonErrorLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addSyslogJsonErrorLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addSyslogJsonErrorLogPublisherRequest.schemas) &&
        Objects.equals(this.defaultSeverity, addSyslogJsonErrorLogPublisherRequest.defaultSeverity) &&
        Objects.equals(this.syslogExternalServer, addSyslogJsonErrorLogPublisherRequest.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, addSyslogJsonErrorLogPublisherRequest.syslogFacility) &&
        Objects.equals(this.syslogSeverity, addSyslogJsonErrorLogPublisherRequest.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, addSyslogJsonErrorLogPublisherRequest.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, addSyslogJsonErrorLogPublisherRequest.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, addSyslogJsonErrorLogPublisherRequest.queueSize) &&
        Objects.equals(this.includeProductName, addSyslogJsonErrorLogPublisherRequest.includeProductName) &&
        Objects.equals(this.includeInstanceName, addSyslogJsonErrorLogPublisherRequest.includeInstanceName) &&
        Objects.equals(this.includeStartupID, addSyslogJsonErrorLogPublisherRequest.includeStartupID) &&
        Objects.equals(this.includeThreadID, addSyslogJsonErrorLogPublisherRequest.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, addSyslogJsonErrorLogPublisherRequest.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.overrideSeverity, addSyslogJsonErrorLogPublisherRequest.overrideSeverity) &&
        Objects.equals(this.enabled, addSyslogJsonErrorLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addSyslogJsonErrorLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addSyslogJsonErrorLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, defaultSeverity, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSyslogJsonErrorLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddSyslogJsonErrorLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddSyslogJsonErrorLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSyslogJsonErrorLogPublisherRequest is not found in the empty JSON string", AddSyslogJsonErrorLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSyslogJsonErrorLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSyslogJsonErrorLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSyslogJsonErrorLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSyslogJsonErrorLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSyslogJsonErrorLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSyslogJsonErrorLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddSyslogJsonErrorLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddSyslogJsonErrorLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddSyslogJsonErrorLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddSyslogJsonErrorLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddSyslogJsonErrorLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddSyslogJsonErrorLogPublisherRequest
  */
  public static AddSyslogJsonErrorLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSyslogJsonErrorLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddSyslogJsonErrorLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
