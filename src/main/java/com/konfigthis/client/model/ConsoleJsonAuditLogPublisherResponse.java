...
public class ConsoleJsonAuditLogPublisherResponse {
  ...
  public ConsoleJsonAuditLogPublisherResponse() {
  }

  public ConsoleJsonAuditLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse schemas(List<EnumconsoleJsonAuditLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonAuditLogPublisherResponse addSchemasItem(EnumconsoleJsonAuditLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse useReversibleForm(Boolean useReversibleForm) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse softDeleteEntryAuditBehavior(EnumlogPublisherConsoleJsonAuditSoftDeleteEntryAuditBehaviorProp softDeleteEntryAuditBehavior) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeOperationPurposeRequestControl(Boolean includeOperationPurposeRequestControl) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeIntermediateClientRequestControl(Boolean includeIntermediateClientRequestControl) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse obscureAttribute(List<String> obscureAttribute) {
  ...
  public ConsoleJsonAuditLogPublisherResponse addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse excludeAttribute(List<String> excludeAttribute) {
  ...
  public ConsoleJsonAuditLogPublisherResponse addExcludeAttributeItem(String excludeAttributeItem) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConsoleJsonAuditLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConsoleJsonAuditLogPublisherResponse instance itself
   */
  public ConsoleJsonAuditLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonAuditLogPublisherResponse consoleJsonAuditLogPublisherResponse = (ConsoleJsonAuditLogPublisherResponse) o;
    return Objects.equals(this.id, consoleJsonAuditLogPublisherResponse.id) &&
        Objects.equals(this.description, consoleJsonAuditLogPublisherResponse.description) &&
        Objects.equals(this.schemas, consoleJsonAuditLogPublisherResponse.schemas) &&
        Objects.equals(this.enabled, consoleJsonAuditLogPublisherResponse.enabled) &&
        Objects.equals(this.outputLocation, consoleJsonAuditLogPublisherResponse.outputLocation) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonAuditLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.useReversibleForm, consoleJsonAuditLogPublisherResponse.useReversibleForm) &&
        Objects.equals(this.softDeleteEntryAuditBehavior, consoleJsonAuditLogPublisherResponse.softDeleteEntryAuditBehavior) &&
        Objects.equals(this.includeOperationPurposeRequestControl, consoleJsonAuditLogPublisherResponse.includeOperationPurposeRequestControl) &&
        Objects.equals(this.includeIntermediateClientRequestControl, consoleJsonAuditLogPublisherResponse.includeIntermediateClientRequestControl) &&
        Objects.equals(this.obscureAttribute, consoleJsonAuditLogPublisherResponse.obscureAttribute) &&
        Objects.equals(this.excludeAttribute, consoleJsonAuditLogPublisherResponse.excludeAttribute) &&
        Objects.equals(this.suppressInternalOperations, consoleJsonAuditLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.includeProductName, consoleJsonAuditLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonAuditLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonAuditLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonAuditLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, consoleJsonAuditLogPublisherResponse.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, consoleJsonAuditLogPublisherResponse.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestControls, consoleJsonAuditLogPublisherResponse.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, consoleJsonAuditLogPublisherResponse.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, consoleJsonAuditLogPublisherResponse.includeReplicationChangeID) &&
        Objects.equals(this.logSecurityNegotiation, consoleJsonAuditLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.suppressReplicationOperations, consoleJsonAuditLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, consoleJsonAuditLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, consoleJsonAuditLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, consoleJsonAuditLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonAuditLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, consoleJsonAuditLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, consoleJsonAuditLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, consoleJsonAuditLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, outputLocation, writeMultiLineMessages, useReversibleForm, softDeleteEntryAuditBehavior, includeOperationPurposeRequestControl, includeIntermediateClientRequestControl, obscureAttribute, excludeAttribute, suppressInternalOperations, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterDN, includeRequesterIPAddress, includeRequestControls, includeResponseControls, includeReplicationChangeID, logSecurityNegotiation, suppressReplicationOperations, connectionCriteria, requestCriteria, resultCriteria, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonAuditLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonAuditLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonAuditLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonAuditLogPublisherResponse is not found in the empty JSON string", ConsoleJsonAuditLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsoleJsonAuditLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonAuditLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonAuditLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonAuditLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonAuditLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonAuditLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonAuditLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ConsoleJsonAuditLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonAuditLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonAuditLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonAuditLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonAuditLogPublisherResponse
  */
  public static ConsoleJsonAuditLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonAuditLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ConsoleJsonAuditLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
