...
public class ThirdPartyPassThroughAuthenticationHandlerShared {
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared() {
  }

  public ThirdPartyPassThroughAuthenticationHandlerShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared schemas(List<EnumthirdPartyPassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared addSchemasItem(EnumthirdPartyPassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ThirdPartyPassThroughAuthenticationHandlerShared requestCriteria(String requestCriteria) {
  ...
  **/
   ...
   * @return the ThirdPartyPassThroughAuthenticationHandlerShared instance itself
   */
  public ThirdPartyPassThroughAuthenticationHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyPassThroughAuthenticationHandlerShared thirdPartyPassThroughAuthenticationHandlerShared = (ThirdPartyPassThroughAuthenticationHandlerShared) o;
    return Objects.equals(this.description, thirdPartyPassThroughAuthenticationHandlerShared.description) &&
        Objects.equals(this.schemas, thirdPartyPassThroughAuthenticationHandlerShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyPassThroughAuthenticationHandlerShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyPassThroughAuthenticationHandlerShared.extensionArgument) &&
        Objects.equals(this.includedLocalEntryBaseDN, thirdPartyPassThroughAuthenticationHandlerShared.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, thirdPartyPassThroughAuthenticationHandlerShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, thirdPartyPassThroughAuthenticationHandlerShared.requestCriteria)&&
        Objects.equals(this.additionalProperties, thirdPartyPassThroughAuthenticationHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyPassThroughAuthenticationHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyPassThroughAuthenticationHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyPassThroughAuthenticationHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyPassThroughAuthenticationHandlerShared is not found in the empty JSON string", ThirdPartyPassThroughAuthenticationHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyPassThroughAuthenticationHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyPassThroughAuthenticationHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyPassThroughAuthenticationHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyPassThroughAuthenticationHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyPassThroughAuthenticationHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyPassThroughAuthenticationHandlerShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyPassThroughAuthenticationHandlerShared value) throws IOException {
           ...
           @Override
           public ThirdPartyPassThroughAuthenticationHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyPassThroughAuthenticationHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyPassThroughAuthenticationHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyPassThroughAuthenticationHandlerShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyPassThroughAuthenticationHandlerShared
  */
  public static ThirdPartyPassThroughAuthenticationHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyPassThroughAuthenticationHandlerShared.class);
  }

 /**
  * Convert an instance of ThirdPartyPassThroughAuthenticationHandlerShared to an JSON string
  *
  * @return JSON string
  */
