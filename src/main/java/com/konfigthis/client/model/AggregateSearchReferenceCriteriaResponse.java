...
public class AggregateSearchReferenceCriteriaResponse {
  ...
  public AggregateSearchReferenceCriteriaResponse() {
  }

  public AggregateSearchReferenceCriteriaResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Search Reference Criteria")
  ...
  public AggregateSearchReferenceCriteriaResponse description(String description) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse schemas(List<EnumaggregateSearchReferenceCriteriaSchemaUrn> schemas) {
  ...
  public AggregateSearchReferenceCriteriaResponse addSchemasItem(EnumaggregateSearchReferenceCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse allIncludedSearchReferenceCriteria(List<String> allIncludedSearchReferenceCriteria) {
  ...
  public AggregateSearchReferenceCriteriaResponse addAllIncludedSearchReferenceCriteriaItem(String allIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse anyIncludedSearchReferenceCriteria(List<String> anyIncludedSearchReferenceCriteria) {
  ...
  public AggregateSearchReferenceCriteriaResponse addAnyIncludedSearchReferenceCriteriaItem(String anyIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse notAllIncludedSearchReferenceCriteria(List<String> notAllIncludedSearchReferenceCriteria) {
  ...
  public AggregateSearchReferenceCriteriaResponse addNotAllIncludedSearchReferenceCriteriaItem(String notAllIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse noneIncludedSearchReferenceCriteria(List<String> noneIncludedSearchReferenceCriteria) {
  ...
  public AggregateSearchReferenceCriteriaResponse addNoneIncludedSearchReferenceCriteriaItem(String noneIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AggregateSearchReferenceCriteriaResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AggregateSearchReferenceCriteriaResponse instance itself
   */
  public AggregateSearchReferenceCriteriaResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AggregateSearchReferenceCriteriaResponse aggregateSearchReferenceCriteriaResponse = (AggregateSearchReferenceCriteriaResponse) o;
    return Objects.equals(this.id, aggregateSearchReferenceCriteriaResponse.id) &&
        Objects.equals(this.description, aggregateSearchReferenceCriteriaResponse.description) &&
        Objects.equals(this.schemas, aggregateSearchReferenceCriteriaResponse.schemas) &&
        Objects.equals(this.allIncludedSearchReferenceCriteria, aggregateSearchReferenceCriteriaResponse.allIncludedSearchReferenceCriteria) &&
        Objects.equals(this.anyIncludedSearchReferenceCriteria, aggregateSearchReferenceCriteriaResponse.anyIncludedSearchReferenceCriteria) &&
        Objects.equals(this.notAllIncludedSearchReferenceCriteria, aggregateSearchReferenceCriteriaResponse.notAllIncludedSearchReferenceCriteria) &&
        Objects.equals(this.noneIncludedSearchReferenceCriteria, aggregateSearchReferenceCriteriaResponse.noneIncludedSearchReferenceCriteria) &&
        Objects.equals(this.meta, aggregateSearchReferenceCriteriaResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, aggregateSearchReferenceCriteriaResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, aggregateSearchReferenceCriteriaResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, allIncludedSearchReferenceCriteria, anyIncludedSearchReferenceCriteria, notAllIncludedSearchReferenceCriteria, noneIncludedSearchReferenceCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AggregateSearchReferenceCriteriaResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AggregateSearchReferenceCriteriaResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AggregateSearchReferenceCriteriaResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AggregateSearchReferenceCriteriaResponse is not found in the empty JSON string", AggregateSearchReferenceCriteriaResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AggregateSearchReferenceCriteriaResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AggregateSearchReferenceCriteriaResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AggregateSearchReferenceCriteriaResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AggregateSearchReferenceCriteriaResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AggregateSearchReferenceCriteriaResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AggregateSearchReferenceCriteriaResponse>() {
           @Override
           public void write(JsonWriter out, AggregateSearchReferenceCriteriaResponse value) throws IOException {
           ...
           @Override
           public AggregateSearchReferenceCriteriaResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AggregateSearchReferenceCriteriaResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AggregateSearchReferenceCriteriaResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AggregateSearchReferenceCriteriaResponse
  * @throws IOException if the JSON string is invalid with respect to AggregateSearchReferenceCriteriaResponse
  */
  public static AggregateSearchReferenceCriteriaResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AggregateSearchReferenceCriteriaResponse.class);
  }

 /**
  * Convert an instance of AggregateSearchReferenceCriteriaResponse to an JSON string
  *
  * @return JSON string
  */
