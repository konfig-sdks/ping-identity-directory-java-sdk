...
public class OpendjExternalServerShared {
  ...
  public OpendjExternalServerShared() {
  }

  public OpendjExternalServerShared description(String description) {
  ...
  **/
  ...
  public OpendjExternalServerShared schemas(List<EnumopendjExternalServerSchemaUrn> schemas) {
  ...
  public OpendjExternalServerShared addSchemasItem(EnumopendjExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OpendjExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public OpendjExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public OpendjExternalServerShared location(String location) {
  ...
  **/
  ...
  public OpendjExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public OpendjExternalServerShared password(String password) {
  ...
  **/
  ...
  public OpendjExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public OpendjExternalServerShared connectionSecurity(EnumexternalServerOpendjConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public OpendjExternalServerShared authenticationMethod(EnumexternalServerOpendjAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public OpendjExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public OpendjExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public OpendjExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public OpendjExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public OpendjExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public OpendjExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public OpendjExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public OpendjExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public OpendjExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public OpendjExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public OpendjExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public OpendjExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public OpendjExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the OpendjExternalServerShared instance itself
   */
  public OpendjExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpendjExternalServerShared opendjExternalServerShared = (OpendjExternalServerShared) o;
    return Objects.equals(this.description, opendjExternalServerShared.description) &&
        Objects.equals(this.schemas, opendjExternalServerShared.schemas) &&
        Objects.equals(this.serverHostName, opendjExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, opendjExternalServerShared.serverPort) &&
        Objects.equals(this.location, opendjExternalServerShared.location) &&
        Objects.equals(this.bindDN, opendjExternalServerShared.bindDN) &&
        Objects.equals(this.password, opendjExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, opendjExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, opendjExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, opendjExternalServerShared.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, opendjExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, opendjExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, opendjExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, opendjExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, opendjExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, opendjExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, opendjExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, opendjExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, opendjExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, opendjExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, opendjExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, opendjExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, opendjExternalServerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpendjExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpendjExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpendjExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpendjExternalServerShared is not found in the empty JSON string", OpendjExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpendjExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpendjExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpendjExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpendjExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpendjExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<OpendjExternalServerShared>() {
           @Override
           public void write(JsonWriter out, OpendjExternalServerShared value) throws IOException {
           ...
           @Override
           public OpendjExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OpendjExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OpendjExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OpendjExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to OpendjExternalServerShared
  */
  public static OpendjExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpendjExternalServerShared.class);
  }

 /**
  * Convert an instance of OpendjExternalServerShared to an JSON string
  *
  * @return JSON string
  */
