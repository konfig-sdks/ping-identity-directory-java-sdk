...
public class ProxyServerInstanceResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumproxyServerInstanceSchemaUrn> schemas = new ArrayList<>();
  ...
  public ProxyServerInstanceResponse() {
  }

  public ProxyServerInstanceResponse schemas(List<EnumproxyServerInstanceSchemaUrn> schemas) {
  ...
  public ProxyServerInstanceResponse addSchemasItem(EnumproxyServerInstanceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse id(String id) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse serverInstanceType(EnumserverInstanceServerInstanceTypeProp serverInstanceType) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse serverInstanceName(String serverInstanceName) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse clusterName(String clusterName) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse serverInstanceLocation(String serverInstanceLocation) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse hostname(String hostname) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse serverRoot(String serverRoot) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse serverVersion(String serverVersion) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse interServerCertificate(String interServerCertificate) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse ldapPort(Integer ldapPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse ldapsPort(Integer ldapsPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse httpPort(Integer httpPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse httpsPort(Integer httpsPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse replicationPort(Integer replicationPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse replicationServerID(Integer replicationServerID) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse replicationDomainServerID(List<Integer> replicationDomainServerID) {
  ...
  public ProxyServerInstanceResponse addReplicationDomainServerIDItem(Integer replicationDomainServerIDItem) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse jmxPort(Integer jmxPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse jmxsPort(Integer jmxsPort) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse preferredSecurity(EnumserverInstancePreferredSecurityProp preferredSecurity) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse startTLSEnabled(Boolean startTLSEnabled) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse baseDN(List<String> baseDN) {
  ...
  public ProxyServerInstanceResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse memberOfServerGroup(List<String> memberOfServerGroup) {
  ...
  public ProxyServerInstanceResponse addMemberOfServerGroupItem(String memberOfServerGroupItem) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ProxyServerInstanceResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ProxyServerInstanceResponse instance itself
   */
  public ProxyServerInstanceResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ProxyServerInstanceResponse proxyServerInstanceResponse = (ProxyServerInstanceResponse) o;
    return Objects.equals(this.schemas, proxyServerInstanceResponse.schemas) &&
        Objects.equals(this.id, proxyServerInstanceResponse.id) &&
        Objects.equals(this.serverInstanceType, proxyServerInstanceResponse.serverInstanceType) &&
        Objects.equals(this.serverInstanceName, proxyServerInstanceResponse.serverInstanceName) &&
        Objects.equals(this.clusterName, proxyServerInstanceResponse.clusterName) &&
        Objects.equals(this.serverInstanceLocation, proxyServerInstanceResponse.serverInstanceLocation) &&
        Objects.equals(this.hostname, proxyServerInstanceResponse.hostname) &&
        Objects.equals(this.serverRoot, proxyServerInstanceResponse.serverRoot) &&
        Objects.equals(this.serverVersion, proxyServerInstanceResponse.serverVersion) &&
        Objects.equals(this.interServerCertificate, proxyServerInstanceResponse.interServerCertificate) &&
        Objects.equals(this.ldapPort, proxyServerInstanceResponse.ldapPort) &&
        Objects.equals(this.ldapsPort, proxyServerInstanceResponse.ldapsPort) &&
        Objects.equals(this.httpPort, proxyServerInstanceResponse.httpPort) &&
        Objects.equals(this.httpsPort, proxyServerInstanceResponse.httpsPort) &&
        Objects.equals(this.replicationPort, proxyServerInstanceResponse.replicationPort) &&
        Objects.equals(this.replicationServerID, proxyServerInstanceResponse.replicationServerID) &&
        Objects.equals(this.replicationDomainServerID, proxyServerInstanceResponse.replicationDomainServerID) &&
        Objects.equals(this.jmxPort, proxyServerInstanceResponse.jmxPort) &&
        Objects.equals(this.jmxsPort, proxyServerInstanceResponse.jmxsPort) &&
        Objects.equals(this.preferredSecurity, proxyServerInstanceResponse.preferredSecurity) &&
        Objects.equals(this.startTLSEnabled, proxyServerInstanceResponse.startTLSEnabled) &&
        Objects.equals(this.baseDN, proxyServerInstanceResponse.baseDN) &&
        Objects.equals(this.memberOfServerGroup, proxyServerInstanceResponse.memberOfServerGroup) &&
        Objects.equals(this.meta, proxyServerInstanceResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, proxyServerInstanceResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, proxyServerInstanceResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProxyServerInstanceResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProxyServerInstanceResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ProxyServerInstanceResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProxyServerInstanceResponse is not found in the empty JSON string", ProxyServerInstanceResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ProxyServerInstanceResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProxyServerInstanceResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProxyServerInstanceResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProxyServerInstanceResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProxyServerInstanceResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ProxyServerInstanceResponse>() {
           @Override
           public void write(JsonWriter out, ProxyServerInstanceResponse value) throws IOException {
           ...
           @Override
           public ProxyServerInstanceResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ProxyServerInstanceResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ProxyServerInstanceResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProxyServerInstanceResponse
  * @throws IOException if the JSON string is invalid with respect to ProxyServerInstanceResponse
  */
  public static ProxyServerInstanceResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProxyServerInstanceResponse.class);
  }

 /**
  * Convert an instance of ProxyServerInstanceResponse to an JSON string
  *
  * @return JSON string
  */
