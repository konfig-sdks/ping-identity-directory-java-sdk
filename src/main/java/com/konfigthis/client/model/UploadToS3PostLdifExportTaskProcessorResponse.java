...
public class UploadToS3PostLdifExportTaskProcessorResponse {
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse() {
  }

  public UploadToS3PostLdifExportTaskProcessorResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Post LDIF Export Task Processor")
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse description(String description) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse schemas(List<EnumuploadToS3PostLdifExportTaskProcessorSchemaUrn> schemas) {
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse addSchemasItem(EnumuploadToS3PostLdifExportTaskProcessorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse s3BucketName(String s3BucketName) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse targetThroughputInMegabitsPerSecond(Integer targetThroughputInMegabitsPerSecond) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse maximumConcurrentTransferConnections(Integer maximumConcurrentTransferConnections) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse maximumFileCountToRetain(Integer maximumFileCountToRetain) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse maximumFileAgeToRetain(String maximumFileAgeToRetain) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse fileRetentionPattern(String fileRetentionPattern) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UploadToS3PostLdifExportTaskProcessorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UploadToS3PostLdifExportTaskProcessorResponse instance itself
   */
  public UploadToS3PostLdifExportTaskProcessorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UploadToS3PostLdifExportTaskProcessorResponse uploadToS3PostLdifExportTaskProcessorResponse = (UploadToS3PostLdifExportTaskProcessorResponse) o;
    return Objects.equals(this.id, uploadToS3PostLdifExportTaskProcessorResponse.id) &&
        Objects.equals(this.description, uploadToS3PostLdifExportTaskProcessorResponse.description) &&
        Objects.equals(this.schemas, uploadToS3PostLdifExportTaskProcessorResponse.schemas) &&
        Objects.equals(this.awsExternalServer, uploadToS3PostLdifExportTaskProcessorResponse.awsExternalServer) &&
        Objects.equals(this.s3BucketName, uploadToS3PostLdifExportTaskProcessorResponse.s3BucketName) &&
        Objects.equals(this.targetThroughputInMegabitsPerSecond, uploadToS3PostLdifExportTaskProcessorResponse.targetThroughputInMegabitsPerSecond) &&
        Objects.equals(this.maximumConcurrentTransferConnections, uploadToS3PostLdifExportTaskProcessorResponse.maximumConcurrentTransferConnections) &&
        Objects.equals(this.maximumFileCountToRetain, uploadToS3PostLdifExportTaskProcessorResponse.maximumFileCountToRetain) &&
        Objects.equals(this.maximumFileAgeToRetain, uploadToS3PostLdifExportTaskProcessorResponse.maximumFileAgeToRetain) &&
        Objects.equals(this.fileRetentionPattern, uploadToS3PostLdifExportTaskProcessorResponse.fileRetentionPattern) &&
        Objects.equals(this.enabled, uploadToS3PostLdifExportTaskProcessorResponse.enabled) &&
        Objects.equals(this.meta, uploadToS3PostLdifExportTaskProcessorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, uploadToS3PostLdifExportTaskProcessorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, uploadToS3PostLdifExportTaskProcessorResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadToS3PostLdifExportTaskProcessorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadToS3PostLdifExportTaskProcessorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadToS3PostLdifExportTaskProcessorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadToS3PostLdifExportTaskProcessorResponse is not found in the empty JSON string", UploadToS3PostLdifExportTaskProcessorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UploadToS3PostLdifExportTaskProcessorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadToS3PostLdifExportTaskProcessorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadToS3PostLdifExportTaskProcessorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadToS3PostLdifExportTaskProcessorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadToS3PostLdifExportTaskProcessorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadToS3PostLdifExportTaskProcessorResponse>() {
           @Override
           public void write(JsonWriter out, UploadToS3PostLdifExportTaskProcessorResponse value) throws IOException {
           ...
           @Override
           public UploadToS3PostLdifExportTaskProcessorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UploadToS3PostLdifExportTaskProcessorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UploadToS3PostLdifExportTaskProcessorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UploadToS3PostLdifExportTaskProcessorResponse
  * @throws IOException if the JSON string is invalid with respect to UploadToS3PostLdifExportTaskProcessorResponse
  */
  public static UploadToS3PostLdifExportTaskProcessorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadToS3PostLdifExportTaskProcessorResponse.class);
  }

 /**
  * Convert an instance of UploadToS3PostLdifExportTaskProcessorResponse to an JSON string
  *
  * @return JSON string
  */
