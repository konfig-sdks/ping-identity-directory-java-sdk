...
public class AddActiveDirectoryExternalServerRequest {
  ...
  public AddActiveDirectoryExternalServerRequest() {
  }

  public AddActiveDirectoryExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest schemas(List<EnumactiveDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public AddActiveDirectoryExternalServerRequest addSchemasItem(EnumactiveDirectoryExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest bindDN(String bindDN) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest location(String location) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest password(String password) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest connectionSecurity(EnumexternalServerActiveDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest authenticationMethod(EnumexternalServerActiveDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public AddActiveDirectoryExternalServerRequest addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public AddActiveDirectoryExternalServerRequest abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the AddActiveDirectoryExternalServerRequest instance itself
   */
  public AddActiveDirectoryExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddActiveDirectoryExternalServerRequest addActiveDirectoryExternalServerRequest = (AddActiveDirectoryExternalServerRequest) o;
    return Objects.equals(this.serverName, addActiveDirectoryExternalServerRequest.serverName) &&
        Objects.equals(this.description, addActiveDirectoryExternalServerRequest.description) &&
        Objects.equals(this.schemas, addActiveDirectoryExternalServerRequest.schemas) &&
        Objects.equals(this.bindDN, addActiveDirectoryExternalServerRequest.bindDN) &&
        Objects.equals(this.serverHostName, addActiveDirectoryExternalServerRequest.serverHostName) &&
        Objects.equals(this.serverPort, addActiveDirectoryExternalServerRequest.serverPort) &&
        Objects.equals(this.location, addActiveDirectoryExternalServerRequest.location) &&
        Objects.equals(this.password, addActiveDirectoryExternalServerRequest.password) &&
        Objects.equals(this.passphraseProvider, addActiveDirectoryExternalServerRequest.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, addActiveDirectoryExternalServerRequest.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, addActiveDirectoryExternalServerRequest.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, addActiveDirectoryExternalServerRequest.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, addActiveDirectoryExternalServerRequest.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, addActiveDirectoryExternalServerRequest.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, addActiveDirectoryExternalServerRequest.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, addActiveDirectoryExternalServerRequest.connectTimeout) &&
        Objects.equals(this.maxResponseSize, addActiveDirectoryExternalServerRequest.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, addActiveDirectoryExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addActiveDirectoryExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.initialConnections, addActiveDirectoryExternalServerRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addActiveDirectoryExternalServerRequest.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, addActiveDirectoryExternalServerRequest.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, addActiveDirectoryExternalServerRequest.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, addActiveDirectoryExternalServerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(serverName, description, schemas, bindDN, serverHostName, serverPort, location, password, passphraseProvider, connectionSecurity, authenticationMethod, verifyCredentialsMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddActiveDirectoryExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddActiveDirectoryExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddActiveDirectoryExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddActiveDirectoryExternalServerRequest is not found in the empty JSON string", AddActiveDirectoryExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddActiveDirectoryExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddActiveDirectoryExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddActiveDirectoryExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddActiveDirectoryExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddActiveDirectoryExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddActiveDirectoryExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddActiveDirectoryExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddActiveDirectoryExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddActiveDirectoryExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddActiveDirectoryExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddActiveDirectoryExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddActiveDirectoryExternalServerRequest
  */
  public static AddActiveDirectoryExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddActiveDirectoryExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddActiveDirectoryExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
