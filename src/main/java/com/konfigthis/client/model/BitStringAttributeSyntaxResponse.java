...
import com.konfigthis.client.model.EnumbitStringAttributeSyntaxSchemaUrn;
...
public class BitStringAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumbitStringAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public BitStringAttributeSyntaxResponse() {
  }

  public BitStringAttributeSyntaxResponse schemas(List<EnumbitStringAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BitStringAttributeSyntaxResponse addSchemasItem(EnumbitStringAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumbitStringAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumbitStringAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BitStringAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public BitStringAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public BitStringAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the BitStringAttributeSyntaxResponse instance itself
   */
  public BitStringAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BitStringAttributeSyntaxResponse bitStringAttributeSyntaxResponse = (BitStringAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, bitStringAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, bitStringAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, bitStringAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, bitStringAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, bitStringAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, bitStringAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, bitStringAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, bitStringAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, bitStringAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, bitStringAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BitStringAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BitStringAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BitStringAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BitStringAttributeSyntaxResponse is not found in the empty JSON string", BitStringAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BitStringAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BitStringAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BitStringAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BitStringAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BitStringAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BitStringAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, BitStringAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public BitStringAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BitStringAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BitStringAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BitStringAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to BitStringAttributeSyntaxResponse
  */
  public static BitStringAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BitStringAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of BitStringAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
