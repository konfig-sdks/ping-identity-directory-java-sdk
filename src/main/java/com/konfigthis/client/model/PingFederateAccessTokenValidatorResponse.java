...
public class PingFederateAccessTokenValidatorResponse {
  ...
  public PingFederateAccessTokenValidatorResponse() {
  }

  public PingFederateAccessTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse schemas(List<EnumpingFederateAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public PingFederateAccessTokenValidatorResponse addSchemasItem(EnumpingFederateAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse clientID(String clientID) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse clientSecret(String clientSecret) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse clientSecretPassphraseProvider(String clientSecretPassphraseProvider) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse includeAudParameter(Boolean includeAudParameter) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse accessTokenManagerID(String accessTokenManagerID) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse endpointCacheRefresh(String endpointCacheRefresh) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "When multiple Ping Federate Access Token Validators are defined for a single Directory Server, this property determines the evaluation order for determining the correct validator class for an access token received by the Directory Server. Values of this property must be unique among all Ping Federate Access Token Validators defined within Directory Server but not necessarily contiguous. Ping Federate Access Token Validators with a smaller value will be evaluated first to determine if they are able to validate the access token.")
  ...
  public PingFederateAccessTokenValidatorResponse authorizationServer(String authorizationServer) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PingFederateAccessTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PingFederateAccessTokenValidatorResponse instance itself
   */
  public PingFederateAccessTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingFederateAccessTokenValidatorResponse pingFederateAccessTokenValidatorResponse = (PingFederateAccessTokenValidatorResponse) o;
    return Objects.equals(this.id, pingFederateAccessTokenValidatorResponse.id) &&
        Objects.equals(this.description, pingFederateAccessTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, pingFederateAccessTokenValidatorResponse.schemas) &&
        Objects.equals(this.clientID, pingFederateAccessTokenValidatorResponse.clientID) &&
        Objects.equals(this.clientSecret, pingFederateAccessTokenValidatorResponse.clientSecret) &&
        Objects.equals(this.clientSecretPassphraseProvider, pingFederateAccessTokenValidatorResponse.clientSecretPassphraseProvider) &&
        Objects.equals(this.includeAudParameter, pingFederateAccessTokenValidatorResponse.includeAudParameter) &&
        Objects.equals(this.accessTokenManagerID, pingFederateAccessTokenValidatorResponse.accessTokenManagerID) &&
        Objects.equals(this.endpointCacheRefresh, pingFederateAccessTokenValidatorResponse.endpointCacheRefresh) &&
        Objects.equals(this.evaluationOrderIndex, pingFederateAccessTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.authorizationServer, pingFederateAccessTokenValidatorResponse.authorizationServer) &&
        Objects.equals(this.identityMapper, pingFederateAccessTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, pingFederateAccessTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.enabled, pingFederateAccessTokenValidatorResponse.enabled) &&
        Objects.equals(this.meta, pingFederateAccessTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pingFederateAccessTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pingFederateAccessTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, clientID, clientSecret, clientSecretPassphraseProvider, includeAudParameter, accessTokenManagerID, endpointCacheRefresh, evaluationOrderIndex, authorizationServer, identityMapper, subjectClaimName, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PingFederateAccessTokenValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingFederateAccessTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingFederateAccessTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingFederateAccessTokenValidatorResponse is not found in the empty JSON string", PingFederateAccessTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingFederateAccessTokenValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingFederateAccessTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingFederateAccessTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingFederateAccessTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingFederateAccessTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PingFederateAccessTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, PingFederateAccessTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public PingFederateAccessTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingFederateAccessTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingFederateAccessTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingFederateAccessTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to PingFederateAccessTokenValidatorResponse
  */
  public static PingFederateAccessTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingFederateAccessTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of PingFederateAccessTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
