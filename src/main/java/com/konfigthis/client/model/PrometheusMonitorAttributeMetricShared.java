...
public class PrometheusMonitorAttributeMetricShared {
  ...
  public PrometheusMonitorAttributeMetricShared() {
  }

  public PrometheusMonitorAttributeMetricShared schemas(List<EnumprometheusMonitorAttributeMetricSchemaUrn> schemas) {
  ...
  public PrometheusMonitorAttributeMetricShared addSchemasItem(EnumprometheusMonitorAttributeMetricSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared metricName(String metricName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared monitorAttributeName(String monitorAttributeName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared monitorObjectClassName(String monitorObjectClassName) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared metricType(EnumprometheusMonitorAttributeMetricMetricTypeProp metricType) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared filter(String filter) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared metricDescription(String metricDescription) {
  ...
  **/
  ...
  public PrometheusMonitorAttributeMetricShared labelNameValuePair(List<String> labelNameValuePair) {
  ...
  public PrometheusMonitorAttributeMetricShared addLabelNameValuePairItem(String labelNameValuePairItem) {
  ...
  **/
   ...
   * @return the PrometheusMonitorAttributeMetricShared instance itself
   */
  public PrometheusMonitorAttributeMetricShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrometheusMonitorAttributeMetricShared prometheusMonitorAttributeMetricShared = (PrometheusMonitorAttributeMetricShared) o;
    return Objects.equals(this.schemas, prometheusMonitorAttributeMetricShared.schemas) &&
        Objects.equals(this.metricName, prometheusMonitorAttributeMetricShared.metricName) &&
        Objects.equals(this.monitorAttributeName, prometheusMonitorAttributeMetricShared.monitorAttributeName) &&
        Objects.equals(this.monitorObjectClassName, prometheusMonitorAttributeMetricShared.monitorObjectClassName) &&
        Objects.equals(this.metricType, prometheusMonitorAttributeMetricShared.metricType) &&
        Objects.equals(this.filter, prometheusMonitorAttributeMetricShared.filter) &&
        Objects.equals(this.metricDescription, prometheusMonitorAttributeMetricShared.metricDescription) &&
        Objects.equals(this.labelNameValuePair, prometheusMonitorAttributeMetricShared.labelNameValuePair)&&
        Objects.equals(this.additionalProperties, prometheusMonitorAttributeMetricShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, metricName, monitorAttributeName, monitorObjectClassName, metricType, filter, metricDescription, labelNameValuePair, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrometheusMonitorAttributeMetricShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrometheusMonitorAttributeMetricShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrometheusMonitorAttributeMetricShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrometheusMonitorAttributeMetricShared is not found in the empty JSON string", PrometheusMonitorAttributeMetricShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrometheusMonitorAttributeMetricShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrometheusMonitorAttributeMetricShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrometheusMonitorAttributeMetricShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrometheusMonitorAttributeMetricShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrometheusMonitorAttributeMetricShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PrometheusMonitorAttributeMetricShared>() {
           @Override
           public void write(JsonWriter out, PrometheusMonitorAttributeMetricShared value) throws IOException {
           ...
           @Override
           public PrometheusMonitorAttributeMetricShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrometheusMonitorAttributeMetricShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrometheusMonitorAttributeMetricShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrometheusMonitorAttributeMetricShared
  * @throws IOException if the JSON string is invalid with respect to PrometheusMonitorAttributeMetricShared
  */
  public static PrometheusMonitorAttributeMetricShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrometheusMonitorAttributeMetricShared.class);
  }

 /**
  * Convert an instance of PrometheusMonitorAttributeMetricShared to an JSON string
  *
  * @return JSON string
  */
