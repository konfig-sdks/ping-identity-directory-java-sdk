...
import com.konfigthis.client.model.EnumbooleanAttributeSyntaxSchemaUrn;
...
public class BooleanAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumbooleanAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public BooleanAttributeSyntaxResponse() {
  }

  public BooleanAttributeSyntaxResponse schemas(List<EnumbooleanAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BooleanAttributeSyntaxResponse addSchemasItem(EnumbooleanAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumbooleanAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumbooleanAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BooleanAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public BooleanAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public BooleanAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public BooleanAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the BooleanAttributeSyntaxResponse instance itself
   */
  public BooleanAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BooleanAttributeSyntaxResponse booleanAttributeSyntaxResponse = (BooleanAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, booleanAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, booleanAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, booleanAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, booleanAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, booleanAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, booleanAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, booleanAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, booleanAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, booleanAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, booleanAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BooleanAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BooleanAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BooleanAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BooleanAttributeSyntaxResponse is not found in the empty JSON string", BooleanAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BooleanAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BooleanAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BooleanAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BooleanAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BooleanAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BooleanAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, BooleanAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public BooleanAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BooleanAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BooleanAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BooleanAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to BooleanAttributeSyntaxResponse
  */
  public static BooleanAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BooleanAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of BooleanAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
