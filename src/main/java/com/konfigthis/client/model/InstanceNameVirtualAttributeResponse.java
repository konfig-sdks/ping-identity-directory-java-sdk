...
import com.konfigthis.client.model.EnuminstanceNameVirtualAttributeSchemaUrn;
...
public class InstanceNameVirtualAttributeResponse {
  ...
  private List<EnuminstanceNameVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public InstanceNameVirtualAttributeResponse() {
  }

  public InstanceNameVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse schemas(List<EnuminstanceNameVirtualAttributeSchemaUrn> schemas) {
  ...
  public InstanceNameVirtualAttributeResponse addSchemasItem(EnuminstanceNameVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnuminstanceNameVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnuminstanceNameVirtualAttributeSchemaUrn> schemas) {
  ...
  public InstanceNameVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public InstanceNameVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public InstanceNameVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse filter(List<String> filter) {
  ...
  public InstanceNameVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public InstanceNameVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public InstanceNameVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the InstanceNameVirtualAttributeResponse instance itself
   */
  public InstanceNameVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    InstanceNameVirtualAttributeResponse instanceNameVirtualAttributeResponse = (InstanceNameVirtualAttributeResponse) o;
    return Objects.equals(this.description, instanceNameVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, instanceNameVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, instanceNameVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, instanceNameVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, instanceNameVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, instanceNameVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, instanceNameVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, instanceNameVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, instanceNameVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, instanceNameVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, instanceNameVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, instanceNameVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, instanceNameVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, instanceNameVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, instanceNameVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, instanceNameVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, instanceNameVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstanceNameVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to InstanceNameVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!InstanceNameVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in InstanceNameVirtualAttributeResponse is not found in the empty JSON string", InstanceNameVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : InstanceNameVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InstanceNameVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InstanceNameVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InstanceNameVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InstanceNameVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<InstanceNameVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, InstanceNameVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public InstanceNameVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             InstanceNameVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of InstanceNameVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of InstanceNameVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to InstanceNameVirtualAttributeResponse
  */
  public static InstanceNameVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, InstanceNameVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of InstanceNameVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
