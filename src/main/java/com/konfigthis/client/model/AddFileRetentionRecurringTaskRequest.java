...
public class AddFileRetentionRecurringTaskRequest {
  ...
  public AddFileRetentionRecurringTaskRequest() {
  }

  public AddFileRetentionRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest schemas(List<EnumfileRetentionRecurringTaskSchemaUrn> schemas) {
  ...
  public AddFileRetentionRecurringTaskRequest addSchemasItem(EnumfileRetentionRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest targetDirectory(String targetDirectory) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest filenamePattern(String filenamePattern) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest timestampFormat(EnumrecurringTaskTimestampFormatProp timestampFormat) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest retainFileCount(Integer retainFileCount) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest retainFileAge(String retainFileAge) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest retainAggregateFileSize(String retainAggregateFileSize) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddFileRetentionRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddFileRetentionRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddFileRetentionRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddFileRetentionRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddFileRetentionRecurringTaskRequest instance itself
   */
  public AddFileRetentionRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddFileRetentionRecurringTaskRequest addFileRetentionRecurringTaskRequest = (AddFileRetentionRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addFileRetentionRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addFileRetentionRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addFileRetentionRecurringTaskRequest.schemas) &&
        Objects.equals(this.targetDirectory, addFileRetentionRecurringTaskRequest.targetDirectory) &&
        Objects.equals(this.filenamePattern, addFileRetentionRecurringTaskRequest.filenamePattern) &&
        Objects.equals(this.timestampFormat, addFileRetentionRecurringTaskRequest.timestampFormat) &&
        Objects.equals(this.retainFileCount, addFileRetentionRecurringTaskRequest.retainFileCount) &&
        Objects.equals(this.retainFileAge, addFileRetentionRecurringTaskRequest.retainFileAge) &&
        Objects.equals(this.retainAggregateFileSize, addFileRetentionRecurringTaskRequest.retainAggregateFileSize) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addFileRetentionRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addFileRetentionRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addFileRetentionRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addFileRetentionRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addFileRetentionRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addFileRetentionRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addFileRetentionRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addFileRetentionRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, targetDirectory, filenamePattern, timestampFormat, retainFileCount, retainFileAge, retainAggregateFileSize, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddFileRetentionRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFileRetentionRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFileRetentionRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFileRetentionRecurringTaskRequest is not found in the empty JSON string", AddFileRetentionRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddFileRetentionRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddFileRetentionRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddFileRetentionRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddFileRetentionRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddFileRetentionRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddFileRetentionRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddFileRetentionRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddFileRetentionRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddFileRetentionRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddFileRetentionRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddFileRetentionRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddFileRetentionRecurringTaskRequest
  */
  public static AddFileRetentionRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddFileRetentionRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddFileRetentionRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
