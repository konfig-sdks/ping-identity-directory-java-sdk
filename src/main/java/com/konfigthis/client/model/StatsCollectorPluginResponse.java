...
public class StatsCollectorPluginResponse {
  ...
  private List<EnumstatsCollectorPluginSchemaUrn> schemas = new ArrayList<>();
  ...
  public StatsCollectorPluginResponse() {
  }

  public StatsCollectorPluginResponse description(String description) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse schemas(List<EnumstatsCollectorPluginSchemaUrn> schemas) {
  ...
  public StatsCollectorPluginResponse addSchemasItem(EnumstatsCollectorPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse id(String id) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse sampleInterval(String sampleInterval) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The duration between statistics collections. Setting this value too small can have an impact on performance. This value should be a multiple of collection-interval.")
  ...
  public StatsCollectorPluginResponse collectionInterval(String collectionInterval) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Some of the calculated statistics, such as the average and maximum queue sizes, can use multiple samples within a log interval. This value controls how often samples are gathered, and setting this value too small can have an adverse impact on performance.")
  ...
  public StatsCollectorPluginResponse ldapInfo(EnumpluginLdapInfoProp ldapInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse serverInfo(EnumpluginServerInfoProp serverInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse perApplicationLDAPStats(EnumpluginStatsCollectorPerApplicationLDAPStatsProp perApplicationLDAPStats) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse ldapChangelogInfo(EnumpluginLdapChangelogInfoProp ldapChangelogInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse statusSummaryInfo(EnumpluginStatusSummaryInfoProp statusSummaryInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse generateCollectorFiles(Boolean generateCollectorFiles) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse localDBBackendInfo(EnumpluginLocalDBBackendInfoProp localDBBackendInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse replicationInfo(EnumpluginReplicationInfoProp replicationInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse entryCacheInfo(EnumpluginEntryCacheInfoProp entryCacheInfo) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse hostInfo(List<EnumpluginHostInfoProp> hostInfo) {
  ...
  public StatsCollectorPluginResponse addHostInfoItem(EnumpluginHostInfoProp hostInfoItem) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse includedLDAPApplication(List<String> includedLDAPApplication) {
  ...
  public StatsCollectorPluginResponse addIncludedLDAPApplicationItem(String includedLDAPApplicationItem) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public StatsCollectorPluginResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the StatsCollectorPluginResponse instance itself
   */
  public StatsCollectorPluginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    StatsCollectorPluginResponse statsCollectorPluginResponse = (StatsCollectorPluginResponse) o;
    return Objects.equals(this.description, statsCollectorPluginResponse.description) &&
        Objects.equals(this.schemas, statsCollectorPluginResponse.schemas) &&
        Objects.equals(this.id, statsCollectorPluginResponse.id) &&
        Objects.equals(this.sampleInterval, statsCollectorPluginResponse.sampleInterval) &&
        Objects.equals(this.collectionInterval, statsCollectorPluginResponse.collectionInterval) &&
        Objects.equals(this.ldapInfo, statsCollectorPluginResponse.ldapInfo) &&
        Objects.equals(this.serverInfo, statsCollectorPluginResponse.serverInfo) &&
        Objects.equals(this.perApplicationLDAPStats, statsCollectorPluginResponse.perApplicationLDAPStats) &&
        Objects.equals(this.ldapChangelogInfo, statsCollectorPluginResponse.ldapChangelogInfo) &&
        Objects.equals(this.statusSummaryInfo, statsCollectorPluginResponse.statusSummaryInfo) &&
        Objects.equals(this.generateCollectorFiles, statsCollectorPluginResponse.generateCollectorFiles) &&
        Objects.equals(this.localDBBackendInfo, statsCollectorPluginResponse.localDBBackendInfo) &&
        Objects.equals(this.replicationInfo, statsCollectorPluginResponse.replicationInfo) &&
        Objects.equals(this.entryCacheInfo, statsCollectorPluginResponse.entryCacheInfo) &&
        Objects.equals(this.hostInfo, statsCollectorPluginResponse.hostInfo) &&
        Objects.equals(this.includedLDAPApplication, statsCollectorPluginResponse.includedLDAPApplication) &&
        Objects.equals(this.enabled, statsCollectorPluginResponse.enabled) &&
        Objects.equals(this.meta, statsCollectorPluginResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, statsCollectorPluginResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, statsCollectorPluginResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, sampleInterval, collectionInterval, ldapInfo, serverInfo, perApplicationLDAPStats, ldapChangelogInfo, statusSummaryInfo, generateCollectorFiles, localDBBackendInfo, replicationInfo, entryCacheInfo, hostInfo, includedLDAPApplication, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StatsCollectorPluginResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to StatsCollectorPluginResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!StatsCollectorPluginResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in StatsCollectorPluginResponse is not found in the empty JSON string", StatsCollectorPluginResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : StatsCollectorPluginResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sampleInterval").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!StatsCollectorPluginResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'StatsCollectorPluginResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<StatsCollectorPluginResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(StatsCollectorPluginResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<StatsCollectorPluginResponse>() {
           @Override
           public void write(JsonWriter out, StatsCollectorPluginResponse value) throws IOException {
           ...
           @Override
           public StatsCollectorPluginResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             StatsCollectorPluginResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of StatsCollectorPluginResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of StatsCollectorPluginResponse
  * @throws IOException if the JSON string is invalid with respect to StatsCollectorPluginResponse
  */
  public static StatsCollectorPluginResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, StatsCollectorPluginResponse.class);
  }

 /**
  * Convert an instance of StatsCollectorPluginResponse to an JSON string
  *
  * @return JSON string
  */
