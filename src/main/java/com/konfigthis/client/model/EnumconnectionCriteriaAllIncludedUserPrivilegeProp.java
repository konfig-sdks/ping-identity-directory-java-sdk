 ...
 */
@JsonAdapter(EnumconnectionCriteriaAllIncludedUserPrivilegeProp.Adapter.class)public enum EnumconnectionCriteriaAllIncludedUserPrivilegeProp {
  ...
  EnumconnectionCriteriaAllIncludedUserPrivilegeProp(String value) {
    this.value = value;
  }
  ...
  public static EnumconnectionCriteriaAllIncludedUserPrivilegeProp fromValue(String value) {
    for (EnumconnectionCriteriaAllIncludedUserPrivilegeProp b : EnumconnectionCriteriaAllIncludedUserPrivilegeProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumconnectionCriteriaAllIncludedUserPrivilegeProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumconnectionCriteriaAllIncludedUserPrivilegeProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumconnectionCriteriaAllIncludedUserPrivilegeProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumconnectionCriteriaAllIncludedUserPrivilegeProp.fromValue(value);
    }
  }
}
