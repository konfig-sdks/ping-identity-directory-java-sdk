...
public class AddPingOneIdTokenValidatorRequest {
  ...
  public AddPingOneIdTokenValidatorRequest() {
  }

  public AddPingOneIdTokenValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest schemas(List<EnumpingOneIdTokenValidatorSchemaUrn> schemas) {
  ...
  public AddPingOneIdTokenValidatorRequest addSchemasItem(EnumpingOneIdTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest issuerURL(String issuerURL) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest openIDConnectProvider(String openIDConnectProvider) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest openIDConnectMetadataCacheDuration(String openIDConnectMetadataCacheDuration) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest identityMapper(String identityMapper) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest jwksCacheDuration(String jwksCacheDuration) {
  ...
  **/
  ...
  public AddPingOneIdTokenValidatorRequest evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
   ...
   * @return the AddPingOneIdTokenValidatorRequest instance itself
   */
  public AddPingOneIdTokenValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPingOneIdTokenValidatorRequest addPingOneIdTokenValidatorRequest = (AddPingOneIdTokenValidatorRequest) o;
    return Objects.equals(this.validatorName, addPingOneIdTokenValidatorRequest.validatorName) &&
        Objects.equals(this.description, addPingOneIdTokenValidatorRequest.description) &&
        Objects.equals(this.schemas, addPingOneIdTokenValidatorRequest.schemas) &&
        Objects.equals(this.issuerURL, addPingOneIdTokenValidatorRequest.issuerURL) &&
        Objects.equals(this.openIDConnectProvider, addPingOneIdTokenValidatorRequest.openIDConnectProvider) &&
        Objects.equals(this.openIDConnectMetadataCacheDuration, addPingOneIdTokenValidatorRequest.openIDConnectMetadataCacheDuration) &&
        Objects.equals(this.enabled, addPingOneIdTokenValidatorRequest.enabled) &&
        Objects.equals(this.identityMapper, addPingOneIdTokenValidatorRequest.identityMapper) &&
        Objects.equals(this.subjectClaimName, addPingOneIdTokenValidatorRequest.subjectClaimName) &&
        Objects.equals(this.clockSkewGracePeriod, addPingOneIdTokenValidatorRequest.clockSkewGracePeriod) &&
        Objects.equals(this.jwksCacheDuration, addPingOneIdTokenValidatorRequest.jwksCacheDuration) &&
        Objects.equals(this.evaluationOrderIndex, addPingOneIdTokenValidatorRequest.evaluationOrderIndex)&&
        Objects.equals(this.additionalProperties, addPingOneIdTokenValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, issuerURL, openIDConnectProvider, openIDConnectMetadataCacheDuration, enabled, identityMapper, subjectClaimName, clockSkewGracePeriod, jwksCacheDuration, evaluationOrderIndex, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPingOneIdTokenValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPingOneIdTokenValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPingOneIdTokenValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPingOneIdTokenValidatorRequest is not found in the empty JSON string", AddPingOneIdTokenValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPingOneIdTokenValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPingOneIdTokenValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPingOneIdTokenValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPingOneIdTokenValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPingOneIdTokenValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPingOneIdTokenValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddPingOneIdTokenValidatorRequest value) throws IOException {
           ...
           @Override
           public AddPingOneIdTokenValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPingOneIdTokenValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPingOneIdTokenValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPingOneIdTokenValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddPingOneIdTokenValidatorRequest
  */
  public static AddPingOneIdTokenValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPingOneIdTokenValidatorRequest.class);
  }

 /**
  * Convert an instance of AddPingOneIdTokenValidatorRequest to an JSON string
  *
  * @return JSON string
  */
