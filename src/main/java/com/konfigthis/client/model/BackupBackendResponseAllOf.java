...
public class BackupBackendResponseAllOf {
  ...
  private List<EnumbackupBackendSchemaUrn> schemas = null;
  ...
  private List<String> backupDirectory = null;
  ...
  public BackupBackendResponseAllOf() {
  }

  public BackupBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf schemas(List<EnumbackupBackendSchemaUrn> schemas) {
  ...
  public BackupBackendResponseAllOf addSchemasItem(EnumbackupBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public BackupBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf backupDirectory(List<String> backupDirectory) {
  ...
  public BackupBackendResponseAllOf addBackupDirectoryItem(String backupDirectoryItem) {
    if (this.backupDirectory == null) {
      this.backupDirectory = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the path to a backup directory containing one or more backups for a particular backend.")
  ...
  public BackupBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public BackupBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the BackupBackendResponseAllOf instance itself
   */
  public BackupBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BackupBackendResponseAllOf backupBackendResponseAllOf = (BackupBackendResponseAllOf) o;
    return Objects.equals(this.description, backupBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, backupBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, backupBackendResponseAllOf.id) &&
        Objects.equals(this.backendID, backupBackendResponseAllOf.backendID) &&
        Objects.equals(this.baseDN, backupBackendResponseAllOf.baseDN) &&
        Objects.equals(this.writabilityMode, backupBackendResponseAllOf.writabilityMode) &&
        Objects.equals(this.backupDirectory, backupBackendResponseAllOf.backupDirectory) &&
        Objects.equals(this.enabled, backupBackendResponseAllOf.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, backupBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, backupBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.notificationManager, backupBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, backupBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, backendID, baseDN, writabilityMode, backupDirectory, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BackupBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BackupBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BackupBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BackupBackendResponseAllOf is not found in the empty JSON string", BackupBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("backupDirectory") != null && !jsonObj.get("backupDirectory").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BackupBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BackupBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BackupBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BackupBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<BackupBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, BackupBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public BackupBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BackupBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BackupBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BackupBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to BackupBackendResponseAllOf
  */
  public static BackupBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BackupBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of BackupBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
