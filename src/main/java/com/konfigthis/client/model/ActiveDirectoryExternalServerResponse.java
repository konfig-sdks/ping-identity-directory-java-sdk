...
import com.konfigthis.client.model.EnumactiveDirectoryExternalServerSchemaUrn;
import com.konfigthis.client.model.EnumexternalServerActiveDirectoryAuthenticationMethodProp;
import com.konfigthis.client.model.EnumexternalServerActiveDirectoryConnectionSecurityProp;
...
public class ActiveDirectoryExternalServerResponse {
  ...
  private List<EnumactiveDirectoryExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerActiveDirectoryConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerActiveDirectoryAuthenticationMethodProp authenticationMethod;
  ...
  public ActiveDirectoryExternalServerResponse() {
  }

  public ActiveDirectoryExternalServerResponse id(String id) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse description(String description) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse schemas(List<EnumactiveDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public ActiveDirectoryExternalServerResponse addSchemasItem(EnumactiveDirectoryExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumactiveDirectoryExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumactiveDirectoryExternalServerSchemaUrn> schemas) {
  ...
  public ActiveDirectoryExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The DN to use to bind to the target LDAP server if simple authentication is required. The authentication identity can also be specified in User-Principal-Name (UPN) format.")
  ...
  public ActiveDirectoryExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse location(String location) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse password(String password) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse connectionSecurity(EnumexternalServerActiveDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerActiveDirectoryConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerActiveDirectoryConnectionSecurityProp connectionSecurity) {
  ...
  public ActiveDirectoryExternalServerResponse authenticationMethod(EnumexternalServerActiveDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerActiveDirectoryAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerActiveDirectoryAuthenticationMethodProp authenticationMethod) {
  ...
  public ActiveDirectoryExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public ActiveDirectoryExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ActiveDirectoryExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ActiveDirectoryExternalServerResponse instance itself
   */
  public ActiveDirectoryExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ActiveDirectoryExternalServerResponse activeDirectoryExternalServerResponse = (ActiveDirectoryExternalServerResponse) o;
    return Objects.equals(this.id, activeDirectoryExternalServerResponse.id) &&
        Objects.equals(this.description, activeDirectoryExternalServerResponse.description) &&
        Objects.equals(this.schemas, activeDirectoryExternalServerResponse.schemas) &&
        Objects.equals(this.bindDN, activeDirectoryExternalServerResponse.bindDN) &&
        Objects.equals(this.serverHostName, activeDirectoryExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, activeDirectoryExternalServerResponse.serverPort) &&
        Objects.equals(this.location, activeDirectoryExternalServerResponse.location) &&
        Objects.equals(this.password, activeDirectoryExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, activeDirectoryExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, activeDirectoryExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, activeDirectoryExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, activeDirectoryExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, activeDirectoryExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, activeDirectoryExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, activeDirectoryExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, activeDirectoryExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, activeDirectoryExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, activeDirectoryExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, activeDirectoryExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, activeDirectoryExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, activeDirectoryExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, activeDirectoryExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, activeDirectoryExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, activeDirectoryExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, activeDirectoryExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, activeDirectoryExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, bindDN, serverHostName, serverPort, location, password, passphraseProvider, connectionSecurity, authenticationMethod, verifyCredentialsMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ActiveDirectoryExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ActiveDirectoryExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ActiveDirectoryExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ActiveDirectoryExternalServerResponse is not found in the empty JSON string", ActiveDirectoryExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ActiveDirectoryExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ActiveDirectoryExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ActiveDirectoryExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ActiveDirectoryExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ActiveDirectoryExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ActiveDirectoryExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, ActiveDirectoryExternalServerResponse value) throws IOException {
           ...
           @Override
           public ActiveDirectoryExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ActiveDirectoryExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ActiveDirectoryExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ActiveDirectoryExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to ActiveDirectoryExternalServerResponse
  */
  public static ActiveDirectoryExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ActiveDirectoryExternalServerResponse.class);
  }

 /**
  * Convert an instance of ActiveDirectoryExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
