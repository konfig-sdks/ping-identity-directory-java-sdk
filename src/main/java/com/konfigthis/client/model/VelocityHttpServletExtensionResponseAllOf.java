...
public class VelocityHttpServletExtensionResponseAllOf {
  ...
  private List<EnumvelocityHttpServletExtensionSchemaUrn> schemas = null;
  ...
  private List<String> templateDirectory = null;
  ...
  public VelocityHttpServletExtensionResponseAllOf() {
  }

  public VelocityHttpServletExtensionResponseAllOf description(String description) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf schemas(List<EnumvelocityHttpServletExtensionSchemaUrn> schemas) {
  ...
  public VelocityHttpServletExtensionResponseAllOf addSchemasItem(EnumvelocityHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf id(String id) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf baseContextPath(String baseContextPath) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The context path to use to access all template-based and static content. The value must start with a forward slash and must represent a valid HTTP context path.")
  ...
  public VelocityHttpServletExtensionResponseAllOf staticContextPath(String staticContextPath) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf staticContentDirectory(String staticContentDirectory) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf staticCustomDirectory(String staticCustomDirectory) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf templateDirectory(List<String> templateDirectory) {
  ...
  public VelocityHttpServletExtensionResponseAllOf addTemplateDirectoryItem(String templateDirectoryItem) {
    if (this.templateDirectory == null) {
      this.templateDirectory = new ArrayList<>();
    }
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies an ordered list of directories in which to search for the template files.")
  ...
  public VelocityHttpServletExtensionResponseAllOf exposeRequestAttributes(Boolean exposeRequestAttributes) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf exposeSessionAttributes(Boolean exposeSessionAttributes) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf exposeServerContext(Boolean exposeServerContext) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf allowContextOverride(Boolean allowContextOverride) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf mimeTypesFile(String mimeTypesFile) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf defaultMIMEType(String defaultMIMEType) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf characterEncoding(String characterEncoding) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf responseHeader(List<String> responseHeader) {
  ...
  public VelocityHttpServletExtensionResponseAllOf addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf staticResponseHeader(List<String> staticResponseHeader) {
  ...
  public VelocityHttpServletExtensionResponseAllOf addStaticResponseHeaderItem(String staticResponseHeaderItem) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf requireAuthentication(Boolean requireAuthentication) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf identityMapper(String identityMapper) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public VelocityHttpServletExtensionResponseAllOf correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the VelocityHttpServletExtensionResponseAllOf instance itself
   */
  public VelocityHttpServletExtensionResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VelocityHttpServletExtensionResponseAllOf velocityHttpServletExtensionResponseAllOf = (VelocityHttpServletExtensionResponseAllOf) o;
    return Objects.equals(this.description, velocityHttpServletExtensionResponseAllOf.description) &&
        Objects.equals(this.schemas, velocityHttpServletExtensionResponseAllOf.schemas) &&
        Objects.equals(this.id, velocityHttpServletExtensionResponseAllOf.id) &&
        Objects.equals(this.baseContextPath, velocityHttpServletExtensionResponseAllOf.baseContextPath) &&
        Objects.equals(this.staticContextPath, velocityHttpServletExtensionResponseAllOf.staticContextPath) &&
        Objects.equals(this.staticContentDirectory, velocityHttpServletExtensionResponseAllOf.staticContentDirectory) &&
        Objects.equals(this.staticCustomDirectory, velocityHttpServletExtensionResponseAllOf.staticCustomDirectory) &&
        Objects.equals(this.templateDirectory, velocityHttpServletExtensionResponseAllOf.templateDirectory) &&
        Objects.equals(this.exposeRequestAttributes, velocityHttpServletExtensionResponseAllOf.exposeRequestAttributes) &&
        Objects.equals(this.exposeSessionAttributes, velocityHttpServletExtensionResponseAllOf.exposeSessionAttributes) &&
        Objects.equals(this.exposeServerContext, velocityHttpServletExtensionResponseAllOf.exposeServerContext) &&
        Objects.equals(this.allowContextOverride, velocityHttpServletExtensionResponseAllOf.allowContextOverride) &&
        Objects.equals(this.mimeTypesFile, velocityHttpServletExtensionResponseAllOf.mimeTypesFile) &&
        Objects.equals(this.defaultMIMEType, velocityHttpServletExtensionResponseAllOf.defaultMIMEType) &&
        Objects.equals(this.characterEncoding, velocityHttpServletExtensionResponseAllOf.characterEncoding) &&
        Objects.equals(this.responseHeader, velocityHttpServletExtensionResponseAllOf.responseHeader) &&
        Objects.equals(this.staticResponseHeader, velocityHttpServletExtensionResponseAllOf.staticResponseHeader) &&
        Objects.equals(this.requireAuthentication, velocityHttpServletExtensionResponseAllOf.requireAuthentication) &&
        Objects.equals(this.identityMapper, velocityHttpServletExtensionResponseAllOf.identityMapper) &&
        Objects.equals(this.crossOriginPolicy, velocityHttpServletExtensionResponseAllOf.crossOriginPolicy) &&
        Objects.equals(this.correlationIDResponseHeader, velocityHttpServletExtensionResponseAllOf.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, velocityHttpServletExtensionResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseContextPath, staticContextPath, staticContentDirectory, staticCustomDirectory, templateDirectory, exposeRequestAttributes, exposeSessionAttributes, exposeServerContext, allowContextOverride, mimeTypesFile, defaultMIMEType, characterEncoding, responseHeader, staticResponseHeader, requireAuthentication, identityMapper, crossOriginPolicy, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VelocityHttpServletExtensionResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VelocityHttpServletExtensionResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VelocityHttpServletExtensionResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VelocityHttpServletExtensionResponseAllOf is not found in the empty JSON string", VelocityHttpServletExtensionResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("templateDirectory") != null && !jsonObj.get("templateDirectory").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VelocityHttpServletExtensionResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VelocityHttpServletExtensionResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VelocityHttpServletExtensionResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VelocityHttpServletExtensionResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<VelocityHttpServletExtensionResponseAllOf>() {
           @Override
           public void write(JsonWriter out, VelocityHttpServletExtensionResponseAllOf value) throws IOException {
           ...
           @Override
           public VelocityHttpServletExtensionResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VelocityHttpServletExtensionResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VelocityHttpServletExtensionResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VelocityHttpServletExtensionResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to VelocityHttpServletExtensionResponseAllOf
  */
  public static VelocityHttpServletExtensionResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VelocityHttpServletExtensionResponseAllOf.class);
  }

 /**
  * Convert an instance of VelocityHttpServletExtensionResponseAllOf to an JSON string
  *
  * @return JSON string
  */
