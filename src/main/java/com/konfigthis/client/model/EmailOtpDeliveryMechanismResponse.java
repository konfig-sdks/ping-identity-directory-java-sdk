...
public class EmailOtpDeliveryMechanismResponse {
  ...
  public EmailOtpDeliveryMechanismResponse() {
  }

  public EmailOtpDeliveryMechanismResponse id(String id) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse description(String description) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse schemas(List<EnumemailOtpDeliveryMechanismSchemaUrn> schemas) {
  ...
  public EmailOtpDeliveryMechanismResponse addSchemasItem(EnumemailOtpDeliveryMechanismSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse emailAddressAttributeType(String emailAddressAttributeType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name or OID of the attribute that holds the email address to which the message should be sent.")
  ...
  public EmailOtpDeliveryMechanismResponse emailAddressJSONField(String emailAddressJSONField) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse emailAddressJSONObjectFilter(String emailAddressJSONObjectFilter) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse senderAddress(String senderAddress) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse messageSubject(String messageSubject) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The subject to use for the e-mail message.")
  ...
  public EmailOtpDeliveryMechanismResponse messageTextBeforeOTP(String messageTextBeforeOTP) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse messageTextAfterOTP(String messageTextAfterOTP) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EmailOtpDeliveryMechanismResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EmailOtpDeliveryMechanismResponse instance itself
   */
  public EmailOtpDeliveryMechanismResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmailOtpDeliveryMechanismResponse emailOtpDeliveryMechanismResponse = (EmailOtpDeliveryMechanismResponse) o;
    return Objects.equals(this.id, emailOtpDeliveryMechanismResponse.id) &&
        Objects.equals(this.description, emailOtpDeliveryMechanismResponse.description) &&
        Objects.equals(this.schemas, emailOtpDeliveryMechanismResponse.schemas) &&
        Objects.equals(this.emailAddressAttributeType, emailOtpDeliveryMechanismResponse.emailAddressAttributeType) &&
        Objects.equals(this.emailAddressJSONField, emailOtpDeliveryMechanismResponse.emailAddressJSONField) &&
        Objects.equals(this.emailAddressJSONObjectFilter, emailOtpDeliveryMechanismResponse.emailAddressJSONObjectFilter) &&
        Objects.equals(this.senderAddress, emailOtpDeliveryMechanismResponse.senderAddress) &&
        Objects.equals(this.messageSubject, emailOtpDeliveryMechanismResponse.messageSubject) &&
        Objects.equals(this.messageTextBeforeOTP, emailOtpDeliveryMechanismResponse.messageTextBeforeOTP) &&
        Objects.equals(this.messageTextAfterOTP, emailOtpDeliveryMechanismResponse.messageTextAfterOTP) &&
        Objects.equals(this.enabled, emailOtpDeliveryMechanismResponse.enabled) &&
        Objects.equals(this.meta, emailOtpDeliveryMechanismResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, emailOtpDeliveryMechanismResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, emailOtpDeliveryMechanismResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, emailAddressAttributeType, emailAddressJSONField, emailAddressJSONObjectFilter, senderAddress, messageSubject, messageTextBeforeOTP, messageTextAfterOTP, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EmailOtpDeliveryMechanismResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("emailAddressAttributeType");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailOtpDeliveryMechanismResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailOtpDeliveryMechanismResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailOtpDeliveryMechanismResponse is not found in the empty JSON string", EmailOtpDeliveryMechanismResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EmailOtpDeliveryMechanismResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("emailAddressAttributeType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailOtpDeliveryMechanismResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailOtpDeliveryMechanismResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailOtpDeliveryMechanismResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailOtpDeliveryMechanismResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailOtpDeliveryMechanismResponse>() {
           @Override
           public void write(JsonWriter out, EmailOtpDeliveryMechanismResponse value) throws IOException {
           ...
           @Override
           public EmailOtpDeliveryMechanismResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmailOtpDeliveryMechanismResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmailOtpDeliveryMechanismResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailOtpDeliveryMechanismResponse
  * @throws IOException if the JSON string is invalid with respect to EmailOtpDeliveryMechanismResponse
  */
  public static EmailOtpDeliveryMechanismResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailOtpDeliveryMechanismResponse.class);
  }

 /**
  * Convert an instance of EmailOtpDeliveryMechanismResponse to an JSON string
  *
  * @return JSON string
  */
