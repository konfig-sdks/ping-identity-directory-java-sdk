...
public class SoftDeletePolicyShared {
  ...
  public SoftDeletePolicyShared() {
  }

  public SoftDeletePolicyShared description(String description) {
  ...
  **/
  ...
  public SoftDeletePolicyShared schemas(List<EnumsoftDeletePolicySchemaUrn> schemas) {
  ...
  public SoftDeletePolicyShared addSchemasItem(EnumsoftDeletePolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public SoftDeletePolicyShared autoSoftDeleteConnectionCriteria(String autoSoftDeleteConnectionCriteria) {
  ...
  **/
  ...
  public SoftDeletePolicyShared autoSoftDeleteRequestCriteria(String autoSoftDeleteRequestCriteria) {
  ...
  **/
  ...
  public SoftDeletePolicyShared softDeleteRetentionTime(String softDeleteRetentionTime) {
  ...
  **/
  ...
  public SoftDeletePolicyShared softDeleteRetainNumberOfEntries(Integer softDeleteRetainNumberOfEntries) {
  ...
  **/
   ...
   * @return the SoftDeletePolicyShared instance itself
   */
  public SoftDeletePolicyShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SoftDeletePolicyShared softDeletePolicyShared = (SoftDeletePolicyShared) o;
    return Objects.equals(this.description, softDeletePolicyShared.description) &&
        Objects.equals(this.schemas, softDeletePolicyShared.schemas) &&
        Objects.equals(this.autoSoftDeleteConnectionCriteria, softDeletePolicyShared.autoSoftDeleteConnectionCriteria) &&
        Objects.equals(this.autoSoftDeleteRequestCriteria, softDeletePolicyShared.autoSoftDeleteRequestCriteria) &&
        Objects.equals(this.softDeleteRetentionTime, softDeletePolicyShared.softDeleteRetentionTime) &&
        Objects.equals(this.softDeleteRetainNumberOfEntries, softDeletePolicyShared.softDeleteRetainNumberOfEntries)&&
        Objects.equals(this.additionalProperties, softDeletePolicyShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, autoSoftDeleteConnectionCriteria, autoSoftDeleteRequestCriteria, softDeleteRetentionTime, softDeleteRetainNumberOfEntries, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SoftDeletePolicyShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SoftDeletePolicyShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SoftDeletePolicyShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SoftDeletePolicyShared is not found in the empty JSON string", SoftDeletePolicyShared.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SoftDeletePolicyShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SoftDeletePolicyShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SoftDeletePolicyShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SoftDeletePolicyShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SoftDeletePolicyShared>() {
           @Override
           public void write(JsonWriter out, SoftDeletePolicyShared value) throws IOException {
           ...
           @Override
           public SoftDeletePolicyShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SoftDeletePolicyShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SoftDeletePolicyShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SoftDeletePolicyShared
  * @throws IOException if the JSON string is invalid with respect to SoftDeletePolicyShared
  */
  public static SoftDeletePolicyShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SoftDeletePolicyShared.class);
  }

 /**
  * Convert an instance of SoftDeletePolicyShared to an JSON string
  *
  * @return JSON string
  */
