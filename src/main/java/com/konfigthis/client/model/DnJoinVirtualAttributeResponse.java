...
public class DnJoinVirtualAttributeResponse {
  ...
  public DnJoinVirtualAttributeResponse() {
  }

  public DnJoinVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse schemas(List<EnumdnJoinVirtualAttributeSchemaUrn> schemas) {
  ...
  public DnJoinVirtualAttributeResponse addSchemasItem(EnumdnJoinVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinDNAttribute(String joinDNAttribute) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinBaseDNType(EnumvirtualAttributeJoinBaseDNTypeProp joinBaseDNType) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinCustomBaseDN(String joinCustomBaseDN) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinScope(EnumvirtualAttributeJoinScopeProp joinScope) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinSizeLimit(Integer joinSizeLimit) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinFilter(String joinFilter) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse joinAttribute(List<String> joinAttribute) {
  ...
  public DnJoinVirtualAttributeResponse addJoinAttributeItem(String joinAttributeItem) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public DnJoinVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public DnJoinVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse filter(List<String> filter) {
  ...
  public DnJoinVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public DnJoinVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DnJoinVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DnJoinVirtualAttributeResponse instance itself
   */
  public DnJoinVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DnJoinVirtualAttributeResponse dnJoinVirtualAttributeResponse = (DnJoinVirtualAttributeResponse) o;
    return Objects.equals(this.id, dnJoinVirtualAttributeResponse.id) &&
        Objects.equals(this.description, dnJoinVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, dnJoinVirtualAttributeResponse.schemas) &&
        Objects.equals(this.joinDNAttribute, dnJoinVirtualAttributeResponse.joinDNAttribute) &&
        Objects.equals(this.joinBaseDNType, dnJoinVirtualAttributeResponse.joinBaseDNType) &&
        Objects.equals(this.joinCustomBaseDN, dnJoinVirtualAttributeResponse.joinCustomBaseDN) &&
        Objects.equals(this.joinScope, dnJoinVirtualAttributeResponse.joinScope) &&
        Objects.equals(this.joinSizeLimit, dnJoinVirtualAttributeResponse.joinSizeLimit) &&
        Objects.equals(this.joinFilter, dnJoinVirtualAttributeResponse.joinFilter) &&
        Objects.equals(this.joinAttribute, dnJoinVirtualAttributeResponse.joinAttribute) &&
        Objects.equals(this.enabled, dnJoinVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, dnJoinVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, dnJoinVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, dnJoinVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, dnJoinVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, dnJoinVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, dnJoinVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, dnJoinVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, dnJoinVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, dnJoinVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, dnJoinVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, dnJoinVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, dnJoinVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, dnJoinVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class DnJoinVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DnJoinVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DnJoinVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DnJoinVirtualAttributeResponse is not found in the empty JSON string", DnJoinVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DnJoinVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DnJoinVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DnJoinVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DnJoinVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DnJoinVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DnJoinVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, DnJoinVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public DnJoinVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DnJoinVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DnJoinVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DnJoinVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to DnJoinVirtualAttributeResponse
  */
  public static DnJoinVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DnJoinVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of DnJoinVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
