...
public class AddExpiredPasswordDataSecurityAuditorRequest {
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest() {
  }

  public AddExpiredPasswordDataSecurityAuditorRequest auditorName(String auditorName) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest schemas(List<EnumexpiredPasswordDataSecurityAuditorSchemaUrn> schemas) {
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest addSchemasItem(EnumexpiredPasswordDataSecurityAuditorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest reportFile(String reportFile) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest includeAttribute(List<String> includeAttribute) {
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest addIncludeAttributeItem(String includeAttributeItem) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest passwordEvaluationAge(String passwordEvaluationAge) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest auditBackend(List<String> auditBackend) {
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest addAuditBackendItem(String auditBackendItem) {
  ...
  **/
  ...
  public AddExpiredPasswordDataSecurityAuditorRequest auditSeverity(EnumdataSecurityAuditorAuditSeverityProp auditSeverity) {
  ...
  **/
   ...
   * @return the AddExpiredPasswordDataSecurityAuditorRequest instance itself
   */
  public AddExpiredPasswordDataSecurityAuditorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddExpiredPasswordDataSecurityAuditorRequest addExpiredPasswordDataSecurityAuditorRequest = (AddExpiredPasswordDataSecurityAuditorRequest) o;
    return Objects.equals(this.auditorName, addExpiredPasswordDataSecurityAuditorRequest.auditorName) &&
        Objects.equals(this.schemas, addExpiredPasswordDataSecurityAuditorRequest.schemas) &&
        Objects.equals(this.reportFile, addExpiredPasswordDataSecurityAuditorRequest.reportFile) &&
        Objects.equals(this.includeAttribute, addExpiredPasswordDataSecurityAuditorRequest.includeAttribute) &&
        Objects.equals(this.passwordEvaluationAge, addExpiredPasswordDataSecurityAuditorRequest.passwordEvaluationAge) &&
        Objects.equals(this.enabled, addExpiredPasswordDataSecurityAuditorRequest.enabled) &&
        Objects.equals(this.auditBackend, addExpiredPasswordDataSecurityAuditorRequest.auditBackend) &&
        Objects.equals(this.auditSeverity, addExpiredPasswordDataSecurityAuditorRequest.auditSeverity)&&
        Objects.equals(this.additionalProperties, addExpiredPasswordDataSecurityAuditorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(auditorName, schemas, reportFile, includeAttribute, passwordEvaluationAge, enabled, auditBackend, auditSeverity, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddExpiredPasswordDataSecurityAuditorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddExpiredPasswordDataSecurityAuditorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddExpiredPasswordDataSecurityAuditorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddExpiredPasswordDataSecurityAuditorRequest is not found in the empty JSON string", AddExpiredPasswordDataSecurityAuditorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddExpiredPasswordDataSecurityAuditorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddExpiredPasswordDataSecurityAuditorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddExpiredPasswordDataSecurityAuditorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddExpiredPasswordDataSecurityAuditorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddExpiredPasswordDataSecurityAuditorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddExpiredPasswordDataSecurityAuditorRequest>() {
           @Override
           public void write(JsonWriter out, AddExpiredPasswordDataSecurityAuditorRequest value) throws IOException {
           ...
           @Override
           public AddExpiredPasswordDataSecurityAuditorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddExpiredPasswordDataSecurityAuditorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddExpiredPasswordDataSecurityAuditorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddExpiredPasswordDataSecurityAuditorRequest
  * @throws IOException if the JSON string is invalid with respect to AddExpiredPasswordDataSecurityAuditorRequest
  */
  public static AddExpiredPasswordDataSecurityAuditorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddExpiredPasswordDataSecurityAuditorRequest.class);
  }

 /**
  * Convert an instance of AddExpiredPasswordDataSecurityAuditorRequest to an JSON string
  *
  * @return JSON string
  */
