...
public class ThirdPartyAlertHandlerResponse {
  ...
  public ThirdPartyAlertHandlerResponse() {
  }

  public ThirdPartyAlertHandlerResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse schemas(List<EnumthirdPartyAlertHandlerSchemaUrn> schemas) {
  ...
  public ThirdPartyAlertHandlerResponse addSchemasItem(EnumthirdPartyAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyAlertHandlerResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public ThirdPartyAlertHandlerResponse addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public ThirdPartyAlertHandlerResponse addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public ThirdPartyAlertHandlerResponse addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyAlertHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyAlertHandlerResponse instance itself
   */
  public ThirdPartyAlertHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyAlertHandlerResponse thirdPartyAlertHandlerResponse = (ThirdPartyAlertHandlerResponse) o;
    return Objects.equals(this.id, thirdPartyAlertHandlerResponse.id) &&
        Objects.equals(this.description, thirdPartyAlertHandlerResponse.description) &&
        Objects.equals(this.schemas, thirdPartyAlertHandlerResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyAlertHandlerResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyAlertHandlerResponse.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyAlertHandlerResponse.enabled) &&
        Objects.equals(this.asynchronous, thirdPartyAlertHandlerResponse.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, thirdPartyAlertHandlerResponse.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, thirdPartyAlertHandlerResponse.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, thirdPartyAlertHandlerResponse.disabledAlertType) &&
        Objects.equals(this.meta, thirdPartyAlertHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyAlertHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyAlertHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyAlertHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyAlertHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyAlertHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyAlertHandlerResponse is not found in the empty JSON string", ThirdPartyAlertHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyAlertHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyAlertHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyAlertHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyAlertHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyAlertHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyAlertHandlerResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyAlertHandlerResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyAlertHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyAlertHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyAlertHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyAlertHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyAlertHandlerResponse
  */
  public static ThirdPartyAlertHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyAlertHandlerResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyAlertHandlerResponse to an JSON string
  *
  * @return JSON string
  */
