...
public class AddCollectSupportDataRecurringTaskRequest {
  ...
  public AddCollectSupportDataRecurringTaskRequest() {
  }

  public AddCollectSupportDataRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest schemas(List<EnumcollectSupportDataRecurringTaskSchemaUrn> schemas) {
  ...
  public AddCollectSupportDataRecurringTaskRequest addSchemasItem(EnumcollectSupportDataRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest outputDirectory(String outputDirectory) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest encryptionPassphraseFile(String encryptionPassphraseFile) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest includeExpensiveData(Boolean includeExpensiveData) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest includeReplicationStateDump(Boolean includeReplicationStateDump) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest includeBinaryFiles(Boolean includeBinaryFiles) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest includeExtensionSource(Boolean includeExtensionSource) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest useSequentialMode(Boolean useSequentialMode) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest securityLevel(EnumrecurringTaskSecurityLevelProp securityLevel) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest jstackCount(Integer jstackCount) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest reportCount(Integer reportCount) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest reportIntervalSeconds(Integer reportIntervalSeconds) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest logDuration(String logDuration) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest logFileHeadCollectionSize(String logFileHeadCollectionSize) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest logFileTailCollectionSize(String logFileTailCollectionSize) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest comment(String comment) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest retainPreviousSupportDataArchiveCount(Integer retainPreviousSupportDataArchiveCount) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest retainPreviousSupportDataArchiveAge(String retainPreviousSupportDataArchiveAge) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddCollectSupportDataRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddCollectSupportDataRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddCollectSupportDataRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddCollectSupportDataRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddCollectSupportDataRecurringTaskRequest instance itself
   */
  public AddCollectSupportDataRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddCollectSupportDataRecurringTaskRequest addCollectSupportDataRecurringTaskRequest = (AddCollectSupportDataRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addCollectSupportDataRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addCollectSupportDataRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addCollectSupportDataRecurringTaskRequest.schemas) &&
        Objects.equals(this.outputDirectory, addCollectSupportDataRecurringTaskRequest.outputDirectory) &&
        Objects.equals(this.encryptionPassphraseFile, addCollectSupportDataRecurringTaskRequest.encryptionPassphraseFile) &&
        Objects.equals(this.includeExpensiveData, addCollectSupportDataRecurringTaskRequest.includeExpensiveData) &&
        Objects.equals(this.includeReplicationStateDump, addCollectSupportDataRecurringTaskRequest.includeReplicationStateDump) &&
        Objects.equals(this.includeBinaryFiles, addCollectSupportDataRecurringTaskRequest.includeBinaryFiles) &&
        Objects.equals(this.includeExtensionSource, addCollectSupportDataRecurringTaskRequest.includeExtensionSource) &&
        Objects.equals(this.useSequentialMode, addCollectSupportDataRecurringTaskRequest.useSequentialMode) &&
        Objects.equals(this.securityLevel, addCollectSupportDataRecurringTaskRequest.securityLevel) &&
        Objects.equals(this.jstackCount, addCollectSupportDataRecurringTaskRequest.jstackCount) &&
        Objects.equals(this.reportCount, addCollectSupportDataRecurringTaskRequest.reportCount) &&
        Objects.equals(this.reportIntervalSeconds, addCollectSupportDataRecurringTaskRequest.reportIntervalSeconds) &&
        Objects.equals(this.logDuration, addCollectSupportDataRecurringTaskRequest.logDuration) &&
        Objects.equals(this.logFileHeadCollectionSize, addCollectSupportDataRecurringTaskRequest.logFileHeadCollectionSize) &&
        Objects.equals(this.logFileTailCollectionSize, addCollectSupportDataRecurringTaskRequest.logFileTailCollectionSize) &&
        Objects.equals(this.comment, addCollectSupportDataRecurringTaskRequest.comment) &&
        Objects.equals(this.retainPreviousSupportDataArchiveCount, addCollectSupportDataRecurringTaskRequest.retainPreviousSupportDataArchiveCount) &&
        Objects.equals(this.retainPreviousSupportDataArchiveAge, addCollectSupportDataRecurringTaskRequest.retainPreviousSupportDataArchiveAge) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addCollectSupportDataRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addCollectSupportDataRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addCollectSupportDataRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addCollectSupportDataRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addCollectSupportDataRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addCollectSupportDataRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addCollectSupportDataRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addCollectSupportDataRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, outputDirectory, encryptionPassphraseFile, includeExpensiveData, includeReplicationStateDump, includeBinaryFiles, includeExtensionSource, useSequentialMode, securityLevel, jstackCount, reportCount, reportIntervalSeconds, logDuration, logFileHeadCollectionSize, logFileTailCollectionSize, comment, retainPreviousSupportDataArchiveCount, retainPreviousSupportDataArchiveAge, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddCollectSupportDataRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCollectSupportDataRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCollectSupportDataRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCollectSupportDataRecurringTaskRequest is not found in the empty JSON string", AddCollectSupportDataRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCollectSupportDataRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCollectSupportDataRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCollectSupportDataRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCollectSupportDataRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCollectSupportDataRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCollectSupportDataRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddCollectSupportDataRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddCollectSupportDataRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddCollectSupportDataRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddCollectSupportDataRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddCollectSupportDataRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddCollectSupportDataRecurringTaskRequest
  */
  public static AddCollectSupportDataRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCollectSupportDataRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddCollectSupportDataRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
