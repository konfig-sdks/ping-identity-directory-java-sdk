...
public class LdifBackendResponseAllOf {
  ...
  private List<EnumldifBackendSchemaUrn> schemas = null;
  ...
  public LdifBackendResponseAllOf() {
  }

  public LdifBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf schemas(List<EnumldifBackendSchemaUrn> schemas) {
  ...
  public LdifBackendResponseAllOf addSchemasItem(EnumldifBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf isPrivateBackend(Boolean isPrivateBackend) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf ldifFile(String ldifFile) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public LdifBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public LdifBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the LdifBackendResponseAllOf instance itself
   */
  public LdifBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdifBackendResponseAllOf ldifBackendResponseAllOf = (LdifBackendResponseAllOf) o;
    return Objects.equals(this.description, ldifBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, ldifBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, ldifBackendResponseAllOf.id) &&
        Objects.equals(this.writabilityMode, ldifBackendResponseAllOf.writabilityMode) &&
        Objects.equals(this.isPrivateBackend, ldifBackendResponseAllOf.isPrivateBackend) &&
        Objects.equals(this.ldifFile, ldifBackendResponseAllOf.ldifFile) &&
        Objects.equals(this.backendID, ldifBackendResponseAllOf.backendID) &&
        Objects.equals(this.enabled, ldifBackendResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, ldifBackendResponseAllOf.baseDN) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, ldifBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, ldifBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, ldifBackendResponseAllOf.backupFilePermissions) &&
        Objects.equals(this.notificationManager, ldifBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, ldifBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, writabilityMode, isPrivateBackend, ldifFile, backendID, enabled, baseDN, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdifBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdifBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdifBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdifBackendResponseAllOf is not found in the empty JSON string", LdifBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdifBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdifBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdifBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdifBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<LdifBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, LdifBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public LdifBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdifBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdifBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdifBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to LdifBackendResponseAllOf
  */
  public static LdifBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdifBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of LdifBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
