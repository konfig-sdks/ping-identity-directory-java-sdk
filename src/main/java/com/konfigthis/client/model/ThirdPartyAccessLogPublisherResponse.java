...
public class ThirdPartyAccessLogPublisherResponse {
  ...
  private List<EnumthirdPartyAccessLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public ThirdPartyAccessLogPublisherResponse() {
  }

  public ThirdPartyAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse schemas(List<EnumthirdPartyAccessLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyAccessLogPublisherResponse addSchemasItem(EnumthirdPartyAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumthirdPartyAccessLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumthirdPartyAccessLogPublisherSchemaUrn> schemas) {
  ...
  public ThirdPartyAccessLogPublisherResponse extensionClass(String extensionClass) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The fully-qualified name of the Java class providing the logic for the Third Party Access Log Publisher.")
  ...
  public ThirdPartyAccessLogPublisherResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyAccessLogPublisherResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The set of arguments used to customize the behavior for the Third Party Access Log Publisher. Each configuration property should be given in the form 'name=value'.")
  ...
  public ThirdPartyAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyAccessLogPublisherResponse instance itself
   */
  public ThirdPartyAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyAccessLogPublisherResponse thirdPartyAccessLogPublisherResponse = (ThirdPartyAccessLogPublisherResponse) o;
    return Objects.equals(this.id, thirdPartyAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, thirdPartyAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, thirdPartyAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyAccessLogPublisherResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyAccessLogPublisherResponse.extensionArgument) &&
        Objects.equals(this.logConnects, thirdPartyAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, thirdPartyAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, thirdPartyAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, thirdPartyAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, thirdPartyAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, thirdPartyAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logSearchEntries, thirdPartyAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, thirdPartyAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, thirdPartyAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, thirdPartyAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, thirdPartyAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, thirdPartyAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, thirdPartyAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, thirdPartyAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, thirdPartyAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, thirdPartyAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, thirdPartyAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, thirdPartyAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, thirdPartyAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, thirdPartyAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyAccessLogPublisherResponse is not found in the empty JSON string", ThirdPartyAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyAccessLogPublisherResponse
  */
  public static ThirdPartyAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
