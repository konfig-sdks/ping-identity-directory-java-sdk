...
public class VaultCipherStreamProviderShared {
  ...
  public VaultCipherStreamProviderShared() {
  }

  public VaultCipherStreamProviderShared description(String description) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared schemas(List<EnumvaultCipherStreamProviderSchemaUrn> schemas) {
  ...
  public VaultCipherStreamProviderShared addSchemasItem(EnumvaultCipherStreamProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultExternalServer(String vaultExternalServer) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultServerBaseURI(List<String> vaultServerBaseURI) {
  ...
  public VaultCipherStreamProviderShared addVaultServerBaseURIItem(String vaultServerBaseURIItem) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultAuthenticationMethod(String vaultAuthenticationMethod) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultSecretPath(String vaultSecretPath) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultSecretFieldName(String vaultSecretFieldName) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared vaultEncryptionMetadataFile(String vaultEncryptionMetadataFile) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared iterationCount(Integer iterationCount) {
  ...
  **/
  ...
  public VaultCipherStreamProviderShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the VaultCipherStreamProviderShared instance itself
   */
  public VaultCipherStreamProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultCipherStreamProviderShared vaultCipherStreamProviderShared = (VaultCipherStreamProviderShared) o;
    return Objects.equals(this.description, vaultCipherStreamProviderShared.description) &&
        Objects.equals(this.schemas, vaultCipherStreamProviderShared.schemas) &&
        Objects.equals(this.vaultExternalServer, vaultCipherStreamProviderShared.vaultExternalServer) &&
        Objects.equals(this.vaultServerBaseURI, vaultCipherStreamProviderShared.vaultServerBaseURI) &&
        Objects.equals(this.vaultAuthenticationMethod, vaultCipherStreamProviderShared.vaultAuthenticationMethod) &&
        Objects.equals(this.vaultSecretPath, vaultCipherStreamProviderShared.vaultSecretPath) &&
        Objects.equals(this.vaultSecretFieldName, vaultCipherStreamProviderShared.vaultSecretFieldName) &&
        Objects.equals(this.vaultEncryptionMetadataFile, vaultCipherStreamProviderShared.vaultEncryptionMetadataFile) &&
        Objects.equals(this.trustStoreFile, vaultCipherStreamProviderShared.trustStoreFile) &&
        Objects.equals(this.trustStorePin, vaultCipherStreamProviderShared.trustStorePin) &&
        Objects.equals(this.trustStoreType, vaultCipherStreamProviderShared.trustStoreType) &&
        Objects.equals(this.iterationCount, vaultCipherStreamProviderShared.iterationCount) &&
        Objects.equals(this.enabled, vaultCipherStreamProviderShared.enabled)&&
        Objects.equals(this.additionalProperties, vaultCipherStreamProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, vaultExternalServer, vaultServerBaseURI, vaultAuthenticationMethod, vaultSecretPath, vaultSecretFieldName, vaultEncryptionMetadataFile, trustStoreFile, trustStorePin, trustStoreType, iterationCount, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultCipherStreamProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultCipherStreamProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultCipherStreamProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultCipherStreamProviderShared is not found in the empty JSON string", VaultCipherStreamProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultCipherStreamProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultCipherStreamProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultCipherStreamProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultCipherStreamProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultCipherStreamProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultCipherStreamProviderShared>() {
           @Override
           public void write(JsonWriter out, VaultCipherStreamProviderShared value) throws IOException {
           ...
           @Override
           public VaultCipherStreamProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultCipherStreamProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultCipherStreamProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultCipherStreamProviderShared
  * @throws IOException if the JSON string is invalid with respect to VaultCipherStreamProviderShared
  */
  public static VaultCipherStreamProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultCipherStreamProviderShared.class);
  }

 /**
  * Convert an instance of VaultCipherStreamProviderShared to an JSON string
  *
  * @return JSON string
  */
