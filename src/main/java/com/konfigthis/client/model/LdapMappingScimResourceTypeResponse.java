...
public class LdapMappingScimResourceTypeResponse {
  ...
  public LdapMappingScimResourceTypeResponse() {
  }

  public LdapMappingScimResourceTypeResponse id(String id) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse description(String description) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse schemas(List<EnumldapMappingScimResourceTypeSchemaUrn> schemas) {
  ...
  public LdapMappingScimResourceTypeResponse addSchemasItem(EnumldapMappingScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse coreSchema(String coreSchema) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse requiredSchemaExtension(List<String> requiredSchemaExtension) {
  ...
  public LdapMappingScimResourceTypeResponse addRequiredSchemaExtensionItem(String requiredSchemaExtensionItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse optionalSchemaExtension(List<String> optionalSchemaExtension) {
  ...
  public LdapMappingScimResourceTypeResponse addOptionalSchemaExtensionItem(String optionalSchemaExtensionItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse endpoint(String endpoint) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public LdapMappingScimResourceTypeResponse addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public LdapMappingScimResourceTypeResponse addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse includeFilter(List<String> includeFilter) {
  ...
  public LdapMappingScimResourceTypeResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public LdapMappingScimResourceTypeResponse addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse createDNPattern(String createDNPattern) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LdapMappingScimResourceTypeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LdapMappingScimResourceTypeResponse instance itself
   */
  public LdapMappingScimResourceTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapMappingScimResourceTypeResponse ldapMappingScimResourceTypeResponse = (LdapMappingScimResourceTypeResponse) o;
    return Objects.equals(this.id, ldapMappingScimResourceTypeResponse.id) &&
        Objects.equals(this.description, ldapMappingScimResourceTypeResponse.description) &&
        Objects.equals(this.schemas, ldapMappingScimResourceTypeResponse.schemas) &&
        Objects.equals(this.coreSchema, ldapMappingScimResourceTypeResponse.coreSchema) &&
        Objects.equals(this.requiredSchemaExtension, ldapMappingScimResourceTypeResponse.requiredSchemaExtension) &&
        Objects.equals(this.optionalSchemaExtension, ldapMappingScimResourceTypeResponse.optionalSchemaExtension) &&
        Objects.equals(this.enabled, ldapMappingScimResourceTypeResponse.enabled) &&
        Objects.equals(this.endpoint, ldapMappingScimResourceTypeResponse.endpoint) &&
        Objects.equals(this.lookthroughLimit, ldapMappingScimResourceTypeResponse.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, ldapMappingScimResourceTypeResponse.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, ldapMappingScimResourceTypeResponse.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, ldapMappingScimResourceTypeResponse.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, ldapMappingScimResourceTypeResponse.includeBaseDN) &&
        Objects.equals(this.includeFilter, ldapMappingScimResourceTypeResponse.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, ldapMappingScimResourceTypeResponse.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, ldapMappingScimResourceTypeResponse.createDNPattern) &&
        Objects.equals(this.meta, ldapMappingScimResourceTypeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, ldapMappingScimResourceTypeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, ldapMappingScimResourceTypeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, coreSchema, requiredSchemaExtension, optionalSchemaExtension, enabled, endpoint, lookthroughLimit, schemaCheckingOption, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, includeBaseDN, includeFilter, includeOperationalAttribute, createDNPattern, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdapMappingScimResourceTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapMappingScimResourceTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapMappingScimResourceTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapMappingScimResourceTypeResponse is not found in the empty JSON string", LdapMappingScimResourceTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LdapMappingScimResourceTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapMappingScimResourceTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapMappingScimResourceTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapMappingScimResourceTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapMappingScimResourceTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapMappingScimResourceTypeResponse>() {
           @Override
           public void write(JsonWriter out, LdapMappingScimResourceTypeResponse value) throws IOException {
           ...
           @Override
           public LdapMappingScimResourceTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapMappingScimResourceTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapMappingScimResourceTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapMappingScimResourceTypeResponse
  * @throws IOException if the JSON string is invalid with respect to LdapMappingScimResourceTypeResponse
  */
  public static LdapMappingScimResourceTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapMappingScimResourceTypeResponse.class);
  }

 /**
  * Convert an instance of LdapMappingScimResourceTypeResponse to an JSON string
  *
  * @return JSON string
  */
