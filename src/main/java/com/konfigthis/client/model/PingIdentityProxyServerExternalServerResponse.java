...
import com.konfigthis.client.model.EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp;
import com.konfigthis.client.model.EnumexternalServerPingIdentityProxyServerConnectionSecurityProp;
import com.konfigthis.client.model.EnumexternalServerVerifyCredentialsMethodProp;
import com.konfigthis.client.model.EnumpingIdentityProxyServerExternalServerSchemaUrn;
...
public class PingIdentityProxyServerExternalServerResponse {
  ...
  private List<EnumpingIdentityProxyServerExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerPingIdentityProxyServerConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp authenticationMethod;
  ...
  public PingIdentityProxyServerExternalServerResponse() {
  }

  public PingIdentityProxyServerExternalServerResponse id(String id) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse description(String description) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse schemas(List<EnumpingIdentityProxyServerExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityProxyServerExternalServerResponse addSchemasItem(EnumpingIdentityProxyServerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumpingIdentityProxyServerExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumpingIdentityProxyServerExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityProxyServerExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse location(String location) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse password(String password) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse connectionSecurity(EnumexternalServerPingIdentityProxyServerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerPingIdentityProxyServerConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerPingIdentityProxyServerConnectionSecurityProp connectionSecurity) {
  ...
  public PingIdentityProxyServerExternalServerResponse authenticationMethod(EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp authenticationMethod) {
  ...
  public PingIdentityProxyServerExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public PingIdentityProxyServerExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PingIdentityProxyServerExternalServerResponse instance itself
   */
  public PingIdentityProxyServerExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingIdentityProxyServerExternalServerResponse pingIdentityProxyServerExternalServerResponse = (PingIdentityProxyServerExternalServerResponse) o;
    return Objects.equals(this.id, pingIdentityProxyServerExternalServerResponse.id) &&
        Objects.equals(this.description, pingIdentityProxyServerExternalServerResponse.description) &&
        Objects.equals(this.schemas, pingIdentityProxyServerExternalServerResponse.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, pingIdentityProxyServerExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, pingIdentityProxyServerExternalServerResponse.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, pingIdentityProxyServerExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, pingIdentityProxyServerExternalServerResponse.serverPort) &&
        Objects.equals(this.location, pingIdentityProxyServerExternalServerResponse.location) &&
        Objects.equals(this.bindDN, pingIdentityProxyServerExternalServerResponse.bindDN) &&
        Objects.equals(this.password, pingIdentityProxyServerExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, pingIdentityProxyServerExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, pingIdentityProxyServerExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, pingIdentityProxyServerExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, pingIdentityProxyServerExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, pingIdentityProxyServerExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, pingIdentityProxyServerExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, pingIdentityProxyServerExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, pingIdentityProxyServerExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, pingIdentityProxyServerExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, pingIdentityProxyServerExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, pingIdentityProxyServerExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, pingIdentityProxyServerExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, pingIdentityProxyServerExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, pingIdentityProxyServerExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, pingIdentityProxyServerExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pingIdentityProxyServerExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pingIdentityProxyServerExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, verifyCredentialsMethod, useAdministrativeOperationControl, serverHostName, serverPort, location, bindDN, password, passphraseProvider, connectionSecurity, authenticationMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PingIdentityProxyServerExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingIdentityProxyServerExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingIdentityProxyServerExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingIdentityProxyServerExternalServerResponse is not found in the empty JSON string", PingIdentityProxyServerExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingIdentityProxyServerExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingIdentityProxyServerExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingIdentityProxyServerExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingIdentityProxyServerExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingIdentityProxyServerExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PingIdentityProxyServerExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, PingIdentityProxyServerExternalServerResponse value) throws IOException {
           ...
           @Override
           public PingIdentityProxyServerExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingIdentityProxyServerExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingIdentityProxyServerExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingIdentityProxyServerExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to PingIdentityProxyServerExternalServerResponse
  */
  public static PingIdentityProxyServerExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingIdentityProxyServerExternalServerResponse.class);
  }

 /**
  * Convert an instance of PingIdentityProxyServerExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
