...
public class AddOpendjExternalServerRequest {
  ...
  public AddOpendjExternalServerRequest() {
  }

  public AddOpendjExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest schemas(List<EnumopendjExternalServerSchemaUrn> schemas) {
  ...
  public AddOpendjExternalServerRequest addSchemasItem(EnumopendjExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest location(String location) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest bindDN(String bindDN) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest password(String password) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest connectionSecurity(EnumexternalServerOpendjConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest authenticationMethod(EnumexternalServerOpendjAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public AddOpendjExternalServerRequest addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public AddOpendjExternalServerRequest abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the AddOpendjExternalServerRequest instance itself
   */
  public AddOpendjExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddOpendjExternalServerRequest addOpendjExternalServerRequest = (AddOpendjExternalServerRequest) o;
    return Objects.equals(this.serverName, addOpendjExternalServerRequest.serverName) &&
        Objects.equals(this.description, addOpendjExternalServerRequest.description) &&
        Objects.equals(this.schemas, addOpendjExternalServerRequest.schemas) &&
        Objects.equals(this.serverHostName, addOpendjExternalServerRequest.serverHostName) &&
        Objects.equals(this.serverPort, addOpendjExternalServerRequest.serverPort) &&
        Objects.equals(this.location, addOpendjExternalServerRequest.location) &&
        Objects.equals(this.bindDN, addOpendjExternalServerRequest.bindDN) &&
        Objects.equals(this.password, addOpendjExternalServerRequest.password) &&
        Objects.equals(this.passphraseProvider, addOpendjExternalServerRequest.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, addOpendjExternalServerRequest.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, addOpendjExternalServerRequest.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, addOpendjExternalServerRequest.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, addOpendjExternalServerRequest.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, addOpendjExternalServerRequest.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, addOpendjExternalServerRequest.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, addOpendjExternalServerRequest.connectTimeout) &&
        Objects.equals(this.maxResponseSize, addOpendjExternalServerRequest.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, addOpendjExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addOpendjExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.initialConnections, addOpendjExternalServerRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addOpendjExternalServerRequest.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, addOpendjExternalServerRequest.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, addOpendjExternalServerRequest.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, addOpendjExternalServerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddOpendjExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddOpendjExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddOpendjExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddOpendjExternalServerRequest is not found in the empty JSON string", AddOpendjExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddOpendjExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddOpendjExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddOpendjExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddOpendjExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddOpendjExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddOpendjExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddOpendjExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddOpendjExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddOpendjExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddOpendjExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddOpendjExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddOpendjExternalServerRequest
  */
  public static AddOpendjExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddOpendjExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddOpendjExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
