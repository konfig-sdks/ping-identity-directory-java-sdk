...
import com.konfigthis.client.model.EnumisMemberOfVirtualAttributeSchemaUrn;
...
import com.konfigthis.client.model.EnumvirtualAttributeRewriteSearchFiltersProp;
...
public class IsMemberOfVirtualAttributeResponse {
  ...
  private List<EnumisMemberOfVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_DIRECT_MEMBERSHIPS_ONLY = "directMembershipsOnly";
  @SerializedName(SERIALIZED_NAME_DIRECT_MEMBERSHIPS_ONLY)
  private Boolean directMembershipsOnly;

  public static final String SERIALIZED_NAME_INCLUDED_GROUP_FILTER = "includedGroupFilter";
  @SerializedName(SERIALIZED_NAME_INCLUDED_GROUP_FILTER)
  private String includedGroupFilter;

  public static final String SERIALIZED_NAME_REWRITE_SEARCH_FILTERS = "rewriteSearchFilters";
  @SerializedName(SERIALIZED_NAME_REWRITE_SEARCH_FILTERS)
  private EnumvirtualAttributeRewriteSearchFiltersProp rewriteSearchFilters;
  ...
  public IsMemberOfVirtualAttributeResponse() {
  }

  public IsMemberOfVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse schemas(List<EnumisMemberOfVirtualAttributeSchemaUrn> schemas) {
  ...
  public IsMemberOfVirtualAttributeResponse addSchemasItem(EnumisMemberOfVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumisMemberOfVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumisMemberOfVirtualAttributeSchemaUrn> schemas) {
  ...
  public IsMemberOfVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse directMembershipsOnly(Boolean directMembershipsOnly) {
    
    
    
    
    this.directMembershipsOnly = directMembershipsOnly;
    return this;
  }
   ...
   * @return directMembershipsOnly
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies whether to only include groups in which the user is directly associated with and the membership maybe modified via the group entry. Groups in which the user's membership is derived dynamically or through nested groups will not be included.")

  public Boolean getDirectMembershipsOnly() {
    return directMembershipsOnly;
  }


  public void setDirectMembershipsOnly(Boolean directMembershipsOnly) {
  ...
  public IsMemberOfVirtualAttributeResponse includedGroupFilter(String includedGroupFilter) {
    
    
    
    
    this.includedGroupFilter = includedGroupFilter;
    return this;
  }
   ...
   * @return includedGroupFilter
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A search filter that will be used to identify which groups should be included in the values of the virtual attribute. With no value defined (which is the default behavior), all groups that contain the target user will be included.")

  public String getIncludedGroupFilter() {
    return includedGroupFilter;
  }


  public void setIncludedGroupFilter(String includedGroupFilter) {
  ...
  public IsMemberOfVirtualAttributeResponse rewriteSearchFilters(EnumvirtualAttributeRewriteSearchFiltersProp rewriteSearchFilters) {
    
    
    
    
    this.rewriteSearchFilters = rewriteSearchFilters;
    return this;
  }

   /**
   * Get rewriteSearchFilters
   * @return rewriteSearchFilters
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public EnumvirtualAttributeRewriteSearchFiltersProp getRewriteSearchFilters() {
    return rewriteSearchFilters;
  }


  public void setRewriteSearchFilters(EnumvirtualAttributeRewriteSearchFiltersProp rewriteSearchFilters) {
  ...
  public IsMemberOfVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public IsMemberOfVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public IsMemberOfVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse filter(List<String> filter) {
  ...
  public IsMemberOfVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public IsMemberOfVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public IsMemberOfVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the IsMemberOfVirtualAttributeResponse instance itself
   */
  public IsMemberOfVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IsMemberOfVirtualAttributeResponse isMemberOfVirtualAttributeResponse = (IsMemberOfVirtualAttributeResponse) o;
    return Objects.equals(this.id, isMemberOfVirtualAttributeResponse.id) &&
        Objects.equals(this.description, isMemberOfVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, isMemberOfVirtualAttributeResponse.schemas) &&
        Objects.equals(this.conflictBehavior, isMemberOfVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, isMemberOfVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.directMembershipsOnly, isMemberOfVirtualAttributeResponse.directMembershipsOnly) &&
        Objects.equals(this.includedGroupFilter, isMemberOfVirtualAttributeResponse.includedGroupFilter) &&
        Objects.equals(this.rewriteSearchFilters, isMemberOfVirtualAttributeResponse.rewriteSearchFilters) &&
        Objects.equals(this.enabled, isMemberOfVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, isMemberOfVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, isMemberOfVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, isMemberOfVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, isMemberOfVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, isMemberOfVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, isMemberOfVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, isMemberOfVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, isMemberOfVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, isMemberOfVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, isMemberOfVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, isMemberOfVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, conflictBehavior, attributeType, directMembershipsOnly, includedGroupFilter, rewriteSearchFilters, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IsMemberOfVirtualAttributeResponse {\n");
    ...
    sb.append("    directMembershipsOnly: ").append(toIndentedString(directMembershipsOnly)).append("\n");
    sb.append("    includedGroupFilter: ").append(toIndentedString(includedGroupFilter)).append("\n");
    sb.append("    rewriteSearchFilters: ").append(toIndentedString(rewriteSearchFilters)).append("\n");
  ...
  static {
    ...
    openapiFields.add("directMembershipsOnly");
    openapiFields.add("includedGroupFilter");
    openapiFields.add("rewriteSearchFilters");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IsMemberOfVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IsMemberOfVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IsMemberOfVirtualAttributeResponse is not found in the empty JSON string", IsMemberOfVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IsMemberOfVirtualAttributeResponse.openapiRequiredFields) {
      ...
      if ((jsonObj.get("includedGroupFilter") != null && !jsonObj.get("includedGroupFilter").isJsonNull()) && !jsonObj.get("includedGroupFilter").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `includedGroupFilter` to be a primitive type in the JSON string but got `%s`", jsonObj.get("includedGroupFilter").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IsMemberOfVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IsMemberOfVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IsMemberOfVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IsMemberOfVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<IsMemberOfVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, IsMemberOfVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public IsMemberOfVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IsMemberOfVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IsMemberOfVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IsMemberOfVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to IsMemberOfVirtualAttributeResponse
  */
  public static IsMemberOfVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IsMemberOfVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of IsMemberOfVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
