...
public class LdapSdkDebugLoggerResponseAllOf {
  ...
  private List<EnumldapSdkDebugLoggerDebugTypeProp> debugType = null;
  ...
  public LdapSdkDebugLoggerResponseAllOf() {
  }

  public LdapSdkDebugLoggerResponseAllOf description(String description) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf schemas(List<EnumldapSdkDebugLoggerSchemaUrn> schemas) {
  ...
  public LdapSdkDebugLoggerResponseAllOf addSchemasItem(EnumldapSdkDebugLoggerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether this LDAP SDK Debug Logger is enabled.")
  ...
  public LdapSdkDebugLoggerResponseAllOf logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The path and base name of the file to use for log files generated by this LDAP SDK Debug Logger. The path may be either absolute or relative to the server root.")
  ...
  public LdapSdkDebugLoggerResponseAllOf debugLevel(EnumldapSdkDebugLoggerDebugLevelProp debugLevel) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf debugType(List<EnumldapSdkDebugLoggerDebugTypeProp> debugType) {
  ...
  public LdapSdkDebugLoggerResponseAllOf addDebugTypeItem(EnumldapSdkDebugLoggerDebugTypeProp debugTypeItem) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf includeStackTrace(Boolean includeStackTrace) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this LDAP SDK Debug Logger.")
  ...
  public LdapSdkDebugLoggerResponseAllOf timeInterval(String timeInterval) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the LDAP SDK Debug Logger will publish records asynchronously.")
  ...
  public LdapSdkDebugLoggerResponseAllOf queueSize(Integer queueSize) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf bufferSize(String bufferSize) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf append(Boolean append) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf rotationPolicy(List<String> rotationPolicy) {
  ...
  public LdapSdkDebugLoggerResponseAllOf addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the LDAP SDK Debug Logger .")
  ...
  public LdapSdkDebugLoggerResponseAllOf rotationListener(List<String> rotationListener) {
  ...
  public LdapSdkDebugLoggerResponseAllOf addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf retentionPolicy(List<String> retentionPolicy) {
  ...
  public LdapSdkDebugLoggerResponseAllOf addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the LDAP SDK Debug Logger .")
  ...
  public LdapSdkDebugLoggerResponseAllOf compressionMechanism(EnumldapSdkDebugLoggerCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf signLog(Boolean signLog) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf timestampPrecision(EnumldapSdkDebugLoggerTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public LdapSdkDebugLoggerResponseAllOf loggingErrorBehavior(EnumldapSdkDebugLoggerLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the LdapSdkDebugLoggerResponseAllOf instance itself
   */
  public LdapSdkDebugLoggerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LdapSdkDebugLoggerResponseAllOf ldapSdkDebugLoggerResponseAllOf = (LdapSdkDebugLoggerResponseAllOf) o;
    return Objects.equals(this.description, ldapSdkDebugLoggerResponseAllOf.description) &&
        Objects.equals(this.schemas, ldapSdkDebugLoggerResponseAllOf.schemas) &&
        Objects.equals(this.enabled, ldapSdkDebugLoggerResponseAllOf.enabled) &&
        Objects.equals(this.logFile, ldapSdkDebugLoggerResponseAllOf.logFile) &&
        Objects.equals(this.debugLevel, ldapSdkDebugLoggerResponseAllOf.debugLevel) &&
        Objects.equals(this.debugType, ldapSdkDebugLoggerResponseAllOf.debugType) &&
        Objects.equals(this.includeStackTrace, ldapSdkDebugLoggerResponseAllOf.includeStackTrace) &&
        Objects.equals(this.logFilePermissions, ldapSdkDebugLoggerResponseAllOf.logFilePermissions) &&
        Objects.equals(this.timeInterval, ldapSdkDebugLoggerResponseAllOf.timeInterval) &&
        Objects.equals(this.autoFlush, ldapSdkDebugLoggerResponseAllOf.autoFlush) &&
        Objects.equals(this.asynchronous, ldapSdkDebugLoggerResponseAllOf.asynchronous) &&
        Objects.equals(this.queueSize, ldapSdkDebugLoggerResponseAllOf.queueSize) &&
        Objects.equals(this.bufferSize, ldapSdkDebugLoggerResponseAllOf.bufferSize) &&
        Objects.equals(this.append, ldapSdkDebugLoggerResponseAllOf.append) &&
        Objects.equals(this.rotationPolicy, ldapSdkDebugLoggerResponseAllOf.rotationPolicy) &&
        Objects.equals(this.rotationListener, ldapSdkDebugLoggerResponseAllOf.rotationListener) &&
        Objects.equals(this.retentionPolicy, ldapSdkDebugLoggerResponseAllOf.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, ldapSdkDebugLoggerResponseAllOf.compressionMechanism) &&
        Objects.equals(this.signLog, ldapSdkDebugLoggerResponseAllOf.signLog) &&
        Objects.equals(this.encryptLog, ldapSdkDebugLoggerResponseAllOf.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, ldapSdkDebugLoggerResponseAllOf.encryptionSettingsDefinitionID) &&
        Objects.equals(this.timestampPrecision, ldapSdkDebugLoggerResponseAllOf.timestampPrecision) &&
        Objects.equals(this.loggingErrorBehavior, ldapSdkDebugLoggerResponseAllOf.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, ldapSdkDebugLoggerResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, enabled, logFile, debugLevel, debugType, includeStackTrace, logFilePermissions, timeInterval, autoFlush, asynchronous, queueSize, bufferSize, append, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, timestampPrecision, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LdapSdkDebugLoggerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LdapSdkDebugLoggerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LdapSdkDebugLoggerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LdapSdkDebugLoggerResponseAllOf is not found in the empty JSON string", LdapSdkDebugLoggerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LdapSdkDebugLoggerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LdapSdkDebugLoggerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LdapSdkDebugLoggerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LdapSdkDebugLoggerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<LdapSdkDebugLoggerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, LdapSdkDebugLoggerResponseAllOf value) throws IOException {
           ...
           @Override
           public LdapSdkDebugLoggerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LdapSdkDebugLoggerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LdapSdkDebugLoggerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LdapSdkDebugLoggerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to LdapSdkDebugLoggerResponseAllOf
  */
  public static LdapSdkDebugLoggerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LdapSdkDebugLoggerResponseAllOf.class);
  }

 /**
  * Convert an instance of LdapSdkDebugLoggerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
