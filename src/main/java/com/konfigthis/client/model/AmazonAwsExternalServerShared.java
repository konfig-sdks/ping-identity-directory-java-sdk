...
public class AmazonAwsExternalServerShared {
  ...
  public AmazonAwsExternalServerShared() {
  }

  public AmazonAwsExternalServerShared description(String description) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared schemas(List<EnumamazonAwsExternalServerSchemaUrn> schemas) {
  ...
  public AmazonAwsExternalServerShared addSchemasItem(EnumamazonAwsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared authenticationMethod(EnumexternalServerAmazonAwsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared awsAccessKeyID(String awsAccessKeyID) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared awsSecretAccessKey(String awsSecretAccessKey) {
  ...
  **/
  ...
  public AmazonAwsExternalServerShared awsRegionName(String awsRegionName) {
  ...
  **/
   ...
   * @return the AmazonAwsExternalServerShared instance itself
   */
  public AmazonAwsExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AmazonAwsExternalServerShared amazonAwsExternalServerShared = (AmazonAwsExternalServerShared) o;
    return Objects.equals(this.description, amazonAwsExternalServerShared.description) &&
        Objects.equals(this.schemas, amazonAwsExternalServerShared.schemas) &&
        Objects.equals(this.httpProxyExternalServer, amazonAwsExternalServerShared.httpProxyExternalServer) &&
        Objects.equals(this.authenticationMethod, amazonAwsExternalServerShared.authenticationMethod) &&
        Objects.equals(this.awsAccessKeyID, amazonAwsExternalServerShared.awsAccessKeyID) &&
        Objects.equals(this.awsSecretAccessKey, amazonAwsExternalServerShared.awsSecretAccessKey) &&
        Objects.equals(this.awsRegionName, amazonAwsExternalServerShared.awsRegionName)&&
        Objects.equals(this.additionalProperties, amazonAwsExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, httpProxyExternalServer, authenticationMethod, awsAccessKeyID, awsSecretAccessKey, awsRegionName, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AmazonAwsExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AmazonAwsExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AmazonAwsExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AmazonAwsExternalServerShared is not found in the empty JSON string", AmazonAwsExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AmazonAwsExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AmazonAwsExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AmazonAwsExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AmazonAwsExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AmazonAwsExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<AmazonAwsExternalServerShared>() {
           @Override
           public void write(JsonWriter out, AmazonAwsExternalServerShared value) throws IOException {
           ...
           @Override
           public AmazonAwsExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AmazonAwsExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AmazonAwsExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AmazonAwsExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to AmazonAwsExternalServerShared
  */
  public static AmazonAwsExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AmazonAwsExternalServerShared.class);
  }

 /**
  * Convert an instance of AmazonAwsExternalServerShared to an JSON string
  *
  * @return JSON string
  */
