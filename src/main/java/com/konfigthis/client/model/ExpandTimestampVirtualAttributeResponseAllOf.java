...
import com.konfigthis.client.model.EnumexpandTimestampVirtualAttributeSchemaUrn;
...
public class ExpandTimestampVirtualAttributeResponseAllOf {
  ...
  private List<EnumexpandTimestampVirtualAttributeSchemaUrn> schemas = null;
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf() {
  }

  public ExpandTimestampVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf schemas(List<EnumexpandTimestampVirtualAttributeSchemaUrn> schemas) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf addSchemasItem(EnumexpandTimestampVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumexpandTimestampVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumexpandTimestampVirtualAttributeSchemaUrn> schemas) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf sourceAttribute(String sourceAttribute) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the source attribute containing the compact timestamp to be expanded.")
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ExpandTimestampVirtualAttributeResponseAllOf instance itself
   */
  public ExpandTimestampVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandTimestampVirtualAttributeResponseAllOf expandTimestampVirtualAttributeResponseAllOf = (ExpandTimestampVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, expandTimestampVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, expandTimestampVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, expandTimestampVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, expandTimestampVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.sourceAttribute, expandTimestampVirtualAttributeResponseAllOf.sourceAttribute) &&
        Objects.equals(this.enabled, expandTimestampVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.attributeType, expandTimestampVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.baseDN, expandTimestampVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, expandTimestampVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, expandTimestampVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, expandTimestampVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, expandTimestampVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, expandTimestampVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, expandTimestampVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, expandTimestampVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, expandTimestampVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, sourceAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandTimestampVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExpandTimestampVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExpandTimestampVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpandTimestampVirtualAttributeResponseAllOf is not found in the empty JSON string", ExpandTimestampVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandTimestampVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandTimestampVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandTimestampVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandTimestampVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandTimestampVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ExpandTimestampVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public ExpandTimestampVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExpandTimestampVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExpandTimestampVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExpandTimestampVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ExpandTimestampVirtualAttributeResponseAllOf
  */
  public static ExpandTimestampVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandTimestampVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of ExpandTimestampVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
