...
public class AddRecurringTaskChainRequest {
  ...
  public AddRecurringTaskChainRequest() {
  }

  public AddRecurringTaskChainRequest chainName(String chainName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Recurring Task Chain")
  ...
  public AddRecurringTaskChainRequest description(String description) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest schemas(List<EnumrecurringTaskChainSchemaUrn> schemas) {
  ...
  public AddRecurringTaskChainRequest addSchemasItem(EnumrecurringTaskChainSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest recurringTask(List<String> recurringTask) {
  ...
  public AddRecurringTaskChainRequest addRecurringTaskItem(String recurringTaskItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest scheduledMonth(List<EnumrecurringTaskChainScheduledMonthProp> scheduledMonth) {
  ...
  public AddRecurringTaskChainRequest addScheduledMonthItem(EnumrecurringTaskChainScheduledMonthProp scheduledMonthItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest scheduledDateSelectionType(EnumrecurringTaskChainScheduledDateSelectionTypeProp scheduledDateSelectionType) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest scheduledDayOfTheWeek(List<EnumrecurringTaskChainScheduledDayOfTheWeekProp> scheduledDayOfTheWeek) {
  ...
  public AddRecurringTaskChainRequest addScheduledDayOfTheWeekItem(EnumrecurringTaskChainScheduledDayOfTheWeekProp scheduledDayOfTheWeekItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest scheduledDayOfTheMonth(List<EnumrecurringTaskChainScheduledDayOfTheMonthProp> scheduledDayOfTheMonth) {
  ...
  public AddRecurringTaskChainRequest addScheduledDayOfTheMonthItem(EnumrecurringTaskChainScheduledDayOfTheMonthProp scheduledDayOfTheMonthItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest scheduledTimeOfDay(List<String> scheduledTimeOfDay) {
  ...
  public AddRecurringTaskChainRequest addScheduledTimeOfDayItem(String scheduledTimeOfDayItem) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest timeZone(String timeZone) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest interruptedByShutdownBehavior(EnumrecurringTaskChainInterruptedByShutdownBehaviorProp interruptedByShutdownBehavior) {
  ...
  **/
  ...
  public AddRecurringTaskChainRequest serverOfflineAtStartTimeBehavior(EnumrecurringTaskChainServerOfflineAtStartTimeBehaviorProp serverOfflineAtStartTimeBehavior) {
  ...
  **/
   ...
   * @return the AddRecurringTaskChainRequest instance itself
   */
  public AddRecurringTaskChainRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddRecurringTaskChainRequest addRecurringTaskChainRequest = (AddRecurringTaskChainRequest) o;
    return Objects.equals(this.chainName, addRecurringTaskChainRequest.chainName) &&
        Objects.equals(this.description, addRecurringTaskChainRequest.description) &&
        Objects.equals(this.schemas, addRecurringTaskChainRequest.schemas) &&
        Objects.equals(this.enabled, addRecurringTaskChainRequest.enabled) &&
        Objects.equals(this.recurringTask, addRecurringTaskChainRequest.recurringTask) &&
        Objects.equals(this.scheduledMonth, addRecurringTaskChainRequest.scheduledMonth) &&
        Objects.equals(this.scheduledDateSelectionType, addRecurringTaskChainRequest.scheduledDateSelectionType) &&
        Objects.equals(this.scheduledDayOfTheWeek, addRecurringTaskChainRequest.scheduledDayOfTheWeek) &&
        Objects.equals(this.scheduledDayOfTheMonth, addRecurringTaskChainRequest.scheduledDayOfTheMonth) &&
        Objects.equals(this.scheduledTimeOfDay, addRecurringTaskChainRequest.scheduledTimeOfDay) &&
        Objects.equals(this.timeZone, addRecurringTaskChainRequest.timeZone) &&
        Objects.equals(this.interruptedByShutdownBehavior, addRecurringTaskChainRequest.interruptedByShutdownBehavior) &&
        Objects.equals(this.serverOfflineAtStartTimeBehavior, addRecurringTaskChainRequest.serverOfflineAtStartTimeBehavior)&&
        Objects.equals(this.additionalProperties, addRecurringTaskChainRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chainName, description, schemas, enabled, recurringTask, scheduledMonth, scheduledDateSelectionType, scheduledDayOfTheWeek, scheduledDayOfTheMonth, scheduledTimeOfDay, timeZone, interruptedByShutdownBehavior, serverOfflineAtStartTimeBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddRecurringTaskChainRequest {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("chainName");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddRecurringTaskChainRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddRecurringTaskChainRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddRecurringTaskChainRequest is not found in the empty JSON string", AddRecurringTaskChainRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddRecurringTaskChainRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("chainName").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddRecurringTaskChainRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddRecurringTaskChainRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddRecurringTaskChainRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddRecurringTaskChainRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddRecurringTaskChainRequest>() {
           @Override
           public void write(JsonWriter out, AddRecurringTaskChainRequest value) throws IOException {
           ...
           @Override
           public AddRecurringTaskChainRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddRecurringTaskChainRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddRecurringTaskChainRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddRecurringTaskChainRequest
  * @throws IOException if the JSON string is invalid with respect to AddRecurringTaskChainRequest
  */
  public static AddRecurringTaskChainRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddRecurringTaskChainRequest.class);
  }

 /**
  * Convert an instance of AddRecurringTaskChainRequest to an JSON string
  *
  * @return JSON string
  */
