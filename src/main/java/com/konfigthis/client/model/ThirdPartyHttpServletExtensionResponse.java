...
public class ThirdPartyHttpServletExtensionResponse {
  ...
  public ThirdPartyHttpServletExtensionResponse() {
  }

  public ThirdPartyHttpServletExtensionResponse id(String id) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse description(String description) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse schemas(List<EnumthirdPartyHttpServletExtensionSchemaUrn> schemas) {
  ...
  public ThirdPartyHttpServletExtensionResponse addSchemasItem(EnumthirdPartyHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyHttpServletExtensionResponse addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse responseHeader(List<String> responseHeader) {
  ...
  public ThirdPartyHttpServletExtensionResponse addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ThirdPartyHttpServletExtensionResponse instance itself
   */
  public ThirdPartyHttpServletExtensionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyHttpServletExtensionResponse thirdPartyHttpServletExtensionResponse = (ThirdPartyHttpServletExtensionResponse) o;
    return Objects.equals(this.id, thirdPartyHttpServletExtensionResponse.id) &&
        Objects.equals(this.description, thirdPartyHttpServletExtensionResponse.description) &&
        Objects.equals(this.schemas, thirdPartyHttpServletExtensionResponse.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyHttpServletExtensionResponse.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyHttpServletExtensionResponse.extensionArgument) &&
        Objects.equals(this.crossOriginPolicy, thirdPartyHttpServletExtensionResponse.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, thirdPartyHttpServletExtensionResponse.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, thirdPartyHttpServletExtensionResponse.correlationIDResponseHeader) &&
        Objects.equals(this.meta, thirdPartyHttpServletExtensionResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, thirdPartyHttpServletExtensionResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, thirdPartyHttpServletExtensionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, extensionClass, extensionArgument, crossOriginPolicy, responseHeader, correlationIDResponseHeader, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyHttpServletExtensionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyHttpServletExtensionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyHttpServletExtensionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyHttpServletExtensionResponse is not found in the empty JSON string", ThirdPartyHttpServletExtensionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyHttpServletExtensionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyHttpServletExtensionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyHttpServletExtensionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyHttpServletExtensionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyHttpServletExtensionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyHttpServletExtensionResponse>() {
           @Override
           public void write(JsonWriter out, ThirdPartyHttpServletExtensionResponse value) throws IOException {
           ...
           @Override
           public ThirdPartyHttpServletExtensionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyHttpServletExtensionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyHttpServletExtensionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyHttpServletExtensionResponse
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyHttpServletExtensionResponse
  */
  public static ThirdPartyHttpServletExtensionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyHttpServletExtensionResponse.class);
  }

 /**
  * Convert an instance of ThirdPartyHttpServletExtensionResponse to an JSON string
  *
  * @return JSON string
  */
