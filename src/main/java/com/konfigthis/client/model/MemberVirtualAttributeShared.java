...
public class MemberVirtualAttributeShared {
  ...
  public MemberVirtualAttributeShared() {
  }

  public MemberVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared schemas(List<EnummemberVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberVirtualAttributeShared addSchemasItem(EnummemberVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared allowRetrievingMembership(Boolean allowRetrievingMembership) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared filter(List<String> filter) {
  ...
  public MemberVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public MemberVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public MemberVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public MemberVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public MemberVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
   ...
   * @return the MemberVirtualAttributeShared instance itself
   */
  public MemberVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MemberVirtualAttributeShared memberVirtualAttributeShared = (MemberVirtualAttributeShared) o;
    return Objects.equals(this.description, memberVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, memberVirtualAttributeShared.schemas) &&
        Objects.equals(this.conflictBehavior, memberVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.allowRetrievingMembership, memberVirtualAttributeShared.allowRetrievingMembership) &&
        Objects.equals(this.filter, memberVirtualAttributeShared.filter) &&
        Objects.equals(this.allowIndexConflicts, memberVirtualAttributeShared.allowIndexConflicts) &&
        Objects.equals(this.enabled, memberVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, memberVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, memberVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, memberVirtualAttributeShared.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, memberVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, memberVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, memberVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, memberVirtualAttributeShared.multipleVirtualAttributeMergeBehavior)&&
        Objects.equals(this.additionalProperties, memberVirtualAttributeShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemberVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemberVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberVirtualAttributeShared is not found in the empty JSON string", MemberVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MemberVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, MemberVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public MemberVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemberVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemberVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to MemberVirtualAttributeShared
  */
  public static MemberVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of MemberVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
