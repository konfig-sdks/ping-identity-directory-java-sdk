...
public class EncryptionSettingsBackendResponseAllOf {
  ...
  private List<EnumencryptionSettingsBackendSchemaUrn> schemas = null;
  ...
  public EncryptionSettingsBackendResponseAllOf() {
  }

  public EncryptionSettingsBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf schemas(List<EnumencryptionSettingsBackendSchemaUrn> schemas) {
  ...
  public EncryptionSettingsBackendResponseAllOf addSchemasItem(EnumencryptionSettingsBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public EncryptionSettingsBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public EncryptionSettingsBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the EncryptionSettingsBackendResponseAllOf instance itself
   */
  public EncryptionSettingsBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EncryptionSettingsBackendResponseAllOf encryptionSettingsBackendResponseAllOf = (EncryptionSettingsBackendResponseAllOf) o;
    return Objects.equals(this.description, encryptionSettingsBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, encryptionSettingsBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, encryptionSettingsBackendResponseAllOf.id) &&
        Objects.equals(this.baseDN, encryptionSettingsBackendResponseAllOf.baseDN) &&
        Objects.equals(this.backendID, encryptionSettingsBackendResponseAllOf.backendID) &&
        Objects.equals(this.enabled, encryptionSettingsBackendResponseAllOf.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, encryptionSettingsBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, encryptionSettingsBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, encryptionSettingsBackendResponseAllOf.backupFilePermissions) &&
        Objects.equals(this.notificationManager, encryptionSettingsBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, encryptionSettingsBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseDN, backendID, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EncryptionSettingsBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EncryptionSettingsBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EncryptionSettingsBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EncryptionSettingsBackendResponseAllOf is not found in the empty JSON string", EncryptionSettingsBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EncryptionSettingsBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EncryptionSettingsBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EncryptionSettingsBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EncryptionSettingsBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<EncryptionSettingsBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, EncryptionSettingsBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public EncryptionSettingsBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EncryptionSettingsBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EncryptionSettingsBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EncryptionSettingsBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to EncryptionSettingsBackendResponseAllOf
  */
  public static EncryptionSettingsBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EncryptionSettingsBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of EncryptionSettingsBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
