...
public class AddAggregatePassThroughAuthenticationHandlerRequest {
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest() {
  }

  public AddAggregatePassThroughAuthenticationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest schemas(List<EnumaggregatePassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest addSchemasItem(EnumaggregatePassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest subordinatePassThroughAuthenticationHandler(List<String> subordinatePassThroughAuthenticationHandler) {
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest addSubordinatePassThroughAuthenticationHandlerItem(String subordinatePassThroughAuthenticationHandlerItem) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest continueOnFailureType(List<EnumpassThroughAuthenticationHandlerContinueOnFailureTypeProp> continueOnFailureType) {
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest addContinueOnFailureTypeItem(EnumpassThroughAuthenticationHandlerContinueOnFailureTypeProp continueOnFailureTypeItem) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddAggregatePassThroughAuthenticationHandlerRequest requestCriteria(String requestCriteria) {
  ...
  **/
   ...
   * @return the AddAggregatePassThroughAuthenticationHandlerRequest instance itself
   */
  public AddAggregatePassThroughAuthenticationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAggregatePassThroughAuthenticationHandlerRequest addAggregatePassThroughAuthenticationHandlerRequest = (AddAggregatePassThroughAuthenticationHandlerRequest) o;
    return Objects.equals(this.handlerName, addAggregatePassThroughAuthenticationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addAggregatePassThroughAuthenticationHandlerRequest.description) &&
        Objects.equals(this.schemas, addAggregatePassThroughAuthenticationHandlerRequest.schemas) &&
        Objects.equals(this.subordinatePassThroughAuthenticationHandler, addAggregatePassThroughAuthenticationHandlerRequest.subordinatePassThroughAuthenticationHandler) &&
        Objects.equals(this.continueOnFailureType, addAggregatePassThroughAuthenticationHandlerRequest.continueOnFailureType) &&
        Objects.equals(this.includedLocalEntryBaseDN, addAggregatePassThroughAuthenticationHandlerRequest.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, addAggregatePassThroughAuthenticationHandlerRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addAggregatePassThroughAuthenticationHandlerRequest.requestCriteria)&&
        Objects.equals(this.additionalProperties, addAggregatePassThroughAuthenticationHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, subordinatePassThroughAuthenticationHandler, continueOnFailureType, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAggregatePassThroughAuthenticationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAggregatePassThroughAuthenticationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAggregatePassThroughAuthenticationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAggregatePassThroughAuthenticationHandlerRequest is not found in the empty JSON string", AddAggregatePassThroughAuthenticationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAggregatePassThroughAuthenticationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAggregatePassThroughAuthenticationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAggregatePassThroughAuthenticationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAggregatePassThroughAuthenticationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAggregatePassThroughAuthenticationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAggregatePassThroughAuthenticationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddAggregatePassThroughAuthenticationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddAggregatePassThroughAuthenticationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAggregatePassThroughAuthenticationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAggregatePassThroughAuthenticationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAggregatePassThroughAuthenticationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddAggregatePassThroughAuthenticationHandlerRequest
  */
  public static AddAggregatePassThroughAuthenticationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAggregatePassThroughAuthenticationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddAggregatePassThroughAuthenticationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
