...
public class AddGroovyScriptedPasswordValidatorRequest {
  ...
  public AddGroovyScriptedPasswordValidatorRequest() {
  }

  public AddGroovyScriptedPasswordValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest schemas(List<EnumgroovyScriptedPasswordValidatorSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedPasswordValidatorRequest addSchemasItem(EnumgroovyScriptedPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedPasswordValidatorRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public AddGroovyScriptedPasswordValidatorRequest validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedPasswordValidatorRequest instance itself
   */
  public AddGroovyScriptedPasswordValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedPasswordValidatorRequest addGroovyScriptedPasswordValidatorRequest = (AddGroovyScriptedPasswordValidatorRequest) o;
    return Objects.equals(this.validatorName, addGroovyScriptedPasswordValidatorRequest.validatorName) &&
        Objects.equals(this.description, addGroovyScriptedPasswordValidatorRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedPasswordValidatorRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedPasswordValidatorRequest.scriptClass) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedPasswordValidatorRequest.scriptArgument) &&
        Objects.equals(this.enabled, addGroovyScriptedPasswordValidatorRequest.enabled) &&
        Objects.equals(this.validatorRequirementDescription, addGroovyScriptedPasswordValidatorRequest.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, addGroovyScriptedPasswordValidatorRequest.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedPasswordValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, scriptClass, scriptArgument, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedPasswordValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedPasswordValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedPasswordValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedPasswordValidatorRequest is not found in the empty JSON string", AddGroovyScriptedPasswordValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedPasswordValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedPasswordValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedPasswordValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedPasswordValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedPasswordValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedPasswordValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedPasswordValidatorRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedPasswordValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedPasswordValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedPasswordValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedPasswordValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedPasswordValidatorRequest
  */
  public static AddGroovyScriptedPasswordValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedPasswordValidatorRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedPasswordValidatorRequest to an JSON string
  *
  * @return JSON string
  */
