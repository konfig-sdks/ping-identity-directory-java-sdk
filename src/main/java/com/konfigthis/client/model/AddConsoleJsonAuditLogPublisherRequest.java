...
public class AddConsoleJsonAuditLogPublisherRequest {
  ...
  public AddConsoleJsonAuditLogPublisherRequest() {
  }

  public AddConsoleJsonAuditLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest schemas(List<EnumconsoleJsonAuditLogPublisherSchemaUrn> schemas) {
  ...
  public AddConsoleJsonAuditLogPublisherRequest addSchemasItem(EnumconsoleJsonAuditLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest useReversibleForm(Boolean useReversibleForm) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest softDeleteEntryAuditBehavior(EnumlogPublisherConsoleJsonAuditSoftDeleteEntryAuditBehaviorProp softDeleteEntryAuditBehavior) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeOperationPurposeRequestControl(Boolean includeOperationPurposeRequestControl) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeIntermediateClientRequestControl(Boolean includeIntermediateClientRequestControl) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest obscureAttribute(List<String> obscureAttribute) {
  ...
  public AddConsoleJsonAuditLogPublisherRequest addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest excludeAttribute(List<String> excludeAttribute) {
  ...
  public AddConsoleJsonAuditLogPublisherRequest addExcludeAttributeItem(String excludeAttributeItem) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public AddConsoleJsonAuditLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddConsoleJsonAuditLogPublisherRequest instance itself
   */
  public AddConsoleJsonAuditLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddConsoleJsonAuditLogPublisherRequest addConsoleJsonAuditLogPublisherRequest = (AddConsoleJsonAuditLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addConsoleJsonAuditLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addConsoleJsonAuditLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addConsoleJsonAuditLogPublisherRequest.schemas) &&
        Objects.equals(this.enabled, addConsoleJsonAuditLogPublisherRequest.enabled) &&
        Objects.equals(this.outputLocation, addConsoleJsonAuditLogPublisherRequest.outputLocation) &&
        Objects.equals(this.writeMultiLineMessages, addConsoleJsonAuditLogPublisherRequest.writeMultiLineMessages) &&
        Objects.equals(this.useReversibleForm, addConsoleJsonAuditLogPublisherRequest.useReversibleForm) &&
        Objects.equals(this.softDeleteEntryAuditBehavior, addConsoleJsonAuditLogPublisherRequest.softDeleteEntryAuditBehavior) &&
        Objects.equals(this.includeOperationPurposeRequestControl, addConsoleJsonAuditLogPublisherRequest.includeOperationPurposeRequestControl) &&
        Objects.equals(this.includeIntermediateClientRequestControl, addConsoleJsonAuditLogPublisherRequest.includeIntermediateClientRequestControl) &&
        Objects.equals(this.obscureAttribute, addConsoleJsonAuditLogPublisherRequest.obscureAttribute) &&
        Objects.equals(this.excludeAttribute, addConsoleJsonAuditLogPublisherRequest.excludeAttribute) &&
        Objects.equals(this.suppressInternalOperations, addConsoleJsonAuditLogPublisherRequest.suppressInternalOperations) &&
        Objects.equals(this.includeProductName, addConsoleJsonAuditLogPublisherRequest.includeProductName) &&
        Objects.equals(this.includeInstanceName, addConsoleJsonAuditLogPublisherRequest.includeInstanceName) &&
        Objects.equals(this.includeStartupID, addConsoleJsonAuditLogPublisherRequest.includeStartupID) &&
        Objects.equals(this.includeThreadID, addConsoleJsonAuditLogPublisherRequest.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, addConsoleJsonAuditLogPublisherRequest.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, addConsoleJsonAuditLogPublisherRequest.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestControls, addConsoleJsonAuditLogPublisherRequest.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, addConsoleJsonAuditLogPublisherRequest.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, addConsoleJsonAuditLogPublisherRequest.includeReplicationChangeID) &&
        Objects.equals(this.logSecurityNegotiation, addConsoleJsonAuditLogPublisherRequest.logSecurityNegotiation) &&
        Objects.equals(this.suppressReplicationOperations, addConsoleJsonAuditLogPublisherRequest.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, addConsoleJsonAuditLogPublisherRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addConsoleJsonAuditLogPublisherRequest.requestCriteria) &&
        Objects.equals(this.resultCriteria, addConsoleJsonAuditLogPublisherRequest.resultCriteria) &&
        Objects.equals(this.loggingErrorBehavior, addConsoleJsonAuditLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addConsoleJsonAuditLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, enabled, outputLocation, writeMultiLineMessages, useReversibleForm, softDeleteEntryAuditBehavior, includeOperationPurposeRequestControl, includeIntermediateClientRequestControl, obscureAttribute, excludeAttribute, suppressInternalOperations, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterDN, includeRequesterIPAddress, includeRequestControls, includeResponseControls, includeReplicationChangeID, logSecurityNegotiation, suppressReplicationOperations, connectionCriteria, requestCriteria, resultCriteria, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddConsoleJsonAuditLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddConsoleJsonAuditLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddConsoleJsonAuditLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddConsoleJsonAuditLogPublisherRequest is not found in the empty JSON string", AddConsoleJsonAuditLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddConsoleJsonAuditLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddConsoleJsonAuditLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddConsoleJsonAuditLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddConsoleJsonAuditLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddConsoleJsonAuditLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddConsoleJsonAuditLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddConsoleJsonAuditLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddConsoleJsonAuditLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddConsoleJsonAuditLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddConsoleJsonAuditLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddConsoleJsonAuditLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddConsoleJsonAuditLogPublisherRequest
  */
  public static AddConsoleJsonAuditLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddConsoleJsonAuditLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddConsoleJsonAuditLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
