...
public class AddPingIdentityDsExternalServerRequest {
  ...
  public AddPingIdentityDsExternalServerRequest() {
  }

  public AddPingIdentityDsExternalServerRequest serverName(String serverName) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest description(String description) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest schemas(List<EnumpingIdentityDsExternalServerSchemaUrn> schemas) {
  ...
  public AddPingIdentityDsExternalServerRequest addSchemasItem(EnumpingIdentityDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest location(String location) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest bindDN(String bindDN) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest password(String password) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest connectionSecurity(EnumexternalServerPingIdentityDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest authenticationMethod(EnumexternalServerPingIdentityDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public AddPingIdentityDsExternalServerRequest addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public AddPingIdentityDsExternalServerRequest abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the AddPingIdentityDsExternalServerRequest instance itself
   */
  public AddPingIdentityDsExternalServerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPingIdentityDsExternalServerRequest addPingIdentityDsExternalServerRequest = (AddPingIdentityDsExternalServerRequest) o;
    return Objects.equals(this.serverName, addPingIdentityDsExternalServerRequest.serverName) &&
        Objects.equals(this.description, addPingIdentityDsExternalServerRequest.description) &&
        Objects.equals(this.schemas, addPingIdentityDsExternalServerRequest.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, addPingIdentityDsExternalServerRequest.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, addPingIdentityDsExternalServerRequest.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, addPingIdentityDsExternalServerRequest.serverHostName) &&
        Objects.equals(this.serverPort, addPingIdentityDsExternalServerRequest.serverPort) &&
        Objects.equals(this.location, addPingIdentityDsExternalServerRequest.location) &&
        Objects.equals(this.bindDN, addPingIdentityDsExternalServerRequest.bindDN) &&
        Objects.equals(this.password, addPingIdentityDsExternalServerRequest.password) &&
        Objects.equals(this.passphraseProvider, addPingIdentityDsExternalServerRequest.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, addPingIdentityDsExternalServerRequest.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, addPingIdentityDsExternalServerRequest.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, addPingIdentityDsExternalServerRequest.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, addPingIdentityDsExternalServerRequest.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, addPingIdentityDsExternalServerRequest.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, addPingIdentityDsExternalServerRequest.connectTimeout) &&
        Objects.equals(this.maxResponseSize, addPingIdentityDsExternalServerRequest.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, addPingIdentityDsExternalServerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addPingIdentityDsExternalServerRequest.trustManagerProvider) &&
        Objects.equals(this.initialConnections, addPingIdentityDsExternalServerRequest.initialConnections) &&
        Objects.equals(this.maxConnections, addPingIdentityDsExternalServerRequest.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, addPingIdentityDsExternalServerRequest.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, addPingIdentityDsExternalServerRequest.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, addPingIdentityDsExternalServerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddPingIdentityDsExternalServerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPingIdentityDsExternalServerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPingIdentityDsExternalServerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPingIdentityDsExternalServerRequest is not found in the empty JSON string", AddPingIdentityDsExternalServerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPingIdentityDsExternalServerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPingIdentityDsExternalServerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPingIdentityDsExternalServerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPingIdentityDsExternalServerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPingIdentityDsExternalServerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPingIdentityDsExternalServerRequest>() {
           @Override
           public void write(JsonWriter out, AddPingIdentityDsExternalServerRequest value) throws IOException {
           ...
           @Override
           public AddPingIdentityDsExternalServerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPingIdentityDsExternalServerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPingIdentityDsExternalServerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPingIdentityDsExternalServerRequest
  * @throws IOException if the JSON string is invalid with respect to AddPingIdentityDsExternalServerRequest
  */
  public static AddPingIdentityDsExternalServerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPingIdentityDsExternalServerRequest.class);
  }

 /**
  * Convert an instance of AddPingIdentityDsExternalServerRequest to an JSON string
  *
  * @return JSON string
  */
