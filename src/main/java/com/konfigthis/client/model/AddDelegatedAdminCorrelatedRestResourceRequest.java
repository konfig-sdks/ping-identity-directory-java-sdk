...
public class AddDelegatedAdminCorrelatedRestResourceRequest {
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest() {
  }

  public AddDelegatedAdminCorrelatedRestResourceRequest resourceName(String resourceName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Delegated Admin Correlated REST Resource")
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest schemas(List<EnumdelegatedAdminCorrelatedRestResourceSchemaUrn> schemas) {
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest addSchemasItem(EnumdelegatedAdminCorrelatedRestResourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest displayName(String displayName) {
  ...
  **/
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest correlatedRESTResource(String correlatedRESTResource) {
  ...
  **/
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest primaryRESTResourceCorrelationAttribute(String primaryRESTResourceCorrelationAttribute) {
  ...
  **/
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest secondaryRESTResourceCorrelationAttribute(String secondaryRESTResourceCorrelationAttribute) {
  ...
  **/
  ...
  public AddDelegatedAdminCorrelatedRestResourceRequest useSecondaryValueForLinking(Boolean useSecondaryValueForLinking) {
  ...
  **/
   ...
   * @return the AddDelegatedAdminCorrelatedRestResourceRequest instance itself
   */
  public AddDelegatedAdminCorrelatedRestResourceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddDelegatedAdminCorrelatedRestResourceRequest addDelegatedAdminCorrelatedRestResourceRequest = (AddDelegatedAdminCorrelatedRestResourceRequest) o;
    return Objects.equals(this.resourceName, addDelegatedAdminCorrelatedRestResourceRequest.resourceName) &&
        Objects.equals(this.schemas, addDelegatedAdminCorrelatedRestResourceRequest.schemas) &&
        Objects.equals(this.displayName, addDelegatedAdminCorrelatedRestResourceRequest.displayName) &&
        Objects.equals(this.correlatedRESTResource, addDelegatedAdminCorrelatedRestResourceRequest.correlatedRESTResource) &&
        Objects.equals(this.primaryRESTResourceCorrelationAttribute, addDelegatedAdminCorrelatedRestResourceRequest.primaryRESTResourceCorrelationAttribute) &&
        Objects.equals(this.secondaryRESTResourceCorrelationAttribute, addDelegatedAdminCorrelatedRestResourceRequest.secondaryRESTResourceCorrelationAttribute) &&
        Objects.equals(this.useSecondaryValueForLinking, addDelegatedAdminCorrelatedRestResourceRequest.useSecondaryValueForLinking)&&
        Objects.equals(this.additionalProperties, addDelegatedAdminCorrelatedRestResourceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(resourceName, schemas, displayName, correlatedRESTResource, primaryRESTResourceCorrelationAttribute, secondaryRESTResourceCorrelationAttribute, useSecondaryValueForLinking, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddDelegatedAdminCorrelatedRestResourceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddDelegatedAdminCorrelatedRestResourceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddDelegatedAdminCorrelatedRestResourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddDelegatedAdminCorrelatedRestResourceRequest is not found in the empty JSON string", AddDelegatedAdminCorrelatedRestResourceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddDelegatedAdminCorrelatedRestResourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddDelegatedAdminCorrelatedRestResourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddDelegatedAdminCorrelatedRestResourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddDelegatedAdminCorrelatedRestResourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddDelegatedAdminCorrelatedRestResourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddDelegatedAdminCorrelatedRestResourceRequest>() {
           @Override
           public void write(JsonWriter out, AddDelegatedAdminCorrelatedRestResourceRequest value) throws IOException {
           ...
           @Override
           public AddDelegatedAdminCorrelatedRestResourceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddDelegatedAdminCorrelatedRestResourceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddDelegatedAdminCorrelatedRestResourceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddDelegatedAdminCorrelatedRestResourceRequest
  * @throws IOException if the JSON string is invalid with respect to AddDelegatedAdminCorrelatedRestResourceRequest
  */
  public static AddDelegatedAdminCorrelatedRestResourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddDelegatedAdminCorrelatedRestResourceRequest.class);
  }

 /**
  * Convert an instance of AddDelegatedAdminCorrelatedRestResourceRequest to an JSON string
  *
  * @return JSON string
  */
