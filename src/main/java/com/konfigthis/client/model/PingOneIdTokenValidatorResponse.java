...
public class PingOneIdTokenValidatorResponse {
  ...
  public PingOneIdTokenValidatorResponse() {
  }

  public PingOneIdTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse schemas(List<EnumpingOneIdTokenValidatorSchemaUrn> schemas) {
  ...
  public PingOneIdTokenValidatorResponse addSchemasItem(EnumpingOneIdTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse issuerURL(String issuerURL) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse openIDConnectProvider(String openIDConnectProvider) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies HTTPS connection settings for the PingOne OpenID Connect provider.")
  ...
  public PingOneIdTokenValidatorResponse openIDConnectMetadataCacheDuration(String openIDConnectMetadataCacheDuration) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse jwksCacheDuration(String jwksCacheDuration) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PingOneIdTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PingOneIdTokenValidatorResponse instance itself
   */
  public PingOneIdTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingOneIdTokenValidatorResponse pingOneIdTokenValidatorResponse = (PingOneIdTokenValidatorResponse) o;
    return Objects.equals(this.id, pingOneIdTokenValidatorResponse.id) &&
        Objects.equals(this.description, pingOneIdTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, pingOneIdTokenValidatorResponse.schemas) &&
        Objects.equals(this.issuerURL, pingOneIdTokenValidatorResponse.issuerURL) &&
        Objects.equals(this.openIDConnectProvider, pingOneIdTokenValidatorResponse.openIDConnectProvider) &&
        Objects.equals(this.openIDConnectMetadataCacheDuration, pingOneIdTokenValidatorResponse.openIDConnectMetadataCacheDuration) &&
        Objects.equals(this.enabled, pingOneIdTokenValidatorResponse.enabled) &&
        Objects.equals(this.identityMapper, pingOneIdTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, pingOneIdTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.clockSkewGracePeriod, pingOneIdTokenValidatorResponse.clockSkewGracePeriod) &&
        Objects.equals(this.jwksCacheDuration, pingOneIdTokenValidatorResponse.jwksCacheDuration) &&
        Objects.equals(this.evaluationOrderIndex, pingOneIdTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.meta, pingOneIdTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pingOneIdTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pingOneIdTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, issuerURL, openIDConnectProvider, openIDConnectMetadataCacheDuration, enabled, identityMapper, subjectClaimName, clockSkewGracePeriod, jwksCacheDuration, evaluationOrderIndex, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PingOneIdTokenValidatorResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("OpenIDConnectProvider");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingOneIdTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingOneIdTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingOneIdTokenValidatorResponse is not found in the empty JSON string", PingOneIdTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingOneIdTokenValidatorResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("OpenIDConnectProvider").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingOneIdTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingOneIdTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingOneIdTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingOneIdTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PingOneIdTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, PingOneIdTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public PingOneIdTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingOneIdTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingOneIdTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingOneIdTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to PingOneIdTokenValidatorResponse
  */
  public static PingOneIdTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingOneIdTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of PingOneIdTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
