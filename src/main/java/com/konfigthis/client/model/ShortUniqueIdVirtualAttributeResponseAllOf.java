...
public class ShortUniqueIdVirtualAttributeResponseAllOf {
  ...
  private List<EnumshortUniqueIdVirtualAttributeSchemaUrn> schemas = null;
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf() {
  }

  public ShortUniqueIdVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf schemas(List<EnumshortUniqueIdVirtualAttributeSchemaUrn> schemas) {
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf addSchemasItem(EnumshortUniqueIdVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf sequenceNumberAttribute(String sequenceNumberAttribute) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the name or OID of the attribute which contains the sequence number from which unique identifiers are generated. The attribute should have Integer syntax or a String syntax permitting integer values. If this property is modified then the filter property should be updated accordingly so that only entries containing the sequence number attribute are eligible to have a value generated for this virtual attribute.")
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ShortUniqueIdVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the ShortUniqueIdVirtualAttributeResponseAllOf instance itself
   */
  public ShortUniqueIdVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ShortUniqueIdVirtualAttributeResponseAllOf shortUniqueIdVirtualAttributeResponseAllOf = (ShortUniqueIdVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, shortUniqueIdVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, shortUniqueIdVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, shortUniqueIdVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.sequenceNumberAttribute, shortUniqueIdVirtualAttributeResponseAllOf.sequenceNumberAttribute) &&
        Objects.equals(this.enabled, shortUniqueIdVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.attributeType, shortUniqueIdVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.baseDN, shortUniqueIdVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, shortUniqueIdVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, shortUniqueIdVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, shortUniqueIdVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, shortUniqueIdVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, shortUniqueIdVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, shortUniqueIdVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, shortUniqueIdVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, sequenceNumberAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ShortUniqueIdVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ShortUniqueIdVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ShortUniqueIdVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ShortUniqueIdVirtualAttributeResponseAllOf is not found in the empty JSON string", ShortUniqueIdVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("sequenceNumberAttribute") != null && !jsonObj.get("sequenceNumberAttribute").isJsonNull()) && !jsonObj.get("sequenceNumberAttribute").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ShortUniqueIdVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ShortUniqueIdVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ShortUniqueIdVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ShortUniqueIdVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ShortUniqueIdVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ShortUniqueIdVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public ShortUniqueIdVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ShortUniqueIdVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ShortUniqueIdVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ShortUniqueIdVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ShortUniqueIdVirtualAttributeResponseAllOf
  */
  public static ShortUniqueIdVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ShortUniqueIdVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of ShortUniqueIdVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
