...
public class AddJdbcBasedAccessLogPublisherRequest {
  ...
  public AddJdbcBasedAccessLogPublisherRequest() {
  }

  public AddJdbcBasedAccessLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest schemas(List<EnumjdbcBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public AddJdbcBasedAccessLogPublisherRequest addSchemasItem(EnumjdbcBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest server(String server) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logFieldMapping(String logFieldMapping) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logTableName(String logTableName) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logResults(Boolean logResults) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddJdbcBasedAccessLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddJdbcBasedAccessLogPublisherRequest instance itself
   */
  public AddJdbcBasedAccessLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddJdbcBasedAccessLogPublisherRequest addJdbcBasedAccessLogPublisherRequest = (AddJdbcBasedAccessLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addJdbcBasedAccessLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addJdbcBasedAccessLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addJdbcBasedAccessLogPublisherRequest.schemas) &&
        Objects.equals(this.server, addJdbcBasedAccessLogPublisherRequest.server) &&
        Objects.equals(this.logFieldMapping, addJdbcBasedAccessLogPublisherRequest.logFieldMapping) &&
        Objects.equals(this.logTableName, addJdbcBasedAccessLogPublisherRequest.logTableName) &&
        Objects.equals(this.queueSize, addJdbcBasedAccessLogPublisherRequest.queueSize) &&
        Objects.equals(this.logConnects, addJdbcBasedAccessLogPublisherRequest.logConnects) &&
        Objects.equals(this.logDisconnects, addJdbcBasedAccessLogPublisherRequest.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, addJdbcBasedAccessLogPublisherRequest.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, addJdbcBasedAccessLogPublisherRequest.logClientCertificates) &&
        Objects.equals(this.logRequests, addJdbcBasedAccessLogPublisherRequest.logRequests) &&
        Objects.equals(this.logResults, addJdbcBasedAccessLogPublisherRequest.logResults) &&
        Objects.equals(this.logSearchEntries, addJdbcBasedAccessLogPublisherRequest.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, addJdbcBasedAccessLogPublisherRequest.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, addJdbcBasedAccessLogPublisherRequest.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, addJdbcBasedAccessLogPublisherRequest.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, addJdbcBasedAccessLogPublisherRequest.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, addJdbcBasedAccessLogPublisherRequest.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, addJdbcBasedAccessLogPublisherRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addJdbcBasedAccessLogPublisherRequest.requestCriteria) &&
        Objects.equals(this.resultCriteria, addJdbcBasedAccessLogPublisherRequest.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, addJdbcBasedAccessLogPublisherRequest.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, addJdbcBasedAccessLogPublisherRequest.searchReferenceCriteria) &&
        Objects.equals(this.enabled, addJdbcBasedAccessLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addJdbcBasedAccessLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addJdbcBasedAccessLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, server, logFieldMapping, logTableName, queueSize, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddJdbcBasedAccessLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddJdbcBasedAccessLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddJdbcBasedAccessLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddJdbcBasedAccessLogPublisherRequest is not found in the empty JSON string", AddJdbcBasedAccessLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddJdbcBasedAccessLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddJdbcBasedAccessLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddJdbcBasedAccessLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddJdbcBasedAccessLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddJdbcBasedAccessLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddJdbcBasedAccessLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddJdbcBasedAccessLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddJdbcBasedAccessLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddJdbcBasedAccessLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddJdbcBasedAccessLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddJdbcBasedAccessLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddJdbcBasedAccessLogPublisherRequest
  */
  public static AddJdbcBasedAccessLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddJdbcBasedAccessLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddJdbcBasedAccessLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
