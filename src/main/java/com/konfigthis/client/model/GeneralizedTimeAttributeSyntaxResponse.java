...
import com.konfigthis.client.model.EnumgeneralizedTimeAttributeSyntaxSchemaUrn;
...
public class GeneralizedTimeAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public GeneralizedTimeAttributeSyntaxResponse() {
  }

  public GeneralizedTimeAttributeSyntaxResponse schemas(List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> schemas) {
  ...
  public GeneralizedTimeAttributeSyntaxResponse addSchemasItem(EnumgeneralizedTimeAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumgeneralizedTimeAttributeSyntaxSchemaUrn> schemas) {
  ...
  public GeneralizedTimeAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public GeneralizedTimeAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public GeneralizedTimeAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GeneralizedTimeAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GeneralizedTimeAttributeSyntaxResponse instance itself
   */
  public GeneralizedTimeAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GeneralizedTimeAttributeSyntaxResponse generalizedTimeAttributeSyntaxResponse = (GeneralizedTimeAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, generalizedTimeAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, generalizedTimeAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, generalizedTimeAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, generalizedTimeAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, generalizedTimeAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, generalizedTimeAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, generalizedTimeAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, generalizedTimeAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, generalizedTimeAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, generalizedTimeAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GeneralizedTimeAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GeneralizedTimeAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GeneralizedTimeAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GeneralizedTimeAttributeSyntaxResponse is not found in the empty JSON string", GeneralizedTimeAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GeneralizedTimeAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GeneralizedTimeAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GeneralizedTimeAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GeneralizedTimeAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GeneralizedTimeAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GeneralizedTimeAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, GeneralizedTimeAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public GeneralizedTimeAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GeneralizedTimeAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GeneralizedTimeAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GeneralizedTimeAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to GeneralizedTimeAttributeSyntaxResponse
  */
  public static GeneralizedTimeAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GeneralizedTimeAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of GeneralizedTimeAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
