...
public class AddGroovyScriptedVirtualAttributeRequest {
  ...
  public AddGroovyScriptedVirtualAttributeRequest() {
  }

  public AddGroovyScriptedVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest schemas(List<EnumgroovyScriptedVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addSchemasItem(EnumgroovyScriptedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddGroovyScriptedVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddGroovyScriptedVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedVirtualAttributeRequest instance itself
   */
  public AddGroovyScriptedVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedVirtualAttributeRequest addGroovyScriptedVirtualAttributeRequest = (AddGroovyScriptedVirtualAttributeRequest) o;
    return Objects.equals(this.name, addGroovyScriptedVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addGroovyScriptedVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedVirtualAttributeRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedVirtualAttributeRequest.scriptClass) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedVirtualAttributeRequest.scriptArgument) &&
        Objects.equals(this.enabled, addGroovyScriptedVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addGroovyScriptedVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addGroovyScriptedVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addGroovyScriptedVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addGroovyScriptedVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addGroovyScriptedVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addGroovyScriptedVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addGroovyScriptedVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addGroovyScriptedVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addGroovyScriptedVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addGroovyScriptedVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, scriptClass, scriptArgument, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedVirtualAttributeRequest is not found in the empty JSON string", AddGroovyScriptedVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedVirtualAttributeRequest
  */
  public static AddGroovyScriptedVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
