...
public class PrometheusMonitoringHttpServletExtensionShared {
  ...
  public PrometheusMonitoringHttpServletExtensionShared() {
  }

  public PrometheusMonitoringHttpServletExtensionShared description(String description) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared schemas(List<EnumprometheusMonitoringHttpServletExtensionSchemaUrn> schemas) {
  ...
  public PrometheusMonitoringHttpServletExtensionShared addSchemasItem(EnumprometheusMonitoringHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared includeInstanceNameLabel(Boolean includeInstanceNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared includeProductNameLabel(Boolean includeProductNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared includeLocationNameLabel(Boolean includeLocationNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared alwaysIncludeMonitorEntryNameLabel(Boolean alwaysIncludeMonitorEntryNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared includeMonitorObjectClassNameLabel(Boolean includeMonitorObjectClassNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared includeMonitorAttributeNameLabel(Boolean includeMonitorAttributeNameLabel) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared labelNameValuePair(List<String> labelNameValuePair) {
  ...
  public PrometheusMonitoringHttpServletExtensionShared addLabelNameValuePairItem(String labelNameValuePairItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared responseHeader(List<String> responseHeader) {
  ...
  public PrometheusMonitoringHttpServletExtensionShared addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public PrometheusMonitoringHttpServletExtensionShared correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the PrometheusMonitoringHttpServletExtensionShared instance itself
   */
  public PrometheusMonitoringHttpServletExtensionShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PrometheusMonitoringHttpServletExtensionShared prometheusMonitoringHttpServletExtensionShared = (PrometheusMonitoringHttpServletExtensionShared) o;
    return Objects.equals(this.description, prometheusMonitoringHttpServletExtensionShared.description) &&
        Objects.equals(this.schemas, prometheusMonitoringHttpServletExtensionShared.schemas) &&
        Objects.equals(this.baseContextPath, prometheusMonitoringHttpServletExtensionShared.baseContextPath) &&
        Objects.equals(this.includeInstanceNameLabel, prometheusMonitoringHttpServletExtensionShared.includeInstanceNameLabel) &&
        Objects.equals(this.includeProductNameLabel, prometheusMonitoringHttpServletExtensionShared.includeProductNameLabel) &&
        Objects.equals(this.includeLocationNameLabel, prometheusMonitoringHttpServletExtensionShared.includeLocationNameLabel) &&
        Objects.equals(this.alwaysIncludeMonitorEntryNameLabel, prometheusMonitoringHttpServletExtensionShared.alwaysIncludeMonitorEntryNameLabel) &&
        Objects.equals(this.includeMonitorObjectClassNameLabel, prometheusMonitoringHttpServletExtensionShared.includeMonitorObjectClassNameLabel) &&
        Objects.equals(this.includeMonitorAttributeNameLabel, prometheusMonitoringHttpServletExtensionShared.includeMonitorAttributeNameLabel) &&
        Objects.equals(this.labelNameValuePair, prometheusMonitoringHttpServletExtensionShared.labelNameValuePair) &&
        Objects.equals(this.crossOriginPolicy, prometheusMonitoringHttpServletExtensionShared.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, prometheusMonitoringHttpServletExtensionShared.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, prometheusMonitoringHttpServletExtensionShared.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, prometheusMonitoringHttpServletExtensionShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, baseContextPath, includeInstanceNameLabel, includeProductNameLabel, includeLocationNameLabel, alwaysIncludeMonitorEntryNameLabel, includeMonitorObjectClassNameLabel, includeMonitorAttributeNameLabel, labelNameValuePair, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PrometheusMonitoringHttpServletExtensionShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PrometheusMonitoringHttpServletExtensionShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PrometheusMonitoringHttpServletExtensionShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PrometheusMonitoringHttpServletExtensionShared is not found in the empty JSON string", PrometheusMonitoringHttpServletExtensionShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PrometheusMonitoringHttpServletExtensionShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PrometheusMonitoringHttpServletExtensionShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PrometheusMonitoringHttpServletExtensionShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PrometheusMonitoringHttpServletExtensionShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PrometheusMonitoringHttpServletExtensionShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PrometheusMonitoringHttpServletExtensionShared>() {
           @Override
           public void write(JsonWriter out, PrometheusMonitoringHttpServletExtensionShared value) throws IOException {
           ...
           @Override
           public PrometheusMonitoringHttpServletExtensionShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PrometheusMonitoringHttpServletExtensionShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PrometheusMonitoringHttpServletExtensionShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PrometheusMonitoringHttpServletExtensionShared
  * @throws IOException if the JSON string is invalid with respect to PrometheusMonitoringHttpServletExtensionShared
  */
  public static PrometheusMonitoringHttpServletExtensionShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PrometheusMonitoringHttpServletExtensionShared.class);
  }

 /**
  * Convert an instance of PrometheusMonitoringHttpServletExtensionShared to an JSON string
  *
  * @return JSON string
  */
