...
public class AddCharacterSetPasswordValidatorRequest {
  ...
  public AddCharacterSetPasswordValidatorRequest() {
  }

  public AddCharacterSetPasswordValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest schemas(List<EnumcharacterSetPasswordValidatorSchemaUrn> schemas) {
  ...
  public AddCharacterSetPasswordValidatorRequest addSchemasItem(EnumcharacterSetPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest characterSet(List<String> characterSet) {
  ...
  public AddCharacterSetPasswordValidatorRequest addCharacterSetItem(String characterSetItem) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest allowUnclassifiedCharacters(Boolean allowUnclassifiedCharacters) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest minimumRequiredCharacterSets(Integer minimumRequiredCharacterSets) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public AddCharacterSetPasswordValidatorRequest validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the AddCharacterSetPasswordValidatorRequest instance itself
   */
  public AddCharacterSetPasswordValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddCharacterSetPasswordValidatorRequest addCharacterSetPasswordValidatorRequest = (AddCharacterSetPasswordValidatorRequest) o;
    return Objects.equals(this.validatorName, addCharacterSetPasswordValidatorRequest.validatorName) &&
        Objects.equals(this.description, addCharacterSetPasswordValidatorRequest.description) &&
        Objects.equals(this.schemas, addCharacterSetPasswordValidatorRequest.schemas) &&
        Objects.equals(this.characterSet, addCharacterSetPasswordValidatorRequest.characterSet) &&
        Objects.equals(this.allowUnclassifiedCharacters, addCharacterSetPasswordValidatorRequest.allowUnclassifiedCharacters) &&
        Objects.equals(this.minimumRequiredCharacterSets, addCharacterSetPasswordValidatorRequest.minimumRequiredCharacterSets) &&
        Objects.equals(this.enabled, addCharacterSetPasswordValidatorRequest.enabled) &&
        Objects.equals(this.validatorRequirementDescription, addCharacterSetPasswordValidatorRequest.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, addCharacterSetPasswordValidatorRequest.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, addCharacterSetPasswordValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, characterSet, allowUnclassifiedCharacters, minimumRequiredCharacterSets, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddCharacterSetPasswordValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddCharacterSetPasswordValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddCharacterSetPasswordValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddCharacterSetPasswordValidatorRequest is not found in the empty JSON string", AddCharacterSetPasswordValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddCharacterSetPasswordValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddCharacterSetPasswordValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddCharacterSetPasswordValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddCharacterSetPasswordValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddCharacterSetPasswordValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddCharacterSetPasswordValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddCharacterSetPasswordValidatorRequest value) throws IOException {
           ...
           @Override
           public AddCharacterSetPasswordValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddCharacterSetPasswordValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddCharacterSetPasswordValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddCharacterSetPasswordValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddCharacterSetPasswordValidatorRequest
  */
  public static AddCharacterSetPasswordValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddCharacterSetPasswordValidatorRequest.class);
  }

 /**
  * Convert an instance of AddCharacterSetPasswordValidatorRequest to an JSON string
  *
  * @return JSON string
  */
