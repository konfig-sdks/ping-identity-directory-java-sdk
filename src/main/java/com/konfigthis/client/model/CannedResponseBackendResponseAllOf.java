...
public class CannedResponseBackendResponseAllOf {
  ...
  private List<EnumcannedResponseBackendSchemaUrn> schemas = null;
  ...
  public CannedResponseBackendResponseAllOf() {
  }

  public CannedResponseBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf schemas(List<EnumcannedResponseBackendSchemaUrn> schemas) {
  ...
  public CannedResponseBackendResponseAllOf addSchemasItem(EnumcannedResponseBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public CannedResponseBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public CannedResponseBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the CannedResponseBackendResponseAllOf instance itself
   */
  public CannedResponseBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CannedResponseBackendResponseAllOf cannedResponseBackendResponseAllOf = (CannedResponseBackendResponseAllOf) o;
    return Objects.equals(this.description, cannedResponseBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, cannedResponseBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, cannedResponseBackendResponseAllOf.id) &&
        Objects.equals(this.writabilityMode, cannedResponseBackendResponseAllOf.writabilityMode) &&
        Objects.equals(this.backendID, cannedResponseBackendResponseAllOf.backendID) &&
        Objects.equals(this.enabled, cannedResponseBackendResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, cannedResponseBackendResponseAllOf.baseDN) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, cannedResponseBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, cannedResponseBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.notificationManager, cannedResponseBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, cannedResponseBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, writabilityMode, backendID, enabled, baseDN, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CannedResponseBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CannedResponseBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CannedResponseBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CannedResponseBackendResponseAllOf is not found in the empty JSON string", CannedResponseBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CannedResponseBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CannedResponseBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CannedResponseBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CannedResponseBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CannedResponseBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, CannedResponseBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public CannedResponseBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CannedResponseBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CannedResponseBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CannedResponseBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to CannedResponseBackendResponseAllOf
  */
  public static CannedResponseBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CannedResponseBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of CannedResponseBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
