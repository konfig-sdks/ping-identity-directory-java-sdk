...
public class AddExecRecurringTaskRequest {
  ...
  public AddExecRecurringTaskRequest() {
  }

  public AddExecRecurringTaskRequest taskName(String taskName) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest description(String description) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest schemas(List<EnumexecRecurringTaskSchemaUrn> schemas) {
  ...
  public AddExecRecurringTaskRequest addSchemasItem(EnumexecRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest commandPath(String commandPath) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest commandArguments(String commandArguments) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest commandOutputFileBaseName(String commandOutputFileBaseName) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest retainPreviousOutputFileCount(Integer retainPreviousOutputFileCount) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest retainPreviousOutputFileAge(String retainPreviousOutputFileAge) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest logCommandOutput(Boolean logCommandOutput) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest taskCompletionStateForNonzeroExitCode(EnumrecurringTaskTaskCompletionStateForNonzeroExitCodeProp taskCompletionStateForNonzeroExitCode) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest workingDirectory(String workingDirectory) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest emailOnStart(List<String> emailOnStart) {
  ...
  public AddExecRecurringTaskRequest addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public AddExecRecurringTaskRequest addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest emailOnFailure(List<String> emailOnFailure) {
  ...
  public AddExecRecurringTaskRequest addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public AddExecRecurringTaskRequest alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the AddExecRecurringTaskRequest instance itself
   */
  public AddExecRecurringTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddExecRecurringTaskRequest addExecRecurringTaskRequest = (AddExecRecurringTaskRequest) o;
    return Objects.equals(this.taskName, addExecRecurringTaskRequest.taskName) &&
        Objects.equals(this.description, addExecRecurringTaskRequest.description) &&
        Objects.equals(this.schemas, addExecRecurringTaskRequest.schemas) &&
        Objects.equals(this.commandPath, addExecRecurringTaskRequest.commandPath) &&
        Objects.equals(this.commandArguments, addExecRecurringTaskRequest.commandArguments) &&
        Objects.equals(this.commandOutputFileBaseName, addExecRecurringTaskRequest.commandOutputFileBaseName) &&
        Objects.equals(this.retainPreviousOutputFileCount, addExecRecurringTaskRequest.retainPreviousOutputFileCount) &&
        Objects.equals(this.retainPreviousOutputFileAge, addExecRecurringTaskRequest.retainPreviousOutputFileAge) &&
        Objects.equals(this.logCommandOutput, addExecRecurringTaskRequest.logCommandOutput) &&
        Objects.equals(this.taskCompletionStateForNonzeroExitCode, addExecRecurringTaskRequest.taskCompletionStateForNonzeroExitCode) &&
        Objects.equals(this.workingDirectory, addExecRecurringTaskRequest.workingDirectory) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, addExecRecurringTaskRequest.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, addExecRecurringTaskRequest.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, addExecRecurringTaskRequest.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, addExecRecurringTaskRequest.emailOnFailure) &&
        Objects.equals(this.alertOnStart, addExecRecurringTaskRequest.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, addExecRecurringTaskRequest.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, addExecRecurringTaskRequest.alertOnFailure)&&
        Objects.equals(this.additionalProperties, addExecRecurringTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(taskName, description, schemas, commandPath, commandArguments, commandOutputFileBaseName, retainPreviousOutputFileCount, retainPreviousOutputFileAge, logCommandOutput, taskCompletionStateForNonzeroExitCode, workingDirectory, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddExecRecurringTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddExecRecurringTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddExecRecurringTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddExecRecurringTaskRequest is not found in the empty JSON string", AddExecRecurringTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddExecRecurringTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddExecRecurringTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddExecRecurringTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddExecRecurringTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddExecRecurringTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddExecRecurringTaskRequest>() {
           @Override
           public void write(JsonWriter out, AddExecRecurringTaskRequest value) throws IOException {
           ...
           @Override
           public AddExecRecurringTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddExecRecurringTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddExecRecurringTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddExecRecurringTaskRequest
  * @throws IOException if the JSON string is invalid with respect to AddExecRecurringTaskRequest
  */
  public static AddExecRecurringTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddExecRecurringTaskRequest.class);
  }

 /**
  * Convert an instance of AddExecRecurringTaskRequest to an JSON string
  *
  * @return JSON string
  */
