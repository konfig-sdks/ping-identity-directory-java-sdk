...
public class PhotoDelegatedAdminAttributeResponse {
  ...
  public PhotoDelegatedAdminAttributeResponse() {
  }

  public PhotoDelegatedAdminAttributeResponse id(String id) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse description(String description) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse schemas(List<EnumphotoDelegatedAdminAttributeSchemaUrn> schemas) {
  ...
  public PhotoDelegatedAdminAttributeResponse addSchemasItem(EnumphotoDelegatedAdminAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse allowedMIMEType(List<EnumdelegatedAdminAttributePhotoAllowedMIMETypeProp> allowedMIMEType) {
  ...
  public PhotoDelegatedAdminAttributeResponse addAllowedMIMETypeItem(EnumdelegatedAdminAttributePhotoAllowedMIMETypeProp allowedMIMETypeItem) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse displayName(String displayName) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse mutability(EnumdelegatedAdminAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse attributeCategory(String attributeCategory) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse displayOrderIndex(Integer displayOrderIndex) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse referenceResourceType(String referenceResourceType) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse attributePresentation(EnumdelegatedAdminAttributeAttributePresentationProp attributePresentation) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse dateTimeFormat(String dateTimeFormat) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PhotoDelegatedAdminAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PhotoDelegatedAdminAttributeResponse instance itself
   */
  public PhotoDelegatedAdminAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PhotoDelegatedAdminAttributeResponse photoDelegatedAdminAttributeResponse = (PhotoDelegatedAdminAttributeResponse) o;
    return Objects.equals(this.id, photoDelegatedAdminAttributeResponse.id) &&
        Objects.equals(this.description, photoDelegatedAdminAttributeResponse.description) &&
        Objects.equals(this.schemas, photoDelegatedAdminAttributeResponse.schemas) &&
        Objects.equals(this.allowedMIMEType, photoDelegatedAdminAttributeResponse.allowedMIMEType) &&
        Objects.equals(this.attributeType, photoDelegatedAdminAttributeResponse.attributeType) &&
        Objects.equals(this.displayName, photoDelegatedAdminAttributeResponse.displayName) &&
        Objects.equals(this.mutability, photoDelegatedAdminAttributeResponse.mutability) &&
        Objects.equals(this.multiValued, photoDelegatedAdminAttributeResponse.multiValued) &&
        Objects.equals(this.attributeCategory, photoDelegatedAdminAttributeResponse.attributeCategory) &&
        Objects.equals(this.displayOrderIndex, photoDelegatedAdminAttributeResponse.displayOrderIndex) &&
        Objects.equals(this.referenceResourceType, photoDelegatedAdminAttributeResponse.referenceResourceType) &&
        Objects.equals(this.attributePresentation, photoDelegatedAdminAttributeResponse.attributePresentation) &&
        Objects.equals(this.dateTimeFormat, photoDelegatedAdminAttributeResponse.dateTimeFormat) &&
        Objects.equals(this.meta, photoDelegatedAdminAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, photoDelegatedAdminAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, photoDelegatedAdminAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PhotoDelegatedAdminAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PhotoDelegatedAdminAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PhotoDelegatedAdminAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PhotoDelegatedAdminAttributeResponse is not found in the empty JSON string", PhotoDelegatedAdminAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PhotoDelegatedAdminAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PhotoDelegatedAdminAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PhotoDelegatedAdminAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PhotoDelegatedAdminAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PhotoDelegatedAdminAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PhotoDelegatedAdminAttributeResponse>() {
           @Override
           public void write(JsonWriter out, PhotoDelegatedAdminAttributeResponse value) throws IOException {
           ...
           @Override
           public PhotoDelegatedAdminAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PhotoDelegatedAdminAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PhotoDelegatedAdminAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PhotoDelegatedAdminAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to PhotoDelegatedAdminAttributeResponse
  */
  public static PhotoDelegatedAdminAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PhotoDelegatedAdminAttributeResponse.class);
  }

 /**
  * Convert an instance of PhotoDelegatedAdminAttributeResponse to an JSON string
  *
  * @return JSON string
  */
