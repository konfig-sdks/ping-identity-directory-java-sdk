...
public class NokiaDsExternalServerResponse {
  ...
  public NokiaDsExternalServerResponse() {
  }

  public NokiaDsExternalServerResponse id(String id) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse description(String description) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse schemas(List<EnumnokiaDsExternalServerSchemaUrn> schemas) {
  ...
  public NokiaDsExternalServerResponse addSchemasItem(EnumnokiaDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse location(String location) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse password(String password) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse connectionSecurity(EnumexternalServerNokiaDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse authenticationMethod(EnumexternalServerNokiaDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public NokiaDsExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public NokiaDsExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the NokiaDsExternalServerResponse instance itself
   */
  public NokiaDsExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NokiaDsExternalServerResponse nokiaDsExternalServerResponse = (NokiaDsExternalServerResponse) o;
    return Objects.equals(this.id, nokiaDsExternalServerResponse.id) &&
        Objects.equals(this.description, nokiaDsExternalServerResponse.description) &&
        Objects.equals(this.schemas, nokiaDsExternalServerResponse.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, nokiaDsExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, nokiaDsExternalServerResponse.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, nokiaDsExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, nokiaDsExternalServerResponse.serverPort) &&
        Objects.equals(this.location, nokiaDsExternalServerResponse.location) &&
        Objects.equals(this.bindDN, nokiaDsExternalServerResponse.bindDN) &&
        Objects.equals(this.password, nokiaDsExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, nokiaDsExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, nokiaDsExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, nokiaDsExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, nokiaDsExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, nokiaDsExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, nokiaDsExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, nokiaDsExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, nokiaDsExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, nokiaDsExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, nokiaDsExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, nokiaDsExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, nokiaDsExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, nokiaDsExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, nokiaDsExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, nokiaDsExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, nokiaDsExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, nokiaDsExternalServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NokiaDsExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NokiaDsExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NokiaDsExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NokiaDsExternalServerResponse is not found in the empty JSON string", NokiaDsExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NokiaDsExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NokiaDsExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NokiaDsExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NokiaDsExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NokiaDsExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<NokiaDsExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, NokiaDsExternalServerResponse value) throws IOException {
           ...
           @Override
           public NokiaDsExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NokiaDsExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NokiaDsExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NokiaDsExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to NokiaDsExternalServerResponse
  */
  public static NokiaDsExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NokiaDsExternalServerResponse.class);
  }

 /**
  * Convert an instance of NokiaDsExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
