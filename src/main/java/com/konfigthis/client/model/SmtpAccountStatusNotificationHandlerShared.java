...
public class SmtpAccountStatusNotificationHandlerShared {
  ...
  public SmtpAccountStatusNotificationHandlerShared() {
  }

  public SmtpAccountStatusNotificationHandlerShared description(String description) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared schemas(List<EnumsmtpAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public SmtpAccountStatusNotificationHandlerShared addSchemasItem(EnumsmtpAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared emailAddressAttributeType(List<String> emailAddressAttributeType) {
  ...
  public SmtpAccountStatusNotificationHandlerShared addEmailAddressAttributeTypeItem(String emailAddressAttributeTypeItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared emailAddressJSONField(String emailAddressJSONField) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared emailAddressJSONObjectFilter(String emailAddressJSONObjectFilter) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared recipientAddress(List<String> recipientAddress) {
  ...
  public SmtpAccountStatusNotificationHandlerShared addRecipientAddressItem(String recipientAddressItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared sendMessageWithoutEndUserAddress(Boolean sendMessageWithoutEndUserAddress) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared senderAddress(String senderAddress) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared messageSubject(List<String> messageSubject) {
  ...
  public SmtpAccountStatusNotificationHandlerShared addMessageSubjectItem(String messageSubjectItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared messageTemplateFile(List<String> messageTemplateFile) {
  ...
  public SmtpAccountStatusNotificationHandlerShared addMessageTemplateFileItem(String messageTemplateFileItem) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public SmtpAccountStatusNotificationHandlerShared accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the SmtpAccountStatusNotificationHandlerShared instance itself
   */
  public SmtpAccountStatusNotificationHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpAccountStatusNotificationHandlerShared smtpAccountStatusNotificationHandlerShared = (SmtpAccountStatusNotificationHandlerShared) o;
    return Objects.equals(this.description, smtpAccountStatusNotificationHandlerShared.description) &&
        Objects.equals(this.schemas, smtpAccountStatusNotificationHandlerShared.schemas) &&
        Objects.equals(this.emailAddressAttributeType, smtpAccountStatusNotificationHandlerShared.emailAddressAttributeType) &&
        Objects.equals(this.emailAddressJSONField, smtpAccountStatusNotificationHandlerShared.emailAddressJSONField) &&
        Objects.equals(this.emailAddressJSONObjectFilter, smtpAccountStatusNotificationHandlerShared.emailAddressJSONObjectFilter) &&
        Objects.equals(this.recipientAddress, smtpAccountStatusNotificationHandlerShared.recipientAddress) &&
        Objects.equals(this.sendMessageWithoutEndUserAddress, smtpAccountStatusNotificationHandlerShared.sendMessageWithoutEndUserAddress) &&
        Objects.equals(this.senderAddress, smtpAccountStatusNotificationHandlerShared.senderAddress) &&
        Objects.equals(this.messageSubject, smtpAccountStatusNotificationHandlerShared.messageSubject) &&
        Objects.equals(this.messageTemplateFile, smtpAccountStatusNotificationHandlerShared.messageTemplateFile) &&
        Objects.equals(this.enabled, smtpAccountStatusNotificationHandlerShared.enabled) &&
        Objects.equals(this.asynchronous, smtpAccountStatusNotificationHandlerShared.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, smtpAccountStatusNotificationHandlerShared.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, smtpAccountStatusNotificationHandlerShared.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, smtpAccountStatusNotificationHandlerShared.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, smtpAccountStatusNotificationHandlerShared.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, smtpAccountStatusNotificationHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, emailAddressAttributeType, emailAddressJSONField, emailAddressJSONObjectFilter, recipientAddress, sendMessageWithoutEndUserAddress, senderAddress, messageSubject, messageTemplateFile, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmtpAccountStatusNotificationHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmtpAccountStatusNotificationHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmtpAccountStatusNotificationHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpAccountStatusNotificationHandlerShared is not found in the empty JSON string", SmtpAccountStatusNotificationHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmtpAccountStatusNotificationHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpAccountStatusNotificationHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpAccountStatusNotificationHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpAccountStatusNotificationHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpAccountStatusNotificationHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpAccountStatusNotificationHandlerShared>() {
           @Override
           public void write(JsonWriter out, SmtpAccountStatusNotificationHandlerShared value) throws IOException {
           ...
           @Override
           public SmtpAccountStatusNotificationHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SmtpAccountStatusNotificationHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SmtpAccountStatusNotificationHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmtpAccountStatusNotificationHandlerShared
  * @throws IOException if the JSON string is invalid with respect to SmtpAccountStatusNotificationHandlerShared
  */
  public static SmtpAccountStatusNotificationHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpAccountStatusNotificationHandlerShared.class);
  }

 /**
  * Convert an instance of SmtpAccountStatusNotificationHandlerShared to an JSON string
  *
  * @return JSON string
  */
