...
import com.konfigthis.client.model.EnumleaveLockdownModeRecurringTaskSchemaUrn;
...
public class LeaveLockdownModeRecurringTaskResponse {
  ...
  private List<EnumleaveLockdownModeRecurringTaskSchemaUrn> schemas = new ArrayList<>();
  ...
  public LeaveLockdownModeRecurringTaskResponse() {
  }

  public LeaveLockdownModeRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse schemas(List<EnumleaveLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public LeaveLockdownModeRecurringTaskResponse addSchemasItem(EnumleaveLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumleaveLockdownModeRecurringTaskSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumleaveLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public LeaveLockdownModeRecurringTaskResponse reason(String reason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reason that the server is being taken out of in lockdown mode.")
  ...
  public LeaveLockdownModeRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public LeaveLockdownModeRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public LeaveLockdownModeRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public LeaveLockdownModeRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LeaveLockdownModeRecurringTaskResponse instance itself
   */
  public LeaveLockdownModeRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveLockdownModeRecurringTaskResponse leaveLockdownModeRecurringTaskResponse = (LeaveLockdownModeRecurringTaskResponse) o;
    return Objects.equals(this.id, leaveLockdownModeRecurringTaskResponse.id) &&
        Objects.equals(this.description, leaveLockdownModeRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, leaveLockdownModeRecurringTaskResponse.schemas) &&
        Objects.equals(this.reason, leaveLockdownModeRecurringTaskResponse.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, leaveLockdownModeRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, leaveLockdownModeRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, leaveLockdownModeRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, leaveLockdownModeRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, leaveLockdownModeRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, leaveLockdownModeRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, leaveLockdownModeRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, leaveLockdownModeRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, leaveLockdownModeRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, leaveLockdownModeRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, reason, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveLockdownModeRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveLockdownModeRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveLockdownModeRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveLockdownModeRecurringTaskResponse is not found in the empty JSON string", LeaveLockdownModeRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveLockdownModeRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveLockdownModeRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveLockdownModeRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveLockdownModeRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveLockdownModeRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveLockdownModeRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, LeaveLockdownModeRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public LeaveLockdownModeRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveLockdownModeRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveLockdownModeRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveLockdownModeRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to LeaveLockdownModeRecurringTaskResponse
  */
  public static LeaveLockdownModeRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveLockdownModeRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of LeaveLockdownModeRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
