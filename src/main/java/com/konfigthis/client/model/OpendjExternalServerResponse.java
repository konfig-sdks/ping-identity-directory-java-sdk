...
import com.konfigthis.client.model.EnumexternalServerOpendjAuthenticationMethodProp;
import com.konfigthis.client.model.EnumexternalServerOpendjConnectionSecurityProp;
import com.konfigthis.client.model.EnumexternalServerVerifyCredentialsMethodProp;
import com.konfigthis.client.model.EnumopendjExternalServerSchemaUrn;
...
public class OpendjExternalServerResponse {
  ...
  private List<EnumopendjExternalServerSchemaUrn> schemas = new ArrayList<>();
  ...
  private EnumexternalServerOpendjConnectionSecurityProp connectionSecurity;
  ...
  private EnumexternalServerOpendjAuthenticationMethodProp authenticationMethod;
  ...
  public OpendjExternalServerResponse() {
  }

  public OpendjExternalServerResponse id(String id) {
  ...
  **/
  ...
  public OpendjExternalServerResponse description(String description) {
  ...
  **/
  ...
  public OpendjExternalServerResponse schemas(List<EnumopendjExternalServerSchemaUrn> schemas) {
  ...
  public OpendjExternalServerResponse addSchemasItem(EnumopendjExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumopendjExternalServerSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumopendjExternalServerSchemaUrn> schemas) {
  ...
  public OpendjExternalServerResponse serverHostName(String serverHostName) {
  ...
  **/
  ...
  public OpendjExternalServerResponse serverPort(Integer serverPort) {
  ...
  **/
  ...
  public OpendjExternalServerResponse location(String location) {
  ...
  **/
  ...
  public OpendjExternalServerResponse bindDN(String bindDN) {
  ...
  **/
  ...
  public OpendjExternalServerResponse password(String password) {
  ...
  **/
  ...
  public OpendjExternalServerResponse passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public OpendjExternalServerResponse connectionSecurity(EnumexternalServerOpendjConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public EnumexternalServerOpendjConnectionSecurityProp getConnectionSecurity() {
    return connectionSecurity;
  }


  public void setConnectionSecurity(EnumexternalServerOpendjConnectionSecurityProp connectionSecurity) {
  ...
  public OpendjExternalServerResponse authenticationMethod(EnumexternalServerOpendjAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public EnumexternalServerOpendjAuthenticationMethodProp getAuthenticationMethod() {
    return authenticationMethod;
  }


  public void setAuthenticationMethod(EnumexternalServerOpendjAuthenticationMethodProp authenticationMethod) {
  ...
  public OpendjExternalServerResponse verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public OpendjExternalServerResponse healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public OpendjExternalServerResponse maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public OpendjExternalServerResponse minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public OpendjExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public OpendjExternalServerResponse maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public OpendjExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public OpendjExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public OpendjExternalServerResponse initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public OpendjExternalServerResponse maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public OpendjExternalServerResponse defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public OpendjExternalServerResponse addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public OpendjExternalServerResponse abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
  ...
  public OpendjExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public OpendjExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the OpendjExternalServerResponse instance itself
   */
  public OpendjExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OpendjExternalServerResponse opendjExternalServerResponse = (OpendjExternalServerResponse) o;
    return Objects.equals(this.id, opendjExternalServerResponse.id) &&
        Objects.equals(this.description, opendjExternalServerResponse.description) &&
        Objects.equals(this.schemas, opendjExternalServerResponse.schemas) &&
        Objects.equals(this.serverHostName, opendjExternalServerResponse.serverHostName) &&
        Objects.equals(this.serverPort, opendjExternalServerResponse.serverPort) &&
        Objects.equals(this.location, opendjExternalServerResponse.location) &&
        Objects.equals(this.bindDN, opendjExternalServerResponse.bindDN) &&
        Objects.equals(this.password, opendjExternalServerResponse.password) &&
        Objects.equals(this.passphraseProvider, opendjExternalServerResponse.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, opendjExternalServerResponse.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, opendjExternalServerResponse.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, opendjExternalServerResponse.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, opendjExternalServerResponse.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, opendjExternalServerResponse.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, opendjExternalServerResponse.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, opendjExternalServerResponse.connectTimeout) &&
        Objects.equals(this.maxResponseSize, opendjExternalServerResponse.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, opendjExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, opendjExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.initialConnections, opendjExternalServerResponse.initialConnections) &&
        Objects.equals(this.maxConnections, opendjExternalServerResponse.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, opendjExternalServerResponse.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, opendjExternalServerResponse.abandonOnTimeout) &&
        Objects.equals(this.meta, opendjExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, opendjExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, opendjExternalServerResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OpendjExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OpendjExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OpendjExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OpendjExternalServerResponse is not found in the empty JSON string", OpendjExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OpendjExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OpendjExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OpendjExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OpendjExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OpendjExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OpendjExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, OpendjExternalServerResponse value) throws IOException {
           ...
           @Override
           public OpendjExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OpendjExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OpendjExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OpendjExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to OpendjExternalServerResponse
  */
  public static OpendjExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OpendjExternalServerResponse.class);
  }

 /**
  * Convert an instance of OpendjExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
