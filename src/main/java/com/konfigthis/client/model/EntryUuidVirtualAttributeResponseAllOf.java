...
public class EntryUuidVirtualAttributeResponseAllOf {
  ...
  private List<EnumentryUuidVirtualAttributeSchemaUrn> schemas = null;
  ...
  public EntryUuidVirtualAttributeResponseAllOf() {
  }

  public EntryUuidVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf schemas(List<EnumentryUuidVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryUuidVirtualAttributeResponseAllOf addSchemasItem(EnumentryUuidVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public EntryUuidVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public EntryUuidVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public EntryUuidVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EntryUuidVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
   ...
   * @return the EntryUuidVirtualAttributeResponseAllOf instance itself
   */
  public EntryUuidVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntryUuidVirtualAttributeResponseAllOf entryUuidVirtualAttributeResponseAllOf = (EntryUuidVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, entryUuidVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, entryUuidVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, entryUuidVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, entryUuidVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, entryUuidVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.allowIndexConflicts, entryUuidVirtualAttributeResponseAllOf.allowIndexConflicts) &&
        Objects.equals(this.enabled, entryUuidVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, entryUuidVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, entryUuidVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, entryUuidVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, entryUuidVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, entryUuidVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, entryUuidVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, entryUuidVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior)&&
        Objects.equals(this.additionalProperties, entryUuidVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, allowIndexConflicts, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntryUuidVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EntryUuidVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntryUuidVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryUuidVirtualAttributeResponseAllOf is not found in the empty JSON string", EntryUuidVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntryUuidVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntryUuidVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntryUuidVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntryUuidVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<EntryUuidVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, EntryUuidVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public EntryUuidVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EntryUuidVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EntryUuidVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EntryUuidVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to EntryUuidVirtualAttributeResponseAllOf
  */
  public static EntryUuidVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntryUuidVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of EntryUuidVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
