...
public class PingIdentityProxyServerExternalServerShared {
  ...
  public PingIdentityProxyServerExternalServerShared() {
  }

  public PingIdentityProxyServerExternalServerShared description(String description) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared schemas(List<EnumpingIdentityProxyServerExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityProxyServerExternalServerShared addSchemasItem(EnumpingIdentityProxyServerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared location(String location) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared password(String password) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared connectionSecurity(EnumexternalServerPingIdentityProxyServerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared authenticationMethod(EnumexternalServerPingIdentityProxyServerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public PingIdentityProxyServerExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public PingIdentityProxyServerExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the PingIdentityProxyServerExternalServerShared instance itself
   */
  public PingIdentityProxyServerExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingIdentityProxyServerExternalServerShared pingIdentityProxyServerExternalServerShared = (PingIdentityProxyServerExternalServerShared) o;
    return Objects.equals(this.description, pingIdentityProxyServerExternalServerShared.description) &&
        Objects.equals(this.schemas, pingIdentityProxyServerExternalServerShared.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, pingIdentityProxyServerExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, pingIdentityProxyServerExternalServerShared.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, pingIdentityProxyServerExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, pingIdentityProxyServerExternalServerShared.serverPort) &&
        Objects.equals(this.location, pingIdentityProxyServerExternalServerShared.location) &&
        Objects.equals(this.bindDN, pingIdentityProxyServerExternalServerShared.bindDN) &&
        Objects.equals(this.password, pingIdentityProxyServerExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, pingIdentityProxyServerExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, pingIdentityProxyServerExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, pingIdentityProxyServerExternalServerShared.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, pingIdentityProxyServerExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, pingIdentityProxyServerExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, pingIdentityProxyServerExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, pingIdentityProxyServerExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, pingIdentityProxyServerExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, pingIdentityProxyServerExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, pingIdentityProxyServerExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, pingIdentityProxyServerExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, pingIdentityProxyServerExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, pingIdentityProxyServerExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, pingIdentityProxyServerExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, pingIdentityProxyServerExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, verifyCredentialsMethod, useAdministrativeOperationControl, serverHostName, serverPort, location, bindDN, password, passphraseProvider, connectionSecurity, authenticationMethod, healthCheckConnectTimeout, maxConnectionAge, minExpiredConnectionDisconnectInterval, connectTimeout, maxResponseSize, keyManagerProvider, trustManagerProvider, initialConnections, maxConnections, defunctConnectionResultCode, abandonOnTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PingIdentityProxyServerExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingIdentityProxyServerExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingIdentityProxyServerExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingIdentityProxyServerExternalServerShared is not found in the empty JSON string", PingIdentityProxyServerExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingIdentityProxyServerExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingIdentityProxyServerExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingIdentityProxyServerExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingIdentityProxyServerExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingIdentityProxyServerExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PingIdentityProxyServerExternalServerShared>() {
           @Override
           public void write(JsonWriter out, PingIdentityProxyServerExternalServerShared value) throws IOException {
           ...
           @Override
           public PingIdentityProxyServerExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingIdentityProxyServerExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingIdentityProxyServerExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingIdentityProxyServerExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to PingIdentityProxyServerExternalServerShared
  */
  public static PingIdentityProxyServerExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingIdentityProxyServerExternalServerShared.class);
  }

 /**
  * Convert an instance of PingIdentityProxyServerExternalServerShared to an JSON string
  *
  * @return JSON string
  */
