...
public class FileBasedJsonSyncLogPublisherResponse {
  ...
  private List<EnumfileBasedJsonSyncLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public FileBasedJsonSyncLogPublisherResponse() {
  }

  public FileBasedJsonSyncLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse schemas(List<EnumfileBasedJsonSyncLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addSchemasItem(EnumfileBasedJsonSyncLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse logFile(String logFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The file name to use for the log files generated by the File Based JSON Sync Log Publisher. The path to the file can be specified either as relative to the server root or as an absolute path.")
  ...
  public FileBasedJsonSyncLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based JSON Sync Log Publisher.")
  ...
  public FileBasedJsonSyncLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based JSON Sync Log Publisher .")
  ...
  public FileBasedJsonSyncLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based JSON Sync Log Publisher .")
  ...
  public FileBasedJsonSyncLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based JSON Sync Log Publisher will publish records asynchronously.")
  ...
  public FileBasedJsonSyncLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse includeSyncPipe(List<String> includeSyncPipe) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addIncludeSyncPipeItem(String includeSyncPipeItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse loggedMessageType(List<EnumlogPublisherLoggedMessageTypeProp> loggedMessageType) {
  ...
  public FileBasedJsonSyncLogPublisherResponse addLoggedMessageTypeItem(EnumlogPublisherLoggedMessageTypeProp loggedMessageTypeItem) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedJsonSyncLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedJsonSyncLogPublisherResponse instance itself
   */
  public FileBasedJsonSyncLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedJsonSyncLogPublisherResponse fileBasedJsonSyncLogPublisherResponse = (FileBasedJsonSyncLogPublisherResponse) o;
    return Objects.equals(this.description, fileBasedJsonSyncLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedJsonSyncLogPublisherResponse.schemas) &&
        Objects.equals(this.id, fileBasedJsonSyncLogPublisherResponse.id) &&
        Objects.equals(this.logFile, fileBasedJsonSyncLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedJsonSyncLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedJsonSyncLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedJsonSyncLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedJsonSyncLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedJsonSyncLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedJsonSyncLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedJsonSyncLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedJsonSyncLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedJsonSyncLogPublisherResponse.append) &&
        Objects.equals(this.asynchronous, fileBasedJsonSyncLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedJsonSyncLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedJsonSyncLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedJsonSyncLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedJsonSyncLogPublisherResponse.timeInterval) &&
        Objects.equals(this.writeMultiLineMessages, fileBasedJsonSyncLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, fileBasedJsonSyncLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, fileBasedJsonSyncLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, fileBasedJsonSyncLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, fileBasedJsonSyncLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeSyncPipe, fileBasedJsonSyncLogPublisherResponse.includeSyncPipe) &&
        Objects.equals(this.loggedMessageType, fileBasedJsonSyncLogPublisherResponse.loggedMessageType) &&
        Objects.equals(this.enabled, fileBasedJsonSyncLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedJsonSyncLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedJsonSyncLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedJsonSyncLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedJsonSyncLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeSyncPipe, loggedMessageType, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedJsonSyncLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedJsonSyncLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedJsonSyncLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedJsonSyncLogPublisherResponse is not found in the empty JSON string", FileBasedJsonSyncLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedJsonSyncLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedJsonSyncLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedJsonSyncLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedJsonSyncLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedJsonSyncLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedJsonSyncLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedJsonSyncLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedJsonSyncLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedJsonSyncLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedJsonSyncLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedJsonSyncLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedJsonSyncLogPublisherResponse
  */
  public static FileBasedJsonSyncLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedJsonSyncLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedJsonSyncLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
