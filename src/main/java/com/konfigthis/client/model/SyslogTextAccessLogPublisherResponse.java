...
import com.konfigthis.client.model.EnumsyslogTextAccessLogPublisherSchemaUrn;
...
public class SyslogTextAccessLogPublisherResponse {
  ...
  private List<EnumsyslogTextAccessLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public SyslogTextAccessLogPublisherResponse() {
  }

  public SyslogTextAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse schemas(List<EnumsyslogTextAccessLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogTextAccessLogPublisherResponse addSchemasItem(EnumsyslogTextAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumsyslogTextAccessLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumsyslogTextAccessLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogTextAccessLogPublisherResponse syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogTextAccessLogPublisherResponse addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The local host name that will be included in syslog messages that are logged by this Syslog Text Access Log Publisher.")
  ...
  public SyslogTextAccessLogPublisherResponse syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The application name that will be included in syslog messages that are logged by this Syslog Text Access Log Publisher.")
  ...
  public SyslogTextAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logAssuranceCompleted(Boolean logAssuranceCompleted) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequestDetailsInSearchEntryMessages(Boolean includeRequestDetailsInSearchEntryMessages) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequestDetailsInSearchReferenceMessages(Boolean includeRequestDetailsInSearchReferenceMessages) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequestDetailsInIntermediateResponseMessages(Boolean includeRequestDetailsInIntermediateResponseMessages) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeResultCodeNames(Boolean includeResultCodeNames) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeExtendedSearchRequestDetails(Boolean includeExtendedSearchRequestDetails) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeAddAttributeNames(Boolean includeAddAttributeNames) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeModifyAttributeNames(Boolean includeModifyAttributeNames) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeSearchEntryAttributeNames(Boolean includeSearchEntryAttributeNames) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse logFieldBehavior(String logFieldBehavior) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SyslogTextAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SyslogTextAccessLogPublisherResponse instance itself
   */
  public SyslogTextAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogTextAccessLogPublisherResponse syslogTextAccessLogPublisherResponse = (SyslogTextAccessLogPublisherResponse) o;
    return Objects.equals(this.id, syslogTextAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, syslogTextAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, syslogTextAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.syslogExternalServer, syslogTextAccessLogPublisherResponse.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogTextAccessLogPublisherResponse.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogTextAccessLogPublisherResponse.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogTextAccessLogPublisherResponse.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogTextAccessLogPublisherResponse.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogTextAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.logConnects, syslogTextAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, syslogTextAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, syslogTextAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, syslogTextAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, syslogTextAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, syslogTextAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logAssuranceCompleted, syslogTextAccessLogPublisherResponse.logAssuranceCompleted) &&
        Objects.equals(this.logSearchEntries, syslogTextAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, syslogTextAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, syslogTextAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, syslogTextAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, syslogTextAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, syslogTextAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.includeProductName, syslogTextAccessLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogTextAccessLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogTextAccessLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogTextAccessLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, syslogTextAccessLogPublisherResponse.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, syslogTextAccessLogPublisherResponse.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, syslogTextAccessLogPublisherResponse.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchEntryMessages, syslogTextAccessLogPublisherResponse.includeRequestDetailsInSearchEntryMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchReferenceMessages, syslogTextAccessLogPublisherResponse.includeRequestDetailsInSearchReferenceMessages) &&
        Objects.equals(this.includeRequestDetailsInIntermediateResponseMessages, syslogTextAccessLogPublisherResponse.includeRequestDetailsInIntermediateResponseMessages) &&
        Objects.equals(this.includeResultCodeNames, syslogTextAccessLogPublisherResponse.includeResultCodeNames) &&
        Objects.equals(this.includeExtendedSearchRequestDetails, syslogTextAccessLogPublisherResponse.includeExtendedSearchRequestDetails) &&
        Objects.equals(this.includeAddAttributeNames, syslogTextAccessLogPublisherResponse.includeAddAttributeNames) &&
        Objects.equals(this.includeModifyAttributeNames, syslogTextAccessLogPublisherResponse.includeModifyAttributeNames) &&
        Objects.equals(this.includeSearchEntryAttributeNames, syslogTextAccessLogPublisherResponse.includeSearchEntryAttributeNames) &&
        Objects.equals(this.includeRequestControls, syslogTextAccessLogPublisherResponse.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, syslogTextAccessLogPublisherResponse.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, syslogTextAccessLogPublisherResponse.includeReplicationChangeID) &&
        Objects.equals(this.maxStringLength, syslogTextAccessLogPublisherResponse.maxStringLength) &&
        Objects.equals(this.timestampPrecision, syslogTextAccessLogPublisherResponse.timestampPrecision) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, syslogTextAccessLogPublisherResponse.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.asynchronous, syslogTextAccessLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, syslogTextAccessLogPublisherResponse.autoFlush) &&
        Objects.equals(this.logFieldBehavior, syslogTextAccessLogPublisherResponse.logFieldBehavior) &&
        Objects.equals(this.connectionCriteria, syslogTextAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, syslogTextAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, syslogTextAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, syslogTextAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, syslogTextAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, syslogTextAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogTextAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, syslogTextAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, syslogTextAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, syslogTextAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logAssuranceCompleted, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterDN, includeRequesterIPAddress, includeRequestDetailsInResultMessages, includeRequestDetailsInSearchEntryMessages, includeRequestDetailsInSearchReferenceMessages, includeRequestDetailsInIntermediateResponseMessages, includeResultCodeNames, includeExtendedSearchRequestDetails, includeAddAttributeNames, includeModifyAttributeNames, includeSearchEntryAttributeNames, includeRequestControls, includeResponseControls, includeReplicationChangeID, maxStringLength, timestampPrecision, generifyMessageStringsWhenPossible, asynchronous, autoFlush, logFieldBehavior, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogTextAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogTextAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogTextAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogTextAccessLogPublisherResponse is not found in the empty JSON string", SyslogTextAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogTextAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogTextAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogTextAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogTextAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogTextAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogTextAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, SyslogTextAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public SyslogTextAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogTextAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogTextAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogTextAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to SyslogTextAccessLogPublisherResponse
  */
  public static SyslogTextAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogTextAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of SyslogTextAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
