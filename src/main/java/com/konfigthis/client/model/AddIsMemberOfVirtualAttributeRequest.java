...
public class AddIsMemberOfVirtualAttributeRequest {
  ...
  public AddIsMemberOfVirtualAttributeRequest() {
  }

  public AddIsMemberOfVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest schemas(List<EnumisMemberOfVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddIsMemberOfVirtualAttributeRequest addSchemasItem(EnumisMemberOfVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest directMembershipsOnly(Boolean directMembershipsOnly) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest includedGroupFilter(String includedGroupFilter) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest rewriteSearchFilters(EnumvirtualAttributeRewriteSearchFiltersProp rewriteSearchFilters) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddIsMemberOfVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddIsMemberOfVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddIsMemberOfVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddIsMemberOfVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddIsMemberOfVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddIsMemberOfVirtualAttributeRequest instance itself
   */
  public AddIsMemberOfVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddIsMemberOfVirtualAttributeRequest addIsMemberOfVirtualAttributeRequest = (AddIsMemberOfVirtualAttributeRequest) o;
    return Objects.equals(this.name, addIsMemberOfVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addIsMemberOfVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addIsMemberOfVirtualAttributeRequest.schemas) &&
        Objects.equals(this.conflictBehavior, addIsMemberOfVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.attributeType, addIsMemberOfVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.directMembershipsOnly, addIsMemberOfVirtualAttributeRequest.directMembershipsOnly) &&
        Objects.equals(this.includedGroupFilter, addIsMemberOfVirtualAttributeRequest.includedGroupFilter) &&
        Objects.equals(this.rewriteSearchFilters, addIsMemberOfVirtualAttributeRequest.rewriteSearchFilters) &&
        Objects.equals(this.enabled, addIsMemberOfVirtualAttributeRequest.enabled) &&
        Objects.equals(this.baseDN, addIsMemberOfVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addIsMemberOfVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addIsMemberOfVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addIsMemberOfVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, addIsMemberOfVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addIsMemberOfVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addIsMemberOfVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addIsMemberOfVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addIsMemberOfVirtualAttributeRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddIsMemberOfVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddIsMemberOfVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddIsMemberOfVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddIsMemberOfVirtualAttributeRequest is not found in the empty JSON string", AddIsMemberOfVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddIsMemberOfVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddIsMemberOfVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddIsMemberOfVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddIsMemberOfVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddIsMemberOfVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddIsMemberOfVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddIsMemberOfVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddIsMemberOfVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddIsMemberOfVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddIsMemberOfVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddIsMemberOfVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddIsMemberOfVirtualAttributeRequest
  */
  public static AddIsMemberOfVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddIsMemberOfVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddIsMemberOfVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
