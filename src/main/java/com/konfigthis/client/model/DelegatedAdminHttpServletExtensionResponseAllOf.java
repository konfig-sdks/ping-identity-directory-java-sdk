...
public class DelegatedAdminHttpServletExtensionResponseAllOf {
  ...
  private List<EnumdelegatedAdminHttpServletExtensionSchemaUrn> schemas = null;
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf() {
  }

  public DelegatedAdminHttpServletExtensionResponseAllOf description(String description) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf schemas(List<EnumdelegatedAdminHttpServletExtensionSchemaUrn> schemas) {
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf addSchemasItem(EnumdelegatedAdminHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf id(String id) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf basicAuthEnabled(Boolean basicAuthEnabled) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf identityMapper(String identityMapper) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf accessTokenScope(String accessTokenScope) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf audience(String audience) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf responseHeader(List<String> responseHeader) {
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public DelegatedAdminHttpServletExtensionResponseAllOf correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the DelegatedAdminHttpServletExtensionResponseAllOf instance itself
   */
  public DelegatedAdminHttpServletExtensionResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DelegatedAdminHttpServletExtensionResponseAllOf delegatedAdminHttpServletExtensionResponseAllOf = (DelegatedAdminHttpServletExtensionResponseAllOf) o;
    return Objects.equals(this.description, delegatedAdminHttpServletExtensionResponseAllOf.description) &&
        Objects.equals(this.schemas, delegatedAdminHttpServletExtensionResponseAllOf.schemas) &&
        Objects.equals(this.id, delegatedAdminHttpServletExtensionResponseAllOf.id) &&
        Objects.equals(this.basicAuthEnabled, delegatedAdminHttpServletExtensionResponseAllOf.basicAuthEnabled) &&
        Objects.equals(this.identityMapper, delegatedAdminHttpServletExtensionResponseAllOf.identityMapper) &&
        Objects.equals(this.accessTokenValidator, delegatedAdminHttpServletExtensionResponseAllOf.accessTokenValidator) &&
        Objects.equals(this.accessTokenScope, delegatedAdminHttpServletExtensionResponseAllOf.accessTokenScope) &&
        Objects.equals(this.audience, delegatedAdminHttpServletExtensionResponseAllOf.audience) &&
        Objects.equals(this.crossOriginPolicy, delegatedAdminHttpServletExtensionResponseAllOf.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, delegatedAdminHttpServletExtensionResponseAllOf.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, delegatedAdminHttpServletExtensionResponseAllOf.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, delegatedAdminHttpServletExtensionResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, basicAuthEnabled, identityMapper, accessTokenValidator, accessTokenScope, audience, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DelegatedAdminHttpServletExtensionResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DelegatedAdminHttpServletExtensionResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DelegatedAdminHttpServletExtensionResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DelegatedAdminHttpServletExtensionResponseAllOf is not found in the empty JSON string", DelegatedAdminHttpServletExtensionResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DelegatedAdminHttpServletExtensionResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DelegatedAdminHttpServletExtensionResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DelegatedAdminHttpServletExtensionResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DelegatedAdminHttpServletExtensionResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<DelegatedAdminHttpServletExtensionResponseAllOf>() {
           @Override
           public void write(JsonWriter out, DelegatedAdminHttpServletExtensionResponseAllOf value) throws IOException {
           ...
           @Override
           public DelegatedAdminHttpServletExtensionResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DelegatedAdminHttpServletExtensionResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DelegatedAdminHttpServletExtensionResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DelegatedAdminHttpServletExtensionResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to DelegatedAdminHttpServletExtensionResponseAllOf
  */
  public static DelegatedAdminHttpServletExtensionResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DelegatedAdminHttpServletExtensionResponseAllOf.class);
  }

 /**
  * Convert an instance of DelegatedAdminHttpServletExtensionResponseAllOf to an JSON string
  *
  * @return JSON string
  */
