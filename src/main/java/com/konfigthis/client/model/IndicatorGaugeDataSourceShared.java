...
public class IndicatorGaugeDataSourceShared {
  ...
  public IndicatorGaugeDataSourceShared() {
  }

  public IndicatorGaugeDataSourceShared description(String description) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared schemas(List<EnumindicatorGaugeDataSourceSchemaUrn> schemas) {
  ...
  public IndicatorGaugeDataSourceShared addSchemasItem(EnumindicatorGaugeDataSourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared additionalText(String additionalText) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared monitorAttribute(String monitorAttribute) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared includeFilter(String includeFilter) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared resourceAttribute(String resourceAttribute) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared resourceType(String resourceType) {
  ...
  **/
  ...
  public IndicatorGaugeDataSourceShared minimumUpdateInterval(String minimumUpdateInterval) {
  ...
  **/
   ...
   * @return the IndicatorGaugeDataSourceShared instance itself
   */
  public IndicatorGaugeDataSourceShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    IndicatorGaugeDataSourceShared indicatorGaugeDataSourceShared = (IndicatorGaugeDataSourceShared) o;
    return Objects.equals(this.description, indicatorGaugeDataSourceShared.description) &&
        Objects.equals(this.schemas, indicatorGaugeDataSourceShared.schemas) &&
        Objects.equals(this.additionalText, indicatorGaugeDataSourceShared.additionalText) &&
        Objects.equals(this.monitorObjectclass, indicatorGaugeDataSourceShared.monitorObjectclass) &&
        Objects.equals(this.monitorAttribute, indicatorGaugeDataSourceShared.monitorAttribute) &&
        Objects.equals(this.includeFilter, indicatorGaugeDataSourceShared.includeFilter) &&
        Objects.equals(this.resourceAttribute, indicatorGaugeDataSourceShared.resourceAttribute) &&
        Objects.equals(this.resourceType, indicatorGaugeDataSourceShared.resourceType) &&
        Objects.equals(this.minimumUpdateInterval, indicatorGaugeDataSourceShared.minimumUpdateInterval)&&
        Objects.equals(this.additionalProperties, indicatorGaugeDataSourceShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, additionalText, monitorObjectclass, monitorAttribute, includeFilter, resourceAttribute, resourceType, minimumUpdateInterval, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IndicatorGaugeDataSourceShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to IndicatorGaugeDataSourceShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!IndicatorGaugeDataSourceShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in IndicatorGaugeDataSourceShared is not found in the empty JSON string", IndicatorGaugeDataSourceShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : IndicatorGaugeDataSourceShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!IndicatorGaugeDataSourceShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'IndicatorGaugeDataSourceShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<IndicatorGaugeDataSourceShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(IndicatorGaugeDataSourceShared.class));

       return (TypeAdapter<T>) new TypeAdapter<IndicatorGaugeDataSourceShared>() {
           @Override
           public void write(JsonWriter out, IndicatorGaugeDataSourceShared value) throws IOException {
           ...
           @Override
           public IndicatorGaugeDataSourceShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             IndicatorGaugeDataSourceShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of IndicatorGaugeDataSourceShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of IndicatorGaugeDataSourceShared
  * @throws IOException if the JSON string is invalid with respect to IndicatorGaugeDataSourceShared
  */
  public static IndicatorGaugeDataSourceShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, IndicatorGaugeDataSourceShared.class);
  }

 /**
  * Convert an instance of IndicatorGaugeDataSourceShared to an JSON string
  *
  * @return JSON string
  */
