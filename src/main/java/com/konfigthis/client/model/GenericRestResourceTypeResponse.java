...
import com.konfigthis.client.model.EnumgenericRestResourceTypeSchemaUrn;
...
public class GenericRestResourceTypeResponse {
  ...
  private List<EnumgenericRestResourceTypeSchemaUrn> schemas = new ArrayList<>();
  ...
  public GenericRestResourceTypeResponse() {
  }

  public GenericRestResourceTypeResponse id(String id) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse description(String description) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse schemas(List<EnumgenericRestResourceTypeSchemaUrn> schemas) {
  ...
  public GenericRestResourceTypeResponse addSchemasItem(EnumgenericRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumgenericRestResourceTypeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumgenericRestResourceTypeSchemaUrn> schemas) {
  ...
  public GenericRestResourceTypeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public GenericRestResourceTypeResponse addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse includeFilter(List<String> includeFilter) {
  ...
  public GenericRestResourceTypeResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse parentDN(String parentDN) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public GenericRestResourceTypeResponse addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public GenericRestResourceTypeResponse addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse displayName(String displayName) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GenericRestResourceTypeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GenericRestResourceTypeResponse instance itself
   */
  public GenericRestResourceTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenericRestResourceTypeResponse genericRestResourceTypeResponse = (GenericRestResourceTypeResponse) o;
    return Objects.equals(this.id, genericRestResourceTypeResponse.id) &&
        Objects.equals(this.description, genericRestResourceTypeResponse.description) &&
        Objects.equals(this.schemas, genericRestResourceTypeResponse.schemas) &&
        Objects.equals(this.enabled, genericRestResourceTypeResponse.enabled) &&
        Objects.equals(this.resourceEndpoint, genericRestResourceTypeResponse.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, genericRestResourceTypeResponse.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, genericRestResourceTypeResponse.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, genericRestResourceTypeResponse.searchBaseDN) &&
        Objects.equals(this.includeFilter, genericRestResourceTypeResponse.includeFilter) &&
        Objects.equals(this.parentDN, genericRestResourceTypeResponse.parentDN) &&
        Objects.equals(this.parentResourceType, genericRestResourceTypeResponse.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, genericRestResourceTypeResponse.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, genericRestResourceTypeResponse.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, genericRestResourceTypeResponse.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, genericRestResourceTypeResponse.updateConstructedAttribute) &&
        Objects.equals(this.displayName, genericRestResourceTypeResponse.displayName) &&
        Objects.equals(this.searchFilterPattern, genericRestResourceTypeResponse.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, genericRestResourceTypeResponse.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, genericRestResourceTypeResponse.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, genericRestResourceTypeResponse.delegatedAdminReportSizeLimit) &&
        Objects.equals(this.membersColumnName, genericRestResourceTypeResponse.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, genericRestResourceTypeResponse.nonmembersColumnName) &&
        Objects.equals(this.meta, genericRestResourceTypeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, genericRestResourceTypeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, genericRestResourceTypeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, membersColumnName, nonmembersColumnName, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenericRestResourceTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericRestResourceTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericRestResourceTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericRestResourceTypeResponse is not found in the empty JSON string", GenericRestResourceTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenericRestResourceTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenericRestResourceTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenericRestResourceTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenericRestResourceTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenericRestResourceTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GenericRestResourceTypeResponse>() {
           @Override
           public void write(JsonWriter out, GenericRestResourceTypeResponse value) throws IOException {
           ...
           @Override
           public GenericRestResourceTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenericRestResourceTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenericRestResourceTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenericRestResourceTypeResponse
  * @throws IOException if the JSON string is invalid with respect to GenericRestResourceTypeResponse
  */
  public static GenericRestResourceTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericRestResourceTypeResponse.class);
  }

 /**
  * Convert an instance of GenericRestResourceTypeResponse to an JSON string
  *
  * @return JSON string
  */
