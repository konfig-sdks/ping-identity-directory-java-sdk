...
import com.konfigthis.client.model.EnummemberVirtualAttributeSchemaUrn;
...
public class MemberVirtualAttributeResponse {
  ...
  private List<EnummemberVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public static final String SERIALIZED_NAME_ALLOW_RETRIEVING_MEMBERSHIP = "allowRetrievingMembership";
  @SerializedName(SERIALIZED_NAME_ALLOW_RETRIEVING_MEMBERSHIP)
  private Boolean allowRetrievingMembership;
  ...
  public MemberVirtualAttributeResponse() {
  }

  public MemberVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse schemas(List<EnummemberVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberVirtualAttributeResponse addSchemasItem(EnummemberVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnummemberVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnummemberVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse allowRetrievingMembership(Boolean allowRetrievingMembership) {
   ...
   * @return allowRetrievingMembership
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether to handle requests that request all values for the virtual attribute.")

  public Boolean getAllowRetrievingMembership() {
    return allowRetrievingMembership;
  }


  public void setAllowRetrievingMembership(Boolean allowRetrievingMembership) {
  ...
  public MemberVirtualAttributeResponse filter(List<String> filter) {
  ...
  public MemberVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public MemberVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public MemberVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public MemberVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MemberVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MemberVirtualAttributeResponse instance itself
   */
  public MemberVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MemberVirtualAttributeResponse memberVirtualAttributeResponse = (MemberVirtualAttributeResponse) o;
    return Objects.equals(this.id, memberVirtualAttributeResponse.id) &&
        Objects.equals(this.description, memberVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, memberVirtualAttributeResponse.schemas) &&
        Objects.equals(this.conflictBehavior, memberVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.allowRetrievingMembership, memberVirtualAttributeResponse.allowRetrievingMembership) &&
        Objects.equals(this.filter, memberVirtualAttributeResponse.filter) &&
        Objects.equals(this.allowIndexConflicts, memberVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.enabled, memberVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, memberVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, memberVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, memberVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.clientConnectionPolicy, memberVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, memberVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, memberVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, memberVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.meta, memberVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, memberVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, memberVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, conflictBehavior, allowRetrievingMembership, filter, allowIndexConflicts, enabled, attributeType, baseDN, groupDN, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MemberVirtualAttributeResponse {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    schemas: ").append(toIndentedString(schemas)).append("\n");
    sb.append("    conflictBehavior: ").append(toIndentedString(conflictBehavior)).append("\n");
    sb.append("    allowRetrievingMembership: ").append(toIndentedString(allowRetrievingMembership)).append("\n");
  ...
  static {
    ...
    openapiFields.add("allowRetrievingMembership");
    ...
    openapiRequiredFields.add("allowRetrievingMembership");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemberVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemberVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberVirtualAttributeResponse is not found in the empty JSON string", MemberVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MemberVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, MemberVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public MemberVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemberVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemberVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to MemberVirtualAttributeResponse
  */
  public static MemberVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of MemberVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
