...
import com.konfigthis.client.model.EnumjdbcBasedAccessLogPublisherSchemaUrn;
...
public class JdbcBasedAccessLogPublisherResponse {
  ...
  private List<EnumjdbcBasedAccessLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public JdbcBasedAccessLogPublisherResponse() {
  }

  public JdbcBasedAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse schemas(List<EnumjdbcBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public JdbcBasedAccessLogPublisherResponse addSchemasItem(EnumjdbcBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumjdbcBasedAccessLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumjdbcBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public JdbcBasedAccessLogPublisherResponse server(String server) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logFieldMapping(String logFieldMapping) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logTableName(String logTableName) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public JdbcBasedAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the JdbcBasedAccessLogPublisherResponse instance itself
   */
  public JdbcBasedAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JdbcBasedAccessLogPublisherResponse jdbcBasedAccessLogPublisherResponse = (JdbcBasedAccessLogPublisherResponse) o;
    return Objects.equals(this.id, jdbcBasedAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, jdbcBasedAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, jdbcBasedAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.server, jdbcBasedAccessLogPublisherResponse.server) &&
        Objects.equals(this.logFieldMapping, jdbcBasedAccessLogPublisherResponse.logFieldMapping) &&
        Objects.equals(this.logTableName, jdbcBasedAccessLogPublisherResponse.logTableName) &&
        Objects.equals(this.queueSize, jdbcBasedAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.logConnects, jdbcBasedAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, jdbcBasedAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, jdbcBasedAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, jdbcBasedAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, jdbcBasedAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, jdbcBasedAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logSearchEntries, jdbcBasedAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, jdbcBasedAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, jdbcBasedAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, jdbcBasedAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, jdbcBasedAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, jdbcBasedAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, jdbcBasedAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, jdbcBasedAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, jdbcBasedAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, jdbcBasedAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, jdbcBasedAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, jdbcBasedAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, jdbcBasedAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, jdbcBasedAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, jdbcBasedAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, jdbcBasedAccessLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, server, logFieldMapping, logTableName, queueSize, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JdbcBasedAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JdbcBasedAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JdbcBasedAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JdbcBasedAccessLogPublisherResponse is not found in the empty JSON string", JdbcBasedAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JdbcBasedAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JdbcBasedAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JdbcBasedAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JdbcBasedAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JdbcBasedAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<JdbcBasedAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, JdbcBasedAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public JdbcBasedAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JdbcBasedAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JdbcBasedAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JdbcBasedAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to JdbcBasedAccessLogPublisherResponse
  */
  public static JdbcBasedAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JdbcBasedAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of JdbcBasedAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
