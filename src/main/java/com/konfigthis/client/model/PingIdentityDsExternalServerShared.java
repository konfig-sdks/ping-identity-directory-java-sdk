...
public class PingIdentityDsExternalServerShared {
  ...
  public PingIdentityDsExternalServerShared() {
  }

  public PingIdentityDsExternalServerShared description(String description) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared schemas(List<EnumpingIdentityDsExternalServerSchemaUrn> schemas) {
  ...
  public PingIdentityDsExternalServerShared addSchemasItem(EnumpingIdentityDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared location(String location) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared password(String password) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared connectionSecurity(EnumexternalServerPingIdentityDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared authenticationMethod(EnumexternalServerPingIdentityDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public PingIdentityDsExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public PingIdentityDsExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the PingIdentityDsExternalServerShared instance itself
   */
  public PingIdentityDsExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingIdentityDsExternalServerShared pingIdentityDsExternalServerShared = (PingIdentityDsExternalServerShared) o;
    return Objects.equals(this.description, pingIdentityDsExternalServerShared.description) &&
        Objects.equals(this.schemas, pingIdentityDsExternalServerShared.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, pingIdentityDsExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, pingIdentityDsExternalServerShared.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, pingIdentityDsExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, pingIdentityDsExternalServerShared.serverPort) &&
        Objects.equals(this.location, pingIdentityDsExternalServerShared.location) &&
        Objects.equals(this.bindDN, pingIdentityDsExternalServerShared.bindDN) &&
        Objects.equals(this.password, pingIdentityDsExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, pingIdentityDsExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, pingIdentityDsExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, pingIdentityDsExternalServerShared.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, pingIdentityDsExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, pingIdentityDsExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, pingIdentityDsExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, pingIdentityDsExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, pingIdentityDsExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, pingIdentityDsExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, pingIdentityDsExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, pingIdentityDsExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, pingIdentityDsExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, pingIdentityDsExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, pingIdentityDsExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, pingIdentityDsExternalServerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class PingIdentityDsExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingIdentityDsExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingIdentityDsExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingIdentityDsExternalServerShared is not found in the empty JSON string", PingIdentityDsExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingIdentityDsExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingIdentityDsExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingIdentityDsExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingIdentityDsExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingIdentityDsExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PingIdentityDsExternalServerShared>() {
           @Override
           public void write(JsonWriter out, PingIdentityDsExternalServerShared value) throws IOException {
           ...
           @Override
           public PingIdentityDsExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingIdentityDsExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingIdentityDsExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingIdentityDsExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to PingIdentityDsExternalServerShared
  */
  public static PingIdentityDsExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingIdentityDsExternalServerShared.class);
  }

 /**
  * Convert an instance of PingIdentityDsExternalServerShared to an JSON string
  *
  * @return JSON string
  */
