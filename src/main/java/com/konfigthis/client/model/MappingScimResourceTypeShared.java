...
public class MappingScimResourceTypeShared {
  ...
  public MappingScimResourceTypeShared() {
  }

  public MappingScimResourceTypeShared description(String description) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared schemas(List<EnummappingScimResourceTypeSchemaUrn> schemas) {
  ...
  public MappingScimResourceTypeShared addSchemasItem(EnummappingScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared coreSchema(String coreSchema) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared requiredSchemaExtension(List<String> requiredSchemaExtension) {
  ...
  public MappingScimResourceTypeShared addRequiredSchemaExtensionItem(String requiredSchemaExtensionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared optionalSchemaExtension(List<String> optionalSchemaExtension) {
  ...
  public MappingScimResourceTypeShared addOptionalSchemaExtensionItem(String optionalSchemaExtensionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared endpoint(String endpoint) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public MappingScimResourceTypeShared addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public MappingScimResourceTypeShared addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared includeFilter(List<String> includeFilter) {
  ...
  public MappingScimResourceTypeShared addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public MappingScimResourceTypeShared addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeShared createDNPattern(String createDNPattern) {
  ...
  **/
   ...
   * @return the MappingScimResourceTypeShared instance itself
   */
  public MappingScimResourceTypeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MappingScimResourceTypeShared mappingScimResourceTypeShared = (MappingScimResourceTypeShared) o;
    return Objects.equals(this.description, mappingScimResourceTypeShared.description) &&
        Objects.equals(this.schemas, mappingScimResourceTypeShared.schemas) &&
        Objects.equals(this.coreSchema, mappingScimResourceTypeShared.coreSchema) &&
        Objects.equals(this.requiredSchemaExtension, mappingScimResourceTypeShared.requiredSchemaExtension) &&
        Objects.equals(this.optionalSchemaExtension, mappingScimResourceTypeShared.optionalSchemaExtension) &&
        Objects.equals(this.enabled, mappingScimResourceTypeShared.enabled) &&
        Objects.equals(this.endpoint, mappingScimResourceTypeShared.endpoint) &&
        Objects.equals(this.lookthroughLimit, mappingScimResourceTypeShared.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, mappingScimResourceTypeShared.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, mappingScimResourceTypeShared.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, mappingScimResourceTypeShared.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, mappingScimResourceTypeShared.includeBaseDN) &&
        Objects.equals(this.includeFilter, mappingScimResourceTypeShared.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, mappingScimResourceTypeShared.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, mappingScimResourceTypeShared.createDNPattern)&&
        Objects.equals(this.additionalProperties, mappingScimResourceTypeShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MappingScimResourceTypeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MappingScimResourceTypeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MappingScimResourceTypeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MappingScimResourceTypeShared is not found in the empty JSON string", MappingScimResourceTypeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MappingScimResourceTypeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MappingScimResourceTypeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MappingScimResourceTypeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MappingScimResourceTypeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MappingScimResourceTypeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<MappingScimResourceTypeShared>() {
           @Override
           public void write(JsonWriter out, MappingScimResourceTypeShared value) throws IOException {
           ...
           @Override
           public MappingScimResourceTypeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MappingScimResourceTypeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MappingScimResourceTypeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MappingScimResourceTypeShared
  * @throws IOException if the JSON string is invalid with respect to MappingScimResourceTypeShared
  */
  public static MappingScimResourceTypeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MappingScimResourceTypeShared.class);
  }

 /**
  * Convert an instance of MappingScimResourceTypeShared to an JSON string
  *
  * @return JSON string
  */
