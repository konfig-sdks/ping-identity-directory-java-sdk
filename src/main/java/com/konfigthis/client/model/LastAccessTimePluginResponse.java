...
public class LastAccessTimePluginResponse {
  ...
  private List<EnumlastAccessTimePluginSchemaUrn> schemas = new ArrayList<>();
  ...
  public LastAccessTimePluginResponse() {
  }

  public LastAccessTimePluginResponse description(String description) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse schemas(List<EnumlastAccessTimePluginSchemaUrn> schemas) {
  ...
  public LastAccessTimePluginResponse addSchemasItem(EnumlastAccessTimePluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse id(String id) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse maxUpdateFrequency(String maxUpdateFrequency) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse operationType(List<EnumpluginOperationTypeProp> operationType) {
  ...
  public LastAccessTimePluginResponse addOperationTypeItem(EnumpluginOperationTypeProp operationTypeItem) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse invokeForFailedBinds(Boolean invokeForFailedBinds) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse maxSearchResultEntriesToUpdate(Integer maxSearchResultEntriesToUpdate) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public LastAccessTimePluginResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the LastAccessTimePluginResponse instance itself
   */
  public LastAccessTimePluginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LastAccessTimePluginResponse lastAccessTimePluginResponse = (LastAccessTimePluginResponse) o;
    return Objects.equals(this.description, lastAccessTimePluginResponse.description) &&
        Objects.equals(this.schemas, lastAccessTimePluginResponse.schemas) &&
        Objects.equals(this.id, lastAccessTimePluginResponse.id) &&
        Objects.equals(this.maxUpdateFrequency, lastAccessTimePluginResponse.maxUpdateFrequency) &&
        Objects.equals(this.operationType, lastAccessTimePluginResponse.operationType) &&
        Objects.equals(this.invokeForFailedBinds, lastAccessTimePluginResponse.invokeForFailedBinds) &&
        Objects.equals(this.maxSearchResultEntriesToUpdate, lastAccessTimePluginResponse.maxSearchResultEntriesToUpdate) &&
        Objects.equals(this.requestCriteria, lastAccessTimePluginResponse.requestCriteria) &&
        Objects.equals(this.invokeForInternalOperations, lastAccessTimePluginResponse.invokeForInternalOperations) &&
        Objects.equals(this.enabled, lastAccessTimePluginResponse.enabled) &&
        Objects.equals(this.meta, lastAccessTimePluginResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, lastAccessTimePluginResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, lastAccessTimePluginResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, maxUpdateFrequency, operationType, invokeForFailedBinds, maxSearchResultEntriesToUpdate, requestCriteria, invokeForInternalOperations, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LastAccessTimePluginResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LastAccessTimePluginResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LastAccessTimePluginResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LastAccessTimePluginResponse is not found in the empty JSON string", LastAccessTimePluginResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LastAccessTimePluginResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LastAccessTimePluginResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LastAccessTimePluginResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LastAccessTimePluginResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LastAccessTimePluginResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<LastAccessTimePluginResponse>() {
           @Override
           public void write(JsonWriter out, LastAccessTimePluginResponse value) throws IOException {
           ...
           @Override
           public LastAccessTimePluginResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LastAccessTimePluginResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LastAccessTimePluginResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LastAccessTimePluginResponse
  * @throws IOException if the JSON string is invalid with respect to LastAccessTimePluginResponse
  */
  public static LastAccessTimePluginResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LastAccessTimePluginResponse.class);
  }

 /**
  * Convert an instance of LastAccessTimePluginResponse to an JSON string
  *
  * @return JSON string
  */
