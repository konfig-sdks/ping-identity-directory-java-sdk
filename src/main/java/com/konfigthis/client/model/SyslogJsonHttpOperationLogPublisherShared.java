...
public class SyslogJsonHttpOperationLogPublisherShared {
  ...
  public SyslogJsonHttpOperationLogPublisherShared() {
  }

  public SyslogJsonHttpOperationLogPublisherShared description(String description) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared schemas(List<EnumsyslogJsonHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonHttpOperationLogPublisherShared addSchemasItem(EnumsyslogJsonHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonHttpOperationLogPublisherShared addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logResults(Boolean logResults) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequestHeaders(EnumlogPublisherLogRequestHeadersProp logRequestHeaders) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared suppressedRequestHeaderName(List<String> suppressedRequestHeaderName) {
  ...
  public SyslogJsonHttpOperationLogPublisherShared addSuppressedRequestHeaderNameItem(String suppressedRequestHeaderNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logResponseHeaders(EnumlogPublisherLogResponseHeadersProp logResponseHeaders) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared suppressedResponseHeaderName(List<String> suppressedResponseHeaderName) {
  ...
  public SyslogJsonHttpOperationLogPublisherShared addSuppressedResponseHeaderNameItem(String suppressedResponseHeaderNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequestAuthorizationType(Boolean logRequestAuthorizationType) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequestCookieNames(Boolean logRequestCookieNames) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logResponseCookieNames(Boolean logResponseCookieNames) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequestParameters(EnumlogPublisherLogRequestParametersProp logRequestParameters) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared suppressedRequestParameterName(List<String> suppressedRequestParameterName) {
  ...
  public SyslogJsonHttpOperationLogPublisherShared addSuppressedRequestParameterNameItem(String suppressedRequestParameterNameItem) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRequestProtocol(Boolean logRequestProtocol) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared logRedirectURI(Boolean logRedirectURI) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonHttpOperationLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyslogJsonHttpOperationLogPublisherShared instance itself
   */
  public SyslogJsonHttpOperationLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonHttpOperationLogPublisherShared syslogJsonHttpOperationLogPublisherShared = (SyslogJsonHttpOperationLogPublisherShared) o;
    return Objects.equals(this.description, syslogJsonHttpOperationLogPublisherShared.description) &&
        Objects.equals(this.schemas, syslogJsonHttpOperationLogPublisherShared.schemas) &&
        Objects.equals(this.syslogExternalServer, syslogJsonHttpOperationLogPublisherShared.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonHttpOperationLogPublisherShared.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonHttpOperationLogPublisherShared.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonHttpOperationLogPublisherShared.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonHttpOperationLogPublisherShared.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonHttpOperationLogPublisherShared.queueSize) &&
        Objects.equals(this.logRequests, syslogJsonHttpOperationLogPublisherShared.logRequests) &&
        Objects.equals(this.logResults, syslogJsonHttpOperationLogPublisherShared.logResults) &&
        Objects.equals(this.includeProductName, syslogJsonHttpOperationLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonHttpOperationLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonHttpOperationLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonHttpOperationLogPublisherShared.includeThreadID) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, syslogJsonHttpOperationLogPublisherShared.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.logRequestHeaders, syslogJsonHttpOperationLogPublisherShared.logRequestHeaders) &&
        Objects.equals(this.suppressedRequestHeaderName, syslogJsonHttpOperationLogPublisherShared.suppressedRequestHeaderName) &&
        Objects.equals(this.logResponseHeaders, syslogJsonHttpOperationLogPublisherShared.logResponseHeaders) &&
        Objects.equals(this.suppressedResponseHeaderName, syslogJsonHttpOperationLogPublisherShared.suppressedResponseHeaderName) &&
        Objects.equals(this.logRequestAuthorizationType, syslogJsonHttpOperationLogPublisherShared.logRequestAuthorizationType) &&
        Objects.equals(this.logRequestCookieNames, syslogJsonHttpOperationLogPublisherShared.logRequestCookieNames) &&
        Objects.equals(this.logResponseCookieNames, syslogJsonHttpOperationLogPublisherShared.logResponseCookieNames) &&
        Objects.equals(this.logRequestParameters, syslogJsonHttpOperationLogPublisherShared.logRequestParameters) &&
        Objects.equals(this.suppressedRequestParameterName, syslogJsonHttpOperationLogPublisherShared.suppressedRequestParameterName) &&
        Objects.equals(this.logRequestProtocol, syslogJsonHttpOperationLogPublisherShared.logRequestProtocol) &&
        Objects.equals(this.logRedirectURI, syslogJsonHttpOperationLogPublisherShared.logRedirectURI) &&
        Objects.equals(this.writeMultiLineMessages, syslogJsonHttpOperationLogPublisherShared.writeMultiLineMessages) &&
        Objects.equals(this.enabled, syslogJsonHttpOperationLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonHttpOperationLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syslogJsonHttpOperationLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyslogJsonHttpOperationLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonHttpOperationLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonHttpOperationLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonHttpOperationLogPublisherShared is not found in the empty JSON string", SyslogJsonHttpOperationLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonHttpOperationLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonHttpOperationLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonHttpOperationLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonHttpOperationLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonHttpOperationLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonHttpOperationLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, SyslogJsonHttpOperationLogPublisherShared value) throws IOException {
           ...
           @Override
           public SyslogJsonHttpOperationLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonHttpOperationLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonHttpOperationLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonHttpOperationLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonHttpOperationLogPublisherShared
  */
  public static SyslogJsonHttpOperationLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonHttpOperationLogPublisherShared.class);
  }

 /**
  * Convert an instance of SyslogJsonHttpOperationLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
