...
public class AddSyslogBasedErrorLogPublisherRequest {
  ...
  public AddSyslogBasedErrorLogPublisherRequest() {
  }

  public AddSyslogBasedErrorLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest schemas(List<EnumsyslogBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public AddSyslogBasedErrorLogPublisherRequest addSchemasItem(EnumsyslogBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest syslogFacility(Integer syslogFacility) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public AddSyslogBasedErrorLogPublisherRequest addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest overrideSeverity(List<String> overrideSeverity) {
  ...
  public AddSyslogBasedErrorLogPublisherRequest addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public AddSyslogBasedErrorLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddSyslogBasedErrorLogPublisherRequest instance itself
   */
  public AddSyslogBasedErrorLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddSyslogBasedErrorLogPublisherRequest addSyslogBasedErrorLogPublisherRequest = (AddSyslogBasedErrorLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addSyslogBasedErrorLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addSyslogBasedErrorLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addSyslogBasedErrorLogPublisherRequest.schemas) &&
        Objects.equals(this.enabled, addSyslogBasedErrorLogPublisherRequest.enabled) &&
        Objects.equals(this.serverHostName, addSyslogBasedErrorLogPublisherRequest.serverHostName) &&
        Objects.equals(this.serverPort, addSyslogBasedErrorLogPublisherRequest.serverPort) &&
        Objects.equals(this.syslogFacility, addSyslogBasedErrorLogPublisherRequest.syslogFacility) &&
        Objects.equals(this.autoFlush, addSyslogBasedErrorLogPublisherRequest.autoFlush) &&
        Objects.equals(this.asynchronous, addSyslogBasedErrorLogPublisherRequest.asynchronous) &&
        Objects.equals(this.queueSize, addSyslogBasedErrorLogPublisherRequest.queueSize) &&
        Objects.equals(this.defaultSeverity, addSyslogBasedErrorLogPublisherRequest.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, addSyslogBasedErrorLogPublisherRequest.overrideSeverity) &&
        Objects.equals(this.loggingErrorBehavior, addSyslogBasedErrorLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addSyslogBasedErrorLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, enabled, serverHostName, serverPort, syslogFacility, autoFlush, asynchronous, queueSize, defaultSeverity, overrideSeverity, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSyslogBasedErrorLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddSyslogBasedErrorLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddSyslogBasedErrorLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSyslogBasedErrorLogPublisherRequest is not found in the empty JSON string", AddSyslogBasedErrorLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSyslogBasedErrorLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSyslogBasedErrorLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSyslogBasedErrorLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSyslogBasedErrorLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSyslogBasedErrorLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSyslogBasedErrorLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddSyslogBasedErrorLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddSyslogBasedErrorLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddSyslogBasedErrorLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddSyslogBasedErrorLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddSyslogBasedErrorLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddSyslogBasedErrorLogPublisherRequest
  */
  public static AddSyslogBasedErrorLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSyslogBasedErrorLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddSyslogBasedErrorLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
