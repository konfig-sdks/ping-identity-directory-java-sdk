...
public class ThirdPartyAccountStatusNotificationHandlerShared {
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared() {
  }

  public ThirdPartyAccountStatusNotificationHandlerShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared schemas(List<EnumthirdPartyAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared addSchemasItem(EnumthirdPartyAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public ThirdPartyAccountStatusNotificationHandlerShared accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the ThirdPartyAccountStatusNotificationHandlerShared instance itself
   */
  public ThirdPartyAccountStatusNotificationHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyAccountStatusNotificationHandlerShared thirdPartyAccountStatusNotificationHandlerShared = (ThirdPartyAccountStatusNotificationHandlerShared) o;
    return Objects.equals(this.description, thirdPartyAccountStatusNotificationHandlerShared.description) &&
        Objects.equals(this.schemas, thirdPartyAccountStatusNotificationHandlerShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyAccountStatusNotificationHandlerShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyAccountStatusNotificationHandlerShared.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyAccountStatusNotificationHandlerShared.enabled) &&
        Objects.equals(this.asynchronous, thirdPartyAccountStatusNotificationHandlerShared.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, thirdPartyAccountStatusNotificationHandlerShared.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, thirdPartyAccountStatusNotificationHandlerShared.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, thirdPartyAccountStatusNotificationHandlerShared.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, thirdPartyAccountStatusNotificationHandlerShared.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, thirdPartyAccountStatusNotificationHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyAccountStatusNotificationHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyAccountStatusNotificationHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyAccountStatusNotificationHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyAccountStatusNotificationHandlerShared is not found in the empty JSON string", ThirdPartyAccountStatusNotificationHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyAccountStatusNotificationHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyAccountStatusNotificationHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyAccountStatusNotificationHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyAccountStatusNotificationHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyAccountStatusNotificationHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyAccountStatusNotificationHandlerShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyAccountStatusNotificationHandlerShared value) throws IOException {
           ...
           @Override
           public ThirdPartyAccountStatusNotificationHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyAccountStatusNotificationHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyAccountStatusNotificationHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyAccountStatusNotificationHandlerShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyAccountStatusNotificationHandlerShared
  */
  public static ThirdPartyAccountStatusNotificationHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyAccountStatusNotificationHandlerShared.class);
  }

 /**
  * Convert an instance of ThirdPartyAccountStatusNotificationHandlerShared to an JSON string
  *
  * @return JSON string
  */
