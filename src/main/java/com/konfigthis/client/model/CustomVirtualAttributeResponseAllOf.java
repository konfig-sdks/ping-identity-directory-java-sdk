...
public class CustomVirtualAttributeResponseAllOf {
  ...
  private List<EnumcustomVirtualAttributeSchemaUrn> schemas = null;
  ...
  public CustomVirtualAttributeResponseAllOf() {
  }

  public CustomVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf schemas(List<EnumcustomVirtualAttributeSchemaUrn> schemas) {
  ...
  public CustomVirtualAttributeResponseAllOf addSchemasItem(EnumcustomVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public CustomVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public CustomVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public CustomVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public CustomVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the CustomVirtualAttributeResponseAllOf instance itself
   */
  public CustomVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomVirtualAttributeResponseAllOf customVirtualAttributeResponseAllOf = (CustomVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, customVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, customVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, customVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.enabled, customVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.attributeType, customVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.baseDN, customVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, customVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, customVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, customVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, customVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, customVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, customVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, customVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, customVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, customVirtualAttributeResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomVirtualAttributeResponseAllOf is not found in the empty JSON string", CustomVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, CustomVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public CustomVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CustomVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustomVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to CustomVirtualAttributeResponseAllOf
  */
  public static CustomVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of CustomVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
