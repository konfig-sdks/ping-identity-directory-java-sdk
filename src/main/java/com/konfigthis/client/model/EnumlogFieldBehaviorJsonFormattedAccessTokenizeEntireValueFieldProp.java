 ...
 */
@JsonAdapter(EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp.Adapter.class)public enum EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp {
  ...
  EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp(String value) {
    this.value = value;
  }
  ...
  public static EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp fromValue(String value) {
    for (EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp b : EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumlogFieldBehaviorJsonFormattedAccessTokenizeEntireValueFieldProp.fromValue(value);
    }
  }
}
