...
public class AddJsonFieldConstraintsRequest {
  ...
  public AddJsonFieldConstraintsRequest() {
  }

  public AddJsonFieldConstraintsRequest jsonField(String jsonField) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest description(String description) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest schemas(List<EnumjsonFieldConstraintsSchemaUrn> schemas) {
  ...
  public AddJsonFieldConstraintsRequest addSchemasItem(EnumjsonFieldConstraintsSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest valueType(EnumjsonFieldConstraintsValueTypeProp valueType) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest isRequired(Boolean isRequired) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest isArray(EnumjsonFieldConstraintsIsArrayProp isArray) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest allowNullValue(Boolean allowNullValue) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest allowEmptyObject(Boolean allowEmptyObject) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest indexValues(Boolean indexValues) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest indexEntryLimit(Integer indexEntryLimit) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest primeIndex(Boolean primeIndex) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest cacheMode(EnumjsonFieldConstraintsCacheModeProp cacheMode) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest tokenizeValues(Boolean tokenizeValues) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest allowedValue(List<String> allowedValue) {
  ...
  public AddJsonFieldConstraintsRequest addAllowedValueItem(String allowedValueItem) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest allowedValueRegularExpression(List<String> allowedValueRegularExpression) {
  ...
  public AddJsonFieldConstraintsRequest addAllowedValueRegularExpressionItem(String allowedValueRegularExpressionItem) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest minimumNumericValue(String minimumNumericValue) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest maximumNumericValue(String maximumNumericValue) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest minimumValueLength(Integer minimumValueLength) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest maximumValueLength(Integer maximumValueLength) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest minimumValueCount(Integer minimumValueCount) {
  ...
  **/
  ...
  public AddJsonFieldConstraintsRequest maximumValueCount(Integer maximumValueCount) {
  ...
  **/
   ...
   * @return the AddJsonFieldConstraintsRequest instance itself
   */
  public AddJsonFieldConstraintsRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddJsonFieldConstraintsRequest addJsonFieldConstraintsRequest = (AddJsonFieldConstraintsRequest) o;
    return Objects.equals(this.jsonField, addJsonFieldConstraintsRequest.jsonField) &&
        Objects.equals(this.description, addJsonFieldConstraintsRequest.description) &&
        Objects.equals(this.schemas, addJsonFieldConstraintsRequest.schemas) &&
        Objects.equals(this.valueType, addJsonFieldConstraintsRequest.valueType) &&
        Objects.equals(this.isRequired, addJsonFieldConstraintsRequest.isRequired) &&
        Objects.equals(this.isArray, addJsonFieldConstraintsRequest.isArray) &&
        Objects.equals(this.allowNullValue, addJsonFieldConstraintsRequest.allowNullValue) &&
        Objects.equals(this.allowEmptyObject, addJsonFieldConstraintsRequest.allowEmptyObject) &&
        Objects.equals(this.indexValues, addJsonFieldConstraintsRequest.indexValues) &&
        Objects.equals(this.indexEntryLimit, addJsonFieldConstraintsRequest.indexEntryLimit) &&
        Objects.equals(this.primeIndex, addJsonFieldConstraintsRequest.primeIndex) &&
        Objects.equals(this.cacheMode, addJsonFieldConstraintsRequest.cacheMode) &&
        Objects.equals(this.tokenizeValues, addJsonFieldConstraintsRequest.tokenizeValues) &&
        Objects.equals(this.allowedValue, addJsonFieldConstraintsRequest.allowedValue) &&
        Objects.equals(this.allowedValueRegularExpression, addJsonFieldConstraintsRequest.allowedValueRegularExpression) &&
        Objects.equals(this.minimumNumericValue, addJsonFieldConstraintsRequest.minimumNumericValue) &&
        Objects.equals(this.maximumNumericValue, addJsonFieldConstraintsRequest.maximumNumericValue) &&
        Objects.equals(this.minimumValueLength, addJsonFieldConstraintsRequest.minimumValueLength) &&
        Objects.equals(this.maximumValueLength, addJsonFieldConstraintsRequest.maximumValueLength) &&
        Objects.equals(this.minimumValueCount, addJsonFieldConstraintsRequest.minimumValueCount) &&
        Objects.equals(this.maximumValueCount, addJsonFieldConstraintsRequest.maximumValueCount)&&
        Objects.equals(this.additionalProperties, addJsonFieldConstraintsRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(jsonField, description, schemas, valueType, isRequired, isArray, allowNullValue, allowEmptyObject, indexValues, indexEntryLimit, primeIndex, cacheMode, tokenizeValues, allowedValue, allowedValueRegularExpression, minimumNumericValue, maximumNumericValue, minimumValueLength, maximumValueLength, minimumValueCount, maximumValueCount, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddJsonFieldConstraintsRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddJsonFieldConstraintsRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddJsonFieldConstraintsRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddJsonFieldConstraintsRequest is not found in the empty JSON string", AddJsonFieldConstraintsRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddJsonFieldConstraintsRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddJsonFieldConstraintsRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddJsonFieldConstraintsRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddJsonFieldConstraintsRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddJsonFieldConstraintsRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddJsonFieldConstraintsRequest>() {
           @Override
           public void write(JsonWriter out, AddJsonFieldConstraintsRequest value) throws IOException {
           ...
           @Override
           public AddJsonFieldConstraintsRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddJsonFieldConstraintsRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddJsonFieldConstraintsRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddJsonFieldConstraintsRequest
  * @throws IOException if the JSON string is invalid with respect to AddJsonFieldConstraintsRequest
  */
  public static AddJsonFieldConstraintsRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddJsonFieldConstraintsRequest.class);
  }

 /**
  * Convert an instance of AddJsonFieldConstraintsRequest to an JSON string
  *
  * @return JSON string
  */
