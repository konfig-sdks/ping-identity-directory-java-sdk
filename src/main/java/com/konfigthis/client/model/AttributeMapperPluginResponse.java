...
public class AttributeMapperPluginResponse {
  ...
  public AttributeMapperPluginResponse() {
  }

  public AttributeMapperPluginResponse id(String id) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse description(String description) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse schemas(List<EnumattributeMapperPluginSchemaUrn> schemas) {
  ...
  public AttributeMapperPluginResponse addSchemasItem(EnumattributeMapperPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public AttributeMapperPluginResponse addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse sourceAttribute(String sourceAttribute) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse targetAttribute(String targetAttribute) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse enableControlMapping(Boolean enableControlMapping) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether mapping should be applied to attribute types that may be present in specific controls. If enabled, attribute mapping will only be applied for control types which are specifically supported by the attribute mapper plugin.")
  ...
  public AttributeMapperPluginResponse alwaysMapResponses(Boolean alwaysMapResponses) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the target attribute in response messages should always be remapped back to the source attribute. If this is \"false\", then the mapping will be performed for a response message only if one or more elements of the associated request are mapped. Otherwise, the mapping will be performed for all responses regardless of whether the mapping was applied to the request.")
  ...
  public AttributeMapperPluginResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public AttributeMapperPluginResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the AttributeMapperPluginResponse instance itself
   */
  public AttributeMapperPluginResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AttributeMapperPluginResponse attributeMapperPluginResponse = (AttributeMapperPluginResponse) o;
    return Objects.equals(this.id, attributeMapperPluginResponse.id) &&
        Objects.equals(this.description, attributeMapperPluginResponse.description) &&
        Objects.equals(this.schemas, attributeMapperPluginResponse.schemas) &&
        Objects.equals(this.pluginType, attributeMapperPluginResponse.pluginType) &&
        Objects.equals(this.sourceAttribute, attributeMapperPluginResponse.sourceAttribute) &&
        Objects.equals(this.targetAttribute, attributeMapperPluginResponse.targetAttribute) &&
        Objects.equals(this.enableControlMapping, attributeMapperPluginResponse.enableControlMapping) &&
        Objects.equals(this.alwaysMapResponses, attributeMapperPluginResponse.alwaysMapResponses) &&
        Objects.equals(this.enabled, attributeMapperPluginResponse.enabled) &&
        Objects.equals(this.invokeForInternalOperations, attributeMapperPluginResponse.invokeForInternalOperations) &&
        Objects.equals(this.meta, attributeMapperPluginResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, attributeMapperPluginResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, attributeMapperPluginResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, pluginType, sourceAttribute, targetAttribute, enableControlMapping, alwaysMapResponses, enabled, invokeForInternalOperations, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AttributeMapperPluginResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttributeMapperPluginResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AttributeMapperPluginResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttributeMapperPluginResponse is not found in the empty JSON string", AttributeMapperPluginResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AttributeMapperPluginResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttributeMapperPluginResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttributeMapperPluginResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttributeMapperPluginResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttributeMapperPluginResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AttributeMapperPluginResponse>() {
           @Override
           public void write(JsonWriter out, AttributeMapperPluginResponse value) throws IOException {
           ...
           @Override
           public AttributeMapperPluginResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AttributeMapperPluginResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AttributeMapperPluginResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttributeMapperPluginResponse
  * @throws IOException if the JSON string is invalid with respect to AttributeMapperPluginResponse
  */
  public static AttributeMapperPluginResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttributeMapperPluginResponse.class);
  }

 /**
  * Convert an instance of AttributeMapperPluginResponse to an JSON string
  *
  * @return JSON string
  */
