...
public class DelayRecurringTaskResponse {
  ...
  public DelayRecurringTaskResponse() {
  }

  public DelayRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse schemas(List<EnumdelayRecurringTaskSchemaUrn> schemas) {
  ...
  public DelayRecurringTaskResponse addSchemasItem(EnumdelayRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse sleepDuration(String sleepDuration) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse durationToWaitForWorkQueueIdle(String durationToWaitForWorkQueueIdle) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse ldapURLForSearchExpectedToReturnEntries(List<String> ldapURLForSearchExpectedToReturnEntries) {
  ...
  public DelayRecurringTaskResponse addLdapURLForSearchExpectedToReturnEntriesItem(String ldapURLForSearchExpectedToReturnEntriesItem) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse searchInterval(String searchInterval) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse searchTimeLimit(String searchTimeLimit) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse durationToWaitForSearchToReturnEntries(String durationToWaitForSearchToReturnEntries) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse taskReturnStateIfTimeoutIsEncountered(EnumrecurringTaskTaskReturnStateIfTimeoutIsEncounteredProp taskReturnStateIfTimeoutIsEncountered) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public DelayRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public DelayRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public DelayRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DelayRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DelayRecurringTaskResponse instance itself
   */
  public DelayRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DelayRecurringTaskResponse delayRecurringTaskResponse = (DelayRecurringTaskResponse) o;
    return Objects.equals(this.id, delayRecurringTaskResponse.id) &&
        Objects.equals(this.description, delayRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, delayRecurringTaskResponse.schemas) &&
        Objects.equals(this.sleepDuration, delayRecurringTaskResponse.sleepDuration) &&
        Objects.equals(this.durationToWaitForWorkQueueIdle, delayRecurringTaskResponse.durationToWaitForWorkQueueIdle) &&
        Objects.equals(this.ldapURLForSearchExpectedToReturnEntries, delayRecurringTaskResponse.ldapURLForSearchExpectedToReturnEntries) &&
        Objects.equals(this.searchInterval, delayRecurringTaskResponse.searchInterval) &&
        Objects.equals(this.searchTimeLimit, delayRecurringTaskResponse.searchTimeLimit) &&
        Objects.equals(this.durationToWaitForSearchToReturnEntries, delayRecurringTaskResponse.durationToWaitForSearchToReturnEntries) &&
        Objects.equals(this.taskReturnStateIfTimeoutIsEncountered, delayRecurringTaskResponse.taskReturnStateIfTimeoutIsEncountered) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, delayRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, delayRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, delayRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, delayRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, delayRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, delayRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, delayRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, delayRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, delayRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, delayRecurringTaskResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, sleepDuration, durationToWaitForWorkQueueIdle, ldapURLForSearchExpectedToReturnEntries, searchInterval, searchTimeLimit, durationToWaitForSearchToReturnEntries, taskReturnStateIfTimeoutIsEncountered, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DelayRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DelayRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DelayRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DelayRecurringTaskResponse is not found in the empty JSON string", DelayRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DelayRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DelayRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DelayRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DelayRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DelayRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DelayRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, DelayRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public DelayRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DelayRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DelayRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DelayRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to DelayRecurringTaskResponse
  */
  public static DelayRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DelayRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of DelayRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
