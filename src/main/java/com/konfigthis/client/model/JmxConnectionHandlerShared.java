...
public class JmxConnectionHandlerShared {
  ...
  public JmxConnectionHandlerShared() {
  }

  public JmxConnectionHandlerShared description(String description) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared schemas(List<EnumjmxConnectionHandlerSchemaUrn> schemas) {
  ...
  public JmxConnectionHandlerShared addSchemasItem(EnumjmxConnectionHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared listenPort(Integer listenPort) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared allowedClient(List<String> allowedClient) {
  ...
  public JmxConnectionHandlerShared addAllowedClientItem(String allowedClientItem) {
  ...
  **/
  ...
  public JmxConnectionHandlerShared deniedClient(List<String> deniedClient) {
  ...
  public JmxConnectionHandlerShared addDeniedClientItem(String deniedClientItem) {
  ...
  **/
   ...
   * @return the JmxConnectionHandlerShared instance itself
   */
  public JmxConnectionHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JmxConnectionHandlerShared jmxConnectionHandlerShared = (JmxConnectionHandlerShared) o;
    return Objects.equals(this.description, jmxConnectionHandlerShared.description) &&
        Objects.equals(this.schemas, jmxConnectionHandlerShared.schemas) &&
        Objects.equals(this.listenPort, jmxConnectionHandlerShared.listenPort) &&
        Objects.equals(this.useSSL, jmxConnectionHandlerShared.useSSL) &&
        Objects.equals(this.sslCertNickname, jmxConnectionHandlerShared.sslCertNickname) &&
        Objects.equals(this.keyManagerProvider, jmxConnectionHandlerShared.keyManagerProvider) &&
        Objects.equals(this.enabled, jmxConnectionHandlerShared.enabled) &&
        Objects.equals(this.allowedClient, jmxConnectionHandlerShared.allowedClient) &&
        Objects.equals(this.deniedClient, jmxConnectionHandlerShared.deniedClient)&&
        Objects.equals(this.additionalProperties, jmxConnectionHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, listenPort, useSSL, sslCertNickname, keyManagerProvider, enabled, allowedClient, deniedClient, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JmxConnectionHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JmxConnectionHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JmxConnectionHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JmxConnectionHandlerShared is not found in the empty JSON string", JmxConnectionHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JmxConnectionHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JmxConnectionHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JmxConnectionHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JmxConnectionHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JmxConnectionHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JmxConnectionHandlerShared>() {
           @Override
           public void write(JsonWriter out, JmxConnectionHandlerShared value) throws IOException {
           ...
           @Override
           public JmxConnectionHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JmxConnectionHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JmxConnectionHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JmxConnectionHandlerShared
  * @throws IOException if the JSON string is invalid with respect to JmxConnectionHandlerShared
  */
  public static JmxConnectionHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JmxConnectionHandlerShared.class);
  }

 /**
  * Convert an instance of JmxConnectionHandlerShared to an JSON string
  *
  * @return JSON string
  */
