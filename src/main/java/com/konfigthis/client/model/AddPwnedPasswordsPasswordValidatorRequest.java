...
public class AddPwnedPasswordsPasswordValidatorRequest {
  ...
  public AddPwnedPasswordsPasswordValidatorRequest() {
  }

  public AddPwnedPasswordsPasswordValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest schemas(List<EnumpwnedPasswordsPasswordValidatorSchemaUrn> schemas) {
  ...
  public AddPwnedPasswordsPasswordValidatorRequest addSchemasItem(EnumpwnedPasswordsPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest pwnedPasswordsBaseURL(String pwnedPasswordsBaseURL) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest httpConnectTimeout(String httpConnectTimeout) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest httpResponseTimeout(String httpResponseTimeout) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest invokeForAdd(Boolean invokeForAdd) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest invokeForSelfChange(Boolean invokeForSelfChange) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest invokeForAdminReset(Boolean invokeForAdminReset) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest acceptPasswordOnServiceError(Boolean acceptPasswordOnServiceError) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public AddPwnedPasswordsPasswordValidatorRequest validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the AddPwnedPasswordsPasswordValidatorRequest instance itself
   */
  public AddPwnedPasswordsPasswordValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddPwnedPasswordsPasswordValidatorRequest addPwnedPasswordsPasswordValidatorRequest = (AddPwnedPasswordsPasswordValidatorRequest) o;
    return Objects.equals(this.validatorName, addPwnedPasswordsPasswordValidatorRequest.validatorName) &&
        Objects.equals(this.description, addPwnedPasswordsPasswordValidatorRequest.description) &&
        Objects.equals(this.schemas, addPwnedPasswordsPasswordValidatorRequest.schemas) &&
        Objects.equals(this.pwnedPasswordsBaseURL, addPwnedPasswordsPasswordValidatorRequest.pwnedPasswordsBaseURL) &&
        Objects.equals(this.httpProxyExternalServer, addPwnedPasswordsPasswordValidatorRequest.httpProxyExternalServer) &&
        Objects.equals(this.httpConnectTimeout, addPwnedPasswordsPasswordValidatorRequest.httpConnectTimeout) &&
        Objects.equals(this.httpResponseTimeout, addPwnedPasswordsPasswordValidatorRequest.httpResponseTimeout) &&
        Objects.equals(this.invokeForAdd, addPwnedPasswordsPasswordValidatorRequest.invokeForAdd) &&
        Objects.equals(this.invokeForSelfChange, addPwnedPasswordsPasswordValidatorRequest.invokeForSelfChange) &&
        Objects.equals(this.invokeForAdminReset, addPwnedPasswordsPasswordValidatorRequest.invokeForAdminReset) &&
        Objects.equals(this.acceptPasswordOnServiceError, addPwnedPasswordsPasswordValidatorRequest.acceptPasswordOnServiceError) &&
        Objects.equals(this.keyManagerProvider, addPwnedPasswordsPasswordValidatorRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addPwnedPasswordsPasswordValidatorRequest.trustManagerProvider) &&
        Objects.equals(this.enabled, addPwnedPasswordsPasswordValidatorRequest.enabled) &&
        Objects.equals(this.validatorRequirementDescription, addPwnedPasswordsPasswordValidatorRequest.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, addPwnedPasswordsPasswordValidatorRequest.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, addPwnedPasswordsPasswordValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, pwnedPasswordsBaseURL, httpProxyExternalServer, httpConnectTimeout, httpResponseTimeout, invokeForAdd, invokeForSelfChange, invokeForAdminReset, acceptPasswordOnServiceError, keyManagerProvider, trustManagerProvider, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddPwnedPasswordsPasswordValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddPwnedPasswordsPasswordValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddPwnedPasswordsPasswordValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddPwnedPasswordsPasswordValidatorRequest is not found in the empty JSON string", AddPwnedPasswordsPasswordValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddPwnedPasswordsPasswordValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddPwnedPasswordsPasswordValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddPwnedPasswordsPasswordValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddPwnedPasswordsPasswordValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddPwnedPasswordsPasswordValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddPwnedPasswordsPasswordValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddPwnedPasswordsPasswordValidatorRequest value) throws IOException {
           ...
           @Override
           public AddPwnedPasswordsPasswordValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddPwnedPasswordsPasswordValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddPwnedPasswordsPasswordValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddPwnedPasswordsPasswordValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddPwnedPasswordsPasswordValidatorRequest
  */
  public static AddPwnedPasswordsPasswordValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddPwnedPasswordsPasswordValidatorRequest.class);
  }

 /**
  * Convert an instance of AddPwnedPasswordsPasswordValidatorRequest to an JSON string
  *
  * @return JSON string
  */
