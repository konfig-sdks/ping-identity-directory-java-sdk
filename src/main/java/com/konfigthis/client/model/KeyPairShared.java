...
public class KeyPairShared {
  ...
  public KeyPairShared() {
  }

  public KeyPairShared schemas(List<EnumkeyPairSchemaUrn> schemas) {
  ...
  public KeyPairShared addSchemasItem(EnumkeyPairSchemaUrn schemasItem) {
  ...
  **/
  ...
  public KeyPairShared keyAlgorithm(EnumkeyPairKeyAlgorithmProp keyAlgorithm) {
  ...
  **/
  ...
  public KeyPairShared selfSignedCertificateValidity(String selfSignedCertificateValidity) {
  ...
  **/
  ...
  public KeyPairShared subjectDN(String subjectDN) {
  ...
  **/
  ...
  public KeyPairShared certificateChain(String certificateChain) {
  ...
  **/
  ...
  public KeyPairShared privateKey(String privateKey) {
  ...
  **/
   ...
   * @return the KeyPairShared instance itself
   */
  public KeyPairShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    KeyPairShared keyPairShared = (KeyPairShared) o;
    return Objects.equals(this.schemas, keyPairShared.schemas) &&
        Objects.equals(this.keyAlgorithm, keyPairShared.keyAlgorithm) &&
        Objects.equals(this.selfSignedCertificateValidity, keyPairShared.selfSignedCertificateValidity) &&
        Objects.equals(this.subjectDN, keyPairShared.subjectDN) &&
        Objects.equals(this.certificateChain, keyPairShared.certificateChain) &&
        Objects.equals(this.privateKey, keyPairShared.privateKey)&&
        Objects.equals(this.additionalProperties, keyPairShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, keyAlgorithm, selfSignedCertificateValidity, subjectDN, certificateChain, privateKey, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class KeyPairShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to KeyPairShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!KeyPairShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in KeyPairShared is not found in the empty JSON string", KeyPairShared.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!KeyPairShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'KeyPairShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<KeyPairShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(KeyPairShared.class));

       return (TypeAdapter<T>) new TypeAdapter<KeyPairShared>() {
           @Override
           public void write(JsonWriter out, KeyPairShared value) throws IOException {
           ...
           @Override
           public KeyPairShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             KeyPairShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of KeyPairShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of KeyPairShared
  * @throws IOException if the JSON string is invalid with respect to KeyPairShared
  */
  public static KeyPairShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, KeyPairShared.class);
  }

 /**
  * Convert an instance of KeyPairShared to an JSON string
  *
  * @return JSON string
  */
