...
public class AddAvailabilityStateHttpServletExtensionRequest {
  ...
  public AddAvailabilityStateHttpServletExtensionRequest() {
  }

  public AddAvailabilityStateHttpServletExtensionRequest extensionName(String extensionName) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest description(String description) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest schemas(List<EnumavailabilityStateHttpServletExtensionSchemaUrn> schemas) {
  ...
  public AddAvailabilityStateHttpServletExtensionRequest addSchemasItem(EnumavailabilityStateHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest baseContextPath(String baseContextPath) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest availableStatusCode(Integer availableStatusCode) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest degradedStatusCode(Integer degradedStatusCode) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest unavailableStatusCode(Integer unavailableStatusCode) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest overrideStatusCode(Integer overrideStatusCode) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest includeResponseBody(Boolean includeResponseBody) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest additionalResponseContents(String additionalResponseContents) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest responseHeader(List<String> responseHeader) {
  ...
  public AddAvailabilityStateHttpServletExtensionRequest addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public AddAvailabilityStateHttpServletExtensionRequest correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the AddAvailabilityStateHttpServletExtensionRequest instance itself
   */
  public AddAvailabilityStateHttpServletExtensionRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAvailabilityStateHttpServletExtensionRequest addAvailabilityStateHttpServletExtensionRequest = (AddAvailabilityStateHttpServletExtensionRequest) o;
    return Objects.equals(this.extensionName, addAvailabilityStateHttpServletExtensionRequest.extensionName) &&
        Objects.equals(this.description, addAvailabilityStateHttpServletExtensionRequest.description) &&
        Objects.equals(this.schemas, addAvailabilityStateHttpServletExtensionRequest.schemas) &&
        Objects.equals(this.baseContextPath, addAvailabilityStateHttpServletExtensionRequest.baseContextPath) &&
        Objects.equals(this.availableStatusCode, addAvailabilityStateHttpServletExtensionRequest.availableStatusCode) &&
        Objects.equals(this.degradedStatusCode, addAvailabilityStateHttpServletExtensionRequest.degradedStatusCode) &&
        Objects.equals(this.unavailableStatusCode, addAvailabilityStateHttpServletExtensionRequest.unavailableStatusCode) &&
        Objects.equals(this.overrideStatusCode, addAvailabilityStateHttpServletExtensionRequest.overrideStatusCode) &&
        Objects.equals(this.includeResponseBody, addAvailabilityStateHttpServletExtensionRequest.includeResponseBody) &&
        Objects.equals(this.additionalResponseContents, addAvailabilityStateHttpServletExtensionRequest.additionalResponseContents) &&
        Objects.equals(this.crossOriginPolicy, addAvailabilityStateHttpServletExtensionRequest.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, addAvailabilityStateHttpServletExtensionRequest.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, addAvailabilityStateHttpServletExtensionRequest.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, addAvailabilityStateHttpServletExtensionRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extensionName, description, schemas, baseContextPath, availableStatusCode, degradedStatusCode, unavailableStatusCode, overrideStatusCode, includeResponseBody, additionalResponseContents, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAvailabilityStateHttpServletExtensionRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAvailabilityStateHttpServletExtensionRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAvailabilityStateHttpServletExtensionRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAvailabilityStateHttpServletExtensionRequest is not found in the empty JSON string", AddAvailabilityStateHttpServletExtensionRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAvailabilityStateHttpServletExtensionRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAvailabilityStateHttpServletExtensionRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAvailabilityStateHttpServletExtensionRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAvailabilityStateHttpServletExtensionRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAvailabilityStateHttpServletExtensionRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAvailabilityStateHttpServletExtensionRequest>() {
           @Override
           public void write(JsonWriter out, AddAvailabilityStateHttpServletExtensionRequest value) throws IOException {
           ...
           @Override
           public AddAvailabilityStateHttpServletExtensionRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAvailabilityStateHttpServletExtensionRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAvailabilityStateHttpServletExtensionRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAvailabilityStateHttpServletExtensionRequest
  * @throws IOException if the JSON string is invalid with respect to AddAvailabilityStateHttpServletExtensionRequest
  */
  public static AddAvailabilityStateHttpServletExtensionRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAvailabilityStateHttpServletExtensionRequest.class);
  }

 /**
  * Convert an instance of AddAvailabilityStateHttpServletExtensionRequest to an JSON string
  *
  * @return JSON string
  */
