...
public class LeaveLockdownModeRecurringTaskShared {
  ...
  public LeaveLockdownModeRecurringTaskShared() {
  }

  public LeaveLockdownModeRecurringTaskShared description(String description) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared schemas(List<EnumleaveLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public LeaveLockdownModeRecurringTaskShared addSchemasItem(EnumleaveLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared reason(String reason) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared emailOnStart(List<String> emailOnStart) {
  ...
  public LeaveLockdownModeRecurringTaskShared addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public LeaveLockdownModeRecurringTaskShared addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared emailOnFailure(List<String> emailOnFailure) {
  ...
  public LeaveLockdownModeRecurringTaskShared addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public LeaveLockdownModeRecurringTaskShared alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
   ...
   * @return the LeaveLockdownModeRecurringTaskShared instance itself
   */
  public LeaveLockdownModeRecurringTaskShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    LeaveLockdownModeRecurringTaskShared leaveLockdownModeRecurringTaskShared = (LeaveLockdownModeRecurringTaskShared) o;
    return Objects.equals(this.description, leaveLockdownModeRecurringTaskShared.description) &&
        Objects.equals(this.schemas, leaveLockdownModeRecurringTaskShared.schemas) &&
        Objects.equals(this.reason, leaveLockdownModeRecurringTaskShared.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, leaveLockdownModeRecurringTaskShared.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, leaveLockdownModeRecurringTaskShared.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, leaveLockdownModeRecurringTaskShared.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, leaveLockdownModeRecurringTaskShared.emailOnFailure) &&
        Objects.equals(this.alertOnStart, leaveLockdownModeRecurringTaskShared.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, leaveLockdownModeRecurringTaskShared.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, leaveLockdownModeRecurringTaskShared.alertOnFailure)&&
        Objects.equals(this.additionalProperties, leaveLockdownModeRecurringTaskShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, reason, cancelOnTaskDependencyFailure, emailOnStart, emailOnSuccess, emailOnFailure, alertOnStart, alertOnSuccess, alertOnFailure, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class LeaveLockdownModeRecurringTaskShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to LeaveLockdownModeRecurringTaskShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LeaveLockdownModeRecurringTaskShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LeaveLockdownModeRecurringTaskShared is not found in the empty JSON string", LeaveLockdownModeRecurringTaskShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LeaveLockdownModeRecurringTaskShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LeaveLockdownModeRecurringTaskShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LeaveLockdownModeRecurringTaskShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LeaveLockdownModeRecurringTaskShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LeaveLockdownModeRecurringTaskShared.class));

       return (TypeAdapter<T>) new TypeAdapter<LeaveLockdownModeRecurringTaskShared>() {
           @Override
           public void write(JsonWriter out, LeaveLockdownModeRecurringTaskShared value) throws IOException {
           ...
           @Override
           public LeaveLockdownModeRecurringTaskShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LeaveLockdownModeRecurringTaskShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LeaveLockdownModeRecurringTaskShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LeaveLockdownModeRecurringTaskShared
  * @throws IOException if the JSON string is invalid with respect to LeaveLockdownModeRecurringTaskShared
  */
  public static LeaveLockdownModeRecurringTaskShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LeaveLockdownModeRecurringTaskShared.class);
  }

 /**
  * Convert an instance of LeaveLockdownModeRecurringTaskShared to an JSON string
  *
  * @return JSON string
  */
