...
public class AddAzureKeyVaultPassphraseProviderRequest {
  ...
  public AddAzureKeyVaultPassphraseProviderRequest() {
  }

  public AddAzureKeyVaultPassphraseProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest description(String description) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest schemas(List<EnumazureKeyVaultPassphraseProviderSchemaUrn> schemas) {
  ...
  public AddAzureKeyVaultPassphraseProviderRequest addSchemasItem(EnumazureKeyVaultPassphraseProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest keyVaultURI(String keyVaultURI) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest azureAuthenticationMethod(String azureAuthenticationMethod) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest secretName(String secretName) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest maxCacheDuration(String maxCacheDuration) {
  ...
  **/
  ...
  public AddAzureKeyVaultPassphraseProviderRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddAzureKeyVaultPassphraseProviderRequest instance itself
   */
  public AddAzureKeyVaultPassphraseProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAzureKeyVaultPassphraseProviderRequest addAzureKeyVaultPassphraseProviderRequest = (AddAzureKeyVaultPassphraseProviderRequest) o;
    return Objects.equals(this.providerName, addAzureKeyVaultPassphraseProviderRequest.providerName) &&
        Objects.equals(this.description, addAzureKeyVaultPassphraseProviderRequest.description) &&
        Objects.equals(this.schemas, addAzureKeyVaultPassphraseProviderRequest.schemas) &&
        Objects.equals(this.keyVaultURI, addAzureKeyVaultPassphraseProviderRequest.keyVaultURI) &&
        Objects.equals(this.azureAuthenticationMethod, addAzureKeyVaultPassphraseProviderRequest.azureAuthenticationMethod) &&
        Objects.equals(this.httpProxyExternalServer, addAzureKeyVaultPassphraseProviderRequest.httpProxyExternalServer) &&
        Objects.equals(this.secretName, addAzureKeyVaultPassphraseProviderRequest.secretName) &&
        Objects.equals(this.maxCacheDuration, addAzureKeyVaultPassphraseProviderRequest.maxCacheDuration) &&
        Objects.equals(this.enabled, addAzureKeyVaultPassphraseProviderRequest.enabled)&&
        Objects.equals(this.additionalProperties, addAzureKeyVaultPassphraseProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, description, schemas, keyVaultURI, azureAuthenticationMethod, httpProxyExternalServer, secretName, maxCacheDuration, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAzureKeyVaultPassphraseProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAzureKeyVaultPassphraseProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAzureKeyVaultPassphraseProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAzureKeyVaultPassphraseProviderRequest is not found in the empty JSON string", AddAzureKeyVaultPassphraseProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAzureKeyVaultPassphraseProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAzureKeyVaultPassphraseProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAzureKeyVaultPassphraseProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAzureKeyVaultPassphraseProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAzureKeyVaultPassphraseProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAzureKeyVaultPassphraseProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddAzureKeyVaultPassphraseProviderRequest value) throws IOException {
           ...
           @Override
           public AddAzureKeyVaultPassphraseProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAzureKeyVaultPassphraseProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAzureKeyVaultPassphraseProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAzureKeyVaultPassphraseProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddAzureKeyVaultPassphraseProviderRequest
  */
  public static AddAzureKeyVaultPassphraseProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAzureKeyVaultPassphraseProviderRequest.class);
  }

 /**
  * Convert an instance of AddAzureKeyVaultPassphraseProviderRequest to an JSON string
  *
  * @return JSON string
  */
