...
public class GroovyScriptedAccessLogPublisherResponse {
  ...
  public GroovyScriptedAccessLogPublisherResponse() {
  }

  public GroovyScriptedAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse schemas(List<EnumgroovyScriptedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public GroovyScriptedAccessLogPublisherResponse addSchemasItem(EnumgroovyScriptedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse scriptClass(String scriptClass) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse scriptArgument(List<String> scriptArgument) {
  ...
  public GroovyScriptedAccessLogPublisherResponse addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public GroovyScriptedAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the GroovyScriptedAccessLogPublisherResponse instance itself
   */
  public GroovyScriptedAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GroovyScriptedAccessLogPublisherResponse groovyScriptedAccessLogPublisherResponse = (GroovyScriptedAccessLogPublisherResponse) o;
    return Objects.equals(this.id, groovyScriptedAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, groovyScriptedAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, groovyScriptedAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.scriptClass, groovyScriptedAccessLogPublisherResponse.scriptClass) &&
        Objects.equals(this.scriptArgument, groovyScriptedAccessLogPublisherResponse.scriptArgument) &&
        Objects.equals(this.logConnects, groovyScriptedAccessLogPublisherResponse.logConnects) &&
        Objects.equals(this.logDisconnects, groovyScriptedAccessLogPublisherResponse.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, groovyScriptedAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, groovyScriptedAccessLogPublisherResponse.logClientCertificates) &&
        Objects.equals(this.logRequests, groovyScriptedAccessLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, groovyScriptedAccessLogPublisherResponse.logResults) &&
        Objects.equals(this.logSearchEntries, groovyScriptedAccessLogPublisherResponse.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, groovyScriptedAccessLogPublisherResponse.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, groovyScriptedAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, groovyScriptedAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, groovyScriptedAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, groovyScriptedAccessLogPublisherResponse.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, groovyScriptedAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, groovyScriptedAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, groovyScriptedAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, groovyScriptedAccessLogPublisherResponse.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, groovyScriptedAccessLogPublisherResponse.searchReferenceCriteria) &&
        Objects.equals(this.enabled, groovyScriptedAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, groovyScriptedAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, groovyScriptedAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, groovyScriptedAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, groovyScriptedAccessLogPublisherResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroovyScriptedAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GroovyScriptedAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GroovyScriptedAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GroovyScriptedAccessLogPublisherResponse is not found in the empty JSON string", GroovyScriptedAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GroovyScriptedAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GroovyScriptedAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GroovyScriptedAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GroovyScriptedAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GroovyScriptedAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<GroovyScriptedAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, GroovyScriptedAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public GroovyScriptedAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GroovyScriptedAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GroovyScriptedAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GroovyScriptedAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to GroovyScriptedAccessLogPublisherResponse
  */
  public static GroovyScriptedAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GroovyScriptedAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of GroovyScriptedAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
