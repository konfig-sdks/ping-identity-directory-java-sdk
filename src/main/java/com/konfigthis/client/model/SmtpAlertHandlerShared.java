...
public class SmtpAlertHandlerShared {
  ...
  public SmtpAlertHandlerShared() {
  }

  public SmtpAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared schemas(List<EnumsmtpAlertHandlerSchemaUrn> schemas) {
  ...
  public SmtpAlertHandlerShared addSchemasItem(EnumsmtpAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared senderAddress(String senderAddress) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared recipientAddress(List<String> recipientAddress) {
  ...
  public SmtpAlertHandlerShared addRecipientAddressItem(String recipientAddressItem) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared messageSubject(String messageSubject) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared messageBody(String messageBody) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared includeMonitorDataFilter(String includeMonitorDataFilter) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public SmtpAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public SmtpAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public SmtpAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public SmtpAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the SmtpAlertHandlerShared instance itself
   */
  public SmtpAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SmtpAlertHandlerShared smtpAlertHandlerShared = (SmtpAlertHandlerShared) o;
    return Objects.equals(this.description, smtpAlertHandlerShared.description) &&
        Objects.equals(this.schemas, smtpAlertHandlerShared.schemas) &&
        Objects.equals(this.asynchronous, smtpAlertHandlerShared.asynchronous) &&
        Objects.equals(this.senderAddress, smtpAlertHandlerShared.senderAddress) &&
        Objects.equals(this.recipientAddress, smtpAlertHandlerShared.recipientAddress) &&
        Objects.equals(this.messageSubject, smtpAlertHandlerShared.messageSubject) &&
        Objects.equals(this.messageBody, smtpAlertHandlerShared.messageBody) &&
        Objects.equals(this.includeMonitorDataFilter, smtpAlertHandlerShared.includeMonitorDataFilter) &&
        Objects.equals(this.enabled, smtpAlertHandlerShared.enabled) &&
        Objects.equals(this.enabledAlertSeverity, smtpAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, smtpAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, smtpAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, smtpAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, asynchronous, senderAddress, recipientAddress, messageSubject, messageBody, includeMonitorDataFilter, enabled, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SmtpAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SmtpAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SmtpAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SmtpAlertHandlerShared is not found in the empty JSON string", SmtpAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SmtpAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SmtpAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SmtpAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SmtpAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SmtpAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SmtpAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, SmtpAlertHandlerShared value) throws IOException {
           ...
           @Override
           public SmtpAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SmtpAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SmtpAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SmtpAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to SmtpAlertHandlerShared
  */
  public static SmtpAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SmtpAlertHandlerShared.class);
  }

 /**
  * Convert an instance of SmtpAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
