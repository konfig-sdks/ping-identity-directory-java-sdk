...
public class UuidAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumuuidAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public UuidAttributeSyntaxResponseAllOf() {
  }

  public UuidAttributeSyntaxResponseAllOf schemas(List<EnumuuidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public UuidAttributeSyntaxResponseAllOf addSchemasItem(EnumuuidAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public UuidAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public UuidAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public UuidAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the UuidAttributeSyntaxResponseAllOf instance itself
   */
  public UuidAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UuidAttributeSyntaxResponseAllOf uuidAttributeSyntaxResponseAllOf = (UuidAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, uuidAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, uuidAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, uuidAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, uuidAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, uuidAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, uuidAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, uuidAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, uuidAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UuidAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UuidAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UuidAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UuidAttributeSyntaxResponseAllOf is not found in the empty JSON string", UuidAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UuidAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UuidAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UuidAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UuidAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<UuidAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, UuidAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public UuidAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UuidAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UuidAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UuidAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to UuidAttributeSyntaxResponseAllOf
  */
  public static UuidAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UuidAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of UuidAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
