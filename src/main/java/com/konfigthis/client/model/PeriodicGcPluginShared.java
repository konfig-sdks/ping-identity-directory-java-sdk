...
public class PeriodicGcPluginShared {
  ...
  public PeriodicGcPluginShared() {
  }

  public PeriodicGcPluginShared description(String description) {
  ...
  **/
  ...
  public PeriodicGcPluginShared schemas(List<EnumperiodicGcPluginSchemaUrn> schemas) {
  ...
  public PeriodicGcPluginShared addSchemasItem(EnumperiodicGcPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PeriodicGcPluginShared pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public PeriodicGcPluginShared addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public PeriodicGcPluginShared invokeGCDayOfWeek(List<EnumpluginInvokeGCDayOfWeekProp> invokeGCDayOfWeek) {
  ...
  public PeriodicGcPluginShared addInvokeGCDayOfWeekItem(EnumpluginInvokeGCDayOfWeekProp invokeGCDayOfWeekItem) {
  ...
  **/
  ...
  public PeriodicGcPluginShared invokeGCTimeUtc(List<String> invokeGCTimeUtc) {
  ...
  public PeriodicGcPluginShared addInvokeGCTimeUtcItem(String invokeGCTimeUtcItem) {
  ...
  **/
  ...
  public PeriodicGcPluginShared delayAfterAlert(String delayAfterAlert) {
  ...
  **/
  ...
  public PeriodicGcPluginShared delayPostGC(String delayPostGC) {
  ...
  **/
  ...
  public PeriodicGcPluginShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public PeriodicGcPluginShared invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the PeriodicGcPluginShared instance itself
   */
  public PeriodicGcPluginShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PeriodicGcPluginShared periodicGcPluginShared = (PeriodicGcPluginShared) o;
    return Objects.equals(this.description, periodicGcPluginShared.description) &&
        Objects.equals(this.schemas, periodicGcPluginShared.schemas) &&
        Objects.equals(this.pluginType, periodicGcPluginShared.pluginType) &&
        Objects.equals(this.invokeGCDayOfWeek, periodicGcPluginShared.invokeGCDayOfWeek) &&
        Objects.equals(this.invokeGCTimeUtc, periodicGcPluginShared.invokeGCTimeUtc) &&
        Objects.equals(this.delayAfterAlert, periodicGcPluginShared.delayAfterAlert) &&
        Objects.equals(this.delayPostGC, periodicGcPluginShared.delayPostGC) &&
        Objects.equals(this.enabled, periodicGcPluginShared.enabled) &&
        Objects.equals(this.invokeForInternalOperations, periodicGcPluginShared.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, periodicGcPluginShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, pluginType, invokeGCDayOfWeek, invokeGCTimeUtc, delayAfterAlert, delayPostGC, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PeriodicGcPluginShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PeriodicGcPluginShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PeriodicGcPluginShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PeriodicGcPluginShared is not found in the empty JSON string", PeriodicGcPluginShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PeriodicGcPluginShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PeriodicGcPluginShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PeriodicGcPluginShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PeriodicGcPluginShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PeriodicGcPluginShared.class));

       return (TypeAdapter<T>) new TypeAdapter<PeriodicGcPluginShared>() {
           @Override
           public void write(JsonWriter out, PeriodicGcPluginShared value) throws IOException {
           ...
           @Override
           public PeriodicGcPluginShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PeriodicGcPluginShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PeriodicGcPluginShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PeriodicGcPluginShared
  * @throws IOException if the JSON string is invalid with respect to PeriodicGcPluginShared
  */
  public static PeriodicGcPluginShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PeriodicGcPluginShared.class);
  }

 /**
  * Convert an instance of PeriodicGcPluginShared to an JSON string
  *
  * @return JSON string
  */
