...
public class AddUniqueCharactersPasswordValidatorRequest {
  ...
  public AddUniqueCharactersPasswordValidatorRequest() {
  }

  public AddUniqueCharactersPasswordValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest schemas(List<EnumuniqueCharactersPasswordValidatorSchemaUrn> schemas) {
  ...
  public AddUniqueCharactersPasswordValidatorRequest addSchemasItem(EnumuniqueCharactersPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest minUniqueCharacters(Integer minUniqueCharacters) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest caseSensitiveValidation(Boolean caseSensitiveValidation) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public AddUniqueCharactersPasswordValidatorRequest validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the AddUniqueCharactersPasswordValidatorRequest instance itself
   */
  public AddUniqueCharactersPasswordValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddUniqueCharactersPasswordValidatorRequest addUniqueCharactersPasswordValidatorRequest = (AddUniqueCharactersPasswordValidatorRequest) o;
    return Objects.equals(this.validatorName, addUniqueCharactersPasswordValidatorRequest.validatorName) &&
        Objects.equals(this.description, addUniqueCharactersPasswordValidatorRequest.description) &&
        Objects.equals(this.schemas, addUniqueCharactersPasswordValidatorRequest.schemas) &&
        Objects.equals(this.minUniqueCharacters, addUniqueCharactersPasswordValidatorRequest.minUniqueCharacters) &&
        Objects.equals(this.caseSensitiveValidation, addUniqueCharactersPasswordValidatorRequest.caseSensitiveValidation) &&
        Objects.equals(this.enabled, addUniqueCharactersPasswordValidatorRequest.enabled) &&
        Objects.equals(this.validatorRequirementDescription, addUniqueCharactersPasswordValidatorRequest.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, addUniqueCharactersPasswordValidatorRequest.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, addUniqueCharactersPasswordValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, minUniqueCharacters, caseSensitiveValidation, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddUniqueCharactersPasswordValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddUniqueCharactersPasswordValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddUniqueCharactersPasswordValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUniqueCharactersPasswordValidatorRequest is not found in the empty JSON string", AddUniqueCharactersPasswordValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddUniqueCharactersPasswordValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUniqueCharactersPasswordValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUniqueCharactersPasswordValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUniqueCharactersPasswordValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUniqueCharactersPasswordValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUniqueCharactersPasswordValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddUniqueCharactersPasswordValidatorRequest value) throws IOException {
           ...
           @Override
           public AddUniqueCharactersPasswordValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddUniqueCharactersPasswordValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddUniqueCharactersPasswordValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddUniqueCharactersPasswordValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddUniqueCharactersPasswordValidatorRequest
  */
  public static AddUniqueCharactersPasswordValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUniqueCharactersPasswordValidatorRequest.class);
  }

 /**
  * Convert an instance of AddUniqueCharactersPasswordValidatorRequest to an JSON string
  *
  * @return JSON string
  */
