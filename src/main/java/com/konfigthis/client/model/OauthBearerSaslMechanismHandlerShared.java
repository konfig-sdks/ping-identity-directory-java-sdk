...
public class OauthBearerSaslMechanismHandlerShared {
  ...
  public OauthBearerSaslMechanismHandlerShared() {
  }

  public OauthBearerSaslMechanismHandlerShared description(String description) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared schemas(List<EnumoauthBearerSaslMechanismHandlerSchemaUrn> schemas) {
  ...
  public OauthBearerSaslMechanismHandlerShared addSchemasItem(EnumoauthBearerSaslMechanismHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public OauthBearerSaslMechanismHandlerShared addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared idTokenValidator(List<String> idTokenValidator) {
  ...
  public OauthBearerSaslMechanismHandlerShared addIdTokenValidatorItem(String idTokenValidatorItem) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared requireBothAccessTokenAndIDToken(Boolean requireBothAccessTokenAndIDToken) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared validateAccessTokenWhenIDTokenIsAlsoProvided(EnumsaslMechanismHandlerValidateAccessTokenWhenIDTokenIsAlsoProvidedProp validateAccessTokenWhenIDTokenIsAlsoProvided) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared alternateAuthorizationIdentityMapper(String alternateAuthorizationIdentityMapper) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared allRequiredScope(List<String> allRequiredScope) {
  ...
  public OauthBearerSaslMechanismHandlerShared addAllRequiredScopeItem(String allRequiredScopeItem) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared anyRequiredScope(List<String> anyRequiredScope) {
  ...
  public OauthBearerSaslMechanismHandlerShared addAnyRequiredScopeItem(String anyRequiredScopeItem) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared serverFqdn(String serverFqdn) {
  ...
  **/
  ...
  public OauthBearerSaslMechanismHandlerShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the OauthBearerSaslMechanismHandlerShared instance itself
   */
  public OauthBearerSaslMechanismHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OauthBearerSaslMechanismHandlerShared oauthBearerSaslMechanismHandlerShared = (OauthBearerSaslMechanismHandlerShared) o;
    return Objects.equals(this.description, oauthBearerSaslMechanismHandlerShared.description) &&
        Objects.equals(this.schemas, oauthBearerSaslMechanismHandlerShared.schemas) &&
        Objects.equals(this.accessTokenValidator, oauthBearerSaslMechanismHandlerShared.accessTokenValidator) &&
        Objects.equals(this.idTokenValidator, oauthBearerSaslMechanismHandlerShared.idTokenValidator) &&
        Objects.equals(this.requireBothAccessTokenAndIDToken, oauthBearerSaslMechanismHandlerShared.requireBothAccessTokenAndIDToken) &&
        Objects.equals(this.validateAccessTokenWhenIDTokenIsAlsoProvided, oauthBearerSaslMechanismHandlerShared.validateAccessTokenWhenIDTokenIsAlsoProvided) &&
        Objects.equals(this.alternateAuthorizationIdentityMapper, oauthBearerSaslMechanismHandlerShared.alternateAuthorizationIdentityMapper) &&
        Objects.equals(this.allRequiredScope, oauthBearerSaslMechanismHandlerShared.allRequiredScope) &&
        Objects.equals(this.anyRequiredScope, oauthBearerSaslMechanismHandlerShared.anyRequiredScope) &&
        Objects.equals(this.serverFqdn, oauthBearerSaslMechanismHandlerShared.serverFqdn) &&
        Objects.equals(this.enabled, oauthBearerSaslMechanismHandlerShared.enabled)&&
        Objects.equals(this.additionalProperties, oauthBearerSaslMechanismHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, accessTokenValidator, idTokenValidator, requireBothAccessTokenAndIDToken, validateAccessTokenWhenIDTokenIsAlsoProvided, alternateAuthorizationIdentityMapper, allRequiredScope, anyRequiredScope, serverFqdn, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OauthBearerSaslMechanismHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OauthBearerSaslMechanismHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OauthBearerSaslMechanismHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OauthBearerSaslMechanismHandlerShared is not found in the empty JSON string", OauthBearerSaslMechanismHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OauthBearerSaslMechanismHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OauthBearerSaslMechanismHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OauthBearerSaslMechanismHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OauthBearerSaslMechanismHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OauthBearerSaslMechanismHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<OauthBearerSaslMechanismHandlerShared>() {
           @Override
           public void write(JsonWriter out, OauthBearerSaslMechanismHandlerShared value) throws IOException {
           ...
           @Override
           public OauthBearerSaslMechanismHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OauthBearerSaslMechanismHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OauthBearerSaslMechanismHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OauthBearerSaslMechanismHandlerShared
  * @throws IOException if the JSON string is invalid with respect to OauthBearerSaslMechanismHandlerShared
  */
  public static OauthBearerSaslMechanismHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OauthBearerSaslMechanismHandlerShared.class);
  }

 /**
  * Convert an instance of OauthBearerSaslMechanismHandlerShared to an JSON string
  *
  * @return JSON string
  */
