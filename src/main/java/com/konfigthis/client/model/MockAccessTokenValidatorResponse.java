...
public class MockAccessTokenValidatorResponse {
  ...
  public MockAccessTokenValidatorResponse() {
  }

  public MockAccessTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse schemas(List<EnummockAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public MockAccessTokenValidatorResponse addSchemasItem(EnummockAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse clientIDClaimName(String clientIDClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse scopeClaimName(String scopeClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "When multiple Mock Access Token Validators are defined for a single Directory Server, this property determines the evaluation order for determining the correct validator class for an access token received by the Directory Server. Values of this property must be unique among all Mock Access Token Validators defined within Directory Server but not necessarily contiguous. Mock Access Token Validators with a smaller value will be evaluated first to determine if they are able to validate the access token.")
  ...
  public MockAccessTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MockAccessTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MockAccessTokenValidatorResponse instance itself
   */
  public MockAccessTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MockAccessTokenValidatorResponse mockAccessTokenValidatorResponse = (MockAccessTokenValidatorResponse) o;
    return Objects.equals(this.id, mockAccessTokenValidatorResponse.id) &&
        Objects.equals(this.description, mockAccessTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, mockAccessTokenValidatorResponse.schemas) &&
        Objects.equals(this.clientIDClaimName, mockAccessTokenValidatorResponse.clientIDClaimName) &&
        Objects.equals(this.scopeClaimName, mockAccessTokenValidatorResponse.scopeClaimName) &&
        Objects.equals(this.evaluationOrderIndex, mockAccessTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.identityMapper, mockAccessTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, mockAccessTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.enabled, mockAccessTokenValidatorResponse.enabled) &&
        Objects.equals(this.meta, mockAccessTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, mockAccessTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, mockAccessTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, clientIDClaimName, scopeClaimName, evaluationOrderIndex, identityMapper, subjectClaimName, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MockAccessTokenValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MockAccessTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MockAccessTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MockAccessTokenValidatorResponse is not found in the empty JSON string", MockAccessTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MockAccessTokenValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MockAccessTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MockAccessTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MockAccessTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MockAccessTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MockAccessTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, MockAccessTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public MockAccessTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MockAccessTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MockAccessTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MockAccessTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to MockAccessTokenValidatorResponse
  */
  public static MockAccessTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MockAccessTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of MockAccessTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
