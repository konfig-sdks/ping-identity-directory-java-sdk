...
public class UploadToS3LogFileRotationListenerShared {
  ...
  public UploadToS3LogFileRotationListenerShared() {
  }

  public UploadToS3LogFileRotationListenerShared description(String description) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared schemas(List<EnumuploadToS3LogFileRotationListenerSchemaUrn> schemas) {
  ...
  public UploadToS3LogFileRotationListenerShared addSchemasItem(EnumuploadToS3LogFileRotationListenerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared s3BucketName(String s3BucketName) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared targetThroughputInMegabitsPerSecond(Integer targetThroughputInMegabitsPerSecond) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared maximumConcurrentTransferConnections(Integer maximumConcurrentTransferConnections) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared maximumFileCountToRetain(Integer maximumFileCountToRetain) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared maximumFileAgeToRetain(String maximumFileAgeToRetain) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared fileRetentionPattern(String fileRetentionPattern) {
  ...
  **/
  ...
  public UploadToS3LogFileRotationListenerShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the UploadToS3LogFileRotationListenerShared instance itself
   */
  public UploadToS3LogFileRotationListenerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UploadToS3LogFileRotationListenerShared uploadToS3LogFileRotationListenerShared = (UploadToS3LogFileRotationListenerShared) o;
    return Objects.equals(this.description, uploadToS3LogFileRotationListenerShared.description) &&
        Objects.equals(this.schemas, uploadToS3LogFileRotationListenerShared.schemas) &&
        Objects.equals(this.awsExternalServer, uploadToS3LogFileRotationListenerShared.awsExternalServer) &&
        Objects.equals(this.s3BucketName, uploadToS3LogFileRotationListenerShared.s3BucketName) &&
        Objects.equals(this.targetThroughputInMegabitsPerSecond, uploadToS3LogFileRotationListenerShared.targetThroughputInMegabitsPerSecond) &&
        Objects.equals(this.maximumConcurrentTransferConnections, uploadToS3LogFileRotationListenerShared.maximumConcurrentTransferConnections) &&
        Objects.equals(this.maximumFileCountToRetain, uploadToS3LogFileRotationListenerShared.maximumFileCountToRetain) &&
        Objects.equals(this.maximumFileAgeToRetain, uploadToS3LogFileRotationListenerShared.maximumFileAgeToRetain) &&
        Objects.equals(this.fileRetentionPattern, uploadToS3LogFileRotationListenerShared.fileRetentionPattern) &&
        Objects.equals(this.enabled, uploadToS3LogFileRotationListenerShared.enabled)&&
        Objects.equals(this.additionalProperties, uploadToS3LogFileRotationListenerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UploadToS3LogFileRotationListenerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UploadToS3LogFileRotationListenerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UploadToS3LogFileRotationListenerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UploadToS3LogFileRotationListenerShared is not found in the empty JSON string", UploadToS3LogFileRotationListenerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UploadToS3LogFileRotationListenerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UploadToS3LogFileRotationListenerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UploadToS3LogFileRotationListenerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UploadToS3LogFileRotationListenerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UploadToS3LogFileRotationListenerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<UploadToS3LogFileRotationListenerShared>() {
           @Override
           public void write(JsonWriter out, UploadToS3LogFileRotationListenerShared value) throws IOException {
           ...
           @Override
           public UploadToS3LogFileRotationListenerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UploadToS3LogFileRotationListenerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UploadToS3LogFileRotationListenerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UploadToS3LogFileRotationListenerShared
  * @throws IOException if the JSON string is invalid with respect to UploadToS3LogFileRotationListenerShared
  */
  public static UploadToS3LogFileRotationListenerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UploadToS3LogFileRotationListenerShared.class);
  }

 /**
  * Convert an instance of UploadToS3LogFileRotationListenerShared to an JSON string
  *
  * @return JSON string
  */
