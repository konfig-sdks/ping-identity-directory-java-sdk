 ...
 */
@JsonAdapter(EnumresultCriteriaMissingPrivilegeProp.Adapter.class)public enum EnumresultCriteriaMissingPrivilegeProp {
  ...
  EnumresultCriteriaMissingPrivilegeProp(String value) {
    this.value = value;
  }
  ...
  public static EnumresultCriteriaMissingPrivilegeProp fromValue(String value) {
    for (EnumresultCriteriaMissingPrivilegeProp b : EnumresultCriteriaMissingPrivilegeProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumresultCriteriaMissingPrivilegeProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumresultCriteriaMissingPrivilegeProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumresultCriteriaMissingPrivilegeProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumresultCriteriaMissingPrivilegeProp.fromValue(value);
    }
  }
}
