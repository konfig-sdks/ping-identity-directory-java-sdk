...
public class PingOnePassThroughAuthenticationHandlerResponse {
  ...
  public PingOnePassThroughAuthenticationHandlerResponse() {
  }

  public PingOnePassThroughAuthenticationHandlerResponse id(String id) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse description(String description) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse schemas(List<EnumpingOnePassThroughAuthenticationHandlerSchemaUrn> schemas) {
  ...
  public PingOnePassThroughAuthenticationHandlerResponse addSchemasItem(EnumpingOnePassThroughAuthenticationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse apiURL(String apiURL) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse authURL(String authURL) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse oauthClientID(String oauthClientID) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse oauthClientSecret(String oauthClientSecret) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse oauthClientSecretPassphraseProvider(String oauthClientSecretPassphraseProvider) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse environmentID(String environmentID) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse userMappingLocalAttribute(List<String> userMappingLocalAttribute) {
  ...
  public PingOnePassThroughAuthenticationHandlerResponse addUserMappingLocalAttributeItem(String userMappingLocalAttributeItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse userMappingRemoteJSONField(List<String> userMappingRemoteJSONField) {
  ...
  public PingOnePassThroughAuthenticationHandlerResponse addUserMappingRemoteJSONFieldItem(String userMappingRemoteJSONFieldItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse additionalUserMappingSCIMFilter(String additionalUserMappingSCIMFilter) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse includedLocalEntryBaseDN(List<String> includedLocalEntryBaseDN) {
  ...
  public PingOnePassThroughAuthenticationHandlerResponse addIncludedLocalEntryBaseDNItem(String includedLocalEntryBaseDNItem) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public PingOnePassThroughAuthenticationHandlerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the PingOnePassThroughAuthenticationHandlerResponse instance itself
   */
  public PingOnePassThroughAuthenticationHandlerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    PingOnePassThroughAuthenticationHandlerResponse pingOnePassThroughAuthenticationHandlerResponse = (PingOnePassThroughAuthenticationHandlerResponse) o;
    return Objects.equals(this.id, pingOnePassThroughAuthenticationHandlerResponse.id) &&
        Objects.equals(this.description, pingOnePassThroughAuthenticationHandlerResponse.description) &&
        Objects.equals(this.schemas, pingOnePassThroughAuthenticationHandlerResponse.schemas) &&
        Objects.equals(this.apiURL, pingOnePassThroughAuthenticationHandlerResponse.apiURL) &&
        Objects.equals(this.authURL, pingOnePassThroughAuthenticationHandlerResponse.authURL) &&
        Objects.equals(this.oauthClientID, pingOnePassThroughAuthenticationHandlerResponse.oauthClientID) &&
        Objects.equals(this.oauthClientSecret, pingOnePassThroughAuthenticationHandlerResponse.oauthClientSecret) &&
        Objects.equals(this.oauthClientSecretPassphraseProvider, pingOnePassThroughAuthenticationHandlerResponse.oauthClientSecretPassphraseProvider) &&
        Objects.equals(this.environmentID, pingOnePassThroughAuthenticationHandlerResponse.environmentID) &&
        Objects.equals(this.httpProxyExternalServer, pingOnePassThroughAuthenticationHandlerResponse.httpProxyExternalServer) &&
        Objects.equals(this.userMappingLocalAttribute, pingOnePassThroughAuthenticationHandlerResponse.userMappingLocalAttribute) &&
        Objects.equals(this.userMappingRemoteJSONField, pingOnePassThroughAuthenticationHandlerResponse.userMappingRemoteJSONField) &&
        Objects.equals(this.additionalUserMappingSCIMFilter, pingOnePassThroughAuthenticationHandlerResponse.additionalUserMappingSCIMFilter) &&
        Objects.equals(this.includedLocalEntryBaseDN, pingOnePassThroughAuthenticationHandlerResponse.includedLocalEntryBaseDN) &&
        Objects.equals(this.connectionCriteria, pingOnePassThroughAuthenticationHandlerResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, pingOnePassThroughAuthenticationHandlerResponse.requestCriteria) &&
        Objects.equals(this.meta, pingOnePassThroughAuthenticationHandlerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pingOnePassThroughAuthenticationHandlerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pingOnePassThroughAuthenticationHandlerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, apiURL, authURL, oauthClientID, oauthClientSecret, oauthClientSecretPassphraseProvider, environmentID, httpProxyExternalServer, userMappingLocalAttribute, userMappingRemoteJSONField, additionalUserMappingSCIMFilter, includedLocalEntryBaseDN, connectionCriteria, requestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PingOnePassThroughAuthenticationHandlerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to PingOnePassThroughAuthenticationHandlerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!PingOnePassThroughAuthenticationHandlerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in PingOnePassThroughAuthenticationHandlerResponse is not found in the empty JSON string", PingOnePassThroughAuthenticationHandlerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : PingOnePassThroughAuthenticationHandlerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!PingOnePassThroughAuthenticationHandlerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'PingOnePassThroughAuthenticationHandlerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<PingOnePassThroughAuthenticationHandlerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(PingOnePassThroughAuthenticationHandlerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<PingOnePassThroughAuthenticationHandlerResponse>() {
           @Override
           public void write(JsonWriter out, PingOnePassThroughAuthenticationHandlerResponse value) throws IOException {
           ...
           @Override
           public PingOnePassThroughAuthenticationHandlerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             PingOnePassThroughAuthenticationHandlerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of PingOnePassThroughAuthenticationHandlerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of PingOnePassThroughAuthenticationHandlerResponse
  * @throws IOException if the JSON string is invalid with respect to PingOnePassThroughAuthenticationHandlerResponse
  */
  public static PingOnePassThroughAuthenticationHandlerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PingOnePassThroughAuthenticationHandlerResponse.class);
  }

 /**
  * Convert an instance of PingOnePassThroughAuthenticationHandlerResponse to an JSON string
  *
  * @return JSON string
  */
