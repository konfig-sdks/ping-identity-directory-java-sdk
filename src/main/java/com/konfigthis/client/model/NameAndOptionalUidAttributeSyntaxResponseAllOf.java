...
public class NameAndOptionalUidAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf() {
  }

  public NameAndOptionalUidAttributeSyntaxResponseAllOf schemas(List<EnumnameAndOptionalUidAttributeSyntaxSchemaUrn> schemas) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf addSchemasItem(EnumnameAndOptionalUidAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public NameAndOptionalUidAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the NameAndOptionalUidAttributeSyntaxResponseAllOf instance itself
   */
  public NameAndOptionalUidAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NameAndOptionalUidAttributeSyntaxResponseAllOf nameAndOptionalUidAttributeSyntaxResponseAllOf = (NameAndOptionalUidAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, nameAndOptionalUidAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, nameAndOptionalUidAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, nameAndOptionalUidAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, nameAndOptionalUidAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, nameAndOptionalUidAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, nameAndOptionalUidAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, nameAndOptionalUidAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, nameAndOptionalUidAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NameAndOptionalUidAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NameAndOptionalUidAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NameAndOptionalUidAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NameAndOptionalUidAttributeSyntaxResponseAllOf is not found in the empty JSON string", NameAndOptionalUidAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NameAndOptionalUidAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NameAndOptionalUidAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NameAndOptionalUidAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NameAndOptionalUidAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<NameAndOptionalUidAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, NameAndOptionalUidAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public NameAndOptionalUidAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NameAndOptionalUidAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NameAndOptionalUidAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NameAndOptionalUidAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to NameAndOptionalUidAttributeSyntaxResponseAllOf
  */
  public static NameAndOptionalUidAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NameAndOptionalUidAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of NameAndOptionalUidAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
