...
public class ErrorLogAlertHandlerShared {
  ...
  public ErrorLogAlertHandlerShared() {
  }

  public ErrorLogAlertHandlerShared description(String description) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared schemas(List<EnumerrorLogAlertHandlerSchemaUrn> schemas) {
  ...
  public ErrorLogAlertHandlerShared addSchemasItem(EnumerrorLogAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public ErrorLogAlertHandlerShared addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public ErrorLogAlertHandlerShared addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public ErrorLogAlertHandlerShared disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public ErrorLogAlertHandlerShared addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the ErrorLogAlertHandlerShared instance itself
   */
  public ErrorLogAlertHandlerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ErrorLogAlertHandlerShared errorLogAlertHandlerShared = (ErrorLogAlertHandlerShared) o;
    return Objects.equals(this.description, errorLogAlertHandlerShared.description) &&
        Objects.equals(this.schemas, errorLogAlertHandlerShared.schemas) &&
        Objects.equals(this.enabled, errorLogAlertHandlerShared.enabled) &&
        Objects.equals(this.asynchronous, errorLogAlertHandlerShared.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, errorLogAlertHandlerShared.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, errorLogAlertHandlerShared.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, errorLogAlertHandlerShared.disabledAlertType)&&
        Objects.equals(this.additionalProperties, errorLogAlertHandlerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ErrorLogAlertHandlerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ErrorLogAlertHandlerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ErrorLogAlertHandlerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ErrorLogAlertHandlerShared is not found in the empty JSON string", ErrorLogAlertHandlerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ErrorLogAlertHandlerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ErrorLogAlertHandlerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ErrorLogAlertHandlerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ErrorLogAlertHandlerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ErrorLogAlertHandlerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ErrorLogAlertHandlerShared>() {
           @Override
           public void write(JsonWriter out, ErrorLogAlertHandlerShared value) throws IOException {
           ...
           @Override
           public ErrorLogAlertHandlerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ErrorLogAlertHandlerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ErrorLogAlertHandlerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ErrorLogAlertHandlerShared
  * @throws IOException if the JSON string is invalid with respect to ErrorLogAlertHandlerShared
  */
  public static ErrorLogAlertHandlerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ErrorLogAlertHandlerShared.class);
  }

 /**
  * Convert an instance of ErrorLogAlertHandlerShared to an JSON string
  *
  * @return JSON string
  */
