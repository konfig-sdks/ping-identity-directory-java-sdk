...
public class Pkcs11KeyManagerProviderResponse {
  ...
  public Pkcs11KeyManagerProviderResponse() {
  }

  public Pkcs11KeyManagerProviderResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Key Manager Provider")
  ...
  public Pkcs11KeyManagerProviderResponse description(String description) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse schemas(List<Enumpkcs11KeyManagerProviderSchemaUrn> schemas) {
  ...
  public Pkcs11KeyManagerProviderResponse addSchemasItem(Enumpkcs11KeyManagerProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse pkcs11ProviderClass(String pkcs11ProviderClass) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse pkcs11ProviderConfigurationFile(String pkcs11ProviderConfigurationFile) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse pkcs11KeyStoreType(String pkcs11KeyStoreType) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse pkcs11MaxCacheDuration(String pkcs11MaxCacheDuration) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse keyStorePin(String keyStorePin) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse keyStorePinFile(String keyStorePinFile) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse keyStorePinPassphraseProvider(String keyStorePinPassphraseProvider) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public Pkcs11KeyManagerProviderResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the Pkcs11KeyManagerProviderResponse instance itself
   */
  public Pkcs11KeyManagerProviderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Pkcs11KeyManagerProviderResponse pkcs11KeyManagerProviderResponse = (Pkcs11KeyManagerProviderResponse) o;
    return Objects.equals(this.id, pkcs11KeyManagerProviderResponse.id) &&
        Objects.equals(this.description, pkcs11KeyManagerProviderResponse.description) &&
        Objects.equals(this.schemas, pkcs11KeyManagerProviderResponse.schemas) &&
        Objects.equals(this.pkcs11ProviderClass, pkcs11KeyManagerProviderResponse.pkcs11ProviderClass) &&
        Objects.equals(this.pkcs11ProviderConfigurationFile, pkcs11KeyManagerProviderResponse.pkcs11ProviderConfigurationFile) &&
        Objects.equals(this.pkcs11KeyStoreType, pkcs11KeyManagerProviderResponse.pkcs11KeyStoreType) &&
        Objects.equals(this.pkcs11MaxCacheDuration, pkcs11KeyManagerProviderResponse.pkcs11MaxCacheDuration) &&
        Objects.equals(this.keyStorePin, pkcs11KeyManagerProviderResponse.keyStorePin) &&
        Objects.equals(this.keyStorePinFile, pkcs11KeyManagerProviderResponse.keyStorePinFile) &&
        Objects.equals(this.keyStorePinPassphraseProvider, pkcs11KeyManagerProviderResponse.keyStorePinPassphraseProvider) &&
        Objects.equals(this.enabled, pkcs11KeyManagerProviderResponse.enabled) &&
        Objects.equals(this.meta, pkcs11KeyManagerProviderResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, pkcs11KeyManagerProviderResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, pkcs11KeyManagerProviderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, pkcs11ProviderClass, pkcs11ProviderConfigurationFile, pkcs11KeyStoreType, pkcs11MaxCacheDuration, keyStorePin, keyStorePinFile, keyStorePinPassphraseProvider, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Pkcs11KeyManagerProviderResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to Pkcs11KeyManagerProviderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Pkcs11KeyManagerProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Pkcs11KeyManagerProviderResponse is not found in the empty JSON string", Pkcs11KeyManagerProviderResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Pkcs11KeyManagerProviderResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Pkcs11KeyManagerProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Pkcs11KeyManagerProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Pkcs11KeyManagerProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Pkcs11KeyManagerProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<Pkcs11KeyManagerProviderResponse>() {
           @Override
           public void write(JsonWriter out, Pkcs11KeyManagerProviderResponse value) throws IOException {
           ...
           @Override
           public Pkcs11KeyManagerProviderResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Pkcs11KeyManagerProviderResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Pkcs11KeyManagerProviderResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Pkcs11KeyManagerProviderResponse
  * @throws IOException if the JSON string is invalid with respect to Pkcs11KeyManagerProviderResponse
  */
  public static Pkcs11KeyManagerProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Pkcs11KeyManagerProviderResponse.class);
  }

 /**
  * Convert an instance of Pkcs11KeyManagerProviderResponse to an JSON string
  *
  * @return JSON string
  */
