...
public class VaultExternalServerShared {
  ...
  public VaultExternalServerShared() {
  }

  public VaultExternalServerShared description(String description) {
  ...
  **/
  ...
  public VaultExternalServerShared schemas(List<EnumvaultExternalServerSchemaUrn> schemas) {
  ...
  public VaultExternalServerShared addSchemasItem(EnumvaultExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultExternalServerShared vaultServerBaseURI(List<String> vaultServerBaseURI) {
  ...
  public VaultExternalServerShared addVaultServerBaseURIItem(String vaultServerBaseURIItem) {
  ...
  **/
  ...
  public VaultExternalServerShared vaultAuthenticationMethod(String vaultAuthenticationMethod) {
  ...
  **/
  ...
  public VaultExternalServerShared httpConnectTimeout(String httpConnectTimeout) {
  ...
  **/
  ...
  public VaultExternalServerShared httpResponseTimeout(String httpResponseTimeout) {
  ...
  **/
  ...
  public VaultExternalServerShared trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public VaultExternalServerShared trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public VaultExternalServerShared trustStoreType(String trustStoreType) {
  ...
  **/
   ...
   * @return the VaultExternalServerShared instance itself
   */
  public VaultExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultExternalServerShared vaultExternalServerShared = (VaultExternalServerShared) o;
    return Objects.equals(this.description, vaultExternalServerShared.description) &&
        Objects.equals(this.schemas, vaultExternalServerShared.schemas) &&
        Objects.equals(this.vaultServerBaseURI, vaultExternalServerShared.vaultServerBaseURI) &&
        Objects.equals(this.vaultAuthenticationMethod, vaultExternalServerShared.vaultAuthenticationMethod) &&
        Objects.equals(this.httpConnectTimeout, vaultExternalServerShared.httpConnectTimeout) &&
        Objects.equals(this.httpResponseTimeout, vaultExternalServerShared.httpResponseTimeout) &&
        Objects.equals(this.trustStoreFile, vaultExternalServerShared.trustStoreFile) &&
        Objects.equals(this.trustStorePin, vaultExternalServerShared.trustStorePin) &&
        Objects.equals(this.trustStoreType, vaultExternalServerShared.trustStoreType)&&
        Objects.equals(this.additionalProperties, vaultExternalServerShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, vaultServerBaseURI, vaultAuthenticationMethod, httpConnectTimeout, httpResponseTimeout, trustStoreFile, trustStorePin, trustStoreType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultExternalServerShared is not found in the empty JSON string", VaultExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultExternalServerShared>() {
           @Override
           public void write(JsonWriter out, VaultExternalServerShared value) throws IOException {
           ...
           @Override
           public VaultExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to VaultExternalServerShared
  */
  public static VaultExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultExternalServerShared.class);
  }

 /**
  * Convert an instance of VaultExternalServerShared to an JSON string
  *
  * @return JSON string
  */
