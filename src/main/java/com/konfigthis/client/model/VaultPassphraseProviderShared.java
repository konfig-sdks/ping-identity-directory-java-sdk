...
public class VaultPassphraseProviderShared {
  ...
  public VaultPassphraseProviderShared() {
  }

  public VaultPassphraseProviderShared description(String description) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared schemas(List<EnumvaultPassphraseProviderSchemaUrn> schemas) {
  ...
  public VaultPassphraseProviderShared addSchemasItem(EnumvaultPassphraseProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared vaultExternalServer(String vaultExternalServer) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared vaultSecretPath(String vaultSecretPath) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared vaultSecretFieldName(String vaultSecretFieldName) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared maxCacheDuration(String maxCacheDuration) {
  ...
  **/
  ...
  public VaultPassphraseProviderShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the VaultPassphraseProviderShared instance itself
   */
  public VaultPassphraseProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultPassphraseProviderShared vaultPassphraseProviderShared = (VaultPassphraseProviderShared) o;
    return Objects.equals(this.description, vaultPassphraseProviderShared.description) &&
        Objects.equals(this.schemas, vaultPassphraseProviderShared.schemas) &&
        Objects.equals(this.vaultExternalServer, vaultPassphraseProviderShared.vaultExternalServer) &&
        Objects.equals(this.vaultSecretPath, vaultPassphraseProviderShared.vaultSecretPath) &&
        Objects.equals(this.vaultSecretFieldName, vaultPassphraseProviderShared.vaultSecretFieldName) &&
        Objects.equals(this.maxCacheDuration, vaultPassphraseProviderShared.maxCacheDuration) &&
        Objects.equals(this.enabled, vaultPassphraseProviderShared.enabled)&&
        Objects.equals(this.additionalProperties, vaultPassphraseProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, vaultExternalServer, vaultSecretPath, vaultSecretFieldName, maxCacheDuration, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultPassphraseProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultPassphraseProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultPassphraseProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultPassphraseProviderShared is not found in the empty JSON string", VaultPassphraseProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultPassphraseProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultPassphraseProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultPassphraseProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultPassphraseProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultPassphraseProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultPassphraseProviderShared>() {
           @Override
           public void write(JsonWriter out, VaultPassphraseProviderShared value) throws IOException {
           ...
           @Override
           public VaultPassphraseProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultPassphraseProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultPassphraseProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultPassphraseProviderShared
  * @throws IOException if the JSON string is invalid with respect to VaultPassphraseProviderShared
  */
  public static VaultPassphraseProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultPassphraseProviderShared.class);
  }

 /**
  * Convert an instance of VaultPassphraseProviderShared to an JSON string
  *
  * @return JSON string
  */
