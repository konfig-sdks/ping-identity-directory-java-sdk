...
public class ConfigFileHandlerBackendResponse {
  ...
  private List<EnumconfigFileHandlerBackendSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConfigFileHandlerBackendResponse() {
  }

  public ConfigFileHandlerBackendResponse description(String description) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse schemas(List<EnumconfigFileHandlerBackendSchemaUrn> schemas) {
  ...
  public ConfigFileHandlerBackendResponse addSchemasItem(EnumconfigFileHandlerBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse id(String id) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse backendID(String backendID) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse baseDN(List<String> baseDN) {
  ...
  public ConfigFileHandlerBackendResponse addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse insignificantConfigArchiveAttribute(List<String> insignificantConfigArchiveAttribute) {
  ...
  public ConfigFileHandlerBackendResponse addInsignificantConfigArchiveAttributeItem(String insignificantConfigArchiveAttributeItem) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse insignificantConfigArchiveBaseDN(List<String> insignificantConfigArchiveBaseDN) {
  ...
  public ConfigFileHandlerBackendResponse addInsignificantConfigArchiveBaseDNItem(String insignificantConfigArchiveBaseDNItem) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse maintainConfigArchive(Boolean maintainConfigArchive) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse maxConfigArchiveCount(Integer maxConfigArchiveCount) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse mirroredSubtreePeerPollingInterval(String mirroredSubtreePeerPollingInterval) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse mirroredSubtreeEntryUpdateTimeout(String mirroredSubtreeEntryUpdateTimeout) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse mirroredSubtreeSearchTimeout(String mirroredSubtreeSearchTimeout) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse notificationManager(String notificationManager) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConfigFileHandlerBackendResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConfigFileHandlerBackendResponse instance itself
   */
  public ConfigFileHandlerBackendResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConfigFileHandlerBackendResponse configFileHandlerBackendResponse = (ConfigFileHandlerBackendResponse) o;
    return Objects.equals(this.description, configFileHandlerBackendResponse.description) &&
        Objects.equals(this.schemas, configFileHandlerBackendResponse.schemas) &&
        Objects.equals(this.id, configFileHandlerBackendResponse.id) &&
        Objects.equals(this.backendID, configFileHandlerBackendResponse.backendID) &&
        Objects.equals(this.baseDN, configFileHandlerBackendResponse.baseDN) &&
        Objects.equals(this.writabilityMode, configFileHandlerBackendResponse.writabilityMode) &&
        Objects.equals(this.insignificantConfigArchiveAttribute, configFileHandlerBackendResponse.insignificantConfigArchiveAttribute) &&
        Objects.equals(this.insignificantConfigArchiveBaseDN, configFileHandlerBackendResponse.insignificantConfigArchiveBaseDN) &&
        Objects.equals(this.maintainConfigArchive, configFileHandlerBackendResponse.maintainConfigArchive) &&
        Objects.equals(this.maxConfigArchiveCount, configFileHandlerBackendResponse.maxConfigArchiveCount) &&
        Objects.equals(this.mirroredSubtreePeerPollingInterval, configFileHandlerBackendResponse.mirroredSubtreePeerPollingInterval) &&
        Objects.equals(this.mirroredSubtreeEntryUpdateTimeout, configFileHandlerBackendResponse.mirroredSubtreeEntryUpdateTimeout) &&
        Objects.equals(this.mirroredSubtreeSearchTimeout, configFileHandlerBackendResponse.mirroredSubtreeSearchTimeout) &&
        Objects.equals(this.enabled, configFileHandlerBackendResponse.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, configFileHandlerBackendResponse.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, configFileHandlerBackendResponse.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, configFileHandlerBackendResponse.backupFilePermissions) &&
        Objects.equals(this.notificationManager, configFileHandlerBackendResponse.notificationManager) &&
        Objects.equals(this.meta, configFileHandlerBackendResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, configFileHandlerBackendResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, configFileHandlerBackendResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConfigFileHandlerBackendResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConfigFileHandlerBackendResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConfigFileHandlerBackendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConfigFileHandlerBackendResponse is not found in the empty JSON string", ConfigFileHandlerBackendResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConfigFileHandlerBackendResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConfigFileHandlerBackendResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConfigFileHandlerBackendResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConfigFileHandlerBackendResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConfigFileHandlerBackendResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConfigFileHandlerBackendResponse>() {
           @Override
           public void write(JsonWriter out, ConfigFileHandlerBackendResponse value) throws IOException {
           ...
           @Override
           public ConfigFileHandlerBackendResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConfigFileHandlerBackendResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConfigFileHandlerBackendResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConfigFileHandlerBackendResponse
  * @throws IOException if the JSON string is invalid with respect to ConfigFileHandlerBackendResponse
  */
  public static ConfigFileHandlerBackendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConfigFileHandlerBackendResponse.class);
  }

 /**
  * Convert an instance of ConfigFileHandlerBackendResponse to an JSON string
  *
  * @return JSON string
  */
