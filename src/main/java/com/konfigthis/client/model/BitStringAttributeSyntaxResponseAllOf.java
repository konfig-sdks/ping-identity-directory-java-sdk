...
public class BitStringAttributeSyntaxResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumbitStringAttributeSyntaxSchemaUrn> schemas = null;
  ...
  public BitStringAttributeSyntaxResponseAllOf() {
  }

  public BitStringAttributeSyntaxResponseAllOf schemas(List<EnumbitStringAttributeSyntaxSchemaUrn> schemas) {
  ...
  public BitStringAttributeSyntaxResponseAllOf addSchemasItem(EnumbitStringAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf id(String id) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public BitStringAttributeSyntaxResponseAllOf addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public BitStringAttributeSyntaxResponseAllOf addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public BitStringAttributeSyntaxResponseAllOf requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
   ...
   * @return the BitStringAttributeSyntaxResponseAllOf instance itself
   */
  public BitStringAttributeSyntaxResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BitStringAttributeSyntaxResponseAllOf bitStringAttributeSyntaxResponseAllOf = (BitStringAttributeSyntaxResponseAllOf) o;
    return Objects.equals(this.schemas, bitStringAttributeSyntaxResponseAllOf.schemas) &&
        Objects.equals(this.id, bitStringAttributeSyntaxResponseAllOf.id) &&
        Objects.equals(this.enableCompaction, bitStringAttributeSyntaxResponseAllOf.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, bitStringAttributeSyntaxResponseAllOf.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, bitStringAttributeSyntaxResponseAllOf.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, bitStringAttributeSyntaxResponseAllOf.enabled) &&
        Objects.equals(this.requireBinaryTransfer, bitStringAttributeSyntaxResponseAllOf.requireBinaryTransfer)&&
        Objects.equals(this.additionalProperties, bitStringAttributeSyntaxResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BitStringAttributeSyntaxResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BitStringAttributeSyntaxResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BitStringAttributeSyntaxResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BitStringAttributeSyntaxResponseAllOf is not found in the empty JSON string", BitStringAttributeSyntaxResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BitStringAttributeSyntaxResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BitStringAttributeSyntaxResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BitStringAttributeSyntaxResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BitStringAttributeSyntaxResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<BitStringAttributeSyntaxResponseAllOf>() {
           @Override
           public void write(JsonWriter out, BitStringAttributeSyntaxResponseAllOf value) throws IOException {
           ...
           @Override
           public BitStringAttributeSyntaxResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BitStringAttributeSyntaxResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BitStringAttributeSyntaxResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BitStringAttributeSyntaxResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to BitStringAttributeSyntaxResponseAllOf
  */
  public static BitStringAttributeSyntaxResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BitStringAttributeSyntaxResponseAllOf.class);
  }

 /**
  * Convert an instance of BitStringAttributeSyntaxResponseAllOf to an JSON string
  *
  * @return JSON string
  */
