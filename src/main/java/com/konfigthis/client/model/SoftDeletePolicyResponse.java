...
public class SoftDeletePolicyResponse {
  ...
  public SoftDeletePolicyResponse() {
  }

  public SoftDeletePolicyResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Soft Delete Policy")
  ...
  public SoftDeletePolicyResponse description(String description) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse schemas(List<EnumsoftDeletePolicySchemaUrn> schemas) {
  ...
  public SoftDeletePolicyResponse addSchemasItem(EnumsoftDeletePolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse autoSoftDeleteConnectionCriteria(String autoSoftDeleteConnectionCriteria) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse autoSoftDeleteRequestCriteria(String autoSoftDeleteRequestCriteria) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse softDeleteRetentionTime(String softDeleteRetentionTime) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse softDeleteRetainNumberOfEntries(Integer softDeleteRetainNumberOfEntries) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public SoftDeletePolicyResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the SoftDeletePolicyResponse instance itself
   */
  public SoftDeletePolicyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SoftDeletePolicyResponse softDeletePolicyResponse = (SoftDeletePolicyResponse) o;
    return Objects.equals(this.id, softDeletePolicyResponse.id) &&
        Objects.equals(this.description, softDeletePolicyResponse.description) &&
        Objects.equals(this.schemas, softDeletePolicyResponse.schemas) &&
        Objects.equals(this.autoSoftDeleteConnectionCriteria, softDeletePolicyResponse.autoSoftDeleteConnectionCriteria) &&
        Objects.equals(this.autoSoftDeleteRequestCriteria, softDeletePolicyResponse.autoSoftDeleteRequestCriteria) &&
        Objects.equals(this.softDeleteRetentionTime, softDeletePolicyResponse.softDeleteRetentionTime) &&
        Objects.equals(this.softDeleteRetainNumberOfEntries, softDeletePolicyResponse.softDeleteRetainNumberOfEntries) &&
        Objects.equals(this.meta, softDeletePolicyResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, softDeletePolicyResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, softDeletePolicyResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, autoSoftDeleteConnectionCriteria, autoSoftDeleteRequestCriteria, softDeleteRetentionTime, softDeleteRetainNumberOfEntries, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SoftDeletePolicyResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SoftDeletePolicyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SoftDeletePolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SoftDeletePolicyResponse is not found in the empty JSON string", SoftDeletePolicyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SoftDeletePolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SoftDeletePolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SoftDeletePolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SoftDeletePolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SoftDeletePolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SoftDeletePolicyResponse>() {
           @Override
           public void write(JsonWriter out, SoftDeletePolicyResponse value) throws IOException {
           ...
           @Override
           public SoftDeletePolicyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SoftDeletePolicyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SoftDeletePolicyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SoftDeletePolicyResponse
  * @throws IOException if the JSON string is invalid with respect to SoftDeletePolicyResponse
  */
  public static SoftDeletePolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SoftDeletePolicyResponse.class);
  }

 /**
  * Convert an instance of SoftDeletePolicyResponse to an JSON string
  *
  * @return JSON string
  */
