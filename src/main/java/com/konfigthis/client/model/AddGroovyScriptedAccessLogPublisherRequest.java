...
public class AddGroovyScriptedAccessLogPublisherRequest {
  ...
  public AddGroovyScriptedAccessLogPublisherRequest() {
  }

  public AddGroovyScriptedAccessLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest schemas(List<EnumgroovyScriptedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedAccessLogPublisherRequest addSchemasItem(EnumgroovyScriptedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedAccessLogPublisherRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logResults(Boolean logResults) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedAccessLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedAccessLogPublisherRequest instance itself
   */
  public AddGroovyScriptedAccessLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedAccessLogPublisherRequest addGroovyScriptedAccessLogPublisherRequest = (AddGroovyScriptedAccessLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addGroovyScriptedAccessLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addGroovyScriptedAccessLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedAccessLogPublisherRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedAccessLogPublisherRequest.scriptClass) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedAccessLogPublisherRequest.scriptArgument) &&
        Objects.equals(this.logConnects, addGroovyScriptedAccessLogPublisherRequest.logConnects) &&
        Objects.equals(this.logDisconnects, addGroovyScriptedAccessLogPublisherRequest.logDisconnects) &&
        Objects.equals(this.logSecurityNegotiation, addGroovyScriptedAccessLogPublisherRequest.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, addGroovyScriptedAccessLogPublisherRequest.logClientCertificates) &&
        Objects.equals(this.logRequests, addGroovyScriptedAccessLogPublisherRequest.logRequests) &&
        Objects.equals(this.logResults, addGroovyScriptedAccessLogPublisherRequest.logResults) &&
        Objects.equals(this.logSearchEntries, addGroovyScriptedAccessLogPublisherRequest.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, addGroovyScriptedAccessLogPublisherRequest.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, addGroovyScriptedAccessLogPublisherRequest.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, addGroovyScriptedAccessLogPublisherRequest.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, addGroovyScriptedAccessLogPublisherRequest.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, addGroovyScriptedAccessLogPublisherRequest.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, addGroovyScriptedAccessLogPublisherRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addGroovyScriptedAccessLogPublisherRequest.requestCriteria) &&
        Objects.equals(this.resultCriteria, addGroovyScriptedAccessLogPublisherRequest.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, addGroovyScriptedAccessLogPublisherRequest.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, addGroovyScriptedAccessLogPublisherRequest.searchReferenceCriteria) &&
        Objects.equals(this.enabled, addGroovyScriptedAccessLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addGroovyScriptedAccessLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedAccessLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, scriptClass, scriptArgument, logConnects, logDisconnects, logSecurityNegotiation, logClientCertificates, logRequests, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedAccessLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedAccessLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedAccessLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedAccessLogPublisherRequest is not found in the empty JSON string", AddGroovyScriptedAccessLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedAccessLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedAccessLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedAccessLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedAccessLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedAccessLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedAccessLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedAccessLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedAccessLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedAccessLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedAccessLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedAccessLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedAccessLogPublisherRequest
  */
  public static AddGroovyScriptedAccessLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedAccessLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedAccessLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
