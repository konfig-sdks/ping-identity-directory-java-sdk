...
import com.konfigthis.client.model.EnumconsoleJsonHttpOperationLogPublisherSchemaUrn;
...
public class ConsoleJsonHttpOperationLogPublisherResponse {
  ...
  private List<EnumconsoleJsonHttpOperationLogPublisherSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse() {
  }

  public ConsoleJsonHttpOperationLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse schemas(List<EnumconsoleJsonHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse addSchemasItem(EnumconsoleJsonHttpOperationLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumconsoleJsonHttpOperationLogPublisherSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumconsoleJsonHttpOperationLogPublisherSchemaUrn> schemas) {
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Console JSON HTTP Operation Log Publisher is enabled for use.")
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse outputLocation(EnumlogPublisherOutputLocationProp outputLocation) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logResults(Boolean logResults) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequestHeaders(EnumlogPublisherLogRequestHeadersProp logRequestHeaders) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse suppressedRequestHeaderName(List<String> suppressedRequestHeaderName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse addSuppressedRequestHeaderNameItem(String suppressedRequestHeaderNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logResponseHeaders(EnumlogPublisherLogResponseHeadersProp logResponseHeaders) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse suppressedResponseHeaderName(List<String> suppressedResponseHeaderName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse addSuppressedResponseHeaderNameItem(String suppressedResponseHeaderNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequestAuthorizationType(Boolean logRequestAuthorizationType) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequestCookieNames(Boolean logRequestCookieNames) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logResponseCookieNames(Boolean logResponseCookieNames) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequestParameters(EnumlogPublisherLogRequestParametersProp logRequestParameters) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse suppressedRequestParameterName(List<String> suppressedRequestParameterName) {
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse addSuppressedRequestParameterNameItem(String suppressedRequestParameterNameItem) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRequestProtocol(Boolean logRequestProtocol) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse logRedirectURI(Boolean logRedirectURI) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConsoleJsonHttpOperationLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConsoleJsonHttpOperationLogPublisherResponse instance itself
   */
  public ConsoleJsonHttpOperationLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsoleJsonHttpOperationLogPublisherResponse consoleJsonHttpOperationLogPublisherResponse = (ConsoleJsonHttpOperationLogPublisherResponse) o;
    return Objects.equals(this.id, consoleJsonHttpOperationLogPublisherResponse.id) &&
        Objects.equals(this.description, consoleJsonHttpOperationLogPublisherResponse.description) &&
        Objects.equals(this.schemas, consoleJsonHttpOperationLogPublisherResponse.schemas) &&
        Objects.equals(this.enabled, consoleJsonHttpOperationLogPublisherResponse.enabled) &&
        Objects.equals(this.outputLocation, consoleJsonHttpOperationLogPublisherResponse.outputLocation) &&
        Objects.equals(this.logRequests, consoleJsonHttpOperationLogPublisherResponse.logRequests) &&
        Objects.equals(this.logResults, consoleJsonHttpOperationLogPublisherResponse.logResults) &&
        Objects.equals(this.includeProductName, consoleJsonHttpOperationLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, consoleJsonHttpOperationLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, consoleJsonHttpOperationLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, consoleJsonHttpOperationLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, consoleJsonHttpOperationLogPublisherResponse.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.logRequestHeaders, consoleJsonHttpOperationLogPublisherResponse.logRequestHeaders) &&
        Objects.equals(this.suppressedRequestHeaderName, consoleJsonHttpOperationLogPublisherResponse.suppressedRequestHeaderName) &&
        Objects.equals(this.logResponseHeaders, consoleJsonHttpOperationLogPublisherResponse.logResponseHeaders) &&
        Objects.equals(this.suppressedResponseHeaderName, consoleJsonHttpOperationLogPublisherResponse.suppressedResponseHeaderName) &&
        Objects.equals(this.logRequestAuthorizationType, consoleJsonHttpOperationLogPublisherResponse.logRequestAuthorizationType) &&
        Objects.equals(this.logRequestCookieNames, consoleJsonHttpOperationLogPublisherResponse.logRequestCookieNames) &&
        Objects.equals(this.logResponseCookieNames, consoleJsonHttpOperationLogPublisherResponse.logResponseCookieNames) &&
        Objects.equals(this.logRequestParameters, consoleJsonHttpOperationLogPublisherResponse.logRequestParameters) &&
        Objects.equals(this.suppressedRequestParameterName, consoleJsonHttpOperationLogPublisherResponse.suppressedRequestParameterName) &&
        Objects.equals(this.logRequestProtocol, consoleJsonHttpOperationLogPublisherResponse.logRequestProtocol) &&
        Objects.equals(this.logRedirectURI, consoleJsonHttpOperationLogPublisherResponse.logRedirectURI) &&
        Objects.equals(this.writeMultiLineMessages, consoleJsonHttpOperationLogPublisherResponse.writeMultiLineMessages) &&
        Objects.equals(this.loggingErrorBehavior, consoleJsonHttpOperationLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, consoleJsonHttpOperationLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, consoleJsonHttpOperationLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, consoleJsonHttpOperationLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, outputLocation, logRequests, logResults, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequestDetailsInResultMessages, logRequestHeaders, suppressedRequestHeaderName, logResponseHeaders, suppressedResponseHeaderName, logRequestAuthorizationType, logRequestCookieNames, logResponseCookieNames, logRequestParameters, suppressedRequestParameterName, logRequestProtocol, logRedirectURI, writeMultiLineMessages, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsoleJsonHttpOperationLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsoleJsonHttpOperationLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsoleJsonHttpOperationLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsoleJsonHttpOperationLogPublisherResponse is not found in the empty JSON string", ConsoleJsonHttpOperationLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsoleJsonHttpOperationLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsoleJsonHttpOperationLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsoleJsonHttpOperationLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsoleJsonHttpOperationLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsoleJsonHttpOperationLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsoleJsonHttpOperationLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, ConsoleJsonHttpOperationLogPublisherResponse value) throws IOException {
           ...
           @Override
           public ConsoleJsonHttpOperationLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsoleJsonHttpOperationLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsoleJsonHttpOperationLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsoleJsonHttpOperationLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to ConsoleJsonHttpOperationLogPublisherResponse
  */
  public static ConsoleJsonHttpOperationLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsoleJsonHttpOperationLogPublisherResponse.class);
  }

 /**
  * Convert an instance of ConsoleJsonHttpOperationLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
