 ...
 */
@JsonAdapter(EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp.Adapter.class)public enum EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp {
  ...
  ASSURANCE_TIMEOUT_MILLIS("assurance-timeout-millis"),
  ...
  BIND_AUTHENTICATION_FAILURE_ID("bind-authentication-failure-id"),
  
  BIND_AUTHENTICATION_FAILURE_NAME("bind-authentication-failure-name"),
  ...
  INTER_SERVER_COMPONENT("inter-server-component"),
  
  INTER_SERVER_CONTROL_FORWARDED_CLIENT_CONNECTION_POLICY("inter-server-control-forwarded-client-connection-policy"),
  
  INTER_SERVER_PROPERTIES("inter-server-properties"),
  
  INTER_SERVER_OPERATION_PURPOSE("inter-server-operation-purpose"),
  
  INTERMEDIATE_CLIENT_REQUEST("intermediate-client-request"),
  
  INTERMEDIATE_CLIENT_RESULT("intermediate-client-result"),
  ...
  ISSUER_CERTIFICATE_SUBJECT_DN("issuer-certificate-subject-dn"),
  
  LDAP_CLIENT_DECODE_ERROR_MESSAGE("ldap-client-decode-error-message"),
  
  LOCAL_ASSURANCE_LEVEL("local-assurance-level"),
  ...
  PEER_CERTIFICATE_SUBJECT_DN("peer-certificate-subject-dn"),
  ...
  REMOTE_ASSURANCE_LEVEL("remote-assurance-level"),
  ...
  RESPONSE_DELAYED_BY_ASSURANCE("response-delayed-by-assurance"),
  ...
  EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp(String value) {
    this.value = value;
  }
  ...
  public static EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp fromValue(String value) {
    for (EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp b : EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumlogFieldBehaviorTextAccessTokenizeValueComponentsFieldProp.fromValue(value);
    }
  }
}
