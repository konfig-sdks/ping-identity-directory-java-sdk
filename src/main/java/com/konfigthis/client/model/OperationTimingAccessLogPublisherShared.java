...
public class OperationTimingAccessLogPublisherShared {
  ...
  public OperationTimingAccessLogPublisherShared() {
  }

  public OperationTimingAccessLogPublisherShared description(String description) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared schemas(List<EnumoperationTimingAccessLogPublisherSchemaUrn> schemas) {
  ...
  public OperationTimingAccessLogPublisherShared addSchemasItem(EnumoperationTimingAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public OperationTimingAccessLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public OperationTimingAccessLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public OperationTimingAccessLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared minIncludedOperationProcessingTime(String minIncludedOperationProcessingTime) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared minIncludedPhaseTimeNanos(Integer minIncludedPhaseTimeNanos) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the OperationTimingAccessLogPublisherShared instance itself
   */
  public OperationTimingAccessLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OperationTimingAccessLogPublisherShared operationTimingAccessLogPublisherShared = (OperationTimingAccessLogPublisherShared) o;
    return Objects.equals(this.description, operationTimingAccessLogPublisherShared.description) &&
        Objects.equals(this.schemas, operationTimingAccessLogPublisherShared.schemas) &&
        Objects.equals(this.logFile, operationTimingAccessLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, operationTimingAccessLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, operationTimingAccessLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, operationTimingAccessLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, operationTimingAccessLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, operationTimingAccessLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, operationTimingAccessLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, operationTimingAccessLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, operationTimingAccessLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, operationTimingAccessLogPublisherShared.append) &&
        Objects.equals(this.includeProductName, operationTimingAccessLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, operationTimingAccessLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, operationTimingAccessLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, operationTimingAccessLogPublisherShared.includeThreadID) &&
        Objects.equals(this.includeRequesterIPAddress, operationTimingAccessLogPublisherShared.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequesterDN, operationTimingAccessLogPublisherShared.includeRequesterDN) &&
        Objects.equals(this.minIncludedOperationProcessingTime, operationTimingAccessLogPublisherShared.minIncludedOperationProcessingTime) &&
        Objects.equals(this.minIncludedPhaseTimeNanos, operationTimingAccessLogPublisherShared.minIncludedPhaseTimeNanos) &&
        Objects.equals(this.asynchronous, operationTimingAccessLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, operationTimingAccessLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, operationTimingAccessLogPublisherShared.bufferSize) &&
        Objects.equals(this.maxStringLength, operationTimingAccessLogPublisherShared.maxStringLength) &&
        Objects.equals(this.queueSize, operationTimingAccessLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, operationTimingAccessLogPublisherShared.timeInterval) &&
        Objects.equals(this.logSecurityNegotiation, operationTimingAccessLogPublisherShared.logSecurityNegotiation) &&
        Objects.equals(this.logIntermediateResponses, operationTimingAccessLogPublisherShared.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, operationTimingAccessLogPublisherShared.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, operationTimingAccessLogPublisherShared.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, operationTimingAccessLogPublisherShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, operationTimingAccessLogPublisherShared.requestCriteria) &&
        Objects.equals(this.resultCriteria, operationTimingAccessLogPublisherShared.resultCriteria) &&
        Objects.equals(this.enabled, operationTimingAccessLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, operationTimingAccessLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, operationTimingAccessLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperationTimingAccessLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OperationTimingAccessLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OperationTimingAccessLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OperationTimingAccessLogPublisherShared is not found in the empty JSON string", OperationTimingAccessLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OperationTimingAccessLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OperationTimingAccessLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OperationTimingAccessLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OperationTimingAccessLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OperationTimingAccessLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<OperationTimingAccessLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, OperationTimingAccessLogPublisherShared value) throws IOException {
           ...
           @Override
           public OperationTimingAccessLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OperationTimingAccessLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OperationTimingAccessLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OperationTimingAccessLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to OperationTimingAccessLogPublisherShared
  */
  public static OperationTimingAccessLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OperationTimingAccessLogPublisherShared.class);
  }

 /**
  * Convert an instance of OperationTimingAccessLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
