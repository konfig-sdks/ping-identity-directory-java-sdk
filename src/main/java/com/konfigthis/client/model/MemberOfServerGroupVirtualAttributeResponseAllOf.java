...
public class MemberOfServerGroupVirtualAttributeResponseAllOf {
  ...
  private List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> schemas = null;
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf() {
  }

  public MemberOfServerGroupVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf schemas(List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf addSchemasItem(EnummemberOfServerGroupVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the MemberOfServerGroupVirtualAttributeResponseAllOf instance itself
   */
  public MemberOfServerGroupVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MemberOfServerGroupVirtualAttributeResponseAllOf memberOfServerGroupVirtualAttributeResponseAllOf = (MemberOfServerGroupVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, memberOfServerGroupVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, memberOfServerGroupVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, memberOfServerGroupVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, memberOfServerGroupVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, memberOfServerGroupVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.enabled, memberOfServerGroupVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, memberOfServerGroupVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, memberOfServerGroupVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, memberOfServerGroupVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, memberOfServerGroupVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, memberOfServerGroupVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, memberOfServerGroupVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, memberOfServerGroupVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, memberOfServerGroupVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, memberOfServerGroupVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemberOfServerGroupVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemberOfServerGroupVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemberOfServerGroupVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberOfServerGroupVirtualAttributeResponseAllOf is not found in the empty JSON string", MemberOfServerGroupVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberOfServerGroupVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberOfServerGroupVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberOfServerGroupVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberOfServerGroupVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberOfServerGroupVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, MemberOfServerGroupVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public MemberOfServerGroupVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemberOfServerGroupVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemberOfServerGroupVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberOfServerGroupVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to MemberOfServerGroupVirtualAttributeResponseAllOf
  */
  public static MemberOfServerGroupVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberOfServerGroupVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of MemberOfServerGroupVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
