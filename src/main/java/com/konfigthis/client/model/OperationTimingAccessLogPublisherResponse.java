...
public class OperationTimingAccessLogPublisherResponse {
  ...
  public OperationTimingAccessLogPublisherResponse() {
  }

  public OperationTimingAccessLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse schemas(List<EnumoperationTimingAccessLogPublisherSchemaUrn> schemas) {
  ...
  public OperationTimingAccessLogPublisherResponse addSchemasItem(EnumoperationTimingAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this Operation Timing Access Log Publisher.")
  ...
  public OperationTimingAccessLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public OperationTimingAccessLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the Operation Timing Access Log Publisher .")
  ...
  public OperationTimingAccessLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public OperationTimingAccessLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public OperationTimingAccessLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the Operation Timing Access Log Publisher .")
  ...
  public OperationTimingAccessLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse minIncludedOperationProcessingTime(String minIncludedOperationProcessingTime) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse minIncludedPhaseTimeNanos(Integer minIncludedPhaseTimeNanos) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the Operation Timing Access Log Publisher will publish records asynchronously.")
  ...
  public OperationTimingAccessLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public OperationTimingAccessLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the OperationTimingAccessLogPublisherResponse instance itself
   */
  public OperationTimingAccessLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OperationTimingAccessLogPublisherResponse operationTimingAccessLogPublisherResponse = (OperationTimingAccessLogPublisherResponse) o;
    return Objects.equals(this.id, operationTimingAccessLogPublisherResponse.id) &&
        Objects.equals(this.description, operationTimingAccessLogPublisherResponse.description) &&
        Objects.equals(this.schemas, operationTimingAccessLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, operationTimingAccessLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, operationTimingAccessLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, operationTimingAccessLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, operationTimingAccessLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, operationTimingAccessLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, operationTimingAccessLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, operationTimingAccessLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, operationTimingAccessLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, operationTimingAccessLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, operationTimingAccessLogPublisherResponse.append) &&
        Objects.equals(this.includeProductName, operationTimingAccessLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, operationTimingAccessLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, operationTimingAccessLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, operationTimingAccessLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.includeRequesterIPAddress, operationTimingAccessLogPublisherResponse.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequesterDN, operationTimingAccessLogPublisherResponse.includeRequesterDN) &&
        Objects.equals(this.minIncludedOperationProcessingTime, operationTimingAccessLogPublisherResponse.minIncludedOperationProcessingTime) &&
        Objects.equals(this.minIncludedPhaseTimeNanos, operationTimingAccessLogPublisherResponse.minIncludedPhaseTimeNanos) &&
        Objects.equals(this.asynchronous, operationTimingAccessLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, operationTimingAccessLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, operationTimingAccessLogPublisherResponse.bufferSize) &&
        Objects.equals(this.maxStringLength, operationTimingAccessLogPublisherResponse.maxStringLength) &&
        Objects.equals(this.queueSize, operationTimingAccessLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, operationTimingAccessLogPublisherResponse.timeInterval) &&
        Objects.equals(this.logSecurityNegotiation, operationTimingAccessLogPublisherResponse.logSecurityNegotiation) &&
        Objects.equals(this.logIntermediateResponses, operationTimingAccessLogPublisherResponse.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, operationTimingAccessLogPublisherResponse.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, operationTimingAccessLogPublisherResponse.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, operationTimingAccessLogPublisherResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, operationTimingAccessLogPublisherResponse.requestCriteria) &&
        Objects.equals(this.resultCriteria, operationTimingAccessLogPublisherResponse.resultCriteria) &&
        Objects.equals(this.enabled, operationTimingAccessLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, operationTimingAccessLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, operationTimingAccessLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, operationTimingAccessLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, operationTimingAccessLogPublisherResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class OperationTimingAccessLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OperationTimingAccessLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OperationTimingAccessLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OperationTimingAccessLogPublisherResponse is not found in the empty JSON string", OperationTimingAccessLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OperationTimingAccessLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OperationTimingAccessLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OperationTimingAccessLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OperationTimingAccessLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OperationTimingAccessLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<OperationTimingAccessLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, OperationTimingAccessLogPublisherResponse value) throws IOException {
           ...
           @Override
           public OperationTimingAccessLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OperationTimingAccessLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OperationTimingAccessLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OperationTimingAccessLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to OperationTimingAccessLogPublisherResponse
  */
  public static OperationTimingAccessLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OperationTimingAccessLogPublisherResponse.class);
  }

 /**
  * Convert an instance of OperationTimingAccessLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
