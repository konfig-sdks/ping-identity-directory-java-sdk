...
public class ThirdPartyPasswordValidatorShared {
  ...
  public ThirdPartyPasswordValidatorShared() {
  }

  public ThirdPartyPasswordValidatorShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared schemas(List<EnumthirdPartyPasswordValidatorSchemaUrn> schemas) {
  ...
  public ThirdPartyPasswordValidatorShared addSchemasItem(EnumthirdPartyPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyPasswordValidatorShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public ThirdPartyPasswordValidatorShared validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the ThirdPartyPasswordValidatorShared instance itself
   */
  public ThirdPartyPasswordValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyPasswordValidatorShared thirdPartyPasswordValidatorShared = (ThirdPartyPasswordValidatorShared) o;
    return Objects.equals(this.description, thirdPartyPasswordValidatorShared.description) &&
        Objects.equals(this.schemas, thirdPartyPasswordValidatorShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyPasswordValidatorShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyPasswordValidatorShared.extensionArgument) &&
        Objects.equals(this.enabled, thirdPartyPasswordValidatorShared.enabled) &&
        Objects.equals(this.validatorRequirementDescription, thirdPartyPasswordValidatorShared.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, thirdPartyPasswordValidatorShared.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, thirdPartyPasswordValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyPasswordValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyPasswordValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyPasswordValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyPasswordValidatorShared is not found in the empty JSON string", ThirdPartyPasswordValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyPasswordValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyPasswordValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyPasswordValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyPasswordValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyPasswordValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyPasswordValidatorShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyPasswordValidatorShared value) throws IOException {
           ...
           @Override
           public ThirdPartyPasswordValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyPasswordValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyPasswordValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyPasswordValidatorShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyPasswordValidatorShared
  */
  public static ThirdPartyPasswordValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyPasswordValidatorShared.class);
  }

 /**
  * Convert an instance of ThirdPartyPasswordValidatorShared to an JSON string
  *
  * @return JSON string
  */
