...
public class SubschemaSubentryVirtualAttributeResponseAllOf {
  ...
  private List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> schemas = null;
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf() {
  }

  public SubschemaSubentryVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf schemas(List<EnumsubschemaSubentryVirtualAttributeSchemaUrn> schemas) {
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf addSchemasItem(EnumsubschemaSubentryVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public SubschemaSubentryVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the SubschemaSubentryVirtualAttributeResponseAllOf instance itself
   */
  public SubschemaSubentryVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SubschemaSubentryVirtualAttributeResponseAllOf subschemaSubentryVirtualAttributeResponseAllOf = (SubschemaSubentryVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, subschemaSubentryVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, subschemaSubentryVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, subschemaSubentryVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, subschemaSubentryVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, subschemaSubentryVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.enabled, subschemaSubentryVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, subschemaSubentryVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, subschemaSubentryVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, subschemaSubentryVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, subschemaSubentryVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, subschemaSubentryVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, subschemaSubentryVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, subschemaSubentryVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, subschemaSubentryVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, subschemaSubentryVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubschemaSubentryVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubschemaSubentryVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubschemaSubentryVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubschemaSubentryVirtualAttributeResponseAllOf is not found in the empty JSON string", SubschemaSubentryVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubschemaSubentryVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubschemaSubentryVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubschemaSubentryVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubschemaSubentryVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SubschemaSubentryVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SubschemaSubentryVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public SubschemaSubentryVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SubschemaSubentryVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SubschemaSubentryVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SubschemaSubentryVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SubschemaSubentryVirtualAttributeResponseAllOf
  */
  public static SubschemaSubentryVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubschemaSubentryVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of SubschemaSubentryVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
