...
public class ThirdPartyHttpServletExtensionShared {
  ...
  public ThirdPartyHttpServletExtensionShared() {
  }

  public ThirdPartyHttpServletExtensionShared description(String description) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared schemas(List<EnumthirdPartyHttpServletExtensionSchemaUrn> schemas) {
  ...
  public ThirdPartyHttpServletExtensionShared addSchemasItem(EnumthirdPartyHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared extensionClass(String extensionClass) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared extensionArgument(List<String> extensionArgument) {
  ...
  public ThirdPartyHttpServletExtensionShared addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared responseHeader(List<String> responseHeader) {
  ...
  public ThirdPartyHttpServletExtensionShared addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public ThirdPartyHttpServletExtensionShared correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
   ...
   * @return the ThirdPartyHttpServletExtensionShared instance itself
   */
  public ThirdPartyHttpServletExtensionShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ThirdPartyHttpServletExtensionShared thirdPartyHttpServletExtensionShared = (ThirdPartyHttpServletExtensionShared) o;
    return Objects.equals(this.description, thirdPartyHttpServletExtensionShared.description) &&
        Objects.equals(this.schemas, thirdPartyHttpServletExtensionShared.schemas) &&
        Objects.equals(this.extensionClass, thirdPartyHttpServletExtensionShared.extensionClass) &&
        Objects.equals(this.extensionArgument, thirdPartyHttpServletExtensionShared.extensionArgument) &&
        Objects.equals(this.crossOriginPolicy, thirdPartyHttpServletExtensionShared.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, thirdPartyHttpServletExtensionShared.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, thirdPartyHttpServletExtensionShared.correlationIDResponseHeader)&&
        Objects.equals(this.additionalProperties, thirdPartyHttpServletExtensionShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, extensionClass, extensionArgument, crossOriginPolicy, responseHeader, correlationIDResponseHeader, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThirdPartyHttpServletExtensionShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ThirdPartyHttpServletExtensionShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ThirdPartyHttpServletExtensionShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ThirdPartyHttpServletExtensionShared is not found in the empty JSON string", ThirdPartyHttpServletExtensionShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ThirdPartyHttpServletExtensionShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ThirdPartyHttpServletExtensionShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ThirdPartyHttpServletExtensionShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ThirdPartyHttpServletExtensionShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ThirdPartyHttpServletExtensionShared.class));

       return (TypeAdapter<T>) new TypeAdapter<ThirdPartyHttpServletExtensionShared>() {
           @Override
           public void write(JsonWriter out, ThirdPartyHttpServletExtensionShared value) throws IOException {
           ...
           @Override
           public ThirdPartyHttpServletExtensionShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ThirdPartyHttpServletExtensionShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ThirdPartyHttpServletExtensionShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ThirdPartyHttpServletExtensionShared
  * @throws IOException if the JSON string is invalid with respect to ThirdPartyHttpServletExtensionShared
  */
  public static ThirdPartyHttpServletExtensionShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ThirdPartyHttpServletExtensionShared.class);
  }

 /**
  * Convert an instance of ThirdPartyHttpServletExtensionShared to an JSON string
  *
  * @return JSON string
  */
