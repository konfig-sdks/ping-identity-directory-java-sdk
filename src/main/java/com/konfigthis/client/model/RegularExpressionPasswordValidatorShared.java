...
public class RegularExpressionPasswordValidatorShared {
  ...
  public RegularExpressionPasswordValidatorShared() {
  }

  public RegularExpressionPasswordValidatorShared description(String description) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared schemas(List<EnumregularExpressionPasswordValidatorSchemaUrn> schemas) {
  ...
  public RegularExpressionPasswordValidatorShared addSchemasItem(EnumregularExpressionPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared matchPattern(String matchPattern) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared matchBehavior(EnumpasswordValidatorMatchBehaviorProp matchBehavior) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public RegularExpressionPasswordValidatorShared validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the RegularExpressionPasswordValidatorShared instance itself
   */
  public RegularExpressionPasswordValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RegularExpressionPasswordValidatorShared regularExpressionPasswordValidatorShared = (RegularExpressionPasswordValidatorShared) o;
    return Objects.equals(this.description, regularExpressionPasswordValidatorShared.description) &&
        Objects.equals(this.schemas, regularExpressionPasswordValidatorShared.schemas) &&
        Objects.equals(this.matchPattern, regularExpressionPasswordValidatorShared.matchPattern) &&
        Objects.equals(this.matchBehavior, regularExpressionPasswordValidatorShared.matchBehavior) &&
        Objects.equals(this.enabled, regularExpressionPasswordValidatorShared.enabled) &&
        Objects.equals(this.validatorRequirementDescription, regularExpressionPasswordValidatorShared.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, regularExpressionPasswordValidatorShared.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, regularExpressionPasswordValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, matchPattern, matchBehavior, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RegularExpressionPasswordValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RegularExpressionPasswordValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RegularExpressionPasswordValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RegularExpressionPasswordValidatorShared is not found in the empty JSON string", RegularExpressionPasswordValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RegularExpressionPasswordValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RegularExpressionPasswordValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RegularExpressionPasswordValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RegularExpressionPasswordValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RegularExpressionPasswordValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<RegularExpressionPasswordValidatorShared>() {
           @Override
           public void write(JsonWriter out, RegularExpressionPasswordValidatorShared value) throws IOException {
           ...
           @Override
           public RegularExpressionPasswordValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RegularExpressionPasswordValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RegularExpressionPasswordValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RegularExpressionPasswordValidatorShared
  * @throws IOException if the JSON string is invalid with respect to RegularExpressionPasswordValidatorShared
  */
  public static RegularExpressionPasswordValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RegularExpressionPasswordValidatorShared.class);
  }

 /**
  * Convert an instance of RegularExpressionPasswordValidatorShared to an JSON string
  *
  * @return JSON string
  */
