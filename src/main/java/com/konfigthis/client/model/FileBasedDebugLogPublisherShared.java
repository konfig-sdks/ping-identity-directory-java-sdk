...
public class FileBasedDebugLogPublisherShared {
  ...
  public FileBasedDebugLogPublisherShared() {
  }

  public FileBasedDebugLogPublisherShared description(String description) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared schemas(List<EnumfileBasedDebugLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedDebugLogPublisherShared addSchemasItem(EnumfileBasedDebugLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedDebugLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public FileBasedDebugLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedDebugLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultDebugLevel(EnumlogPublisherDefaultDebugLevelProp defaultDebugLevel) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultDebugCategory(List<EnumlogPublisherDefaultDebugCategoryProp> defaultDebugCategory) {
  ...
  public FileBasedDebugLogPublisherShared addDefaultDebugCategoryItem(EnumlogPublisherDefaultDebugCategoryProp defaultDebugCategoryItem) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultOmitMethodEntryArguments(Boolean defaultOmitMethodEntryArguments) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultOmitMethodReturnValue(Boolean defaultOmitMethodReturnValue) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultIncludeThrowableCause(Boolean defaultIncludeThrowableCause) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared defaultThrowableStackFrames(Integer defaultThrowableStackFrames) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedDebugLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the FileBasedDebugLogPublisherShared instance itself
   */
  public FileBasedDebugLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedDebugLogPublisherShared fileBasedDebugLogPublisherShared = (FileBasedDebugLogPublisherShared) o;
    return Objects.equals(this.description, fileBasedDebugLogPublisherShared.description) &&
        Objects.equals(this.schemas, fileBasedDebugLogPublisherShared.schemas) &&
        Objects.equals(this.logFile, fileBasedDebugLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedDebugLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedDebugLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedDebugLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedDebugLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedDebugLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedDebugLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, fileBasedDebugLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedDebugLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedDebugLogPublisherShared.append) &&
        Objects.equals(this.asynchronous, fileBasedDebugLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedDebugLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedDebugLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedDebugLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedDebugLogPublisherShared.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedDebugLogPublisherShared.timestampPrecision) &&
        Objects.equals(this.defaultDebugLevel, fileBasedDebugLogPublisherShared.defaultDebugLevel) &&
        Objects.equals(this.defaultDebugCategory, fileBasedDebugLogPublisherShared.defaultDebugCategory) &&
        Objects.equals(this.defaultOmitMethodEntryArguments, fileBasedDebugLogPublisherShared.defaultOmitMethodEntryArguments) &&
        Objects.equals(this.defaultOmitMethodReturnValue, fileBasedDebugLogPublisherShared.defaultOmitMethodReturnValue) &&
        Objects.equals(this.defaultIncludeThrowableCause, fileBasedDebugLogPublisherShared.defaultIncludeThrowableCause) &&
        Objects.equals(this.defaultThrowableStackFrames, fileBasedDebugLogPublisherShared.defaultThrowableStackFrames) &&
        Objects.equals(this.enabled, fileBasedDebugLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedDebugLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, fileBasedDebugLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FileBasedDebugLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedDebugLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedDebugLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedDebugLogPublisherShared is not found in the empty JSON string", FileBasedDebugLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedDebugLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedDebugLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedDebugLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedDebugLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedDebugLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedDebugLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, FileBasedDebugLogPublisherShared value) throws IOException {
           ...
           @Override
           public FileBasedDebugLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedDebugLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedDebugLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedDebugLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to FileBasedDebugLogPublisherShared
  */
  public static FileBasedDebugLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedDebugLogPublisherShared.class);
  }

 /**
  * Convert an instance of FileBasedDebugLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
