...
public class ReplicationAssurancePolicyResponse {
  ...
  public ReplicationAssurancePolicyResponse() {
  }

  public ReplicationAssurancePolicyResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Replication Assurance Policy")
  ...
  public ReplicationAssurancePolicyResponse description(String description) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse schemas(List<EnumreplicationAssurancePolicySchemaUrn> schemas) {
  ...
  public ReplicationAssurancePolicyResponse addSchemasItem(EnumreplicationAssurancePolicySchemaUrn schemasItem) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether this Replication Assurance Policy is enabled for use in the server. If a Replication Assurance Policy is disabled, then no new operations will be associated with it.")
  ...
  public ReplicationAssurancePolicyResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse localLevel(EnumreplicationAssurancePolicyLocalLevelProp localLevel) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse remoteLevel(EnumreplicationAssurancePolicyRemoteLevelProp remoteLevel) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse timeout(String timeout) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ReplicationAssurancePolicyResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ReplicationAssurancePolicyResponse instance itself
   */
  public ReplicationAssurancePolicyResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReplicationAssurancePolicyResponse replicationAssurancePolicyResponse = (ReplicationAssurancePolicyResponse) o;
    return Objects.equals(this.id, replicationAssurancePolicyResponse.id) &&
        Objects.equals(this.description, replicationAssurancePolicyResponse.description) &&
        Objects.equals(this.schemas, replicationAssurancePolicyResponse.schemas) &&
        Objects.equals(this.enabled, replicationAssurancePolicyResponse.enabled) &&
        Objects.equals(this.evaluationOrderIndex, replicationAssurancePolicyResponse.evaluationOrderIndex) &&
        Objects.equals(this.localLevel, replicationAssurancePolicyResponse.localLevel) &&
        Objects.equals(this.remoteLevel, replicationAssurancePolicyResponse.remoteLevel) &&
        Objects.equals(this.timeout, replicationAssurancePolicyResponse.timeout) &&
        Objects.equals(this.connectionCriteria, replicationAssurancePolicyResponse.connectionCriteria) &&
        Objects.equals(this.requestCriteria, replicationAssurancePolicyResponse.requestCriteria) &&
        Objects.equals(this.meta, replicationAssurancePolicyResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, replicationAssurancePolicyResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, replicationAssurancePolicyResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, enabled, evaluationOrderIndex, localLevel, remoteLevel, timeout, connectionCriteria, requestCriteria, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ReplicationAssurancePolicyResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("localLevel");
    openapiRequiredFields.add("remoteLevel");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReplicationAssurancePolicyResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReplicationAssurancePolicyResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReplicationAssurancePolicyResponse is not found in the empty JSON string", ReplicationAssurancePolicyResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ReplicationAssurancePolicyResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReplicationAssurancePolicyResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReplicationAssurancePolicyResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReplicationAssurancePolicyResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReplicationAssurancePolicyResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReplicationAssurancePolicyResponse>() {
           @Override
           public void write(JsonWriter out, ReplicationAssurancePolicyResponse value) throws IOException {
           ...
           @Override
           public ReplicationAssurancePolicyResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReplicationAssurancePolicyResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReplicationAssurancePolicyResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReplicationAssurancePolicyResponse
  * @throws IOException if the JSON string is invalid with respect to ReplicationAssurancePolicyResponse
  */
  public static ReplicationAssurancePolicyResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReplicationAssurancePolicyResponse.class);
  }

 /**
  * Convert an instance of ReplicationAssurancePolicyResponse to an JSON string
  *
  * @return JSON string
  */
