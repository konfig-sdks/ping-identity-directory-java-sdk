...
public class BindAccessTokenValidatorResponse {
  ...
  private List<EnumbindAccessTokenValidatorSchemaUrn> schemas = new ArrayList<>();
  ...
  public BindAccessTokenValidatorResponse() {
  }

  public BindAccessTokenValidatorResponse description(String description) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse schemas(List<EnumbindAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public BindAccessTokenValidatorResponse addSchemasItem(EnumbindAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse id(String id) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether this Bind Access Token Validator is enabled for use in Directory Server.")
  ...
  public BindAccessTokenValidatorResponse persistAccessTokens(Boolean persistAccessTokens) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse maximumTokenLifetime(String maximumTokenLifetime) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse allowedAuthenticationType(List<EnumaccessTokenValidatorAllowedAuthenticationTypeProp> allowedAuthenticationType) {
  ...
  public BindAccessTokenValidatorResponse addAllowedAuthenticationTypeItem(EnumaccessTokenValidatorAllowedAuthenticationTypeProp allowedAuthenticationTypeItem) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse allowedSASLMechanism(List<String> allowedSASLMechanism) {
  ...
  public BindAccessTokenValidatorResponse addAllowedSASLMechanismItem(String allowedSASLMechanismItem) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse generateTokenResultCriteria(String generateTokenResultCriteria) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse includedScope(List<String> includedScope) {
  ...
  public BindAccessTokenValidatorResponse addIncludedScopeItem(String includedScopeItem) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public BindAccessTokenValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the BindAccessTokenValidatorResponse instance itself
   */
  public BindAccessTokenValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BindAccessTokenValidatorResponse bindAccessTokenValidatorResponse = (BindAccessTokenValidatorResponse) o;
    return Objects.equals(this.description, bindAccessTokenValidatorResponse.description) &&
        Objects.equals(this.schemas, bindAccessTokenValidatorResponse.schemas) &&
        Objects.equals(this.id, bindAccessTokenValidatorResponse.id) &&
        Objects.equals(this.enabled, bindAccessTokenValidatorResponse.enabled) &&
        Objects.equals(this.persistAccessTokens, bindAccessTokenValidatorResponse.persistAccessTokens) &&
        Objects.equals(this.maximumTokenLifetime, bindAccessTokenValidatorResponse.maximumTokenLifetime) &&
        Objects.equals(this.allowedAuthenticationType, bindAccessTokenValidatorResponse.allowedAuthenticationType) &&
        Objects.equals(this.allowedSASLMechanism, bindAccessTokenValidatorResponse.allowedSASLMechanism) &&
        Objects.equals(this.generateTokenResultCriteria, bindAccessTokenValidatorResponse.generateTokenResultCriteria) &&
        Objects.equals(this.includedScope, bindAccessTokenValidatorResponse.includedScope) &&
        Objects.equals(this.identityMapper, bindAccessTokenValidatorResponse.identityMapper) &&
        Objects.equals(this.subjectClaimName, bindAccessTokenValidatorResponse.subjectClaimName) &&
        Objects.equals(this.evaluationOrderIndex, bindAccessTokenValidatorResponse.evaluationOrderIndex) &&
        Objects.equals(this.meta, bindAccessTokenValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, bindAccessTokenValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, bindAccessTokenValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, persistAccessTokens, maximumTokenLifetime, allowedAuthenticationType, allowedSASLMechanism, generateTokenResultCriteria, includedScope, identityMapper, subjectClaimName, evaluationOrderIndex, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BindAccessTokenValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BindAccessTokenValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BindAccessTokenValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BindAccessTokenValidatorResponse is not found in the empty JSON string", BindAccessTokenValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : BindAccessTokenValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BindAccessTokenValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BindAccessTokenValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BindAccessTokenValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BindAccessTokenValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BindAccessTokenValidatorResponse>() {
           @Override
           public void write(JsonWriter out, BindAccessTokenValidatorResponse value) throws IOException {
           ...
           @Override
           public BindAccessTokenValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BindAccessTokenValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BindAccessTokenValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BindAccessTokenValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to BindAccessTokenValidatorResponse
  */
  public static BindAccessTokenValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BindAccessTokenValidatorResponse.class);
  }

 /**
  * Convert an instance of BindAccessTokenValidatorResponse to an JSON string
  *
  * @return JSON string
  */
