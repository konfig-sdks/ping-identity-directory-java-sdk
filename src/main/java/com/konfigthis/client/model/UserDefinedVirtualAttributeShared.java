...
public class UserDefinedVirtualAttributeShared {
  ...
  public UserDefinedVirtualAttributeShared() {
  }

  public UserDefinedVirtualAttributeShared description(String description) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared schemas(List<EnumuserDefinedVirtualAttributeSchemaUrn> schemas) {
  ...
  public UserDefinedVirtualAttributeShared addSchemasItem(EnumuserDefinedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared value(List<String> value) {
  ...
  public UserDefinedVirtualAttributeShared addValueItem(String valueItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared baseDN(List<String> baseDN) {
  ...
  public UserDefinedVirtualAttributeShared addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared groupDN(List<String> groupDN) {
  ...
  public UserDefinedVirtualAttributeShared addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared filter(List<String> filter) {
  ...
  public UserDefinedVirtualAttributeShared addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public UserDefinedVirtualAttributeShared addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public UserDefinedVirtualAttributeShared allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the UserDefinedVirtualAttributeShared instance itself
   */
  public UserDefinedVirtualAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserDefinedVirtualAttributeShared userDefinedVirtualAttributeShared = (UserDefinedVirtualAttributeShared) o;
    return Objects.equals(this.description, userDefinedVirtualAttributeShared.description) &&
        Objects.equals(this.schemas, userDefinedVirtualAttributeShared.schemas) &&
        Objects.equals(this.value, userDefinedVirtualAttributeShared.value) &&
        Objects.equals(this.enabled, userDefinedVirtualAttributeShared.enabled) &&
        Objects.equals(this.attributeType, userDefinedVirtualAttributeShared.attributeType) &&
        Objects.equals(this.baseDN, userDefinedVirtualAttributeShared.baseDN) &&
        Objects.equals(this.groupDN, userDefinedVirtualAttributeShared.groupDN) &&
        Objects.equals(this.filter, userDefinedVirtualAttributeShared.filter) &&
        Objects.equals(this.clientConnectionPolicy, userDefinedVirtualAttributeShared.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, userDefinedVirtualAttributeShared.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, userDefinedVirtualAttributeShared.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, userDefinedVirtualAttributeShared.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, userDefinedVirtualAttributeShared.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, userDefinedVirtualAttributeShared.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, userDefinedVirtualAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, value, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UserDefinedVirtualAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserDefinedVirtualAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserDefinedVirtualAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDefinedVirtualAttributeShared is not found in the empty JSON string", UserDefinedVirtualAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserDefinedVirtualAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDefinedVirtualAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDefinedVirtualAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDefinedVirtualAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDefinedVirtualAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDefinedVirtualAttributeShared>() {
           @Override
           public void write(JsonWriter out, UserDefinedVirtualAttributeShared value) throws IOException {
           ...
           @Override
           public UserDefinedVirtualAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserDefinedVirtualAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserDefinedVirtualAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserDefinedVirtualAttributeShared
  * @throws IOException if the JSON string is invalid with respect to UserDefinedVirtualAttributeShared
  */
  public static UserDefinedVirtualAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDefinedVirtualAttributeShared.class);
  }

 /**
  * Convert an instance of UserDefinedVirtualAttributeShared to an JSON string
  *
  * @return JSON string
  */
