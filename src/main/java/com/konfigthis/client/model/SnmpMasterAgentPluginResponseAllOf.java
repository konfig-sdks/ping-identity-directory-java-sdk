...
public class SnmpMasterAgentPluginResponseAllOf {
  ...
  private List<EnumsnmpMasterAgentPluginSchemaUrn> schemas = null;
  ...
  private List<EnumpluginAgentSNMPVersionProp> agentSNMPVersion = null;
  ...
  public SnmpMasterAgentPluginResponseAllOf() {
  }

  public SnmpMasterAgentPluginResponseAllOf description(String description) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf schemas(List<EnumsnmpMasterAgentPluginSchemaUrn> schemas) {
  ...
  public SnmpMasterAgentPluginResponseAllOf addSchemasItem(EnumsnmpMasterAgentPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf id(String id) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf listenAddress(String listenAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The IP address on which the SNMP agent will listen for client requests.")
  ...
  public SnmpMasterAgentPluginResponseAllOf listenPort(Integer listenPort) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The port number on which the SNMP agent will listen for client requests.")
  ...
  public SnmpMasterAgentPluginResponseAllOf agentxTransport(EnumpluginAgentxTransportProp agentxTransport) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentxListenAddress(String agentxListenAddress) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The IP address on which the SNMP agent will listen for sub-agent sessions.")
  ...
  public SnmpMasterAgentPluginResponseAllOf agentxListenPort(Integer agentxListenPort) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The port number on which the SNMP agent will listen for sub-agent sessions.")
  ...
  public SnmpMasterAgentPluginResponseAllOf notificationTargetAddress(String notificationTargetAddress) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf notificationTargetPort(Integer notificationTargetPort) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentSNMPVersion(List<EnumpluginAgentSNMPVersionProp> agentSNMPVersion) {
  ...
  public SnmpMasterAgentPluginResponseAllOf addAgentSNMPVersionItem(EnumpluginAgentSNMPVersionProp agentSNMPVersionItem) {
    if (this.agentSNMPVersion == null) {
      this.agentSNMPVersion = new ArrayList<>();
    }
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf communityName(String communityName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the community to use for the SNMP agent.")
  ...
  public SnmpMasterAgentPluginResponseAllOf agentSecurityName(String agentSecurityName) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentSecurityLevel(EnumpluginAgentSecurityLevelProp agentSecurityLevel) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentAuthenticationProtocol(EnumpluginAgentAuthenticationProtocolProp agentAuthenticationProtocol) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentAuthenticationPassphrase(String agentAuthenticationPassphrase) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentPrivacyProtocol(EnumpluginAgentPrivacyProtocolProp agentPrivacyProtocol) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf agentPrivacyPassphrase(String agentPrivacyPassphrase) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf numWorkerThreads(Integer numWorkerThreads) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public SnmpMasterAgentPluginResponseAllOf invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the SnmpMasterAgentPluginResponseAllOf instance itself
   */
  public SnmpMasterAgentPluginResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SnmpMasterAgentPluginResponseAllOf snmpMasterAgentPluginResponseAllOf = (SnmpMasterAgentPluginResponseAllOf) o;
    return Objects.equals(this.description, snmpMasterAgentPluginResponseAllOf.description) &&
        Objects.equals(this.schemas, snmpMasterAgentPluginResponseAllOf.schemas) &&
        Objects.equals(this.id, snmpMasterAgentPluginResponseAllOf.id) &&
        Objects.equals(this.listenAddress, snmpMasterAgentPluginResponseAllOf.listenAddress) &&
        Objects.equals(this.listenPort, snmpMasterAgentPluginResponseAllOf.listenPort) &&
        Objects.equals(this.agentxTransport, snmpMasterAgentPluginResponseAllOf.agentxTransport) &&
        Objects.equals(this.agentxListenAddress, snmpMasterAgentPluginResponseAllOf.agentxListenAddress) &&
        Objects.equals(this.agentxListenPort, snmpMasterAgentPluginResponseAllOf.agentxListenPort) &&
        Objects.equals(this.notificationTargetAddress, snmpMasterAgentPluginResponseAllOf.notificationTargetAddress) &&
        Objects.equals(this.notificationTargetPort, snmpMasterAgentPluginResponseAllOf.notificationTargetPort) &&
        Objects.equals(this.agentSNMPVersion, snmpMasterAgentPluginResponseAllOf.agentSNMPVersion) &&
        Objects.equals(this.communityName, snmpMasterAgentPluginResponseAllOf.communityName) &&
        Objects.equals(this.agentSecurityName, snmpMasterAgentPluginResponseAllOf.agentSecurityName) &&
        Objects.equals(this.agentSecurityLevel, snmpMasterAgentPluginResponseAllOf.agentSecurityLevel) &&
        Objects.equals(this.agentAuthenticationProtocol, snmpMasterAgentPluginResponseAllOf.agentAuthenticationProtocol) &&
        Objects.equals(this.agentAuthenticationPassphrase, snmpMasterAgentPluginResponseAllOf.agentAuthenticationPassphrase) &&
        Objects.equals(this.agentPrivacyProtocol, snmpMasterAgentPluginResponseAllOf.agentPrivacyProtocol) &&
        Objects.equals(this.agentPrivacyPassphrase, snmpMasterAgentPluginResponseAllOf.agentPrivacyPassphrase) &&
        Objects.equals(this.numWorkerThreads, snmpMasterAgentPluginResponseAllOf.numWorkerThreads) &&
        Objects.equals(this.enabled, snmpMasterAgentPluginResponseAllOf.enabled) &&
        Objects.equals(this.invokeForInternalOperations, snmpMasterAgentPluginResponseAllOf.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, snmpMasterAgentPluginResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, listenAddress, listenPort, agentxTransport, agentxListenAddress, agentxListenPort, notificationTargetAddress, notificationTargetPort, agentSNMPVersion, communityName, agentSecurityName, agentSecurityLevel, agentAuthenticationProtocol, agentAuthenticationPassphrase, agentPrivacyProtocol, agentPrivacyPassphrase, numWorkerThreads, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SnmpMasterAgentPluginResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SnmpMasterAgentPluginResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SnmpMasterAgentPluginResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SnmpMasterAgentPluginResponseAllOf is not found in the empty JSON string", SnmpMasterAgentPluginResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("agentxListenAddress") != null && !jsonObj.get("agentxListenAddress").isJsonNull()) && !jsonObj.get("agentxListenAddress").isJsonPrimitive()) {
      ...
      // ensure the optional json data is an array if present
      if (jsonObj.get("agentSNMPVersion") != null && !jsonObj.get("agentSNMPVersion").isJsonArray()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SnmpMasterAgentPluginResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SnmpMasterAgentPluginResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SnmpMasterAgentPluginResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SnmpMasterAgentPluginResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SnmpMasterAgentPluginResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SnmpMasterAgentPluginResponseAllOf value) throws IOException {
           ...
           @Override
           public SnmpMasterAgentPluginResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SnmpMasterAgentPluginResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SnmpMasterAgentPluginResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SnmpMasterAgentPluginResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SnmpMasterAgentPluginResponseAllOf
  */
  public static SnmpMasterAgentPluginResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SnmpMasterAgentPluginResponseAllOf.class);
  }

 /**
  * Convert an instance of SnmpMasterAgentPluginResponseAllOf to an JSON string
  *
  * @return JSON string
  */
