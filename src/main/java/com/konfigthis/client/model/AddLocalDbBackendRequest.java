...
public class AddLocalDbBackendRequest {
  public static final String SERIALIZED_NAME_BACKEND_NAME = "backendName";
  @SerializedName(SERIALIZED_NAME_BACKEND_NAME)
  ...
  private List<EnumlocalDbBackendSchemaUrn> schemas = new ArrayList<>();

  public static final String SERIALIZED_NAME_UNCACHED_ID2ENTRY_CACHE_MODE = "uncachedId2entryCacheMode";
  @SerializedName(SERIALIZED_NAME_UNCACHED_ID2ENTRY_CACHE_MODE)
  private EnumbackendUncachedId2entryCacheModeProp uncachedId2entryCacheMode;

  public static final String SERIALIZED_NAME_UNCACHED_ATTRIBUTE_CRITERIA = "uncachedAttributeCriteria";
  @SerializedName(SERIALIZED_NAME_UNCACHED_ATTRIBUTE_CRITERIA)
  private String uncachedAttributeCriteria;

  public static final String SERIALIZED_NAME_UNCACHED_ENTRY_CRITERIA = "uncachedEntryCriteria";
  @SerializedName(SERIALIZED_NAME_UNCACHED_ENTRY_CRITERIA)
  ...
  public static final String SERIALIZED_NAME_SET_DEGRADED_ALERT_FOR_UNTRUSTED_INDEX = "setDegradedAlertForUntrustedIndex";
  @SerializedName(SERIALIZED_NAME_SET_DEGRADED_ALERT_FOR_UNTRUSTED_INDEX)
  private Boolean setDegradedAlertForUntrustedIndex;

  public static final String SERIALIZED_NAME_RETURN_UNAVAILABLE_FOR_UNTRUSTED_INDEX = "returnUnavailableForUntrustedIndex";
  @SerializedName(SERIALIZED_NAME_RETURN_UNAVAILABLE_FOR_UNTRUSTED_INDEX)
  private Boolean returnUnavailableForUntrustedIndex;

  public static final String SERIALIZED_NAME_PROCESS_FILTERS_WITH_UNDEFINED_ATTRIBUTE_TYPES = "processFiltersWithUndefinedAttributeTypes";
  @SerializedName(SERIALIZED_NAME_PROCESS_FILTERS_WITH_UNDEFINED_ATTRIBUTE_TYPES)
  ...
  public AddLocalDbBackendRequest() {
  }

  public AddLocalDbBackendRequest backendName(String backendName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Backend")
  ...
  public AddLocalDbBackendRequest description(String description) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest schemas(List<EnumlocalDbBackendSchemaUrn> schemas) {
  ...
  public AddLocalDbBackendRequest addSchemasItem(EnumlocalDbBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumlocalDbBackendSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumlocalDbBackendSchemaUrn> schemas) {
  ...
  public AddLocalDbBackendRequest uncachedId2entryCacheMode(EnumbackendUncachedId2entryCacheModeProp uncachedId2entryCacheMode) {
   ...
   /**
   * Get uncachedId2entryCacheMode
   * @return uncachedId2entryCacheMode
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public EnumbackendUncachedId2entryCacheModeProp getUncachedId2entryCacheMode() {
    return uncachedId2entryCacheMode;
  }


  public void setUncachedId2entryCacheMode(EnumbackendUncachedId2entryCacheModeProp uncachedId2entryCacheMode) {
  ...
  public AddLocalDbBackendRequest uncachedAttributeCriteria(String uncachedAttributeCriteria) {
   ...
   * @return uncachedAttributeCriteria
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The criteria that will be used to identify attributes that should be written into the uncached-id2entry database rather than the id2entry database. This will only be used for entries in which the associated uncached-entry-criteria does not indicate that the entire entry should be uncached.")

  public String getUncachedAttributeCriteria() {
    return uncachedAttributeCriteria;
  }


  public void setUncachedAttributeCriteria(String uncachedAttributeCriteria) {
  ...
  public AddLocalDbBackendRequest uncachedEntryCriteria(String uncachedEntryCriteria) {
   ...
   * @return uncachedEntryCriteria
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The criteria that will be used to identify entries that should be written into the uncached-id2entry database rather than the id2entry database.")

  public String getUncachedEntryCriteria() {
    return uncachedEntryCriteria;
  }


  public void setUncachedEntryCriteria(String uncachedEntryCriteria) {
  ...
  public AddLocalDbBackendRequest writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest setDegradedAlertForUntrustedIndex(Boolean setDegradedAlertForUntrustedIndex) {
   ...
   * @return setDegradedAlertForUntrustedIndex
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines whether the Directory Server enters a DEGRADED state when this Local DB Backend has an index whose contents cannot be trusted.")

  public Boolean getSetDegradedAlertForUntrustedIndex() {
    return setDegradedAlertForUntrustedIndex;
  }


  public void setSetDegradedAlertForUntrustedIndex(Boolean setDegradedAlertForUntrustedIndex) {
  ...
  public AddLocalDbBackendRequest returnUnavailableForUntrustedIndex(Boolean returnUnavailableForUntrustedIndex) {
   ...
   * @return returnUnavailableForUntrustedIndex
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines whether the Directory Server returns UNAVAILABLE for any LDAP search operation in this Local DB Backend that would use an index whose contents cannot be trusted.")

  public Boolean getReturnUnavailableForUntrustedIndex() {
    return returnUnavailableForUntrustedIndex;
  }


  public void setReturnUnavailableForUntrustedIndex(Boolean returnUnavailableForUntrustedIndex) {
  ...
  public AddLocalDbBackendRequest processFiltersWithUndefinedAttributeTypes(Boolean processFiltersWithUndefinedAttributeTypes) {
   ...
   * @return processFiltersWithUndefinedAttributeTypes
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Determines whether the Directory Server should continue filter processing for LDAP search operations in this Local DB Backend that includes a search filter with an attribute that is not defined in the schema. This will only apply if check-schema is enabled in the global configuration.")

  public Boolean getProcessFiltersWithUndefinedAttributeTypes() {
    return processFiltersWithUndefinedAttributeTypes;
  }


  public void setProcessFiltersWithUndefinedAttributeTypes(Boolean processFiltersWithUndefinedAttributeTypes) {
  ...
  public AddLocalDbBackendRequest isPrivateBackend(Boolean isPrivateBackend) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbDirectory(String dbDirectory) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbDirectoryPermissions(String dbDirectoryPermissions) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest compactCommonParentDN(List<String> compactCommonParentDN) {
  ...
  public AddLocalDbBackendRequest addCompactCommonParentDNItem(String compactCommonParentDNItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest compressEntries(Boolean compressEntries) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest hashEntries(Boolean hashEntries) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbNumCleanerThreads(Integer dbNumCleanerThreads) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbCleanerMinUtilization(Integer dbCleanerMinUtilization) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbEvictorCriticalPercentage(Integer dbEvictorCriticalPercentage) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbCheckpointerWakeupInterval(String dbCheckpointerWakeupInterval) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbBackgroundSyncInterval(String dbBackgroundSyncInterval) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbUseThreadLocalHandles(Boolean dbUseThreadLocalHandles) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbLogFileMax(String dbLogFileMax) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbLoggingLevel(String dbLoggingLevel) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest jeProperty(List<String> jeProperty) {
  ...
  public AddLocalDbBackendRequest addJePropertyItem(String jePropertyItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbCachePercent(Integer dbCachePercent) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest defaultCacheMode(EnumbackendDefaultCacheModeProp defaultCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest id2entryCacheMode(EnumbackendId2entryCacheModeProp id2entryCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dn2idCacheMode(EnumbackendDn2idCacheModeProp dn2idCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest id2childrenCacheMode(EnumbackendId2childrenCacheModeProp id2childrenCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest id2subtreeCacheMode(EnumbackendId2subtreeCacheModeProp id2subtreeCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dn2uriCacheMode(EnumbackendDn2uriCacheModeProp dn2uriCacheMode) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest primeMethod(List<EnumbackendPrimeMethodProp> primeMethod) {
  ...
  public AddLocalDbBackendRequest addPrimeMethodItem(EnumbackendPrimeMethodProp primeMethodItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest primeThreadCount(Integer primeThreadCount) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest primeTimeLimit(String primeTimeLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest primeAllIndexes(Boolean primeAllIndexes) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest systemIndexToPrime(List<EnumbackendSystemIndexToPrimeProp> systemIndexToPrime) {
  ...
  public AddLocalDbBackendRequest addSystemIndexToPrimeItem(EnumbackendSystemIndexToPrimeProp systemIndexToPrimeItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest systemIndexToPrimeInternalNodesOnly(List<EnumbackendSystemIndexToPrimeInternalNodesOnlyProp> systemIndexToPrimeInternalNodesOnly) {
  ...
  public AddLocalDbBackendRequest addSystemIndexToPrimeInternalNodesOnlyItem(EnumbackendSystemIndexToPrimeInternalNodesOnlyProp systemIndexToPrimeInternalNodesOnlyItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest backgroundPrime(Boolean backgroundPrime) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest indexEntryLimit(Integer indexEntryLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest compositeIndexEntryLimit(Integer compositeIndexEntryLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest id2childrenIndexEntryLimit(Integer id2childrenIndexEntryLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest id2subtreeIndexEntryLimit(Integer id2subtreeIndexEntryLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest importTempDirectory(String importTempDirectory) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest importThreadCount(Integer importThreadCount) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest exportThreadCount(Integer exportThreadCount) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbImportCachePercent(Integer dbImportCachePercent) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest dbTxnWriteNoSync(Boolean dbTxnWriteNoSync) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest deadlockRetryLimit(Integer deadlockRetryLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest externalTxnDefaultBackendLockBehavior(EnumbackendExternalTxnDefaultBackendLockBehaviorProp externalTxnDefaultBackendLockBehavior) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest singleWriterLockBehavior(EnumbackendSingleWriterLockBehaviorProp singleWriterLockBehavior) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest subtreeDeleteSizeLimit(Integer subtreeDeleteSizeLimit) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest numRecentChanges(Integer numRecentChanges) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest offlineProcessDatabaseOpenTimeout(String offlineProcessDatabaseOpenTimeout) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest backendID(String backendID) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest baseDN(List<String> baseDN) {
  ...
  public AddLocalDbBackendRequest addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public AddLocalDbBackendRequest notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the AddLocalDbBackendRequest instance itself
   */
  public AddLocalDbBackendRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddLocalDbBackendRequest addLocalDbBackendRequest = (AddLocalDbBackendRequest) o;
    return Objects.equals(this.backendName, addLocalDbBackendRequest.backendName) &&
        Objects.equals(this.description, addLocalDbBackendRequest.description) &&
        Objects.equals(this.schemas, addLocalDbBackendRequest.schemas) &&
        Objects.equals(this.uncachedId2entryCacheMode, addLocalDbBackendRequest.uncachedId2entryCacheMode) &&
        Objects.equals(this.uncachedAttributeCriteria, addLocalDbBackendRequest.uncachedAttributeCriteria) &&
        Objects.equals(this.uncachedEntryCriteria, addLocalDbBackendRequest.uncachedEntryCriteria) &&
        Objects.equals(this.writabilityMode, addLocalDbBackendRequest.writabilityMode) &&
        Objects.equals(this.setDegradedAlertForUntrustedIndex, addLocalDbBackendRequest.setDegradedAlertForUntrustedIndex) &&
        Objects.equals(this.returnUnavailableForUntrustedIndex, addLocalDbBackendRequest.returnUnavailableForUntrustedIndex) &&
        Objects.equals(this.processFiltersWithUndefinedAttributeTypes, addLocalDbBackendRequest.processFiltersWithUndefinedAttributeTypes) &&
        Objects.equals(this.isPrivateBackend, addLocalDbBackendRequest.isPrivateBackend) &&
        Objects.equals(this.dbDirectory, addLocalDbBackendRequest.dbDirectory) &&
        Objects.equals(this.dbDirectoryPermissions, addLocalDbBackendRequest.dbDirectoryPermissions) &&
        Objects.equals(this.compactCommonParentDN, addLocalDbBackendRequest.compactCommonParentDN) &&
        Objects.equals(this.compressEntries, addLocalDbBackendRequest.compressEntries) &&
        Objects.equals(this.hashEntries, addLocalDbBackendRequest.hashEntries) &&
        Objects.equals(this.dbNumCleanerThreads, addLocalDbBackendRequest.dbNumCleanerThreads) &&
        Objects.equals(this.dbCleanerMinUtilization, addLocalDbBackendRequest.dbCleanerMinUtilization) &&
        Objects.equals(this.dbEvictorCriticalPercentage, addLocalDbBackendRequest.dbEvictorCriticalPercentage) &&
        Objects.equals(this.dbCheckpointerWakeupInterval, addLocalDbBackendRequest.dbCheckpointerWakeupInterval) &&
        Objects.equals(this.dbBackgroundSyncInterval, addLocalDbBackendRequest.dbBackgroundSyncInterval) &&
        Objects.equals(this.dbUseThreadLocalHandles, addLocalDbBackendRequest.dbUseThreadLocalHandles) &&
        Objects.equals(this.dbLogFileMax, addLocalDbBackendRequest.dbLogFileMax) &&
        Objects.equals(this.dbLoggingLevel, addLocalDbBackendRequest.dbLoggingLevel) &&
        Objects.equals(this.jeProperty, addLocalDbBackendRequest.jeProperty) &&
        Objects.equals(this.dbCachePercent, addLocalDbBackendRequest.dbCachePercent) &&
        Objects.equals(this.defaultCacheMode, addLocalDbBackendRequest.defaultCacheMode) &&
        Objects.equals(this.id2entryCacheMode, addLocalDbBackendRequest.id2entryCacheMode) &&
        Objects.equals(this.dn2idCacheMode, addLocalDbBackendRequest.dn2idCacheMode) &&
        Objects.equals(this.id2childrenCacheMode, addLocalDbBackendRequest.id2childrenCacheMode) &&
        Objects.equals(this.id2subtreeCacheMode, addLocalDbBackendRequest.id2subtreeCacheMode) &&
        Objects.equals(this.dn2uriCacheMode, addLocalDbBackendRequest.dn2uriCacheMode) &&
        Objects.equals(this.primeMethod, addLocalDbBackendRequest.primeMethod) &&
        Objects.equals(this.primeThreadCount, addLocalDbBackendRequest.primeThreadCount) &&
        Objects.equals(this.primeTimeLimit, addLocalDbBackendRequest.primeTimeLimit) &&
        Objects.equals(this.primeAllIndexes, addLocalDbBackendRequest.primeAllIndexes) &&
        Objects.equals(this.systemIndexToPrime, addLocalDbBackendRequest.systemIndexToPrime) &&
        Objects.equals(this.systemIndexToPrimeInternalNodesOnly, addLocalDbBackendRequest.systemIndexToPrimeInternalNodesOnly) &&
        Objects.equals(this.backgroundPrime, addLocalDbBackendRequest.backgroundPrime) &&
        Objects.equals(this.indexEntryLimit, addLocalDbBackendRequest.indexEntryLimit) &&
        Objects.equals(this.compositeIndexEntryLimit, addLocalDbBackendRequest.compositeIndexEntryLimit) &&
        Objects.equals(this.id2childrenIndexEntryLimit, addLocalDbBackendRequest.id2childrenIndexEntryLimit) &&
        Objects.equals(this.id2subtreeIndexEntryLimit, addLocalDbBackendRequest.id2subtreeIndexEntryLimit) &&
        Objects.equals(this.importTempDirectory, addLocalDbBackendRequest.importTempDirectory) &&
        Objects.equals(this.importThreadCount, addLocalDbBackendRequest.importThreadCount) &&
        Objects.equals(this.exportThreadCount, addLocalDbBackendRequest.exportThreadCount) &&
        Objects.equals(this.dbImportCachePercent, addLocalDbBackendRequest.dbImportCachePercent) &&
        Objects.equals(this.dbTxnWriteNoSync, addLocalDbBackendRequest.dbTxnWriteNoSync) &&
        Objects.equals(this.deadlockRetryLimit, addLocalDbBackendRequest.deadlockRetryLimit) &&
        Objects.equals(this.externalTxnDefaultBackendLockBehavior, addLocalDbBackendRequest.externalTxnDefaultBackendLockBehavior) &&
        Objects.equals(this.singleWriterLockBehavior, addLocalDbBackendRequest.singleWriterLockBehavior) &&
        Objects.equals(this.subtreeDeleteSizeLimit, addLocalDbBackendRequest.subtreeDeleteSizeLimit) &&
        Objects.equals(this.numRecentChanges, addLocalDbBackendRequest.numRecentChanges) &&
        Objects.equals(this.offlineProcessDatabaseOpenTimeout, addLocalDbBackendRequest.offlineProcessDatabaseOpenTimeout) &&
        Objects.equals(this.backendID, addLocalDbBackendRequest.backendID) &&
        Objects.equals(this.enabled, addLocalDbBackendRequest.enabled) &&
        Objects.equals(this.baseDN, addLocalDbBackendRequest.baseDN) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, addLocalDbBackendRequest.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, addLocalDbBackendRequest.returnUnavailableWhenDisabled) &&
        Objects.equals(this.notificationManager, addLocalDbBackendRequest.notificationManager)&&
        Objects.equals(this.additionalProperties, addLocalDbBackendRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(backendName, description, schemas, uncachedId2entryCacheMode, uncachedAttributeCriteria, uncachedEntryCriteria, writabilityMode, setDegradedAlertForUntrustedIndex, returnUnavailableForUntrustedIndex, processFiltersWithUndefinedAttributeTypes, isPrivateBackend, dbDirectory, dbDirectoryPermissions, compactCommonParentDN, compressEntries, hashEntries, dbNumCleanerThreads, dbCleanerMinUtilization, dbEvictorCriticalPercentage, dbCheckpointerWakeupInterval, dbBackgroundSyncInterval, dbUseThreadLocalHandles, dbLogFileMax, dbLoggingLevel, jeProperty, dbCachePercent, defaultCacheMode, id2entryCacheMode, dn2idCacheMode, id2childrenCacheMode, id2subtreeCacheMode, dn2uriCacheMode, primeMethod, primeThreadCount, primeTimeLimit, primeAllIndexes, systemIndexToPrime, systemIndexToPrimeInternalNodesOnly, backgroundPrime, indexEntryLimit, compositeIndexEntryLimit, id2childrenIndexEntryLimit, id2subtreeIndexEntryLimit, importTempDirectory, importThreadCount, exportThreadCount, dbImportCachePercent, dbTxnWriteNoSync, deadlockRetryLimit, externalTxnDefaultBackendLockBehavior, singleWriterLockBehavior, subtreeDeleteSizeLimit, numRecentChanges, offlineProcessDatabaseOpenTimeout, backendID, enabled, baseDN, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddLocalDbBackendRequest {\n");
    sb.append("    backendName: ").append(toIndentedString(backendName)).append("\n");
    sb.append("    description: ").append(toIndentedString(description)).append("\n");
    sb.append("    schemas: ").append(toIndentedString(schemas)).append("\n");
    sb.append("    uncachedId2entryCacheMode: ").append(toIndentedString(uncachedId2entryCacheMode)).append("\n");
    sb.append("    uncachedAttributeCriteria: ").append(toIndentedString(uncachedAttributeCriteria)).append("\n");
    sb.append("    uncachedEntryCriteria: ").append(toIndentedString(uncachedEntryCriteria)).append("\n");
    sb.append("    writabilityMode: ").append(toIndentedString(writabilityMode)).append("\n");
    sb.append("    setDegradedAlertForUntrustedIndex: ").append(toIndentedString(setDegradedAlertForUntrustedIndex)).append("\n");
    sb.append("    returnUnavailableForUntrustedIndex: ").append(toIndentedString(returnUnavailableForUntrustedIndex)).append("\n");
    sb.append("    processFiltersWithUndefinedAttributeTypes: ").append(toIndentedString(processFiltersWithUndefinedAttributeTypes)).append("\n");
  ...
  static {
    ...
    openapiFields.add("backendName");
    openapiFields.add("description");
    openapiFields.add("schemas");
    openapiFields.add("uncachedId2entryCacheMode");
    openapiFields.add("uncachedAttributeCriteria");
    openapiFields.add("uncachedEntryCriteria");
    openapiFields.add("writabilityMode");
    openapiFields.add("setDegradedAlertForUntrustedIndex");
    openapiFields.add("returnUnavailableForUntrustedIndex");
    openapiFields.add("processFiltersWithUndefinedAttributeTypes");
    ...
    openapiRequiredFields.add("backendName");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddLocalDbBackendRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddLocalDbBackendRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLocalDbBackendRequest is not found in the empty JSON string", AddLocalDbBackendRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLocalDbBackendRequest.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      if (!jsonObj.get("backendName").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `backendName` to be a primitive type in the JSON string but got `%s`", jsonObj.get("backendName").toString()));
      }
      ...
      if ((jsonObj.get("uncachedAttributeCriteria") != null && !jsonObj.get("uncachedAttributeCriteria").isJsonNull()) && !jsonObj.get("uncachedAttributeCriteria").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `uncachedAttributeCriteria` to be a primitive type in the JSON string but got `%s`", jsonObj.get("uncachedAttributeCriteria").toString()));
      }
      if ((jsonObj.get("uncachedEntryCriteria") != null && !jsonObj.get("uncachedEntryCriteria").isJsonNull()) && !jsonObj.get("uncachedEntryCriteria").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `uncachedEntryCriteria` to be a primitive type in the JSON string but got `%s`", jsonObj.get("uncachedEntryCriteria").toString()));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLocalDbBackendRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLocalDbBackendRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLocalDbBackendRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLocalDbBackendRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLocalDbBackendRequest>() {
           @Override
           public void write(JsonWriter out, AddLocalDbBackendRequest value) throws IOException {
           ...
           @Override
           public AddLocalDbBackendRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddLocalDbBackendRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddLocalDbBackendRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddLocalDbBackendRequest
  * @throws IOException if the JSON string is invalid with respect to AddLocalDbBackendRequest
  */
  public static AddLocalDbBackendRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLocalDbBackendRequest.class);
  }

 /**
  * Convert an instance of AddLocalDbBackendRequest to an JSON string
  *
  * @return JSON string
  */
