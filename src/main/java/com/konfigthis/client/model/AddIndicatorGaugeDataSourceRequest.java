...
public class AddIndicatorGaugeDataSourceRequest {
  ...
  public AddIndicatorGaugeDataSourceRequest() {
  }

  public AddIndicatorGaugeDataSourceRequest sourceName(String sourceName) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest description(String description) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest schemas(List<EnumindicatorGaugeDataSourceSchemaUrn> schemas) {
  ...
  public AddIndicatorGaugeDataSourceRequest addSchemasItem(EnumindicatorGaugeDataSourceSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest additionalText(String additionalText) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest monitorObjectclass(String monitorObjectclass) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest monitorAttribute(String monitorAttribute) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest includeFilter(String includeFilter) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest resourceAttribute(String resourceAttribute) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest resourceType(String resourceType) {
  ...
  **/
  ...
  public AddIndicatorGaugeDataSourceRequest minimumUpdateInterval(String minimumUpdateInterval) {
  ...
  **/
   ...
   * @return the AddIndicatorGaugeDataSourceRequest instance itself
   */
  public AddIndicatorGaugeDataSourceRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddIndicatorGaugeDataSourceRequest addIndicatorGaugeDataSourceRequest = (AddIndicatorGaugeDataSourceRequest) o;
    return Objects.equals(this.sourceName, addIndicatorGaugeDataSourceRequest.sourceName) &&
        Objects.equals(this.description, addIndicatorGaugeDataSourceRequest.description) &&
        Objects.equals(this.schemas, addIndicatorGaugeDataSourceRequest.schemas) &&
        Objects.equals(this.additionalText, addIndicatorGaugeDataSourceRequest.additionalText) &&
        Objects.equals(this.monitorObjectclass, addIndicatorGaugeDataSourceRequest.monitorObjectclass) &&
        Objects.equals(this.monitorAttribute, addIndicatorGaugeDataSourceRequest.monitorAttribute) &&
        Objects.equals(this.includeFilter, addIndicatorGaugeDataSourceRequest.includeFilter) &&
        Objects.equals(this.resourceAttribute, addIndicatorGaugeDataSourceRequest.resourceAttribute) &&
        Objects.equals(this.resourceType, addIndicatorGaugeDataSourceRequest.resourceType) &&
        Objects.equals(this.minimumUpdateInterval, addIndicatorGaugeDataSourceRequest.minimumUpdateInterval)&&
        Objects.equals(this.additionalProperties, addIndicatorGaugeDataSourceRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sourceName, description, schemas, additionalText, monitorObjectclass, monitorAttribute, includeFilter, resourceAttribute, resourceType, minimumUpdateInterval, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddIndicatorGaugeDataSourceRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddIndicatorGaugeDataSourceRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddIndicatorGaugeDataSourceRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddIndicatorGaugeDataSourceRequest is not found in the empty JSON string", AddIndicatorGaugeDataSourceRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddIndicatorGaugeDataSourceRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddIndicatorGaugeDataSourceRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddIndicatorGaugeDataSourceRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddIndicatorGaugeDataSourceRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddIndicatorGaugeDataSourceRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddIndicatorGaugeDataSourceRequest>() {
           @Override
           public void write(JsonWriter out, AddIndicatorGaugeDataSourceRequest value) throws IOException {
           ...
           @Override
           public AddIndicatorGaugeDataSourceRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddIndicatorGaugeDataSourceRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddIndicatorGaugeDataSourceRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddIndicatorGaugeDataSourceRequest
  * @throws IOException if the JSON string is invalid with respect to AddIndicatorGaugeDataSourceRequest
  */
  public static AddIndicatorGaugeDataSourceRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddIndicatorGaugeDataSourceRequest.class);
  }

 /**
  * Convert an instance of AddIndicatorGaugeDataSourceRequest to an JSON string
  *
  * @return JSON string
  */
