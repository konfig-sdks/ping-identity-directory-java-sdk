...
public class ConsentHttpServletExtensionResponse {
  ...
  private List<EnumconsentHttpServletExtensionSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConsentHttpServletExtensionResponse() {
  }

  public ConsentHttpServletExtensionResponse description(String description) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse schemas(List<EnumconsentHttpServletExtensionSchemaUrn> schemas) {
  ...
  public ConsentHttpServletExtensionResponse addSchemasItem(EnumconsentHttpServletExtensionSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse id(String id) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse bearerTokenAuthEnabled(Boolean bearerTokenAuthEnabled) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse basicAuthEnabled(Boolean basicAuthEnabled) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse identityMapper(String identityMapper) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse accessTokenValidator(List<String> accessTokenValidator) {
  ...
  public ConsentHttpServletExtensionResponse addAccessTokenValidatorItem(String accessTokenValidatorItem) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse crossOriginPolicy(String crossOriginPolicy) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse responseHeader(List<String> responseHeader) {
  ...
  public ConsentHttpServletExtensionResponse addResponseHeaderItem(String responseHeaderItem) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse correlationIDResponseHeader(String correlationIDResponseHeader) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConsentHttpServletExtensionResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConsentHttpServletExtensionResponse instance itself
   */
  public ConsentHttpServletExtensionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsentHttpServletExtensionResponse consentHttpServletExtensionResponse = (ConsentHttpServletExtensionResponse) o;
    return Objects.equals(this.description, consentHttpServletExtensionResponse.description) &&
        Objects.equals(this.schemas, consentHttpServletExtensionResponse.schemas) &&
        Objects.equals(this.id, consentHttpServletExtensionResponse.id) &&
        Objects.equals(this.bearerTokenAuthEnabled, consentHttpServletExtensionResponse.bearerTokenAuthEnabled) &&
        Objects.equals(this.basicAuthEnabled, consentHttpServletExtensionResponse.basicAuthEnabled) &&
        Objects.equals(this.identityMapper, consentHttpServletExtensionResponse.identityMapper) &&
        Objects.equals(this.accessTokenValidator, consentHttpServletExtensionResponse.accessTokenValidator) &&
        Objects.equals(this.crossOriginPolicy, consentHttpServletExtensionResponse.crossOriginPolicy) &&
        Objects.equals(this.responseHeader, consentHttpServletExtensionResponse.responseHeader) &&
        Objects.equals(this.correlationIDResponseHeader, consentHttpServletExtensionResponse.correlationIDResponseHeader) &&
        Objects.equals(this.meta, consentHttpServletExtensionResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, consentHttpServletExtensionResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, consentHttpServletExtensionResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, bearerTokenAuthEnabled, basicAuthEnabled, identityMapper, accessTokenValidator, crossOriginPolicy, responseHeader, correlationIDResponseHeader, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsentHttpServletExtensionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsentHttpServletExtensionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsentHttpServletExtensionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsentHttpServletExtensionResponse is not found in the empty JSON string", ConsentHttpServletExtensionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConsentHttpServletExtensionResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsentHttpServletExtensionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsentHttpServletExtensionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsentHttpServletExtensionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsentHttpServletExtensionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsentHttpServletExtensionResponse>() {
           @Override
           public void write(JsonWriter out, ConsentHttpServletExtensionResponse value) throws IOException {
           ...
           @Override
           public ConsentHttpServletExtensionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsentHttpServletExtensionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsentHttpServletExtensionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsentHttpServletExtensionResponse
  * @throws IOException if the JSON string is invalid with respect to ConsentHttpServletExtensionResponse
  */
  public static ConsentHttpServletExtensionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsentHttpServletExtensionResponse.class);
  }

 /**
  * Convert an instance of ConsentHttpServletExtensionResponse to an JSON string
  *
  * @return JSON string
  */
