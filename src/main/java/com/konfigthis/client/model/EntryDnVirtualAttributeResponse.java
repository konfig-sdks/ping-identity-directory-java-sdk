...
public class EntryDnVirtualAttributeResponse {
  ...
  public EntryDnVirtualAttributeResponse() {
  }

  public EntryDnVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse schemas(List<EnumentryDnVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryDnVirtualAttributeResponse addSchemasItem(EnumentryDnVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public EntryDnVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public EntryDnVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse filter(List<String> filter) {
  ...
  public EntryDnVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EntryDnVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EntryDnVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EntryDnVirtualAttributeResponse instance itself
   */
  public EntryDnVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntryDnVirtualAttributeResponse entryDnVirtualAttributeResponse = (EntryDnVirtualAttributeResponse) o;
    return Objects.equals(this.id, entryDnVirtualAttributeResponse.id) &&
        Objects.equals(this.description, entryDnVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, entryDnVirtualAttributeResponse.schemas) &&
        Objects.equals(this.conflictBehavior, entryDnVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, entryDnVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, entryDnVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, entryDnVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, entryDnVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, entryDnVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, entryDnVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, entryDnVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, entryDnVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, entryDnVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, entryDnVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, entryDnVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, entryDnVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, entryDnVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, conflictBehavior, attributeType, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntryDnVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EntryDnVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntryDnVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryDnVirtualAttributeResponse is not found in the empty JSON string", EntryDnVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntryDnVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntryDnVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntryDnVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntryDnVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntryDnVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EntryDnVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, EntryDnVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public EntryDnVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EntryDnVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EntryDnVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EntryDnVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to EntryDnVirtualAttributeResponse
  */
  public static EntryDnVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntryDnVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of EntryDnVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
