...
public class RedHatDsExternalServerResponseAllOf {
  ...
  private List<EnumredHatDsExternalServerSchemaUrn> schemas = null;
  ...
  public RedHatDsExternalServerResponseAllOf() {
  }

  public RedHatDsExternalServerResponseAllOf description(String description) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf schemas(List<EnumredHatDsExternalServerSchemaUrn> schemas) {
  ...
  public RedHatDsExternalServerResponseAllOf addSchemasItem(EnumredHatDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf id(String id) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf serverHostName(String serverHostName) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf serverPort(Integer serverPort) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf location(String location) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf bindDN(String bindDN) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf password(String password) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf connectionSecurity(EnumexternalServerRedHatDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf authenticationMethod(EnumexternalServerRedHatDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public RedHatDsExternalServerResponseAllOf addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public RedHatDsExternalServerResponseAllOf abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the RedHatDsExternalServerResponseAllOf instance itself
   */
  public RedHatDsExternalServerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RedHatDsExternalServerResponseAllOf redHatDsExternalServerResponseAllOf = (RedHatDsExternalServerResponseAllOf) o;
    return Objects.equals(this.description, redHatDsExternalServerResponseAllOf.description) &&
        Objects.equals(this.schemas, redHatDsExternalServerResponseAllOf.schemas) &&
        Objects.equals(this.id, redHatDsExternalServerResponseAllOf.id) &&
        Objects.equals(this.serverHostName, redHatDsExternalServerResponseAllOf.serverHostName) &&
        Objects.equals(this.serverPort, redHatDsExternalServerResponseAllOf.serverPort) &&
        Objects.equals(this.location, redHatDsExternalServerResponseAllOf.location) &&
        Objects.equals(this.bindDN, redHatDsExternalServerResponseAllOf.bindDN) &&
        Objects.equals(this.password, redHatDsExternalServerResponseAllOf.password) &&
        Objects.equals(this.passphraseProvider, redHatDsExternalServerResponseAllOf.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, redHatDsExternalServerResponseAllOf.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, redHatDsExternalServerResponseAllOf.authenticationMethod) &&
        Objects.equals(this.verifyCredentialsMethod, redHatDsExternalServerResponseAllOf.verifyCredentialsMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, redHatDsExternalServerResponseAllOf.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, redHatDsExternalServerResponseAllOf.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, redHatDsExternalServerResponseAllOf.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, redHatDsExternalServerResponseAllOf.connectTimeout) &&
        Objects.equals(this.maxResponseSize, redHatDsExternalServerResponseAllOf.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, redHatDsExternalServerResponseAllOf.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, redHatDsExternalServerResponseAllOf.trustManagerProvider) &&
        Objects.equals(this.initialConnections, redHatDsExternalServerResponseAllOf.initialConnections) &&
        Objects.equals(this.maxConnections, redHatDsExternalServerResponseAllOf.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, redHatDsExternalServerResponseAllOf.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, redHatDsExternalServerResponseAllOf.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, redHatDsExternalServerResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RedHatDsExternalServerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RedHatDsExternalServerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RedHatDsExternalServerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RedHatDsExternalServerResponseAllOf is not found in the empty JSON string", RedHatDsExternalServerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RedHatDsExternalServerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RedHatDsExternalServerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RedHatDsExternalServerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RedHatDsExternalServerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<RedHatDsExternalServerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, RedHatDsExternalServerResponseAllOf value) throws IOException {
           ...
           @Override
           public RedHatDsExternalServerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RedHatDsExternalServerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RedHatDsExternalServerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RedHatDsExternalServerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to RedHatDsExternalServerResponseAllOf
  */
  public static RedHatDsExternalServerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RedHatDsExternalServerResponseAllOf.class);
  }

 /**
  * Convert an instance of RedHatDsExternalServerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
