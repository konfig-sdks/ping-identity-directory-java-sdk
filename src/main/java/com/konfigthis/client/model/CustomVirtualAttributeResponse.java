...
import com.konfigthis.client.model.EnumcustomVirtualAttributeSchemaUrn;
...
public class CustomVirtualAttributeResponse {
  ...
  private List<EnumcustomVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public CustomVirtualAttributeResponse() {
  }

  public CustomVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse schemas(List<EnumcustomVirtualAttributeSchemaUrn> schemas) {
  ...
  public CustomVirtualAttributeResponse addSchemasItem(EnumcustomVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumcustomVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumcustomVirtualAttributeSchemaUrn> schemas) {
  ...
  public CustomVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public CustomVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public CustomVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse filter(List<String> filter) {
  ...
  public CustomVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public CustomVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public CustomVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the CustomVirtualAttributeResponse instance itself
   */
  public CustomVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CustomVirtualAttributeResponse customVirtualAttributeResponse = (CustomVirtualAttributeResponse) o;
    return Objects.equals(this.description, customVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, customVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, customVirtualAttributeResponse.id) &&
        Objects.equals(this.enabled, customVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, customVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, customVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, customVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, customVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, customVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, customVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, customVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, customVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, customVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, customVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, customVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, customVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, customVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CustomVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CustomVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CustomVirtualAttributeResponse is not found in the empty JSON string", CustomVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CustomVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CustomVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CustomVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CustomVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CustomVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CustomVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, CustomVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public CustomVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CustomVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CustomVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CustomVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to CustomVirtualAttributeResponse
  */
  public static CustomVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CustomVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of CustomVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
