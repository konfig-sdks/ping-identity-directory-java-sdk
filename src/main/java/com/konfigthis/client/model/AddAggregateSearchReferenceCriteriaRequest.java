...
public class AddAggregateSearchReferenceCriteriaRequest {
  ...
  public AddAggregateSearchReferenceCriteriaRequest() {
  }

  public AddAggregateSearchReferenceCriteriaRequest criteriaName(String criteriaName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Search Reference Criteria")
  ...
  public AddAggregateSearchReferenceCriteriaRequest description(String description) {
  ...
  **/
  ...
  public AddAggregateSearchReferenceCriteriaRequest schemas(List<EnumaggregateSearchReferenceCriteriaSchemaUrn> schemas) {
  ...
  public AddAggregateSearchReferenceCriteriaRequest addSchemasItem(EnumaggregateSearchReferenceCriteriaSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAggregateSearchReferenceCriteriaRequest allIncludedSearchReferenceCriteria(List<String> allIncludedSearchReferenceCriteria) {
  ...
  public AddAggregateSearchReferenceCriteriaRequest addAllIncludedSearchReferenceCriteriaItem(String allIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AddAggregateSearchReferenceCriteriaRequest anyIncludedSearchReferenceCriteria(List<String> anyIncludedSearchReferenceCriteria) {
  ...
  public AddAggregateSearchReferenceCriteriaRequest addAnyIncludedSearchReferenceCriteriaItem(String anyIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AddAggregateSearchReferenceCriteriaRequest notAllIncludedSearchReferenceCriteria(List<String> notAllIncludedSearchReferenceCriteria) {
  ...
  public AddAggregateSearchReferenceCriteriaRequest addNotAllIncludedSearchReferenceCriteriaItem(String notAllIncludedSearchReferenceCriteriaItem) {
  ...
  **/
  ...
  public AddAggregateSearchReferenceCriteriaRequest noneIncludedSearchReferenceCriteria(List<String> noneIncludedSearchReferenceCriteria) {
  ...
  public AddAggregateSearchReferenceCriteriaRequest addNoneIncludedSearchReferenceCriteriaItem(String noneIncludedSearchReferenceCriteriaItem) {
  ...
  **/
   ...
   * @return the AddAggregateSearchReferenceCriteriaRequest instance itself
   */
  public AddAggregateSearchReferenceCriteriaRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAggregateSearchReferenceCriteriaRequest addAggregateSearchReferenceCriteriaRequest = (AddAggregateSearchReferenceCriteriaRequest) o;
    return Objects.equals(this.criteriaName, addAggregateSearchReferenceCriteriaRequest.criteriaName) &&
        Objects.equals(this.description, addAggregateSearchReferenceCriteriaRequest.description) &&
        Objects.equals(this.schemas, addAggregateSearchReferenceCriteriaRequest.schemas) &&
        Objects.equals(this.allIncludedSearchReferenceCriteria, addAggregateSearchReferenceCriteriaRequest.allIncludedSearchReferenceCriteria) &&
        Objects.equals(this.anyIncludedSearchReferenceCriteria, addAggregateSearchReferenceCriteriaRequest.anyIncludedSearchReferenceCriteria) &&
        Objects.equals(this.notAllIncludedSearchReferenceCriteria, addAggregateSearchReferenceCriteriaRequest.notAllIncludedSearchReferenceCriteria) &&
        Objects.equals(this.noneIncludedSearchReferenceCriteria, addAggregateSearchReferenceCriteriaRequest.noneIncludedSearchReferenceCriteria)&&
        Objects.equals(this.additionalProperties, addAggregateSearchReferenceCriteriaRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(criteriaName, description, schemas, allIncludedSearchReferenceCriteria, anyIncludedSearchReferenceCriteria, notAllIncludedSearchReferenceCriteria, noneIncludedSearchReferenceCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAggregateSearchReferenceCriteriaRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAggregateSearchReferenceCriteriaRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAggregateSearchReferenceCriteriaRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAggregateSearchReferenceCriteriaRequest is not found in the empty JSON string", AddAggregateSearchReferenceCriteriaRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAggregateSearchReferenceCriteriaRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAggregateSearchReferenceCriteriaRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAggregateSearchReferenceCriteriaRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAggregateSearchReferenceCriteriaRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAggregateSearchReferenceCriteriaRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAggregateSearchReferenceCriteriaRequest>() {
           @Override
           public void write(JsonWriter out, AddAggregateSearchReferenceCriteriaRequest value) throws IOException {
           ...
           @Override
           public AddAggregateSearchReferenceCriteriaRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAggregateSearchReferenceCriteriaRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAggregateSearchReferenceCriteriaRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAggregateSearchReferenceCriteriaRequest
  * @throws IOException if the JSON string is invalid with respect to AddAggregateSearchReferenceCriteriaRequest
  */
  public static AddAggregateSearchReferenceCriteriaRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAggregateSearchReferenceCriteriaRequest.class);
  }

 /**
  * Convert an instance of AddAggregateSearchReferenceCriteriaRequest to an JSON string
  *
  * @return JSON string
  */
