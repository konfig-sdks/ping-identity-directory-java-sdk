...
public class MirrorVirtualAttributeResponse {
  ...
  public MirrorVirtualAttributeResponse() {
  }

  public MirrorVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse schemas(List<EnummirrorVirtualAttributeSchemaUrn> schemas) {
  ...
  public MirrorVirtualAttributeResponse addSchemasItem(EnummirrorVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse sourceAttribute(String sourceAttribute) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse sourceEntryDNAttribute(String sourceEntryDNAttribute) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse sourceEntryDNMap(String sourceEntryDNMap) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse bypassAccessControlForSearches(Boolean bypassAccessControlForSearches) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public MirrorVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public MirrorVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse filter(List<String> filter) {
  ...
  public MirrorVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public MirrorVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MirrorVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MirrorVirtualAttributeResponse instance itself
   */
  public MirrorVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MirrorVirtualAttributeResponse mirrorVirtualAttributeResponse = (MirrorVirtualAttributeResponse) o;
    return Objects.equals(this.id, mirrorVirtualAttributeResponse.id) &&
        Objects.equals(this.description, mirrorVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, mirrorVirtualAttributeResponse.schemas) &&
        Objects.equals(this.conflictBehavior, mirrorVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.sourceAttribute, mirrorVirtualAttributeResponse.sourceAttribute) &&
        Objects.equals(this.sourceEntryDNAttribute, mirrorVirtualAttributeResponse.sourceEntryDNAttribute) &&
        Objects.equals(this.sourceEntryDNMap, mirrorVirtualAttributeResponse.sourceEntryDNMap) &&
        Objects.equals(this.bypassAccessControlForSearches, mirrorVirtualAttributeResponse.bypassAccessControlForSearches) &&
        Objects.equals(this.enabled, mirrorVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, mirrorVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, mirrorVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, mirrorVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, mirrorVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, mirrorVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, mirrorVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, mirrorVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, mirrorVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, mirrorVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, mirrorVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, mirrorVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, mirrorVirtualAttributeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MirrorVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MirrorVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MirrorVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MirrorVirtualAttributeResponse is not found in the empty JSON string", MirrorVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MirrorVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MirrorVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MirrorVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MirrorVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MirrorVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MirrorVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, MirrorVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public MirrorVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MirrorVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MirrorVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MirrorVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to MirrorVirtualAttributeResponse
  */
  public static MirrorVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MirrorVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of MirrorVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
