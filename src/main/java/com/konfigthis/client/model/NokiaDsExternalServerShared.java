...
public class NokiaDsExternalServerShared {
  ...
  public NokiaDsExternalServerShared() {
  }

  public NokiaDsExternalServerShared description(String description) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared schemas(List<EnumnokiaDsExternalServerSchemaUrn> schemas) {
  ...
  public NokiaDsExternalServerShared addSchemasItem(EnumnokiaDsExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared useAdministrativeOperationControl(Boolean useAdministrativeOperationControl) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared serverHostName(String serverHostName) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared serverPort(Integer serverPort) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared location(String location) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared bindDN(String bindDN) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared password(String password) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared connectionSecurity(EnumexternalServerNokiaDsConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared authenticationMethod(EnumexternalServerNokiaDsAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public NokiaDsExternalServerShared addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public NokiaDsExternalServerShared abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the NokiaDsExternalServerShared instance itself
   */
  public NokiaDsExternalServerShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NokiaDsExternalServerShared nokiaDsExternalServerShared = (NokiaDsExternalServerShared) o;
    return Objects.equals(this.description, nokiaDsExternalServerShared.description) &&
        Objects.equals(this.schemas, nokiaDsExternalServerShared.schemas) &&
        Objects.equals(this.verifyCredentialsMethod, nokiaDsExternalServerShared.verifyCredentialsMethod) &&
        Objects.equals(this.useAdministrativeOperationControl, nokiaDsExternalServerShared.useAdministrativeOperationControl) &&
        Objects.equals(this.serverHostName, nokiaDsExternalServerShared.serverHostName) &&
        Objects.equals(this.serverPort, nokiaDsExternalServerShared.serverPort) &&
        Objects.equals(this.location, nokiaDsExternalServerShared.location) &&
        Objects.equals(this.bindDN, nokiaDsExternalServerShared.bindDN) &&
        Objects.equals(this.password, nokiaDsExternalServerShared.password) &&
        Objects.equals(this.passphraseProvider, nokiaDsExternalServerShared.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, nokiaDsExternalServerShared.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, nokiaDsExternalServerShared.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, nokiaDsExternalServerShared.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, nokiaDsExternalServerShared.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, nokiaDsExternalServerShared.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, nokiaDsExternalServerShared.connectTimeout) &&
        Objects.equals(this.maxResponseSize, nokiaDsExternalServerShared.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, nokiaDsExternalServerShared.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, nokiaDsExternalServerShared.trustManagerProvider) &&
        Objects.equals(this.initialConnections, nokiaDsExternalServerShared.initialConnections) &&
        Objects.equals(this.maxConnections, nokiaDsExternalServerShared.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, nokiaDsExternalServerShared.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, nokiaDsExternalServerShared.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, nokiaDsExternalServerShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NokiaDsExternalServerShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NokiaDsExternalServerShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NokiaDsExternalServerShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NokiaDsExternalServerShared is not found in the empty JSON string", NokiaDsExternalServerShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : NokiaDsExternalServerShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NokiaDsExternalServerShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NokiaDsExternalServerShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NokiaDsExternalServerShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NokiaDsExternalServerShared.class));

       return (TypeAdapter<T>) new TypeAdapter<NokiaDsExternalServerShared>() {
           @Override
           public void write(JsonWriter out, NokiaDsExternalServerShared value) throws IOException {
           ...
           @Override
           public NokiaDsExternalServerShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NokiaDsExternalServerShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NokiaDsExternalServerShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NokiaDsExternalServerShared
  * @throws IOException if the JSON string is invalid with respect to NokiaDsExternalServerShared
  */
  public static NokiaDsExternalServerShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NokiaDsExternalServerShared.class);
  }

 /**
  * Convert an instance of NokiaDsExternalServerShared to an JSON string
  *
  * @return JSON string
  */
