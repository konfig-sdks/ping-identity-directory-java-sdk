...
public class AddIndicatorGaugeRequest {
  ...
  public AddIndicatorGaugeRequest() {
  }

  public AddIndicatorGaugeRequest gaugeName(String gaugeName) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest description(String description) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest schemas(List<EnumindicatorGaugeSchemaUrn> schemas) {
  ...
  public AddIndicatorGaugeRequest addSchemasItem(EnumindicatorGaugeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest gaugeDataSource(String gaugeDataSource) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest criticalValue(String criticalValue) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest majorValue(String majorValue) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest minorValue(String minorValue) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest warningValue(String warningValue) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest overrideSeverity(EnumgaugeOverrideSeverityProp overrideSeverity) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest alertLevel(EnumgaugeAlertLevelProp alertLevel) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest updateInterval(String updateInterval) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest samplesPerUpdateInterval(Integer samplesPerUpdateInterval) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest includeResource(List<String> includeResource) {
  ...
  public AddIndicatorGaugeRequest addIncludeResourceItem(String includeResourceItem) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest excludeResource(List<String> excludeResource) {
  ...
  public AddIndicatorGaugeRequest addExcludeResourceItem(String excludeResourceItem) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest serverUnavailableSeverityLevel(EnumgaugeServerUnavailableSeverityLevelProp serverUnavailableSeverityLevel) {
  ...
  **/
  ...
  public AddIndicatorGaugeRequest serverDegradedSeverityLevel(EnumgaugeServerDegradedSeverityLevelProp serverDegradedSeverityLevel) {
  ...
  **/
   ...
   * @return the AddIndicatorGaugeRequest instance itself
   */
  public AddIndicatorGaugeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddIndicatorGaugeRequest addIndicatorGaugeRequest = (AddIndicatorGaugeRequest) o;
    return Objects.equals(this.gaugeName, addIndicatorGaugeRequest.gaugeName) &&
        Objects.equals(this.description, addIndicatorGaugeRequest.description) &&
        Objects.equals(this.schemas, addIndicatorGaugeRequest.schemas) &&
        Objects.equals(this.gaugeDataSource, addIndicatorGaugeRequest.gaugeDataSource) &&
        Objects.equals(this.criticalValue, addIndicatorGaugeRequest.criticalValue) &&
        Objects.equals(this.majorValue, addIndicatorGaugeRequest.majorValue) &&
        Objects.equals(this.minorValue, addIndicatorGaugeRequest.minorValue) &&
        Objects.equals(this.warningValue, addIndicatorGaugeRequest.warningValue) &&
        Objects.equals(this.enabled, addIndicatorGaugeRequest.enabled) &&
        Objects.equals(this.overrideSeverity, addIndicatorGaugeRequest.overrideSeverity) &&
        Objects.equals(this.alertLevel, addIndicatorGaugeRequest.alertLevel) &&
        Objects.equals(this.updateInterval, addIndicatorGaugeRequest.updateInterval) &&
        Objects.equals(this.samplesPerUpdateInterval, addIndicatorGaugeRequest.samplesPerUpdateInterval) &&
        Objects.equals(this.includeResource, addIndicatorGaugeRequest.includeResource) &&
        Objects.equals(this.excludeResource, addIndicatorGaugeRequest.excludeResource) &&
        Objects.equals(this.serverUnavailableSeverityLevel, addIndicatorGaugeRequest.serverUnavailableSeverityLevel) &&
        Objects.equals(this.serverDegradedSeverityLevel, addIndicatorGaugeRequest.serverDegradedSeverityLevel)&&
        Objects.equals(this.additionalProperties, addIndicatorGaugeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(gaugeName, description, schemas, gaugeDataSource, criticalValue, majorValue, minorValue, warningValue, enabled, overrideSeverity, alertLevel, updateInterval, samplesPerUpdateInterval, includeResource, excludeResource, serverUnavailableSeverityLevel, serverDegradedSeverityLevel, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddIndicatorGaugeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddIndicatorGaugeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddIndicatorGaugeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddIndicatorGaugeRequest is not found in the empty JSON string", AddIndicatorGaugeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddIndicatorGaugeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddIndicatorGaugeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddIndicatorGaugeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddIndicatorGaugeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddIndicatorGaugeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddIndicatorGaugeRequest>() {
           @Override
           public void write(JsonWriter out, AddIndicatorGaugeRequest value) throws IOException {
           ...
           @Override
           public AddIndicatorGaugeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddIndicatorGaugeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddIndicatorGaugeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddIndicatorGaugeRequest
  * @throws IOException if the JSON string is invalid with respect to AddIndicatorGaugeRequest
  */
  public static AddIndicatorGaugeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddIndicatorGaugeRequest.class);
  }

 /**
  * Convert an instance of AddIndicatorGaugeRequest to an JSON string
  *
  * @return JSON string
  */
