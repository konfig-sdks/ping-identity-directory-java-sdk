...
public class TwilioOtpDeliveryMechanismResponse {
  ...
  public TwilioOtpDeliveryMechanismResponse() {
  }

  public TwilioOtpDeliveryMechanismResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the OTP Delivery Mechanism")
  ...
  public TwilioOtpDeliveryMechanismResponse description(String description) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse schemas(List<EnumtwilioOtpDeliveryMechanismSchemaUrn> schemas) {
  ...
  public TwilioOtpDeliveryMechanismResponse addSchemasItem(EnumtwilioOtpDeliveryMechanismSchemaUrn schemasItem) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse httpProxyExternalServer(String httpProxyExternalServer) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse twilioAccountSID(String twilioAccountSID) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse twilioAuthToken(String twilioAuthToken) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse twilioAuthTokenPassphraseProvider(String twilioAuthTokenPassphraseProvider) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse phoneNumberAttributeType(String phoneNumberAttributeType) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The name or OID of the attribute in the user's entry that holds the phone number to which the message should be sent.")
  ...
  public TwilioOtpDeliveryMechanismResponse phoneNumberJSONField(String phoneNumberJSONField) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse phoneNumberJSONObjectFilter(String phoneNumberJSONObjectFilter) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse senderPhoneNumber(List<String> senderPhoneNumber) {
  ...
  public TwilioOtpDeliveryMechanismResponse addSenderPhoneNumberItem(String senderPhoneNumberItem) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse messageTextBeforeOTP(String messageTextBeforeOTP) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse messageTextAfterOTP(String messageTextAfterOTP) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public TwilioOtpDeliveryMechanismResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the TwilioOtpDeliveryMechanismResponse instance itself
   */
  public TwilioOtpDeliveryMechanismResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TwilioOtpDeliveryMechanismResponse twilioOtpDeliveryMechanismResponse = (TwilioOtpDeliveryMechanismResponse) o;
    return Objects.equals(this.id, twilioOtpDeliveryMechanismResponse.id) &&
        Objects.equals(this.description, twilioOtpDeliveryMechanismResponse.description) &&
        Objects.equals(this.schemas, twilioOtpDeliveryMechanismResponse.schemas) &&
        Objects.equals(this.httpProxyExternalServer, twilioOtpDeliveryMechanismResponse.httpProxyExternalServer) &&
        Objects.equals(this.twilioAccountSID, twilioOtpDeliveryMechanismResponse.twilioAccountSID) &&
        Objects.equals(this.twilioAuthToken, twilioOtpDeliveryMechanismResponse.twilioAuthToken) &&
        Objects.equals(this.twilioAuthTokenPassphraseProvider, twilioOtpDeliveryMechanismResponse.twilioAuthTokenPassphraseProvider) &&
        Objects.equals(this.phoneNumberAttributeType, twilioOtpDeliveryMechanismResponse.phoneNumberAttributeType) &&
        Objects.equals(this.phoneNumberJSONField, twilioOtpDeliveryMechanismResponse.phoneNumberJSONField) &&
        Objects.equals(this.phoneNumberJSONObjectFilter, twilioOtpDeliveryMechanismResponse.phoneNumberJSONObjectFilter) &&
        Objects.equals(this.senderPhoneNumber, twilioOtpDeliveryMechanismResponse.senderPhoneNumber) &&
        Objects.equals(this.messageTextBeforeOTP, twilioOtpDeliveryMechanismResponse.messageTextBeforeOTP) &&
        Objects.equals(this.messageTextAfterOTP, twilioOtpDeliveryMechanismResponse.messageTextAfterOTP) &&
        Objects.equals(this.enabled, twilioOtpDeliveryMechanismResponse.enabled) &&
        Objects.equals(this.meta, twilioOtpDeliveryMechanismResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, twilioOtpDeliveryMechanismResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, twilioOtpDeliveryMechanismResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, httpProxyExternalServer, twilioAccountSID, twilioAuthToken, twilioAuthTokenPassphraseProvider, phoneNumberAttributeType, phoneNumberJSONField, phoneNumberJSONObjectFilter, senderPhoneNumber, messageTextBeforeOTP, messageTextAfterOTP, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TwilioOtpDeliveryMechanismResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("phoneNumberAttributeType");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TwilioOtpDeliveryMechanismResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TwilioOtpDeliveryMechanismResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TwilioOtpDeliveryMechanismResponse is not found in the empty JSON string", TwilioOtpDeliveryMechanismResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TwilioOtpDeliveryMechanismResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("phoneNumberAttributeType").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TwilioOtpDeliveryMechanismResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TwilioOtpDeliveryMechanismResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TwilioOtpDeliveryMechanismResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TwilioOtpDeliveryMechanismResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TwilioOtpDeliveryMechanismResponse>() {
           @Override
           public void write(JsonWriter out, TwilioOtpDeliveryMechanismResponse value) throws IOException {
           ...
           @Override
           public TwilioOtpDeliveryMechanismResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TwilioOtpDeliveryMechanismResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TwilioOtpDeliveryMechanismResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TwilioOtpDeliveryMechanismResponse
  * @throws IOException if the JSON string is invalid with respect to TwilioOtpDeliveryMechanismResponse
  */
  public static TwilioOtpDeliveryMechanismResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TwilioOtpDeliveryMechanismResponse.class);
  }

 /**
  * Convert an instance of TwilioOtpDeliveryMechanismResponse to an JSON string
  *
  * @return JSON string
  */
