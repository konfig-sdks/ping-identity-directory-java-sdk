...
public class AddSyslogBasedAccessLogPublisherRequest {
  ...
  public AddSyslogBasedAccessLogPublisherRequest() {
  }

  public AddSyslogBasedAccessLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest schemas(List<EnumsyslogBasedAccessLogPublisherSchemaUrn> schemas) {
  ...
  public AddSyslogBasedAccessLogPublisherRequest addSchemasItem(EnumsyslogBasedAccessLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest serverHostName(String serverHostName) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest serverPort(Integer serverPort) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest syslogFacility(Integer syslogFacility) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the syslog facility to use for this Syslog Based Access Log Publisher")
  ...
  public AddSyslogBasedAccessLogPublisherRequest maxStringLength(Integer maxStringLength) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logConnects(Boolean logConnects) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logDisconnects(Boolean logDisconnects) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logRequests(Boolean logRequests) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logAssuranceCompleted(Boolean logAssuranceCompleted) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequestDetailsInResultMessages(Boolean includeRequestDetailsInResultMessages) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequestDetailsInSearchEntryMessages(Boolean includeRequestDetailsInSearchEntryMessages) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequestDetailsInSearchReferenceMessages(Boolean includeRequestDetailsInSearchReferenceMessages) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequestDetailsInIntermediateResponseMessages(Boolean includeRequestDetailsInIntermediateResponseMessages) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeResultCodeNames(Boolean includeResultCodeNames) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeExtendedSearchRequestDetails(Boolean includeExtendedSearchRequestDetails) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeAddAttributeNames(Boolean includeAddAttributeNames) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeModifyAttributeNames(Boolean includeModifyAttributeNames) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeSearchEntryAttributeNames(Boolean includeSearchEntryAttributeNames) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeResponseControls(Boolean includeResponseControls) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logFieldBehavior(String logFieldBehavior) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logClientCertificates(Boolean logClientCertificates) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logResults(Boolean logResults) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logSearchEntries(Boolean logSearchEntries) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logSearchReferences(Boolean logSearchReferences) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest correlateRequestsAndResults(Boolean correlateRequestsAndResults) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest searchEntryCriteria(String searchEntryCriteria) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest searchReferenceCriteria(String searchReferenceCriteria) {
  ...
  **/
  ...
  public AddSyslogBasedAccessLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddSyslogBasedAccessLogPublisherRequest instance itself
   */
  public AddSyslogBasedAccessLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddSyslogBasedAccessLogPublisherRequest addSyslogBasedAccessLogPublisherRequest = (AddSyslogBasedAccessLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addSyslogBasedAccessLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addSyslogBasedAccessLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addSyslogBasedAccessLogPublisherRequest.schemas) &&
        Objects.equals(this.enabled, addSyslogBasedAccessLogPublisherRequest.enabled) &&
        Objects.equals(this.serverHostName, addSyslogBasedAccessLogPublisherRequest.serverHostName) &&
        Objects.equals(this.serverPort, addSyslogBasedAccessLogPublisherRequest.serverPort) &&
        Objects.equals(this.syslogFacility, addSyslogBasedAccessLogPublisherRequest.syslogFacility) &&
        Objects.equals(this.maxStringLength, addSyslogBasedAccessLogPublisherRequest.maxStringLength) &&
        Objects.equals(this.logConnects, addSyslogBasedAccessLogPublisherRequest.logConnects) &&
        Objects.equals(this.logDisconnects, addSyslogBasedAccessLogPublisherRequest.logDisconnects) &&
        Objects.equals(this.logRequests, addSyslogBasedAccessLogPublisherRequest.logRequests) &&
        Objects.equals(this.logAssuranceCompleted, addSyslogBasedAccessLogPublisherRequest.logAssuranceCompleted) &&
        Objects.equals(this.includeProductName, addSyslogBasedAccessLogPublisherRequest.includeProductName) &&
        Objects.equals(this.includeInstanceName, addSyslogBasedAccessLogPublisherRequest.includeInstanceName) &&
        Objects.equals(this.includeStartupID, addSyslogBasedAccessLogPublisherRequest.includeStartupID) &&
        Objects.equals(this.includeThreadID, addSyslogBasedAccessLogPublisherRequest.includeThreadID) &&
        Objects.equals(this.includeRequesterDN, addSyslogBasedAccessLogPublisherRequest.includeRequesterDN) &&
        Objects.equals(this.includeRequesterIPAddress, addSyslogBasedAccessLogPublisherRequest.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequestDetailsInResultMessages, addSyslogBasedAccessLogPublisherRequest.includeRequestDetailsInResultMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchEntryMessages, addSyslogBasedAccessLogPublisherRequest.includeRequestDetailsInSearchEntryMessages) &&
        Objects.equals(this.includeRequestDetailsInSearchReferenceMessages, addSyslogBasedAccessLogPublisherRequest.includeRequestDetailsInSearchReferenceMessages) &&
        Objects.equals(this.includeRequestDetailsInIntermediateResponseMessages, addSyslogBasedAccessLogPublisherRequest.includeRequestDetailsInIntermediateResponseMessages) &&
        Objects.equals(this.includeResultCodeNames, addSyslogBasedAccessLogPublisherRequest.includeResultCodeNames) &&
        Objects.equals(this.includeExtendedSearchRequestDetails, addSyslogBasedAccessLogPublisherRequest.includeExtendedSearchRequestDetails) &&
        Objects.equals(this.includeAddAttributeNames, addSyslogBasedAccessLogPublisherRequest.includeAddAttributeNames) &&
        Objects.equals(this.includeModifyAttributeNames, addSyslogBasedAccessLogPublisherRequest.includeModifyAttributeNames) &&
        Objects.equals(this.includeSearchEntryAttributeNames, addSyslogBasedAccessLogPublisherRequest.includeSearchEntryAttributeNames) &&
        Objects.equals(this.includeRequestControls, addSyslogBasedAccessLogPublisherRequest.includeRequestControls) &&
        Objects.equals(this.includeResponseControls, addSyslogBasedAccessLogPublisherRequest.includeResponseControls) &&
        Objects.equals(this.includeReplicationChangeID, addSyslogBasedAccessLogPublisherRequest.includeReplicationChangeID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, addSyslogBasedAccessLogPublisherRequest.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.asynchronous, addSyslogBasedAccessLogPublisherRequest.asynchronous) &&
        Objects.equals(this.autoFlush, addSyslogBasedAccessLogPublisherRequest.autoFlush) &&
        Objects.equals(this.queueSize, addSyslogBasedAccessLogPublisherRequest.queueSize) &&
        Objects.equals(this.logFieldBehavior, addSyslogBasedAccessLogPublisherRequest.logFieldBehavior) &&
        Objects.equals(this.logSecurityNegotiation, addSyslogBasedAccessLogPublisherRequest.logSecurityNegotiation) &&
        Objects.equals(this.logClientCertificates, addSyslogBasedAccessLogPublisherRequest.logClientCertificates) &&
        Objects.equals(this.logResults, addSyslogBasedAccessLogPublisherRequest.logResults) &&
        Objects.equals(this.logSearchEntries, addSyslogBasedAccessLogPublisherRequest.logSearchEntries) &&
        Objects.equals(this.logSearchReferences, addSyslogBasedAccessLogPublisherRequest.logSearchReferences) &&
        Objects.equals(this.logIntermediateResponses, addSyslogBasedAccessLogPublisherRequest.logIntermediateResponses) &&
        Objects.equals(this.suppressInternalOperations, addSyslogBasedAccessLogPublisherRequest.suppressInternalOperations) &&
        Objects.equals(this.suppressReplicationOperations, addSyslogBasedAccessLogPublisherRequest.suppressReplicationOperations) &&
        Objects.equals(this.correlateRequestsAndResults, addSyslogBasedAccessLogPublisherRequest.correlateRequestsAndResults) &&
        Objects.equals(this.connectionCriteria, addSyslogBasedAccessLogPublisherRequest.connectionCriteria) &&
        Objects.equals(this.requestCriteria, addSyslogBasedAccessLogPublisherRequest.requestCriteria) &&
        Objects.equals(this.resultCriteria, addSyslogBasedAccessLogPublisherRequest.resultCriteria) &&
        Objects.equals(this.searchEntryCriteria, addSyslogBasedAccessLogPublisherRequest.searchEntryCriteria) &&
        Objects.equals(this.searchReferenceCriteria, addSyslogBasedAccessLogPublisherRequest.searchReferenceCriteria) &&
        Objects.equals(this.loggingErrorBehavior, addSyslogBasedAccessLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addSyslogBasedAccessLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, enabled, serverHostName, serverPort, syslogFacility, maxStringLength, logConnects, logDisconnects, logRequests, logAssuranceCompleted, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterDN, includeRequesterIPAddress, includeRequestDetailsInResultMessages, includeRequestDetailsInSearchEntryMessages, includeRequestDetailsInSearchReferenceMessages, includeRequestDetailsInIntermediateResponseMessages, includeResultCodeNames, includeExtendedSearchRequestDetails, includeAddAttributeNames, includeModifyAttributeNames, includeSearchEntryAttributeNames, includeRequestControls, includeResponseControls, includeReplicationChangeID, generifyMessageStringsWhenPossible, asynchronous, autoFlush, queueSize, logFieldBehavior, logSecurityNegotiation, logClientCertificates, logResults, logSearchEntries, logSearchReferences, logIntermediateResponses, suppressInternalOperations, suppressReplicationOperations, correlateRequestsAndResults, connectionCriteria, requestCriteria, resultCriteria, searchEntryCriteria, searchReferenceCriteria, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddSyslogBasedAccessLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddSyslogBasedAccessLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddSyslogBasedAccessLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSyslogBasedAccessLogPublisherRequest is not found in the empty JSON string", AddSyslogBasedAccessLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSyslogBasedAccessLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSyslogBasedAccessLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSyslogBasedAccessLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSyslogBasedAccessLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSyslogBasedAccessLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSyslogBasedAccessLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddSyslogBasedAccessLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddSyslogBasedAccessLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddSyslogBasedAccessLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddSyslogBasedAccessLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddSyslogBasedAccessLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddSyslogBasedAccessLogPublisherRequest
  */
  public static AddSyslogBasedAccessLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSyslogBasedAccessLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddSyslogBasedAccessLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
