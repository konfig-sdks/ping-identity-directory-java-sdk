...
public class SyslogJsonErrorLogPublisherShared {
  ...
  public SyslogJsonErrorLogPublisherShared() {
  }

  public SyslogJsonErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared schemas(List<EnumsyslogJsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public SyslogJsonErrorLogPublisherShared addSchemasItem(EnumsyslogJsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public SyslogJsonErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared syslogExternalServer(List<String> syslogExternalServer) {
  ...
  public SyslogJsonErrorLogPublisherShared addSyslogExternalServerItem(String syslogExternalServerItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared syslogFacility(EnumlogPublisherSyslogFacilityProp syslogFacility) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared syslogSeverity(EnumlogPublisherSyslogSeverityProp syslogSeverity) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared syslogMessageHostName(String syslogMessageHostName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared syslogMessageApplicationName(String syslogMessageApplicationName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public SyslogJsonErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyslogJsonErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the SyslogJsonErrorLogPublisherShared instance itself
   */
  public SyslogJsonErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyslogJsonErrorLogPublisherShared syslogJsonErrorLogPublisherShared = (SyslogJsonErrorLogPublisherShared) o;
    return Objects.equals(this.description, syslogJsonErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, syslogJsonErrorLogPublisherShared.schemas) &&
        Objects.equals(this.defaultSeverity, syslogJsonErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.syslogExternalServer, syslogJsonErrorLogPublisherShared.syslogExternalServer) &&
        Objects.equals(this.syslogFacility, syslogJsonErrorLogPublisherShared.syslogFacility) &&
        Objects.equals(this.syslogSeverity, syslogJsonErrorLogPublisherShared.syslogSeverity) &&
        Objects.equals(this.syslogMessageHostName, syslogJsonErrorLogPublisherShared.syslogMessageHostName) &&
        Objects.equals(this.syslogMessageApplicationName, syslogJsonErrorLogPublisherShared.syslogMessageApplicationName) &&
        Objects.equals(this.queueSize, syslogJsonErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.includeProductName, syslogJsonErrorLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, syslogJsonErrorLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, syslogJsonErrorLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, syslogJsonErrorLogPublisherShared.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, syslogJsonErrorLogPublisherShared.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.overrideSeverity, syslogJsonErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, syslogJsonErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, syslogJsonErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, syslogJsonErrorLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, defaultSeverity, syslogExternalServer, syslogFacility, syslogSeverity, syslogMessageHostName, syslogMessageApplicationName, queueSize, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class SyslogJsonErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyslogJsonErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyslogJsonErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyslogJsonErrorLogPublisherShared is not found in the empty JSON string", SyslogJsonErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SyslogJsonErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyslogJsonErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyslogJsonErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyslogJsonErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyslogJsonErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<SyslogJsonErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, SyslogJsonErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public SyslogJsonErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyslogJsonErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyslogJsonErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyslogJsonErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to SyslogJsonErrorLogPublisherShared
  */
  public static SyslogJsonErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyslogJsonErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of SyslogJsonErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
