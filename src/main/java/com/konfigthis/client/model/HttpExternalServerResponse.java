...
public class HttpExternalServerResponse {
  ...
  public HttpExternalServerResponse() {
  }

  public HttpExternalServerResponse id(String id) {
  ...
  **/
  ...
  public HttpExternalServerResponse description(String description) {
  ...
  **/
  ...
  public HttpExternalServerResponse schemas(List<EnumhttpExternalServerSchemaUrn> schemas) {
  ...
  public HttpExternalServerResponse addSchemasItem(EnumhttpExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public HttpExternalServerResponse baseURL(String baseURL) {
  ...
  **/
  ...
  public HttpExternalServerResponse hostnameVerificationMethod(EnumexternalServerHttpHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public HttpExternalServerResponse keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public HttpExternalServerResponse trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public HttpExternalServerResponse sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public HttpExternalServerResponse connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public HttpExternalServerResponse responseTimeout(String responseTimeout) {
  ...
  **/
  ...
  public HttpExternalServerResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public HttpExternalServerResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the HttpExternalServerResponse instance itself
   */
  public HttpExternalServerResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HttpExternalServerResponse httpExternalServerResponse = (HttpExternalServerResponse) o;
    return Objects.equals(this.id, httpExternalServerResponse.id) &&
        Objects.equals(this.description, httpExternalServerResponse.description) &&
        Objects.equals(this.schemas, httpExternalServerResponse.schemas) &&
        Objects.equals(this.baseURL, httpExternalServerResponse.baseURL) &&
        Objects.equals(this.hostnameVerificationMethod, httpExternalServerResponse.hostnameVerificationMethod) &&
        Objects.equals(this.keyManagerProvider, httpExternalServerResponse.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, httpExternalServerResponse.trustManagerProvider) &&
        Objects.equals(this.sslCertNickname, httpExternalServerResponse.sslCertNickname) &&
        Objects.equals(this.connectTimeout, httpExternalServerResponse.connectTimeout) &&
        Objects.equals(this.responseTimeout, httpExternalServerResponse.responseTimeout) &&
        Objects.equals(this.meta, httpExternalServerResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, httpExternalServerResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, httpExternalServerResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, baseURL, hostnameVerificationMethod, keyManagerProvider, trustManagerProvider, sslCertNickname, connectTimeout, responseTimeout, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HttpExternalServerResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HttpExternalServerResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HttpExternalServerResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HttpExternalServerResponse is not found in the empty JSON string", HttpExternalServerResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : HttpExternalServerResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HttpExternalServerResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HttpExternalServerResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HttpExternalServerResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HttpExternalServerResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<HttpExternalServerResponse>() {
           @Override
           public void write(JsonWriter out, HttpExternalServerResponse value) throws IOException {
           ...
           @Override
           public HttpExternalServerResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HttpExternalServerResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HttpExternalServerResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HttpExternalServerResponse
  * @throws IOException if the JSON string is invalid with respect to HttpExternalServerResponse
  */
  public static HttpExternalServerResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HttpExternalServerResponse.class);
  }

 /**
  * Convert an instance of HttpExternalServerResponse to an JSON string
  *
  * @return JSON string
  */
