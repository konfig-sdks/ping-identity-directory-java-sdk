...
public class AddUploadToS3PostLdifExportTaskProcessorRequest {
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest() {
  }

  public AddUploadToS3PostLdifExportTaskProcessorRequest processorName(String processorName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Post LDIF Export Task Processor")
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest description(String description) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest schemas(List<EnumuploadToS3PostLdifExportTaskProcessorSchemaUrn> schemas) {
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest addSchemasItem(EnumuploadToS3PostLdifExportTaskProcessorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest awsExternalServer(String awsExternalServer) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest s3BucketName(String s3BucketName) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest targetThroughputInMegabitsPerSecond(Integer targetThroughputInMegabitsPerSecond) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest maximumConcurrentTransferConnections(Integer maximumConcurrentTransferConnections) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest maximumFileCountToRetain(Integer maximumFileCountToRetain) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest maximumFileAgeToRetain(String maximumFileAgeToRetain) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest fileRetentionPattern(String fileRetentionPattern) {
  ...
  **/
  ...
  public AddUploadToS3PostLdifExportTaskProcessorRequest enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the AddUploadToS3PostLdifExportTaskProcessorRequest instance itself
   */
  public AddUploadToS3PostLdifExportTaskProcessorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddUploadToS3PostLdifExportTaskProcessorRequest addUploadToS3PostLdifExportTaskProcessorRequest = (AddUploadToS3PostLdifExportTaskProcessorRequest) o;
    return Objects.equals(this.processorName, addUploadToS3PostLdifExportTaskProcessorRequest.processorName) &&
        Objects.equals(this.description, addUploadToS3PostLdifExportTaskProcessorRequest.description) &&
        Objects.equals(this.schemas, addUploadToS3PostLdifExportTaskProcessorRequest.schemas) &&
        Objects.equals(this.awsExternalServer, addUploadToS3PostLdifExportTaskProcessorRequest.awsExternalServer) &&
        Objects.equals(this.s3BucketName, addUploadToS3PostLdifExportTaskProcessorRequest.s3BucketName) &&
        Objects.equals(this.targetThroughputInMegabitsPerSecond, addUploadToS3PostLdifExportTaskProcessorRequest.targetThroughputInMegabitsPerSecond) &&
        Objects.equals(this.maximumConcurrentTransferConnections, addUploadToS3PostLdifExportTaskProcessorRequest.maximumConcurrentTransferConnections) &&
        Objects.equals(this.maximumFileCountToRetain, addUploadToS3PostLdifExportTaskProcessorRequest.maximumFileCountToRetain) &&
        Objects.equals(this.maximumFileAgeToRetain, addUploadToS3PostLdifExportTaskProcessorRequest.maximumFileAgeToRetain) &&
        Objects.equals(this.fileRetentionPattern, addUploadToS3PostLdifExportTaskProcessorRequest.fileRetentionPattern) &&
        Objects.equals(this.enabled, addUploadToS3PostLdifExportTaskProcessorRequest.enabled)&&
        Objects.equals(this.additionalProperties, addUploadToS3PostLdifExportTaskProcessorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(processorName, description, schemas, awsExternalServer, s3BucketName, targetThroughputInMegabitsPerSecond, maximumConcurrentTransferConnections, maximumFileCountToRetain, maximumFileAgeToRetain, fileRetentionPattern, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddUploadToS3PostLdifExportTaskProcessorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddUploadToS3PostLdifExportTaskProcessorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddUploadToS3PostLdifExportTaskProcessorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddUploadToS3PostLdifExportTaskProcessorRequest is not found in the empty JSON string", AddUploadToS3PostLdifExportTaskProcessorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddUploadToS3PostLdifExportTaskProcessorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddUploadToS3PostLdifExportTaskProcessorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddUploadToS3PostLdifExportTaskProcessorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddUploadToS3PostLdifExportTaskProcessorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddUploadToS3PostLdifExportTaskProcessorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddUploadToS3PostLdifExportTaskProcessorRequest>() {
           @Override
           public void write(JsonWriter out, AddUploadToS3PostLdifExportTaskProcessorRequest value) throws IOException {
           ...
           @Override
           public AddUploadToS3PostLdifExportTaskProcessorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddUploadToS3PostLdifExportTaskProcessorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddUploadToS3PostLdifExportTaskProcessorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddUploadToS3PostLdifExportTaskProcessorRequest
  * @throws IOException if the JSON string is invalid with respect to AddUploadToS3PostLdifExportTaskProcessorRequest
  */
  public static AddUploadToS3PostLdifExportTaskProcessorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddUploadToS3PostLdifExportTaskProcessorRequest.class);
  }

 /**
  * Convert an instance of AddUploadToS3PostLdifExportTaskProcessorRequest to an JSON string
  *
  * @return JSON string
  */
