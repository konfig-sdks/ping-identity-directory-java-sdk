...
import com.konfigthis.client.model.EnumenterLockdownModeRecurringTaskSchemaUrn;
...
public class EnterLockdownModeRecurringTaskResponse {
  ...
  private List<EnumenterLockdownModeRecurringTaskSchemaUrn> schemas = new ArrayList<>();
  ...
  public EnterLockdownModeRecurringTaskResponse() {
  }

  public EnterLockdownModeRecurringTaskResponse id(String id) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse description(String description) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse schemas(List<EnumenterLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public EnterLockdownModeRecurringTaskResponse addSchemasItem(EnumenterLockdownModeRecurringTaskSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumenterLockdownModeRecurringTaskSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumenterLockdownModeRecurringTaskSchemaUrn> schemas) {
  ...
  public EnterLockdownModeRecurringTaskResponse reason(String reason) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reason that the server is being placed in lockdown mode.")
  ...
  public EnterLockdownModeRecurringTaskResponse cancelOnTaskDependencyFailure(Boolean cancelOnTaskDependencyFailure) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse emailOnStart(List<String> emailOnStart) {
  ...
  public EnterLockdownModeRecurringTaskResponse addEmailOnStartItem(String emailOnStartItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse emailOnSuccess(List<String> emailOnSuccess) {
  ...
  public EnterLockdownModeRecurringTaskResponse addEmailOnSuccessItem(String emailOnSuccessItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse emailOnFailure(List<String> emailOnFailure) {
  ...
  public EnterLockdownModeRecurringTaskResponse addEmailOnFailureItem(String emailOnFailureItem) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse alertOnStart(Boolean alertOnStart) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse alertOnSuccess(Boolean alertOnSuccess) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse alertOnFailure(Boolean alertOnFailure) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EnterLockdownModeRecurringTaskResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EnterLockdownModeRecurringTaskResponse instance itself
   */
  public EnterLockdownModeRecurringTaskResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EnterLockdownModeRecurringTaskResponse enterLockdownModeRecurringTaskResponse = (EnterLockdownModeRecurringTaskResponse) o;
    return Objects.equals(this.id, enterLockdownModeRecurringTaskResponse.id) &&
        Objects.equals(this.description, enterLockdownModeRecurringTaskResponse.description) &&
        Objects.equals(this.schemas, enterLockdownModeRecurringTaskResponse.schemas) &&
        Objects.equals(this.reason, enterLockdownModeRecurringTaskResponse.reason) &&
        Objects.equals(this.cancelOnTaskDependencyFailure, enterLockdownModeRecurringTaskResponse.cancelOnTaskDependencyFailure) &&
        Objects.equals(this.emailOnStart, enterLockdownModeRecurringTaskResponse.emailOnStart) &&
        Objects.equals(this.emailOnSuccess, enterLockdownModeRecurringTaskResponse.emailOnSuccess) &&
        Objects.equals(this.emailOnFailure, enterLockdownModeRecurringTaskResponse.emailOnFailure) &&
        Objects.equals(this.alertOnStart, enterLockdownModeRecurringTaskResponse.alertOnStart) &&
        Objects.equals(this.alertOnSuccess, enterLockdownModeRecurringTaskResponse.alertOnSuccess) &&
        Objects.equals(this.alertOnFailure, enterLockdownModeRecurringTaskResponse.alertOnFailure) &&
        Objects.equals(this.meta, enterLockdownModeRecurringTaskResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, enterLockdownModeRecurringTaskResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, enterLockdownModeRecurringTaskResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnterLockdownModeRecurringTaskResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EnterLockdownModeRecurringTaskResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EnterLockdownModeRecurringTaskResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EnterLockdownModeRecurringTaskResponse is not found in the empty JSON string", EnterLockdownModeRecurringTaskResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EnterLockdownModeRecurringTaskResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EnterLockdownModeRecurringTaskResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EnterLockdownModeRecurringTaskResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EnterLockdownModeRecurringTaskResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EnterLockdownModeRecurringTaskResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EnterLockdownModeRecurringTaskResponse>() {
           @Override
           public void write(JsonWriter out, EnterLockdownModeRecurringTaskResponse value) throws IOException {
           ...
           @Override
           public EnterLockdownModeRecurringTaskResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EnterLockdownModeRecurringTaskResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EnterLockdownModeRecurringTaskResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EnterLockdownModeRecurringTaskResponse
  * @throws IOException if the JSON string is invalid with respect to EnterLockdownModeRecurringTaskResponse
  */
  public static EnterLockdownModeRecurringTaskResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EnterLockdownModeRecurringTaskResponse.class);
  }

 /**
  * Convert an instance of EnterLockdownModeRecurringTaskResponse to an JSON string
  *
  * @return JSON string
  */
