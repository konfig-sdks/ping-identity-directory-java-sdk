...
public class AddGroupRestResourceTypeRequest {
  ...
  public AddGroupRestResourceTypeRequest() {
  }

  public AddGroupRestResourceTypeRequest typeName(String typeName) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest description(String description) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest schemas(List<EnumgroupRestResourceTypeSchemaUrn> schemas) {
  ...
  public AddGroupRestResourceTypeRequest addSchemasItem(EnumgroupRestResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest membersColumnName(String membersColumnName) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest nonmembersColumnName(String nonmembersColumnName) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest resourceEndpoint(String resourceEndpoint) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public AddGroupRestResourceTypeRequest addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest searchBaseDN(String searchBaseDN) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest includeFilter(List<String> includeFilter) {
  ...
  public AddGroupRestResourceTypeRequest addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest parentDN(String parentDN) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest parentResourceType(String parentResourceType) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest relativeDNFromParentResource(String relativeDNFromParentResource) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest createRDNAttributeType(String createRDNAttributeType) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest postCreateConstructedAttribute(List<String> postCreateConstructedAttribute) {
  ...
  public AddGroupRestResourceTypeRequest addPostCreateConstructedAttributeItem(String postCreateConstructedAttributeItem) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest updateConstructedAttribute(List<String> updateConstructedAttribute) {
  ...
  public AddGroupRestResourceTypeRequest addUpdateConstructedAttributeItem(String updateConstructedAttributeItem) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest displayName(String displayName) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest searchFilterPattern(String searchFilterPattern) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest primaryDisplayAttributeType(String primaryDisplayAttributeType) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest delegatedAdminSearchSizeLimit(Integer delegatedAdminSearchSizeLimit) {
  ...
  **/
  ...
  public AddGroupRestResourceTypeRequest delegatedAdminReportSizeLimit(Integer delegatedAdminReportSizeLimit) {
  ...
  **/
   ...
   * @return the AddGroupRestResourceTypeRequest instance itself
   */
  public AddGroupRestResourceTypeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroupRestResourceTypeRequest addGroupRestResourceTypeRequest = (AddGroupRestResourceTypeRequest) o;
    return Objects.equals(this.typeName, addGroupRestResourceTypeRequest.typeName) &&
        Objects.equals(this.description, addGroupRestResourceTypeRequest.description) &&
        Objects.equals(this.schemas, addGroupRestResourceTypeRequest.schemas) &&
        Objects.equals(this.membersColumnName, addGroupRestResourceTypeRequest.membersColumnName) &&
        Objects.equals(this.nonmembersColumnName, addGroupRestResourceTypeRequest.nonmembersColumnName) &&
        Objects.equals(this.enabled, addGroupRestResourceTypeRequest.enabled) &&
        Objects.equals(this.resourceEndpoint, addGroupRestResourceTypeRequest.resourceEndpoint) &&
        Objects.equals(this.structuralLDAPObjectclass, addGroupRestResourceTypeRequest.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, addGroupRestResourceTypeRequest.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.searchBaseDN, addGroupRestResourceTypeRequest.searchBaseDN) &&
        Objects.equals(this.includeFilter, addGroupRestResourceTypeRequest.includeFilter) &&
        Objects.equals(this.parentDN, addGroupRestResourceTypeRequest.parentDN) &&
        Objects.equals(this.parentResourceType, addGroupRestResourceTypeRequest.parentResourceType) &&
        Objects.equals(this.relativeDNFromParentResource, addGroupRestResourceTypeRequest.relativeDNFromParentResource) &&
        Objects.equals(this.createRDNAttributeType, addGroupRestResourceTypeRequest.createRDNAttributeType) &&
        Objects.equals(this.postCreateConstructedAttribute, addGroupRestResourceTypeRequest.postCreateConstructedAttribute) &&
        Objects.equals(this.updateConstructedAttribute, addGroupRestResourceTypeRequest.updateConstructedAttribute) &&
        Objects.equals(this.displayName, addGroupRestResourceTypeRequest.displayName) &&
        Objects.equals(this.searchFilterPattern, addGroupRestResourceTypeRequest.searchFilterPattern) &&
        Objects.equals(this.primaryDisplayAttributeType, addGroupRestResourceTypeRequest.primaryDisplayAttributeType) &&
        Objects.equals(this.delegatedAdminSearchSizeLimit, addGroupRestResourceTypeRequest.delegatedAdminSearchSizeLimit) &&
        Objects.equals(this.delegatedAdminReportSizeLimit, addGroupRestResourceTypeRequest.delegatedAdminReportSizeLimit)&&
        Objects.equals(this.additionalProperties, addGroupRestResourceTypeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(typeName, description, schemas, membersColumnName, nonmembersColumnName, enabled, resourceEndpoint, structuralLDAPObjectclass, auxiliaryLDAPObjectclass, searchBaseDN, includeFilter, parentDN, parentResourceType, relativeDNFromParentResource, createRDNAttributeType, postCreateConstructedAttribute, updateConstructedAttribute, displayName, searchFilterPattern, primaryDisplayAttributeType, delegatedAdminSearchSizeLimit, delegatedAdminReportSizeLimit, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroupRestResourceTypeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroupRestResourceTypeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroupRestResourceTypeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroupRestResourceTypeRequest is not found in the empty JSON string", AddGroupRestResourceTypeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroupRestResourceTypeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroupRestResourceTypeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroupRestResourceTypeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroupRestResourceTypeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroupRestResourceTypeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroupRestResourceTypeRequest>() {
           @Override
           public void write(JsonWriter out, AddGroupRestResourceTypeRequest value) throws IOException {
           ...
           @Override
           public AddGroupRestResourceTypeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroupRestResourceTypeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroupRestResourceTypeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroupRestResourceTypeRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroupRestResourceTypeRequest
  */
  public static AddGroupRestResourceTypeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroupRestResourceTypeRequest.class);
  }

 /**
  * Convert an instance of AddGroupRestResourceTypeRequest to an JSON string
  *
  * @return JSON string
  */
