...
public class DisallowedCharactersPasswordValidatorResponse {
  ...
  public DisallowedCharactersPasswordValidatorResponse() {
  }

  public DisallowedCharactersPasswordValidatorResponse id(String id) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse description(String description) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse schemas(List<EnumdisallowedCharactersPasswordValidatorSchemaUrn> schemas) {
  ...
  public DisallowedCharactersPasswordValidatorResponse addSchemasItem(EnumdisallowedCharactersPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse disallowedCharacters(String disallowedCharacters) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse disallowedLeadingCharacters(String disallowedLeadingCharacters) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse disallowedTrailingCharacters(String disallowedTrailingCharacters) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public DisallowedCharactersPasswordValidatorResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the DisallowedCharactersPasswordValidatorResponse instance itself
   */
  public DisallowedCharactersPasswordValidatorResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    DisallowedCharactersPasswordValidatorResponse disallowedCharactersPasswordValidatorResponse = (DisallowedCharactersPasswordValidatorResponse) o;
    return Objects.equals(this.id, disallowedCharactersPasswordValidatorResponse.id) &&
        Objects.equals(this.description, disallowedCharactersPasswordValidatorResponse.description) &&
        Objects.equals(this.schemas, disallowedCharactersPasswordValidatorResponse.schemas) &&
        Objects.equals(this.disallowedCharacters, disallowedCharactersPasswordValidatorResponse.disallowedCharacters) &&
        Objects.equals(this.disallowedLeadingCharacters, disallowedCharactersPasswordValidatorResponse.disallowedLeadingCharacters) &&
        Objects.equals(this.disallowedTrailingCharacters, disallowedCharactersPasswordValidatorResponse.disallowedTrailingCharacters) &&
        Objects.equals(this.enabled, disallowedCharactersPasswordValidatorResponse.enabled) &&
        Objects.equals(this.validatorRequirementDescription, disallowedCharactersPasswordValidatorResponse.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, disallowedCharactersPasswordValidatorResponse.validatorFailureMessage) &&
        Objects.equals(this.meta, disallowedCharactersPasswordValidatorResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, disallowedCharactersPasswordValidatorResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, disallowedCharactersPasswordValidatorResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, disallowedCharacters, disallowedLeadingCharacters, disallowedTrailingCharacters, enabled, validatorRequirementDescription, validatorFailureMessage, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DisallowedCharactersPasswordValidatorResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to DisallowedCharactersPasswordValidatorResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!DisallowedCharactersPasswordValidatorResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in DisallowedCharactersPasswordValidatorResponse is not found in the empty JSON string", DisallowedCharactersPasswordValidatorResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : DisallowedCharactersPasswordValidatorResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DisallowedCharactersPasswordValidatorResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DisallowedCharactersPasswordValidatorResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DisallowedCharactersPasswordValidatorResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DisallowedCharactersPasswordValidatorResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<DisallowedCharactersPasswordValidatorResponse>() {
           @Override
           public void write(JsonWriter out, DisallowedCharactersPasswordValidatorResponse value) throws IOException {
           ...
           @Override
           public DisallowedCharactersPasswordValidatorResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             DisallowedCharactersPasswordValidatorResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of DisallowedCharactersPasswordValidatorResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of DisallowedCharactersPasswordValidatorResponse
  * @throws IOException if the JSON string is invalid with respect to DisallowedCharactersPasswordValidatorResponse
  */
  public static DisallowedCharactersPasswordValidatorResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DisallowedCharactersPasswordValidatorResponse.class);
  }

 /**
  * Convert an instance of DisallowedCharactersPasswordValidatorResponse to an JSON string
  *
  * @return JSON string
  */
