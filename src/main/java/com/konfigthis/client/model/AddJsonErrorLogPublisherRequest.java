...
public class AddJsonErrorLogPublisherRequest {
  ...
  public AddJsonErrorLogPublisherRequest() {
  }

  public AddJsonErrorLogPublisherRequest publisherName(String publisherName) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest description(String description) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest schemas(List<EnumjsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public AddJsonErrorLogPublisherRequest addSchemasItem(EnumjsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest logFile(String logFile) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The UNIX permissions of the log files created by this JSON Error Log Publisher.")
  ...
  public AddJsonErrorLogPublisherRequest rotationPolicy(List<String> rotationPolicy) {
  ...
  public AddJsonErrorLogPublisherRequest addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The rotation policy to use for the JSON Error Log Publisher .")
  ...
  public AddJsonErrorLogPublisherRequest rotationListener(List<String> rotationListener) {
  ...
  public AddJsonErrorLogPublisherRequest addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest retentionPolicy(List<String> retentionPolicy) {
  ...
  public AddJsonErrorLogPublisherRequest addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The retention policy to use for the JSON Error Log Publisher .")
  ...
  public AddJsonErrorLogPublisherRequest compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest signLog(Boolean signLog) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest append(Boolean append) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Indicates whether the JSON Error Log Publisher will publish records asynchronously.")
  ...
  public AddJsonErrorLogPublisherRequest autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest bufferSize(String bufferSize) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest queueSize(Integer queueSize) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest timeInterval(String timeInterval) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public AddJsonErrorLogPublisherRequest addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest overrideSeverity(List<String> overrideSeverity) {
  ...
  public AddJsonErrorLogPublisherRequest addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddJsonErrorLogPublisherRequest loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the AddJsonErrorLogPublisherRequest instance itself
   */
  public AddJsonErrorLogPublisherRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddJsonErrorLogPublisherRequest addJsonErrorLogPublisherRequest = (AddJsonErrorLogPublisherRequest) o;
    return Objects.equals(this.publisherName, addJsonErrorLogPublisherRequest.publisherName) &&
        Objects.equals(this.description, addJsonErrorLogPublisherRequest.description) &&
        Objects.equals(this.schemas, addJsonErrorLogPublisherRequest.schemas) &&
        Objects.equals(this.logFile, addJsonErrorLogPublisherRequest.logFile) &&
        Objects.equals(this.logFilePermissions, addJsonErrorLogPublisherRequest.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, addJsonErrorLogPublisherRequest.rotationPolicy) &&
        Objects.equals(this.rotationListener, addJsonErrorLogPublisherRequest.rotationListener) &&
        Objects.equals(this.retentionPolicy, addJsonErrorLogPublisherRequest.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, addJsonErrorLogPublisherRequest.compressionMechanism) &&
        Objects.equals(this.signLog, addJsonErrorLogPublisherRequest.signLog) &&
        Objects.equals(this.encryptLog, addJsonErrorLogPublisherRequest.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, addJsonErrorLogPublisherRequest.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, addJsonErrorLogPublisherRequest.append) &&
        Objects.equals(this.asynchronous, addJsonErrorLogPublisherRequest.asynchronous) &&
        Objects.equals(this.autoFlush, addJsonErrorLogPublisherRequest.autoFlush) &&
        Objects.equals(this.bufferSize, addJsonErrorLogPublisherRequest.bufferSize) &&
        Objects.equals(this.queueSize, addJsonErrorLogPublisherRequest.queueSize) &&
        Objects.equals(this.timeInterval, addJsonErrorLogPublisherRequest.timeInterval) &&
        Objects.equals(this.writeMultiLineMessages, addJsonErrorLogPublisherRequest.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, addJsonErrorLogPublisherRequest.includeProductName) &&
        Objects.equals(this.includeInstanceName, addJsonErrorLogPublisherRequest.includeInstanceName) &&
        Objects.equals(this.includeStartupID, addJsonErrorLogPublisherRequest.includeStartupID) &&
        Objects.equals(this.includeThreadID, addJsonErrorLogPublisherRequest.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, addJsonErrorLogPublisherRequest.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.defaultSeverity, addJsonErrorLogPublisherRequest.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, addJsonErrorLogPublisherRequest.overrideSeverity) &&
        Objects.equals(this.enabled, addJsonErrorLogPublisherRequest.enabled) &&
        Objects.equals(this.loggingErrorBehavior, addJsonErrorLogPublisherRequest.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, addJsonErrorLogPublisherRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(publisherName, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, writeMultiLineMessages, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddJsonErrorLogPublisherRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddJsonErrorLogPublisherRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddJsonErrorLogPublisherRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddJsonErrorLogPublisherRequest is not found in the empty JSON string", AddJsonErrorLogPublisherRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddJsonErrorLogPublisherRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddJsonErrorLogPublisherRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddJsonErrorLogPublisherRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddJsonErrorLogPublisherRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddJsonErrorLogPublisherRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddJsonErrorLogPublisherRequest>() {
           @Override
           public void write(JsonWriter out, AddJsonErrorLogPublisherRequest value) throws IOException {
           ...
           @Override
           public AddJsonErrorLogPublisherRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddJsonErrorLogPublisherRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddJsonErrorLogPublisherRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddJsonErrorLogPublisherRequest
  * @throws IOException if the JSON string is invalid with respect to AddJsonErrorLogPublisherRequest
  */
  public static AddJsonErrorLogPublisherRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddJsonErrorLogPublisherRequest.class);
  }

 /**
  * Convert an instance of AddJsonErrorLogPublisherRequest to an JSON string
  *
  * @return JSON string
  */
