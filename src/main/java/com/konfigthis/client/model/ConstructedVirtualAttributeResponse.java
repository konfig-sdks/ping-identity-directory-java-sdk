...
import com.konfigthis.client.model.EnumconstructedVirtualAttributeSchemaUrn;
...
public class ConstructedVirtualAttributeResponse {
  ...
  private List<EnumconstructedVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public ConstructedVirtualAttributeResponse() {
  }

  public ConstructedVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse schemas(List<EnumconstructedVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConstructedVirtualAttributeResponse addSchemasItem(EnumconstructedVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumconstructedVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumconstructedVirtualAttributeSchemaUrn> schemas) {
  ...
  public ConstructedVirtualAttributeResponse valuePattern(List<String> valuePattern) {
  ...
  public ConstructedVirtualAttributeResponse addValuePatternItem(String valuePatternItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies a pattern for constructing the virtual attribute value using fixed text and attribute values from the entry.")
  ...
  public ConstructedVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public ConstructedVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public ConstructedVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse filter(List<String> filter) {
  ...
  public ConstructedVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ConstructedVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ConstructedVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ConstructedVirtualAttributeResponse instance itself
   */
  public ConstructedVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConstructedVirtualAttributeResponse constructedVirtualAttributeResponse = (ConstructedVirtualAttributeResponse) o;
    return Objects.equals(this.id, constructedVirtualAttributeResponse.id) &&
        Objects.equals(this.description, constructedVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, constructedVirtualAttributeResponse.schemas) &&
        Objects.equals(this.valuePattern, constructedVirtualAttributeResponse.valuePattern) &&
        Objects.equals(this.enabled, constructedVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, constructedVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, constructedVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, constructedVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, constructedVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, constructedVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, constructedVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, constructedVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, constructedVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, constructedVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, constructedVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, constructedVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, constructedVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, constructedVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, valuePattern, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConstructedVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConstructedVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConstructedVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConstructedVirtualAttributeResponse is not found in the empty JSON string", ConstructedVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ConstructedVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConstructedVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConstructedVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConstructedVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConstructedVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ConstructedVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, ConstructedVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public ConstructedVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConstructedVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConstructedVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConstructedVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to ConstructedVirtualAttributeResponse
  */
  public static ConstructedVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConstructedVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of ConstructedVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
