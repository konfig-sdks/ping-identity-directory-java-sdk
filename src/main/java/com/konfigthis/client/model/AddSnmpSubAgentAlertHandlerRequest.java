...
public class AddSnmpSubAgentAlertHandlerRequest {
  ...
  public AddSnmpSubAgentAlertHandlerRequest() {
  }

  public AddSnmpSubAgentAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest schemas(List<EnumsnmpSubAgentAlertHandlerSchemaUrn> schemas) {
  ...
  public AddSnmpSubAgentAlertHandlerRequest addSchemasItem(EnumsnmpSubAgentAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddSnmpSubAgentAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddSnmpSubAgentAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddSnmpSubAgentAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddSnmpSubAgentAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddSnmpSubAgentAlertHandlerRequest instance itself
   */
  public AddSnmpSubAgentAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddSnmpSubAgentAlertHandlerRequest addSnmpSubAgentAlertHandlerRequest = (AddSnmpSubAgentAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addSnmpSubAgentAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addSnmpSubAgentAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addSnmpSubAgentAlertHandlerRequest.schemas) &&
        Objects.equals(this.asynchronous, addSnmpSubAgentAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabled, addSnmpSubAgentAlertHandlerRequest.enabled) &&
        Objects.equals(this.enabledAlertSeverity, addSnmpSubAgentAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addSnmpSubAgentAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addSnmpSubAgentAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addSnmpSubAgentAlertHandlerRequest.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddSnmpSubAgentAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddSnmpSubAgentAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddSnmpSubAgentAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddSnmpSubAgentAlertHandlerRequest is not found in the empty JSON string", AddSnmpSubAgentAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddSnmpSubAgentAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddSnmpSubAgentAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddSnmpSubAgentAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddSnmpSubAgentAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddSnmpSubAgentAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddSnmpSubAgentAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddSnmpSubAgentAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddSnmpSubAgentAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddSnmpSubAgentAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddSnmpSubAgentAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddSnmpSubAgentAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddSnmpSubAgentAlertHandlerRequest
  */
  public static AddSnmpSubAgentAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddSnmpSubAgentAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddSnmpSubAgentAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
