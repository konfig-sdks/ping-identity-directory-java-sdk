...
public class NumSubordinatesVirtualAttributeResponseAllOf {
  ...
  private List<EnumnumSubordinatesVirtualAttributeSchemaUrn> schemas = null;
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf() {
  }

  public NumSubordinatesVirtualAttributeResponseAllOf description(String description) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf schemas(List<EnumnumSubordinatesVirtualAttributeSchemaUrn> schemas) {
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf addSchemasItem(EnumnumSubordinatesVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf id(String id) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf attributeType(String attributeType) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf baseDN(List<String> baseDN) {
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf groupDN(List<String> groupDN) {
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf filter(List<String> filter) {
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public NumSubordinatesVirtualAttributeResponseAllOf allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the NumSubordinatesVirtualAttributeResponseAllOf instance itself
   */
  public NumSubordinatesVirtualAttributeResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    NumSubordinatesVirtualAttributeResponseAllOf numSubordinatesVirtualAttributeResponseAllOf = (NumSubordinatesVirtualAttributeResponseAllOf) o;
    return Objects.equals(this.description, numSubordinatesVirtualAttributeResponseAllOf.description) &&
        Objects.equals(this.schemas, numSubordinatesVirtualAttributeResponseAllOf.schemas) &&
        Objects.equals(this.id, numSubordinatesVirtualAttributeResponseAllOf.id) &&
        Objects.equals(this.conflictBehavior, numSubordinatesVirtualAttributeResponseAllOf.conflictBehavior) &&
        Objects.equals(this.attributeType, numSubordinatesVirtualAttributeResponseAllOf.attributeType) &&
        Objects.equals(this.enabled, numSubordinatesVirtualAttributeResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, numSubordinatesVirtualAttributeResponseAllOf.baseDN) &&
        Objects.equals(this.groupDN, numSubordinatesVirtualAttributeResponseAllOf.groupDN) &&
        Objects.equals(this.filter, numSubordinatesVirtualAttributeResponseAllOf.filter) &&
        Objects.equals(this.clientConnectionPolicy, numSubordinatesVirtualAttributeResponseAllOf.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, numSubordinatesVirtualAttributeResponseAllOf.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, numSubordinatesVirtualAttributeResponseAllOf.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, numSubordinatesVirtualAttributeResponseAllOf.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, numSubordinatesVirtualAttributeResponseAllOf.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, numSubordinatesVirtualAttributeResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class NumSubordinatesVirtualAttributeResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to NumSubordinatesVirtualAttributeResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!NumSubordinatesVirtualAttributeResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in NumSubordinatesVirtualAttributeResponseAllOf is not found in the empty JSON string", NumSubordinatesVirtualAttributeResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!NumSubordinatesVirtualAttributeResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'NumSubordinatesVirtualAttributeResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<NumSubordinatesVirtualAttributeResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(NumSubordinatesVirtualAttributeResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<NumSubordinatesVirtualAttributeResponseAllOf>() {
           @Override
           public void write(JsonWriter out, NumSubordinatesVirtualAttributeResponseAllOf value) throws IOException {
           ...
           @Override
           public NumSubordinatesVirtualAttributeResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             NumSubordinatesVirtualAttributeResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of NumSubordinatesVirtualAttributeResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of NumSubordinatesVirtualAttributeResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to NumSubordinatesVirtualAttributeResponseAllOf
  */
  public static NumSubordinatesVirtualAttributeResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, NumSubordinatesVirtualAttributeResponseAllOf.class);
  }

 /**
  * Convert an instance of NumSubordinatesVirtualAttributeResponseAllOf to an JSON string
  *
  * @return JSON string
  */
