...
public class AddFifoEntryCacheRequest {
  ...
  public AddFifoEntryCacheRequest() {
  }

  public AddFifoEntryCacheRequest cacheName(String cacheName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new Entry Cache")
  ...
  public AddFifoEntryCacheRequest description(String description) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest schemas(List<EnumfifoEntryCacheSchemaUrn> schemas) {
  ...
  public AddFifoEntryCacheRequest addSchemasItem(EnumfifoEntryCacheSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest maxMemoryPercent(Integer maxMemoryPercent) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest maxEntries(Integer maxEntries) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest onlyCacheFrequentlyAccessed(Boolean onlyCacheFrequentlyAccessed) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest includeFilter(List<String> includeFilter) {
  ...
  public AddFifoEntryCacheRequest addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest excludeFilter(List<String> excludeFilter) {
  ...
  public AddFifoEntryCacheRequest addExcludeFilterItem(String excludeFilterItem) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest minCacheEntryValueCount(Integer minCacheEntryValueCount) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest minCacheEntryAttribute(List<String> minCacheEntryAttribute) {
  ...
  public AddFifoEntryCacheRequest addMinCacheEntryAttributeItem(String minCacheEntryAttributeItem) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest cacheLevel(Integer cacheLevel) {
  ...
  **/
  ...
  public AddFifoEntryCacheRequest cacheUnindexedSearchResults(Boolean cacheUnindexedSearchResults) {
  ...
  **/
   ...
   * @return the AddFifoEntryCacheRequest instance itself
   */
  public AddFifoEntryCacheRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddFifoEntryCacheRequest addFifoEntryCacheRequest = (AddFifoEntryCacheRequest) o;
    return Objects.equals(this.cacheName, addFifoEntryCacheRequest.cacheName) &&
        Objects.equals(this.description, addFifoEntryCacheRequest.description) &&
        Objects.equals(this.schemas, addFifoEntryCacheRequest.schemas) &&
        Objects.equals(this.maxMemoryPercent, addFifoEntryCacheRequest.maxMemoryPercent) &&
        Objects.equals(this.maxEntries, addFifoEntryCacheRequest.maxEntries) &&
        Objects.equals(this.onlyCacheFrequentlyAccessed, addFifoEntryCacheRequest.onlyCacheFrequentlyAccessed) &&
        Objects.equals(this.includeFilter, addFifoEntryCacheRequest.includeFilter) &&
        Objects.equals(this.excludeFilter, addFifoEntryCacheRequest.excludeFilter) &&
        Objects.equals(this.minCacheEntryValueCount, addFifoEntryCacheRequest.minCacheEntryValueCount) &&
        Objects.equals(this.minCacheEntryAttribute, addFifoEntryCacheRequest.minCacheEntryAttribute) &&
        Objects.equals(this.enabled, addFifoEntryCacheRequest.enabled) &&
        Objects.equals(this.cacheLevel, addFifoEntryCacheRequest.cacheLevel) &&
        Objects.equals(this.cacheUnindexedSearchResults, addFifoEntryCacheRequest.cacheUnindexedSearchResults)&&
        Objects.equals(this.additionalProperties, addFifoEntryCacheRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(cacheName, description, schemas, maxMemoryPercent, maxEntries, onlyCacheFrequentlyAccessed, includeFilter, excludeFilter, minCacheEntryValueCount, minCacheEntryAttribute, enabled, cacheLevel, cacheUnindexedSearchResults, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddFifoEntryCacheRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFifoEntryCacheRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFifoEntryCacheRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFifoEntryCacheRequest is not found in the empty JSON string", AddFifoEntryCacheRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddFifoEntryCacheRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddFifoEntryCacheRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddFifoEntryCacheRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddFifoEntryCacheRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddFifoEntryCacheRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddFifoEntryCacheRequest>() {
           @Override
           public void write(JsonWriter out, AddFifoEntryCacheRequest value) throws IOException {
           ...
           @Override
           public AddFifoEntryCacheRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddFifoEntryCacheRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddFifoEntryCacheRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddFifoEntryCacheRequest
  * @throws IOException if the JSON string is invalid with respect to AddFifoEntryCacheRequest
  */
  public static AddFifoEntryCacheRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddFifoEntryCacheRequest.class);
  }

 /**
  * Convert an instance of AddFifoEntryCacheRequest to an JSON string
  *
  * @return JSON string
  */
