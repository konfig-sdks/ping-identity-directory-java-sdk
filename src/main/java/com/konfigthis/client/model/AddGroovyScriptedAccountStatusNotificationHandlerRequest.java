...
public class AddGroovyScriptedAccountStatusNotificationHandlerRequest {
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest() {
  }

  public AddGroovyScriptedAccountStatusNotificationHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest schemas(List<EnumgroovyScriptedAccountStatusNotificationHandlerSchemaUrn> schemas) {
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest addSchemasItem(EnumgroovyScriptedAccountStatusNotificationHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest scriptClass(String scriptClass) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest scriptArgument(List<String> scriptArgument) {
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest addScriptArgumentItem(String scriptArgumentItem) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest accountAuthenticationNotificationResultCriteria(String accountAuthenticationNotificationResultCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest accountCreationNotificationRequestCriteria(String accountCreationNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest accountDeletionNotificationRequestCriteria(String accountDeletionNotificationRequestCriteria) {
  ...
  **/
  ...
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest accountUpdateNotificationRequestCriteria(String accountUpdateNotificationRequestCriteria) {
  ...
  **/
   ...
   * @return the AddGroovyScriptedAccountStatusNotificationHandlerRequest instance itself
   */
  public AddGroovyScriptedAccountStatusNotificationHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddGroovyScriptedAccountStatusNotificationHandlerRequest addGroovyScriptedAccountStatusNotificationHandlerRequest = (AddGroovyScriptedAccountStatusNotificationHandlerRequest) o;
    return Objects.equals(this.handlerName, addGroovyScriptedAccountStatusNotificationHandlerRequest.handlerName) &&
        Objects.equals(this.description, addGroovyScriptedAccountStatusNotificationHandlerRequest.description) &&
        Objects.equals(this.schemas, addGroovyScriptedAccountStatusNotificationHandlerRequest.schemas) &&
        Objects.equals(this.scriptClass, addGroovyScriptedAccountStatusNotificationHandlerRequest.scriptClass) &&
        Objects.equals(this.scriptArgument, addGroovyScriptedAccountStatusNotificationHandlerRequest.scriptArgument) &&
        Objects.equals(this.enabled, addGroovyScriptedAccountStatusNotificationHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addGroovyScriptedAccountStatusNotificationHandlerRequest.asynchronous) &&
        Objects.equals(this.accountAuthenticationNotificationResultCriteria, addGroovyScriptedAccountStatusNotificationHandlerRequest.accountAuthenticationNotificationResultCriteria) &&
        Objects.equals(this.accountCreationNotificationRequestCriteria, addGroovyScriptedAccountStatusNotificationHandlerRequest.accountCreationNotificationRequestCriteria) &&
        Objects.equals(this.accountDeletionNotificationRequestCriteria, addGroovyScriptedAccountStatusNotificationHandlerRequest.accountDeletionNotificationRequestCriteria) &&
        Objects.equals(this.accountUpdateNotificationRequestCriteria, addGroovyScriptedAccountStatusNotificationHandlerRequest.accountUpdateNotificationRequestCriteria)&&
        Objects.equals(this.additionalProperties, addGroovyScriptedAccountStatusNotificationHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, scriptClass, scriptArgument, enabled, asynchronous, accountAuthenticationNotificationResultCriteria, accountCreationNotificationRequestCriteria, accountDeletionNotificationRequestCriteria, accountUpdateNotificationRequestCriteria, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddGroovyScriptedAccountStatusNotificationHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddGroovyScriptedAccountStatusNotificationHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddGroovyScriptedAccountStatusNotificationHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddGroovyScriptedAccountStatusNotificationHandlerRequest is not found in the empty JSON string", AddGroovyScriptedAccountStatusNotificationHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddGroovyScriptedAccountStatusNotificationHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddGroovyScriptedAccountStatusNotificationHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddGroovyScriptedAccountStatusNotificationHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddGroovyScriptedAccountStatusNotificationHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddGroovyScriptedAccountStatusNotificationHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddGroovyScriptedAccountStatusNotificationHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddGroovyScriptedAccountStatusNotificationHandlerRequest value) throws IOException {
           ...
           @Override
           public AddGroovyScriptedAccountStatusNotificationHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddGroovyScriptedAccountStatusNotificationHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddGroovyScriptedAccountStatusNotificationHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddGroovyScriptedAccountStatusNotificationHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddGroovyScriptedAccountStatusNotificationHandlerRequest
  */
  public static AddGroovyScriptedAccountStatusNotificationHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddGroovyScriptedAccountStatusNotificationHandlerRequest.class);
  }

 /**
  * Convert an instance of AddGroovyScriptedAccountStatusNotificationHandlerRequest to an JSON string
  *
  * @return JSON string
  */
