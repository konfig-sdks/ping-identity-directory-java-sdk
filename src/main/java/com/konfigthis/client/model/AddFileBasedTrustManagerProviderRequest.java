...
public class AddFileBasedTrustManagerProviderRequest {
  ...
  public AddFileBasedTrustManagerProviderRequest() {
  }

  public AddFileBasedTrustManagerProviderRequest providerName(String providerName) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest schemas(List<EnumfileBasedTrustManagerProviderSchemaUrn> schemas) {
  ...
  public AddFileBasedTrustManagerProviderRequest addSchemasItem(EnumfileBasedTrustManagerProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest trustStorePinFile(String trustStorePinFile) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest trustStorePinPassphraseProvider(String trustStorePinPassphraseProvider) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddFileBasedTrustManagerProviderRequest includeJVMDefaultIssuers(Boolean includeJVMDefaultIssuers) {
  ...
  **/
   ...
   * @return the AddFileBasedTrustManagerProviderRequest instance itself
   */
  public AddFileBasedTrustManagerProviderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddFileBasedTrustManagerProviderRequest addFileBasedTrustManagerProviderRequest = (AddFileBasedTrustManagerProviderRequest) o;
    return Objects.equals(this.providerName, addFileBasedTrustManagerProviderRequest.providerName) &&
        Objects.equals(this.schemas, addFileBasedTrustManagerProviderRequest.schemas) &&
        Objects.equals(this.trustStoreFile, addFileBasedTrustManagerProviderRequest.trustStoreFile) &&
        Objects.equals(this.trustStoreType, addFileBasedTrustManagerProviderRequest.trustStoreType) &&
        Objects.equals(this.trustStorePin, addFileBasedTrustManagerProviderRequest.trustStorePin) &&
        Objects.equals(this.trustStorePinFile, addFileBasedTrustManagerProviderRequest.trustStorePinFile) &&
        Objects.equals(this.trustStorePinPassphraseProvider, addFileBasedTrustManagerProviderRequest.trustStorePinPassphraseProvider) &&
        Objects.equals(this.enabled, addFileBasedTrustManagerProviderRequest.enabled) &&
        Objects.equals(this.includeJVMDefaultIssuers, addFileBasedTrustManagerProviderRequest.includeJVMDefaultIssuers)&&
        Objects.equals(this.additionalProperties, addFileBasedTrustManagerProviderRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(providerName, schemas, trustStoreFile, trustStoreType, trustStorePin, trustStorePinFile, trustStorePinPassphraseProvider, enabled, includeJVMDefaultIssuers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddFileBasedTrustManagerProviderRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddFileBasedTrustManagerProviderRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddFileBasedTrustManagerProviderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddFileBasedTrustManagerProviderRequest is not found in the empty JSON string", AddFileBasedTrustManagerProviderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddFileBasedTrustManagerProviderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddFileBasedTrustManagerProviderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddFileBasedTrustManagerProviderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddFileBasedTrustManagerProviderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddFileBasedTrustManagerProviderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddFileBasedTrustManagerProviderRequest>() {
           @Override
           public void write(JsonWriter out, AddFileBasedTrustManagerProviderRequest value) throws IOException {
           ...
           @Override
           public AddFileBasedTrustManagerProviderRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddFileBasedTrustManagerProviderRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddFileBasedTrustManagerProviderRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddFileBasedTrustManagerProviderRequest
  * @throws IOException if the JSON string is invalid with respect to AddFileBasedTrustManagerProviderRequest
  */
  public static AddFileBasedTrustManagerProviderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddFileBasedTrustManagerProviderRequest.class);
  }

 /**
  * Convert an instance of AddFileBasedTrustManagerProviderRequest to an JSON string
  *
  * @return JSON string
  */
