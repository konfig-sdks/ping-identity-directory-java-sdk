...
import com.konfigthis.client.model.EnummemberOfServerGroupVirtualAttributeSchemaUrn;
...
public class MemberOfServerGroupVirtualAttributeResponse {
  ...
  private List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public MemberOfServerGroupVirtualAttributeResponse() {
  }

  public MemberOfServerGroupVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse schemas(List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse addSchemasItem(EnummemberOfServerGroupVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnummemberOfServerGroupVirtualAttributeSchemaUrn> schemas) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse filter(List<String> filter) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public MemberOfServerGroupVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MemberOfServerGroupVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MemberOfServerGroupVirtualAttributeResponse instance itself
   */
  public MemberOfServerGroupVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MemberOfServerGroupVirtualAttributeResponse memberOfServerGroupVirtualAttributeResponse = (MemberOfServerGroupVirtualAttributeResponse) o;
    return Objects.equals(this.description, memberOfServerGroupVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, memberOfServerGroupVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, memberOfServerGroupVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, memberOfServerGroupVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, memberOfServerGroupVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.enabled, memberOfServerGroupVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, memberOfServerGroupVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, memberOfServerGroupVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, memberOfServerGroupVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, memberOfServerGroupVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, memberOfServerGroupVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, memberOfServerGroupVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, memberOfServerGroupVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, memberOfServerGroupVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, memberOfServerGroupVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, memberOfServerGroupVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, memberOfServerGroupVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MemberOfServerGroupVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemberOfServerGroupVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemberOfServerGroupVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemberOfServerGroupVirtualAttributeResponse is not found in the empty JSON string", MemberOfServerGroupVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MemberOfServerGroupVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemberOfServerGroupVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemberOfServerGroupVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemberOfServerGroupVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemberOfServerGroupVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MemberOfServerGroupVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, MemberOfServerGroupVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public MemberOfServerGroupVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemberOfServerGroupVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemberOfServerGroupVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemberOfServerGroupVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to MemberOfServerGroupVirtualAttributeResponse
  */
  public static MemberOfServerGroupVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemberOfServerGroupVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of MemberOfServerGroupVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
