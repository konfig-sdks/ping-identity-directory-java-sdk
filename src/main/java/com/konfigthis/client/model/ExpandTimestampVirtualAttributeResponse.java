...
public class ExpandTimestampVirtualAttributeResponse {
  ...
  private List<EnumexpandTimestampVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public ExpandTimestampVirtualAttributeResponse() {
  }

  public ExpandTimestampVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse schemas(List<EnumexpandTimestampVirtualAttributeSchemaUrn> schemas) {
  ...
  public ExpandTimestampVirtualAttributeResponse addSchemasItem(EnumexpandTimestampVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse sourceAttribute(String sourceAttribute) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the source attribute containing the compact timestamp to be expanded.")
  ...
  public ExpandTimestampVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public ExpandTimestampVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public ExpandTimestampVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse filter(List<String> filter) {
  ...
  public ExpandTimestampVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public ExpandTimestampVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public ExpandTimestampVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the ExpandTimestampVirtualAttributeResponse instance itself
   */
  public ExpandTimestampVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExpandTimestampVirtualAttributeResponse expandTimestampVirtualAttributeResponse = (ExpandTimestampVirtualAttributeResponse) o;
    return Objects.equals(this.description, expandTimestampVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, expandTimestampVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, expandTimestampVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, expandTimestampVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.sourceAttribute, expandTimestampVirtualAttributeResponse.sourceAttribute) &&
        Objects.equals(this.enabled, expandTimestampVirtualAttributeResponse.enabled) &&
        Objects.equals(this.attributeType, expandTimestampVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.baseDN, expandTimestampVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, expandTimestampVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, expandTimestampVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, expandTimestampVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, expandTimestampVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, expandTimestampVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, expandTimestampVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, expandTimestampVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.meta, expandTimestampVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, expandTimestampVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, expandTimestampVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, sourceAttribute, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExpandTimestampVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExpandTimestampVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExpandTimestampVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExpandTimestampVirtualAttributeResponse is not found in the empty JSON string", ExpandTimestampVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ExpandTimestampVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExpandTimestampVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExpandTimestampVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExpandTimestampVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExpandTimestampVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ExpandTimestampVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, ExpandTimestampVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public ExpandTimestampVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExpandTimestampVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExpandTimestampVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExpandTimestampVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to ExpandTimestampVirtualAttributeResponse
  */
  public static ExpandTimestampVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExpandTimestampVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of ExpandTimestampVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
