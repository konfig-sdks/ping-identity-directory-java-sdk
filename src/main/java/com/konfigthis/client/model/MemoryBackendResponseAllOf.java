...
public class MemoryBackendResponseAllOf {
  ...
  private List<EnummemoryBackendSchemaUrn> schemas = null;
  ...
  public MemoryBackendResponseAllOf() {
  }

  public MemoryBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf schemas(List<EnummemoryBackendSchemaUrn> schemas) {
  ...
  public MemoryBackendResponseAllOf addSchemasItem(EnummemoryBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public MemoryBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public MemoryBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the MemoryBackendResponseAllOf instance itself
   */
  public MemoryBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MemoryBackendResponseAllOf memoryBackendResponseAllOf = (MemoryBackendResponseAllOf) o;
    return Objects.equals(this.description, memoryBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, memoryBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, memoryBackendResponseAllOf.id) &&
        Objects.equals(this.writabilityMode, memoryBackendResponseAllOf.writabilityMode) &&
        Objects.equals(this.backendID, memoryBackendResponseAllOf.backendID) &&
        Objects.equals(this.enabled, memoryBackendResponseAllOf.enabled) &&
        Objects.equals(this.baseDN, memoryBackendResponseAllOf.baseDN) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, memoryBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, memoryBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.notificationManager, memoryBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, memoryBackendResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MemoryBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MemoryBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MemoryBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MemoryBackendResponseAllOf is not found in the empty JSON string", MemoryBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MemoryBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MemoryBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MemoryBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MemoryBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<MemoryBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, MemoryBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public MemoryBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MemoryBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MemoryBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MemoryBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to MemoryBackendResponseAllOf
  */
  public static MemoryBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MemoryBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of MemoryBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
