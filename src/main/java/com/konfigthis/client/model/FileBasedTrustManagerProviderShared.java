...
public class FileBasedTrustManagerProviderShared {
  ...
  public FileBasedTrustManagerProviderShared() {
  }

  public FileBasedTrustManagerProviderShared schemas(List<EnumfileBasedTrustManagerProviderSchemaUrn> schemas) {
  ...
  public FileBasedTrustManagerProviderShared addSchemasItem(EnumfileBasedTrustManagerProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared trustStoreFile(String trustStoreFile) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared trustStorePinFile(String trustStorePinFile) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared trustStorePinPassphraseProvider(String trustStorePinPassphraseProvider) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedTrustManagerProviderShared includeJVMDefaultIssuers(Boolean includeJVMDefaultIssuers) {
  ...
  **/
   ...
   * @return the FileBasedTrustManagerProviderShared instance itself
   */
  public FileBasedTrustManagerProviderShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedTrustManagerProviderShared fileBasedTrustManagerProviderShared = (FileBasedTrustManagerProviderShared) o;
    return Objects.equals(this.schemas, fileBasedTrustManagerProviderShared.schemas) &&
        Objects.equals(this.trustStoreFile, fileBasedTrustManagerProviderShared.trustStoreFile) &&
        Objects.equals(this.trustStoreType, fileBasedTrustManagerProviderShared.trustStoreType) &&
        Objects.equals(this.trustStorePin, fileBasedTrustManagerProviderShared.trustStorePin) &&
        Objects.equals(this.trustStorePinFile, fileBasedTrustManagerProviderShared.trustStorePinFile) &&
        Objects.equals(this.trustStorePinPassphraseProvider, fileBasedTrustManagerProviderShared.trustStorePinPassphraseProvider) &&
        Objects.equals(this.enabled, fileBasedTrustManagerProviderShared.enabled) &&
        Objects.equals(this.includeJVMDefaultIssuers, fileBasedTrustManagerProviderShared.includeJVMDefaultIssuers)&&
        Objects.equals(this.additionalProperties, fileBasedTrustManagerProviderShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, trustStoreFile, trustStoreType, trustStorePin, trustStorePinFile, trustStorePinPassphraseProvider, enabled, includeJVMDefaultIssuers, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedTrustManagerProviderShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedTrustManagerProviderShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedTrustManagerProviderShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedTrustManagerProviderShared is not found in the empty JSON string", FileBasedTrustManagerProviderShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedTrustManagerProviderShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedTrustManagerProviderShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedTrustManagerProviderShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedTrustManagerProviderShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedTrustManagerProviderShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedTrustManagerProviderShared>() {
           @Override
           public void write(JsonWriter out, FileBasedTrustManagerProviderShared value) throws IOException {
           ...
           @Override
           public FileBasedTrustManagerProviderShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedTrustManagerProviderShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedTrustManagerProviderShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedTrustManagerProviderShared
  * @throws IOException if the JSON string is invalid with respect to FileBasedTrustManagerProviderShared
  */
  public static FileBasedTrustManagerProviderShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedTrustManagerProviderShared.class);
  }

 /**
  * Convert an instance of FileBasedTrustManagerProviderShared to an JSON string
  *
  * @return JSON string
  */
