...
public class AddAttributeMapperPluginRequest {
  ...
  public AddAttributeMapperPluginRequest() {
  }

  public AddAttributeMapperPluginRequest pluginName(String pluginName) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest description(String description) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest schemas(List<EnumattributeMapperPluginSchemaUrn> schemas) {
  ...
  public AddAttributeMapperPluginRequest addSchemasItem(EnumattributeMapperPluginSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest pluginType(List<EnumpluginPluginTypeProp> pluginType) {
  ...
  public AddAttributeMapperPluginRequest addPluginTypeItem(EnumpluginPluginTypeProp pluginTypeItem) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest sourceAttribute(String sourceAttribute) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest targetAttribute(String targetAttribute) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest enableControlMapping(Boolean enableControlMapping) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest alwaysMapResponses(Boolean alwaysMapResponses) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddAttributeMapperPluginRequest invokeForInternalOperations(Boolean invokeForInternalOperations) {
  ...
  **/
   ...
   * @return the AddAttributeMapperPluginRequest instance itself
   */
  public AddAttributeMapperPluginRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddAttributeMapperPluginRequest addAttributeMapperPluginRequest = (AddAttributeMapperPluginRequest) o;
    return Objects.equals(this.pluginName, addAttributeMapperPluginRequest.pluginName) &&
        Objects.equals(this.description, addAttributeMapperPluginRequest.description) &&
        Objects.equals(this.schemas, addAttributeMapperPluginRequest.schemas) &&
        Objects.equals(this.pluginType, addAttributeMapperPluginRequest.pluginType) &&
        Objects.equals(this.sourceAttribute, addAttributeMapperPluginRequest.sourceAttribute) &&
        Objects.equals(this.targetAttribute, addAttributeMapperPluginRequest.targetAttribute) &&
        Objects.equals(this.enableControlMapping, addAttributeMapperPluginRequest.enableControlMapping) &&
        Objects.equals(this.alwaysMapResponses, addAttributeMapperPluginRequest.alwaysMapResponses) &&
        Objects.equals(this.enabled, addAttributeMapperPluginRequest.enabled) &&
        Objects.equals(this.invokeForInternalOperations, addAttributeMapperPluginRequest.invokeForInternalOperations)&&
        Objects.equals(this.additionalProperties, addAttributeMapperPluginRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pluginName, description, schemas, pluginType, sourceAttribute, targetAttribute, enableControlMapping, alwaysMapResponses, enabled, invokeForInternalOperations, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddAttributeMapperPluginRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddAttributeMapperPluginRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddAttributeMapperPluginRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddAttributeMapperPluginRequest is not found in the empty JSON string", AddAttributeMapperPluginRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddAttributeMapperPluginRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAttributeMapperPluginRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAttributeMapperPluginRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAttributeMapperPluginRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAttributeMapperPluginRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAttributeMapperPluginRequest>() {
           @Override
           public void write(JsonWriter out, AddAttributeMapperPluginRequest value) throws IOException {
           ...
           @Override
           public AddAttributeMapperPluginRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddAttributeMapperPluginRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddAttributeMapperPluginRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddAttributeMapperPluginRequest
  * @throws IOException if the JSON string is invalid with respect to AddAttributeMapperPluginRequest
  */
  public static AddAttributeMapperPluginRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAttributeMapperPluginRequest.class);
  }

 /**
  * Convert an instance of AddAttributeMapperPluginRequest to an JSON string
  *
  * @return JSON string
  */
