...
public class AddThirdPartyAlertHandlerRequest {
  ...
  public AddThirdPartyAlertHandlerRequest() {
  }

  public AddThirdPartyAlertHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest schemas(List<EnumthirdPartyAlertHandlerSchemaUrn> schemas) {
  ...
  public AddThirdPartyAlertHandlerRequest addSchemasItem(EnumthirdPartyAlertHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyAlertHandlerRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest enabledAlertSeverity(List<EnumalertHandlerEnabledAlertSeverityProp> enabledAlertSeverity) {
  ...
  public AddThirdPartyAlertHandlerRequest addEnabledAlertSeverityItem(EnumalertHandlerEnabledAlertSeverityProp enabledAlertSeverityItem) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest enabledAlertType(List<EnumalertHandlerEnabledAlertTypeProp> enabledAlertType) {
  ...
  public AddThirdPartyAlertHandlerRequest addEnabledAlertTypeItem(EnumalertHandlerEnabledAlertTypeProp enabledAlertTypeItem) {
  ...
  **/
  ...
  public AddThirdPartyAlertHandlerRequest disabledAlertType(List<EnumalertHandlerDisabledAlertTypeProp> disabledAlertType) {
  ...
  public AddThirdPartyAlertHandlerRequest addDisabledAlertTypeItem(EnumalertHandlerDisabledAlertTypeProp disabledAlertTypeItem) {
  ...
  **/
   ...
   * @return the AddThirdPartyAlertHandlerRequest instance itself
   */
  public AddThirdPartyAlertHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyAlertHandlerRequest addThirdPartyAlertHandlerRequest = (AddThirdPartyAlertHandlerRequest) o;
    return Objects.equals(this.handlerName, addThirdPartyAlertHandlerRequest.handlerName) &&
        Objects.equals(this.description, addThirdPartyAlertHandlerRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyAlertHandlerRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyAlertHandlerRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyAlertHandlerRequest.extensionArgument) &&
        Objects.equals(this.enabled, addThirdPartyAlertHandlerRequest.enabled) &&
        Objects.equals(this.asynchronous, addThirdPartyAlertHandlerRequest.asynchronous) &&
        Objects.equals(this.enabledAlertSeverity, addThirdPartyAlertHandlerRequest.enabledAlertSeverity) &&
        Objects.equals(this.enabledAlertType, addThirdPartyAlertHandlerRequest.enabledAlertType) &&
        Objects.equals(this.disabledAlertType, addThirdPartyAlertHandlerRequest.disabledAlertType)&&
        Objects.equals(this.additionalProperties, addThirdPartyAlertHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, extensionClass, extensionArgument, enabled, asynchronous, enabledAlertSeverity, enabledAlertType, disabledAlertType, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyAlertHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyAlertHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyAlertHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyAlertHandlerRequest is not found in the empty JSON string", AddThirdPartyAlertHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyAlertHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyAlertHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyAlertHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyAlertHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyAlertHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyAlertHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyAlertHandlerRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyAlertHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyAlertHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyAlertHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyAlertHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyAlertHandlerRequest
  */
  public static AddThirdPartyAlertHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyAlertHandlerRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyAlertHandlerRequest to an JSON string
  *
  * @return JSON string
  */
