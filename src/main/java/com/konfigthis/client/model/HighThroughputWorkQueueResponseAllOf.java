...
public class HighThroughputWorkQueueResponseAllOf {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumhighThroughputWorkQueueSchemaUrn> schemas = null;
  ...
  public HighThroughputWorkQueueResponseAllOf() {
  }

  public HighThroughputWorkQueueResponseAllOf schemas(List<EnumhighThroughputWorkQueueSchemaUrn> schemas) {
  ...
  public HighThroughputWorkQueueResponseAllOf addSchemasItem(EnumhighThroughputWorkQueueSchemaUrn schemasItem) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf numWorkerThreads(Integer numWorkerThreads) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf numWriteWorkerThreads(Integer numWriteWorkerThreads) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf numAdministrativeSessionWorkerThreads(Integer numAdministrativeSessionWorkerThreads) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf numQueues(Integer numQueues) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf numWriteQueues(Integer numWriteQueues) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf maxWorkQueueCapacity(Integer maxWorkQueueCapacity) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf maxOfferTime(String maxOfferTime) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf monitorQueueTime(Boolean monitorQueueTime) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf maxQueueTime(String maxQueueTime) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf expensiveOperationCheckInterval(String expensiveOperationCheckInterval) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf expensiveOperationMinimumConcurrentCount(Integer expensiveOperationMinimumConcurrentCount) {
  ...
  **/
  ...
  public HighThroughputWorkQueueResponseAllOf expensiveOperationMinimumDumpInterval(String expensiveOperationMinimumDumpInterval) {
  ...
  **/
   ...
   * @return the HighThroughputWorkQueueResponseAllOf instance itself
   */
  public HighThroughputWorkQueueResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    HighThroughputWorkQueueResponseAllOf highThroughputWorkQueueResponseAllOf = (HighThroughputWorkQueueResponseAllOf) o;
    return Objects.equals(this.schemas, highThroughputWorkQueueResponseAllOf.schemas) &&
        Objects.equals(this.numWorkerThreads, highThroughputWorkQueueResponseAllOf.numWorkerThreads) &&
        Objects.equals(this.numWriteWorkerThreads, highThroughputWorkQueueResponseAllOf.numWriteWorkerThreads) &&
        Objects.equals(this.numAdministrativeSessionWorkerThreads, highThroughputWorkQueueResponseAllOf.numAdministrativeSessionWorkerThreads) &&
        Objects.equals(this.numQueues, highThroughputWorkQueueResponseAllOf.numQueues) &&
        Objects.equals(this.numWriteQueues, highThroughputWorkQueueResponseAllOf.numWriteQueues) &&
        Objects.equals(this.maxWorkQueueCapacity, highThroughputWorkQueueResponseAllOf.maxWorkQueueCapacity) &&
        Objects.equals(this.maxOfferTime, highThroughputWorkQueueResponseAllOf.maxOfferTime) &&
        Objects.equals(this.monitorQueueTime, highThroughputWorkQueueResponseAllOf.monitorQueueTime) &&
        Objects.equals(this.maxQueueTime, highThroughputWorkQueueResponseAllOf.maxQueueTime) &&
        Objects.equals(this.expensiveOperationCheckInterval, highThroughputWorkQueueResponseAllOf.expensiveOperationCheckInterval) &&
        Objects.equals(this.expensiveOperationMinimumConcurrentCount, highThroughputWorkQueueResponseAllOf.expensiveOperationMinimumConcurrentCount) &&
        Objects.equals(this.expensiveOperationMinimumDumpInterval, highThroughputWorkQueueResponseAllOf.expensiveOperationMinimumDumpInterval)&&
        Objects.equals(this.additionalProperties, highThroughputWorkQueueResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(schemas, numWorkerThreads, numWriteWorkerThreads, numAdministrativeSessionWorkerThreads, numQueues, numWriteQueues, maxWorkQueueCapacity, maxOfferTime, monitorQueueTime, maxQueueTime, expensiveOperationCheckInterval, expensiveOperationMinimumConcurrentCount, expensiveOperationMinimumDumpInterval, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HighThroughputWorkQueueResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to HighThroughputWorkQueueResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!HighThroughputWorkQueueResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in HighThroughputWorkQueueResponseAllOf is not found in the empty JSON string", HighThroughputWorkQueueResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!HighThroughputWorkQueueResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'HighThroughputWorkQueueResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<HighThroughputWorkQueueResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(HighThroughputWorkQueueResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<HighThroughputWorkQueueResponseAllOf>() {
           @Override
           public void write(JsonWriter out, HighThroughputWorkQueueResponseAllOf value) throws IOException {
           ...
           @Override
           public HighThroughputWorkQueueResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             HighThroughputWorkQueueResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of HighThroughputWorkQueueResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of HighThroughputWorkQueueResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to HighThroughputWorkQueueResponseAllOf
  */
  public static HighThroughputWorkQueueResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, HighThroughputWorkQueueResponseAllOf.class);
  }

 /**
  * Convert an instance of HighThroughputWorkQueueResponseAllOf to an JSON string
  *
  * @return JSON string
  */
