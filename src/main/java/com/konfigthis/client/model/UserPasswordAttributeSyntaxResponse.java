...
public class UserPasswordAttributeSyntaxResponse {
  public static final String SERIALIZED_NAME_SCHEMAS = "schemas";
  @SerializedName(SERIALIZED_NAME_SCHEMAS)
  private List<EnumuserPasswordAttributeSyntaxSchemaUrn> schemas = new ArrayList<>();
  ...
  public UserPasswordAttributeSyntaxResponse() {
  }

  public UserPasswordAttributeSyntaxResponse schemas(List<EnumuserPasswordAttributeSyntaxSchemaUrn> schemas) {
  ...
  public UserPasswordAttributeSyntaxResponse addSchemasItem(EnumuserPasswordAttributeSyntaxSchemaUrn schemasItem) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse id(String id) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse enableCompaction(Boolean enableCompaction) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse includeAttributeInCompaction(List<String> includeAttributeInCompaction) {
  ...
  public UserPasswordAttributeSyntaxResponse addIncludeAttributeInCompactionItem(String includeAttributeInCompactionItem) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse excludeAttributeFromCompaction(List<String> excludeAttributeFromCompaction) {
  ...
  public UserPasswordAttributeSyntaxResponse addExcludeAttributeFromCompactionItem(String excludeAttributeFromCompactionItem) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse requireBinaryTransfer(Boolean requireBinaryTransfer) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public UserPasswordAttributeSyntaxResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the UserPasswordAttributeSyntaxResponse instance itself
   */
  public UserPasswordAttributeSyntaxResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    UserPasswordAttributeSyntaxResponse userPasswordAttributeSyntaxResponse = (UserPasswordAttributeSyntaxResponse) o;
    return Objects.equals(this.schemas, userPasswordAttributeSyntaxResponse.schemas) &&
        Objects.equals(this.id, userPasswordAttributeSyntaxResponse.id) &&
        Objects.equals(this.enableCompaction, userPasswordAttributeSyntaxResponse.enableCompaction) &&
        Objects.equals(this.includeAttributeInCompaction, userPasswordAttributeSyntaxResponse.includeAttributeInCompaction) &&
        Objects.equals(this.excludeAttributeFromCompaction, userPasswordAttributeSyntaxResponse.excludeAttributeFromCompaction) &&
        Objects.equals(this.enabled, userPasswordAttributeSyntaxResponse.enabled) &&
        Objects.equals(this.requireBinaryTransfer, userPasswordAttributeSyntaxResponse.requireBinaryTransfer) &&
        Objects.equals(this.meta, userPasswordAttributeSyntaxResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, userPasswordAttributeSyntaxResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, userPasswordAttributeSyntaxResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserPasswordAttributeSyntaxResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserPasswordAttributeSyntaxResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!UserPasswordAttributeSyntaxResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserPasswordAttributeSyntaxResponse is not found in the empty JSON string", UserPasswordAttributeSyntaxResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : UserPasswordAttributeSyntaxResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserPasswordAttributeSyntaxResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserPasswordAttributeSyntaxResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserPasswordAttributeSyntaxResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserPasswordAttributeSyntaxResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<UserPasswordAttributeSyntaxResponse>() {
           @Override
           public void write(JsonWriter out, UserPasswordAttributeSyntaxResponse value) throws IOException {
           ...
           @Override
           public UserPasswordAttributeSyntaxResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             UserPasswordAttributeSyntaxResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of UserPasswordAttributeSyntaxResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserPasswordAttributeSyntaxResponse
  * @throws IOException if the JSON string is invalid with respect to UserPasswordAttributeSyntaxResponse
  */
  public static UserPasswordAttributeSyntaxResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserPasswordAttributeSyntaxResponse.class);
  }

 /**
  * Convert an instance of UserPasswordAttributeSyntaxResponse to an JSON string
  *
  * @return JSON string
  */
