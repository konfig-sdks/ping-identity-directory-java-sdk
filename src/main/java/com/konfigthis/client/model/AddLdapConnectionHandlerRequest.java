...
public class AddLdapConnectionHandlerRequest {
  ...
  public AddLdapConnectionHandlerRequest() {
  }

  public AddLdapConnectionHandlerRequest handlerName(String handlerName) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest description(String description) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest schemas(List<EnumldapConnectionHandlerSchemaUrn> schemas) {
  ...
  public AddLdapConnectionHandlerRequest addSchemasItem(EnumldapConnectionHandlerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest listenAddress(List<String> listenAddress) {
  ...
  public AddLdapConnectionHandlerRequest addListenAddressItem(String listenAddressItem) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest listenPort(Integer listenPort) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest useSSL(Boolean useSSL) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest allowStartTLS(Boolean allowStartTLS) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest allowLDAPV2(Boolean allowLDAPV2) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest useTCPKeepAlive(Boolean useTCPKeepAlive) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest sendRejectionNotice(Boolean sendRejectionNotice) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest failedBindResponseDelay(String failedBindResponseDelay) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest maxRequestSize(String maxRequestSize) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest maxCancelHandlers(Integer maxCancelHandlers) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest numAcceptHandlers(Integer numAcceptHandlers) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest numRequestHandlers(Integer numRequestHandlers) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest requestHandlerPerConnection(Boolean requestHandlerPerConnection) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest sslClientAuthPolicy(EnumconnectionHandlerSslClientAuthPolicyProp sslClientAuthPolicy) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest acceptBacklog(Integer acceptBacklog) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest sslProtocol(List<String> sslProtocol) {
  ...
  public AddLdapConnectionHandlerRequest addSslProtocolItem(String sslProtocolItem) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest sslCipherSuite(List<String> sslCipherSuite) {
  ...
  public AddLdapConnectionHandlerRequest addSslCipherSuiteItem(String sslCipherSuiteItem) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest maxBlockedWriteTimeLimit(String maxBlockedWriteTimeLimit) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest autoAuthenticateUsingClientCertificate(Boolean autoAuthenticateUsingClientCertificate) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest closeConnectionsWhenUnavailable(Boolean closeConnectionsWhenUnavailable) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest closeConnectionsOnExplicitGC(Boolean closeConnectionsOnExplicitGC) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest allowedClient(List<String> allowedClient) {
  ...
  public AddLdapConnectionHandlerRequest addAllowedClientItem(String allowedClientItem) {
  ...
  **/
  ...
  public AddLdapConnectionHandlerRequest deniedClient(List<String> deniedClient) {
  ...
  public AddLdapConnectionHandlerRequest addDeniedClientItem(String deniedClientItem) {
  ...
  **/
   ...
   * @return the AddLdapConnectionHandlerRequest instance itself
   */
  public AddLdapConnectionHandlerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddLdapConnectionHandlerRequest addLdapConnectionHandlerRequest = (AddLdapConnectionHandlerRequest) o;
    return Objects.equals(this.handlerName, addLdapConnectionHandlerRequest.handlerName) &&
        Objects.equals(this.description, addLdapConnectionHandlerRequest.description) &&
        Objects.equals(this.schemas, addLdapConnectionHandlerRequest.schemas) &&
        Objects.equals(this.listenAddress, addLdapConnectionHandlerRequest.listenAddress) &&
        Objects.equals(this.listenPort, addLdapConnectionHandlerRequest.listenPort) &&
        Objects.equals(this.useSSL, addLdapConnectionHandlerRequest.useSSL) &&
        Objects.equals(this.allowStartTLS, addLdapConnectionHandlerRequest.allowStartTLS) &&
        Objects.equals(this.sslCertNickname, addLdapConnectionHandlerRequest.sslCertNickname) &&
        Objects.equals(this.keyManagerProvider, addLdapConnectionHandlerRequest.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, addLdapConnectionHandlerRequest.trustManagerProvider) &&
        Objects.equals(this.allowLDAPV2, addLdapConnectionHandlerRequest.allowLDAPV2) &&
        Objects.equals(this.useTCPKeepAlive, addLdapConnectionHandlerRequest.useTCPKeepAlive) &&
        Objects.equals(this.sendRejectionNotice, addLdapConnectionHandlerRequest.sendRejectionNotice) &&
        Objects.equals(this.failedBindResponseDelay, addLdapConnectionHandlerRequest.failedBindResponseDelay) &&
        Objects.equals(this.maxRequestSize, addLdapConnectionHandlerRequest.maxRequestSize) &&
        Objects.equals(this.maxCancelHandlers, addLdapConnectionHandlerRequest.maxCancelHandlers) &&
        Objects.equals(this.numAcceptHandlers, addLdapConnectionHandlerRequest.numAcceptHandlers) &&
        Objects.equals(this.numRequestHandlers, addLdapConnectionHandlerRequest.numRequestHandlers) &&
        Objects.equals(this.requestHandlerPerConnection, addLdapConnectionHandlerRequest.requestHandlerPerConnection) &&
        Objects.equals(this.sslClientAuthPolicy, addLdapConnectionHandlerRequest.sslClientAuthPolicy) &&
        Objects.equals(this.acceptBacklog, addLdapConnectionHandlerRequest.acceptBacklog) &&
        Objects.equals(this.sslProtocol, addLdapConnectionHandlerRequest.sslProtocol) &&
        Objects.equals(this.sslCipherSuite, addLdapConnectionHandlerRequest.sslCipherSuite) &&
        Objects.equals(this.maxBlockedWriteTimeLimit, addLdapConnectionHandlerRequest.maxBlockedWriteTimeLimit) &&
        Objects.equals(this.autoAuthenticateUsingClientCertificate, addLdapConnectionHandlerRequest.autoAuthenticateUsingClientCertificate) &&
        Objects.equals(this.closeConnectionsWhenUnavailable, addLdapConnectionHandlerRequest.closeConnectionsWhenUnavailable) &&
        Objects.equals(this.closeConnectionsOnExplicitGC, addLdapConnectionHandlerRequest.closeConnectionsOnExplicitGC) &&
        Objects.equals(this.enabled, addLdapConnectionHandlerRequest.enabled) &&
        Objects.equals(this.allowedClient, addLdapConnectionHandlerRequest.allowedClient) &&
        Objects.equals(this.deniedClient, addLdapConnectionHandlerRequest.deniedClient)&&
        Objects.equals(this.additionalProperties, addLdapConnectionHandlerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(handlerName, description, schemas, listenAddress, listenPort, useSSL, allowStartTLS, sslCertNickname, keyManagerProvider, trustManagerProvider, allowLDAPV2, useTCPKeepAlive, sendRejectionNotice, failedBindResponseDelay, maxRequestSize, maxCancelHandlers, numAcceptHandlers, numRequestHandlers, requestHandlerPerConnection, sslClientAuthPolicy, acceptBacklog, sslProtocol, sslCipherSuite, maxBlockedWriteTimeLimit, autoAuthenticateUsingClientCertificate, closeConnectionsWhenUnavailable, closeConnectionsOnExplicitGC, enabled, allowedClient, deniedClient, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddLdapConnectionHandlerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddLdapConnectionHandlerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddLdapConnectionHandlerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddLdapConnectionHandlerRequest is not found in the empty JSON string", AddLdapConnectionHandlerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddLdapConnectionHandlerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddLdapConnectionHandlerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddLdapConnectionHandlerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddLdapConnectionHandlerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddLdapConnectionHandlerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddLdapConnectionHandlerRequest>() {
           @Override
           public void write(JsonWriter out, AddLdapConnectionHandlerRequest value) throws IOException {
           ...
           @Override
           public AddLdapConnectionHandlerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddLdapConnectionHandlerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddLdapConnectionHandlerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddLdapConnectionHandlerRequest
  * @throws IOException if the JSON string is invalid with respect to AddLdapConnectionHandlerRequest
  */
  public static AddLdapConnectionHandlerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddLdapConnectionHandlerRequest.class);
  }

 /**
  * Convert an instance of AddLdapConnectionHandlerRequest to an JSON string
  *
  * @return JSON string
  */
