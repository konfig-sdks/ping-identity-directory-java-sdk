...
public class JwtAccessTokenValidatorShared {
  ...
  public JwtAccessTokenValidatorShared() {
  }

  public JwtAccessTokenValidatorShared description(String description) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared schemas(List<EnumjwtAccessTokenValidatorSchemaUrn> schemas) {
  ...
  public JwtAccessTokenValidatorShared addSchemasItem(EnumjwtAccessTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared allowedSigningAlgorithm(List<EnumaccessTokenValidatorAllowedSigningAlgorithmProp> allowedSigningAlgorithm) {
  ...
  public JwtAccessTokenValidatorShared addAllowedSigningAlgorithmItem(EnumaccessTokenValidatorAllowedSigningAlgorithmProp allowedSigningAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared signingCertificate(List<String> signingCertificate) {
  ...
  public JwtAccessTokenValidatorShared addSigningCertificateItem(String signingCertificateItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared jwksEndpointPath(String jwksEndpointPath) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared encryptionKeyPair(String encryptionKeyPair) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared allowedKeyEncryptionAlgorithm(List<EnumaccessTokenValidatorAllowedKeyEncryptionAlgorithmProp> allowedKeyEncryptionAlgorithm) {
  ...
  public JwtAccessTokenValidatorShared addAllowedKeyEncryptionAlgorithmItem(EnumaccessTokenValidatorAllowedKeyEncryptionAlgorithmProp allowedKeyEncryptionAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared allowedContentEncryptionAlgorithm(List<EnumaccessTokenValidatorAllowedContentEncryptionAlgorithmProp> allowedContentEncryptionAlgorithm) {
  ...
  public JwtAccessTokenValidatorShared addAllowedContentEncryptionAlgorithmItem(EnumaccessTokenValidatorAllowedContentEncryptionAlgorithmProp allowedContentEncryptionAlgorithmItem) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared clientIDClaimName(String clientIDClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared scopeClaimName(String scopeClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared authorizationServer(String authorizationServer) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared identityMapper(String identityMapper) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public JwtAccessTokenValidatorShared enabled(Boolean enabled) {
  ...
  **/
   ...
   * @return the JwtAccessTokenValidatorShared instance itself
   */
  public JwtAccessTokenValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JwtAccessTokenValidatorShared jwtAccessTokenValidatorShared = (JwtAccessTokenValidatorShared) o;
    return Objects.equals(this.description, jwtAccessTokenValidatorShared.description) &&
        Objects.equals(this.schemas, jwtAccessTokenValidatorShared.schemas) &&
        Objects.equals(this.allowedSigningAlgorithm, jwtAccessTokenValidatorShared.allowedSigningAlgorithm) &&
        Objects.equals(this.signingCertificate, jwtAccessTokenValidatorShared.signingCertificate) &&
        Objects.equals(this.jwksEndpointPath, jwtAccessTokenValidatorShared.jwksEndpointPath) &&
        Objects.equals(this.encryptionKeyPair, jwtAccessTokenValidatorShared.encryptionKeyPair) &&
        Objects.equals(this.allowedKeyEncryptionAlgorithm, jwtAccessTokenValidatorShared.allowedKeyEncryptionAlgorithm) &&
        Objects.equals(this.allowedContentEncryptionAlgorithm, jwtAccessTokenValidatorShared.allowedContentEncryptionAlgorithm) &&
        Objects.equals(this.clockSkewGracePeriod, jwtAccessTokenValidatorShared.clockSkewGracePeriod) &&
        Objects.equals(this.clientIDClaimName, jwtAccessTokenValidatorShared.clientIDClaimName) &&
        Objects.equals(this.scopeClaimName, jwtAccessTokenValidatorShared.scopeClaimName) &&
        Objects.equals(this.evaluationOrderIndex, jwtAccessTokenValidatorShared.evaluationOrderIndex) &&
        Objects.equals(this.authorizationServer, jwtAccessTokenValidatorShared.authorizationServer) &&
        Objects.equals(this.identityMapper, jwtAccessTokenValidatorShared.identityMapper) &&
        Objects.equals(this.subjectClaimName, jwtAccessTokenValidatorShared.subjectClaimName) &&
        Objects.equals(this.enabled, jwtAccessTokenValidatorShared.enabled)&&
        Objects.equals(this.additionalProperties, jwtAccessTokenValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, allowedSigningAlgorithm, signingCertificate, jwksEndpointPath, encryptionKeyPair, allowedKeyEncryptionAlgorithm, allowedContentEncryptionAlgorithm, clockSkewGracePeriod, clientIDClaimName, scopeClaimName, evaluationOrderIndex, authorizationServer, identityMapper, subjectClaimName, enabled, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JwtAccessTokenValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JwtAccessTokenValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JwtAccessTokenValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JwtAccessTokenValidatorShared is not found in the empty JSON string", JwtAccessTokenValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JwtAccessTokenValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JwtAccessTokenValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JwtAccessTokenValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JwtAccessTokenValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JwtAccessTokenValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JwtAccessTokenValidatorShared>() {
           @Override
           public void write(JsonWriter out, JwtAccessTokenValidatorShared value) throws IOException {
           ...
           @Override
           public JwtAccessTokenValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JwtAccessTokenValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JwtAccessTokenValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JwtAccessTokenValidatorShared
  * @throws IOException if the JSON string is invalid with respect to JwtAccessTokenValidatorShared
  */
  public static JwtAccessTokenValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JwtAccessTokenValidatorShared.class);
  }

 /**
  * Convert an instance of JwtAccessTokenValidatorShared to an JSON string
  *
  * @return JSON string
  */
