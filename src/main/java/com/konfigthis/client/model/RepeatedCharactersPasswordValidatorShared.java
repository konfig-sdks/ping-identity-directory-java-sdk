...
public class RepeatedCharactersPasswordValidatorShared {
  ...
  public RepeatedCharactersPasswordValidatorShared() {
  }

  public RepeatedCharactersPasswordValidatorShared description(String description) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared schemas(List<EnumrepeatedCharactersPasswordValidatorSchemaUrn> schemas) {
  ...
  public RepeatedCharactersPasswordValidatorShared addSchemasItem(EnumrepeatedCharactersPasswordValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared maxConsecutiveLength(Integer maxConsecutiveLength) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared caseSensitiveValidation(Boolean caseSensitiveValidation) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared characterSet(List<String> characterSet) {
  ...
  public RepeatedCharactersPasswordValidatorShared addCharacterSetItem(String characterSetItem) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared validatorRequirementDescription(String validatorRequirementDescription) {
  ...
  **/
  ...
  public RepeatedCharactersPasswordValidatorShared validatorFailureMessage(String validatorFailureMessage) {
  ...
  **/
   ...
   * @return the RepeatedCharactersPasswordValidatorShared instance itself
   */
  public RepeatedCharactersPasswordValidatorShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RepeatedCharactersPasswordValidatorShared repeatedCharactersPasswordValidatorShared = (RepeatedCharactersPasswordValidatorShared) o;
    return Objects.equals(this.description, repeatedCharactersPasswordValidatorShared.description) &&
        Objects.equals(this.schemas, repeatedCharactersPasswordValidatorShared.schemas) &&
        Objects.equals(this.maxConsecutiveLength, repeatedCharactersPasswordValidatorShared.maxConsecutiveLength) &&
        Objects.equals(this.caseSensitiveValidation, repeatedCharactersPasswordValidatorShared.caseSensitiveValidation) &&
        Objects.equals(this.characterSet, repeatedCharactersPasswordValidatorShared.characterSet) &&
        Objects.equals(this.enabled, repeatedCharactersPasswordValidatorShared.enabled) &&
        Objects.equals(this.validatorRequirementDescription, repeatedCharactersPasswordValidatorShared.validatorRequirementDescription) &&
        Objects.equals(this.validatorFailureMessage, repeatedCharactersPasswordValidatorShared.validatorFailureMessage)&&
        Objects.equals(this.additionalProperties, repeatedCharactersPasswordValidatorShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, maxConsecutiveLength, caseSensitiveValidation, characterSet, enabled, validatorRequirementDescription, validatorFailureMessage, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RepeatedCharactersPasswordValidatorShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RepeatedCharactersPasswordValidatorShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RepeatedCharactersPasswordValidatorShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RepeatedCharactersPasswordValidatorShared is not found in the empty JSON string", RepeatedCharactersPasswordValidatorShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RepeatedCharactersPasswordValidatorShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RepeatedCharactersPasswordValidatorShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RepeatedCharactersPasswordValidatorShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RepeatedCharactersPasswordValidatorShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RepeatedCharactersPasswordValidatorShared.class));

       return (TypeAdapter<T>) new TypeAdapter<RepeatedCharactersPasswordValidatorShared>() {
           @Override
           public void write(JsonWriter out, RepeatedCharactersPasswordValidatorShared value) throws IOException {
           ...
           @Override
           public RepeatedCharactersPasswordValidatorShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RepeatedCharactersPasswordValidatorShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RepeatedCharactersPasswordValidatorShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RepeatedCharactersPasswordValidatorShared
  * @throws IOException if the JSON string is invalid with respect to RepeatedCharactersPasswordValidatorShared
  */
  public static RepeatedCharactersPasswordValidatorShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RepeatedCharactersPasswordValidatorShared.class);
  }

 /**
  * Convert an instance of RepeatedCharactersPasswordValidatorShared to an JSON string
  *
  * @return JSON string
  */
