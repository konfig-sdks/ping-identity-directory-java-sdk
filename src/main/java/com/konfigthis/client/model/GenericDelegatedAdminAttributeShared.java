...
public class GenericDelegatedAdminAttributeShared {
  ...
  public GenericDelegatedAdminAttributeShared() {
  }

  public GenericDelegatedAdminAttributeShared description(String description) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared schemas(List<EnumgenericDelegatedAdminAttributeSchemaUrn> schemas) {
  ...
  public GenericDelegatedAdminAttributeShared addSchemasItem(EnumgenericDelegatedAdminAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared attributeType(String attributeType) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared displayName(String displayName) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared mutability(EnumdelegatedAdminAttributeMutabilityProp mutability) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared multiValued(Boolean multiValued) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared includeInSummary(Boolean includeInSummary) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared attributeCategory(String attributeCategory) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared displayOrderIndex(Integer displayOrderIndex) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared referenceResourceType(String referenceResourceType) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared attributePresentation(EnumdelegatedAdminAttributeAttributePresentationProp attributePresentation) {
  ...
  **/
  ...
  public GenericDelegatedAdminAttributeShared dateTimeFormat(String dateTimeFormat) {
  ...
  **/
   ...
   * @return the GenericDelegatedAdminAttributeShared instance itself
   */
  public GenericDelegatedAdminAttributeShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    GenericDelegatedAdminAttributeShared genericDelegatedAdminAttributeShared = (GenericDelegatedAdminAttributeShared) o;
    return Objects.equals(this.description, genericDelegatedAdminAttributeShared.description) &&
        Objects.equals(this.schemas, genericDelegatedAdminAttributeShared.schemas) &&
        Objects.equals(this.attributeType, genericDelegatedAdminAttributeShared.attributeType) &&
        Objects.equals(this.displayName, genericDelegatedAdminAttributeShared.displayName) &&
        Objects.equals(this.mutability, genericDelegatedAdminAttributeShared.mutability) &&
        Objects.equals(this.multiValued, genericDelegatedAdminAttributeShared.multiValued) &&
        Objects.equals(this.includeInSummary, genericDelegatedAdminAttributeShared.includeInSummary) &&
        Objects.equals(this.attributeCategory, genericDelegatedAdminAttributeShared.attributeCategory) &&
        Objects.equals(this.displayOrderIndex, genericDelegatedAdminAttributeShared.displayOrderIndex) &&
        Objects.equals(this.referenceResourceType, genericDelegatedAdminAttributeShared.referenceResourceType) &&
        Objects.equals(this.attributePresentation, genericDelegatedAdminAttributeShared.attributePresentation) &&
        Objects.equals(this.dateTimeFormat, genericDelegatedAdminAttributeShared.dateTimeFormat)&&
        Objects.equals(this.additionalProperties, genericDelegatedAdminAttributeShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, attributeType, displayName, mutability, multiValued, includeInSummary, attributeCategory, displayOrderIndex, referenceResourceType, attributePresentation, dateTimeFormat, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class GenericDelegatedAdminAttributeShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to GenericDelegatedAdminAttributeShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GenericDelegatedAdminAttributeShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GenericDelegatedAdminAttributeShared is not found in the empty JSON string", GenericDelegatedAdminAttributeShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : GenericDelegatedAdminAttributeShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenericDelegatedAdminAttributeShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenericDelegatedAdminAttributeShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenericDelegatedAdminAttributeShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenericDelegatedAdminAttributeShared.class));

       return (TypeAdapter<T>) new TypeAdapter<GenericDelegatedAdminAttributeShared>() {
           @Override
           public void write(JsonWriter out, GenericDelegatedAdminAttributeShared value) throws IOException {
           ...
           @Override
           public GenericDelegatedAdminAttributeShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GenericDelegatedAdminAttributeShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GenericDelegatedAdminAttributeShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GenericDelegatedAdminAttributeShared
  * @throws IOException if the JSON string is invalid with respect to GenericDelegatedAdminAttributeShared
  */
  public static GenericDelegatedAdminAttributeShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenericDelegatedAdminAttributeShared.class);
  }

 /**
  * Convert an instance of GenericDelegatedAdminAttributeShared to an JSON string
  *
  * @return JSON string
  */
