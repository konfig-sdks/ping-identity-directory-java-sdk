...
import com.konfigthis.client.model.EnumentryUuidVirtualAttributeSchemaUrn;
...
public class EntryUuidVirtualAttributeResponse {
  ...
  private List<EnumentryUuidVirtualAttributeSchemaUrn> schemas = new ArrayList<>();
  ...
  public EntryUuidVirtualAttributeResponse() {
  }

  public EntryUuidVirtualAttributeResponse description(String description) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse schemas(List<EnumentryUuidVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryUuidVirtualAttributeResponse addSchemasItem(EnumentryUuidVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnumentryUuidVirtualAttributeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnumentryUuidVirtualAttributeSchemaUrn> schemas) {
  ...
  public EntryUuidVirtualAttributeResponse id(String id) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse attributeType(String attributeType) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse baseDN(List<String> baseDN) {
  ...
  public EntryUuidVirtualAttributeResponse addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse groupDN(List<String> groupDN) {
  ...
  public EntryUuidVirtualAttributeResponse addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse filter(List<String> filter) {
  ...
  public EntryUuidVirtualAttributeResponse addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public EntryUuidVirtualAttributeResponse addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public EntryUuidVirtualAttributeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the EntryUuidVirtualAttributeResponse instance itself
   */
  public EntryUuidVirtualAttributeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EntryUuidVirtualAttributeResponse entryUuidVirtualAttributeResponse = (EntryUuidVirtualAttributeResponse) o;
    return Objects.equals(this.description, entryUuidVirtualAttributeResponse.description) &&
        Objects.equals(this.schemas, entryUuidVirtualAttributeResponse.schemas) &&
        Objects.equals(this.id, entryUuidVirtualAttributeResponse.id) &&
        Objects.equals(this.conflictBehavior, entryUuidVirtualAttributeResponse.conflictBehavior) &&
        Objects.equals(this.attributeType, entryUuidVirtualAttributeResponse.attributeType) &&
        Objects.equals(this.allowIndexConflicts, entryUuidVirtualAttributeResponse.allowIndexConflicts) &&
        Objects.equals(this.enabled, entryUuidVirtualAttributeResponse.enabled) &&
        Objects.equals(this.baseDN, entryUuidVirtualAttributeResponse.baseDN) &&
        Objects.equals(this.groupDN, entryUuidVirtualAttributeResponse.groupDN) &&
        Objects.equals(this.filter, entryUuidVirtualAttributeResponse.filter) &&
        Objects.equals(this.clientConnectionPolicy, entryUuidVirtualAttributeResponse.clientConnectionPolicy) &&
        Objects.equals(this.requireExplicitRequestByName, entryUuidVirtualAttributeResponse.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, entryUuidVirtualAttributeResponse.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, entryUuidVirtualAttributeResponse.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.meta, entryUuidVirtualAttributeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, entryUuidVirtualAttributeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, entryUuidVirtualAttributeResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, conflictBehavior, attributeType, allowIndexConflicts, enabled, baseDN, groupDN, filter, clientConnectionPolicy, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EntryUuidVirtualAttributeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EntryUuidVirtualAttributeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EntryUuidVirtualAttributeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EntryUuidVirtualAttributeResponse is not found in the empty JSON string", EntryUuidVirtualAttributeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : EntryUuidVirtualAttributeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EntryUuidVirtualAttributeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EntryUuidVirtualAttributeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EntryUuidVirtualAttributeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EntryUuidVirtualAttributeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EntryUuidVirtualAttributeResponse>() {
           @Override
           public void write(JsonWriter out, EntryUuidVirtualAttributeResponse value) throws IOException {
           ...
           @Override
           public EntryUuidVirtualAttributeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EntryUuidVirtualAttributeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EntryUuidVirtualAttributeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EntryUuidVirtualAttributeResponse
  * @throws IOException if the JSON string is invalid with respect to EntryUuidVirtualAttributeResponse
  */
  public static EntryUuidVirtualAttributeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EntryUuidVirtualAttributeResponse.class);
  }

 /**
  * Convert an instance of EntryUuidVirtualAttributeResponse to an JSON string
  *
  * @return JSON string
  */
