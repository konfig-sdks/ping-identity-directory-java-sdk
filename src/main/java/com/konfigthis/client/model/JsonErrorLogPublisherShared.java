...
public class JsonErrorLogPublisherShared {
  ...
  public JsonErrorLogPublisherShared() {
  }

  public JsonErrorLogPublisherShared description(String description) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared schemas(List<EnumjsonErrorLogPublisherSchemaUrn> schemas) {
  ...
  public JsonErrorLogPublisherShared addSchemasItem(EnumjsonErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public JsonErrorLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public JsonErrorLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public JsonErrorLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared writeMultiLineMessages(Boolean writeMultiLineMessages) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public JsonErrorLogPublisherShared addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared overrideSeverity(List<String> overrideSeverity) {
  ...
  public JsonErrorLogPublisherShared addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public JsonErrorLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the JsonErrorLogPublisherShared instance itself
   */
  public JsonErrorLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JsonErrorLogPublisherShared jsonErrorLogPublisherShared = (JsonErrorLogPublisherShared) o;
    return Objects.equals(this.description, jsonErrorLogPublisherShared.description) &&
        Objects.equals(this.schemas, jsonErrorLogPublisherShared.schemas) &&
        Objects.equals(this.logFile, jsonErrorLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, jsonErrorLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, jsonErrorLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, jsonErrorLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, jsonErrorLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, jsonErrorLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, jsonErrorLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, jsonErrorLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, jsonErrorLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, jsonErrorLogPublisherShared.append) &&
        Objects.equals(this.asynchronous, jsonErrorLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, jsonErrorLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, jsonErrorLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, jsonErrorLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, jsonErrorLogPublisherShared.timeInterval) &&
        Objects.equals(this.writeMultiLineMessages, jsonErrorLogPublisherShared.writeMultiLineMessages) &&
        Objects.equals(this.includeProductName, jsonErrorLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, jsonErrorLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, jsonErrorLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, jsonErrorLogPublisherShared.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, jsonErrorLogPublisherShared.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.defaultSeverity, jsonErrorLogPublisherShared.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, jsonErrorLogPublisherShared.overrideSeverity) &&
        Objects.equals(this.enabled, jsonErrorLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, jsonErrorLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, jsonErrorLogPublisherShared.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JsonErrorLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JsonErrorLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JsonErrorLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JsonErrorLogPublisherShared is not found in the empty JSON string", JsonErrorLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : JsonErrorLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JsonErrorLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JsonErrorLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JsonErrorLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JsonErrorLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<JsonErrorLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, JsonErrorLogPublisherShared value) throws IOException {
           ...
           @Override
           public JsonErrorLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JsonErrorLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JsonErrorLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JsonErrorLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to JsonErrorLogPublisherShared
  */
  public static JsonErrorLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JsonErrorLogPublisherShared.class);
  }

 /**
  * Convert an instance of JsonErrorLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
