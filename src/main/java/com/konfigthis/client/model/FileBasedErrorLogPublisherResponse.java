...
public class FileBasedErrorLogPublisherResponse {
  ...
  public FileBasedErrorLogPublisherResponse() {
  }

  public FileBasedErrorLogPublisherResponse id(String id) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse description(String description) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse schemas(List<EnumfileBasedErrorLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedErrorLogPublisherResponse addSchemasItem(EnumfileBasedErrorLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse logFilePermissions(String logFilePermissions) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The UNIX permissions of the log files created by this File Based Error Log Publisher.")
  ...
  public FileBasedErrorLogPublisherResponse rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedErrorLogPublisherResponse addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The rotation policy to use for the File Based Error Log Publisher .")
  ...
  public FileBasedErrorLogPublisherResponse rotationListener(List<String> rotationListener) {
  ...
  public FileBasedErrorLogPublisherResponse addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedErrorLogPublisherResponse addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The retention policy to use for the File Based Error Log Publisher .")
  ...
  public FileBasedErrorLogPublisherResponse compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse append(Boolean append) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse generifyMessageStringsWhenPossible(Boolean generifyMessageStringsWhenPossible) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse asynchronous(Boolean asynchronous) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether the File Based Error Log Publisher will publish records asynchronously.")
  ...
  public FileBasedErrorLogPublisherResponse autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse defaultSeverity(List<EnumlogPublisherDefaultSeverityProp> defaultSeverity) {
  ...
  public FileBasedErrorLogPublisherResponse addDefaultSeverityItem(EnumlogPublisherDefaultSeverityProp defaultSeverityItem) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse overrideSeverity(List<String> overrideSeverity) {
  ...
  public FileBasedErrorLogPublisherResponse addOverrideSeverityItem(String overrideSeverityItem) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FileBasedErrorLogPublisherResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FileBasedErrorLogPublisherResponse instance itself
   */
  public FileBasedErrorLogPublisherResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedErrorLogPublisherResponse fileBasedErrorLogPublisherResponse = (FileBasedErrorLogPublisherResponse) o;
    return Objects.equals(this.id, fileBasedErrorLogPublisherResponse.id) &&
        Objects.equals(this.description, fileBasedErrorLogPublisherResponse.description) &&
        Objects.equals(this.schemas, fileBasedErrorLogPublisherResponse.schemas) &&
        Objects.equals(this.logFile, fileBasedErrorLogPublisherResponse.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedErrorLogPublisherResponse.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedErrorLogPublisherResponse.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedErrorLogPublisherResponse.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedErrorLogPublisherResponse.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedErrorLogPublisherResponse.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedErrorLogPublisherResponse.signLog) &&
        Objects.equals(this.encryptLog, fileBasedErrorLogPublisherResponse.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedErrorLogPublisherResponse.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedErrorLogPublisherResponse.append) &&
        Objects.equals(this.includeProductName, fileBasedErrorLogPublisherResponse.includeProductName) &&
        Objects.equals(this.includeInstanceName, fileBasedErrorLogPublisherResponse.includeInstanceName) &&
        Objects.equals(this.includeStartupID, fileBasedErrorLogPublisherResponse.includeStartupID) &&
        Objects.equals(this.includeThreadID, fileBasedErrorLogPublisherResponse.includeThreadID) &&
        Objects.equals(this.generifyMessageStringsWhenPossible, fileBasedErrorLogPublisherResponse.generifyMessageStringsWhenPossible) &&
        Objects.equals(this.asynchronous, fileBasedErrorLogPublisherResponse.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedErrorLogPublisherResponse.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedErrorLogPublisherResponse.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedErrorLogPublisherResponse.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedErrorLogPublisherResponse.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedErrorLogPublisherResponse.timestampPrecision) &&
        Objects.equals(this.defaultSeverity, fileBasedErrorLogPublisherResponse.defaultSeverity) &&
        Objects.equals(this.overrideSeverity, fileBasedErrorLogPublisherResponse.overrideSeverity) &&
        Objects.equals(this.enabled, fileBasedErrorLogPublisherResponse.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedErrorLogPublisherResponse.loggingErrorBehavior) &&
        Objects.equals(this.meta, fileBasedErrorLogPublisherResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fileBasedErrorLogPublisherResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fileBasedErrorLogPublisherResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, includeProductName, includeInstanceName, includeStartupID, includeThreadID, generifyMessageStringsWhenPossible, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, defaultSeverity, overrideSeverity, enabled, loggingErrorBehavior, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedErrorLogPublisherResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedErrorLogPublisherResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedErrorLogPublisherResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedErrorLogPublisherResponse is not found in the empty JSON string", FileBasedErrorLogPublisherResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedErrorLogPublisherResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedErrorLogPublisherResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedErrorLogPublisherResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedErrorLogPublisherResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedErrorLogPublisherResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedErrorLogPublisherResponse>() {
           @Override
           public void write(JsonWriter out, FileBasedErrorLogPublisherResponse value) throws IOException {
           ...
           @Override
           public FileBasedErrorLogPublisherResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedErrorLogPublisherResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedErrorLogPublisherResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedErrorLogPublisherResponse
  * @throws IOException if the JSON string is invalid with respect to FileBasedErrorLogPublisherResponse
  */
  public static FileBasedErrorLogPublisherResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedErrorLogPublisherResponse.class);
  }

 /**
  * Convert an instance of FileBasedErrorLogPublisherResponse to an JSON string
  *
  * @return JSON string
  */
