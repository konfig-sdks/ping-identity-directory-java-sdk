...
public class FileBasedAuditLogPublisherShared {
  ...
  public FileBasedAuditLogPublisherShared() {
  }

  public FileBasedAuditLogPublisherShared description(String description) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared schemas(List<EnumfileBasedAuditLogPublisherSchemaUrn> schemas) {
  ...
  public FileBasedAuditLogPublisherShared addSchemasItem(EnumfileBasedAuditLogPublisherSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared suppressInternalOperations(Boolean suppressInternalOperations) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared logFile(String logFile) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared logFilePermissions(String logFilePermissions) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared rotationPolicy(List<String> rotationPolicy) {
  ...
  public FileBasedAuditLogPublisherShared addRotationPolicyItem(String rotationPolicyItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared rotationListener(List<String> rotationListener) {
  ...
  public FileBasedAuditLogPublisherShared addRotationListenerItem(String rotationListenerItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared retentionPolicy(List<String> retentionPolicy) {
  ...
  public FileBasedAuditLogPublisherShared addRetentionPolicyItem(String retentionPolicyItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared compressionMechanism(EnumlogPublisherCompressionMechanismProp compressionMechanism) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared signLog(Boolean signLog) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared encryptLog(Boolean encryptLog) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared encryptionSettingsDefinitionID(String encryptionSettingsDefinitionID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared append(Boolean append) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeProductName(Boolean includeProductName) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeInstanceName(Boolean includeInstanceName) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeStartupID(Boolean includeStartupID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeThreadID(Boolean includeThreadID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeRequesterIPAddress(Boolean includeRequesterIPAddress) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeRequesterDN(Boolean includeRequesterDN) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeReplicationChangeID(Boolean includeReplicationChangeID) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared useReversibleForm(Boolean useReversibleForm) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared softDeleteEntryAuditBehavior(EnumlogPublisherFileBasedAuditSoftDeleteEntryAuditBehaviorProp softDeleteEntryAuditBehavior) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeRequestControls(Boolean includeRequestControls) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeOperationPurposeRequestControl(Boolean includeOperationPurposeRequestControl) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared includeIntermediateClientRequestControl(Boolean includeIntermediateClientRequestControl) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared obscureAttribute(List<String> obscureAttribute) {
  ...
  public FileBasedAuditLogPublisherShared addObscureAttributeItem(String obscureAttributeItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared excludeAttribute(List<String> excludeAttribute) {
  ...
  public FileBasedAuditLogPublisherShared addExcludeAttributeItem(String excludeAttributeItem) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared asynchronous(Boolean asynchronous) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared autoFlush(Boolean autoFlush) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared bufferSize(String bufferSize) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared queueSize(Integer queueSize) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared timeInterval(String timeInterval) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared timestampPrecision(EnumlogPublisherTimestampPrecisionProp timestampPrecision) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared logSecurityNegotiation(Boolean logSecurityNegotiation) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared logIntermediateResponses(Boolean logIntermediateResponses) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared suppressReplicationOperations(Boolean suppressReplicationOperations) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared connectionCriteria(String connectionCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared requestCriteria(String requestCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared resultCriteria(String resultCriteria) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared enabled(Boolean enabled) {
  ...
  **/
  ...
  public FileBasedAuditLogPublisherShared loggingErrorBehavior(EnumlogPublisherLoggingErrorBehaviorProp loggingErrorBehavior) {
  ...
  **/
   ...
   * @return the FileBasedAuditLogPublisherShared instance itself
   */
  public FileBasedAuditLogPublisherShared putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FileBasedAuditLogPublisherShared fileBasedAuditLogPublisherShared = (FileBasedAuditLogPublisherShared) o;
    return Objects.equals(this.description, fileBasedAuditLogPublisherShared.description) &&
        Objects.equals(this.schemas, fileBasedAuditLogPublisherShared.schemas) &&
        Objects.equals(this.suppressInternalOperations, fileBasedAuditLogPublisherShared.suppressInternalOperations) &&
        Objects.equals(this.logFile, fileBasedAuditLogPublisherShared.logFile) &&
        Objects.equals(this.logFilePermissions, fileBasedAuditLogPublisherShared.logFilePermissions) &&
        Objects.equals(this.rotationPolicy, fileBasedAuditLogPublisherShared.rotationPolicy) &&
        Objects.equals(this.rotationListener, fileBasedAuditLogPublisherShared.rotationListener) &&
        Objects.equals(this.retentionPolicy, fileBasedAuditLogPublisherShared.retentionPolicy) &&
        Objects.equals(this.compressionMechanism, fileBasedAuditLogPublisherShared.compressionMechanism) &&
        Objects.equals(this.signLog, fileBasedAuditLogPublisherShared.signLog) &&
        Objects.equals(this.encryptLog, fileBasedAuditLogPublisherShared.encryptLog) &&
        Objects.equals(this.encryptionSettingsDefinitionID, fileBasedAuditLogPublisherShared.encryptionSettingsDefinitionID) &&
        Objects.equals(this.append, fileBasedAuditLogPublisherShared.append) &&
        Objects.equals(this.includeProductName, fileBasedAuditLogPublisherShared.includeProductName) &&
        Objects.equals(this.includeInstanceName, fileBasedAuditLogPublisherShared.includeInstanceName) &&
        Objects.equals(this.includeStartupID, fileBasedAuditLogPublisherShared.includeStartupID) &&
        Objects.equals(this.includeThreadID, fileBasedAuditLogPublisherShared.includeThreadID) &&
        Objects.equals(this.includeRequesterIPAddress, fileBasedAuditLogPublisherShared.includeRequesterIPAddress) &&
        Objects.equals(this.includeRequesterDN, fileBasedAuditLogPublisherShared.includeRequesterDN) &&
        Objects.equals(this.includeReplicationChangeID, fileBasedAuditLogPublisherShared.includeReplicationChangeID) &&
        Objects.equals(this.useReversibleForm, fileBasedAuditLogPublisherShared.useReversibleForm) &&
        Objects.equals(this.softDeleteEntryAuditBehavior, fileBasedAuditLogPublisherShared.softDeleteEntryAuditBehavior) &&
        Objects.equals(this.includeRequestControls, fileBasedAuditLogPublisherShared.includeRequestControls) &&
        Objects.equals(this.includeOperationPurposeRequestControl, fileBasedAuditLogPublisherShared.includeOperationPurposeRequestControl) &&
        Objects.equals(this.includeIntermediateClientRequestControl, fileBasedAuditLogPublisherShared.includeIntermediateClientRequestControl) &&
        Objects.equals(this.obscureAttribute, fileBasedAuditLogPublisherShared.obscureAttribute) &&
        Objects.equals(this.excludeAttribute, fileBasedAuditLogPublisherShared.excludeAttribute) &&
        Objects.equals(this.asynchronous, fileBasedAuditLogPublisherShared.asynchronous) &&
        Objects.equals(this.autoFlush, fileBasedAuditLogPublisherShared.autoFlush) &&
        Objects.equals(this.bufferSize, fileBasedAuditLogPublisherShared.bufferSize) &&
        Objects.equals(this.queueSize, fileBasedAuditLogPublisherShared.queueSize) &&
        Objects.equals(this.timeInterval, fileBasedAuditLogPublisherShared.timeInterval) &&
        Objects.equals(this.timestampPrecision, fileBasedAuditLogPublisherShared.timestampPrecision) &&
        Objects.equals(this.logSecurityNegotiation, fileBasedAuditLogPublisherShared.logSecurityNegotiation) &&
        Objects.equals(this.logIntermediateResponses, fileBasedAuditLogPublisherShared.logIntermediateResponses) &&
        Objects.equals(this.suppressReplicationOperations, fileBasedAuditLogPublisherShared.suppressReplicationOperations) &&
        Objects.equals(this.connectionCriteria, fileBasedAuditLogPublisherShared.connectionCriteria) &&
        Objects.equals(this.requestCriteria, fileBasedAuditLogPublisherShared.requestCriteria) &&
        Objects.equals(this.resultCriteria, fileBasedAuditLogPublisherShared.resultCriteria) &&
        Objects.equals(this.enabled, fileBasedAuditLogPublisherShared.enabled) &&
        Objects.equals(this.loggingErrorBehavior, fileBasedAuditLogPublisherShared.loggingErrorBehavior)&&
        Objects.equals(this.additionalProperties, fileBasedAuditLogPublisherShared.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, suppressInternalOperations, logFile, logFilePermissions, rotationPolicy, rotationListener, retentionPolicy, compressionMechanism, signLog, encryptLog, encryptionSettingsDefinitionID, append, includeProductName, includeInstanceName, includeStartupID, includeThreadID, includeRequesterIPAddress, includeRequesterDN, includeReplicationChangeID, useReversibleForm, softDeleteEntryAuditBehavior, includeRequestControls, includeOperationPurposeRequestControl, includeIntermediateClientRequestControl, obscureAttribute, excludeAttribute, asynchronous, autoFlush, bufferSize, queueSize, timeInterval, timestampPrecision, logSecurityNegotiation, logIntermediateResponses, suppressReplicationOperations, connectionCriteria, requestCriteria, resultCriteria, enabled, loggingErrorBehavior, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FileBasedAuditLogPublisherShared {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileBasedAuditLogPublisherShared
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FileBasedAuditLogPublisherShared.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FileBasedAuditLogPublisherShared is not found in the empty JSON string", FileBasedAuditLogPublisherShared.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FileBasedAuditLogPublisherShared.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FileBasedAuditLogPublisherShared.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FileBasedAuditLogPublisherShared' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FileBasedAuditLogPublisherShared> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FileBasedAuditLogPublisherShared.class));

       return (TypeAdapter<T>) new TypeAdapter<FileBasedAuditLogPublisherShared>() {
           @Override
           public void write(JsonWriter out, FileBasedAuditLogPublisherShared value) throws IOException {
           ...
           @Override
           public FileBasedAuditLogPublisherShared read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FileBasedAuditLogPublisherShared instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FileBasedAuditLogPublisherShared given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FileBasedAuditLogPublisherShared
  * @throws IOException if the JSON string is invalid with respect to FileBasedAuditLogPublisherShared
  */
  public static FileBasedAuditLogPublisherShared fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FileBasedAuditLogPublisherShared.class);
  }

 /**
  * Convert an instance of FileBasedAuditLogPublisherShared to an JSON string
  *
  * @return JSON string
  */
