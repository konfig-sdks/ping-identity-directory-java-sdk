...
public class AlarmBackendResponseAllOf {
  ...
  private List<EnumalarmBackendSchemaUrn> schemas = null;
  ...
  public AlarmBackendResponseAllOf() {
  }

  public AlarmBackendResponseAllOf description(String description) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf schemas(List<EnumalarmBackendSchemaUrn> schemas) {
  ...
  public AlarmBackendResponseAllOf addSchemasItem(EnumalarmBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf id(String id) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf backendID(String backendID) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf baseDN(List<String> baseDN) {
  ...
  public AlarmBackendResponseAllOf addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf ldifFile(String ldifFile) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf alarmRetentionTime(String alarmRetentionTime) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Specifies the maximum length of time that information about raised alarms should be maintained before they will be purged.")
  ...
  public AlarmBackendResponseAllOf maxAlarms(Integer maxAlarms) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf enabled(Boolean enabled) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public AlarmBackendResponseAllOf notificationManager(String notificationManager) {
  ...
  **/
   ...
   * @return the AlarmBackendResponseAllOf instance itself
   */
  public AlarmBackendResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AlarmBackendResponseAllOf alarmBackendResponseAllOf = (AlarmBackendResponseAllOf) o;
    return Objects.equals(this.description, alarmBackendResponseAllOf.description) &&
        Objects.equals(this.schemas, alarmBackendResponseAllOf.schemas) &&
        Objects.equals(this.id, alarmBackendResponseAllOf.id) &&
        Objects.equals(this.backendID, alarmBackendResponseAllOf.backendID) &&
        Objects.equals(this.baseDN, alarmBackendResponseAllOf.baseDN) &&
        Objects.equals(this.ldifFile, alarmBackendResponseAllOf.ldifFile) &&
        Objects.equals(this.alarmRetentionTime, alarmBackendResponseAllOf.alarmRetentionTime) &&
        Objects.equals(this.maxAlarms, alarmBackendResponseAllOf.maxAlarms) &&
        Objects.equals(this.writabilityMode, alarmBackendResponseAllOf.writabilityMode) &&
        Objects.equals(this.enabled, alarmBackendResponseAllOf.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, alarmBackendResponseAllOf.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, alarmBackendResponseAllOf.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, alarmBackendResponseAllOf.backupFilePermissions) &&
        Objects.equals(this.notificationManager, alarmBackendResponseAllOf.notificationManager)&&
        Objects.equals(this.additionalProperties, alarmBackendResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, backendID, baseDN, ldifFile, alarmRetentionTime, maxAlarms, writabilityMode, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AlarmBackendResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AlarmBackendResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AlarmBackendResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AlarmBackendResponseAllOf is not found in the empty JSON string", AlarmBackendResponseAllOf.openapiRequiredFields.toString()));
        }
      }
      ...
      if ((jsonObj.get("alarmRetentionTime") != null && !jsonObj.get("alarmRetentionTime").isJsonNull()) && !jsonObj.get("alarmRetentionTime").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AlarmBackendResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AlarmBackendResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AlarmBackendResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AlarmBackendResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<AlarmBackendResponseAllOf>() {
           @Override
           public void write(JsonWriter out, AlarmBackendResponseAllOf value) throws IOException {
           ...
           @Override
           public AlarmBackendResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AlarmBackendResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AlarmBackendResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AlarmBackendResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to AlarmBackendResponseAllOf
  */
  public static AlarmBackendResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AlarmBackendResponseAllOf.class);
  }

 /**
  * Convert an instance of AlarmBackendResponseAllOf to an JSON string
  *
  * @return JSON string
  */
