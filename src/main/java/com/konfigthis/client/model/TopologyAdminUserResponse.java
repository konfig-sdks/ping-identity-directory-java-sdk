...
public class TopologyAdminUserResponse {
  ...
  public TopologyAdminUserResponse() {
  }

  public TopologyAdminUserResponse id(String id) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the Topology Admin User")
  ...
  public TopologyAdminUserResponse description(String description) {
  ...
  **/
  ...
  public TopologyAdminUserResponse schemas(List<EnumtopologyAdminUserSchemaUrn> schemas) {
  ...
  public TopologyAdminUserResponse addSchemasItem(EnumtopologyAdminUserSchemaUrn schemasItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse alternateBindDN(List<String> alternateBindDN) {
  ...
  public TopologyAdminUserResponse addAlternateBindDNItem(String alternateBindDNItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse password(String password) {
  ...
  **/
  ...
  public TopologyAdminUserResponse firstName(List<String> firstName) {
  ...
  public TopologyAdminUserResponse addFirstNameItem(String firstNameItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse lastName(List<String> lastName) {
  ...
  public TopologyAdminUserResponse addLastNameItem(String lastNameItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse userID(String userID) {
  ...
  **/
  ...
  public TopologyAdminUserResponse emailAddress(List<String> emailAddress) {
  ...
  public TopologyAdminUserResponse addEmailAddressItem(String emailAddressItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse workTelephoneNumber(List<String> workTelephoneNumber) {
  ...
  public TopologyAdminUserResponse addWorkTelephoneNumberItem(String workTelephoneNumberItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse homeTelephoneNumber(List<String> homeTelephoneNumber) {
  ...
  public TopologyAdminUserResponse addHomeTelephoneNumberItem(String homeTelephoneNumberItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse mobileTelephoneNumber(List<String> mobileTelephoneNumber) {
  ...
  public TopologyAdminUserResponse addMobileTelephoneNumberItem(String mobileTelephoneNumberItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse pagerTelephoneNumber(List<String> pagerTelephoneNumber) {
  ...
  public TopologyAdminUserResponse addPagerTelephoneNumberItem(String pagerTelephoneNumberItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse inheritDefaultRootPrivileges(Boolean inheritDefaultRootPrivileges) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether this User should be automatically granted the set of privileges defined in the default-root-privilege-name property of the Root DN configuration object.")
  ...
  public TopologyAdminUserResponse privilege(List<EnumtopologyAdminUserPrivilegeProp> privilege) {
  ...
  public TopologyAdminUserResponse addPrivilegeItem(EnumtopologyAdminUserPrivilegeProp privilegeItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse searchResultEntryLimit(Integer searchResultEntryLimit) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the maximum number of entries that the server may return to the user in response to any single search request. A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-size-limit LDAP attribute.")
  ...
  public TopologyAdminUserResponse timeLimitSeconds(Integer timeLimitSeconds) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the maximum length of time (in seconds) that the server may spend processing any single search request. A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-time-limit LDAP attribute.")
  ...
  public TopologyAdminUserResponse lookThroughEntryLimit(Integer lookThroughEntryLimit) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the maximum number of candidate entries that the server may examine in the course of processing any single search request. A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-lookthrough-limit LDAP attribute.")
  ...
  public TopologyAdminUserResponse idleTimeLimitSeconds(Integer idleTimeLimitSeconds) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the maximum length of time (in seconds) that a connection authenticated as this user may remain established without issuing any requests. A value of 0 indicates no limit should be enforced. This is stored in the ds-rlim-idle-time-limit LDAP attribute.")
  ...
  public TopologyAdminUserResponse passwordPolicy(String passwordPolicy) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the password policy for the user. This is stored in the ds-pwp-password-policy-dn LDAP attribute.")
  ...
  public TopologyAdminUserResponse disabled(Boolean disabled) {
  ...
  **/
  ...
  public TopologyAdminUserResponse accountActivationTime(String accountActivationTime) {
  ...
  **/
  ...
  public TopologyAdminUserResponse accountExpirationTime(String accountExpirationTime) {
  ...
  **/
  ...
  public TopologyAdminUserResponse requireSecureAuthentication(Boolean requireSecureAuthentication) {
  ...
  **/
  ...
  public TopologyAdminUserResponse requireSecureConnections(Boolean requireSecureConnections) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Indicates whether this User must be required to communicate with the server over a secure connection. When set to \"true\", the User will only be allowed to communicate with the server over a secure connection (i.e., using TLS or the StartTLS extended operation).")
  ...
  public TopologyAdminUserResponse allowedAuthenticationType(List<String> allowedAuthenticationType) {
  ...
  public TopologyAdminUserResponse addAllowedAuthenticationTypeItem(String allowedAuthenticationTypeItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse allowedAuthenticationIPAddress(List<String> allowedAuthenticationIPAddress) {
  ...
  public TopologyAdminUserResponse addAllowedAuthenticationIPAddressItem(String allowedAuthenticationIPAddressItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse preferredOTPDeliveryMechanism(List<String> preferredOTPDeliveryMechanism) {
  ...
  public TopologyAdminUserResponse addPreferredOTPDeliveryMechanismItem(String preferredOTPDeliveryMechanismItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse isProxyable(EnumtopologyAdminUserIsProxyableProp isProxyable) {
  ...
  **/
  ...
  public TopologyAdminUserResponse isProxyableByDN(List<String> isProxyableByDN) {
  ...
  public TopologyAdminUserResponse addIsProxyableByDNItem(String isProxyableByDNItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse isProxyableByGroup(List<String> isProxyableByGroup) {
  ...
  public TopologyAdminUserResponse addIsProxyableByGroupItem(String isProxyableByGroupItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse isProxyableByURL(List<String> isProxyableByURL) {
  ...
  public TopologyAdminUserResponse addIsProxyableByURLItem(String isProxyableByURLItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse mayProxyAsDN(List<String> mayProxyAsDN) {
  ...
  public TopologyAdminUserResponse addMayProxyAsDNItem(String mayProxyAsDNItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse mayProxyAsGroup(List<String> mayProxyAsGroup) {
  ...
  public TopologyAdminUserResponse addMayProxyAsGroupItem(String mayProxyAsGroupItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse mayProxyAsURL(List<String> mayProxyAsURL) {
  ...
  public TopologyAdminUserResponse addMayProxyAsURLItem(String mayProxyAsURLItem) {
  ...
  **/
  ...
  public TopologyAdminUserResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public TopologyAdminUserResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the TopologyAdminUserResponse instance itself
   */
  public TopologyAdminUserResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TopologyAdminUserResponse topologyAdminUserResponse = (TopologyAdminUserResponse) o;
    return Objects.equals(this.id, topologyAdminUserResponse.id) &&
        Objects.equals(this.description, topologyAdminUserResponse.description) &&
        Objects.equals(this.schemas, topologyAdminUserResponse.schemas) &&
        Objects.equals(this.alternateBindDN, topologyAdminUserResponse.alternateBindDN) &&
        Objects.equals(this.password, topologyAdminUserResponse.password) &&
        Objects.equals(this.firstName, topologyAdminUserResponse.firstName) &&
        Objects.equals(this.lastName, topologyAdminUserResponse.lastName) &&
        Objects.equals(this.userID, topologyAdminUserResponse.userID) &&
        Objects.equals(this.emailAddress, topologyAdminUserResponse.emailAddress) &&
        Objects.equals(this.workTelephoneNumber, topologyAdminUserResponse.workTelephoneNumber) &&
        Objects.equals(this.homeTelephoneNumber, topologyAdminUserResponse.homeTelephoneNumber) &&
        Objects.equals(this.mobileTelephoneNumber, topologyAdminUserResponse.mobileTelephoneNumber) &&
        Objects.equals(this.pagerTelephoneNumber, topologyAdminUserResponse.pagerTelephoneNumber) &&
        Objects.equals(this.inheritDefaultRootPrivileges, topologyAdminUserResponse.inheritDefaultRootPrivileges) &&
        Objects.equals(this.privilege, topologyAdminUserResponse.privilege) &&
        Objects.equals(this.searchResultEntryLimit, topologyAdminUserResponse.searchResultEntryLimit) &&
        Objects.equals(this.timeLimitSeconds, topologyAdminUserResponse.timeLimitSeconds) &&
        Objects.equals(this.lookThroughEntryLimit, topologyAdminUserResponse.lookThroughEntryLimit) &&
        Objects.equals(this.idleTimeLimitSeconds, topologyAdminUserResponse.idleTimeLimitSeconds) &&
        Objects.equals(this.passwordPolicy, topologyAdminUserResponse.passwordPolicy) &&
        Objects.equals(this.disabled, topologyAdminUserResponse.disabled) &&
        Objects.equals(this.accountActivationTime, topologyAdminUserResponse.accountActivationTime) &&
        Objects.equals(this.accountExpirationTime, topologyAdminUserResponse.accountExpirationTime) &&
        Objects.equals(this.requireSecureAuthentication, topologyAdminUserResponse.requireSecureAuthentication) &&
        Objects.equals(this.requireSecureConnections, topologyAdminUserResponse.requireSecureConnections) &&
        Objects.equals(this.allowedAuthenticationType, topologyAdminUserResponse.allowedAuthenticationType) &&
        Objects.equals(this.allowedAuthenticationIPAddress, topologyAdminUserResponse.allowedAuthenticationIPAddress) &&
        Objects.equals(this.preferredOTPDeliveryMechanism, topologyAdminUserResponse.preferredOTPDeliveryMechanism) &&
        Objects.equals(this.isProxyable, topologyAdminUserResponse.isProxyable) &&
        Objects.equals(this.isProxyableByDN, topologyAdminUserResponse.isProxyableByDN) &&
        Objects.equals(this.isProxyableByGroup, topologyAdminUserResponse.isProxyableByGroup) &&
        Objects.equals(this.isProxyableByURL, topologyAdminUserResponse.isProxyableByURL) &&
        Objects.equals(this.mayProxyAsDN, topologyAdminUserResponse.mayProxyAsDN) &&
        Objects.equals(this.mayProxyAsGroup, topologyAdminUserResponse.mayProxyAsGroup) &&
        Objects.equals(this.mayProxyAsURL, topologyAdminUserResponse.mayProxyAsURL) &&
        Objects.equals(this.meta, topologyAdminUserResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, topologyAdminUserResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, topologyAdminUserResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, alternateBindDN, password, firstName, lastName, userID, emailAddress, workTelephoneNumber, homeTelephoneNumber, mobileTelephoneNumber, pagerTelephoneNumber, inheritDefaultRootPrivileges, privilege, searchResultEntryLimit, timeLimitSeconds, lookThroughEntryLimit, idleTimeLimitSeconds, passwordPolicy, disabled, accountActivationTime, accountExpirationTime, requireSecureAuthentication, requireSecureConnections, allowedAuthenticationType, allowedAuthenticationIPAddress, preferredOTPDeliveryMechanism, isProxyable, isProxyableByDN, isProxyableByGroup, isProxyableByURL, mayProxyAsDN, mayProxyAsGroup, mayProxyAsURL, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TopologyAdminUserResponse {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("inheritDefaultRootPrivileges");
    openapiRequiredFields.add("searchResultEntryLimit");
    openapiRequiredFields.add("timeLimitSeconds");
    openapiRequiredFields.add("lookThroughEntryLimit");
    openapiRequiredFields.add("idleTimeLimitSeconds");
    openapiRequiredFields.add("passwordPolicy");
    openapiRequiredFields.add("requireSecureAuthentication");
    openapiRequiredFields.add("requireSecureConnections");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TopologyAdminUserResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TopologyAdminUserResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TopologyAdminUserResponse is not found in the empty JSON string", TopologyAdminUserResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TopologyAdminUserResponse.openapiRequiredFields) {
      ...
      if (!jsonObj.get("passwordPolicy").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TopologyAdminUserResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TopologyAdminUserResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TopologyAdminUserResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TopologyAdminUserResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TopologyAdminUserResponse>() {
           @Override
           public void write(JsonWriter out, TopologyAdminUserResponse value) throws IOException {
           ...
           @Override
           public TopologyAdminUserResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TopologyAdminUserResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TopologyAdminUserResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TopologyAdminUserResponse
  * @throws IOException if the JSON string is invalid with respect to TopologyAdminUserResponse
  */
  public static TopologyAdminUserResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TopologyAdminUserResponse.class);
  }

 /**
  * Convert an instance of TopologyAdminUserResponse to an JSON string
  *
  * @return JSON string
  */
