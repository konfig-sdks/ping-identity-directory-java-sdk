 ...
 */
@JsonAdapter(EnumglobalConfigurationDisabledPrivilegeProp.Adapter.class)public enum EnumglobalConfigurationDisabledPrivilegeProp {
  ...
  EnumglobalConfigurationDisabledPrivilegeProp(String value) {
    this.value = value;
  }
  ...
  public static EnumglobalConfigurationDisabledPrivilegeProp fromValue(String value) {
    for (EnumglobalConfigurationDisabledPrivilegeProp b : EnumglobalConfigurationDisabledPrivilegeProp.values()) {
  ...
  public static class Adapter extends TypeAdapter<EnumglobalConfigurationDisabledPrivilegeProp> {
    @Override
    public void write(final JsonWriter jsonWriter, final EnumglobalConfigurationDisabledPrivilegeProp enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public EnumglobalConfigurationDisabledPrivilegeProp read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return EnumglobalConfigurationDisabledPrivilegeProp.fromValue(value);
    }
  }
}
