...
public class ConsentServiceExternalServerResponseAllOf {
  ...
  private List<EnumconsentServiceExternalServerSchemaUrn> schemas = null;
  ...
  public ConsentServiceExternalServerResponseAllOf() {
  }

  public ConsentServiceExternalServerResponseAllOf description(String description) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf schemas(List<EnumconsentServiceExternalServerSchemaUrn> schemas) {
  ...
  public ConsentServiceExternalServerResponseAllOf addSchemasItem(EnumconsentServiceExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf id(String id) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf baseURL(String baseURL) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The base URL of the external Consent Service, including the base path and optionally including the port number. For example, \"https://example.com:1443/consent/v1\".")
  ...
  public ConsentServiceExternalServerResponseAllOf userName(String userName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name of the login account to use when using Basic authentication on REST calls to the Consent Service.")
  ...
  public ConsentServiceExternalServerResponseAllOf password(String password) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The login password to use when using Basic authentication on REST calls to the Consent Service.")
  ...
  public ConsentServiceExternalServerResponseAllOf hostnameVerificationMethod(EnumexternalServerConsentServiceHostnameVerificationMethodProp hostnameVerificationMethod) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf sslCertNickname(String sslCertNickname) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public ConsentServiceExternalServerResponseAllOf responseTimeout(String responseTimeout) {
  ...
  **/
   ...
   * @return the ConsentServiceExternalServerResponseAllOf instance itself
   */
  public ConsentServiceExternalServerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ConsentServiceExternalServerResponseAllOf consentServiceExternalServerResponseAllOf = (ConsentServiceExternalServerResponseAllOf) o;
    return Objects.equals(this.description, consentServiceExternalServerResponseAllOf.description) &&
        Objects.equals(this.schemas, consentServiceExternalServerResponseAllOf.schemas) &&
        Objects.equals(this.id, consentServiceExternalServerResponseAllOf.id) &&
        Objects.equals(this.baseURL, consentServiceExternalServerResponseAllOf.baseURL) &&
        Objects.equals(this.userName, consentServiceExternalServerResponseAllOf.userName) &&
        Objects.equals(this.password, consentServiceExternalServerResponseAllOf.password) &&
        Objects.equals(this.hostnameVerificationMethod, consentServiceExternalServerResponseAllOf.hostnameVerificationMethod) &&
        Objects.equals(this.keyManagerProvider, consentServiceExternalServerResponseAllOf.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, consentServiceExternalServerResponseAllOf.trustManagerProvider) &&
        Objects.equals(this.sslCertNickname, consentServiceExternalServerResponseAllOf.sslCertNickname) &&
        Objects.equals(this.connectTimeout, consentServiceExternalServerResponseAllOf.connectTimeout) &&
        Objects.equals(this.responseTimeout, consentServiceExternalServerResponseAllOf.responseTimeout)&&
        Objects.equals(this.additionalProperties, consentServiceExternalServerResponseAllOf.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, baseURL, userName, password, hostnameVerificationMethod, keyManagerProvider, trustManagerProvider, sslCertNickname, connectTimeout, responseTimeout, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ConsentServiceExternalServerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConsentServiceExternalServerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConsentServiceExternalServerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConsentServiceExternalServerResponseAllOf is not found in the empty JSON string", ConsentServiceExternalServerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConsentServiceExternalServerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConsentServiceExternalServerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConsentServiceExternalServerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConsentServiceExternalServerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<ConsentServiceExternalServerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, ConsentServiceExternalServerResponseAllOf value) throws IOException {
           ...
           @Override
           public ConsentServiceExternalServerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConsentServiceExternalServerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConsentServiceExternalServerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConsentServiceExternalServerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to ConsentServiceExternalServerResponseAllOf
  */
  public static ConsentServiceExternalServerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConsentServiceExternalServerResponseAllOf.class);
  }

 /**
  * Convert an instance of ConsentServiceExternalServerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
