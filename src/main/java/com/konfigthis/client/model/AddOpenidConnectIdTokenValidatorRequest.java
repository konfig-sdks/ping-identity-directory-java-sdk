...
public class AddOpenidConnectIdTokenValidatorRequest {
  ...
  public AddOpenidConnectIdTokenValidatorRequest() {
  }

  public AddOpenidConnectIdTokenValidatorRequest validatorName(String validatorName) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Name of the new ID Token Validator")
  ...
  public AddOpenidConnectIdTokenValidatorRequest description(String description) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest schemas(List<EnumopenidConnectIdTokenValidatorSchemaUrn> schemas) {
  ...
  public AddOpenidConnectIdTokenValidatorRequest addSchemasItem(EnumopenidConnectIdTokenValidatorSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest allowedSigningAlgorithm(List<EnumidTokenValidatorAllowedSigningAlgorithmProp> allowedSigningAlgorithm) {
  ...
  public AddOpenidConnectIdTokenValidatorRequest addAllowedSigningAlgorithmItem(EnumidTokenValidatorAllowedSigningAlgorithmProp allowedSigningAlgorithmItem) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest signingCertificate(List<String> signingCertificate) {
  ...
  public AddOpenidConnectIdTokenValidatorRequest addSigningCertificateItem(String signingCertificateItem) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest openIDConnectProvider(String openIDConnectProvider) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest jwksEndpointPath(String jwksEndpointPath) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest identityMapper(String identityMapper) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest subjectClaimName(String subjectClaimName) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest issuerURL(String issuerURL) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest clockSkewGracePeriod(String clockSkewGracePeriod) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest jwksCacheDuration(String jwksCacheDuration) {
  ...
  **/
  ...
  public AddOpenidConnectIdTokenValidatorRequest evaluationOrderIndex(Integer evaluationOrderIndex) {
  ...
  **/
   ...
   * @return the AddOpenidConnectIdTokenValidatorRequest instance itself
   */
  public AddOpenidConnectIdTokenValidatorRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddOpenidConnectIdTokenValidatorRequest addOpenidConnectIdTokenValidatorRequest = (AddOpenidConnectIdTokenValidatorRequest) o;
    return Objects.equals(this.validatorName, addOpenidConnectIdTokenValidatorRequest.validatorName) &&
        Objects.equals(this.description, addOpenidConnectIdTokenValidatorRequest.description) &&
        Objects.equals(this.schemas, addOpenidConnectIdTokenValidatorRequest.schemas) &&
        Objects.equals(this.allowedSigningAlgorithm, addOpenidConnectIdTokenValidatorRequest.allowedSigningAlgorithm) &&
        Objects.equals(this.signingCertificate, addOpenidConnectIdTokenValidatorRequest.signingCertificate) &&
        Objects.equals(this.openIDConnectProvider, addOpenidConnectIdTokenValidatorRequest.openIDConnectProvider) &&
        Objects.equals(this.jwksEndpointPath, addOpenidConnectIdTokenValidatorRequest.jwksEndpointPath) &&
        Objects.equals(this.enabled, addOpenidConnectIdTokenValidatorRequest.enabled) &&
        Objects.equals(this.identityMapper, addOpenidConnectIdTokenValidatorRequest.identityMapper) &&
        Objects.equals(this.subjectClaimName, addOpenidConnectIdTokenValidatorRequest.subjectClaimName) &&
        Objects.equals(this.issuerURL, addOpenidConnectIdTokenValidatorRequest.issuerURL) &&
        Objects.equals(this.clockSkewGracePeriod, addOpenidConnectIdTokenValidatorRequest.clockSkewGracePeriod) &&
        Objects.equals(this.jwksCacheDuration, addOpenidConnectIdTokenValidatorRequest.jwksCacheDuration) &&
        Objects.equals(this.evaluationOrderIndex, addOpenidConnectIdTokenValidatorRequest.evaluationOrderIndex)&&
        Objects.equals(this.additionalProperties, addOpenidConnectIdTokenValidatorRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(validatorName, description, schemas, allowedSigningAlgorithm, signingCertificate, openIDConnectProvider, jwksEndpointPath, enabled, identityMapper, subjectClaimName, issuerURL, clockSkewGracePeriod, jwksCacheDuration, evaluationOrderIndex, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddOpenidConnectIdTokenValidatorRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddOpenidConnectIdTokenValidatorRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddOpenidConnectIdTokenValidatorRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddOpenidConnectIdTokenValidatorRequest is not found in the empty JSON string", AddOpenidConnectIdTokenValidatorRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddOpenidConnectIdTokenValidatorRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddOpenidConnectIdTokenValidatorRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddOpenidConnectIdTokenValidatorRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddOpenidConnectIdTokenValidatorRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddOpenidConnectIdTokenValidatorRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddOpenidConnectIdTokenValidatorRequest>() {
           @Override
           public void write(JsonWriter out, AddOpenidConnectIdTokenValidatorRequest value) throws IOException {
           ...
           @Override
           public AddOpenidConnectIdTokenValidatorRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddOpenidConnectIdTokenValidatorRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddOpenidConnectIdTokenValidatorRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddOpenidConnectIdTokenValidatorRequest
  * @throws IOException if the JSON string is invalid with respect to AddOpenidConnectIdTokenValidatorRequest
  */
  public static AddOpenidConnectIdTokenValidatorRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddOpenidConnectIdTokenValidatorRequest.class);
  }

 /**
  * Convert an instance of AddOpenidConnectIdTokenValidatorRequest to an JSON string
  *
  * @return JSON string
  */
