...
import com.konfigthis.client.model.EnummappingScimResourceTypeSchemaUrn;
...
public class MappingScimResourceTypeResponse {
  ...
  private List<EnummappingScimResourceTypeSchemaUrn> schemas = new ArrayList<>();
  ...
  public MappingScimResourceTypeResponse() {
  }

  public MappingScimResourceTypeResponse id(String id) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse description(String description) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse schemas(List<EnummappingScimResourceTypeSchemaUrn> schemas) {
  ...
  public MappingScimResourceTypeResponse addSchemasItem(EnummappingScimResourceTypeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public List<EnummappingScimResourceTypeSchemaUrn> getSchemas() {
    return schemas;
  }


  public void setSchemas(List<EnummappingScimResourceTypeSchemaUrn> schemas) {
  ...
  public MappingScimResourceTypeResponse coreSchema(String coreSchema) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse requiredSchemaExtension(List<String> requiredSchemaExtension) {
  ...
  public MappingScimResourceTypeResponse addRequiredSchemaExtensionItem(String requiredSchemaExtensionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse optionalSchemaExtension(List<String> optionalSchemaExtension) {
  ...
  public MappingScimResourceTypeResponse addOptionalSchemaExtensionItem(String optionalSchemaExtensionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse endpoint(String endpoint) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse lookthroughLimit(Integer lookthroughLimit) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse schemaCheckingOption(List<EnumscimResourceTypeSchemaCheckingOptionProp> schemaCheckingOption) {
  ...
  public MappingScimResourceTypeResponse addSchemaCheckingOptionItem(EnumscimResourceTypeSchemaCheckingOptionProp schemaCheckingOptionItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse structuralLDAPObjectclass(String structuralLDAPObjectclass) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse auxiliaryLDAPObjectclass(List<String> auxiliaryLDAPObjectclass) {
  ...
  public MappingScimResourceTypeResponse addAuxiliaryLDAPObjectclassItem(String auxiliaryLDAPObjectclassItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse includeBaseDN(String includeBaseDN) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse includeFilter(List<String> includeFilter) {
  ...
  public MappingScimResourceTypeResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse includeOperationalAttribute(List<String> includeOperationalAttribute) {
  ...
  public MappingScimResourceTypeResponse addIncludeOperationalAttributeItem(String includeOperationalAttributeItem) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse createDNPattern(String createDNPattern) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public MappingScimResourceTypeResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the MappingScimResourceTypeResponse instance itself
   */
  public MappingScimResourceTypeResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    MappingScimResourceTypeResponse mappingScimResourceTypeResponse = (MappingScimResourceTypeResponse) o;
    return Objects.equals(this.id, mappingScimResourceTypeResponse.id) &&
        Objects.equals(this.description, mappingScimResourceTypeResponse.description) &&
        Objects.equals(this.schemas, mappingScimResourceTypeResponse.schemas) &&
        Objects.equals(this.coreSchema, mappingScimResourceTypeResponse.coreSchema) &&
        Objects.equals(this.requiredSchemaExtension, mappingScimResourceTypeResponse.requiredSchemaExtension) &&
        Objects.equals(this.optionalSchemaExtension, mappingScimResourceTypeResponse.optionalSchemaExtension) &&
        Objects.equals(this.enabled, mappingScimResourceTypeResponse.enabled) &&
        Objects.equals(this.endpoint, mappingScimResourceTypeResponse.endpoint) &&
        Objects.equals(this.lookthroughLimit, mappingScimResourceTypeResponse.lookthroughLimit) &&
        Objects.equals(this.schemaCheckingOption, mappingScimResourceTypeResponse.schemaCheckingOption) &&
        Objects.equals(this.structuralLDAPObjectclass, mappingScimResourceTypeResponse.structuralLDAPObjectclass) &&
        Objects.equals(this.auxiliaryLDAPObjectclass, mappingScimResourceTypeResponse.auxiliaryLDAPObjectclass) &&
        Objects.equals(this.includeBaseDN, mappingScimResourceTypeResponse.includeBaseDN) &&
        Objects.equals(this.includeFilter, mappingScimResourceTypeResponse.includeFilter) &&
        Objects.equals(this.includeOperationalAttribute, mappingScimResourceTypeResponse.includeOperationalAttribute) &&
        Objects.equals(this.createDNPattern, mappingScimResourceTypeResponse.createDNPattern) &&
        Objects.equals(this.meta, mappingScimResourceTypeResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, mappingScimResourceTypeResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, mappingScimResourceTypeResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class MappingScimResourceTypeResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to MappingScimResourceTypeResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MappingScimResourceTypeResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MappingScimResourceTypeResponse is not found in the empty JSON string", MappingScimResourceTypeResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MappingScimResourceTypeResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MappingScimResourceTypeResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MappingScimResourceTypeResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MappingScimResourceTypeResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MappingScimResourceTypeResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<MappingScimResourceTypeResponse>() {
           @Override
           public void write(JsonWriter out, MappingScimResourceTypeResponse value) throws IOException {
           ...
           @Override
           public MappingScimResourceTypeResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MappingScimResourceTypeResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MappingScimResourceTypeResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MappingScimResourceTypeResponse
  * @throws IOException if the JSON string is invalid with respect to MappingScimResourceTypeResponse
  */
  public static MappingScimResourceTypeResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MappingScimResourceTypeResponse.class);
  }

 /**
  * Convert an instance of MappingScimResourceTypeResponse to an JSON string
  *
  * @return JSON string
  */
