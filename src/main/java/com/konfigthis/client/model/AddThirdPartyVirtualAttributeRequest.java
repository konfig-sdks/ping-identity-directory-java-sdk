...
public class AddThirdPartyVirtualAttributeRequest {
  ...
  public AddThirdPartyVirtualAttributeRequest() {
  }

  public AddThirdPartyVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest schemas(List<EnumthirdPartyVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddThirdPartyVirtualAttributeRequest addSchemasItem(EnumthirdPartyVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest extensionClass(String extensionClass) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest extensionArgument(List<String> extensionArgument) {
  ...
  public AddThirdPartyVirtualAttributeRequest addExtensionArgumentItem(String extensionArgumentItem) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddThirdPartyVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddThirdPartyVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddThirdPartyVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddThirdPartyVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddThirdPartyVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddThirdPartyVirtualAttributeRequest instance itself
   */
  public AddThirdPartyVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddThirdPartyVirtualAttributeRequest addThirdPartyVirtualAttributeRequest = (AddThirdPartyVirtualAttributeRequest) o;
    return Objects.equals(this.name, addThirdPartyVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addThirdPartyVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addThirdPartyVirtualAttributeRequest.schemas) &&
        Objects.equals(this.extensionClass, addThirdPartyVirtualAttributeRequest.extensionClass) &&
        Objects.equals(this.extensionArgument, addThirdPartyVirtualAttributeRequest.extensionArgument) &&
        Objects.equals(this.enabled, addThirdPartyVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addThirdPartyVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addThirdPartyVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addThirdPartyVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addThirdPartyVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addThirdPartyVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addThirdPartyVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addThirdPartyVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addThirdPartyVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addThirdPartyVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addThirdPartyVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addThirdPartyVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, extensionClass, extensionArgument, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddThirdPartyVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddThirdPartyVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddThirdPartyVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddThirdPartyVirtualAttributeRequest is not found in the empty JSON string", AddThirdPartyVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddThirdPartyVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddThirdPartyVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddThirdPartyVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddThirdPartyVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddThirdPartyVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddThirdPartyVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddThirdPartyVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddThirdPartyVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddThirdPartyVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddThirdPartyVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddThirdPartyVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddThirdPartyVirtualAttributeRequest
  */
  public static AddThirdPartyVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddThirdPartyVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddThirdPartyVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
