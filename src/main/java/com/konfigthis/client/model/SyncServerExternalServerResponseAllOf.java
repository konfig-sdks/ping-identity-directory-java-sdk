...
public class SyncServerExternalServerResponseAllOf {
  ...
  private List<EnumsyncServerExternalServerSchemaUrn> schemas = null;
  ...
  public SyncServerExternalServerResponseAllOf() {
  }

  public SyncServerExternalServerResponseAllOf description(String description) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf schemas(List<EnumsyncServerExternalServerSchemaUrn> schemas) {
  ...
  public SyncServerExternalServerResponseAllOf addSchemasItem(EnumsyncServerExternalServerSchemaUrn schemasItem) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf id(String id) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf verifyCredentialsMethod(EnumexternalServerVerifyCredentialsMethodProp verifyCredentialsMethod) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf syncServerPriorityIndex(Integer syncServerPriorityIndex) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The relative failover priority of this server. Lower numbers have a higher priority.")
  ...
  public SyncServerExternalServerResponseAllOf serverHostName(String serverHostName) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf serverPort(Integer serverPort) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf location(String location) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf bindDN(String bindDN) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf password(String password) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf passphraseProvider(String passphraseProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf connectionSecurity(EnumexternalServerSyncServerConnectionSecurityProp connectionSecurity) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf authenticationMethod(EnumexternalServerSyncServerAuthenticationMethodProp authenticationMethod) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf healthCheckConnectTimeout(String healthCheckConnectTimeout) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf maxConnectionAge(String maxConnectionAge) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf minExpiredConnectionDisconnectInterval(String minExpiredConnectionDisconnectInterval) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf connectTimeout(String connectTimeout) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf maxResponseSize(String maxResponseSize) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf keyManagerProvider(String keyManagerProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf trustManagerProvider(String trustManagerProvider) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf initialConnections(Integer initialConnections) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf maxConnections(Integer maxConnections) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf defunctConnectionResultCode(List<EnumexternalServerDefunctConnectionResultCodeProp> defunctConnectionResultCode) {
  ...
  public SyncServerExternalServerResponseAllOf addDefunctConnectionResultCodeItem(EnumexternalServerDefunctConnectionResultCodeProp defunctConnectionResultCodeItem) {
  ...
  **/
  ...
  public SyncServerExternalServerResponseAllOf abandonOnTimeout(Boolean abandonOnTimeout) {
  ...
  **/
   ...
   * @return the SyncServerExternalServerResponseAllOf instance itself
   */
  public SyncServerExternalServerResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SyncServerExternalServerResponseAllOf syncServerExternalServerResponseAllOf = (SyncServerExternalServerResponseAllOf) o;
    return Objects.equals(this.description, syncServerExternalServerResponseAllOf.description) &&
        Objects.equals(this.schemas, syncServerExternalServerResponseAllOf.schemas) &&
        Objects.equals(this.id, syncServerExternalServerResponseAllOf.id) &&
        Objects.equals(this.verifyCredentialsMethod, syncServerExternalServerResponseAllOf.verifyCredentialsMethod) &&
        Objects.equals(this.syncServerPriorityIndex, syncServerExternalServerResponseAllOf.syncServerPriorityIndex) &&
        Objects.equals(this.serverHostName, syncServerExternalServerResponseAllOf.serverHostName) &&
        Objects.equals(this.serverPort, syncServerExternalServerResponseAllOf.serverPort) &&
        Objects.equals(this.location, syncServerExternalServerResponseAllOf.location) &&
        Objects.equals(this.bindDN, syncServerExternalServerResponseAllOf.bindDN) &&
        Objects.equals(this.password, syncServerExternalServerResponseAllOf.password) &&
        Objects.equals(this.passphraseProvider, syncServerExternalServerResponseAllOf.passphraseProvider) &&
        Objects.equals(this.connectionSecurity, syncServerExternalServerResponseAllOf.connectionSecurity) &&
        Objects.equals(this.authenticationMethod, syncServerExternalServerResponseAllOf.authenticationMethod) &&
        Objects.equals(this.healthCheckConnectTimeout, syncServerExternalServerResponseAllOf.healthCheckConnectTimeout) &&
        Objects.equals(this.maxConnectionAge, syncServerExternalServerResponseAllOf.maxConnectionAge) &&
        Objects.equals(this.minExpiredConnectionDisconnectInterval, syncServerExternalServerResponseAllOf.minExpiredConnectionDisconnectInterval) &&
        Objects.equals(this.connectTimeout, syncServerExternalServerResponseAllOf.connectTimeout) &&
        Objects.equals(this.maxResponseSize, syncServerExternalServerResponseAllOf.maxResponseSize) &&
        Objects.equals(this.keyManagerProvider, syncServerExternalServerResponseAllOf.keyManagerProvider) &&
        Objects.equals(this.trustManagerProvider, syncServerExternalServerResponseAllOf.trustManagerProvider) &&
        Objects.equals(this.initialConnections, syncServerExternalServerResponseAllOf.initialConnections) &&
        Objects.equals(this.maxConnections, syncServerExternalServerResponseAllOf.maxConnections) &&
        Objects.equals(this.defunctConnectionResultCode, syncServerExternalServerResponseAllOf.defunctConnectionResultCode) &&
        Objects.equals(this.abandonOnTimeout, syncServerExternalServerResponseAllOf.abandonOnTimeout)&&
        Objects.equals(this.additionalProperties, syncServerExternalServerResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncServerExternalServerResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SyncServerExternalServerResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SyncServerExternalServerResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SyncServerExternalServerResponseAllOf is not found in the empty JSON string", SyncServerExternalServerResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SyncServerExternalServerResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SyncServerExternalServerResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SyncServerExternalServerResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SyncServerExternalServerResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<SyncServerExternalServerResponseAllOf>() {
           @Override
           public void write(JsonWriter out, SyncServerExternalServerResponseAllOf value) throws IOException {
           ...
           @Override
           public SyncServerExternalServerResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SyncServerExternalServerResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SyncServerExternalServerResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SyncServerExternalServerResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to SyncServerExternalServerResponseAllOf
  */
  public static SyncServerExternalServerResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SyncServerExternalServerResponseAllOf.class);
  }

 /**
  * Convert an instance of SyncServerExternalServerResponseAllOf to an JSON string
  *
  * @return JSON string
  */
