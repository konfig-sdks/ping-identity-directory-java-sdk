...
public class FifoEntryCacheResponse {
  ...
  public FifoEntryCacheResponse() {
  }

  public FifoEntryCacheResponse id(String id) {
  ...
  **/
  ...
  public FifoEntryCacheResponse description(String description) {
  ...
  **/
  ...
  public FifoEntryCacheResponse schemas(List<EnumfifoEntryCacheSchemaUrn> schemas) {
  ...
  public FifoEntryCacheResponse addSchemasItem(EnumfifoEntryCacheSchemaUrn schemasItem) {
  ...
  **/
  ...
  public FifoEntryCacheResponse maxMemoryPercent(Integer maxMemoryPercent) {
  ...
  **/
  ...
  public FifoEntryCacheResponse maxEntries(Integer maxEntries) {
  ...
  **/
  ...
  public FifoEntryCacheResponse onlyCacheFrequentlyAccessed(Boolean onlyCacheFrequentlyAccessed) {
  ...
  **/
  ...
  public FifoEntryCacheResponse includeFilter(List<String> includeFilter) {
  ...
  public FifoEntryCacheResponse addIncludeFilterItem(String includeFilterItem) {
  ...
  **/
  ...
  public FifoEntryCacheResponse excludeFilter(List<String> excludeFilter) {
  ...
  public FifoEntryCacheResponse addExcludeFilterItem(String excludeFilterItem) {
  ...
  **/
  ...
  public FifoEntryCacheResponse minCacheEntryValueCount(Integer minCacheEntryValueCount) {
  ...
  **/
  ...
  public FifoEntryCacheResponse minCacheEntryAttribute(List<String> minCacheEntryAttribute) {
  ...
  public FifoEntryCacheResponse addMinCacheEntryAttributeItem(String minCacheEntryAttributeItem) {
  ...
  **/
  ...
  public FifoEntryCacheResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public FifoEntryCacheResponse cacheLevel(Integer cacheLevel) {
  ...
  **/
  ...
  public FifoEntryCacheResponse cacheUnindexedSearchResults(Boolean cacheUnindexedSearchResults) {
  ...
  **/
  ...
  public FifoEntryCacheResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public FifoEntryCacheResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the FifoEntryCacheResponse instance itself
   */
  public FifoEntryCacheResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FifoEntryCacheResponse fifoEntryCacheResponse = (FifoEntryCacheResponse) o;
    return Objects.equals(this.id, fifoEntryCacheResponse.id) &&
        Objects.equals(this.description, fifoEntryCacheResponse.description) &&
        Objects.equals(this.schemas, fifoEntryCacheResponse.schemas) &&
        Objects.equals(this.maxMemoryPercent, fifoEntryCacheResponse.maxMemoryPercent) &&
        Objects.equals(this.maxEntries, fifoEntryCacheResponse.maxEntries) &&
        Objects.equals(this.onlyCacheFrequentlyAccessed, fifoEntryCacheResponse.onlyCacheFrequentlyAccessed) &&
        Objects.equals(this.includeFilter, fifoEntryCacheResponse.includeFilter) &&
        Objects.equals(this.excludeFilter, fifoEntryCacheResponse.excludeFilter) &&
        Objects.equals(this.minCacheEntryValueCount, fifoEntryCacheResponse.minCacheEntryValueCount) &&
        Objects.equals(this.minCacheEntryAttribute, fifoEntryCacheResponse.minCacheEntryAttribute) &&
        Objects.equals(this.enabled, fifoEntryCacheResponse.enabled) &&
        Objects.equals(this.cacheLevel, fifoEntryCacheResponse.cacheLevel) &&
        Objects.equals(this.cacheUnindexedSearchResults, fifoEntryCacheResponse.cacheUnindexedSearchResults) &&
        Objects.equals(this.meta, fifoEntryCacheResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, fifoEntryCacheResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, fifoEntryCacheResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, maxMemoryPercent, maxEntries, onlyCacheFrequentlyAccessed, includeFilter, excludeFilter, minCacheEntryValueCount, minCacheEntryAttribute, enabled, cacheLevel, cacheUnindexedSearchResults, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class FifoEntryCacheResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FifoEntryCacheResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FifoEntryCacheResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FifoEntryCacheResponse is not found in the empty JSON string", FifoEntryCacheResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : FifoEntryCacheResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FifoEntryCacheResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FifoEntryCacheResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FifoEntryCacheResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FifoEntryCacheResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FifoEntryCacheResponse>() {
           @Override
           public void write(JsonWriter out, FifoEntryCacheResponse value) throws IOException {
           ...
           @Override
           public FifoEntryCacheResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FifoEntryCacheResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FifoEntryCacheResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FifoEntryCacheResponse
  * @throws IOException if the JSON string is invalid with respect to FifoEntryCacheResponse
  */
  public static FifoEntryCacheResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FifoEntryCacheResponse.class);
  }

 /**
  * Convert an instance of FifoEntryCacheResponse to an JSON string
  *
  * @return JSON string
  */
