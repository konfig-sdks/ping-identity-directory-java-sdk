...
public class VaultPassphraseProviderResponse {
  ...
  public VaultPassphraseProviderResponse() {
  }

  public VaultPassphraseProviderResponse id(String id) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse description(String description) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse schemas(List<EnumvaultPassphraseProviderSchemaUrn> schemas) {
  ...
  public VaultPassphraseProviderResponse addSchemasItem(EnumvaultPassphraseProviderSchemaUrn schemasItem) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse vaultExternalServer(String vaultExternalServer) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse vaultSecretPath(String vaultSecretPath) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse vaultSecretFieldName(String vaultSecretFieldName) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse maxCacheDuration(String maxCacheDuration) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public VaultPassphraseProviderResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the VaultPassphraseProviderResponse instance itself
   */
  public VaultPassphraseProviderResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultPassphraseProviderResponse vaultPassphraseProviderResponse = (VaultPassphraseProviderResponse) o;
    return Objects.equals(this.id, vaultPassphraseProviderResponse.id) &&
        Objects.equals(this.description, vaultPassphraseProviderResponse.description) &&
        Objects.equals(this.schemas, vaultPassphraseProviderResponse.schemas) &&
        Objects.equals(this.vaultExternalServer, vaultPassphraseProviderResponse.vaultExternalServer) &&
        Objects.equals(this.vaultSecretPath, vaultPassphraseProviderResponse.vaultSecretPath) &&
        Objects.equals(this.vaultSecretFieldName, vaultPassphraseProviderResponse.vaultSecretFieldName) &&
        Objects.equals(this.maxCacheDuration, vaultPassphraseProviderResponse.maxCacheDuration) &&
        Objects.equals(this.enabled, vaultPassphraseProviderResponse.enabled) &&
        Objects.equals(this.meta, vaultPassphraseProviderResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, vaultPassphraseProviderResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, vaultPassphraseProviderResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, schemas, vaultExternalServer, vaultSecretPath, vaultSecretFieldName, maxCacheDuration, enabled, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VaultPassphraseProviderResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultPassphraseProviderResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultPassphraseProviderResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultPassphraseProviderResponse is not found in the empty JSON string", VaultPassphraseProviderResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultPassphraseProviderResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultPassphraseProviderResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultPassphraseProviderResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultPassphraseProviderResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultPassphraseProviderResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultPassphraseProviderResponse>() {
           @Override
           public void write(JsonWriter out, VaultPassphraseProviderResponse value) throws IOException {
           ...
           @Override
           public VaultPassphraseProviderResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultPassphraseProviderResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultPassphraseProviderResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultPassphraseProviderResponse
  * @throws IOException if the JSON string is invalid with respect to VaultPassphraseProviderResponse
  */
  public static VaultPassphraseProviderResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultPassphraseProviderResponse.class);
  }

 /**
  * Convert an instance of VaultPassphraseProviderResponse to an JSON string
  *
  * @return JSON string
  */
