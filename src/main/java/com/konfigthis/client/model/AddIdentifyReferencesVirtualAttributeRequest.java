...
public class AddIdentifyReferencesVirtualAttributeRequest {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest() {
  }

  public AddIdentifyReferencesVirtualAttributeRequest name(String name) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest description(String description) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest schemas(List<EnumidentifyReferencesVirtualAttributeSchemaUrn> schemas) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addSchemasItem(EnumidentifyReferencesVirtualAttributeSchemaUrn schemasItem) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest referencedByAttribute(List<String> referencedByAttribute) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addReferencedByAttributeItem(String referencedByAttributeItem) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest referenceSearchBaseDN(List<String> referenceSearchBaseDN) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addReferenceSearchBaseDNItem(String referenceSearchBaseDNItem) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest attributeType(String attributeType) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest baseDN(List<String> baseDN) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addBaseDNItem(String baseDNItem) {
    if (this.baseDN == null) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest groupDN(List<String> groupDN) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addGroupDNItem(String groupDNItem) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest filter(List<String> filter) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addFilterItem(String filterItem) {
    if (this.filter == null) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest clientConnectionPolicy(List<String> clientConnectionPolicy) {
  ...
  public AddIdentifyReferencesVirtualAttributeRequest addClientConnectionPolicyItem(String clientConnectionPolicyItem) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest conflictBehavior(EnumvirtualAttributeConflictBehaviorProp conflictBehavior) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest requireExplicitRequestByName(Boolean requireExplicitRequestByName) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest multipleVirtualAttributeEvaluationOrderIndex(Integer multipleVirtualAttributeEvaluationOrderIndex) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest multipleVirtualAttributeMergeBehavior(EnumvirtualAttributeMultipleVirtualAttributeMergeBehaviorProp multipleVirtualAttributeMergeBehavior) {
  ...
  **/
  ...
  public AddIdentifyReferencesVirtualAttributeRequest allowIndexConflicts(Boolean allowIndexConflicts) {
  ...
  **/
   ...
   * @return the AddIdentifyReferencesVirtualAttributeRequest instance itself
   */
  public AddIdentifyReferencesVirtualAttributeRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddIdentifyReferencesVirtualAttributeRequest addIdentifyReferencesVirtualAttributeRequest = (AddIdentifyReferencesVirtualAttributeRequest) o;
    return Objects.equals(this.name, addIdentifyReferencesVirtualAttributeRequest.name) &&
        Objects.equals(this.description, addIdentifyReferencesVirtualAttributeRequest.description) &&
        Objects.equals(this.schemas, addIdentifyReferencesVirtualAttributeRequest.schemas) &&
        Objects.equals(this.referencedByAttribute, addIdentifyReferencesVirtualAttributeRequest.referencedByAttribute) &&
        Objects.equals(this.referenceSearchBaseDN, addIdentifyReferencesVirtualAttributeRequest.referenceSearchBaseDN) &&
        Objects.equals(this.enabled, addIdentifyReferencesVirtualAttributeRequest.enabled) &&
        Objects.equals(this.attributeType, addIdentifyReferencesVirtualAttributeRequest.attributeType) &&
        Objects.equals(this.baseDN, addIdentifyReferencesVirtualAttributeRequest.baseDN) &&
        Objects.equals(this.groupDN, addIdentifyReferencesVirtualAttributeRequest.groupDN) &&
        Objects.equals(this.filter, addIdentifyReferencesVirtualAttributeRequest.filter) &&
        Objects.equals(this.clientConnectionPolicy, addIdentifyReferencesVirtualAttributeRequest.clientConnectionPolicy) &&
        Objects.equals(this.conflictBehavior, addIdentifyReferencesVirtualAttributeRequest.conflictBehavior) &&
        Objects.equals(this.requireExplicitRequestByName, addIdentifyReferencesVirtualAttributeRequest.requireExplicitRequestByName) &&
        Objects.equals(this.multipleVirtualAttributeEvaluationOrderIndex, addIdentifyReferencesVirtualAttributeRequest.multipleVirtualAttributeEvaluationOrderIndex) &&
        Objects.equals(this.multipleVirtualAttributeMergeBehavior, addIdentifyReferencesVirtualAttributeRequest.multipleVirtualAttributeMergeBehavior) &&
        Objects.equals(this.allowIndexConflicts, addIdentifyReferencesVirtualAttributeRequest.allowIndexConflicts)&&
        Objects.equals(this.additionalProperties, addIdentifyReferencesVirtualAttributeRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, description, schemas, referencedByAttribute, referenceSearchBaseDN, enabled, attributeType, baseDN, groupDN, filter, clientConnectionPolicy, conflictBehavior, requireExplicitRequestByName, multipleVirtualAttributeEvaluationOrderIndex, multipleVirtualAttributeMergeBehavior, allowIndexConflicts, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AddIdentifyReferencesVirtualAttributeRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddIdentifyReferencesVirtualAttributeRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddIdentifyReferencesVirtualAttributeRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddIdentifyReferencesVirtualAttributeRequest is not found in the empty JSON string", AddIdentifyReferencesVirtualAttributeRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddIdentifyReferencesVirtualAttributeRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddIdentifyReferencesVirtualAttributeRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddIdentifyReferencesVirtualAttributeRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddIdentifyReferencesVirtualAttributeRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddIdentifyReferencesVirtualAttributeRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<AddIdentifyReferencesVirtualAttributeRequest>() {
           @Override
           public void write(JsonWriter out, AddIdentifyReferencesVirtualAttributeRequest value) throws IOException {
           ...
           @Override
           public AddIdentifyReferencesVirtualAttributeRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddIdentifyReferencesVirtualAttributeRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddIdentifyReferencesVirtualAttributeRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddIdentifyReferencesVirtualAttributeRequest
  * @throws IOException if the JSON string is invalid with respect to AddIdentifyReferencesVirtualAttributeRequest
  */
  public static AddIdentifyReferencesVirtualAttributeRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddIdentifyReferencesVirtualAttributeRequest.class);
  }

 /**
  * Convert an instance of AddIdentifyReferencesVirtualAttributeRequest to an JSON string
  *
  * @return JSON string
  */
