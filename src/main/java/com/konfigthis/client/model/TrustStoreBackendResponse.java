...
public class TrustStoreBackendResponse {
  ...
  private List<EnumtrustStoreBackendSchemaUrn> schemas = new ArrayList<>();
  ...
  public TrustStoreBackendResponse() {
  }

  public TrustStoreBackendResponse description(String description) {
  ...
  **/
  ...
  public TrustStoreBackendResponse schemas(List<EnumtrustStoreBackendSchemaUrn> schemas) {
  ...
  public TrustStoreBackendResponse addSchemasItem(EnumtrustStoreBackendSchemaUrn schemasItem) {
  ...
  **/
  ...
  public TrustStoreBackendResponse id(String id) {
  ...
  **/
  ...
  public TrustStoreBackendResponse backendID(String backendID) {
  ...
  **/
  ...
  public TrustStoreBackendResponse baseDN(List<String> baseDN) {
  ...
  public TrustStoreBackendResponse addBaseDNItem(String baseDNItem) {
  ...
  **/
  ...
  public TrustStoreBackendResponse writabilityMode(EnumbackendWritabilityModeProp writabilityMode) {
  ...
  **/
  ...
  public TrustStoreBackendResponse trustStoreFile(String trustStoreFile) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Specifies the path to the file that stores the trust information.")
  ...
  public TrustStoreBackendResponse trustStoreType(String trustStoreType) {
  ...
  **/
  ...
  public TrustStoreBackendResponse trustStorePin(String trustStorePin) {
  ...
  **/
  ...
  public TrustStoreBackendResponse trustStorePinFile(String trustStorePinFile) {
  ...
  **/
  ...
  public TrustStoreBackendResponse trustStorePinPassphraseProvider(String trustStorePinPassphraseProvider) {
  ...
  **/
  ...
  public TrustStoreBackendResponse enabled(Boolean enabled) {
  ...
  **/
  ...
  public TrustStoreBackendResponse setDegradedAlertWhenDisabled(Boolean setDegradedAlertWhenDisabled) {
  ...
  **/
  ...
  public TrustStoreBackendResponse returnUnavailableWhenDisabled(Boolean returnUnavailableWhenDisabled) {
  ...
  **/
  ...
  public TrustStoreBackendResponse backupFilePermissions(String backupFilePermissions) {
  ...
  **/
  ...
  public TrustStoreBackendResponse notificationManager(String notificationManager) {
  ...
  **/
  ...
  public TrustStoreBackendResponse meta(MetaMeta meta) {
  ...
  **/
  ...
  public TrustStoreBackendResponse urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20(MetaUrnPingidentitySchemasConfigurationMessages20 urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20) {
  ...
  **/
   ...
   * @return the TrustStoreBackendResponse instance itself
   */
  public TrustStoreBackendResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TrustStoreBackendResponse trustStoreBackendResponse = (TrustStoreBackendResponse) o;
    return Objects.equals(this.description, trustStoreBackendResponse.description) &&
        Objects.equals(this.schemas, trustStoreBackendResponse.schemas) &&
        Objects.equals(this.id, trustStoreBackendResponse.id) &&
        Objects.equals(this.backendID, trustStoreBackendResponse.backendID) &&
        Objects.equals(this.baseDN, trustStoreBackendResponse.baseDN) &&
        Objects.equals(this.writabilityMode, trustStoreBackendResponse.writabilityMode) &&
        Objects.equals(this.trustStoreFile, trustStoreBackendResponse.trustStoreFile) &&
        Objects.equals(this.trustStoreType, trustStoreBackendResponse.trustStoreType) &&
        Objects.equals(this.trustStorePin, trustStoreBackendResponse.trustStorePin) &&
        Objects.equals(this.trustStorePinFile, trustStoreBackendResponse.trustStorePinFile) &&
        Objects.equals(this.trustStorePinPassphraseProvider, trustStoreBackendResponse.trustStorePinPassphraseProvider) &&
        Objects.equals(this.enabled, trustStoreBackendResponse.enabled) &&
        Objects.equals(this.setDegradedAlertWhenDisabled, trustStoreBackendResponse.setDegradedAlertWhenDisabled) &&
        Objects.equals(this.returnUnavailableWhenDisabled, trustStoreBackendResponse.returnUnavailableWhenDisabled) &&
        Objects.equals(this.backupFilePermissions, trustStoreBackendResponse.backupFilePermissions) &&
        Objects.equals(this.notificationManager, trustStoreBackendResponse.notificationManager) &&
        Objects.equals(this.meta, trustStoreBackendResponse.meta) &&
        Objects.equals(this.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, trustStoreBackendResponse.urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20)&&
        Objects.equals(this.additionalProperties, trustStoreBackendResponse.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, schemas, id, backendID, baseDN, writabilityMode, trustStoreFile, trustStoreType, trustStorePin, trustStorePinFile, trustStorePinPassphraseProvider, enabled, setDegradedAlertWhenDisabled, returnUnavailableWhenDisabled, backupFilePermissions, notificationManager, meta, urnColonPingidentityColonSchemasColonConfigurationColonMessagesColon20, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class TrustStoreBackendResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrustStoreBackendResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TrustStoreBackendResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrustStoreBackendResponse is not found in the empty JSON string", TrustStoreBackendResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : TrustStoreBackendResponse.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrustStoreBackendResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrustStoreBackendResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrustStoreBackendResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrustStoreBackendResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<TrustStoreBackendResponse>() {
           @Override
           public void write(JsonWriter out, TrustStoreBackendResponse value) throws IOException {
           ...
           @Override
           public TrustStoreBackendResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TrustStoreBackendResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TrustStoreBackendResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrustStoreBackendResponse
  * @throws IOException if the JSON string is invalid with respect to TrustStoreBackendResponse
  */
  public static TrustStoreBackendResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrustStoreBackendResponse.class);
  }

 /**
  * Convert an instance of TrustStoreBackendResponse to an JSON string
  *
  * @return JSON string
  */
